...
class ClientGenerator(
    ...
    private fun writeClientStruct(
        ...
        writer.write(".http_client = aws.http.HttpClient.init(allocator, config.retry_mode),")
        writer.closeBlock("};")
        writer.closeBlock("}")
        writer.blankLine()
        ...
        writer.write(".allocator = allocator,")
        writer.write(".config = config,")
        writer.write(".http_client = aws.http.HttpClient.initWithOptions(allocator, config.retry_mode, options),")
        writer.closeBlock("};")
        writer.closeBlock("}")
        writer.blankLine()
