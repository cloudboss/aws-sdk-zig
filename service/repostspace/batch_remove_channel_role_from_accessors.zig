...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchRemoveChannelRoleFromAccessorsInput, options: Options) !BatchRemoveChannelRoleFromAccessorsOutput {
