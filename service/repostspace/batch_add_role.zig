...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAddRoleInput, options: CallOptions) !BatchAddRoleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchAddRoleInput, config: *aws.Config) !aws.http.Request {
