...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAddChannelRoleToAccessorsInput, options: Options) !BatchAddChannelRoleToAccessorsOutput {
