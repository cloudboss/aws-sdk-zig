...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessorInput, options: CallOptions) !GetAccessorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAccessorInput, config: *aws.Config) !aws.http.Request {
