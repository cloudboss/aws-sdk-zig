...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        illegal_action_exception: IllegalActionException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .illegal_action_exception => |e| e.message,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .illegal_action_exception => |e| e.request_id,
...
pub const IllegalActionException = struct {
    message: []const u8 = "",
    request_id: []const u8 = "",
};
