...
pub const DeleteNodeInput = struct {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteNodeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteNodeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteNodeOutput = .{};
