...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListProposalVotesInput, options: CallOptions) !ListProposalVotesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListProposalVotesInput, config: *aws.Config) !aws.http.Request {
