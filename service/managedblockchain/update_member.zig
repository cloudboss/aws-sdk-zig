...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateMemberInput, options: Options) !UpdateMemberOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateMemberInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateMemberOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
