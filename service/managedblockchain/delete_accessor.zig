...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccessorInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/accessors/");
    try path_buf.appendSlice(alloc, input.accessor_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccessorOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
