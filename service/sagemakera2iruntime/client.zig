...
pub const Client = struct {
    ...
    pub fn deleteHumanLoop(self: *Self, allocator: std.mem.Allocator, input: delete_human_loop.DeleteHumanLoopInput, options: CallOptions) !delete_human_loop.DeleteHumanLoopOutput {
    ...
    pub fn describeHumanLoop(self: *Self, allocator: std.mem.Allocator, input: describe_human_loop.DescribeHumanLoopInput, options: CallOptions) !describe_human_loop.DescribeHumanLoopOutput {
    ...
    pub fn listHumanLoops(self: *Self, allocator: std.mem.Allocator, input: list_human_loops.ListHumanLoopsInput, options: CallOptions) !list_human_loops.ListHumanLoopsOutput {
        return list_human_loops.execute(self, allocator, input, options);
    }

    /// Starts a human loop, provided that at least one activation condition is met.
    pub fn startHumanLoop(self: *Self, allocator: std.mem.Allocator, input: start_human_loop.StartHumanLoopInput, options: CallOptions) !start_human_loop.StartHumanLoopOutput {
        return start_human_loop.execute(self, allocator, input, options);
    }

    /// Stops the specified human loop.
    pub fn stopHumanLoop(self: *Self, allocator: std.mem.Allocator, input: stop_human_loop.StopHumanLoopInput, options: CallOptions) !stop_human_loop.StopHumanLoopOutput {
