...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBucketInventoryConfigurationInput, options: CallOptions) !PutBucketInventoryConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutBucketInventoryConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "<InventoryConfiguration xmlns=" ++ &[_]u8{0x22} ++ "http://s3.amazonaws.com/doc/2006-03-01/" ++ &[_]u8{0x22} ++ ">");
    try serde.serializeInventoryConfiguration(allocator, &body_buf, input.inventory_configuration);
    try body_buf.appendSlice(allocator, "</InventoryConfiguration>");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutBucketInventoryConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
