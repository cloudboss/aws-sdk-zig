...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBucketInventoryConfigurationInput, options: Options) !PutBucketInventoryConfigurationOutput {
