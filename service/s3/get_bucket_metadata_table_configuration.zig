...
pub fn execute(client: *Client, input: GetBucketMetadataTableConfigurationInput, options: Options) !GetBucketMetadataTableConfigurationOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetBucketMetadataTableConfigurationOutput {
    _ = body;
    _ = status;
