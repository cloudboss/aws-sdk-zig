...
pub const GetBucketMetadataTableConfigurationInput = struct {
...
pub const GetBucketMetadataTableConfigurationOutput = struct {
    /// The metadata table configuration for the general purpose bucket.
    get_bucket_metadata_table_configuration_result: ?GetBucketMetadataTableConfigurationResult = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketMetadataTableConfigurationInput, options: CallOptions) !GetBucketMetadataTableConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketMetadataTableConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "metadataTable");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketMetadataTableConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
