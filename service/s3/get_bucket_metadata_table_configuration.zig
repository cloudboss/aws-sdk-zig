...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketMetadataTableConfigurationInput, options: Options) !GetBucketMetadataTableConfigurationOutput {
