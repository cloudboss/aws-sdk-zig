...
pub const GetBucketMetricsConfigurationInput = struct {
...
pub const GetBucketMetricsConfigurationOutput = struct {
    /// Specifies the metrics configuration.
    metrics_configuration: ?MetricsConfiguration = null,

    allocator: std.mem.Allocator,

    pub fn deinit(self: *const GetBucketMetricsConfigurationOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: GetBucketMetricsConfigurationInput, options: Options) !GetBucketMetricsConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetBucketMetricsConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(alloc, "metrics&x-id=GetBucketMetricsConfiguration");
    query_has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetBucketMetricsConfigurationOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: GetBucketMetricsConfigurationOutput = .{ .allocator = alloc };
