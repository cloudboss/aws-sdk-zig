...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketIntelligentTieringConfigurationInput, options: CallOptions) !GetBucketIntelligentTieringConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketIntelligentTieringConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "intelligent-tiering&x-id=GetBucketIntelligentTieringConfiguration");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketIntelligentTieringConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
