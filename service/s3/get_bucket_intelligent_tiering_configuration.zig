...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketIntelligentTieringConfigurationInput, options: Options) !GetBucketIntelligentTieringConfigurationOutput {
