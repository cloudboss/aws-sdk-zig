...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBucketIntelligentTieringConfigurationsInput, options: Options) !ListBucketIntelligentTieringConfigurationsOutput {
