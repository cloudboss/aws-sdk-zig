...
pub const DeletePublicAccessBlockInput = struct {
...
pub const DeletePublicAccessBlockOutput = struct {
    ...
    pub fn deinit(self: *const DeletePublicAccessBlockOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeletePublicAccessBlockInput, options: Options) !DeletePublicAccessBlockOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePublicAccessBlockInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePublicAccessBlockOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePublicAccessBlockOutput = .{ .allocator = alloc };
