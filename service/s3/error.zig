...
pub const Error = struct {
    ...
    /// is meant to be read and
    /// understood by programs that detect and handle errors by type. The following
    /// is a list of Amazon S3 error
    /// codes. For more information, see [Error
    ...
    ///   that prevents
    /// the action from completing successfully. Contact Amazon Web Services Support
    ...
    /// it. Amazon S3 returns this error in all Amazon Web Services Regions except
    /// in the North Virginia Region. For legacy
    /// compatibility, if you re-create an existing bucket that you already own in
    /// the North Virginia
    ...
    /// * *Code:* InvalidRequest
    ///
    /// * *Description:* Amazon S3 Transfer Acceleration is not supported for
    ///   buckets
    ...
    /// * *Code:* InvalidRequest
    ///
    /// * *Description:* Amazon S3 Transfer Accelerate endpoint only supports
    ///   virtual
    /// style requests.
    ///
    /// * *HTTP Status Code:* 400 Bad Request
    ...
    /// URL: [Amazon S3](http://aws.amazon.com/s3)
    ///
    /// * *HTTP Status Code:* 403 Forbidden
    ///
    /// * *SOAP Fault Code Prefix:* Client
    ...
    /// signing method. For more
    /// information, see [REST
    /// Authentication](https://docs.aws.amazon.com/AmazonS3/latest/dev/RESTAuthentication.html) and [SOAP Authentication](https://docs.aws.amazon.com/AmazonS3/latest/dev/SOAPAuthentication.html) for
    /// details.
    ///
    /// * *HTTP Status Code:* 403 Forbidden
    ///
    ...
    /// for a human audience. Simple programs display the message directly to the
    /// end user if they encounter an
    /// error condition they don't know how or don't care to handle. Sophisticated
