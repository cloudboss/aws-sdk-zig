...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketOwnershipControlsInput, options: CallOptions) !DeleteBucketOwnershipControlsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketOwnershipControlsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketOwnershipControlsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
