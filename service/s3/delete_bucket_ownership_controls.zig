...
pub const DeleteBucketOwnershipControlsOutput = struct {
    ...
    pub fn deinit(self: *const DeleteBucketOwnershipControlsOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteBucketOwnershipControlsInput, options: Options) !DeleteBucketOwnershipControlsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBucketOwnershipControlsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBucketOwnershipControlsOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketOwnershipControlsOutput = .{ .allocator = alloc };
