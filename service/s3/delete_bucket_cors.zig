...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketCorsInput, options: CallOptions) !DeleteBucketCorsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketCorsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketCorsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
