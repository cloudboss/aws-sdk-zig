...
pub const DeleteBucketCorsInput = struct {
...
pub const DeleteBucketCorsOutput = struct {

    allocator: std.mem.Allocator,

    pub fn deinit(self: *const DeleteBucketCorsOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteBucketCorsInput, options: Options) !DeleteBucketCorsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBucketCorsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBucketCorsOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketCorsOutput = .{ .allocator = alloc };
