...
pub fn execute(client: *Client, input: GetBucketAbacInput, options: Options) !GetBucketAbacOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetBucketAbacOutput {
    _ = body;
    _ = status;
