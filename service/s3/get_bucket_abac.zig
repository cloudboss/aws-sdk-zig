...
pub const GetBucketAbacOutput = struct {
    /// The ABAC status of the general purpose bucket.
    abac_status: ?AbacStatus = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketAbacInput, options: CallOptions) !GetBucketAbacOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketAbacInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketAbacOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
