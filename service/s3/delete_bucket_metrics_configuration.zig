...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketMetricsConfigurationInput, options: CallOptions) !DeleteBucketMetricsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketMetricsConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketMetricsConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
