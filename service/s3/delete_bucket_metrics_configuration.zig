...
pub const DeleteBucketMetricsConfigurationInput = struct {
...
pub const DeleteBucketMetricsConfigurationOutput = struct {
    ...
    pub fn deinit(self: *const DeleteBucketMetricsConfigurationOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteBucketMetricsConfigurationInput, options: Options) !DeleteBucketMetricsConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBucketMetricsConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(alloc, "metrics");
    query_has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBucketMetricsConfigurationOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketMetricsConfigurationOutput = .{ .allocator = alloc };
