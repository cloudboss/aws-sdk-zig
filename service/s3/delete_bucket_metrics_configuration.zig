...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketMetricsConfigurationInput, options: Options) !DeleteBucketMetricsConfigurationOutput {
