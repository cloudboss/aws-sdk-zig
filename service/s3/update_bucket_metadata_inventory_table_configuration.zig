...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateBucketMetadataInventoryTableConfigurationInput, options: Options) !UpdateBucketMetadataInventoryTableConfigurationOutput {
