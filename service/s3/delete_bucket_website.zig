...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketWebsiteInput, options: CallOptions) !DeleteBucketWebsiteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketWebsiteInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketWebsiteOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
