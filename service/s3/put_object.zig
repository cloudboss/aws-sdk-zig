...
pub const PutObjectOutput = struct {
    ...
    /// The Base64 encoded, 128-bit `MD5` digest of the object. This header is
    /// present if
    /// the object was uploaded with the `MD5` checksum algorithm. For more
    /// information, see
    /// [Checking
    ...
    /// The Base64 encoded, 512-bit `SHA512` digest of the object. This header is
    /// present if
    /// the object was uploaded with the `SHA512` checksum algorithm. For more
    /// information, see
    /// [Checking
    /// object integrity in the Amazon S3 User
    /// Guide](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html).
    ...
    /// The Base64 encoded, 128-bit `XXHASH128` checksum of the object. This header
    /// is present if
    /// the object was uploaded with the `XXHASH128` checksum algorithm. For more
    /// information, see
    /// [Checking
    /// object integrity in the Amazon S3 User
    /// Guide](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html).
    ...
    /// present if
    /// the object was uploaded with the `XXHASH3` checksum algorithm. For more
    /// information, see
    /// [Checking
    /// object integrity in the Amazon S3 User
    /// Guide](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html).
    ...
    /// present if
    /// the object was uploaded with the `XXHASH64` checksum algorithm. For more
    /// information, see
    /// [Checking
    /// object integrity in the Amazon S3 User
    /// Guide](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html).
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutObjectInput, options: CallOptions) !PutObjectOutput {
...
pub fn presign(client: *Client, allocator: std.mem.Allocator, input: PutObjectInput, options: PresignOptions) ![]const u8 {
    var arena = std.heap.ArenaAllocator.init(client.allocator);
    defer arena.deinit();
    const alloc = arena.allocator();
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutObjectInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "x-id=PutObject");
    query_has_prev = true;
    ...
    if (input.write_offset_bytes) |v| {
        {
            const num_str = std.fmt.allocPrint(allocator, "{d}", .{v}) catch "";
            try request.headers.put(allocator, "x-amz-write-offset-bytes", num_str);
        }
    }
