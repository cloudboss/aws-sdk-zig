...
pub const UpdateBucketMetadataJournalTableConfigurationOutput = struct {
    ...
    pub fn deinit(self: *UpdateBucketMetadataJournalTableConfigurationOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: UpdateBucketMetadataJournalTableConfigurationInput, options: Options) !UpdateBucketMetadataJournalTableConfigurationOutput {
