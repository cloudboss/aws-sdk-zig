...
pub const GetBucketTaggingOutput = struct {
    ...
    pub fn deinit(self: *const GetBucketTaggingOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: GetBucketTaggingInput, options: Options) !GetBucketTaggingOutput {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetBucketTaggingOutput {
    ...
    _ = status;
    _ = headers;
    const result: GetBucketTaggingOutput = .{ .allocator = alloc };
