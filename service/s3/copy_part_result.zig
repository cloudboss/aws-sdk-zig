...
pub const CopyPartResult = struct {
    ...
    /// present if
    /// the multipart upload request was created with the `CRC32` checksum
    /// algorithm. For more
    ...
    /// present if
    /// the multipart upload request was created with the `CRC32C` checksum
    /// algorithm. For more
    /// information, see [Checking object
    /// integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html) in
    /// the *Amazon S3 User Guide*.
    ...
    /// The Base64 encoded, 160-bit `SHA1` digest of the part. This checksum is
    /// present if
    /// the multipart upload request was created with the `SHA1` checksum algorithm.
    /// For more
    /// information, see [Checking object
    /// integrity](https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html) in
    /// the *Amazon S3 User Guide*.
    ...
    /// The Base64 encoded, 256-bit `SHA256` digest of the part. This checksum is
    /// present if
