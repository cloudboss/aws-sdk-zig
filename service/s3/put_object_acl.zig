...
pub fn execute(client: *Client, input: PutObjectAclInput, options: Options) !PutObjectAclOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !PutObjectAclOutput {
    _ = body;
    _ = status;
    const result: PutObjectAclOutput = .{ .allocator = alloc };
