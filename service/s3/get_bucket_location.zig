...
pub const GetBucketLocationOutput = struct {
    ...
    pub fn deinit(self: *GetBucketLocationOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: GetBucketLocationInput, options: Options) !GetBucketLocationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetBucketLocationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(alloc, "location");
    query_has_prev = true;
