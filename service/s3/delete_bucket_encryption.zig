...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketEncryptionInput, options: CallOptions) !DeleteBucketEncryptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketEncryptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketEncryptionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
