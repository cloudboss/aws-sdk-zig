...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketEncryptionInput, options: CallOptions) !GetBucketEncryptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketEncryptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketEncryptionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
