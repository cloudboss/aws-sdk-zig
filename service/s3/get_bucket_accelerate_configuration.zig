...
pub const GetBucketAccelerateConfigurationInput = struct {
...
pub const GetBucketAccelerateConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketAccelerateConfigurationInput, options: CallOptions) !GetBucketAccelerateConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketAccelerateConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "accelerate");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketAccelerateConfigurationOutput {
    _ = allocator;
    var result: GetBucketAccelerateConfigurationOutput = .{};
    _ = status;
