...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketAccelerateConfigurationInput, options: Options) !GetBucketAccelerateConfigurationOutput {
