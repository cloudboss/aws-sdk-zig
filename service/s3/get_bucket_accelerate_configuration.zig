...
pub const GetBucketAccelerateConfigurationOutput = struct {
    ...
    pub fn deinit(self: *GetBucketAccelerateConfigurationOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: GetBucketAccelerateConfigurationInput, options: Options) !GetBucketAccelerateConfigurationOutput {
