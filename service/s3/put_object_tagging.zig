...
pub const PutObjectTaggingInput = struct {
...
pub const PutObjectTaggingOutput = struct {
    /// The versionId of the object the tag-set was added to.
    version_id: ?[]const u8 = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutObjectTaggingInput, options: CallOptions) !PutObjectTaggingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutObjectTaggingInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "<Tagging xmlns=" ++ &[_]u8{0x22} ++ "http://s3.amazonaws.com/doc/2006-03-01/" ++ &[_]u8{0x22} ++ ">");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutObjectTaggingOutput {
