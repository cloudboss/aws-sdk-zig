...
pub const DeleteBucketReplicationInput = struct {
    /// The bucket name.
    bucket: []const u8,
...
const DeleteBucketReplicationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketReplicationInput, options: Options) !DeleteBucketReplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketReplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "replication");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketReplicationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketReplicationOutput = .{};
