...
pub const DeleteBucketReplicationOutput = struct {
    ...
    pub fn deinit(self: *DeleteBucketReplicationOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteBucketReplicationInput, options: Options) !DeleteBucketReplicationOutput {
