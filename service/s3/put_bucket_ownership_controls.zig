...
pub const PutBucketOwnershipControlsOutput = struct {
    ...
    pub fn deinit(self: *PutBucketOwnershipControlsOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: PutBucketOwnershipControlsInput, options: Options) !PutBucketOwnershipControlsOutput {
