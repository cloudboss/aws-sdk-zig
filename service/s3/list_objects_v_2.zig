...
pub const ListObjectsV2Output = struct {
    ...
    pub fn deinit(self: *const ListObjectsV2Output) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListObjectsV2Output {
    ...
    if (findElement(body, "KeyCount")) |content| {
        result.key_count = std.fmt.parseInt(i32, content, 10) catch null;
    }
