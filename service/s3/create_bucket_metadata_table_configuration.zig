...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateBucketMetadataTableConfigurationInput, options: CallOptions) !CreateBucketMetadataTableConfigurationOutput {
