...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBucketIntelligentTieringConfigurationInput, options: Options) !PutBucketIntelligentTieringConfigurationOutput {
