...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !PutObjectLockConfigurationOutput {
    _ = body;
    _ = status;
    const result: PutObjectLockConfigurationOutput = .{ .allocator = alloc };
