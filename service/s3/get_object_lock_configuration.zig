...
pub const GetObjectLockConfigurationOutput = struct {
    /// The specified bucket's Object Lock configuration.
    object_lock_configuration: ?ObjectLockConfiguration = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetObjectLockConfigurationInput, options: CallOptions) !GetObjectLockConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetObjectLockConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetObjectLockConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
