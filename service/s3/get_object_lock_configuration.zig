...
pub fn execute(client: *Client, input: GetObjectLockConfigurationInput, options: Options) !GetObjectLockConfigurationOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetObjectLockConfigurationOutput {
    _ = body;
    _ = status;
