...
pub const DeleteBucketIntelligentTieringConfigurationInput = struct {
...
pub const DeleteBucketIntelligentTieringConfigurationOutput = struct {
    ...
    pub fn deinit(self: *const DeleteBucketIntelligentTieringConfigurationOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteBucketIntelligentTieringConfigurationInput, options: Options) !DeleteBucketIntelligentTieringConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBucketIntelligentTieringConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBucketIntelligentTieringConfigurationOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketIntelligentTieringConfigurationOutput = .{ .allocator = alloc };
