...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketIntelligentTieringConfigurationInput, options: CallOptions) !DeleteBucketIntelligentTieringConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketIntelligentTieringConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketIntelligentTieringConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
