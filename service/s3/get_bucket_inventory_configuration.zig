...
pub const GetBucketInventoryConfigurationInput = struct {
...
pub const GetBucketInventoryConfigurationOutput = struct {
    /// Specifies the inventory configuration.
    inventory_configuration: ?InventoryConfiguration = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketInventoryConfigurationInput, options: CallOptions) !GetBucketInventoryConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketInventoryConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "inventory&x-id=GetBucketInventoryConfiguration");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketInventoryConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
