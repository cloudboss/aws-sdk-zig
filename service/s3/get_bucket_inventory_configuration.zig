...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketInventoryConfigurationInput, options: Options) !GetBucketInventoryConfigurationOutput {
