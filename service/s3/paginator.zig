...
pub const ListObjectsV2Paginator = struct {
    client: *Client,
    params: list_objects_v_2.ListObjectsV2Input,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, options: list_objects_v_2.Options) !list_objects_v_2.ListObjectsV2Output {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_objects_v_2.execute(self.client, self.params, options);
