...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBucketWebsiteInput, options: CallOptions) !PutBucketWebsiteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutBucketWebsiteInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutBucketWebsiteOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
