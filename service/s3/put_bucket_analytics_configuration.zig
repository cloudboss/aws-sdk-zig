...
pub const PutBucketAnalyticsConfigurationOutput = struct {
    ...
    pub fn deinit(self: *const PutBucketAnalyticsConfigurationOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: PutBucketAnalyticsConfigurationInput, options: Options) !PutBucketAnalyticsConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutBucketAnalyticsConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(alloc, "analytics");
    query_has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutBucketAnalyticsConfigurationOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: PutBucketAnalyticsConfigurationOutput = .{ .allocator = alloc };
