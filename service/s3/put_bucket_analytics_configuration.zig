...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBucketAnalyticsConfigurationInput, options: CallOptions) !PutBucketAnalyticsConfigurationOutput {
