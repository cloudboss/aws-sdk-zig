...
pub const PutBucketAnalyticsConfigurationInput = struct {
...
const PutBucketAnalyticsConfigurationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBucketAnalyticsConfigurationInput, options: Options) !PutBucketAnalyticsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutBucketAnalyticsConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "analytics");
    query_has_prev = true;
    ...
    try body_buf.appendSlice(allocator, "<AnalyticsConfiguration xmlns=" ++ &[_]u8{0x22} ++ "http://s3.amazonaws.com/doc/2006-03-01/" ++ &[_]u8{0x22} ++ ">");
    try serde.serializeAnalyticsConfiguration(allocator, &body_buf, input.analytics_configuration);
    try body_buf.appendSlice(allocator, "</AnalyticsConfiguration>");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutBucketAnalyticsConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutBucketAnalyticsConfigurationOutput = .{};
