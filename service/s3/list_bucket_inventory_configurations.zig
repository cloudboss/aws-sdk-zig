...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBucketInventoryConfigurationsInput, options: Options) !ListBucketInventoryConfigurationsOutput {
