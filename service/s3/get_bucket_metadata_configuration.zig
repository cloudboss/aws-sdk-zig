...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketMetadataConfigurationInput, options: Options) !GetBucketMetadataConfigurationOutput {
