...
pub const GetBucketNotificationConfigurationOutput = struct {
...
pub fn execute(client: *Client, input: GetBucketNotificationConfigurationInput, options: Options) !GetBucketNotificationConfigurationOutput {
