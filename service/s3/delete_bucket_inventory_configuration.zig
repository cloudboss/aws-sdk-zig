...
pub const DeleteBucketInventoryConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketInventoryConfigurationInput, options: CallOptions) !DeleteBucketInventoryConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketInventoryConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "inventory");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketInventoryConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketInventoryConfigurationOutput = .{};
