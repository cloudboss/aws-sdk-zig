...
pub fn execute(client: *Client, input: GetObjectRetentionInput, options: Options) !GetObjectRetentionOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetObjectRetentionOutput {
    _ = body;
    _ = status;
