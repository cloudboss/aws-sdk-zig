...
pub fn execute(client: *Client, input: ListBucketAnalyticsConfigurationsInput, options: Options) !ListBucketAnalyticsConfigurationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListBucketAnalyticsConfigurationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(alloc, "analytics&x-id=ListBucketAnalyticsConfigurations");
    query_has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListBucketAnalyticsConfigurationsOutput {
