...
pub fn execute(client: *Client, input: GetBucketAclInput, options: Options) !GetBucketAclOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetBucketAclOutput {
    _ = body;
    _ = status;
