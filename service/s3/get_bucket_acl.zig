...
pub const GetBucketAclInput = struct {
...
pub const GetBucketAclOutput = struct {
    /// A list of grants.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketAclInput, options: CallOptions) !GetBucketAclOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketAclInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketAclOutput {
