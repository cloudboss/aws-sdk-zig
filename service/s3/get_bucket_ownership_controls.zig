...
pub const GetBucketOwnershipControlsInput = struct {
...
pub const GetBucketOwnershipControlsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketOwnershipControlsInput, options: CallOptions) !GetBucketOwnershipControlsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketOwnershipControlsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketOwnershipControlsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
