...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketLifecycleInput, options: CallOptions) !DeleteBucketLifecycleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketLifecycleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketLifecycleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
