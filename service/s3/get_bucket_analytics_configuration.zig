...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketAnalyticsConfigurationInput, options: Options) !GetBucketAnalyticsConfigurationOutput {
