...
pub const GetBucketAnalyticsConfigurationInput = struct {
...
pub const GetBucketAnalyticsConfigurationOutput = struct {
    /// The configuration and any analyses for the analytics filter.
    analytics_configuration: ?AnalyticsConfiguration = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketAnalyticsConfigurationInput, options: CallOptions) !GetBucketAnalyticsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketAnalyticsConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "analytics&x-id=GetBucketAnalyticsConfiguration");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketAnalyticsConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
