...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketMetadataConfigurationInput, options: CallOptions) !DeleteBucketMetadataConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketMetadataConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketMetadataConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
