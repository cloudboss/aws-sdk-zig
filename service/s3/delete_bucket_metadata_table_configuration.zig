...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketMetadataTableConfigurationInput, options: Options) !DeleteBucketMetadataTableConfigurationOutput {
