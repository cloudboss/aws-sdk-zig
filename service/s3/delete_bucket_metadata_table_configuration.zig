...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketMetadataTableConfigurationInput, options: CallOptions) !DeleteBucketMetadataTableConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketMetadataTableConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketMetadataTableConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketMetadataTableConfigurationOutput = .{};
