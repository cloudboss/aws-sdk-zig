...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutObjectLegalHoldInput, options: CallOptions) !PutObjectLegalHoldOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutObjectLegalHoldInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutObjectLegalHoldOutput {
    _ = allocator;
