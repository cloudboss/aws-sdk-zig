...
pub const DeleteBucketOutput = struct {
    ...
    pub fn deinit(self: *const DeleteBucketOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteBucketInput, options: Options) !DeleteBucketOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteBucketOutput {
    _ = body;
    _ = status;
    const result: DeleteBucketOutput = .{ .allocator = alloc };
