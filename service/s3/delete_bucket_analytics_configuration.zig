...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketAnalyticsConfigurationInput, options: Options) !DeleteBucketAnalyticsConfigurationOutput {
