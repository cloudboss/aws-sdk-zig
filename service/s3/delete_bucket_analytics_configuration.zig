...
pub fn execute(client: *Client, input: DeleteBucketAnalyticsConfigurationInput, options: Options) !DeleteBucketAnalyticsConfigurationOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteBucketAnalyticsConfigurationOutput {
    _ = body;
    _ = status;
