...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketAnalyticsConfigurationInput, options: CallOptions) !DeleteBucketAnalyticsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketAnalyticsConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketAnalyticsConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
