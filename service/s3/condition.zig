...
pub const Condition = struct {
    ...
    /// if the error code equals
    /// this value, then the specified redirect is applied. Required when parent
    /// element `Condition`
    ...
    /// `/docs`,
    /// which identifies all objects in the `docs/` folder. Required when the parent
    /// element
