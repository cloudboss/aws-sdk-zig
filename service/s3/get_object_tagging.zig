...
pub fn execute(client: *Client, input: GetObjectTaggingInput, options: Options) !GetObjectTaggingOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetObjectTaggingOutput {
    _ = body;
    _ = status;
    const result: GetObjectTaggingOutput = .{ .allocator = alloc };
