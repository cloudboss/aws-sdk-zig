...
pub const GetObjectTaggingInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetObjectTaggingInput, options: CallOptions) !GetObjectTaggingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetObjectTaggingInput, config: *aws.Config) !aws.http.Request {
