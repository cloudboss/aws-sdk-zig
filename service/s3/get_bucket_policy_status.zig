...
pub const GetBucketPolicyStatusInput = struct {
...
pub const GetBucketPolicyStatusOutput = struct {
    /// The policy status for the specified bucket.
    policy_status: ?PolicyStatus = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketPolicyStatusInput, options: CallOptions) !GetBucketPolicyStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketPolicyStatusInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "policyStatus");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketPolicyStatusOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
