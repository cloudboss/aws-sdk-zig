...
pub const UpdateConnectionRecordingPreferencesInput = struct {
...
pub const UpdateConnectionRecordingPreferencesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateConnectionRecordingPreferencesInput, options: CallOptions) !UpdateConnectionRecordingPreferencesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateConnectionRecordingPreferencesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/UpdateConnectionRecordingPreferences";
    ...
    if (has_prev) try body_buf.appendSlice(allocator, ",");
    try body_buf.appendSlice(allocator, "\"ConnectionRecordingPreferences\":");
    try aws.json.writeValue(@TypeOf(input.connection_recording_preferences), input.connection_recording_preferences, allocator, &body_buf);
    has_prev = true;
