...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAnomaliesForInsightInput, options: CallOptions) !ListAnomaliesForInsightOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAnomaliesForInsightInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/anomalies/insight/");
    try path_buf.appendSlice(allocator, input.insight_id);
