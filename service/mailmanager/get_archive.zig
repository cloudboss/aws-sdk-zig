...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetArchiveInput, options: Options) !GetArchiveOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetArchiveInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "MailManagerSvc.GetArchive");
