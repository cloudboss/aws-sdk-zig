...
pub const Client = struct {
    ...
    pub fn createAddonInstance(self: *Self, allocator: std.mem.Allocator, input: create_addon_instance.CreateAddonInstanceInput, options: CallOptions) !create_addon_instance.CreateAddonInstanceOutput {
    ...
    pub fn createAddonSubscription(self: *Self, allocator: std.mem.Allocator, input: create_addon_subscription.CreateAddonSubscriptionInput, options: CallOptions) !create_addon_subscription.CreateAddonSubscriptionOutput {
        return create_addon_subscription.execute(self, allocator, input, options);
    }

    /// Creates a new address list.
    pub fn createAddressList(self: *Self, allocator: std.mem.Allocator, input: create_address_list.CreateAddressListInput, options: CallOptions) !create_address_list.CreateAddressListOutput {
        return create_address_list.execute(self, allocator, input, options);
    }

    /// Creates an import job for an address list.
    pub fn createAddressListImportJob(self: *Self, allocator: std.mem.Allocator, input: create_address_list_import_job.CreateAddressListImportJobInput, options: CallOptions) !create_address_list_import_job.CreateAddressListImportJobOutput {
    ...
    pub fn createIngressPoint(self: *Self, allocator: std.mem.Allocator, input: create_ingress_point.CreateIngressPointInput, options: CallOptions) !create_ingress_point.CreateIngressPointOutput {
    ...
    pub fn createRelay(self: *Self, allocator: std.mem.Allocator, input: create_relay.CreateRelayInput, options: CallOptions) !create_relay.CreateRelayOutput {
        return create_relay.execute(self, allocator, input, options);
    }

    /// Provision a new rule set.
    pub fn createRuleSet(self: *Self, allocator: std.mem.Allocator, input: create_rule_set.CreateRuleSetInput, options: CallOptions) !create_rule_set.CreateRuleSetOutput {
    ...
    pub fn deleteAddonInstance(self: *Self, allocator: std.mem.Allocator, input: delete_addon_instance.DeleteAddonInstanceInput, options: CallOptions) !delete_addon_instance.DeleteAddonInstanceOutput {
        return delete_addon_instance.execute(self, allocator, input, options);
    }

    /// Deletes an Add On subscription.
    pub fn deleteAddonSubscription(self: *Self, allocator: std.mem.Allocator, input: delete_addon_subscription.DeleteAddonSubscriptionInput, options: CallOptions) !delete_addon_subscription.DeleteAddonSubscriptionOutput {
        return delete_addon_subscription.execute(self, allocator, input, options);
    }

    /// Deletes an address list.
    pub fn deleteAddressList(self: *Self, allocator: std.mem.Allocator, input: delete_address_list.DeleteAddressListInput, options: CallOptions) !delete_address_list.DeleteAddressListOutput {
    ...
    pub fn deleteIngressPoint(self: *Self, allocator: std.mem.Allocator, input: delete_ingress_point.DeleteIngressPointInput, options: CallOptions) !delete_ingress_point.DeleteIngressPointOutput {
        return delete_ingress_point.execute(self, allocator, input, options);
    }

    /// Deletes an existing relay resource.
    pub fn deleteRelay(self: *Self, allocator: std.mem.Allocator, input: delete_relay.DeleteRelayInput, options: CallOptions) !delete_relay.DeleteRelayOutput {
        return delete_relay.execute(self, allocator, input, options);
    }

    /// Delete a rule set.
    pub fn deleteRuleSet(self: *Self, allocator: std.mem.Allocator, input: delete_rule_set.DeleteRuleSetInput, options: CallOptions) !delete_rule_set.DeleteRuleSetOutput {
    ...
    pub fn deregisterMemberFromAddressList(self: *Self, allocator: std.mem.Allocator, input: deregister_member_from_address_list.DeregisterMemberFromAddressListInput, options: CallOptions) !deregister_member_from_address_list.DeregisterMemberFromAddressListOutput {
        return deregister_member_from_address_list.execute(self, allocator, input, options);
    }

    /// Gets detailed information about an Add On instance.
    pub fn getAddonInstance(self: *Self, allocator: std.mem.Allocator, input: get_addon_instance.GetAddonInstanceInput, options: CallOptions) !get_addon_instance.GetAddonInstanceOutput {
        return get_addon_instance.execute(self, allocator, input, options);
    }

    /// Gets detailed information about an Add On subscription.
    pub fn getAddonSubscription(self: *Self, allocator: std.mem.Allocator, input: get_addon_subscription.GetAddonSubscriptionInput, options: CallOptions) !get_addon_subscription.GetAddonSubscriptionOutput {
        return get_addon_subscription.execute(self, allocator, input, options);
    }

    /// Fetch attributes of an address list.
    pub fn getAddressList(self: *Self, allocator: std.mem.Allocator, input: get_address_list.GetAddressListInput, options: CallOptions) !get_address_list.GetAddressListOutput {
        return get_address_list.execute(self, allocator, input, options);
    }

    /// Fetch attributes of an import job.
    pub fn getAddressListImportJob(self: *Self, allocator: std.mem.Allocator, input: get_address_list_import_job.GetAddressListImportJobInput, options: CallOptions) !get_address_list_import_job.GetAddressListImportJobOutput {
        return get_address_list_import_job.execute(self, allocator, input, options);
    }

    /// Retrieves the full details and current state of a specified email archive.
    pub fn getArchive(self: *Self, allocator: std.mem.Allocator, input: get_archive.GetArchiveInput, options: CallOptions) !get_archive.GetArchiveOutput {
    ...
    /// job.
    pub fn getArchiveExport(self: *Self, allocator: std.mem.Allocator, input: get_archive_export.GetArchiveExportInput, options: CallOptions) !get_archive_export.GetArchiveExportOutput {
    ...
    pub fn getArchiveMessage(self: *Self, allocator: std.mem.Allocator, input: get_archive_message.GetArchiveMessageInput, options: CallOptions) !get_archive_message.GetArchiveMessageOutput {
    ...
    pub fn getArchiveMessageContent(self: *Self, allocator: std.mem.Allocator, input: get_archive_message_content.GetArchiveMessageContentInput, options: CallOptions) !get_archive_message_content.GetArchiveMessageContentOutput {
    ...
    /// job.
    pub fn getArchiveSearch(self: *Self, allocator: std.mem.Allocator, input: get_archive_search.GetArchiveSearchInput, options: CallOptions) !get_archive_search.GetArchiveSearchOutput {
        return get_archive_search.execute(self, allocator, input, options);
    }

    /// Returns the results of a completed email archive search job.
    pub fn getArchiveSearchResults(self: *Self, allocator: std.mem.Allocator, input: get_archive_search_results.GetArchiveSearchResultsInput, options: CallOptions) !get_archive_search_results.GetArchiveSearchResultsOutput {
        return get_archive_search_results.execute(self, allocator, input, options);
    }

    /// Fetch ingress endpoint resource attributes.
    pub fn getIngressPoint(self: *Self, allocator: std.mem.Allocator, input: get_ingress_point.GetIngressPointInput, options: CallOptions) !get_ingress_point.GetIngressPointOutput {
        return get_ingress_point.execute(self, allocator, input, options);
    }

    /// Fetch attributes of a member in an address list.
    pub fn getMemberOfAddressList(self: *Self, allocator: std.mem.Allocator, input: get_member_of_address_list.GetMemberOfAddressListInput, options: CallOptions) !get_member_of_address_list.GetMemberOfAddressListOutput {
        return get_member_of_address_list.execute(self, allocator, input, options);
    }

    /// Fetch the relay resource and it's attributes.
    pub fn getRelay(self: *Self, allocator: std.mem.Allocator, input: get_relay.GetRelayInput, options: CallOptions) !get_relay.GetRelayOutput {
        return get_relay.execute(self, allocator, input, options);
    }

    /// Fetch attributes of a rule set.
    pub fn getRuleSet(self: *Self, allocator: std.mem.Allocator, input: get_rule_set.GetRuleSetInput, options: CallOptions) !get_rule_set.GetRuleSetOutput {
    ...
    pub fn listAddonInstances(self: *Self, allocator: std.mem.Allocator, input: list_addon_instances.ListAddonInstancesInput, options: CallOptions) !list_addon_instances.ListAddonInstancesOutput {
        return list_addon_instances.execute(self, allocator, input, options);
    }

    /// Lists all Add On subscriptions in your account.
    pub fn listAddonSubscriptions(self: *Self, allocator: std.mem.Allocator, input: list_addon_subscriptions.ListAddonSubscriptionsInput, options: CallOptions) !list_addon_subscriptions.ListAddonSubscriptionsOutput {
        return list_addon_subscriptions.execute(self, allocator, input, options);
    }

    /// Lists jobs for an address list.
    pub fn listAddressListImportJobs(self: *Self, allocator: std.mem.Allocator, input: list_address_list_import_jobs.ListAddressListImportJobsInput, options: CallOptions) !list_address_list_import_jobs.ListAddressListImportJobsOutput {
        return list_address_list_import_jobs.execute(self, allocator, input, options);
    }

    /// Lists address lists for this account.
    pub fn listAddressLists(self: *Self, allocator: std.mem.Allocator, input: list_address_lists.ListAddressListsInput, options: CallOptions) !list_address_lists.ListAddressListsOutput {
        return list_address_lists.execute(self, allocator, input, options);
    }

    /// Returns a list of email archive export jobs.
    pub fn listArchiveExports(self: *Self, allocator: std.mem.Allocator, input: list_archive_exports.ListArchiveExportsInput, options: CallOptions) !list_archive_exports.ListArchiveExportsOutput {
        return list_archive_exports.execute(self, allocator, input, options);
    }

    /// Returns a list of email archive search jobs.
    pub fn listArchiveSearches(self: *Self, allocator: std.mem.Allocator, input: list_archive_searches.ListArchiveSearchesInput, options: CallOptions) !list_archive_searches.ListArchiveSearchesOutput {
    ...
    pub fn listIngressPoints(self: *Self, allocator: std.mem.Allocator, input: list_ingress_points.ListIngressPointsInput, options: CallOptions) !list_ingress_points.ListIngressPointsOutput {
        return list_ingress_points.execute(self, allocator, input, options);
    }

    /// Lists members of an address list.
    pub fn listMembersOfAddressList(self: *Self, allocator: std.mem.Allocator, input: list_members_of_address_list.ListMembersOfAddressListInput, options: CallOptions) !list_members_of_address_list.ListMembersOfAddressListOutput {
        return list_members_of_address_list.execute(self, allocator, input, options);
    }

    /// Lists all the existing relay resources.
    pub fn listRelays(self: *Self, allocator: std.mem.Allocator, input: list_relays.ListRelaysInput, options: CallOptions) !list_relays.ListRelaysOutput {
        return list_relays.execute(self, allocator, input, options);
    }

    /// List rule sets for this account.
    pub fn listRuleSets(self: *Self, allocator: std.mem.Allocator, input: list_rule_sets.ListRuleSetsInput, options: CallOptions) !list_rule_sets.ListRuleSetsOutput {
    ...
    pub fn registerMemberToAddressList(self: *Self, allocator: std.mem.Allocator, input: register_member_to_address_list.RegisterMemberToAddressListInput, options: CallOptions) !register_member_to_address_list.RegisterMemberToAddressListOutput {
        return register_member_to_address_list.execute(self, allocator, input, options);
    }

    /// Starts an import job for an address list.
    pub fn startAddressListImportJob(self: *Self, allocator: std.mem.Allocator, input: start_address_list_import_job.StartAddressListImportJobInput, options: CallOptions) !start_address_list_import_job.StartAddressListImportJobOutput {
        return start_address_list_import_job.execute(self, allocator, input, options);
    }

    /// Initiates an export of emails from the specified archive.
    pub fn startArchiveExport(self: *Self, allocator: std.mem.Allocator, input: start_archive_export.StartArchiveExportInput, options: CallOptions) !start_archive_export.StartArchiveExportOutput {
        return start_archive_export.execute(self, allocator, input, options);
    }

    /// Initiates a search across emails in the specified archive.
    pub fn startArchiveSearch(self: *Self, allocator: std.mem.Allocator, input: start_archive_search.StartArchiveSearchInput, options: CallOptions) !start_archive_search.StartArchiveSearchOutput {
        return start_archive_search.execute(self, allocator, input, options);
    }

    /// Stops an ongoing import job for an address list.
    pub fn stopAddressListImportJob(self: *Self, allocator: std.mem.Allocator, input: stop_address_list_import_job.StopAddressListImportJobInput, options: CallOptions) !stop_address_list_import_job.StopAddressListImportJobOutput {
        return stop_address_list_import_job.execute(self, allocator, input, options);
    }

    /// Stops an in-progress export of emails from an archive.
    pub fn stopArchiveExport(self: *Self, allocator: std.mem.Allocator, input: stop_archive_export.StopArchiveExportInput, options: CallOptions) !stop_archive_export.StopArchiveExportOutput {
        return stop_archive_export.execute(self, allocator, input, options);
    }

    /// Stops an in-progress archive search job.
    pub fn stopArchiveSearch(self: *Self, allocator: std.mem.Allocator, input: stop_archive_search.StopArchiveSearchInput, options: CallOptions) !stop_archive_search.StopArchiveSearchOutput {
    ...
    pub fn updateIngressPoint(self: *Self, allocator: std.mem.Allocator, input: update_ingress_point.UpdateIngressPointInput, options: CallOptions) !update_ingress_point.UpdateIngressPointOutput {
        return update_ingress_point.execute(self, allocator, input, options);
    }

    /// Updates the attributes of an existing relay resource.
    pub fn updateRelay(self: *Self, allocator: std.mem.Allocator, input: update_relay.UpdateRelayInput, options: CallOptions) !update_relay.UpdateRelayOutput {
        return update_relay.execute(self, allocator, input, options);
    }

    /// Update attributes of an already provisioned rule set.
    pub fn updateRuleSet(self: *Self, allocator: std.mem.Allocator, input: update_rule_set.UpdateRuleSetInput, options: CallOptions) !update_rule_set.UpdateRuleSetOutput {
        return update_rule_set.execute(self, allocator, input, options);
    }

    /// Update attributes of an already provisioned traffic policy resource.
    pub fn updateTrafficPolicy(self: *Self, allocator: std.mem.Allocator, input: update_traffic_policy.UpdateTrafficPolicyInput, options: CallOptions) !update_traffic_policy.UpdateTrafficPolicyOutput {
