...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelServiceInstanceDeploymentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AwsProton20200720.CancelServiceInstanceDeployment");
