...
pub const ListTagsForResourceInput = struct {
    ...
    /// resource tags, after the list of resource tags that was
...
pub const ListTagsForResourceOutput = struct {
    /// A token that indicates the location of the next resource tag in the array of
    /// resource tags, after the current requested list of resource
    /// tags.
    next_token: ?[]const u8 = null,
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTagsForResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AwsProton20200720.ListTagsForResource");
