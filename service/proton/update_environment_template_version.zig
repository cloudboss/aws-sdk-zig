...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateEnvironmentTemplateVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AwsProton20200720.UpdateEnvironmentTemplateVersion");
