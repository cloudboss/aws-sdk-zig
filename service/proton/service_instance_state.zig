...
pub const ServiceInstanceState = struct {
    ...
    /// instance.
    last_successful_component_deployment_ids: ?[]const []const u8 = null,

    /// The ID for the last successful environment deployed for this service
    /// instance.
    last_successful_environment_deployment_id: ?[]const u8 = null,

    /// The ID for the last successful service pipeline deployed for this service
    /// instance.
    last_successful_service_pipeline_deployment_id: ?[]const u8 = null,
