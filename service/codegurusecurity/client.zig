...
pub const Client = struct {
    ...
    pub fn createScan(self: *Self, allocator: std.mem.Allocator, input: create_scan.CreateScanInput, options: CallOptions) !create_scan.CreateScanOutput {
    ...
    pub fn getMetricsSummary(self: *Self, allocator: std.mem.Allocator, input: get_metrics_summary.GetMetricsSummaryInput, options: CallOptions) !get_metrics_summary.GetMetricsSummaryOutput {
        return get_metrics_summary.execute(self, allocator, input, options);
    }

    /// Returns details about a scan, including whether or not a scan has completed.
    pub fn getScan(self: *Self, allocator: std.mem.Allocator, input: get_scan.GetScanInput, options: CallOptions) !get_scan.GetScanOutput {
    ...
    /// range.
    pub fn listFindingsMetrics(self: *Self, allocator: std.mem.Allocator, input: list_findings_metrics.ListFindingsMetricsInput, options: CallOptions) !list_findings_metrics.ListFindingsMetricsOutput {
        return list_findings_metrics.execute(self, allocator, input, options);
    }

    /// Returns a list of all scans in an account. Does not return `EXPRESS` scans.
    pub fn listScans(self: *Self, allocator: std.mem.Allocator, input: list_scans.ListScansInput, options: CallOptions) !list_scans.ListScansOutput {
