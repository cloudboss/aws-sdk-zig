...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListScheduleGroupsInput, options: Options) !ListScheduleGroupsOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListScheduleGroupsOutput {
    var result: ListScheduleGroupsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListScheduleGroupsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
