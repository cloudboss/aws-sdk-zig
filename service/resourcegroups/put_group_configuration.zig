...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutGroupConfigurationInput, options: Options) !PutGroupConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutGroupConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutGroupConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
