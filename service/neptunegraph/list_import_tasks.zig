...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListImportTasksInput, options: CallOptions) !ListImportTasksOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListImportTasksInput, config: *aws.Config) !aws.http.Request {
