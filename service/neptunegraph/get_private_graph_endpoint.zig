...
pub const GetPrivateGraphEndpointInput = struct {
...
pub const GetPrivateGraphEndpointOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetPrivateGraphEndpointInput, options: CallOptions) !GetPrivateGraphEndpointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetPrivateGraphEndpointInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetPrivateGraphEndpointOutput {
    var result: GetPrivateGraphEndpointOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetPrivateGraphEndpointOutput, body, allocator);
    }
    _ = status;
    _ = headers;
