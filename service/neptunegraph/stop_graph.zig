...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopGraphInput, options: CallOptions) !StopGraphOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopGraphInput, config: *aws.Config) !aws.http.Request {
