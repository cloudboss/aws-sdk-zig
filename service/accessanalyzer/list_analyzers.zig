...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAnalyzersInput, options: CallOptions) !ListAnalyzersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAnalyzersInput, config: *aws.Config) !aws.http.Request {
