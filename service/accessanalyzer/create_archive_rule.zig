...
pub const CreateArchiveRuleInput = struct {
...
pub const CreateArchiveRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateArchiveRuleInput, options: CallOptions) !CreateArchiveRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateArchiveRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateArchiveRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateArchiveRuleOutput = .{};
