...
pub const UpdateArchiveRuleInput = struct {
...
pub const UpdateArchiveRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateArchiveRuleInput, options: CallOptions) !UpdateArchiveRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateArchiveRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateArchiveRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateArchiveRuleOutput = .{};
