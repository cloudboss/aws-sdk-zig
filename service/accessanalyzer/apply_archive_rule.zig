...
pub const ApplyArchiveRuleInput = struct {
...
pub const ApplyArchiveRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ApplyArchiveRuleInput, options: CallOptions) !ApplyArchiveRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ApplyArchiveRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ApplyArchiveRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ApplyArchiveRuleOutput = .{};
