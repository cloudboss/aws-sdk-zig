...
pub const GenerateFindingRecommendationInput = struct {
    /// The [ARN of the
...
pub const GenerateFindingRecommendationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GenerateFindingRecommendationInput, options: CallOptions) !GenerateFindingRecommendationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GenerateFindingRecommendationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GenerateFindingRecommendationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GenerateFindingRecommendationOutput = .{};
