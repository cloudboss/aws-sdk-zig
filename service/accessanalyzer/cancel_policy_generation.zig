...
pub const CancelPolicyGenerationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelPolicyGenerationInput, options: Options) !CancelPolicyGenerationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelPolicyGenerationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelPolicyGenerationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelPolicyGenerationOutput = .{};
