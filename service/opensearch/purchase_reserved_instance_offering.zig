...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PurchaseReservedInstanceOfferingInput, options: Options) !PurchaseReservedInstanceOfferingOutput {
