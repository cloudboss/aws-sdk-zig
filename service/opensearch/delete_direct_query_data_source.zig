...
pub const DeleteDirectQueryDataSourceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDirectQueryDataSourceInput, options: CallOptions) !DeleteDirectQueryDataSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDirectQueryDataSourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDirectQueryDataSourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
