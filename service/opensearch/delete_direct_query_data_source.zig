...
pub const DeleteDirectQueryDataSourceInput = struct {
...
const DeleteDirectQueryDataSourceOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDirectQueryDataSourceInput, options: Options) !DeleteDirectQueryDataSourceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDirectQueryDataSourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2021-01-01/opensearch/directQueryDataSource/");
    try path_buf.appendSlice(alloc, input.data_source_name);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDirectQueryDataSourceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDirectQueryDataSourceOutput = .{};
