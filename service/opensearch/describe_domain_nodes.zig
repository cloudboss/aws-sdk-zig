...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDomainNodesInput, options: CallOptions) !DescribeDomainNodesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDomainNodesInput, config: *aws.Config) !aws.http.Request {
