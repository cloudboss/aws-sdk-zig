...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInboundConnectionInput, options: CallOptions) !DeleteInboundConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteInboundConnectionInput, config: *aws.Config) !aws.http.Request {
