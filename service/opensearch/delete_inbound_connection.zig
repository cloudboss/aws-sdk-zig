...
pub const DeleteInboundConnectionInput = struct {
...
pub const DeleteInboundConnectionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInboundConnectionInput, options: Options) !DeleteInboundConnectionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteInboundConnectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteInboundConnectionOutput {
    var result: DeleteInboundConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteInboundConnectionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
