...
pub const DeregisterCapabilityInput = struct {
...
pub const DeregisterCapabilityOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterCapabilityInput, options: CallOptions) !DeregisterCapabilityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterCapabilityInput, config: *aws.Config) !aws.http.Request {
