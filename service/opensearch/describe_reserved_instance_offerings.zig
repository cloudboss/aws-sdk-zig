...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReservedInstanceOfferingsInput, options: CallOptions) !DescribeReservedInstanceOfferingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeReservedInstanceOfferingsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeReservedInstanceOfferingsOutput {
    var result: DescribeReservedInstanceOfferingsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeReservedInstanceOfferingsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
