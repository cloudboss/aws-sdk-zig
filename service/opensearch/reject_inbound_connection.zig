...
pub const RejectInboundConnectionInput = struct {
...
pub const RejectInboundConnectionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectInboundConnectionInput, options: CallOptions) !RejectInboundConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RejectInboundConnectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RejectInboundConnectionOutput {
    var result: RejectInboundConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(RejectInboundConnectionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
