...
pub const DeleteBackupVaultLockConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupVaultLockConfigurationInput, options: CallOptions) !DeleteBackupVaultLockConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBackupVaultLockConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBackupVaultLockConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
