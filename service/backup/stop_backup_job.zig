...
pub const StopBackupJobOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopBackupJobInput, options: CallOptions) !StopBackupJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopBackupJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopBackupJobOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
