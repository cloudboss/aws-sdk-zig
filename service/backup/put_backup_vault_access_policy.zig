...
pub const PutBackupVaultAccessPolicyInput = struct {
...
const PutBackupVaultAccessPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBackupVaultAccessPolicyInput, options: Options) !PutBackupVaultAccessPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutBackupVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutBackupVaultAccessPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutBackupVaultAccessPolicyOutput = .{};
