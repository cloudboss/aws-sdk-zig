...
pub const PutBackupVaultAccessPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBackupVaultAccessPolicyInput, options: CallOptions) !PutBackupVaultAccessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutBackupVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutBackupVaultAccessPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
