...
pub const DisassociateRecoveryPointInput = struct {
...
pub const DisassociateRecoveryPointOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateRecoveryPointInput, options: CallOptions) !DisassociateRecoveryPointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateRecoveryPointInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateRecoveryPointOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateRecoveryPointOutput = .{};
