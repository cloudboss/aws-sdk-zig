...
pub const DeleteBackupVaultAccessPolicyInput = struct {
...
const DeleteBackupVaultAccessPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupVaultAccessPolicyInput, options: Options) !DeleteBackupVaultAccessPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBackupVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBackupVaultAccessPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBackupVaultAccessPolicyOutput = .{};
