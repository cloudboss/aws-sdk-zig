...
pub const DeleteBackupVaultAccessPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupVaultAccessPolicyInput, options: CallOptions) !DeleteBackupVaultAccessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBackupVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBackupVaultAccessPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
