...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRecoveryPointsByResourceInput, options: CallOptions) !ListRecoveryPointsByResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRecoveryPointsByResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.managed_by_aws_backup_only) |v| {
        ...
        try query_buf.appendSlice(allocator, "managedByAWSBackupOnly=");
