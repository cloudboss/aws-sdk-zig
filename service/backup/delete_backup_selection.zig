...
pub const DeleteBackupSelectionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupSelectionInput, options: CallOptions) !DeleteBackupSelectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBackupSelectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBackupSelectionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
