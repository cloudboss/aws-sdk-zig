...
pub const DeleteBackupSelectionInput = struct {
...
const DeleteBackupSelectionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupSelectionInput, options: Options) !DeleteBackupSelectionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBackupSelectionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.selection_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBackupSelectionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBackupSelectionOutput = .{};
