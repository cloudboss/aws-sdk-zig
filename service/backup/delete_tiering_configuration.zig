...
pub const DeleteTieringConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTieringConfigurationInput, options: Options) !DeleteTieringConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTieringConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTieringConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTieringConfigurationOutput = .{};
