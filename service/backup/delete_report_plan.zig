...
pub const DeleteReportPlanInput = struct {
...
pub const DeleteReportPlanOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReportPlanInput, options: CallOptions) !DeleteReportPlanOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteReportPlanInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteReportPlanOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteReportPlanOutput = .{};
