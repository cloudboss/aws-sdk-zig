...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReportPlanInput, options: CallOptions) !DescribeReportPlanOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeReportPlanInput, config: *aws.Config) !aws.http.Request {
