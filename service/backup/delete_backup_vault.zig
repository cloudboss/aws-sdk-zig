...
pub const DeleteBackupVaultInput = struct {
...
pub const DeleteBackupVaultOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupVaultInput, options: CallOptions) !DeleteBackupVaultOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBackupVaultInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBackupVaultOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBackupVaultOutput = .{};
