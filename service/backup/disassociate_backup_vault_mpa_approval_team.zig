...
pub const DisassociateBackupVaultMpaApprovalTeamInput = struct {
...
const DisassociateBackupVaultMpaApprovalTeamOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateBackupVaultMpaApprovalTeamInput, options: Options) !DisassociateBackupVaultMpaApprovalTeamOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateBackupVaultMpaApprovalTeamInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateBackupVaultMpaApprovalTeamOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateBackupVaultMpaApprovalTeamOutput = .{};
