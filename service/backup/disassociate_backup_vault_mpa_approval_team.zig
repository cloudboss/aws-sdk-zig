...
pub const DisassociateBackupVaultMpaApprovalTeamOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateBackupVaultMpaApprovalTeamInput, options: CallOptions) !DisassociateBackupVaultMpaApprovalTeamOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateBackupVaultMpaApprovalTeamInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateBackupVaultMpaApprovalTeamOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
