...
pub const DeleteRestoreTestingPlanOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRestoreTestingPlanInput, options: CallOptions) !DeleteRestoreTestingPlanOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRestoreTestingPlanInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRestoreTestingPlanOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
