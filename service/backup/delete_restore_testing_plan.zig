...
pub const DeleteRestoreTestingPlanInput = struct {
...
const DeleteRestoreTestingPlanOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRestoreTestingPlanInput, options: Options) !DeleteRestoreTestingPlanOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteRestoreTestingPlanInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteRestoreTestingPlanOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRestoreTestingPlanOutput = .{};
