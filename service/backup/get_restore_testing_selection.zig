...
const RestoreTestingSelectionForGet = @import("restore_testing_selection_for_get.zig").RestoreTestingSelectionForGet;

pub const GetRestoreTestingSelectionInput = struct {
...
pub const GetRestoreTestingSelectionOutput = struct {
    /// Unique name of the restore testing selection.
    restore_testing_selection: ?RestoreTestingSelectionForGet = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRestoreTestingSelectionInput, options: CallOptions) !GetRestoreTestingSelectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetRestoreTestingSelectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetRestoreTestingSelectionOutput {
    var result: GetRestoreTestingSelectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetRestoreTestingSelectionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
