...
pub const DeleteBackupVaultNotificationsInput = struct {
...
pub const DeleteBackupVaultNotificationsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBackupVaultNotificationsInput, options: CallOptions) !DeleteBackupVaultNotificationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBackupVaultNotificationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBackupVaultNotificationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBackupVaultNotificationsOutput = .{};
