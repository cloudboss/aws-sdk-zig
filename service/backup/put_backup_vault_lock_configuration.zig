...
fn serializeRequest(alloc: std.mem.Allocator, input: PutBackupVaultLockConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.changeable_for_days) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"ChangeableForDays\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutBackupVaultLockConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
