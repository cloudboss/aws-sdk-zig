...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRecoveryPointsByBackupVaultInput, options: CallOptions) !ListRecoveryPointsByBackupVaultOutput {
