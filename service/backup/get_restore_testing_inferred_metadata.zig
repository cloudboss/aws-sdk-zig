...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRestoreTestingInferredMetadataInput, options: Options) !GetRestoreTestingInferredMetadataOutput {
