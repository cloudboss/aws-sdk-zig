...
pub const ListBackupPlanVersionsInput = struct {
...
pub const ListBackupPlanVersionsOutput = struct {
    /// An array of version list items containing metadata about your backup plans.
    backup_plan_versions_list: ?[]const BackupPlansListMember = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBackupPlanVersionsInput, options: CallOptions) !ListBackupPlanVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBackupPlanVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListBackupPlanVersionsOutput {
    var result: ListBackupPlanVersionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListBackupPlanVersionsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
