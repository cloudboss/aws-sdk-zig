...
pub const DeleteFrameworkOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFrameworkInput, options: CallOptions) !DeleteFrameworkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFrameworkInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFrameworkOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
