...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRecoveryPointLifecycleInput, options: CallOptions) !UpdateRecoveryPointLifecycleOutput {
