...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListProtectedResourcesByBackupVaultInput, options: Options) !ListProtectedResourcesByBackupVaultOutput {
