...
pub const DisassociateRecoveryPointFromParentInput = struct {
...
const DisassociateRecoveryPointFromParentOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateRecoveryPointFromParentInput, options: Options) !DisassociateRecoveryPointFromParentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateRecoveryPointFromParentInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/parentAssociation");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateRecoveryPointFromParentOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateRecoveryPointFromParentOutput = .{};
