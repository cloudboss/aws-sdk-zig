...
pub const DeleteRecoveryPointOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRecoveryPointInput, options: CallOptions) !DeleteRecoveryPointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRecoveryPointInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRecoveryPointOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
