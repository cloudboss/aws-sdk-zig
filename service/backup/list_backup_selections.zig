...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBackupSelectionsInput, options: CallOptions) !ListBackupSelectionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBackupSelectionsInput, config: *aws.Config) !aws.http.Request {
