...
pub const Client = struct {
    ...
    pub fn createParallelData(self: *Self, allocator: std.mem.Allocator, input: create_parallel_data.CreateParallelDataInput, options: CallOptions) !create_parallel_data.CreateParallelDataOutput {
        return create_parallel_data.execute(self, allocator, input, options);
    }

    /// Deletes a parallel data resource in Amazon Translate.
    pub fn deleteParallelData(self: *Self, allocator: std.mem.Allocator, input: delete_parallel_data.DeleteParallelDataInput, options: CallOptions) !delete_parallel_data.DeleteParallelDataOutput {
        return delete_parallel_data.execute(self, allocator, input, options);
    }

    /// A synchronous action that deletes a custom terminology.
    pub fn deleteTerminology(self: *Self, allocator: std.mem.Allocator, input: delete_terminology.DeleteTerminologyInput, options: CallOptions) !delete_terminology.DeleteTerminologyOutput {
    ...
    pub fn describeTextTranslationJob(self: *Self, allocator: std.mem.Allocator, input: describe_text_translation_job.DescribeTextTranslationJobInput, options: CallOptions) !describe_text_translation_job.DescribeTextTranslationJobOutput {
        return describe_text_translation_job.execute(self, allocator, input, options);
    }

    /// Provides information about a parallel data resource.
    pub fn getParallelData(self: *Self, allocator: std.mem.Allocator, input: get_parallel_data.GetParallelDataInput, options: CallOptions) !get_parallel_data.GetParallelDataOutput {
        return get_parallel_data.execute(self, allocator, input, options);
    }

    /// Retrieves a custom terminology.
    pub fn getTerminology(self: *Self, allocator: std.mem.Allocator, input: get_terminology.GetTerminologyInput, options: CallOptions) !get_terminology.GetTerminologyOutput {
    ...
    /// the new
    /// terminology.
    pub fn importTerminology(self: *Self, allocator: std.mem.Allocator, input: import_terminology.ImportTerminologyInput, options: CallOptions) !import_terminology.ImportTerminologyOutput {
    ...
    /// Translate supports.
    pub fn listLanguages(self: *Self, allocator: std.mem.Allocator, input: list_languages.ListLanguagesInput, options: CallOptions) !list_languages.ListLanguagesOutput {
        return list_languages.execute(self, allocator, input, options);
    }

    /// Provides a list of your parallel data resources in Amazon Translate.
    pub fn listParallelData(self: *Self, allocator: std.mem.Allocator, input: list_parallel_data.ListParallelDataInput, options: CallOptions) !list_parallel_data.ListParallelDataOutput {
    ...
    pub fn listTerminologies(self: *Self, allocator: std.mem.Allocator, input: list_terminologies.ListTerminologiesInput, options: CallOptions) !list_terminologies.ListTerminologiesOutput {
        return list_terminologies.execute(self, allocator, input, options);
    }

    /// Gets a list of the batch translation jobs that you have submitted.
    pub fn listTextTranslationJobs(self: *Self, allocator: std.mem.Allocator, input: list_text_translation_jobs.ListTextTranslationJobsInput, options: CallOptions) !list_text_translation_jobs.ListTextTranslationJobsOutput {
    ...
    pub fn startTextTranslationJob(self: *Self, allocator: std.mem.Allocator, input: start_text_translation_job.StartTextTranslationJobInput, options: CallOptions) !start_text_translation_job.StartTextTranslationJobOutput {
    ...
    pub fn stopTextTranslationJob(self: *Self, allocator: std.mem.Allocator, input: stop_text_translation_job.StopTextTranslationJobInput, options: CallOptions) !stop_text_translation_job.StopTextTranslationJobOutput {
    ...
    pub fn translateDocument(self: *Self, allocator: std.mem.Allocator, input: translate_document.TranslateDocumentInput, options: CallOptions) !translate_document.TranslateDocumentOutput {
    ...
    pub fn translateText(self: *Self, allocator: std.mem.Allocator, input: translate_text.TranslateTextInput, options: CallOptions) !translate_text.TranslateTextOutput {
    ...
    /// file from
    /// Amazon S3.
    pub fn updateParallelData(self: *Self, allocator: std.mem.Allocator, input: update_parallel_data.UpdateParallelDataInput, options: CallOptions) !update_parallel_data.UpdateParallelDataOutput {
