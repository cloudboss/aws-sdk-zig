...
pub const UpdateServiceSettingsInput = struct {
    ...
    enabled_discovery_source_regions: ?[]const []const u8 = null,
    ...
    pub const json_field_names = .{
        ...
        .enabled_discovery_source_regions = "EnabledDiscoverySourceRegions",
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateServiceSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSLicenseManager.UpdateServiceSettings");
