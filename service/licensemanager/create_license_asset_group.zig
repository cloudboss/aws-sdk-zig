...
pub const CreateLicenseAssetGroupInput = struct {
...
pub const CreateLicenseAssetGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateLicenseAssetGroupInput, options: CallOptions) !CreateLicenseAssetGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateLicenseAssetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSLicenseManager.CreateLicenseAssetGroup");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateLicenseAssetGroupOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(CreateLicenseAssetGroupOutput, body, allocator);
}
