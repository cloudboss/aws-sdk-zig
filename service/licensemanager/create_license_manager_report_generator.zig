...
pub const CreateLicenseManagerReportGeneratorInput = struct {
...
pub const CreateLicenseManagerReportGeneratorOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateLicenseManagerReportGeneratorInput, options: CallOptions) !CreateLicenseManagerReportGeneratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateLicenseManagerReportGeneratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSLicenseManager.CreateLicenseManagerReportGenerator");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateLicenseManagerReportGeneratorOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreateLicenseManagerReportGeneratorOutput, body, allocator);
}
