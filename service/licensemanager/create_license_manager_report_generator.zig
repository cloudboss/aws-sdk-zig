...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateLicenseManagerReportGeneratorInput, options: Options) !CreateLicenseManagerReportGeneratorOutput {
