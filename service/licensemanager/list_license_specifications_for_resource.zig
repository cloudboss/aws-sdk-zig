...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLicenseSpecificationsForResourceInput, options: Options) !ListLicenseSpecificationsForResourceOutput {
