...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListUsageForLicenseConfigurationInput, options: Options) !ListUsageForLicenseConfigurationOutput {
