...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateLicenseSpecificationsForResourceInput, options: Options) !UpdateLicenseSpecificationsForResourceOutput {
