...
pub const UpdateLicenseSpecificationsForResourceInput = struct {
    /// ARNs of the license configurations to add.
    add_license_specifications: ?[]const LicenseSpecification = null,

    /// ARNs of the license configurations to remove.
    remove_license_specifications: ?[]const LicenseSpecification = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateLicenseSpecificationsForResourceInput, options: CallOptions) !UpdateLicenseSpecificationsForResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateLicenseSpecificationsForResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSLicenseManager.UpdateLicenseSpecificationsForResource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateLicenseSpecificationsForResourceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
