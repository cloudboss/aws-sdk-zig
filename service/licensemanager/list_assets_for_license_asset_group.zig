...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssetsForLicenseAssetGroupInput, options: Options) !ListAssetsForLicenseAssetGroupOutput {
