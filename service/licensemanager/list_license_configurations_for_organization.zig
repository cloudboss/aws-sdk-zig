...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLicenseConfigurationsForOrganizationInput, options: Options) !ListLicenseConfigurationsForOrganizationOutput {
