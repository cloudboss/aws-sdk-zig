...
const LicenseConversionTask = @import("license_conversion_task.zig").LicenseConversionTask;

pub const ListLicenseConversionTasksInput = struct {
...
pub const ListLicenseConversionTasksOutput = struct {
    /// Information about the license configuration tasks for your account.
    license_conversion_tasks: ?[]const LicenseConversionTask = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLicenseConversionTasksInput, options: CallOptions) !ListLicenseConversionTasksOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListLicenseConversionTasksInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSLicenseManager.ListLicenseConversionTasks");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListLicenseConversionTasksOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListLicenseConversionTasksOutput, body, allocator);
}
