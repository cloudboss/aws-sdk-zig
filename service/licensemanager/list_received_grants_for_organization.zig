...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListReceivedGrantsForOrganizationInput, options: Options) !ListReceivedGrantsForOrganizationOutput {
