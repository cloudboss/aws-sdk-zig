...
pub const DeleteLicenseManagerReportGeneratorInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLicenseManagerReportGeneratorInput, options: Options) !DeleteLicenseManagerReportGeneratorOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLicenseManagerReportGeneratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSLicenseManager.DeleteLicenseManagerReportGenerator");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLicenseManagerReportGeneratorOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
