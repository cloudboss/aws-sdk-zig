...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConfiguredAudienceModelAssociationsInput, options: CallOptions) !ListConfiguredAudienceModelAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListConfiguredAudienceModelAssociationsInput, config: *aws.Config) !aws.http.Request {
