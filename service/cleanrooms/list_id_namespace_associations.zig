...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListIdNamespaceAssociationsInput, options: CallOptions) !ListIdNamespaceAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListIdNamespaceAssociationsInput, config: *aws.Config) !aws.http.Request {
