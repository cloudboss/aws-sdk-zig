...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfiguredTableAnalysisRuleInput, options: Options) !DeleteConfiguredTableAnalysisRuleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConfiguredTableAnalysisRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConfiguredTableAnalysisRuleOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
