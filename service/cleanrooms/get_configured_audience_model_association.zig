...
pub const GetConfiguredAudienceModelAssociationInput = struct {
...
pub const GetConfiguredAudienceModelAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConfiguredAudienceModelAssociationInput, options: CallOptions) !GetConfiguredAudienceModelAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetConfiguredAudienceModelAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetConfiguredAudienceModelAssociationOutput {
    var result: GetConfiguredAudienceModelAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetConfiguredAudienceModelAssociationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
