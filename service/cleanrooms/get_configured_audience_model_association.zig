...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConfiguredAudienceModelAssociationInput, options: Options) !GetConfiguredAudienceModelAssociationOutput {
