...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateConfiguredTableAssociationAnalysisRuleInput, options: Options) !UpdateConfiguredTableAssociationAnalysisRuleOutput {
