...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAnalysisTemplateInput, options: CallOptions) !DeleteAnalysisTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAnalysisTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAnalysisTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
