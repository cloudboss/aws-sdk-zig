...
pub const DeleteConfiguredAudienceModelAssociationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfiguredAudienceModelAssociationInput, options: Options) !DeleteConfiguredAudienceModelAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConfiguredAudienceModelAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConfiguredAudienceModelAssociationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteConfiguredAudienceModelAssociationOutput = .{};
