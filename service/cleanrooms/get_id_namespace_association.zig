...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIdNamespaceAssociationInput, options: CallOptions) !GetIdNamespaceAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetIdNamespaceAssociationInput, config: *aws.Config) !aws.http.Request {
