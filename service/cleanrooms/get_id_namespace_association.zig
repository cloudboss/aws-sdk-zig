...
pub const GetIdNamespaceAssociationInput = struct {
...
pub const GetIdNamespaceAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIdNamespaceAssociationInput, options: Options) !GetIdNamespaceAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetIdNamespaceAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetIdNamespaceAssociationOutput {
    var result: GetIdNamespaceAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetIdNamespaceAssociationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
