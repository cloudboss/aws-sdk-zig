...
pub const DeletePrivacyBudgetTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePrivacyBudgetTemplateInput, options: Options) !DeletePrivacyBudgetTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePrivacyBudgetTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePrivacyBudgetTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePrivacyBudgetTemplateOutput = .{};
