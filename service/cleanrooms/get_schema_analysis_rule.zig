...
pub const GetSchemaAnalysisRuleInput = struct {
...
pub const GetSchemaAnalysisRuleOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSchemaAnalysisRuleInput, options: CallOptions) !GetSchemaAnalysisRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSchemaAnalysisRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSchemaAnalysisRuleOutput {
    var result: GetSchemaAnalysisRuleOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetSchemaAnalysisRuleOutput, body, allocator);
    }
    _ = status;
    _ = headers;
