...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCollaborationIdNamespaceAssociationsInput, options: CallOptions) !ListCollaborationIdNamespaceAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCollaborationIdNamespaceAssociationsInput, config: *aws.Config) !aws.http.Request {
