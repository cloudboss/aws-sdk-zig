...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetProtectedQueryInput, options: CallOptions) !GetProtectedQueryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetProtectedQueryInput, config: *aws.Config) !aws.http.Request {
