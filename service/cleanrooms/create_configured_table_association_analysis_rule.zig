...
pub const CreateConfiguredTableAssociationAnalysisRuleInput = struct {
...
pub const CreateConfiguredTableAssociationAnalysisRuleOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateConfiguredTableAssociationAnalysisRuleInput, options: Options) !CreateConfiguredTableAssociationAnalysisRuleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateConfiguredTableAssociationAnalysisRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateConfiguredTableAssociationAnalysisRuleOutput {
    var result: CreateConfiguredTableAssociationAnalysisRuleOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateConfiguredTableAssociationAnalysisRuleOutput, body, alloc);
    }
    _ = status;
    _ = headers;
