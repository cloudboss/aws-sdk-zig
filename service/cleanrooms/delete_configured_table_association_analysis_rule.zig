...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfiguredTableAssociationAnalysisRuleInput, options: Options) !DeleteConfiguredTableAssociationAnalysisRuleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConfiguredTableAssociationAnalysisRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConfiguredTableAssociationAnalysisRuleOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
