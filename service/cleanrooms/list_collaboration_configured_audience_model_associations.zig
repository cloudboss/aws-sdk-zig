...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCollaborationConfiguredAudienceModelAssociationsInput, options: CallOptions) !ListCollaborationConfiguredAudienceModelAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCollaborationConfiguredAudienceModelAssociationsInput, config: *aws.Config) !aws.http.Request {
