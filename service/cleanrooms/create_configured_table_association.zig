...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateConfiguredTableAssociationInput, options: CallOptions) !CreateConfiguredTableAssociationOutput {
