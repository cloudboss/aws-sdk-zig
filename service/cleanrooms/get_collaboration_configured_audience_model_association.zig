...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCollaborationConfiguredAudienceModelAssociationInput, options: Options) !GetCollaborationConfiguredAudienceModelAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCollaborationConfiguredAudienceModelAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetCollaborationConfiguredAudienceModelAssociationOutput {
    var result: GetCollaborationConfiguredAudienceModelAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetCollaborationConfiguredAudienceModelAssociationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
