...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCollaborationPrivacyBudgetTemplatesInput, options: Options) !ListCollaborationPrivacyBudgetTemplatesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListCollaborationPrivacyBudgetTemplatesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListCollaborationPrivacyBudgetTemplatesOutput {
    var result: ListCollaborationPrivacyBudgetTemplatesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListCollaborationPrivacyBudgetTemplatesOutput, body, alloc);
    }
    _ = status;
    _ = headers;
