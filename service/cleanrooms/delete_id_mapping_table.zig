...
pub const DeleteIdMappingTableInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdMappingTableInput, options: Options) !DeleteIdMappingTableOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIdMappingTableInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIdMappingTableOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteIdMappingTableOutput = .{};
