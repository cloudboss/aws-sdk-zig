...
pub const DeleteIdNamespaceAssociationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdNamespaceAssociationInput, options: Options) !DeleteIdNamespaceAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIdNamespaceAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIdNamespaceAssociationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteIdNamespaceAssociationOutput = .{};
