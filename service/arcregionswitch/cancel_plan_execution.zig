...
pub const CancelPlanExecutionInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelPlanExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ArcRegionSwitch.CancelPlanExecution");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelPlanExecutionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
