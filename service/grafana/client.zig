...
pub const Client = struct {
    ...
    /// use `ENTERPRISE` for the `licenseType`, and pass in a valid Grafana Labs
    /// token for the `grafanaToken`. Upgrading to Grafana Enterprise incurs
    /// additional fees. For more information, see [Upgrade a workspace to Grafana
    ...
    /// [https://docs.aws.amazon.com/grafana/latest/userguide/Using-Grafana-APIs.html](https://docs.aws.amazon.com/grafana/latest/userguide/Using-Grafana-APIs.html) for available APIs and example requests.
    ///
    ...
    /// accounts](https://docs.aws.amazon.com/grafana/latest/userguide/service-accounts.html) in the *Amazon Managed Grafana User Guide*.
    ///
    ...
    /// API operations for the given [workspace service
    /// account](https://docs.aws.amazon.com/grafana/latest/userguide/service-accounts.html). The service account acts as a user for the API operations, and defines the permissions that are used by the API.
    ///
    ...
    /// in this workspace. If you use this operation without specifying `userId` or
    ...
    /// SAML or IAM Identity Center, use
