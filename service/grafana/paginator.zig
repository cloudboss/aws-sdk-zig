...
pub const ListWorkspaceServiceAccountTokensPaginator = struct {
    client: *Client,
    params: list_workspace_service_account_tokens.ListWorkspaceServiceAccountTokensInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_workspace_service_account_tokens.ListWorkspaceServiceAccountTokensOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_workspace_service_account_tokens.execute(self.client, allocator, self.params, options);
...
pub const ListWorkspaceServiceAccountsPaginator = struct {
    client: *Client,
    params: list_workspace_service_accounts.ListWorkspaceServiceAccountsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_workspace_service_accounts.ListWorkspaceServiceAccountsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_workspace_service_accounts.execute(self.client, allocator, self.params, options);
