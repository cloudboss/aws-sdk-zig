...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeWorkspaceAuthenticationInput, options: CallOptions) !DescribeWorkspaceAuthenticationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeWorkspaceAuthenticationInput, config: *aws.Config) !aws.http.Request {
