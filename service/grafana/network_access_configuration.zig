...
pub const NetworkAccessConfiguration = struct {
    ...
    /// managed prefix
    /// lists](https://docs.aws.amazon.com/vpc/latest/userguide/managed-prefix-lists.html)in the *Amazon Virtual Private Cloud User Guide*.
    ...
    /// [Interface VPC
    /// endpoints](https://docs.aws.amazon.com/grafana/latest/userguide/VPC-endpoints) in the *Amazon Managed Grafana User Guide*.
    ///
