...
pub const ListAccessSourcesPaginator = struct {
    client: *Client,
    params: list_access_sources.ListAccessSourcesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_access_sources.ListAccessSourcesOutput {
        if (self.done) {
...
pub const ListDNSViewsPaginator = struct {
    client: *Client,
    params: list_dns_views.ListDNSViewsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_dns_views.ListDNSViewsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListGlobalResolversPaginator = struct {
    client: *Client,
    params: list_global_resolvers.ListGlobalResolversInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_global_resolvers.ListGlobalResolversOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListHostedZoneAssociationsPaginator = struct {
    client: *Client,
    params: list_hosted_zone_associations.ListHostedZoneAssociationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_hosted_zone_associations.ListHostedZoneAssociationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListManagedFirewallDomainListsPaginator = struct {
    client: *Client,
    params: list_managed_firewall_domain_lists.ListManagedFirewallDomainListsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_managed_firewall_domain_lists.ListManagedFirewallDomainListsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
