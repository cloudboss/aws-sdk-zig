...
pub const Client = struct {
    ...
    pub fn associateHostedZone(self: *Self, allocator: std.mem.Allocator, input: associate_hosted_zone.AssociateHostedZoneInput, options: CallOptions) !associate_hosted_zone.AssociateHostedZoneOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn createAccessSource(self: *Self, allocator: std.mem.Allocator, input: create_access_source.CreateAccessSourceInput, options: CallOptions) !create_access_source.CreateAccessSourceOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn createDnsView(self: *Self, allocator: std.mem.Allocator, input: create_dns_view.CreateDNSViewInput, options: CallOptions) !create_dns_view.CreateDNSViewOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn createFirewallDomainList(self: *Self, allocator: std.mem.Allocator, input: create_firewall_domain_list.CreateFirewallDomainListInput, options: CallOptions) !create_firewall_domain_list.CreateFirewallDomainListOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn createGlobalResolver(self: *Self, allocator: std.mem.Allocator, input: create_global_resolver.CreateGlobalResolverInput, options: CallOptions) !create_global_resolver.CreateGlobalResolverOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn deleteAccessSource(self: *Self, allocator: std.mem.Allocator, input: delete_access_source.DeleteAccessSourceInput, options: CallOptions) !delete_access_source.DeleteAccessSourceOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn deleteDnsView(self: *Self, allocator: std.mem.Allocator, input: delete_dns_view.DeleteDNSViewInput, options: CallOptions) !delete_dns_view.DeleteDNSViewOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn deleteFirewallDomainList(self: *Self, allocator: std.mem.Allocator, input: delete_firewall_domain_list.DeleteFirewallDomainListInput, options: CallOptions) !delete_firewall_domain_list.DeleteFirewallDomainListOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn deleteGlobalResolver(self: *Self, allocator: std.mem.Allocator, input: delete_global_resolver.DeleteGlobalResolverInput, options: CallOptions) !delete_global_resolver.DeleteGlobalResolverOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn disableDnsView(self: *Self, allocator: std.mem.Allocator, input: disable_dns_view.DisableDNSViewInput, options: CallOptions) !disable_dns_view.DisableDNSViewOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn disassociateHostedZone(self: *Self, allocator: std.mem.Allocator, input: disassociate_hosted_zone.DisassociateHostedZoneInput, options: CallOptions) !disassociate_hosted_zone.DisassociateHostedZoneOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn enableDnsView(self: *Self, allocator: std.mem.Allocator, input: enable_dns_view.EnableDNSViewInput, options: CallOptions) !enable_dns_view.EnableDNSViewOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getAccessSource(self: *Self, allocator: std.mem.Allocator, input: get_access_source.GetAccessSourceInput, options: CallOptions) !get_access_source.GetAccessSourceOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getDnsView(self: *Self, allocator: std.mem.Allocator, input: get_dns_view.GetDNSViewInput, options: CallOptions) !get_dns_view.GetDNSViewOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getFirewallDomainList(self: *Self, allocator: std.mem.Allocator, input: get_firewall_domain_list.GetFirewallDomainListInput, options: CallOptions) !get_firewall_domain_list.GetFirewallDomainListOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getFirewallRule(self: *Self, allocator: std.mem.Allocator, input: get_firewall_rule.GetFirewallRuleInput, options: CallOptions) !get_firewall_rule.GetFirewallRuleOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getGlobalResolver(self: *Self, allocator: std.mem.Allocator, input: get_global_resolver.GetGlobalResolverInput, options: CallOptions) !get_global_resolver.GetGlobalResolverOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getHostedZoneAssociation(self: *Self, allocator: std.mem.Allocator, input: get_hosted_zone_association.GetHostedZoneAssociationInput, options: CallOptions) !get_hosted_zone_association.GetHostedZoneAssociationOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn getManagedFirewallDomainList(self: *Self, allocator: std.mem.Allocator, input: get_managed_firewall_domain_list.GetManagedFirewallDomainListInput, options: CallOptions) !get_managed_firewall_domain_list.GetManagedFirewallDomainListOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn importFirewallDomains(self: *Self, allocator: std.mem.Allocator, input: import_firewall_domains.ImportFirewallDomainsInput, options: CallOptions) !import_firewall_domains.ImportFirewallDomainsOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn listAccessSources(self: *Self, allocator: std.mem.Allocator, input: list_access_sources.ListAccessSourcesInput, options: CallOptions) !list_access_sources.ListAccessSourcesOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn listDnsViews(self: *Self, allocator: std.mem.Allocator, input: list_dns_views.ListDNSViewsInput, options: CallOptions) !list_dns_views.ListDNSViewsOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn listFirewallDomainLists(self: *Self, allocator: std.mem.Allocator, input: list_firewall_domain_lists.ListFirewallDomainListsInput, options: CallOptions) !list_firewall_domain_lists.ListFirewallDomainListsOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn listFirewallDomains(self: *Self, allocator: std.mem.Allocator, input: list_firewall_domains.ListFirewallDomainsInput, options: CallOptions) !list_firewall_domains.ListFirewallDomainsOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn listGlobalResolvers(self: *Self, allocator: std.mem.Allocator, input: list_global_resolvers.ListGlobalResolversInput, options: CallOptions) !list_global_resolvers.ListGlobalResolversOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn listHostedZoneAssociations(self: *Self, allocator: std.mem.Allocator, input: list_hosted_zone_associations.ListHostedZoneAssociationsInput, options: CallOptions) !list_hosted_zone_associations.ListHostedZoneAssociationsOutput {
    ...
    /// the categories for DNS Firewall. The categories are either `THREAT` or
    /// `CONTENT`.
    ///
    /// Route 53 Global Resolver is a global service that supports resolvers in
    /// multiple Amazon Web Services Regions but you must specify the US East (Ohio)
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn updateAccessSource(self: *Self, allocator: std.mem.Allocator, input: update_access_source.UpdateAccessSourceInput, options: CallOptions) !update_access_source.UpdateAccessSourceOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn updateAccessToken(self: *Self, allocator: std.mem.Allocator, input: update_access_token.UpdateAccessTokenInput, options: CallOptions) !update_access_token.UpdateAccessTokenOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn updateDnsView(self: *Self, allocator: std.mem.Allocator, input: update_dns_view.UpdateDNSViewInput, options: CallOptions) !update_dns_view.UpdateDNSViewOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn updateFirewallDomains(self: *Self, allocator: std.mem.Allocator, input: update_firewall_domains.UpdateFirewallDomainsInput, options: CallOptions) !update_firewall_domains.UpdateFirewallDomainsOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn updateGlobalResolver(self: *Self, allocator: std.mem.Allocator, input: update_global_resolver.UpdateGlobalResolverInput, options: CallOptions) !update_global_resolver.UpdateGlobalResolverOutput {
    ...
    /// resources. That is, for example, specify `--region us-east-2` on Amazon Web
    /// Services CLI commands.
    pub fn updateHostedZoneAssociation(self: *Self, allocator: std.mem.Allocator, input: update_hosted_zone_association.UpdateHostedZoneAssociationInput, options: CallOptions) !update_hosted_zone_association.UpdateHostedZoneAssociationOutput {
