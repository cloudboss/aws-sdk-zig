...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAccessTokensInput, options: CallOptions) !ListAccessTokensOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAccessTokensInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/tokens/dns-view/");
