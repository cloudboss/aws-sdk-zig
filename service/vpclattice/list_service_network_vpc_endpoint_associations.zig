...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListServiceNetworkVpcEndpointAssociationsInput, options: CallOptions) !ListServiceNetworkVpcEndpointAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListServiceNetworkVpcEndpointAssociationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(allocator, &query_buf, input.service_network_identifier);
    query_has_prev = true;
