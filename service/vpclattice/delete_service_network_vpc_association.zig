...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServiceNetworkVpcAssociationInput, options: CallOptions) !DeleteServiceNetworkVpcAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteServiceNetworkVpcAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteServiceNetworkVpcAssociationOutput {
    var result: DeleteServiceNetworkVpcAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteServiceNetworkVpcAssociationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
