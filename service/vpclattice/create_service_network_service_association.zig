...
pub const CreateServiceNetworkServiceAssociationInput = struct {
...
pub const CreateServiceNetworkServiceAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateServiceNetworkServiceAssociationInput, options: Options) !CreateServiceNetworkServiceAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateServiceNetworkServiceAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateServiceNetworkServiceAssociationOutput {
    var result: CreateServiceNetworkServiceAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateServiceNetworkServiceAssociationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
