...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateServiceNetworkServiceAssociationInput, options: CallOptions) !CreateServiceNetworkServiceAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateServiceNetworkServiceAssociationInput, config: *aws.Config) !aws.http.Request {
