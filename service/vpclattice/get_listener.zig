...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetListenerInput, options: CallOptions) !GetListenerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetListenerInput, config: *aws.Config) !aws.http.Request {
