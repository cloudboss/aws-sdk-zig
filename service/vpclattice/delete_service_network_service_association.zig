...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServiceNetworkServiceAssociationInput, options: CallOptions) !DeleteServiceNetworkServiceAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteServiceNetworkServiceAssociationInput, config: *aws.Config) !aws.http.Request {
