...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteResourceGatewayInput, options: CallOptions) !DeleteResourceGatewayOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteResourceGatewayInput, config: *aws.Config) !aws.http.Request {
