...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResourceGatewaysInput, options: CallOptions) !ListResourceGatewaysOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListResourceGatewaysInput, config: *aws.Config) !aws.http.Request {
