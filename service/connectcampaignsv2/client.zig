...
pub const Client = struct {
    ...
    pub fn deleteCampaignChannelSubtypeConfig(self: *Self, allocator: std.mem.Allocator, input: delete_campaign_channel_subtype_config.DeleteCampaignChannelSubtypeConfigInput, options: delete_campaign_channel_subtype_config.Options) !delete_campaign_channel_subtype_config.DeleteCampaignChannelSubtypeConfigOutput {
    ...
    /// idempotent.
    pub fn deleteCampaignCommunicationLimits(self: *Self, allocator: std.mem.Allocator, input: delete_campaign_communication_limits.DeleteCampaignCommunicationLimitsInput, options: delete_campaign_communication_limits.Options) !delete_campaign_communication_limits.DeleteCampaignCommunicationLimitsOutput {
    ...
    /// idempotent.
    pub fn deleteCampaignCommunicationTime(self: *Self, allocator: std.mem.Allocator, input: delete_campaign_communication_time.DeleteCampaignCommunicationTimeInput, options: delete_campaign_communication_time.Options) !delete_campaign_communication_time.DeleteCampaignCommunicationTimeOutput {
    ...
    pub fn deleteConnectInstanceIntegration(self: *Self, allocator: std.mem.Allocator, input: delete_connect_instance_integration.DeleteConnectInstanceIntegrationInput, options: delete_connect_instance_integration.Options) !delete_connect_instance_integration.DeleteConnectInstanceIntegrationOutput {
    ...
    pub fn getInstanceCommunicationLimits(self: *Self, allocator: std.mem.Allocator, input: get_instance_communication_limits.GetInstanceCommunicationLimitsInput, options: get_instance_communication_limits.Options) !get_instance_communication_limits.GetInstanceCommunicationLimitsOutput {
    ...
    /// Connect instance.
    pub fn listConnectInstanceIntegrations(self: *Self, allocator: std.mem.Allocator, input: list_connect_instance_integrations.ListConnectInstanceIntegrationsInput, options: list_connect_instance_integrations.Options) !list_connect_instance_integrations.ListConnectInstanceIntegrationsOutput {
    ...
    pub fn putConnectInstanceIntegration(self: *Self, allocator: std.mem.Allocator, input: put_connect_instance_integration.PutConnectInstanceIntegrationInput, options: put_connect_instance_integration.Options) !put_connect_instance_integration.PutConnectInstanceIntegrationOutput {
    ...
    pub fn putInstanceCommunicationLimits(self: *Self, allocator: std.mem.Allocator, input: put_instance_communication_limits.PutInstanceCommunicationLimitsInput, options: put_instance_communication_limits.Options) !put_instance_communication_limits.PutInstanceCommunicationLimitsOutput {
    ...
    pub fn putOutboundRequestBatch(self: *Self, allocator: std.mem.Allocator, input: put_outbound_request_batch.PutOutboundRequestBatchInput, options: put_outbound_request_batch.Options) !put_outbound_request_batch.PutOutboundRequestBatchOutput {
    ...
    pub fn putProfileOutboundRequestBatch(self: *Self, allocator: std.mem.Allocator, input: put_profile_outbound_request_batch.PutProfileOutboundRequestBatchInput, options: put_profile_outbound_request_batch.Options) !put_profile_outbound_request_batch.PutProfileOutboundRequestBatchOutput {
    ...
    pub fn updateCampaignChannelSubtypeConfig(self: *Self, allocator: std.mem.Allocator, input: update_campaign_channel_subtype_config.UpdateCampaignChannelSubtypeConfigInput, options: update_campaign_channel_subtype_config.Options) !update_campaign_channel_subtype_config.UpdateCampaignChannelSubtypeConfigOutput {
    ...
    /// idempotent.
    pub fn updateCampaignCommunicationLimits(self: *Self, allocator: std.mem.Allocator, input: update_campaign_communication_limits.UpdateCampaignCommunicationLimitsInput, options: update_campaign_communication_limits.Options) !update_campaign_communication_limits.UpdateCampaignCommunicationLimitsOutput {
    ...
    /// idempotent.
    pub fn updateCampaignCommunicationTime(self: *Self, allocator: std.mem.Allocator, input: update_campaign_communication_time.UpdateCampaignCommunicationTimeInput, options: update_campaign_communication_time.Options) !update_campaign_communication_time.UpdateCampaignCommunicationTimeOutput {
    ...
    /// idempotent.
    pub fn updateCampaignFlowAssociation(self: *Self, allocator: std.mem.Allocator, input: update_campaign_flow_association.UpdateCampaignFlowAssociationInput, options: update_campaign_flow_association.Options) !update_campaign_flow_association.UpdateCampaignFlowAssociationOutput {
    ...
    pub fn updateCampaignSchedule(self: *Self, allocator: std.mem.Allocator, input: update_campaign_schedule.UpdateCampaignScheduleInput, options: update_campaign_schedule.Options) !update_campaign_schedule.UpdateCampaignScheduleOutput {
        return update_campaign_schedule.execute(self, allocator, input, options);
    }

    /// Updates the campaign source with a campaign. This API is idempotent.
    pub fn updateCampaignSource(self: *Self, allocator: std.mem.Allocator, input: update_campaign_source.UpdateCampaignSourceInput, options: update_campaign_source.Options) !update_campaign_source.UpdateCampaignSourceOutput {
