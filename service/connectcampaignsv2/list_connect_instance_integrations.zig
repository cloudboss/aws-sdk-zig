...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConnectInstanceIntegrationsInput, options: CallOptions) !ListConnectInstanceIntegrationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListConnectInstanceIntegrationsInput, config: *aws.Config) !aws.http.Request {
