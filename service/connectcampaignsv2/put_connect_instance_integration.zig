...
pub const PutConnectInstanceIntegrationInput = struct {
...
pub const PutConnectInstanceIntegrationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutConnectInstanceIntegrationInput, options: CallOptions) !PutConnectInstanceIntegrationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutConnectInstanceIntegrationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutConnectInstanceIntegrationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutConnectInstanceIntegrationOutput = .{};
