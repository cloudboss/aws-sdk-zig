...
pub const ListConnectInstanceIntegrationsPaginator = struct {
    client: *Client,
    params: list_connect_instance_integrations.ListConnectInstanceIntegrationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_connect_instance_integrations.Options) !list_connect_instance_integrations.ListConnectInstanceIntegrationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_connect_instance_integrations.execute(self.client, allocator, self.params, options);
