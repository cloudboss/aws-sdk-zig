...
pub const DescribeConnectorProfilesPaginator = struct {
    client: *Client,
    params: describe_connector_profiles.DescribeConnectorProfilesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_connector_profiles.DescribeConnectorProfilesOutput {
        ...
        const output = try describe_connector_profiles.execute(self.client, allocator, self.params, options);
...
pub const DescribeConnectorsPaginator = struct {
    client: *Client,
    params: describe_connectors.DescribeConnectorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_connectors.DescribeConnectorsOutput {
        ...
        const output = try describe_connectors.execute(self.client, allocator, self.params, options);
...
pub const DescribeFlowExecutionRecordsPaginator = struct {
    client: *Client,
    params: describe_flow_execution_records.DescribeFlowExecutionRecordsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_flow_execution_records.DescribeFlowExecutionRecordsOutput {
        ...
        const output = try describe_flow_execution_records.execute(self.client, allocator, self.params, options);
