...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UnregisterConnectorInput, options: Options) !UnregisterConnectorOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UnregisterConnectorInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UnregisterConnectorOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
