...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFlowInput, options: Options) !DeleteFlowOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteFlowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteFlowOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFlowOutput = .{};
