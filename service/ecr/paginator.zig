...
pub const DescribeImageScanFindingsPaginator = struct {
    client: *Client,
...
pub const DescribePullThroughCacheRulesPaginator = struct {
    client: *Client,
    params: describe_pull_through_cache_rules.DescribePullThroughCacheRulesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const DescribeRepositoryCreationTemplatesPaginator = struct {
    client: *Client,
    params: describe_repository_creation_templates.DescribeRepositoryCreationTemplatesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const GetLifecyclePolicyPreviewPaginator = struct {
    client: *Client,
