...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLifecyclePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonEC2ContainerRegistry_V20150921.DeleteLifecyclePolicy");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLifecyclePolicyOutput {
    ...
    return aws.json.parseJsonObject(DeleteLifecyclePolicyOutput, body, allocator);
}
