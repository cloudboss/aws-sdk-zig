...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRegistryScanningConfigurationInput, options: Options) !GetRegistryScanningConfigurationOutput {
