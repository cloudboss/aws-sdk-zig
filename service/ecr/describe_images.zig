...
const DescribeImagesFilter = @import("describe_images_filter.zig").DescribeImagesFilter;
...
pub const DescribeImagesInput = struct {
    ...
    /// which to describe images. If you do not specify a registry, the default
    /// registry is assumed.
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeImagesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonEC2ContainerRegistry_V20150921.DescribeImages");
