...
pub const DeleteDBShardGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBShardGroupInput, options: Options) !DeleteDBShardGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDBShardGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteDBShardGroup&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDBShardGroupOutput {
    _ = status;
    _ = headers;
