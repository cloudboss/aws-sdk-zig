...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDBSnapshotTenantDatabasesInput, options: Options) !DescribeDBSnapshotTenantDatabasesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeDBSnapshotTenantDatabasesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeDBSnapshotTenantDatabases&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeDBSnapshotTenantDatabasesOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "DBSnapshotTenantDatabases")) {
                    result.db_snapshot_tenant_databases = try serde.deserializeDBSnapshotTenantDatabasesList(&reader, alloc, "DBSnapshotTenantDatabase");
