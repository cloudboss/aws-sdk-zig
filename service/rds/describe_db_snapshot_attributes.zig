...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDBSnapshotAttributesInput, options: CallOptions) !DescribeDBSnapshotAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDBSnapshotAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeDBSnapshotAttributes&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeDBSnapshotAttributesOutput {
    _ = status;
    _ = headers;
