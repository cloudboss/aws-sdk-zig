...
pub const ServerlessV2ScalingConfigurationInfo = struct {
    ...
    /// shown when the minimum capacity for the cluster is set to 0 ACUs. Changing
    /// the minimum capacity to a nonzero value removes this property. If you later
    /// change the minimum capacity back to 0 ACUs, this property is reset to its
