...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartDBInstanceInput, options: CallOptions) !StartDBInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartDBInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=StartDBInstance&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartDBInstanceOutput {
    _ = status;
    _ = headers;
