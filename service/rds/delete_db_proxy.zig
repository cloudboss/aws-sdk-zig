...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBProxyInput, options: CallOptions) !DeleteDBProxyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDBProxyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteDBProxy&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDBProxyOutput {
    _ = status;
    _ = headers;
