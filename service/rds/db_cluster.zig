...
pub const DBCluster = struct {
    ...
    backtrack_consumed_change_records: ?i64,
    ...
    db_cluster_instance_class: ?[]const u8,
    ...
    limitless_database: ?LimitlessDatabase,
    ...
    local_write_forwarding_status: ?LocalWriteForwardingStatus,
    ...
    serverless_v2_platform_version: ?[]const u8,
    ...
    /// Reserved for future use.
    status_infos: ?[]const DBClusterStatusInfo,
