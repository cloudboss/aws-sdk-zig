...
pub const DBInstance = struct {
    ...
    /// activity stream.
    activity_stream_engine_native_audit_fields_included: ?bool = null,
    ...
    activity_stream_policy_status: ?ActivityStreamPolicyStatus = null,
    ...
    additional_storage_volumes: ?[]const AdditionalStorageVolumeOutput = null,
    ...
    associated_roles: ?[]const DBInstanceRole = null,
    ...
    customer_owned_ip_enabled: ?bool = null,
    ...
    is_storage_config_upgrade_available: ?bool = null,
    ...
    listener_endpoint: ?Endpoint = null,
    ...
    /// replica.
    read_replica_source_db_cluster_identifier: ?[]const u8 = null,
