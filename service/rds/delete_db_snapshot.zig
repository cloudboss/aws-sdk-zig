...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDBSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteDBSnapshot&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDBSnapshotOutput {
    _ = status;
    _ = headers;
