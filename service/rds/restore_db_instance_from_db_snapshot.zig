...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestoreDBInstanceFromDBSnapshotInput, options: CallOptions) !RestoreDBInstanceFromDBSnapshotOutput {
