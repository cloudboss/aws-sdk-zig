...
fn serializeRequest(alloc: std.mem.Allocator, input: StopDBInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StopDBInstance&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopDBInstanceOutput {
    _ = status;
    _ = headers;
