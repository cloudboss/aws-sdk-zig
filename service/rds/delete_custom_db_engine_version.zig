...
pub const DeleteCustomDBEngineVersionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomDBEngineVersionInput, options: Options) !DeleteCustomDBEngineVersionOutput {
