...
pub const SwitchoverGlobalClusterInput = struct {
    ...
    /// primary for the global database cluster. Use the Amazon Resource Name (ARN)
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SwitchoverGlobalClusterInput, options: Options) !SwitchoverGlobalClusterOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SwitchoverGlobalClusterInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=SwitchoverGlobalCluster&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SwitchoverGlobalClusterOutput {
    _ = status;
    _ = headers;
