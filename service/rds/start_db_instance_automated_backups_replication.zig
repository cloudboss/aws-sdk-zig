...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartDBInstanceAutomatedBackupsReplicationInput, options: Options) !StartDBInstanceAutomatedBackupsReplicationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartDBInstanceAutomatedBackupsReplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StartDBInstanceAutomatedBackupsReplication&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartDBInstanceAutomatedBackupsReplicationOutput {
    _ = status;
    _ = headers;
