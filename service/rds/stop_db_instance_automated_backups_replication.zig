...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopDBInstanceAutomatedBackupsReplicationInput, options: CallOptions) !StopDBInstanceAutomatedBackupsReplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopDBInstanceAutomatedBackupsReplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=StopDBInstanceAutomatedBackupsReplication&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopDBInstanceAutomatedBackupsReplicationOutput {
    _ = status;
    _ = headers;
