...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBInstanceAutomatedBackupInput, options: Options) !DeleteDBInstanceAutomatedBackupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDBInstanceAutomatedBackupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteDBInstanceAutomatedBackup&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDBInstanceAutomatedBackupOutput {
    _ = status;
    _ = headers;
