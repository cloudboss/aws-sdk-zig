...
pub const DBClusterDeletedWaiter = struct {
    client: *Client,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        _ = self.client.describeDbClusters(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "DBClusterNotFoundFault")) {
                    return .success;
                }
            }
            return .retry;
...
pub const DBClusterSnapshotDeletedWaiter = struct {
    client: *Client,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        _ = self.client.describeDbClusterSnapshots(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "DBClusterSnapshotNotFoundFault")) {
                    return .success;
                }
            }
            return .retry;
...
pub const DBSnapshotDeletedWaiter = struct {
    client: *Client,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        _ = self.client.describeDbSnapshots(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "DBSnapshotNotFound")) {
                    return .success;
                }
            }
            return .retry;
...
pub const TenantDatabaseDeletedWaiter = struct {
    client: *Client,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        _ = self.client.describeTenantDatabases(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "DBInstanceNotFoundFault")) {
                    return .success;
                }
            }
            return .retry;
