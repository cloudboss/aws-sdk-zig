...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBSecurityGroupInput, options: CallOptions) !DeleteDBSecurityGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDBSecurityGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteDBSecurityGroup&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDBSecurityGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
