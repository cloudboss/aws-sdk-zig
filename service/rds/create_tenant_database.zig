...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTenantDatabaseInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateTenantDatabase&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTenantDatabaseOutput {
    _ = status;
    _ = headers;
