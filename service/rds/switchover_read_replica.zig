...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SwitchoverReadReplicaInput, options: CallOptions) !SwitchoverReadReplicaOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SwitchoverReadReplicaInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=SwitchoverReadReplica&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SwitchoverReadReplicaOutput {
    _ = status;
    _ = headers;
