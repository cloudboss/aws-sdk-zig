...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBClusterAutomatedBackupInput, options: Options) !DeleteDBClusterAutomatedBackupOutput {
