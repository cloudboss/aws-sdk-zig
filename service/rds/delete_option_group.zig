...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOptionGroupInput, options: CallOptions) !DeleteOptionGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteOptionGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteOptionGroup&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteOptionGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
