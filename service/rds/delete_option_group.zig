...
pub const DeleteOptionGroupInput = struct {
...
pub const DeleteOptionGroupOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOptionGroupInput, options: Options) !DeleteOptionGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteOptionGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteOptionGroup&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteOptionGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteOptionGroupOutput = .{};
