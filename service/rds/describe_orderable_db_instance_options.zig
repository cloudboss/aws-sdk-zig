...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOrderableDBInstanceOptionsInput, options: Options) !DescribeOrderableDBInstanceOptionsOutput {
