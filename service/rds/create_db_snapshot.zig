...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDBSnapshotInput, options: CallOptions) !CreateDBSnapshotOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDBSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateDBSnapshot&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateDBSnapshotOutput {
    _ = status;
    _ = headers;
