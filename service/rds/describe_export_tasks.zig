...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeExportTasksInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeExportTasks&Version=2014-10-31");
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "ExportTasks")) {
                    result.export_tasks = try serde.deserializeExportTasksList(&reader, alloc, "ExportTask");
