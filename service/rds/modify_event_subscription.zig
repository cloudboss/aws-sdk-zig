...
pub const ModifyEventSubscriptionInput = struct {
    ...
    /// parameter to db-instance. For RDS Proxy events, specify `db-proxy`. If this
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyEventSubscriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyEventSubscription&Version=2014-10-31");
    if (input.enabled) |v| {
