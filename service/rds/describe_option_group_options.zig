...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOptionGroupOptionsInput, options: CallOptions) !DescribeOptionGroupOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeOptionGroupOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeOptionGroupOptions&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeOptionGroupOptionsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "Marker")) {
                    ...
                    result.option_group_options = try serde.deserializeOptionGroupOptionsList(allocator, &reader, "OptionGroupOption");
                } else {
