...
fn serializeRequest(alloc: std.mem.Allocator, input: AddRoleToDBInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AddRoleToDBInstance&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddRoleToDBInstanceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: AddRoleToDBInstanceOutput = .{};
