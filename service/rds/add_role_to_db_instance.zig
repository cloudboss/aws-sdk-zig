...
fn serializeRequest(allocator: std.mem.Allocator, input: AddRoleToDBInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AddRoleToDBInstance&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddRoleToDBInstanceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
