...
pub const ListMLDataProcessingJobsInput = struct {
...
pub const ListMLDataProcessingJobsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMLDataProcessingJobsInput, options: CallOptions) !ListMLDataProcessingJobsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListMLDataProcessingJobsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListMLDataProcessingJobsOutput {
    var result: ListMLDataProcessingJobsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListMLDataProcessingJobsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
