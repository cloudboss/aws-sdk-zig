...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ManageSparqlStatisticsInput, options: CallOptions) !ManageSparqlStatisticsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ManageSparqlStatisticsInput, config: *aws.Config) !aws.http.Request {
