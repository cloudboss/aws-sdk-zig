...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelMLModelTransformJobInput, options: CallOptions) !CancelMLModelTransformJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelMLModelTransformJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/ml/modeltransform/");
