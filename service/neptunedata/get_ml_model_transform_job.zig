...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMLModelTransformJobInput, options: CallOptions) !GetMLModelTransformJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetMLModelTransformJobInput, config: *aws.Config) !aws.http.Request {
