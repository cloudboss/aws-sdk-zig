...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSparqlStreamInput, options: CallOptions) !GetSparqlStreamOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSparqlStreamInput, config: *aws.Config) !aws.http.Request {
