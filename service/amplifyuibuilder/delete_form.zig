...
pub const DeleteFormInput = struct {
...
pub const DeleteFormOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFormInput, options: CallOptions) !DeleteFormOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFormInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFormOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFormOutput = .{};
