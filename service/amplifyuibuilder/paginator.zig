...
pub const ExportComponentsPaginator = struct {
    client: *Client,
    params: export_components.ExportComponentsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: export_components.Options) !export_components.ExportComponentsOutput {
        ...
        const output = try export_components.execute(self.client, allocator, self.params, options);
...
pub const ExportFormsPaginator = struct {
    client: *Client,
    params: export_forms.ExportFormsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: export_forms.Options) !export_forms.ExportFormsOutput {
        ...
        const output = try export_forms.execute(self.client, allocator, self.params, options);
...
pub const ExportThemesPaginator = struct {
    client: *Client,
    params: export_themes.ExportThemesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: export_themes.Options) !export_themes.ExportThemesOutput {
        ...
        const output = try export_themes.execute(self.client, allocator, self.params, options);
...
pub const ListCodegenJobsPaginator = struct {
    client: *Client,
    params: list_codegen_jobs.ListCodegenJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_codegen_jobs.Options) !list_codegen_jobs.ListCodegenJobsOutput {
        ...
        const output = try list_codegen_jobs.execute(self.client, allocator, self.params, options);
...
pub const ListFormsPaginator = struct {
    client: *Client,
    params: list_forms.ListFormsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_forms.Options) !list_forms.ListFormsOutput {
        ...
        const output = try list_forms.execute(self.client, allocator, self.params, options);
...
pub const ListThemesPaginator = struct {
    client: *Client,
    params: list_themes.ListThemesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
