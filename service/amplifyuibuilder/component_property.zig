...
pub const ComponentProperty = struct {
    ...
    binding_properties: ?ComponentPropertyBindingProperties = null,

    /// The information to bind the component property to form data.
    bindings: ?[]const aws.map.MapEntry(FormBindingElement) = null,

    /// The information to bind the component property to data at runtime. Use this
    /// for collection
    /// components.
    collection_binding_properties: ?ComponentPropertyBindingProperties = null,
    ...
    /// to this
    /// component property.
    concat: ?[]const ComponentProperty = null,
