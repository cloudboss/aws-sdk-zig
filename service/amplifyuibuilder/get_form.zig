...
pub const GetFormOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFormInput, options: CallOptions) !GetFormOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFormInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetFormOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
