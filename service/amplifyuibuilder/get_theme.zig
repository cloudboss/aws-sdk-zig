...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetThemeInput, options: CallOptions) !GetThemeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetThemeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetThemeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
