...
pub const Client = struct {
    ...
    pub fn getDbCluster(self: *Self, allocator: std.mem.Allocator, input: get_db_cluster.GetDbClusterInput, options: CallOptions) !get_db_cluster.GetDbClusterOutput {
        return get_db_cluster.execute(self, allocator, input, options);
    }

    /// Returns a Timestream for InfluxDB DB instance.
    pub fn getDbInstance(self: *Self, allocator: std.mem.Allocator, input: get_db_instance.GetDbInstanceInput, options: CallOptions) !get_db_instance.GetDbInstanceOutput {
    ...
    pub fn listDbClusters(self: *Self, allocator: std.mem.Allocator, input: list_db_clusters.ListDbClustersInput, options: CallOptions) !list_db_clusters.ListDbClustersOutput {
        return list_db_clusters.execute(self, allocator, input, options);
    }

    /// Returns a list of Timestream for InfluxDB DB instances.
    pub fn listDbInstances(self: *Self, allocator: std.mem.Allocator, input: list_db_instances.ListDbInstancesInput, options: CallOptions) !list_db_instances.ListDbInstancesOutput {
        return list_db_instances.execute(self, allocator, input, options);
    }

    /// Returns a list of Timestream for InfluxDB clusters.
    pub fn listDbInstancesForCluster(self: *Self, allocator: std.mem.Allocator, input: list_db_instances_for_cluster.ListDbInstancesForClusterInput, options: CallOptions) !list_db_instances_for_cluster.ListDbInstancesForClusterOutput {
        return list_db_instances_for_cluster.execute(self, allocator, input, options);
    }

    /// Returns a list of Timestream for InfluxDB DB parameter groups.
    pub fn listDbParameterGroups(self: *Self, allocator: std.mem.Allocator, input: list_db_parameter_groups.ListDbParameterGroupsInput, options: CallOptions) !list_db_parameter_groups.ListDbParameterGroupsOutput {
    ...
    pub fn updateDbCluster(self: *Self, allocator: std.mem.Allocator, input: update_db_cluster.UpdateDbClusterInput, options: CallOptions) !update_db_cluster.UpdateDbClusterOutput {
