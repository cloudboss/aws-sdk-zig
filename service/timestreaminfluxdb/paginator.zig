...
pub const ListDbClustersPaginator = struct {
    client: *Client,
    params: list_db_clusters.ListDbClustersInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_db_clusters.Options) !list_db_clusters.ListDbClustersOutput {
        ...
        const output = try list_db_clusters.execute(self.client, allocator, self.params, options);
...
pub const ListDbInstancesPaginator = struct {
    client: *Client,
    params: list_db_instances.ListDbInstancesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_db_instances.Options) !list_db_instances.ListDbInstancesOutput {
        ...
        const output = try list_db_instances.execute(self.client, allocator, self.params, options);
...
pub const ListDbInstancesForClusterPaginator = struct {
    client: *Client,
    params: list_db_instances_for_cluster.ListDbInstancesForClusterInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_db_instances_for_cluster.Options) !list_db_instances_for_cluster.ListDbInstancesForClusterOutput {
        ...
        const output = try list_db_instances_for_cluster.execute(self.client, allocator, self.params, options);
...
pub const ListDbParameterGroupsPaginator = struct {
    client: *Client,
    params: list_db_parameter_groups.ListDbParameterGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_db_parameter_groups.Options) !list_db_parameter_groups.ListDbParameterGroupsOutput {
        ...
        const output = try list_db_parameter_groups.execute(self.client, allocator, self.params, options);
