...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConfiguredModelAlgorithmAssociationInput, options: CallOptions) !GetConfiguredModelAlgorithmAssociationOutput {
