...
pub const DeleteMLInputChannelDataInput = struct {
...
pub const DeleteMLInputChannelDataOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMLInputChannelDataInput, options: CallOptions) !DeleteMLInputChannelDataOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMLInputChannelDataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMLInputChannelDataOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMLInputChannelDataOutput = .{};
