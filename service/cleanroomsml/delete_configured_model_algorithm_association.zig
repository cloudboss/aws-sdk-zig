...
pub const DeleteConfiguredModelAlgorithmAssociationInput = struct {
...
pub const DeleteConfiguredModelAlgorithmAssociationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfiguredModelAlgorithmAssociationInput, options: CallOptions) !DeleteConfiguredModelAlgorithmAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfiguredModelAlgorithmAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteConfiguredModelAlgorithmAssociationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteConfiguredModelAlgorithmAssociationOutput = .{};
