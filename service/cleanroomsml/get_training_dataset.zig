...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTrainingDatasetInput, options: CallOptions) !GetTrainingDatasetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTrainingDatasetInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/training-dataset/");
    try path_buf.appendSlice(allocator, input.training_dataset_arn);
