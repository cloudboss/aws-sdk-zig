...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GenerateDataKeyPairWithoutPlaintextInput, options: Options) !GenerateDataKeyPairWithoutPlaintextOutput {
