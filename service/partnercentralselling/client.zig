...
pub const Client = struct {
    ...
    pub fn acceptEngagementInvitation(self: *Self, allocator: std.mem.Allocator, input: accept_engagement_invitation.AcceptEngagementInvitationInput, options: accept_engagement_invitation.Options) !accept_engagement_invitation.AcceptEngagementInvitationOutput {
    ...
    pub fn assignOpportunity(self: *Self, allocator: std.mem.Allocator, input: assign_opportunity.AssignOpportunityInput, options: assign_opportunity.Options) !assign_opportunity.AssignOpportunityOutput {
    ...
    pub fn associateOpportunity(self: *Self, allocator: std.mem.Allocator, input: associate_opportunity.AssociateOpportunityInput, options: associate_opportunity.Options) !associate_opportunity.AssociateOpportunityOutput {
    ...
    pub fn createEngagement(self: *Self, allocator: std.mem.Allocator, input: create_engagement.CreateEngagementInput, options: create_engagement.Options) !create_engagement.CreateEngagementOutput {
    ...
    pub fn createEngagementContext(self: *Self, allocator: std.mem.Allocator, input: create_engagement_context.CreateEngagementContextInput, options: create_engagement_context.Options) !create_engagement_context.CreateEngagementContextOutput {
    ...
    /// an engagement.
    pub fn createEngagementInvitation(self: *Self, allocator: std.mem.Allocator, input: create_engagement_invitation.CreateEngagementInvitationInput, options: create_engagement_invitation.Options) !create_engagement_invitation.CreateEngagementInvitationOutput {
    ...
    pub fn createOpportunity(self: *Self, allocator: std.mem.Allocator, input: create_opportunity.CreateOpportunityInput, options: create_opportunity.Options) !create_opportunity.CreateOpportunityOutput {
    ...
    pub fn createResourceSnapshot(self: *Self, allocator: std.mem.Allocator, input: create_resource_snapshot.CreateResourceSnapshotInput, options: create_resource_snapshot.Options) !create_resource_snapshot.CreateResourceSnapshotOutput {
    ...
    pub fn createResourceSnapshotJob(self: *Self, allocator: std.mem.Allocator, input: create_resource_snapshot_job.CreateResourceSnapshotJobInput, options: create_resource_snapshot_job.Options) !create_resource_snapshot_job.CreateResourceSnapshotJobOutput {
    ...
    pub fn deleteResourceSnapshotJob(self: *Self, allocator: std.mem.Allocator, input: delete_resource_snapshot_job.DeleteResourceSnapshotJobInput, options: delete_resource_snapshot_job.Options) !delete_resource_snapshot_job.DeleteResourceSnapshotJobOutput {
    ...
    pub fn disassociateOpportunity(self: *Self, allocator: std.mem.Allocator, input: disassociate_opportunity.DisassociateOpportunityInput, options: disassociate_opportunity.Options) !disassociate_opportunity.DisassociateOpportunityOutput {
    ...
    pub fn getAwsOpportunitySummary(self: *Self, allocator: std.mem.Allocator, input: get_aws_opportunity_summary.GetAwsOpportunitySummaryInput, options: get_aws_opportunity_summary.Options) !get_aws_opportunity_summary.GetAwsOpportunitySummaryOutput {
    ...
    pub fn getEngagement(self: *Self, allocator: std.mem.Allocator, input: get_engagement.GetEngagementInput, options: get_engagement.Options) !get_engagement.GetEngagementOutput {
    ...
    /// `Project.Title`.
    pub fn getEngagementInvitation(self: *Self, allocator: std.mem.Allocator, input: get_engagement_invitation.GetEngagementInvitationInput, options: get_engagement_invitation.Options) !get_engagement_invitation.GetEngagementInvitationOutput {
    ...
    pub fn getOpportunity(self: *Self, allocator: std.mem.Allocator, input: get_opportunity.GetOpportunityInput, options: get_opportunity.Options) !get_opportunity.GetOpportunityOutput {
        return get_opportunity.execute(self, allocator, input, options);
    }

    /// Use this action to retrieve a specific snapshot record.
    pub fn getResourceSnapshot(self: *Self, allocator: std.mem.Allocator, input: get_resource_snapshot.GetResourceSnapshotInput, options: get_resource_snapshot.Options) !get_resource_snapshot.GetResourceSnapshotOutput {
    ...
    /// job.
    pub fn getResourceSnapshotJob(self: *Self, allocator: std.mem.Allocator, input: get_resource_snapshot_job.GetResourceSnapshotJobInput, options: get_resource_snapshot_job.Options) !get_resource_snapshot_job.GetResourceSnapshotJobOutput {
    ...
    pub fn getSellingSystemSettings(self: *Self, allocator: std.mem.Allocator, input: get_selling_system_settings.GetSellingSystemSettingsInput, options: get_selling_system_settings.Options) !get_selling_system_settings.GetSellingSystemSettingsOutput {
    ...
    /// caller's account.
    pub fn listEngagementByAcceptingInvitationTasks(self: *Self, allocator: std.mem.Allocator, input: list_engagement_by_accepting_invitation_tasks.ListEngagementByAcceptingInvitationTasksInput, options: list_engagement_by_accepting_invitation_tasks.Options) !list_engagement_by_accepting_invitation_tasks.ListEngagementByAcceptingInvitationTasksOutput {
    ...
    pub fn listEngagementFromOpportunityTasks(self: *Self, allocator: std.mem.Allocator, input: list_engagement_from_opportunity_tasks.ListEngagementFromOpportunityTasksInput, options: list_engagement_from_opportunity_tasks.Options) !list_engagement_from_opportunity_tasks.ListEngagementFromOpportunityTasksOutput {
    ...
    pub fn listEngagementInvitations(self: *Self, allocator: std.mem.Allocator, input: list_engagement_invitations.ListEngagementInvitationsInput, options: list_engagement_invitations.Options) !list_engagement_invitations.ListEngagementInvitationsOutput {
    ...
    pub fn listEngagementMembers(self: *Self, allocator: std.mem.Allocator, input: list_engagement_members.ListEngagementMembersInput, options: list_engagement_members.Options) !list_engagement_members.ListEngagementMembersOutput {
    ...
    pub fn listEngagementResourceAssociations(self: *Self, allocator: std.mem.Allocator, input: list_engagement_resource_associations.ListEngagementResourceAssociationsInput, options: list_engagement_resource_associations.Options) !list_engagement_resource_associations.ListEngagementResourceAssociationsOutput {
    ...
    pub fn listOpportunities(self: *Self, allocator: std.mem.Allocator, input: list_opportunities.ListOpportunitiesInput, options: list_opportunities.Options) !list_opportunities.ListOpportunitiesOutput {
    ...
    pub fn listOpportunityFromEngagementTasks(self: *Self, allocator: std.mem.Allocator, input: list_opportunity_from_engagement_tasks.ListOpportunityFromEngagementTasksInput, options: list_opportunity_from_engagement_tasks.Options) !list_opportunity_from_engagement_tasks.ListOpportunityFromEngagementTasksOutput {
    ...
    pub fn listResourceSnapshotJobs(self: *Self, allocator: std.mem.Allocator, input: list_resource_snapshot_jobs.ListResourceSnapshotJobsInput, options: list_resource_snapshot_jobs.Options) !list_resource_snapshot_jobs.ListResourceSnapshotJobsOutput {
    ...
    pub fn listResourceSnapshots(self: *Self, allocator: std.mem.Allocator, input: list_resource_snapshots.ListResourceSnapshotsInput, options: list_resource_snapshots.Options) !list_resource_snapshots.ListResourceSnapshotsOutput {
    ...
    /// for resource snapshot jobs.
    pub fn putSellingSystemSettings(self: *Self, allocator: std.mem.Allocator, input: put_selling_system_settings.PutSellingSystemSettingsInput, options: put_selling_system_settings.Options) !put_selling_system_settings.PutSellingSystemSettingsOutput {
    ...
    pub fn rejectEngagementInvitation(self: *Self, allocator: std.mem.Allocator, input: reject_engagement_invitation.RejectEngagementInvitationInput, options: reject_engagement_invitation.Options) !reject_engagement_invitation.RejectEngagementInvitationOutput {
    ...
    pub fn startEngagementByAcceptingInvitationTask(self: *Self, allocator: std.mem.Allocator, input: start_engagement_by_accepting_invitation_task.StartEngagementByAcceptingInvitationTaskInput, options: start_engagement_by_accepting_invitation_task.Options) !start_engagement_by_accepting_invitation_task.StartEngagementByAcceptingInvitationTaskOutput {
    ...
    /// `SubmitOpportunity`.
    pub fn startEngagementFromOpportunityTask(self: *Self, allocator: std.mem.Allocator, input: start_engagement_from_opportunity_task.StartEngagementFromOpportunityTaskInput, options: start_engagement_from_opportunity_task.Options) !start_engagement_from_opportunity_task.StartEngagementFromOpportunityTaskOutput {
    ...
    /// partner's account.
    pub fn startOpportunityFromEngagementTask(self: *Self, allocator: std.mem.Allocator, input: start_opportunity_from_engagement_task.StartOpportunityFromEngagementTaskInput, options: start_opportunity_from_engagement_task.Options) !start_opportunity_from_engagement_task.StartOpportunityFromEngagementTaskOutput {
        return start_opportunity_from_engagement_task.execute(self, allocator, input, options);
    }

    /// Starts a resource snapshot job that has been previously created.
    pub fn startResourceSnapshotJob(self: *Self, allocator: std.mem.Allocator, input: start_resource_snapshot_job.StartResourceSnapshotJobInput, options: start_resource_snapshot_job.Options) !start_resource_snapshot_job.StartResourceSnapshotJobOutput {
    ...
    /// stopped.
    pub fn stopResourceSnapshotJob(self: *Self, allocator: std.mem.Allocator, input: stop_resource_snapshot_job.StopResourceSnapshotJobInput, options: stop_resource_snapshot_job.Options) !stop_resource_snapshot_job.StopResourceSnapshotJobOutput {
    ...
    pub fn submitOpportunity(self: *Self, allocator: std.mem.Allocator, input: submit_opportunity.SubmitOpportunityInput, options: submit_opportunity.Options) !submit_opportunity.SubmitOpportunityOutput {
    ...
    /// modified data.
    pub fn updateEngagementContext(self: *Self, allocator: std.mem.Allocator, input: update_engagement_context.UpdateEngagementContextInput, options: update_engagement_context.Options) !update_engagement_context.UpdateEngagementContextOutput {
    ...
    /// changed.
    pub fn updateOpportunity(self: *Self, allocator: std.mem.Allocator, input: update_opportunity.UpdateOpportunityInput, options: update_opportunity.Options) !update_opportunity.UpdateOpportunityOutput {
