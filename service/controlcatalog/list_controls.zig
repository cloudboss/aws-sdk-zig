...
const ControlFilter = @import("control_filter.zig").ControlFilter;
const ControlSummary = @import("control_summary.zig").ControlSummary;
...
pub const ListControlsOutput = struct {
    ...
    controls: ?[]const ControlSummary = null,
