...
const DeploymentFilter = @import("deployment_filter.zig").DeploymentFilter;
...
pub const ListDeploymentsInput = struct {
    ...
    filters: ?[]const DeploymentFilter = null,
...
pub const ListDeploymentsOutput = struct {
    ...
    deployments: ?[]const DeploymentDataSummary = null,
