...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAgentRuntimesInput, options: CallOptions) !ListAgentRuntimesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAgentRuntimesInput, config: *aws.Config) !aws.http.Request {
