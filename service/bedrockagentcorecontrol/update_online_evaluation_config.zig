...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateOnlineEvaluationConfigInput, options: CallOptions) !UpdateOnlineEvaluationConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateOnlineEvaluationConfigInput, config: *aws.Config) !aws.http.Request {
