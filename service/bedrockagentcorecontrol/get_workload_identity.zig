...
pub const GetWorkloadIdentityInput = struct {
...
pub const GetWorkloadIdentityOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetWorkloadIdentityInput, options: CallOptions) !GetWorkloadIdentityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetWorkloadIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/identities/GetWorkloadIdentity";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetWorkloadIdentityOutput {
    var result: GetWorkloadIdentityOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetWorkloadIdentityOutput, body, allocator);
    }
    _ = status;
    _ = headers;
