...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApiKeyCredentialProviderInput, options: CallOptions) !UpdateApiKeyCredentialProviderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateApiKeyCredentialProviderInput, config: *aws.Config) !aws.http.Request {
