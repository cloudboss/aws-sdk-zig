...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApiKeyCredentialProviderInput, options: CallOptions) !GetApiKeyCredentialProviderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetApiKeyCredentialProviderInput, config: *aws.Config) !aws.http.Request {
