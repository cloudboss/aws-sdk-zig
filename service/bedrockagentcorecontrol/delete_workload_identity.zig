...
pub const DeleteWorkloadIdentityInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteWorkloadIdentityInput, options: Options) !DeleteWorkloadIdentityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteWorkloadIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/identities/DeleteWorkloadIdentity";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteWorkloadIdentityOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteWorkloadIdentityOutput = .{};
