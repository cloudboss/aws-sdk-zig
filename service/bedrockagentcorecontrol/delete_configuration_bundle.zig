...
const ConfigurationBundleStatus = @import("configuration_bundle_status.zig").ConfigurationBundleStatus;

pub const DeleteConfigurationBundleInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfigurationBundleInput, options: CallOptions) !DeleteConfigurationBundleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfigurationBundleInput, config: *aws.Config) !aws.http.Request {
