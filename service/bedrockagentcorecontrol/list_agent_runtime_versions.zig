...
pub const ListAgentRuntimeVersionsInput = struct {
...
pub const ListAgentRuntimeVersionsOutput = struct {
    /// The list of AgentCore Runtime versions.
    agent_runtimes: ?[]const AgentRuntime = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAgentRuntimeVersionsInput, options: CallOptions) !ListAgentRuntimeVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAgentRuntimeVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAgentRuntimeVersionsOutput {
    var result: ListAgentRuntimeVersionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAgentRuntimeVersionsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
