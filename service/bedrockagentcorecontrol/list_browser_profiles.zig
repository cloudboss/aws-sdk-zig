...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBrowserProfilesInput, options: CallOptions) !ListBrowserProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBrowserProfilesInput, config: *aws.Config) !aws.http.Request {
