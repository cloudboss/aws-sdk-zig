...
pub const DeleteRegistryRecordInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRegistryRecordInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRegistryRecordOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRegistryRecordOutput = .{};
