...
const ConfigurationBundleSummary = @import("configuration_bundle_summary.zig").ConfigurationBundleSummary;

pub const ListConfigurationBundlesInput = struct {
...
pub const ListConfigurationBundlesOutput = struct {
    /// The list of configuration bundle summaries.
    bundles: ?[]const ConfigurationBundleSummary = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConfigurationBundlesInput, options: CallOptions) !ListConfigurationBundlesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListConfigurationBundlesInput, config: *aws.Config) !aws.http.Request {
