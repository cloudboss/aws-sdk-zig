...
pub const Client = struct {
    ...
    /// that
    /// have exclusion tags.
    pub fn lockRule(self: *Self, allocator: std.mem.Allocator, input: lock_rule.LockRuleInput, options: CallOptions) !lock_rule.LockRuleOutput {
    ...
    pub fn unlockRule(self: *Self, allocator: std.mem.Allocator, input: unlock_rule.UnlockRuleInput, options: CallOptions) !unlock_rule.UnlockRuleOutput {
