...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLakeFormationOptInInput, options: CallOptions) !DeleteLakeFormationOptInOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLakeFormationOptInInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLakeFormationOptInOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
