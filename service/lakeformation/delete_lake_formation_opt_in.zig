...
pub const DeleteLakeFormationOptInInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLakeFormationOptInInput, options: Options) !DeleteLakeFormationOptInOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLakeFormationOptInInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteLakeFormationOptIn";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLakeFormationOptInOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLakeFormationOptInOutput = .{};
