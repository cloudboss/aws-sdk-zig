...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTemporaryGluePartitionCredentialsInput, options: CallOptions) !GetTemporaryGluePartitionCredentialsOutput {
