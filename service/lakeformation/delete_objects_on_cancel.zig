...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteObjectsOnCancelInput, options: Options) !DeleteObjectsOnCancelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteObjectsOnCancelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteObjectsOnCancelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
