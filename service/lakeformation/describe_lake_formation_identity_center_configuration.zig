...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeLakeFormationIdentityCenterConfigurationInput, options: Options) !DescribeLakeFormationIdentityCenterConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeLakeFormationIdentityCenterConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeLakeFormationIdentityCenterConfigurationOutput {
    var result: DescribeLakeFormationIdentityCenterConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeLakeFormationIdentityCenterConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
