...
pub const DeleteLFTagExpressionInput = struct {
...
pub const DeleteLFTagExpressionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLFTagExpressionInput, options: Options) !DeleteLFTagExpressionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLFTagExpressionInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteLFTagExpression";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLFTagExpressionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLFTagExpressionOutput = .{};
