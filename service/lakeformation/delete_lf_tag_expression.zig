...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLFTagExpressionInput, options: CallOptions) !DeleteLFTagExpressionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLFTagExpressionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLFTagExpressionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
