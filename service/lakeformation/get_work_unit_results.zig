...
pub const GetWorkUnitResultsInput = struct {
    /// The ID of the plan query operation for which to get results.
    query_id: []const u8,

    /// The work unit ID for which to get results. Value generated by enumerating
    /// `WorkUnitIdMin` to `WorkUnitIdMax` (inclusive) from the `WorkUnitRange` in
    /// the output of `GetWorkUnits`.
    work_unit_id: i64 = 0,
...
pub const GetWorkUnitResultsOutput = struct {
    /// Rows returned from the `GetWorkUnitResults` operation as a stream of Apache
    /// Arrow v1.0 messages.
    result_stream: aws.http.StreamingBody = "",
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetWorkUnitResultsInput, options: Options) !GetWorkUnitResultsOutput {
