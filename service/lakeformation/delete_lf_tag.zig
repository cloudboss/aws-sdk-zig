...
pub const DeleteLFTagInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLFTagInput, options: Options) !DeleteLFTagOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLFTagInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLFTagOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLFTagOutput = .{};
