...
pub const ExtendTransactionInput = struct {
...
pub const ExtendTransactionOutput = struct {
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ExtendTransactionInput, options: CallOptions) !ExtendTransactionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ExtendTransactionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ExtendTransactionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ExtendTransactionOutput = .{};
