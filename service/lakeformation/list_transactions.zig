...
const ListTransactionsInput = @import("list_transactions_request.zig").ListTransactionsRequest;

const ListTransactionsOutput = @import("list_transactions_response.zig").ListTransactionsResponse;
