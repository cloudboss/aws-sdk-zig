...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelTransactionInput, options: CallOptions) !CancelTransactionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelTransactionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelTransactionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
