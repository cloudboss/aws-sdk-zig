...
pub const CancelTransactionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelTransactionInput, options: Options) !CancelTransactionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelTransactionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelTransactionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelTransactionOutput = .{};
