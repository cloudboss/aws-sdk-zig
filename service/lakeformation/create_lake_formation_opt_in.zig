...
pub const CreateLakeFormationOptInInput = struct {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateLakeFormationOptInInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/CreateLakeFormationOptIn";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateLakeFormationOptInOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateLakeFormationOptInOutput = .{};
