...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataLakePrincipalInput, options: CallOptions) !GetDataLakePrincipalOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDataLakePrincipalInput, config: *aws.Config) !aws.http.Request {
    _ = input;
