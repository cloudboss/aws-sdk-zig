...
pub const DeleteLakeFormationIdentityCenterConfigurationInput = struct {
    /// The identifier for the Data Catalog. By default, the account ID. The Data
    /// Catalog is the
    /// persistent metadata store. It contains database definitions, table
    /// definitions, view
    /// definition, and other control information to manage your Lake Formation
    /// environment.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLakeFormationIdentityCenterConfigurationInput, options: Options) !DeleteLakeFormationIdentityCenterConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLakeFormationIdentityCenterConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteLakeFormationIdentityCenterConfiguration";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLakeFormationIdentityCenterConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLakeFormationIdentityCenterConfigurationOutput = .{};
