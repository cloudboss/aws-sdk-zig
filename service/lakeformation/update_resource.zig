...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateResourceInput, options: Options) !UpdateResourceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateResourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateResourceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
