...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RevokePermissionsInput, options: Options) !RevokePermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RevokePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RevokePermissionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
