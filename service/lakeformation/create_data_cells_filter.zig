...
pub const CreateDataCellsFilterInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDataCellsFilterInput, options: Options) !CreateDataCellsFilterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDataCellsFilterInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/CreateDataCellsFilter";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateDataCellsFilterOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateDataCellsFilterOutput = .{};
