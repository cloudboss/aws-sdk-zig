...
pub const AddLFTagsToResourceInput = struct {
...
pub const AddLFTagsToResourceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddLFTagsToResourceInput, options: CallOptions) !AddLFTagsToResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddLFTagsToResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/AddLFTagsToResource";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddLFTagsToResourceOutput {
    var result: AddLFTagsToResourceOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(AddLFTagsToResourceOutput, body, allocator);
    }
    _ = status;
    _ = headers;
