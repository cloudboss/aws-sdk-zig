...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTransactionInput, options: CallOptions) !DescribeTransactionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTransactionInput, config: *aws.Config) !aws.http.Request {
