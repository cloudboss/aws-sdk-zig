...
pub const DeregisterResourceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterResourceInput, options: Options) !DeregisterResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterResourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterResourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeregisterResourceOutput = .{};
