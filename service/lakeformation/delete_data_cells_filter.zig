...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataCellsFilterInput, options: Options) !DeleteDataCellsFilterOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDataCellsFilterInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDataCellsFilterOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
