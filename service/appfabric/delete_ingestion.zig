...
pub const DeleteIngestionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIngestionInput, options: Options) !DeleteIngestionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIngestionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIngestionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteIngestionOutput = .{};
