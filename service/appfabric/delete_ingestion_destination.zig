...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIngestionDestinationInput, options: Options) !DeleteIngestionDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIngestionDestinationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIngestionDestinationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
