...
pub const DeleteAppAuthorizationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppAuthorizationInput, options: CallOptions) !DeleteAppAuthorizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppAuthorizationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAppAuthorizationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAppAuthorizationOutput = .{};
