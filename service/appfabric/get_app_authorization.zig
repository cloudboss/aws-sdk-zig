...
pub const GetAppAuthorizationInput = struct {
...
pub const GetAppAuthorizationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAppAuthorizationInput, options: CallOptions) !GetAppAuthorizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAppAuthorizationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAppAuthorizationOutput {
    var result: GetAppAuthorizationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetAppAuthorizationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
