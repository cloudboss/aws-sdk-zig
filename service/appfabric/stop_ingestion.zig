...
pub const StopIngestionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopIngestionInput, options: Options) !StopIngestionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopIngestionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopIngestionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopIngestionOutput = .{};
