...
pub const StartIngestionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartIngestionInput, options: Options) !StartIngestionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartIngestionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartIngestionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: StartIngestionOutput = .{};
