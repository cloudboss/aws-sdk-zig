...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppBundleInput, options: Options) !DeleteAppBundleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAppBundleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAppBundleOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
