...
pub const ListAppAuthorizationsInput = struct {
...
pub const ListAppAuthorizationsOutput = struct {
    /// Contains a list of app authorization summaries.
    app_authorization_summary_list: ?[]const AppAuthorizationSummary = null,
    ...
    pub const json_field_names = .{
        .app_authorization_summary_list = "appAuthorizationSummaryList",
        .next_token = "nextToken",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAppAuthorizationsInput, options: CallOptions) !ListAppAuthorizationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAppAuthorizationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAppAuthorizationsOutput {
    var result: ListAppAuthorizationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAppAuthorizationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
