...
pub const DeleteScalingPolicyInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteScalingPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AnyScaleFrontendService.DeleteScalingPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteScalingPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
