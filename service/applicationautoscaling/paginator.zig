...
pub const DescribeScalableTargetsPaginator = struct {
    client: *Client,
    params: describe_scalable_targets.DescribeScalableTargetsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: describe_scalable_targets.Options) !describe_scalable_targets.DescribeScalableTargetsOutput {
        if (self.done) {
        ...
        const output = try describe_scalable_targets.execute(self.client, allocator, self.params, options);
