const PredictiveScalingMetricStat = @import("predictive_scaling_metric_stat.zig").PredictiveScalingMetricStat;
...
/// returned
/// metric statistics to create a new time series. A time series is a series of
/// data points,
/// each of which is associated with a timestamp.
pub const PredictiveScalingMetricDataQuery = struct {
    ...
    /// valid
    /// characters are letters, numbers, and underscores. The first character must
    /// be a
    /// lowercase letter.
    id: []const u8,
