...
pub const Client = struct {
    ...
    pub fn createAct(self: *Self, allocator: std.mem.Allocator, input: create_act.CreateActInput, options: CallOptions) !create_act.CreateActOutput {
    ...
    pub fn createWorkflowDefinition(self: *Self, allocator: std.mem.Allocator, input: create_workflow_definition.CreateWorkflowDefinitionInput, options: CallOptions) !create_workflow_definition.CreateWorkflowDefinitionOutput {
    ...
    /// parameters.
    pub fn createWorkflowRun(self: *Self, allocator: std.mem.Allocator, input: create_workflow_run.CreateWorkflowRunInput, options: CallOptions) !create_workflow_run.CreateWorkflowRunOutput {
    ...
    /// cannot be undone.
    pub fn deleteWorkflowDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_workflow_definition.DeleteWorkflowDefinitionInput, options: CallOptions) !delete_workflow_definition.DeleteWorkflowDefinitionOutput {
    ...
    /// sessions.
    pub fn deleteWorkflowRun(self: *Self, allocator: std.mem.Allocator, input: delete_workflow_run.DeleteWorkflowRunInput, options: CallOptions) !delete_workflow_run.DeleteWorkflowRunOutput {
    ...
    pub fn getWorkflowDefinition(self: *Self, allocator: std.mem.Allocator, input: get_workflow_definition.GetWorkflowDefinitionInput, options: CallOptions) !get_workflow_definition.GetWorkflowDefinitionOutput {
    ...
    pub fn invokeActStep(self: *Self, allocator: std.mem.Allocator, input: invoke_act_step.InvokeActStepInput, options: CallOptions) !invoke_act_step.InvokeActStepOutput {
    ...
    /// execution details.
    pub fn listActs(self: *Self, allocator: std.mem.Allocator, input: list_acts.ListActsInput, options: CallOptions) !list_acts.ListActsOutput {
    ...
    /// pagination.
    pub fn listWorkflowDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_workflow_definitions.ListWorkflowDefinitionsInput, options: CallOptions) !list_workflow_definitions.ListWorkflowDefinitionsOutput {
    ...
    pub fn updateAct(self: *Self, allocator: std.mem.Allocator, input: update_act.UpdateActInput, options: CallOptions) !update_act.UpdateActOutput {
        return update_act.execute(self, allocator, input, options);
    }

    /// Updates the configuration or state of an active workflow run.
    pub fn updateWorkflowRun(self: *Self, allocator: std.mem.Allocator, input: update_workflow_run.UpdateWorkflowRunInput, options: CallOptions) !update_workflow_run.UpdateWorkflowRunOutput {
