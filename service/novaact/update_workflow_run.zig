...
pub const UpdateWorkflowRunInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateWorkflowRunInput, options: Options) !UpdateWorkflowRunOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateWorkflowRunInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateWorkflowRunOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateWorkflowRunOutput = .{};
