...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteWorkflowDefinitionInput, options: CallOptions) !DeleteWorkflowDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteWorkflowDefinitionInput, config: *aws.Config) !aws.http.Request {
