...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartCallAnalyticsStreamTranscriptionInput, options: CallOptions) !StartCallAnalyticsStreamTranscriptionOutput {
    _ = client;
    _ = allocator;
    _ = input;
    _ = options;
