...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartMedicalStreamTranscriptionInput, options: CallOptions) !StartMedicalStreamTranscriptionOutput {
    _ = client;
    _ = allocator;
    _ = input;
    _ = options;
