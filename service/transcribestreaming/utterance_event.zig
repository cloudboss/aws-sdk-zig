...
pub const UtteranceEvent = struct {
    ...
    /// your transcription
    /// output.
    entities: ?[]const CallAnalyticsEntity = null,
    ...
    /// specified
    /// `UtteranceEvent`.
    items: ?[]const CallAnalyticsItem = null,

    /// The language code that represents the language spoken in your audio stream.
    language_code: ?CallAnalyticsLanguageCode = null,

    /// The language code of the dominant language identified in your stream.
    language_identification: ?[]const CallAnalyticsLanguageWithScore = null,
