...
pub const DeleteStreamKeyInput = struct {
...
pub const DeleteStreamKeyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteStreamKeyInput, options: CallOptions) !DeleteStreamKeyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteStreamKeyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteStreamKeyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteStreamKeyOutput = .{};
