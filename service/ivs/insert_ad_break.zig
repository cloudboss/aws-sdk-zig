...
pub const InsertAdBreakInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: InsertAdBreakInput, options: CallOptions) !InsertAdBreakOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: InsertAdBreakInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.duration_seconds), input.duration_seconds, allocator, &body_buf);
    has_prev = true;
