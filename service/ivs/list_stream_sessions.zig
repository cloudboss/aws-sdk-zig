...
const ListStreamSessionsInput = @import("list_stream_sessions_request.zig").ListStreamSessionsRequest;

const ListStreamSessionsOutput = @import("list_stream_sessions_response.zig").ListStreamSessionsResponse;
