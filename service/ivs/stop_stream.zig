...
pub const StopStreamInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopStreamInput, options: Options) !StopStreamOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopStreamInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopStreamOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopStreamOutput = .{};
