...
pub const GetPlaybackRestrictionPolicyInput = struct {
...
pub const GetPlaybackRestrictionPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetPlaybackRestrictionPolicyInput, options: CallOptions) !GetPlaybackRestrictionPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetPlaybackRestrictionPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/GetPlaybackRestrictionPolicy";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetPlaybackRestrictionPolicyOutput {
    var result: GetPlaybackRestrictionPolicyOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetPlaybackRestrictionPolicyOutput, body, allocator);
    }
    _ = status;
    _ = headers;
