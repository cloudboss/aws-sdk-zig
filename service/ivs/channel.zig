...
pub const Channel = struct {
    ...
    /// ARN and enables
    /// playback restriction. Default: "" (empty string, no playback restriction
    /// policy is
    /// applied).
    playback_restriction_policy_arn: ?[]const u8,
    ...
    recording_configuration_arn: ?[]const u8,
