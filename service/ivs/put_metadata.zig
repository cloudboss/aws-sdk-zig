...
pub const PutMetadataInput = struct {
...
pub const PutMetadataOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutMetadataInput, options: CallOptions) !PutMetadataOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutMetadataOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutMetadataOutput = .{};
