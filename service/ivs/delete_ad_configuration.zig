...
pub const DeleteAdConfigurationInput = struct {
...
pub const DeleteAdConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAdConfigurationInput, options: CallOptions) !DeleteAdConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAdConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteAdConfiguration";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAdConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAdConfigurationOutput = .{};
