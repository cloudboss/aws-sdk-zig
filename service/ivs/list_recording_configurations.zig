...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRecordingConfigurationsInput, options: CallOptions) !ListRecordingConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRecordingConfigurationsInput, config: *aws.Config) !aws.http.Request {
