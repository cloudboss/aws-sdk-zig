...
pub const DeleteLexiconInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLexiconInput, options: Options) !DeleteLexiconOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLexiconInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLexiconOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLexiconOutput = .{};
