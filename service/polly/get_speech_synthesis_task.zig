...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSpeechSynthesisTaskInput, options: CallOptions) !GetSpeechSynthesisTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSpeechSynthesisTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/v1/synthesisTasks/");
