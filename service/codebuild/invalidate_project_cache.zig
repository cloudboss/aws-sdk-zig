...
fn serializeRequest(alloc: std.mem.Allocator, input: InvalidateProjectCacheInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeBuild_20161006.InvalidateProjectCache");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !InvalidateProjectCacheOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
