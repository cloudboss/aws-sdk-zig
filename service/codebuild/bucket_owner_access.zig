...
/// the bucket has
/// access to these objects. This property allows you to give the bucket owner
/// access to
/// these objects.
///
...
/// ownership of uploaded objects using S3
/// Object
/// Ownership](https://docs.aws.amazon.com/AmazonS3/latest/userguide/about-object-ownership.html) in the *Amazon Simple Storage Service User
/// Guide*.
pub const BucketOwnerAccess = enum {
    none,
    read_only,
    full,
