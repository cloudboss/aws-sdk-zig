...
const FleetSortByType = @import("fleet_sort_by_type.zig").FleetSortByType;
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFleetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeBuild_20161006.ListFleets");
