...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetNetworkInput, options: CallOptions) !GetNetworkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetNetworkInput, config: *aws.Config) !aws.http.Request {
