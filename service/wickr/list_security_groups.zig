...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSecurityGroupsInput, options: CallOptions) !ListSecurityGroupsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSecurityGroupsInput, config: *aws.Config) !aws.http.Request {
