...
pub const Client = struct {
    ...
    pub fn batchCreateUser(self: *Self, allocator: std.mem.Allocator, input: batch_create_user.BatchCreateUserInput, options: CallOptions) !batch_create_user.BatchCreateUserOutput {
    ...
    /// network.
    pub fn batchDeleteUser(self: *Self, allocator: std.mem.Allocator, input: batch_delete_user.BatchDeleteUserInput, options: CallOptions) !batch_delete_user.BatchDeleteUserOutput {
    ...
    pub fn batchLookupUserUname(self: *Self, allocator: std.mem.Allocator, input: batch_lookup_user_uname.BatchLookupUserUnameInput, options: CallOptions) !batch_lookup_user_uname.BatchLookupUserUnameOutput {
    ...
    pub fn batchReinviteUser(self: *Self, allocator: std.mem.Allocator, input: batch_reinvite_user.BatchReinviteUserInput, options: CallOptions) !batch_reinvite_user.BatchReinviteUserOutput {
    ...
    /// to be revoked.
    pub fn batchResetDevicesForUser(self: *Self, allocator: std.mem.Allocator, input: batch_reset_devices_for_user.BatchResetDevicesForUserInput, options: CallOptions) !batch_reset_devices_for_user.BatchResetDevicesForUserOutput {
    ...
    pub fn batchToggleUserSuspendStatus(self: *Self, allocator: std.mem.Allocator, input: batch_toggle_user_suspend_status.BatchToggleUserSuspendStatusInput, options: CallOptions) !batch_toggle_user_suspend_status.BatchToggleUserSuspendStatusOutput {
    ...
    pub fn createDataRetentionBot(self: *Self, allocator: std.mem.Allocator, input: create_data_retention_bot.CreateDataRetentionBotInput, options: CallOptions) !create_data_retention_bot.CreateDataRetentionBotOutput {
    ...
    pub fn createDataRetentionBotChallenge(self: *Self, allocator: std.mem.Allocator, input: create_data_retention_bot_challenge.CreateDataRetentionBotChallengeInput, options: CallOptions) !create_data_retention_bot_challenge.CreateDataRetentionBotChallengeOutput {
    ...
    pub fn deleteDataRetentionBot(self: *Self, allocator: std.mem.Allocator, input: delete_data_retention_bot.DeleteDataRetentionBotInput, options: CallOptions) !delete_data_retention_bot.DeleteDataRetentionBotOutput {
    ...
    pub fn getBotsCount(self: *Self, allocator: std.mem.Allocator, input: get_bots_count.GetBotsCountInput, options: CallOptions) !get_bots_count.GetBotsCountOutput {
    ...
    pub fn getDataRetentionBot(self: *Self, allocator: std.mem.Allocator, input: get_data_retention_bot.GetDataRetentionBotInput, options: CallOptions) !get_data_retention_bot.GetDataRetentionBotOutput {
    ...
    pub fn getGuestUserHistoryCount(self: *Self, allocator: std.mem.Allocator, input: get_guest_user_history_count.GetGuestUserHistoryCountInput, options: CallOptions) !get_guest_user_history_count.GetGuestUserHistoryCountOutput {
    ...
    pub fn getOidcInfo(self: *Self, allocator: std.mem.Allocator, input: get_oidc_info.GetOidcInfoInput, options: CallOptions) !get_oidc_info.GetOidcInfoOutput {
    ...
    pub fn getUsersCount(self: *Self, allocator: std.mem.Allocator, input: get_users_count.GetUsersCountInput, options: CallOptions) !get_users_count.GetUsersCountOutput {
    ...
    pub fn listBlockedGuestUsers(self: *Self, allocator: std.mem.Allocator, input: list_blocked_guest_users.ListBlockedGuestUsersInput, options: CallOptions) !list_blocked_guest_users.ListBlockedGuestUsersOutput {
    ...
    pub fn listDevicesForUser(self: *Self, allocator: std.mem.Allocator, input: list_devices_for_user.ListDevicesForUserInput, options: CallOptions) !list_devices_for_user.ListDevicesForUserOutput {
    ...
    pub fn listGuestUsers(self: *Self, allocator: std.mem.Allocator, input: list_guest_users.ListGuestUsersInput, options: CallOptions) !list_guest_users.ListGuestUsersOutput {
    ...
    /// in a Wickr network.
    pub fn listSecurityGroupUsers(self: *Self, allocator: std.mem.Allocator, input: list_security_group_users.ListSecurityGroupUsersInput, options: CallOptions) !list_security_group_users.ListSecurityGroupUsersOutput {
    ...
    pub fn listSecurityGroups(self: *Self, allocator: std.mem.Allocator, input: list_security_groups.ListSecurityGroupsInput, options: CallOptions) !list_security_groups.ListSecurityGroupsOutput {
    ...
    /// provider.
    pub fn registerOidcConfig(self: *Self, allocator: std.mem.Allocator, input: register_oidc_config.RegisterOidcConfigInput, options: CallOptions) !register_oidc_config.RegisterOidcConfigOutput {
    ...
    pub fn updateGuestUser(self: *Self, allocator: std.mem.Allocator, input: update_guest_user.UpdateGuestUserInput, options: CallOptions) !update_guest_user.UpdateGuestUserOutput {
    ...
    pub fn updateSecurityGroup(self: *Self, allocator: std.mem.Allocator, input: update_security_group.UpdateSecurityGroupInput, options: CallOptions) !update_security_group.UpdateSecurityGroupOutput {
