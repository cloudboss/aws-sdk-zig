...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBlockedGuestUsersInput, options: CallOptions) !ListBlockedGuestUsersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBlockedGuestUsersInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/guest-users/blocklist");
    ...
    if (input.admin) |v| {
        ...
        try query_buf.appendSlice(allocator, "admin=");
