...
pub const CreateDataRetentionBotInput = struct {
...
pub const CreateDataRetentionBotOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDataRetentionBotInput, options: CallOptions) !CreateDataRetentionBotOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDataRetentionBotInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateDataRetentionBotOutput {
    var result: CreateDataRetentionBotOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateDataRetentionBotOutput, body, allocator);
    }
    _ = status;
    _ = headers;
