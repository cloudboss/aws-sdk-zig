...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSecurityGroupInput, options: CallOptions) !GetSecurityGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSecurityGroupInput, config: *aws.Config) !aws.http.Request {
