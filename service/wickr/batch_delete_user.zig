...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDeleteUserInput, options: CallOptions) !BatchDeleteUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchDeleteUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/users/batch-delete");
