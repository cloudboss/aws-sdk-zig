...
const NotificationWithSubscribers = @import("notification_with_subscribers.zig").NotificationWithSubscribers;
...
pub const CreateBudgetInput = struct {
    ...
    notifications_with_subscribers: ?[]const NotificationWithSubscribers = null,
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateBudgetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSBudgetServiceGateway.CreateBudget");
