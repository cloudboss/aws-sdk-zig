...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSubscribersForNotificationInput, options: Options) !DescribeSubscribersForNotificationOutput {
