...
pub const Client = struct {
    ...
    pub fn createBudgetAction(self: *Self, allocator: std.mem.Allocator, input: create_budget_action.CreateBudgetActionInput, options: CallOptions) !create_budget_action.CreateBudgetActionOutput {
    ...
    pub fn deleteBudgetAction(self: *Self, allocator: std.mem.Allocator, input: delete_budget_action.DeleteBudgetActionInput, options: CallOptions) !delete_budget_action.DeleteBudgetActionOutput {
    ...
    pub fn describeBudget(self: *Self, allocator: std.mem.Allocator, input: describe_budget.DescribeBudgetInput, options: CallOptions) !describe_budget.DescribeBudgetOutput {
        return describe_budget.execute(self, allocator, input, options);
    }

    /// Describes a budget action detail.
    pub fn describeBudgetAction(self: *Self, allocator: std.mem.Allocator, input: describe_budget_action.DescribeBudgetActionInput, options: CallOptions) !describe_budget_action.DescribeBudgetActionOutput {
        return describe_budget_action.execute(self, allocator, input, options);
    }

    /// Describes a budget action history detail.
    pub fn describeBudgetActionHistories(self: *Self, allocator: std.mem.Allocator, input: describe_budget_action_histories.DescribeBudgetActionHistoriesInput, options: CallOptions) !describe_budget_action_histories.DescribeBudgetActionHistoriesOutput {
        return describe_budget_action_histories.execute(self, allocator, input, options);
    }

    /// Describes all of the budget actions for an account.
    pub fn describeBudgetActionsForAccount(self: *Self, allocator: std.mem.Allocator, input: describe_budget_actions_for_account.DescribeBudgetActionsForAccountInput, options: CallOptions) !describe_budget_actions_for_account.DescribeBudgetActionsForAccountOutput {
        return describe_budget_actions_for_account.execute(self, allocator, input, options);
    }

    /// Describes all of the budget actions for a budget.
    pub fn describeBudgetActionsForBudget(self: *Self, allocator: std.mem.Allocator, input: describe_budget_actions_for_budget.DescribeBudgetActionsForBudgetInput, options: CallOptions) !describe_budget_actions_for_budget.DescribeBudgetActionsForBudgetOutput {
    ...
    /// account.
    pub fn describeBudgetNotificationsForAccount(self: *Self, allocator: std.mem.Allocator, input: describe_budget_notifications_for_account.DescribeBudgetNotificationsForAccountInput, options: CallOptions) !describe_budget_notifications_for_account.DescribeBudgetNotificationsForAccountOutput {
    ...
    pub fn describeBudgetPerformanceHistory(self: *Self, allocator: std.mem.Allocator, input: describe_budget_performance_history.DescribeBudgetPerformanceHistoryInput, options: CallOptions) !describe_budget_performance_history.DescribeBudgetPerformanceHistoryOutput {
    ...
    pub fn describeBudgets(self: *Self, allocator: std.mem.Allocator, input: describe_budgets.DescribeBudgetsInput, options: CallOptions) !describe_budgets.DescribeBudgetsOutput {
        return describe_budgets.execute(self, allocator, input, options);
    }

    /// Lists the notifications that are associated with a budget.
    pub fn describeNotificationsForBudget(self: *Self, allocator: std.mem.Allocator, input: describe_notifications_for_budget.DescribeNotificationsForBudgetInput, options: CallOptions) !describe_notifications_for_budget.DescribeNotificationsForBudgetOutput {
        return describe_notifications_for_budget.execute(self, allocator, input, options);
    }

    /// Lists the subscribers that are associated with a notification.
    pub fn describeSubscribersForNotification(self: *Self, allocator: std.mem.Allocator, input: describe_subscribers_for_notification.DescribeSubscribersForNotificationInput, options: CallOptions) !describe_subscribers_for_notification.DescribeSubscribersForNotificationOutput {
        return describe_subscribers_for_notification.execute(self, allocator, input, options);
    }

    /// Executes a budget action.
    pub fn executeBudgetAction(self: *Self, allocator: std.mem.Allocator, input: execute_budget_action.ExecuteBudgetActionInput, options: CallOptions) !execute_budget_action.ExecuteBudgetActionOutput {
    ...
    pub fn updateBudgetAction(self: *Self, allocator: std.mem.Allocator, input: update_budget_action.UpdateBudgetActionInput, options: CallOptions) !update_budget_action.UpdateBudgetActionOutput {
        return update_budget_action.execute(self, allocator, input, options);
    }

    /// Updates a notification.
    pub fn updateNotification(self: *Self, allocator: std.mem.Allocator, input: update_notification.UpdateNotificationInput, options: CallOptions) !update_notification.UpdateNotificationOutput {
