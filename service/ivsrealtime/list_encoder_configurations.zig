...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEncoderConfigurationsInput, options: CallOptions) !ListEncoderConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEncoderConfigurationsInput, config: *aws.Config) !aws.http.Request {
