...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListStagesInput, options: CallOptions) !ListStagesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListStagesInput, config: *aws.Config) !aws.http.Request {
