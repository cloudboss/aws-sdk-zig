...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEncoderConfigurationInput, options: CallOptions) !GetEncoderConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetEncoderConfigurationInput, config: *aws.Config) !aws.http.Request {
