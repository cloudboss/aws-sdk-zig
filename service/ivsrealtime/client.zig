...
pub const Client = struct {
    ...
    pub fn createEncoderConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_encoder_configuration.CreateEncoderConfigurationInput, options: CallOptions) !create_encoder_configuration.CreateEncoderConfigurationOutput {
    ...
    pub fn createIngestConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_ingest_configuration.CreateIngestConfigurationInput, options: CallOptions) !create_ingest_configuration.CreateIngestConfigurationOutput {
    ...
    /// application.
    pub fn createParticipantToken(self: *Self, allocator: std.mem.Allocator, input: create_participant_token.CreateParticipantTokenInput, options: CallOptions) !create_participant_token.CreateParticipantTokenOutput {
    ...
    pub fn deleteIngestConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_ingest_configuration.DeleteIngestConfigurationInput, options: CallOptions) !delete_ingest_configuration.DeleteIngestConfigurationOutput {
    ...
    pub fn getComposition(self: *Self, allocator: std.mem.Allocator, input: get_composition.GetCompositionInput, options: CallOptions) !get_composition.GetCompositionOutput {
        return get_composition.execute(self, allocator, input, options);
    }

    /// Gets information about the specified EncoderConfiguration resource.
    pub fn getEncoderConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_encoder_configuration.GetEncoderConfigurationInput, options: CallOptions) !get_encoder_configuration.GetEncoderConfigurationOutput {
        return get_encoder_configuration.execute(self, allocator, input, options);
    }

    /// Gets information about the specified IngestConfiguration.
    pub fn getIngestConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_ingest_configuration.GetIngestConfigurationInput, options: CallOptions) !get_ingest_configuration.GetIngestConfigurationOutput {
        return get_ingest_configuration.execute(self, allocator, input, options);
    }

    /// Gets information about the specified participant token.
    pub fn getParticipant(self: *Self, allocator: std.mem.Allocator, input: get_participant.GetParticipantInput, options: CallOptions) !get_participant.GetParticipantOutput {
    ...
    pub fn getStageSession(self: *Self, allocator: std.mem.Allocator, input: get_stage_session.GetStageSessionInput, options: CallOptions) !get_stage_session.GetStageSessionOutput {
        return get_stage_session.execute(self, allocator, input, options);
    }

    /// Gets the storage configuration for the specified ARN.
    pub fn getStorageConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_storage_configuration.GetStorageConfigurationInput, options: CallOptions) !get_storage_configuration.GetStorageConfigurationOutput {
        return get_storage_configuration.execute(self, allocator, input, options);
    }

    /// Import a public key to be used for signing stage participant tokens.
    pub fn importPublicKey(self: *Self, allocator: std.mem.Allocator, input: import_public_key.ImportPublicKeyInput, options: CallOptions) !import_public_key.ImportPublicKeyOutput {
    ...
    pub fn listIngestConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_ingest_configurations.ListIngestConfigurationsInput, options: CallOptions) !list_ingest_configurations.ListIngestConfigurationsOutput {
    ...
    pub fn listParticipantReplicas(self: *Self, allocator: std.mem.Allocator, input: list_participant_replicas.ListParticipantReplicasInput, options: CallOptions) !list_participant_replicas.ListParticipantReplicasOutput {
        return list_participant_replicas.execute(self, allocator, input, options);
    }

    /// Lists all participants in a specified stage session.
    pub fn listParticipants(self: *Self, allocator: std.mem.Allocator, input: list_participants.ListParticipantsInput, options: CallOptions) !list_participants.ListParticipantsOutput {
    ...
    pub fn listStageSessions(self: *Self, allocator: std.mem.Allocator, input: list_stage_sessions.ListStageSessionsInput, options: CallOptions) !list_stage_sessions.ListStageSessionsOutput {
    ...
    pub fn listStorageConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_storage_configurations.ListStorageConfigurationsInput, options: CallOptions) !list_storage_configurations.ListStorageConfigurationsOutput {
    ...
    /// destination stage.
    pub fn startParticipantReplication(self: *Self, allocator: std.mem.Allocator, input: start_participant_replication.StartParticipantReplicationInput, options: CallOptions) !start_participant_replication.StartParticipantReplicationOutput {
    ...
    pub fn stopParticipantReplication(self: *Self, allocator: std.mem.Allocator, input: stop_participant_replication.StopParticipantReplicationInput, options: CallOptions) !stop_participant_replication.StopParticipantReplicationOutput {
    ...
    /// cannot be updated.
    pub fn updateIngestConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_ingest_configuration.UpdateIngestConfigurationInput, options: CallOptions) !update_ingest_configuration.UpdateIngestConfigurationOutput {
