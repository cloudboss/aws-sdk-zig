...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIngestConfigurationInput, options: CallOptions) !GetIngestConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetIngestConfigurationInput, config: *aws.Config) !aws.http.Request {
