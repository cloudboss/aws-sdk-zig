...
pub const GetIngestConfigurationInput = struct {
...
pub const GetIngestConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIngestConfigurationInput, options: Options) !GetIngestConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetIngestConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/GetIngestConfiguration";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetIngestConfigurationOutput {
    var result: GetIngestConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetIngestConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
