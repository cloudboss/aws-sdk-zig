...
pub const DeleteIngestConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIngestConfigurationInput, options: Options) !DeleteIngestConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIngestConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteIngestConfiguration";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIngestConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteIngestConfigurationOutput = .{};
