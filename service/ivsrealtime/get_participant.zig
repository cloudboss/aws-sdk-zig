...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetParticipantInput, options: CallOptions) !GetParticipantOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetParticipantInput, config: *aws.Config) !aws.http.Request {
