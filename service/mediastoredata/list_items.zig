...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListItemsInput, options: CallOptions) !ListItemsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListItemsInput, config: *aws.Config) !aws.http.Request {
