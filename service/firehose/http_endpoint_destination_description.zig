...
const HttpEndpointDescription = @import("http_endpoint_description.zig").HttpEndpointDescription;
...
pub const HttpEndpointDestinationDescription = struct {
    ...
    endpoint_configuration: ?HttpEndpointDescription = null,
