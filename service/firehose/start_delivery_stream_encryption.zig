...
fn serializeRequest(alloc: std.mem.Allocator, input: StartDeliveryStreamEncryptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Firehose_20150804.StartDeliveryStreamEncryption");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartDeliveryStreamEncryptionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
