...
pub const OrcSerDe = struct {
    ...
    /// default is `null`.
    bloom_filter_columns: ?[]const []const u8,
    ...
    /// is 1.
    bloom_filter_false_positive_probability: ?f64,
