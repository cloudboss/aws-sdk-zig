...
pub const Client = struct {
    ...
    pub fn putDialRequestBatch(self: *Self, allocator: std.mem.Allocator, input: put_dial_request_batch.PutDialRequestBatchInput, options: CallOptions) !put_dial_request_batch.PutDialRequestBatchOutput {
    ...
    pub fn updateCampaignDialerConfig(self: *Self, allocator: std.mem.Allocator, input: update_campaign_dialer_config.UpdateCampaignDialerConfigInput, options: CallOptions) !update_campaign_dialer_config.UpdateCampaignDialerConfigOutput {
    ...
    pub fn updateCampaignOutboundCallConfig(self: *Self, allocator: std.mem.Allocator, input: update_campaign_outbound_call_config.UpdateCampaignOutboundCallConfigInput, options: CallOptions) !update_campaign_outbound_call_config.UpdateCampaignOutboundCallConfigOutput {
