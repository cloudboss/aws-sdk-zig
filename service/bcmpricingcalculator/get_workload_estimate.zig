...
fn serializeRequest(alloc: std.mem.Allocator, input: GetWorkloadEstimateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSBCMPricingCalculator.GetWorkloadEstimate");
