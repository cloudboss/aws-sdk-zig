...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBillScenarioUsageModificationsInput, options: Options) !ListBillScenarioUsageModificationsOutput {
