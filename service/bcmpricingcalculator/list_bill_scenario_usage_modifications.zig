...
pub const ListBillScenarioUsageModificationsInput = struct {
...
pub const ListBillScenarioUsageModificationsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBillScenarioUsageModificationsInput, options: CallOptions) !ListBillScenarioUsageModificationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBillScenarioUsageModificationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSBCMPricingCalculator.ListBillScenarioUsageModifications");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListBillScenarioUsageModificationsOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListBillScenarioUsageModificationsOutput, body, allocator);
}
