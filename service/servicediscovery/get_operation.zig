...
const GetOperationInput = @import("get_operation_request.zig").GetOperationRequest;

const GetOperationOutput = @import("get_operation_response.zig").GetOperationResponse;
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetOperationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Route53AutoNaming_v20170314.GetOperation");
