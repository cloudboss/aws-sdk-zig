...
const OperationFilterName = @import("operation_filter_name.zig").OperationFilterName;

/// A complex type that lets you select the operations that you want to list.
pub const OperationFilter = struct {
    ...
    /// `TYPE`. An operation must match one of the specified values to be returned
    /// in the
    /// response.
    ///
