...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServiceAttributesInput, options: Options) !DeleteServiceAttributesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteServiceAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Route53AutoNaming_v20170314.DeleteServiceAttributes");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteServiceAttributesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
