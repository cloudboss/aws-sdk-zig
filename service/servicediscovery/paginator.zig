...
pub const GetInstancesHealthStatusPaginator = struct {
    client: *Client,
    params: get_instances_health_status.GetInstancesHealthStatusInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_instances_health_status.GetInstancesHealthStatusOutput {
        if (self.done) {
        ...
        const output = try get_instances_health_status.execute(self.client, allocator, self.params, options);
