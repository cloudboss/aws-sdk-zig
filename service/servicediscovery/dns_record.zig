...
pub const DnsRecord = struct {
    ...
    /// Amazon Web Services resource that an
    /// alias record routes traffic to. If you include the `AWS_ALIAS_DNS_NAME`
    /// attribute
    /// when you submit a
    /// [RegisterInstance](https://docs.aws.amazon.com/cloud-map/latest/api/API_RegisterInstance.html) request, the
    ...
    /// [Attributes](https://docs.aws.amazon.com/cloud-map/latest/api/API_RegisterInstance.html#cloudmap-RegisterInstance-request-Attributes) in the topic [RegisterInstance](https://docs.aws.amazon.com/cloud-map/latest/api/API_RegisterInstance.html).
    ///
