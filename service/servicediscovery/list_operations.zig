...
pub const ListOperationsInput = @import("list_operations_request.zig").ListOperationsRequest;

pub const ListOperationsOutput = @import("list_operations_response.zig").ListOperationsResponse;
