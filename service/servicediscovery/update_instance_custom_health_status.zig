...
const UpdateInstanceCustomHealthStatusOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateInstanceCustomHealthStatusInput, options: Options) !UpdateInstanceCustomHealthStatusOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateInstanceCustomHealthStatusInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Route53AutoNaming_v20170314.UpdateInstanceCustomHealthStatus");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateInstanceCustomHealthStatusOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
