...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMultiRegionParameterGroupsInput, options: Options) !DescribeMultiRegionParameterGroupsOutput {
