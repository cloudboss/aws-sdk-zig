...
pub const Client = struct {
    ...
    pub fn batchUpdateCluster(self: *Self, allocator: std.mem.Allocator, input: batch_update_cluster.BatchUpdateClusterInput, options: CallOptions) !batch_update_cluster.BatchUpdateClusterOutput {
    ...
    pub fn createAcl(self: *Self, allocator: std.mem.Allocator, input: create_acl.CreateACLInput, options: CallOptions) !create_acl.CreateACLOutput {
    ...
    pub fn createMultiRegionCluster(self: *Self, allocator: std.mem.Allocator, input: create_multi_region_cluster.CreateMultiRegionClusterInput, options: CallOptions) !create_multi_region_cluster.CreateMultiRegionClusterOutput {
    ...
    pub fn createParameterGroup(self: *Self, allocator: std.mem.Allocator, input: create_parameter_group.CreateParameterGroupInput, options: CallOptions) !create_parameter_group.CreateParameterGroupOutput {
    ...
    pub fn createSubnetGroup(self: *Self, allocator: std.mem.Allocator, input: create_subnet_group.CreateSubnetGroupInput, options: CallOptions) !create_subnet_group.CreateSubnetGroupOutput {
    ...
    /// users with Access Contol Lists
    /// (ACLs)](https://docs.aws.amazon.com/MemoryDB/latest/devguide/clusters.acls.html).
    pub fn deleteAcl(self: *Self, allocator: std.mem.Allocator, input: delete_acl.DeleteACLInput, options: CallOptions) !delete_acl.DeleteACLOutput {
    ...
    pub fn deleteMultiRegionCluster(self: *Self, allocator: std.mem.Allocator, input: delete_multi_region_cluster.DeleteMultiRegionClusterInput, options: CallOptions) !delete_multi_region_cluster.DeleteMultiRegionClusterOutput {
    ...
    pub fn deleteParameterGroup(self: *Self, allocator: std.mem.Allocator, input: delete_parameter_group.DeleteParameterGroupInput, options: CallOptions) !delete_parameter_group.DeleteParameterGroupOutput {
    ...
    pub fn deleteSubnetGroup(self: *Self, allocator: std.mem.Allocator, input: delete_subnet_group.DeleteSubnetGroupInput, options: CallOptions) !delete_subnet_group.DeleteSubnetGroupOutput {
    ...
    pub fn describeAcLs(self: *Self, allocator: std.mem.Allocator, input: describe_ac_ls.DescribeACLsInput, options: CallOptions) !describe_ac_ls.DescribeACLsOutput {
    ...
    pub fn describeMultiRegionClusters(self: *Self, allocator: std.mem.Allocator, input: describe_multi_region_clusters.DescribeMultiRegionClustersInput, options: CallOptions) !describe_multi_region_clusters.DescribeMultiRegionClustersOutput {
    ...
    pub fn describeMultiRegionParameterGroups(self: *Self, allocator: std.mem.Allocator, input: describe_multi_region_parameter_groups.DescribeMultiRegionParameterGroupsInput, options: CallOptions) !describe_multi_region_parameter_groups.DescribeMultiRegionParameterGroupsOutput {
    ...
    /// group.
    pub fn describeMultiRegionParameters(self: *Self, allocator: std.mem.Allocator, input: describe_multi_region_parameters.DescribeMultiRegionParametersInput, options: CallOptions) !describe_multi_region_parameters.DescribeMultiRegionParametersOutput {
    ...
    pub fn describeParameterGroups(self: *Self, allocator: std.mem.Allocator, input: describe_parameter_groups.DescribeParameterGroupsInput, options: CallOptions) !describe_parameter_groups.DescribeParameterGroupsOutput {
    ...
    pub fn describeReservedNodesOfferings(self: *Self, allocator: std.mem.Allocator, input: describe_reserved_nodes_offerings.DescribeReservedNodesOfferingsInput, options: CallOptions) !describe_reserved_nodes_offerings.DescribeReservedNodesOfferingsOutput {
    ...
    pub fn describeSubnetGroups(self: *Self, allocator: std.mem.Allocator, input: describe_subnet_groups.DescribeSubnetGroupsInput, options: CallOptions) !describe_subnet_groups.DescribeSubnetGroupsOutput {
    ...
    /// this API.
    pub fn failoverShard(self: *Self, allocator: std.mem.Allocator, input: failover_shard.FailoverShardInput, options: CallOptions) !failover_shard.FailoverShardOutput {
        return failover_shard.execute(self, allocator, input, options);
    }

    /// Lists the allowed updates for a multi-Region cluster.
    pub fn listAllowedMultiRegionClusterUpdates(self: *Self, allocator: std.mem.Allocator, input: list_allowed_multi_region_cluster_updates.ListAllowedMultiRegionClusterUpdatesInput, options: CallOptions) !list_allowed_multi_region_cluster_updates.ListAllowedMultiRegionClusterUpdatesOutput {
    ...
    /// operation.
    pub fn listAllowedNodeTypeUpdates(self: *Self, allocator: std.mem.Allocator, input: list_allowed_node_type_updates.ListAllowedNodeTypeUpdatesInput, options: CallOptions) !list_allowed_node_type_updates.ListAllowedNodeTypeUpdatesOutput {
    ...
    pub fn purchaseReservedNodesOffering(self: *Self, allocator: std.mem.Allocator, input: purchase_reserved_nodes_offering.PurchaseReservedNodesOfferingInput, options: CallOptions) !purchase_reserved_nodes_offering.PurchaseReservedNodesOfferingOutput {
    ...
    pub fn resetParameterGroup(self: *Self, allocator: std.mem.Allocator, input: reset_parameter_group.ResetParameterGroupInput, options: CallOptions) !reset_parameter_group.ResetParameterGroupOutput {
    ...
    pub fn updateAcl(self: *Self, allocator: std.mem.Allocator, input: update_acl.UpdateACLInput, options: CallOptions) !update_acl.UpdateACLOutput {
    ...
    pub fn updateMultiRegionCluster(self: *Self, allocator: std.mem.Allocator, input: update_multi_region_cluster.UpdateMultiRegionClusterInput, options: CallOptions) !update_multi_region_cluster.UpdateMultiRegionClusterOutput {
    ...
    /// pairs.
    pub fn updateParameterGroup(self: *Self, allocator: std.mem.Allocator, input: update_parameter_group.UpdateParameterGroupInput, options: CallOptions) !update_parameter_group.UpdateParameterGroupOutput {
    ...
    pub fn updateSubnetGroup(self: *Self, allocator: std.mem.Allocator, input: update_subnet_group.UpdateSubnetGroupInput, options: CallOptions) !update_subnet_group.UpdateSubnetGroupOutput {
