...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReservedNodesOfferingsInput, options: Options) !DescribeReservedNodesOfferingsOutput {
