...
pub const DescribeACLsPaginator = struct {
    client: *Client,
    params: describe_ac_ls.DescribeACLsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_ac_ls.DescribeACLsOutput {
        if (self.done) {
...
pub const DescribeMultiRegionClustersPaginator = struct {
    client: *Client,
    params: describe_multi_region_clusters.DescribeMultiRegionClustersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_multi_region_clusters.DescribeMultiRegionClustersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const DescribeParameterGroupsPaginator = struct {
    client: *Client,
    params: describe_parameter_groups.DescribeParameterGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_parameter_groups.DescribeParameterGroupsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const DescribeReservedNodesOfferingsPaginator = struct {
    client: *Client,
    params: describe_reserved_nodes_offerings.DescribeReservedNodesOfferingsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_reserved_nodes_offerings.DescribeReservedNodesOfferingsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const DescribeSubnetGroupsPaginator = struct {
    client: *Client,
    params: describe_subnet_groups.DescribeSubnetGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_subnet_groups.DescribeSubnetGroupsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
