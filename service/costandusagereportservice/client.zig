...
pub const Client = struct {
    ...
    /// account.
    pub fn describeReportDefinitions(self: *Self, allocator: std.mem.Allocator, input: describe_report_definitions.DescribeReportDefinitionsInput, options: describe_report_definitions.Options) !describe_report_definitions.DescribeReportDefinitionsOutput {
    ...
    pub fn modifyReportDefinition(self: *Self, allocator: std.mem.Allocator, input: modify_report_definition.ModifyReportDefinitionInput, options: modify_report_definition.Options) !modify_report_definition.ModifyReportDefinitionOutput {
