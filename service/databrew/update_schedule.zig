...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateScheduleInput, options: CallOptions) !UpdateScheduleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateScheduleInput, config: *aws.Config) !aws.http.Request {
