...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRecipeVersionInput, options: CallOptions) !DeleteRecipeVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRecipeVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/recipeVersion/");
    try path_buf.appendSlice(allocator, input.recipe_version);
