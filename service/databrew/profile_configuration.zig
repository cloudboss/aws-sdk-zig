...
pub const ProfileConfiguration = struct {
    ...
    column_statistics_configurations: ?[]const ColumnStatisticsConfiguration,
    ...
    dataset_statistics_configuration: ?StatisticsConfiguration,
    ...
    /// columns.
    profile_columns: ?[]const ColumnSelector,
