...
pub const ListRecipeVersionsPaginator = struct {
    client: *Client,
    params: list_recipe_versions.ListRecipeVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_recipe_versions.ListRecipeVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListRulesetsPaginator = struct {
    client: *Client,
    params: list_rulesets.ListRulesetsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_rulesets.ListRulesetsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSchedulesPaginator = struct {
    client: *Client,
    params: list_schedules.ListSchedulesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
