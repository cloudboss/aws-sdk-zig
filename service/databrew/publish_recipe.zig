...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PublishRecipeInput, options: CallOptions) !PublishRecipeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PublishRecipeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/publishRecipe");
