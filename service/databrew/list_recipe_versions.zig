...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRecipeVersionsInput, options: CallOptions) !ListRecipeVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRecipeVersionsInput, config: *aws.Config) !aws.http.Request {
