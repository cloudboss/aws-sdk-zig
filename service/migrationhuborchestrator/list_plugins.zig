...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPluginsInput, options: CallOptions) !ListPluginsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPluginsInput, config: *aws.Config) !aws.http.Request {
