...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BeginTransactionInput, options: CallOptions) !BeginTransactionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BeginTransactionInput, config: *aws.Config) !aws.http.Request {
