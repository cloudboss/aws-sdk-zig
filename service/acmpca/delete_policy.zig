...
pub const DeletePolicyInput = struct {
    ...
    /// deleted. You can find the CA's ARN by calling the
    /// [ListCertificateAuthorities](https://docs.aws.amazon.com/privateca/latest/APIReference/API_ListCertificateAuthorities.html) action. The ARN value must have the form `arn:aws:acm-pca:region:account:certificate-authority/01234567-89ab-cdef-0123-0123456789ab`.
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ACMPrivateCA.DeletePolicy");
