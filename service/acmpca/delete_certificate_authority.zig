...
const DeleteCertificateAuthorityOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCertificateAuthorityInput, options: Options) !DeleteCertificateAuthorityOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCertificateAuthorityInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "ACMPrivateCA.DeleteCertificateAuthority");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCertificateAuthorityOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
