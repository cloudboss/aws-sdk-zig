...
/// in days, months, or years. For more information, see
/// [Validity](https://tools.ietf.org/html/rfc5280#section-4.1.2.5) in RFC 5280.
///
...
/// `IssueCertificate`:`ValidityNotBefore` specifies a customized starting time
...
pub const Validity = struct {
    ...
    /// format. When UTCTime is used, if the year field (YY) is greater than or
    /// equal to 50, the year is interpreted as 19YY. If the year field is less than
    /// 50, the year is interpreted as 20YY.
    ///
