...
const UpdateCertificateAuthorityOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCertificateAuthorityInput, options: Options) !UpdateCertificateAuthorityOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateCertificateAuthorityInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "ACMPrivateCA.UpdateCertificateAuthority");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateCertificateAuthorityOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
