...
pub const RestoreCertificateAuthorityInput = struct {
...
pub const RestoreCertificateAuthorityOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestoreCertificateAuthorityInput, options: CallOptions) !RestoreCertificateAuthorityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RestoreCertificateAuthorityInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ACMPrivateCA.RestoreCertificateAuthority");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RestoreCertificateAuthorityOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
