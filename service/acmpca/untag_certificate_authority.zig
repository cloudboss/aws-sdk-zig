...
pub const UntagCertificateAuthorityInput = struct {
...
const UntagCertificateAuthorityOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagCertificateAuthorityInput, options: Options) !UntagCertificateAuthorityOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UntagCertificateAuthorityInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "ACMPrivateCA.UntagCertificateAuthority");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UntagCertificateAuthorityOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
