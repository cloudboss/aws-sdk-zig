...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateTargetAccountConfigurationInput, options: Options) !UpdateTargetAccountConfigurationOutput {
