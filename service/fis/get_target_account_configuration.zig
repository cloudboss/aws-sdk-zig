...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTargetAccountConfigurationInput, options: CallOptions) !GetTargetAccountConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTargetAccountConfigurationInput, config: *aws.Config) !aws.http.Request {
