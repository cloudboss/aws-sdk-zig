...
pub const Client = struct {
    ...
    /// application.
    pub fn createChatToken(self: *Self, allocator: std.mem.Allocator, input: create_chat_token.CreateChatTokenInput, options: CallOptions) !create_chat_token.CreateChatTokenOutput {
    ...
    pub fn disconnectUser(self: *Self, allocator: std.mem.Allocator, input: disconnect_user.DisconnectUserInput, options: CallOptions) !disconnect_user.DisconnectUserOutput {
