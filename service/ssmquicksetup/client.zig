...
pub const Client = struct {
    ...
    pub fn createConfigurationManager(self: *Self, allocator: std.mem.Allocator, input: create_configuration_manager.CreateConfigurationManagerInput, options: create_configuration_manager.Options) !create_configuration_manager.CreateConfigurationManagerOutput {
        return create_configuration_manager.execute(self, allocator, input, options);
    }

    /// Deletes a configuration manager.
    pub fn deleteConfigurationManager(self: *Self, allocator: std.mem.Allocator, input: delete_configuration_manager.DeleteConfigurationManagerInput, options: delete_configuration_manager.Options) !delete_configuration_manager.DeleteConfigurationManagerOutput {
    ...
    pub fn getConfigurationManager(self: *Self, allocator: std.mem.Allocator, input: get_configuration_manager.GetConfigurationManagerInput, options: get_configuration_manager.Options) !get_configuration_manager.GetConfigurationManagerOutput {
    ...
    pub fn listConfigurationManagers(self: *Self, allocator: std.mem.Allocator, input: list_configuration_managers.ListConfigurationManagersInput, options: list_configuration_managers.Options) !list_configuration_managers.ListConfigurationManagersOutput {
    ...
    pub fn listQuickSetupTypes(self: *Self, allocator: std.mem.Allocator, input: list_quick_setup_types.ListQuickSetupTypesInput, options: list_quick_setup_types.Options) !list_quick_setup_types.ListQuickSetupTypesOutput {
    ...
    pub fn updateConfigurationDefinition(self: *Self, allocator: std.mem.Allocator, input: update_configuration_definition.UpdateConfigurationDefinitionInput, options: update_configuration_definition.Options) !update_configuration_definition.UpdateConfigurationDefinitionOutput {
        return update_configuration_definition.execute(self, allocator, input, options);
    }

    /// Updates a Quick Setup configuration manager.
    pub fn updateConfigurationManager(self: *Self, allocator: std.mem.Allocator, input: update_configuration_manager.UpdateConfigurationManagerInput, options: update_configuration_manager.Options) !update_configuration_manager.UpdateConfigurationManagerOutput {
