...
pub const ConfigurationDefinitionInput = struct {
    ...
    /// configuration
    /// definitions vary based the configuration type. The following tables outline
    /// the
    ...
    /// deploy the configuration to.
    ///
    /// **Resource Explorer (Type: Amazon Web
    ...
    ///
    /// * Description: (Optional) The ID of the
    /// Amazon Web Services account where the Amazon SNS topic you want to use for
    /// notifications
