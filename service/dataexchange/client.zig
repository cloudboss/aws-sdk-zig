...
pub const Client = struct {
    ...
    pub fn acceptDataGrant(self: *Self, allocator: std.mem.Allocator, input: accept_data_grant.AcceptDataGrantInput, options: CallOptions) !accept_data_grant.AcceptDataGrantOutput {
    ...
    pub fn createDataGrant(self: *Self, allocator: std.mem.Allocator, input: create_data_grant.CreateDataGrantInput, options: CallOptions) !create_data_grant.CreateDataGrantOutput {
    ...
    pub fn createEventAction(self: *Self, allocator: std.mem.Allocator, input: create_event_action.CreateEventActionInput, options: CallOptions) !create_event_action.CreateEventActionOutput {
    ...
    pub fn createRevision(self: *Self, allocator: std.mem.Allocator, input: create_revision.CreateRevisionInput, options: CallOptions) !create_revision.CreateRevisionOutput {
    ...
    pub fn deleteDataGrant(self: *Self, allocator: std.mem.Allocator, input: delete_data_grant.DeleteDataGrantInput, options: CallOptions) !delete_data_grant.DeleteDataGrantOutput {
    ...
    pub fn deleteEventAction(self: *Self, allocator: std.mem.Allocator, input: delete_event_action.DeleteEventActionInput, options: CallOptions) !delete_event_action.DeleteEventActionOutput {
        return delete_event_action.execute(self, allocator, input, options);
    }

    /// This operation deletes a revision.
    pub fn deleteRevision(self: *Self, allocator: std.mem.Allocator, input: delete_revision.DeleteRevisionInput, options: CallOptions) !delete_revision.DeleteRevisionOutput {
    ...
    pub fn getDataGrant(self: *Self, allocator: std.mem.Allocator, input: get_data_grant.GetDataGrantInput, options: CallOptions) !get_data_grant.GetDataGrantOutput {
        return get_data_grant.execute(self, allocator, input, options);
    }

    /// This operation returns information about a data set.
    pub fn getDataSet(self: *Self, allocator: std.mem.Allocator, input: get_data_set.GetDataSetInput, options: CallOptions) !get_data_set.GetDataSetOutput {
        return get_data_set.execute(self, allocator, input, options);
    }

    /// This operation retrieves information about an event action.
    pub fn getEventAction(self: *Self, allocator: std.mem.Allocator, input: get_event_action.GetEventActionInput, options: CallOptions) !get_event_action.GetEventActionOutput {
    ...
    pub fn getReceivedDataGrant(self: *Self, allocator: std.mem.Allocator, input: get_received_data_grant.GetReceivedDataGrantInput, options: CallOptions) !get_received_data_grant.GetReceivedDataGrantOutput {
        return get_received_data_grant.execute(self, allocator, input, options);
    }

    /// This operation returns information about a revision.
    pub fn getRevision(self: *Self, allocator: std.mem.Allocator, input: get_revision.GetRevisionInput, options: CallOptions) !get_revision.GetRevisionOutput {
        return get_revision.execute(self, allocator, input, options);
    }

    /// This operation returns information about all data grants.
    pub fn listDataGrants(self: *Self, allocator: std.mem.Allocator, input: list_data_grants.ListDataGrantsInput, options: CallOptions) !list_data_grants.ListDataGrantsOutput {
    ...
    pub fn listEventActions(self: *Self, allocator: std.mem.Allocator, input: list_event_actions.ListEventActionsInput, options: CallOptions) !list_event_actions.ListEventActionsOutput {
    ...
    pub fn listReceivedDataGrants(self: *Self, allocator: std.mem.Allocator, input: list_received_data_grants.ListReceivedDataGrantsInput, options: CallOptions) !list_received_data_grants.ListReceivedDataGrantsOutput {
        return list_received_data_grants.execute(self, allocator, input, options);
    }

    /// This operation lists a revision's assets sorted alphabetically in descending
    /// order.
    pub fn listRevisionAssets(self: *Self, allocator: std.mem.Allocator, input: list_revision_assets.ListRevisionAssetsInput, options: CallOptions) !list_revision_assets.ListRevisionAssetsOutput {
    ...
    pub fn revokeRevision(self: *Self, allocator: std.mem.Allocator, input: revoke_revision.RevokeRevisionInput, options: CallOptions) !revoke_revision.RevokeRevisionOutput {
    ...
    pub fn sendDataSetNotification(self: *Self, allocator: std.mem.Allocator, input: send_data_set_notification.SendDataSetNotificationInput, options: CallOptions) !send_data_set_notification.SendDataSetNotificationOutput {
    ...
    pub fn updateEventAction(self: *Self, allocator: std.mem.Allocator, input: update_event_action.UpdateEventActionInput, options: CallOptions) !update_event_action.UpdateEventActionOutput {
        return update_event_action.execute(self, allocator, input, options);
    }

    /// This operation updates a revision.
    pub fn updateRevision(self: *Self, allocator: std.mem.Allocator, input: update_revision.UpdateRevisionInput, options: CallOptions) !update_revision.UpdateRevisionOutput {
