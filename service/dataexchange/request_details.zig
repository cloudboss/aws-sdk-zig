...
pub const RequestDetails = struct {
    ...
    create_s3_data_access_from_s3_bucket: ?CreateS3DataAccessFromS3BucketRequestDetails,

    /// Details about the export to Amazon S3 request.
    export_assets_to_s3: ?ExportAssetsToS3RequestDetails,

    /// Details about the export to signed URL request.
    export_asset_to_signed_url: ?ExportAssetToSignedUrlRequestDetails,

    /// Details about the export to Amazon S3 request.
    export_revisions_to_s3: ?ExportRevisionsToS3RequestDetails,

    /// Details about the import from signed URL request.
    import_asset_from_api_gateway_api: ?ImportAssetFromApiGatewayApiRequestDetails,

    /// Details about the import from Amazon S3 request.
    import_asset_from_signed_url: ?ImportAssetFromSignedUrlRequestDetails,

    /// Request details for the ImportAssetsFromLakeFormationTagPolicy job.
    import_assets_from_lake_formation_tag_policy: ?ImportAssetsFromLakeFormationTagPolicyRequestDetails,

    /// Details from an import from Amazon Redshift datashare request.
    import_assets_from_redshift_data_shares: ?ImportAssetsFromRedshiftDataSharesRequestDetails,

    /// Details about the import asset from API Gateway API request.
    import_assets_from_s3: ?ImportAssetsFromS3RequestDetails,
