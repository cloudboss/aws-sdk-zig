...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEventActionInput, options: CallOptions) !UpdateEventActionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateEventActionInput, config: *aws.Config) !aws.http.Request {
