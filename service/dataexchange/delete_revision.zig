...
pub const DeleteRevisionInput = struct {
...
pub const DeleteRevisionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRevisionInput, options: CallOptions) !DeleteRevisionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRevisionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRevisionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRevisionOutput = .{};
