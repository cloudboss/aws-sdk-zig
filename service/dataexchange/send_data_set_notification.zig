...
const NotificationDetails = @import("notification_details.zig").NotificationDetails;
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SendDataSetNotificationInput, options: Options) !SendDataSetNotificationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SendDataSetNotificationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SendDataSetNotificationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: SendDataSetNotificationOutput = .{};
