...
pub const DeleteProductPageInput = struct {
...
pub const DeleteProductPageOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProductPageInput, options: CallOptions) !DeleteProductPageOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProductPageInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteProductPageOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProductPageOutput = .{};
