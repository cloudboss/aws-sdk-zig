...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRouteResponseInput, options: CallOptions) !DeleteRouteResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRouteResponseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRouteResponseOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
