...
pub const Client = struct {
    ...
    pub fn createApiMapping(self: *Self, allocator: std.mem.Allocator, input: create_api_mapping.CreateApiMappingInput, options: create_api_mapping.Options) !create_api_mapping.CreateApiMappingOutput {
    ...
    pub fn createIntegrationResponse(self: *Self, allocator: std.mem.Allocator, input: create_integration_response.CreateIntegrationResponseInput, options: create_integration_response.Options) !create_integration_response.CreateIntegrationResponseOutput {
    ...
    pub fn createPortalProduct(self: *Self, allocator: std.mem.Allocator, input: create_portal_product.CreatePortalProductInput, options: create_portal_product.Options) !create_portal_product.CreatePortalProductOutput {
        return create_portal_product.execute(self, allocator, input, options);
    }

    /// Creates a new product page for a portal product.
    pub fn createProductPage(self: *Self, allocator: std.mem.Allocator, input: create_product_page.CreateProductPageInput, options: create_product_page.Options) !create_product_page.CreateProductPageOutput {
        return create_product_page.execute(self, allocator, input, options);
    }

    /// Creates a product REST endpoint page for a portal product.
    pub fn createProductRestEndpointPage(self: *Self, allocator: std.mem.Allocator, input: create_product_rest_endpoint_page.CreateProductRestEndpointPageInput, options: create_product_rest_endpoint_page.Options) !create_product_rest_endpoint_page.CreateProductRestEndpointPageOutput {
    ...
    pub fn createRouteResponse(self: *Self, allocator: std.mem.Allocator, input: create_route_response.CreateRouteResponseInput, options: create_route_response.Options) !create_route_response.CreateRouteResponseOutput {
        return create_route_response.execute(self, allocator, input, options);
    }

    /// Creates a RoutingRule.
    pub fn createRoutingRule(self: *Self, allocator: std.mem.Allocator, input: create_routing_rule.CreateRoutingRuleInput, options: create_routing_rule.Options) !create_routing_rule.CreateRoutingRuleOutput {
    ...
    pub fn deleteAccessLogSettings(self: *Self, allocator: std.mem.Allocator, input: delete_access_log_settings.DeleteAccessLogSettingsInput, options: delete_access_log_settings.Options) !delete_access_log_settings.DeleteAccessLogSettingsOutput {
    ...
    pub fn deleteApiMapping(self: *Self, allocator: std.mem.Allocator, input: delete_api_mapping.DeleteApiMappingInput, options: delete_api_mapping.Options) !delete_api_mapping.DeleteApiMappingOutput {
    ...
    pub fn deleteCorsConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_cors_configuration.DeleteCorsConfigurationInput, options: delete_cors_configuration.Options) !delete_cors_configuration.DeleteCorsConfigurationOutput {
    ...
    pub fn deletePortalProduct(self: *Self, allocator: std.mem.Allocator, input: delete_portal_product.DeletePortalProductInput, options: delete_portal_product.Options) !delete_portal_product.DeletePortalProductOutput {
        return delete_portal_product.execute(self, allocator, input, options);
    }

    /// Deletes the sharing policy for a portal product.
    pub fn deletePortalProductSharingPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_portal_product_sharing_policy.DeletePortalProductSharingPolicyInput, options: delete_portal_product_sharing_policy.Options) !delete_portal_product_sharing_policy.DeletePortalProductSharingPolicyOutput {
    ...
    pub fn deleteProductPage(self: *Self, allocator: std.mem.Allocator, input: delete_product_page.DeleteProductPageInput, options: delete_product_page.Options) !delete_product_page.DeleteProductPageOutput {
        return delete_product_page.execute(self, allocator, input, options);
    }

    /// Deletes a product REST endpoint page.
    pub fn deleteProductRestEndpointPage(self: *Self, allocator: std.mem.Allocator, input: delete_product_rest_endpoint_page.DeleteProductRestEndpointPageInput, options: delete_product_rest_endpoint_page.Options) !delete_product_rest_endpoint_page.DeleteProductRestEndpointPageOutput {
    ...
    pub fn deleteRouteRequestParameter(self: *Self, allocator: std.mem.Allocator, input: delete_route_request_parameter.DeleteRouteRequestParameterInput, options: delete_route_request_parameter.Options) !delete_route_request_parameter.DeleteRouteRequestParameterOutput {
        return delete_route_request_parameter.execute(self, allocator, input, options);
    }

    /// Deletes a RouteResponse.
    pub fn deleteRouteResponse(self: *Self, allocator: std.mem.Allocator, input: delete_route_response.DeleteRouteResponseInput, options: delete_route_response.Options) !delete_route_response.DeleteRouteResponseOutput {
        return delete_route_response.execute(self, allocator, input, options);
    }

    /// Deletes the RouteSettings for a stage.
    pub fn deleteRouteSettings(self: *Self, allocator: std.mem.Allocator, input: delete_route_settings.DeleteRouteSettingsInput, options: delete_route_settings.Options) !delete_route_settings.DeleteRouteSettingsOutput {
        return delete_route_settings.execute(self, allocator, input, options);
    }

    /// Deletes a routing rule.
    pub fn deleteRoutingRule(self: *Self, allocator: std.mem.Allocator, input: delete_routing_rule.DeleteRoutingRuleInput, options: delete_routing_rule.Options) !delete_routing_rule.DeleteRoutingRuleOutput {
    ...
    pub fn disablePortal(self: *Self, allocator: std.mem.Allocator, input: disable_portal.DisablePortalInput, options: disable_portal.Options) !disable_portal.DisablePortalOutput {
        return disable_portal.execute(self, allocator, input, options);
    }

    pub fn exportApi(self: *Self, allocator: std.mem.Allocator, input: export_api.ExportApiInput, options: export_api.Options) !export_api.ExportApiOutput {
    ...
    /// Gets an API mapping.
    pub fn getApiMapping(self: *Self, allocator: std.mem.Allocator, input: get_api_mapping.GetApiMappingInput, options: get_api_mapping.Options) !get_api_mapping.GetApiMappingOutput {
        return get_api_mapping.execute(self, allocator, input, options);
    }

    /// Gets API mappings.
    pub fn getApiMappings(self: *Self, allocator: std.mem.Allocator, input: get_api_mappings.GetApiMappingsInput, options: get_api_mappings.Options) !get_api_mappings.GetApiMappingsOutput {
        return get_api_mappings.execute(self, allocator, input, options);
    }

    /// Gets a collection of Api resources.
    pub fn getApis(self: *Self, allocator: std.mem.Allocator, input: get_apis.GetApisInput, options: get_apis.Options) !get_apis.GetApisOutput {
    ...
    pub fn getIntegrationResponses(self: *Self, allocator: std.mem.Allocator, input: get_integration_responses.GetIntegrationResponsesInput, options: get_integration_responses.Options) !get_integration_responses.GetIntegrationResponsesOutput {
        return get_integration_responses.execute(self, allocator, input, options);
    }

    /// Gets the Integrations for an API.
    pub fn getIntegrations(self: *Self, allocator: std.mem.Allocator, input: get_integrations.GetIntegrationsInput, options: get_integrations.Options) !get_integrations.GetIntegrationsOutput {
    ...
    pub fn getPortalProduct(self: *Self, allocator: std.mem.Allocator, input: get_portal_product.GetPortalProductInput, options: get_portal_product.Options) !get_portal_product.GetPortalProductOutput {
        return get_portal_product.execute(self, allocator, input, options);
    }

    /// Gets the sharing policy for a portal product.
    pub fn getPortalProductSharingPolicy(self: *Self, allocator: std.mem.Allocator, input: get_portal_product_sharing_policy.GetPortalProductSharingPolicyInput, options: get_portal_product_sharing_policy.Options) !get_portal_product_sharing_policy.GetPortalProductSharingPolicyOutput {
        return get_portal_product_sharing_policy.execute(self, allocator, input, options);
    }

    /// Gets a product page of a portal product.
    pub fn getProductPage(self: *Self, allocator: std.mem.Allocator, input: get_product_page.GetProductPageInput, options: get_product_page.Options) !get_product_page.GetProductPageOutput {
        return get_product_page.execute(self, allocator, input, options);
    }

    /// Gets a product REST endpoint page.
    pub fn getProductRestEndpointPage(self: *Self, allocator: std.mem.Allocator, input: get_product_rest_endpoint_page.GetProductRestEndpointPageInput, options: get_product_rest_endpoint_page.Options) !get_product_rest_endpoint_page.GetProductRestEndpointPageOutput {
    ...
    pub fn getRouteResponse(self: *Self, allocator: std.mem.Allocator, input: get_route_response.GetRouteResponseInput, options: get_route_response.Options) !get_route_response.GetRouteResponseOutput {
        return get_route_response.execute(self, allocator, input, options);
    }

    /// Gets the RouteResponses for a Route.
    pub fn getRouteResponses(self: *Self, allocator: std.mem.Allocator, input: get_route_responses.GetRouteResponsesInput, options: get_route_responses.Options) !get_route_responses.GetRouteResponsesOutput {
        return get_route_responses.execute(self, allocator, input, options);
    }

    /// Gets the Routes for an API.
    pub fn getRoutes(self: *Self, allocator: std.mem.Allocator, input: get_routes.GetRoutesInput, options: get_routes.Options) !get_routes.GetRoutesOutput {
        return get_routes.execute(self, allocator, input, options);
    }

    /// Gets a routing rule.
    pub fn getRoutingRule(self: *Self, allocator: std.mem.Allocator, input: get_routing_rule.GetRoutingRuleInput, options: get_routing_rule.Options) !get_routing_rule.GetRoutingRuleOutput {
    ...
    /// Imports an API.
    pub fn importApi(self: *Self, allocator: std.mem.Allocator, input: import_api.ImportApiInput, options: import_api.Options) !import_api.ImportApiOutput {
        return import_api.execute(self, allocator, input, options);
    }

    /// Lists portal products.
    pub fn listPortalProducts(self: *Self, allocator: std.mem.Allocator, input: list_portal_products.ListPortalProductsInput, options: list_portal_products.Options) !list_portal_products.ListPortalProductsOutput {
    ...
    pub fn listProductPages(self: *Self, allocator: std.mem.Allocator, input: list_product_pages.ListProductPagesInput, options: list_product_pages.Options) !list_product_pages.ListProductPagesOutput {
        return list_product_pages.execute(self, allocator, input, options);
    }

    /// Lists the product REST endpoint pages of a portal product.
    pub fn listProductRestEndpointPages(self: *Self, allocator: std.mem.Allocator, input: list_product_rest_endpoint_pages.ListProductRestEndpointPagesInput, options: list_product_rest_endpoint_pages.Options) !list_product_rest_endpoint_pages.ListProductRestEndpointPagesOutput {
        return list_product_rest_endpoint_pages.execute(self, allocator, input, options);
    }

    /// Lists routing rules.
    pub fn listRoutingRules(self: *Self, allocator: std.mem.Allocator, input: list_routing_rules.ListRoutingRulesInput, options: list_routing_rules.Options) !list_routing_rules.ListRoutingRulesOutput {
        return list_routing_rules.execute(self, allocator, input, options);
    }

    /// Creates a portal preview.
    pub fn previewPortal(self: *Self, allocator: std.mem.Allocator, input: preview_portal.PreviewPortalInput, options: preview_portal.Options) !preview_portal.PreviewPortalOutput {
        return preview_portal.execute(self, allocator, input, options);
    }

    /// Publishes a portal.
    pub fn publishPortal(self: *Self, allocator: std.mem.Allocator, input: publish_portal.PublishPortalInput, options: publish_portal.Options) !publish_portal.PublishPortalOutput {
        return publish_portal.execute(self, allocator, input, options);
    }

    /// Updates the sharing policy for a portal product.
    pub fn putPortalProductSharingPolicy(self: *Self, allocator: std.mem.Allocator, input: put_portal_product_sharing_policy.PutPortalProductSharingPolicyInput, options: put_portal_product_sharing_policy.Options) !put_portal_product_sharing_policy.PutPortalProductSharingPolicyOutput {
        return put_portal_product_sharing_policy.execute(self, allocator, input, options);
    }

    /// Updates a routing rule.
    pub fn putRoutingRule(self: *Self, allocator: std.mem.Allocator, input: put_routing_rule.PutRoutingRuleInput, options: put_routing_rule.Options) !put_routing_rule.PutRoutingRuleOutput {
        return put_routing_rule.execute(self, allocator, input, options);
    }

    /// Puts an Api resource.
    pub fn reimportApi(self: *Self, allocator: std.mem.Allocator, input: reimport_api.ReimportApiInput, options: reimport_api.Options) !reimport_api.ReimportApiOutput {
    ...
    /// APIs.
    pub fn resetAuthorizersCache(self: *Self, allocator: std.mem.Allocator, input: reset_authorizers_cache.ResetAuthorizersCacheInput, options: reset_authorizers_cache.Options) !reset_authorizers_cache.ResetAuthorizersCacheOutput {
    ...
    /// The API mapping.
    pub fn updateApiMapping(self: *Self, allocator: std.mem.Allocator, input: update_api_mapping.UpdateApiMappingInput, options: update_api_mapping.Options) !update_api_mapping.UpdateApiMappingOutput {
    ...
    pub fn updatePortalProduct(self: *Self, allocator: std.mem.Allocator, input: update_portal_product.UpdatePortalProductInput, options: update_portal_product.Options) !update_portal_product.UpdatePortalProductOutput {
        return update_portal_product.execute(self, allocator, input, options);
    }

    /// Updates a product page of a portal product.
    pub fn updateProductPage(self: *Self, allocator: std.mem.Allocator, input: update_product_page.UpdateProductPageInput, options: update_product_page.Options) !update_product_page.UpdateProductPageOutput {
        return update_product_page.execute(self, allocator, input, options);
    }

    /// Updates a product REST endpoint page.
    pub fn updateProductRestEndpointPage(self: *Self, allocator: std.mem.Allocator, input: update_product_rest_endpoint_page.UpdateProductRestEndpointPageInput, options: update_product_rest_endpoint_page.Options) !update_product_rest_endpoint_page.UpdateProductRestEndpointPageOutput {
    ...
    pub fn updateRouteResponse(self: *Self, allocator: std.mem.Allocator, input: update_route_response.UpdateRouteResponseInput, options: update_route_response.Options) !update_route_response.UpdateRouteResponseOutput {
