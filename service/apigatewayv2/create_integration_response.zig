...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateIntegrationResponseInput, options: CallOptions) !CreateIntegrationResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateIntegrationResponseInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.integration_response_key), input.integration_response_key, allocator, &body_buf);
    has_prev = true;
