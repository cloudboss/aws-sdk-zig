...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPortalProductsInput, options: CallOptions) !ListPortalProductsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPortalProductsInput, config: *aws.Config) !aws.http.Request {
