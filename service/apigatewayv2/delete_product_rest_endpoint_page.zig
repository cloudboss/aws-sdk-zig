...
pub const DeleteProductRestEndpointPageInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProductRestEndpointPageInput, options: CallOptions) !DeleteProductRestEndpointPageOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProductRestEndpointPageInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteProductRestEndpointPageOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProductRestEndpointPageOutput = .{};
