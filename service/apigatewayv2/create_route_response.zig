...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateRouteResponseInput, options: CallOptions) !CreateRouteResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateRouteResponseInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.route_response_key), input.route_response_key, allocator, &body_buf);
    has_prev = true;
