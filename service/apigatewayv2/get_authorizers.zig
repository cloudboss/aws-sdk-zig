...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAuthorizersInput, options: CallOptions) !GetAuthorizersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAuthorizersInput, config: *aws.Config) !aws.http.Request {
