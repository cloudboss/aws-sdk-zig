...
fn serializeRequest(alloc: std.mem.Allocator, input: ResetAuthorizersCacheInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/cache/authorizers");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ResetAuthorizersCacheOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
