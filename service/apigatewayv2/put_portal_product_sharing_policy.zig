...
pub const PutPortalProductSharingPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutPortalProductSharingPolicyInput, options: Options) !PutPortalProductSharingPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutPortalProductSharingPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutPortalProductSharingPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutPortalProductSharingPolicyOutput = .{};
