...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetPortalProductSharingPolicyInput, options: CallOptions) !GetPortalProductSharingPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetPortalProductSharingPolicyInput, config: *aws.Config) !aws.http.Request {
