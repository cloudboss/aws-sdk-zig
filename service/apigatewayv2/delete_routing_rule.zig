...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRoutingRuleInput, options: CallOptions) !DeleteRoutingRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRoutingRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRoutingRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
