...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListProfileResourceAssociationsInput, options: Options) !ListProfileResourceAssociationsOutput {
