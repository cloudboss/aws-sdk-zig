...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateProfileInput, options: CallOptions) !DisassociateProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/profileassociation/Profileid/");
    try path_buf.appendSlice(allocator, input.profile_id);
    try path_buf.appendSlice(allocator, "/resourceid/");
