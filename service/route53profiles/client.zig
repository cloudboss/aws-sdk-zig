...
pub const Client = struct {
    ...
    pub fn associateProfile(self: *Self, allocator: std.mem.Allocator, input: associate_profile.AssociateProfileInput, options: CallOptions) !associate_profile.AssociateProfileOutput {
        return associate_profile.execute(self, allocator, input, options);
    }

    /// Associates a DNS reource configuration to a Route 53 Profile.
    pub fn associateResourceToProfile(self: *Self, allocator: std.mem.Allocator, input: associate_resource_to_profile.AssociateResourceToProfileInput, options: CallOptions) !associate_resource_to_profile.AssociateResourceToProfileOutput {
    ...
    pub fn disassociateProfile(self: *Self, allocator: std.mem.Allocator, input: disassociate_profile.DisassociateProfileInput, options: CallOptions) !disassociate_profile.DisassociateProfileOutput {
        return disassociate_profile.execute(self, allocator, input, options);
    }

    /// Dissoaciated a specified resource, from the Route 53 Profile.
    pub fn disassociateResourceFromProfile(self: *Self, allocator: std.mem.Allocator, input: disassociate_resource_from_profile.DisassociateResourceFromProfileInput, options: CallOptions) !disassociate_resource_from_profile.DisassociateResourceFromProfileOutput {
    ...
    pub fn getProfileAssociation(self: *Self, allocator: std.mem.Allocator, input: get_profile_association.GetProfileAssociationInput, options: CallOptions) !get_profile_association.GetProfileAssociationOutput {
        return get_profile_association.execute(self, allocator, input, options);
    }

    /// Returns information about a specified Route 53 Profile resource association.
    pub fn getProfileResourceAssociation(self: *Self, allocator: std.mem.Allocator, input: get_profile_resource_association.GetProfileResourceAssociationInput, options: CallOptions) !get_profile_resource_association.GetProfileResourceAssociationOutput {
        return get_profile_resource_association.execute(self, allocator, input, options);
    }

    /// Lists all the VPCs that the specified Route 53 Profile is associated with.
    pub fn listProfileAssociations(self: *Self, allocator: std.mem.Allocator, input: list_profile_associations.ListProfileAssociationsInput, options: CallOptions) !list_profile_associations.ListProfileAssociationsOutput {
        return list_profile_associations.execute(self, allocator, input, options);
    }

    /// Lists all the resource associations for the specified Route 53 Profile.
    pub fn listProfileResourceAssociations(self: *Self, allocator: std.mem.Allocator, input: list_profile_resource_associations.ListProfileResourceAssociationsInput, options: CallOptions) !list_profile_resource_associations.ListProfileResourceAssociationsOutput {
    ...
    pub fn updateProfileResourceAssociation(self: *Self, allocator: std.mem.Allocator, input: update_profile_resource_association.UpdateProfileResourceAssociationInput, options: CallOptions) !update_profile_resource_association.UpdateProfileResourceAssociationOutput {
