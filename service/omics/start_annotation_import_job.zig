...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartAnnotationImportJobInput, options: CallOptions) !StartAnnotationImportJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartAnnotationImportJobInput, config: *aws.Config) !aws.http.Request {
