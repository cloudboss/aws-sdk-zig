...
pub const DeleteSequenceStoreInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSequenceStoreInput, options: Options) !DeleteSequenceStoreOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSequenceStoreInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSequenceStoreOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSequenceStoreOutput = .{};
