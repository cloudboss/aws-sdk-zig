...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AbortMultipartReadSetUploadInput, options: Options) !AbortMultipartReadSetUploadOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AbortMultipartReadSetUploadInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/abort");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AbortMultipartReadSetUploadOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
