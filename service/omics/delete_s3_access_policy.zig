...
pub const DeleteS3AccessPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteS3AccessPolicyInput, options: Options) !DeleteS3AccessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteS3AccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteS3AccessPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteS3AccessPolicyOutput = .{};
