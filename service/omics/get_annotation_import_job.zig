...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAnnotationImportJobInput, options: CallOptions) !GetAnnotationImportJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAnnotationImportJobInput, config: *aws.Config) !aws.http.Request {
