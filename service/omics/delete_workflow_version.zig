...
pub const DeleteWorkflowVersionInput = struct {
...
pub const DeleteWorkflowVersionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteWorkflowVersionInput, options: CallOptions) !DeleteWorkflowVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteWorkflowVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteWorkflowVersionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteWorkflowVersionOutput = .{};
