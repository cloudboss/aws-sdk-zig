...
pub const DeleteReferenceInput = struct {
    /// The reference's ID.
    id: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReferenceInput, options: Options) !DeleteReferenceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteReferenceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/reference/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteReferenceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteReferenceOutput = .{};
