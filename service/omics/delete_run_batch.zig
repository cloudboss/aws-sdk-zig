...
pub const DeleteRunBatchInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRunBatchInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRunBatchOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRunBatchOutput = .{};
