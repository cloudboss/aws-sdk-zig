...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAnnotationStoreVersionsInput, options: CallOptions) !DeleteAnnotationStoreVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAnnotationStoreVersionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/versions/delete");
