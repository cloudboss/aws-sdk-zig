...
pub const DeleteRunGroupOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRunGroupInput, options: CallOptions) !DeleteRunGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRunGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRunGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
