...
pub const DeleteRunCacheInput = struct {
...
const DeleteRunCacheOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRunCacheInput, options: Options) !DeleteRunCacheOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteRunCacheInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/runCache/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteRunCacheOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRunCacheOutput = .{};
