...
pub const DeleteRunCacheOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRunCacheInput, options: CallOptions) !DeleteRunCacheOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRunCacheInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRunCacheOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
