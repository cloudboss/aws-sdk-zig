...
pub const DeleteReferenceStoreInput = struct {
    /// The store's ID.
    id: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReferenceStoreInput, options: Options) !DeleteReferenceStoreOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteReferenceStoreInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteReferenceStoreOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteReferenceStoreOutput = .{};
