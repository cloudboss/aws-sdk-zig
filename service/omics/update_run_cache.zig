...
pub const UpdateRunCacheInput = struct {
...
const UpdateRunCacheOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRunCacheInput, options: Options) !UpdateRunCacheOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateRunCacheInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateRunCacheOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateRunCacheOutput = .{};
