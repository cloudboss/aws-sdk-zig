...
const UpdateWorkflowVersionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateWorkflowVersionInput, options: Options) !UpdateWorkflowVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateWorkflowVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateWorkflowVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
