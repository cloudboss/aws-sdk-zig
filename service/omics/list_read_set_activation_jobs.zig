...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListReadSetActivationJobsInput, options: CallOptions) !ListReadSetActivationJobsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListReadSetActivationJobsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/activationjobs");
