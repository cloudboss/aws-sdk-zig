...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetReadSetInput, options: Options) !GetReadSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetReadSetInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.file) |v| {
        ...
        try query_buf.appendSlice(alloc, "file=");
...
fn deserializeStreamingResponse(stream_resp: *aws.http.StreamingResponse, alloc: std.mem.Allocator) !GetReadSetOutput {
    _ = alloc;
