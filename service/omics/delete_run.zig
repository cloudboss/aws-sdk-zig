...
pub const DeleteRunInput = struct {
    /// The run's ID.
    id: []const u8,
...
const DeleteRunOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRunInput, options: Options) !DeleteRunOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRunInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRunOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRunOutput = .{};
