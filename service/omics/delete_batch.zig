...
pub const DeleteBatchInput = struct {
...
pub const DeleteBatchOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBatchInput, options: CallOptions) !DeleteBatchOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBatchInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBatchOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBatchOutput = .{};
