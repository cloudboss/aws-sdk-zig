...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListStorageProfilesInput, options: CallOptions) !ListStorageProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListStorageProfilesInput, config: *aws.Config) !aws.http.Request {
