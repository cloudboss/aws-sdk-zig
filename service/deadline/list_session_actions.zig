...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSessionActionsInput, options: CallOptions) !ListSessionActionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSessionActionsInput, config: *aws.Config) !aws.http.Request {
