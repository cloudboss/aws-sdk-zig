...
pub const DisassociateMemberFromFleetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateMemberFromFleetInput, options: Options) !DisassociateMemberFromFleetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateMemberFromFleetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateMemberFromFleetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateMemberFromFleetOutput = .{};
