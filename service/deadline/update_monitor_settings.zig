...
pub const UpdateMonitorSettingsInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateMonitorSettingsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateMonitorSettingsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateMonitorSettingsOutput = .{};
