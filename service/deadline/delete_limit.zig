...
pub const DeleteLimitInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLimitInput, options: Options) !DeleteLimitOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLimitInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLimitOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLimitOutput = .{};
