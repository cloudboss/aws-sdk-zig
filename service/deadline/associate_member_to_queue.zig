...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateMemberToQueueInput, options: Options) !AssociateMemberToQueueOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateMemberToQueueInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateMemberToQueueOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
