...
pub const GetSessionsStatisticsAggregationPaginator = struct {
    client: *Client,
    params: get_sessions_statistics_aggregation.GetSessionsStatisticsAggregationInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_sessions_statistics_aggregation.GetSessionsStatisticsAggregationOutput {
        if (self.done) {
...
pub const ListAvailableMeteredProductsPaginator = struct {
    client: *Client,
    params: list_available_metered_products.ListAvailableMeteredProductsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_available_metered_products.ListAvailableMeteredProductsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListBudgetsPaginator = struct {
    client: *Client,
    params: list_budgets.ListBudgetsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_budgets.ListBudgetsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFarmMembersPaginator = struct {
    client: *Client,
    params: list_farm_members.ListFarmMembersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_farm_members.ListFarmMembersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFarmsPaginator = struct {
    client: *Client,
    params: list_farms.ListFarmsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_farms.ListFarmsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFleetMembersPaginator = struct {
    client: *Client,
    params: list_fleet_members.ListFleetMembersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_fleet_members.ListFleetMembersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListJobMembersPaginator = struct {
    client: *Client,
    params: list_job_members.ListJobMembersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_job_members.ListJobMembersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListJobParameterDefinitionsPaginator = struct {
    client: *Client,
    params: list_job_parameter_definitions.ListJobParameterDefinitionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_job_parameter_definitions.ListJobParameterDefinitionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListLicenseEndpointsPaginator = struct {
    client: *Client,
    params: list_license_endpoints.ListLicenseEndpointsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_license_endpoints.ListLicenseEndpointsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListLimitsPaginator = struct {
    client: *Client,
    params: list_limits.ListLimitsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_limits.ListLimitsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListMeteredProductsPaginator = struct {
    client: *Client,
    params: list_metered_products.ListMeteredProductsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_metered_products.ListMeteredProductsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListQueueEnvironmentsPaginator = struct {
    client: *Client,
    params: list_queue_environments.ListQueueEnvironmentsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_queue_environments.ListQueueEnvironmentsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListQueueFleetAssociationsPaginator = struct {
    client: *Client,
    params: list_queue_fleet_associations.ListQueueFleetAssociationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_queue_fleet_associations.ListQueueFleetAssociationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListQueueLimitAssociationsPaginator = struct {
    client: *Client,
    params: list_queue_limit_associations.ListQueueLimitAssociationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_queue_limit_associations.ListQueueLimitAssociationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListQueueMembersPaginator = struct {
    client: *Client,
    params: list_queue_members.ListQueueMembersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_queue_members.ListQueueMembersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSessionActionsPaginator = struct {
    client: *Client,
    params: list_session_actions.ListSessionActionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_session_actions.ListSessionActionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSessionsForWorkerPaginator = struct {
    client: *Client,
    params: list_sessions_for_worker.ListSessionsForWorkerInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_sessions_for_worker.ListSessionsForWorkerOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListStepConsumersPaginator = struct {
    client: *Client,
    params: list_step_consumers.ListStepConsumersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_step_consumers.ListStepConsumersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListStepDependenciesPaginator = struct {
    client: *Client,
    params: list_step_dependencies.ListStepDependenciesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_step_dependencies.ListStepDependenciesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListStepsPaginator = struct {
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_steps.ListStepsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListStorageProfilesPaginator = struct {
    client: *Client,
    params: list_storage_profiles.ListStorageProfilesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_storage_profiles.ListStorageProfilesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListStorageProfilesForQueuePaginator = struct {
    client: *Client,
    params: list_storage_profiles_for_queue.ListStorageProfilesForQueueInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_storage_profiles_for_queue.ListStorageProfilesForQueueOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListWorkersPaginator = struct {
    client: *Client,
    params: list_workers.ListWorkersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_workers.ListWorkersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
