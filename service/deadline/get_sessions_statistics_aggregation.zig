...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSessionsStatisticsAggregationInput, options: Options) !GetSessionsStatisticsAggregationOutput {
