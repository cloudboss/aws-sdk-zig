...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssumeFleetRoleForWorkerInput, options: CallOptions) !AssumeFleetRoleForWorkerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssumeFleetRoleForWorkerInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/fleet-roles");
