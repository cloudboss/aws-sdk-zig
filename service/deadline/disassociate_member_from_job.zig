...
pub const DisassociateMemberFromJobInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateMemberFromJobInput, options: Options) !DisassociateMemberFromJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateMemberFromJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateMemberFromJobOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateMemberFromJobOutput = .{};
