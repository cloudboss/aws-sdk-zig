...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateLimitInput, options: Options) !UpdateLimitOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateLimitInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateLimitOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
