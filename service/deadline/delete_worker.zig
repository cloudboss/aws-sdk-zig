...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteWorkerInput, options: Options) !DeleteWorkerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteWorkerInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteWorkerOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteWorkerOutput = .{};
