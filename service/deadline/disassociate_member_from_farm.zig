...
pub const DisassociateMemberFromFarmInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateMemberFromFarmInput, options: Options) !DisassociateMemberFromFarmOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateMemberFromFarmInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateMemberFromFarmOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateMemberFromFarmOutput = .{};
