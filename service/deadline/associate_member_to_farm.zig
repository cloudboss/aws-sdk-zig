...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateMemberToFarmInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateMemberToFarmOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
