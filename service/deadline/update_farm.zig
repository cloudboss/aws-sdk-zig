...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFarmInput, options: Options) !UpdateFarmOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateFarmInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateFarmOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateFarmOutput = .{};
