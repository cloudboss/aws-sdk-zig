...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateWorkerInput, options: CallOptions) !CreateWorkerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateWorkerInput, config: *aws.Config) !aws.http.Request {
