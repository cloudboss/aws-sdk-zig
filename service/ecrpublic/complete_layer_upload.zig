...
pub const CompleteLayerUploadInput = struct {
    ...
    /// registry where layers are
    /// uploaded. If you do not specify a registry, the default public registry is
    /// assumed.
...
fn serializeRequest(allocator: std.mem.Allocator, input: CompleteLayerUploadInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SpencerFrontendService.CompleteLayerUpload");
