...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartMedicalTranscriptionJobInput, options: CallOptions) !StartMedicalTranscriptionJobOutput {
