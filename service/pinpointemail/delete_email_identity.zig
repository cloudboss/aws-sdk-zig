...
pub const DeleteEmailIdentityInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEmailIdentityInput, options: Options) !DeleteEmailIdentityOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteEmailIdentityInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteEmailIdentityOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEmailIdentityOutput = .{};
