...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEmailIdentitiesInput, options: CallOptions) !ListEmailIdentitiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEmailIdentitiesInput, config: *aws.Config) !aws.http.Request {
