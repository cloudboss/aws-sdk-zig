...
pub const Client = struct {
    ...
    pub fn associateToConfiguration(self: *Self, allocator: std.mem.Allocator, input: associate_to_configuration.AssociateToConfigurationInput, options: CallOptions) !associate_to_configuration.AssociateToConfigurationOutput {
        return associate_to_configuration.execute(self, allocator, input, options);
    }

    /// Creates an AWS Chatbot configuration for Amazon Chime.
    pub fn createChimeWebhookConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_chime_webhook_configuration.CreateChimeWebhookConfigurationInput, options: CallOptions) !create_chime_webhook_configuration.CreateChimeWebhookConfigurationOutput {
    ...
    /// notification.
    pub fn createCustomAction(self: *Self, allocator: std.mem.Allocator, input: create_custom_action.CreateCustomActionInput, options: CallOptions) !create_custom_action.CreateCustomActionOutput {
        return create_custom_action.execute(self, allocator, input, options);
    }

    /// Creates an AWS Chatbot configuration for Microsoft Teams.
    pub fn createMicrosoftTeamsChannelConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_microsoft_teams_channel_configuration.CreateMicrosoftTeamsChannelConfigurationInput, options: CallOptions) !create_microsoft_teams_channel_configuration.CreateMicrosoftTeamsChannelConfigurationOutput {
    ...
    pub fn deleteChimeWebhookConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_chime_webhook_configuration.DeleteChimeWebhookConfigurationInput, options: CallOptions) !delete_chime_webhook_configuration.DeleteChimeWebhookConfigurationOutput {
        return delete_chime_webhook_configuration.execute(self, allocator, input, options);
    }

    /// Deletes a custom action.
    pub fn deleteCustomAction(self: *Self, allocator: std.mem.Allocator, input: delete_custom_action.DeleteCustomActionInput, options: CallOptions) !delete_custom_action.DeleteCustomActionOutput {
        return delete_custom_action.execute(self, allocator, input, options);
    }

    /// Deletes a Microsoft Teams channel configuration for AWS Chatbot
    pub fn deleteMicrosoftTeamsChannelConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_microsoft_teams_channel_configuration.DeleteMicrosoftTeamsChannelConfigurationInput, options: CallOptions) !delete_microsoft_teams_channel_configuration.DeleteMicrosoftTeamsChannelConfigurationOutput {
    ...
    pub fn deleteMicrosoftTeamsConfiguredTeam(self: *Self, allocator: std.mem.Allocator, input: delete_microsoft_teams_configured_team.DeleteMicrosoftTeamsConfiguredTeamInput, options: CallOptions) !delete_microsoft_teams_configured_team.DeleteMicrosoftTeamsConfiguredTeamOutput {
        return delete_microsoft_teams_configured_team.execute(self, allocator, input, options);
    }

    /// Identifes a user level permission for a channel configuration.
    pub fn deleteMicrosoftTeamsUserIdentity(self: *Self, allocator: std.mem.Allocator, input: delete_microsoft_teams_user_identity.DeleteMicrosoftTeamsUserIdentityInput, options: CallOptions) !delete_microsoft_teams_user_identity.DeleteMicrosoftTeamsUserIdentityOutput {
    ...
    pub fn deleteSlackUserIdentity(self: *Self, allocator: std.mem.Allocator, input: delete_slack_user_identity.DeleteSlackUserIdentityInput, options: CallOptions) !delete_slack_user_identity.DeleteSlackUserIdentityOutput {
    ...
    pub fn deleteSlackWorkspaceAuthorization(self: *Self, allocator: std.mem.Allocator, input: delete_slack_workspace_authorization.DeleteSlackWorkspaceAuthorizationInput, options: CallOptions) !delete_slack_workspace_authorization.DeleteSlackWorkspaceAuthorizationOutput {
    ...
    pub fn describeChimeWebhookConfigurations(self: *Self, allocator: std.mem.Allocator, input: describe_chime_webhook_configurations.DescribeChimeWebhookConfigurationsInput, options: CallOptions) !describe_chime_webhook_configurations.DescribeChimeWebhookConfigurationsOutput {
    ...
    /// ChatConfigurationArn
    pub fn describeSlackChannelConfigurations(self: *Self, allocator: std.mem.Allocator, input: describe_slack_channel_configurations.DescribeSlackChannelConfigurationsInput, options: CallOptions) !describe_slack_channel_configurations.DescribeSlackChannelConfigurationsOutput {
        return describe_slack_channel_configurations.execute(self, allocator, input, options);
    }

    /// Lists all Slack user identities with a mapped role.
    pub fn describeSlackUserIdentities(self: *Self, allocator: std.mem.Allocator, input: describe_slack_user_identities.DescribeSlackUserIdentitiesInput, options: CallOptions) !describe_slack_user_identities.DescribeSlackUserIdentitiesOutput {
    ...
    /// with AWS Chatbot.
    pub fn describeSlackWorkspaces(self: *Self, allocator: std.mem.Allocator, input: describe_slack_workspaces.DescribeSlackWorkspacesInput, options: CallOptions) !describe_slack_workspaces.DescribeSlackWorkspacesOutput {
    ...
    /// configuration.
    pub fn disassociateFromConfiguration(self: *Self, allocator: std.mem.Allocator, input: disassociate_from_configuration.DisassociateFromConfigurationInput, options: CallOptions) !disassociate_from_configuration.DisassociateFromConfigurationOutput {
        return disassociate_from_configuration.execute(self, allocator, input, options);
    }

    /// Returns AWS Chatbot account preferences.
    pub fn getAccountPreferences(self: *Self, allocator: std.mem.Allocator, input: get_account_preferences.GetAccountPreferencesInput, options: CallOptions) !get_account_preferences.GetAccountPreferencesOutput {
        return get_account_preferences.execute(self, allocator, input, options);
    }

    /// Returns a custom action.
    pub fn getCustomAction(self: *Self, allocator: std.mem.Allocator, input: get_custom_action.GetCustomActionInput, options: CallOptions) !get_custom_action.GetCustomActionOutput {
        return get_custom_action.execute(self, allocator, input, options);
    }

    /// Returns a Microsoft Teams channel configuration in an AWS account.
    pub fn getMicrosoftTeamsChannelConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_microsoft_teams_channel_configuration.GetMicrosoftTeamsChannelConfigurationInput, options: CallOptions) !get_microsoft_teams_channel_configuration.GetMicrosoftTeamsChannelConfigurationOutput {
    ...
    pub fn listCustomActions(self: *Self, allocator: std.mem.Allocator, input: list_custom_actions.ListCustomActionsInput, options: CallOptions) !list_custom_actions.ListCustomActionsOutput {
    ...
    /// account.
    pub fn listMicrosoftTeamsChannelConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_microsoft_teams_channel_configurations.ListMicrosoftTeamsChannelConfigurationsInput, options: CallOptions) !list_microsoft_teams_channel_configurations.ListMicrosoftTeamsChannelConfigurationsOutput {
        return list_microsoft_teams_channel_configurations.execute(self, allocator, input, options);
    }

    /// Lists all authorized Microsoft Teams for an AWS Account
    pub fn listMicrosoftTeamsConfiguredTeams(self: *Self, allocator: std.mem.Allocator, input: list_microsoft_teams_configured_teams.ListMicrosoftTeamsConfiguredTeamsInput, options: CallOptions) !list_microsoft_teams_configured_teams.ListMicrosoftTeamsConfiguredTeamsOutput {
        return list_microsoft_teams_configured_teams.execute(self, allocator, input, options);
    }

    /// A list all Microsoft Teams user identities with a mapped role.
    pub fn listMicrosoftTeamsUserIdentities(self: *Self, allocator: std.mem.Allocator, input: list_microsoft_teams_user_identities.ListMicrosoftTeamsUserIdentitiesInput, options: CallOptions) !list_microsoft_teams_user_identities.ListMicrosoftTeamsUserIdentitiesOutput {
    ...
    pub fn updateAccountPreferences(self: *Self, allocator: std.mem.Allocator, input: update_account_preferences.UpdateAccountPreferencesInput, options: CallOptions) !update_account_preferences.UpdateAccountPreferencesOutput {
        return update_account_preferences.execute(self, allocator, input, options);
    }

    /// Updates a Amazon Chime webhook configuration.
    pub fn updateChimeWebhookConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_chime_webhook_configuration.UpdateChimeWebhookConfigurationInput, options: CallOptions) !update_chime_webhook_configuration.UpdateChimeWebhookConfigurationOutput {
        return update_chime_webhook_configuration.execute(self, allocator, input, options);
    }

    /// Updates a custom action.
    pub fn updateCustomAction(self: *Self, allocator: std.mem.Allocator, input: update_custom_action.UpdateCustomActionInput, options: CallOptions) !update_custom_action.UpdateCustomActionOutput {
        return update_custom_action.execute(self, allocator, input, options);
    }

    /// Updates an Microsoft Teams channel configuration.
    pub fn updateMicrosoftTeamsChannelConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_microsoft_teams_channel_configuration.UpdateMicrosoftTeamsChannelConfigurationInput, options: CallOptions) !update_microsoft_teams_channel_configuration.UpdateMicrosoftTeamsChannelConfigurationOutput {
