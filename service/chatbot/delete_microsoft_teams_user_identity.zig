...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMicrosoftTeamsUserIdentityInput, options: Options) !DeleteMicrosoftTeamsUserIdentityOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteMicrosoftTeamsUserIdentityInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteMicrosoftTeamsUserIdentityOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
