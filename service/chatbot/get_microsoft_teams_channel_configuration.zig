...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMicrosoftTeamsChannelConfigurationInput, options: CallOptions) !GetMicrosoftTeamsChannelConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetMicrosoftTeamsChannelConfigurationInput, config: *aws.Config) !aws.http.Request {
