...
pub const GetMicrosoftTeamsChannelConfigurationInput = struct {
...
pub const GetMicrosoftTeamsChannelConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMicrosoftTeamsChannelConfigurationInput, options: Options) !GetMicrosoftTeamsChannelConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetMicrosoftTeamsChannelConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/get-ms-teams-channel-configuration";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetMicrosoftTeamsChannelConfigurationOutput {
    var result: GetMicrosoftTeamsChannelConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetMicrosoftTeamsChannelConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
