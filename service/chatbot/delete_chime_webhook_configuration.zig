...
pub const DeleteChimeWebhookConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChimeWebhookConfigurationInput, options: Options) !DeleteChimeWebhookConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteChimeWebhookConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/delete-chime-webhook-configuration";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteChimeWebhookConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteChimeWebhookConfigurationOutput = .{};
