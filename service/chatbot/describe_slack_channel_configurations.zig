...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSlackChannelConfigurationsInput, options: CallOptions) !DescribeSlackChannelConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeSlackChannelConfigurationsInput, config: *aws.Config) !aws.http.Request {
