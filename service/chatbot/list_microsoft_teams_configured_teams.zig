...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMicrosoftTeamsConfiguredTeamsInput, options: Options) !ListMicrosoftTeamsConfiguredTeamsOutput {
