...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateFromConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateFromConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
