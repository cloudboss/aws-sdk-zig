...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChimeWebhookConfigurationsInput, options: CallOptions) !DescribeChimeWebhookConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeChimeWebhookConfigurationsInput, config: *aws.Config) !aws.http.Request {
