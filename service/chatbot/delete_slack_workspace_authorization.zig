...
pub const DeleteSlackWorkspaceAuthorizationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSlackWorkspaceAuthorizationInput, options: Options) !DeleteSlackWorkspaceAuthorizationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSlackWorkspaceAuthorizationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/delete-slack-workspace-authorization";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSlackWorkspaceAuthorizationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSlackWorkspaceAuthorizationOutput = .{};
