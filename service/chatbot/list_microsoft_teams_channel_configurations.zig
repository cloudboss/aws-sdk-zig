...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMicrosoftTeamsChannelConfigurationsInput, options: Options) !ListMicrosoftTeamsChannelConfigurationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListMicrosoftTeamsChannelConfigurationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListMicrosoftTeamsChannelConfigurationsOutput {
    var result: ListMicrosoftTeamsChannelConfigurationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListMicrosoftTeamsChannelConfigurationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
