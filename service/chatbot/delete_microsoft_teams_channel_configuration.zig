...
pub const DeleteMicrosoftTeamsChannelConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMicrosoftTeamsChannelConfigurationInput, options: Options) !DeleteMicrosoftTeamsChannelConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMicrosoftTeamsChannelConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/delete-ms-teams-channel-configuration";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMicrosoftTeamsChannelConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMicrosoftTeamsChannelConfigurationOutput = .{};
