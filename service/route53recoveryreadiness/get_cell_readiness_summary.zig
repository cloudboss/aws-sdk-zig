...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCellReadinessSummaryInput, options: CallOptions) !GetCellReadinessSummaryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCellReadinessSummaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/cellreadiness/");
