...
pub const GetReadinessCheckStatusInput = struct {
...
pub const GetReadinessCheckStatusOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetReadinessCheckStatusInput, options: CallOptions) !GetReadinessCheckStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetReadinessCheckStatusInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetReadinessCheckStatusOutput {
    var result: GetReadinessCheckStatusOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetReadinessCheckStatusOutput, body, allocator);
    }
    _ = status;
    _ = headers;
