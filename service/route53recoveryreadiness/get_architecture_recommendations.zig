...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetArchitectureRecommendationsInput, options: Options) !GetArchitectureRecommendationsOutput {
