...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCellsInput, options: CallOptions) !ListCellsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCellsInput, config: *aws.Config) !aws.http.Request {
