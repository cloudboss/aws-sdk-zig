...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBillingViewInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSBilling.DeleteBillingView");
