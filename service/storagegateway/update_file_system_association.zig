...
pub const UpdateFileSystemAssociationInput = struct {
...
pub const UpdateFileSystemAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFileSystemAssociationInput, options: CallOptions) !UpdateFileSystemAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateFileSystemAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StorageGateway_20130630.UpdateFileSystemAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateFileSystemAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateFileSystemAssociationOutput, body, allocator);
}
