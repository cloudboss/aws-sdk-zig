...
pub const CreateSnapshotFromVolumeRecoveryPointInput = struct {
...
pub const CreateSnapshotFromVolumeRecoveryPointOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSnapshotFromVolumeRecoveryPointInput, options: CallOptions) !CreateSnapshotFromVolumeRecoveryPointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateSnapshotFromVolumeRecoveryPointInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StorageGateway_20130630.CreateSnapshotFromVolumeRecoveryPoint");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateSnapshotFromVolumeRecoveryPointOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreateSnapshotFromVolumeRecoveryPointOutput, body, allocator);
}
