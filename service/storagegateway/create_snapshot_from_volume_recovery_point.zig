...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSnapshotFromVolumeRecoveryPointInput, options: Options) !CreateSnapshotFromVolumeRecoveryPointOutput {
