...
pub const Client = struct {
    ...
    const Self = @This();
    pub const sdk_id = "Kinesis Video Media";
    ...
    /// addition to
    /// the HTTP status code and the response body, it includes the following pieces
    /// of information:
    ///
    ...
    /// programmatic
    /// decisions about whether errors are retry-able and under what conditions, as
    /// well as provide
