...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTelemetryRuleInput, options: CallOptions) !CreateTelemetryRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateTelemetryRuleInput, config: *aws.Config) !aws.http.Request {
