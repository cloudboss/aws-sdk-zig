...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TestTelemetryPipelineInput, options: CallOptions) !TestTelemetryPipelineOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TestTelemetryPipelineInput, config: *aws.Config) !aws.http.Request {
