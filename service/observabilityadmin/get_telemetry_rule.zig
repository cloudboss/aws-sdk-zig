...
pub const GetTelemetryRuleInput = struct {
...
pub const GetTelemetryRuleOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTelemetryRuleInput, options: CallOptions) !GetTelemetryRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTelemetryRuleInput, config: *aws.Config) !aws.http.Request {
