...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCentralizationRuleForOrganizationInput, options: CallOptions) !CreateCentralizationRuleForOrganizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateCentralizationRuleForOrganizationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateCentralizationRuleForOrganizationOutput {
    var result: CreateCentralizationRuleForOrganizationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateCentralizationRuleForOrganizationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
