...
pub const CreateCentralizationRuleForOrganizationInput = struct {
...
pub const CreateCentralizationRuleForOrganizationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCentralizationRuleForOrganizationInput, options: Options) !CreateCentralizationRuleForOrganizationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateCentralizationRuleForOrganizationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/CreateCentralizationRuleForOrganization";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateCentralizationRuleForOrganizationOutput {
    var result: CreateCentralizationRuleForOrganizationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateCentralizationRuleForOrganizationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
