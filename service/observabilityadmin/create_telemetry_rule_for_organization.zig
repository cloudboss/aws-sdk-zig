...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTelemetryRuleForOrganizationInput, options: Options) !CreateTelemetryRuleForOrganizationOutput {
