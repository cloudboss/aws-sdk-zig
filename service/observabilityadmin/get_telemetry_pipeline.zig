...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTelemetryPipelineInput, options: CallOptions) !GetTelemetryPipelineOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTelemetryPipelineInput, config: *aws.Config) !aws.http.Request {
