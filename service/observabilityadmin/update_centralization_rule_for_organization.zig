...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCentralizationRuleForOrganizationInput, options: CallOptions) !UpdateCentralizationRuleForOrganizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCentralizationRuleForOrganizationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateCentralizationRuleForOrganizationOutput {
    var result: UpdateCentralizationRuleForOrganizationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateCentralizationRuleForOrganizationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
