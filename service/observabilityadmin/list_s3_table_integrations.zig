...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListS3TableIntegrationsInput, options: CallOptions) !ListS3TableIntegrationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListS3TableIntegrationsInput, config: *aws.Config) !aws.http.Request {
