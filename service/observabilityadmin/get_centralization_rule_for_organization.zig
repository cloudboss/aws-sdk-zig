...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCentralizationRuleForOrganizationInput, options: Options) !GetCentralizationRuleForOrganizationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCentralizationRuleForOrganizationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetCentralizationRuleForOrganizationOutput {
    var result: GetCentralizationRuleForOrganizationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetCentralizationRuleForOrganizationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
