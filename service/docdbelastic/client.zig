...
pub const Client = struct {
    ...
    pub fn getClusterSnapshot(self: *Self, allocator: std.mem.Allocator, input: get_cluster_snapshot.GetClusterSnapshotInput, options: CallOptions) !get_cluster_snapshot.GetClusterSnapshotOutput {
        return get_cluster_snapshot.execute(self, allocator, input, options);
    }

    /// Retrieves all maintenance actions that are pending.
    pub fn getPendingMaintenanceAction(self: *Self, allocator: std.mem.Allocator, input: get_pending_maintenance_action.GetPendingMaintenanceActionInput, options: CallOptions) !get_pending_maintenance_action.GetPendingMaintenanceActionOutput {
        return get_pending_maintenance_action.execute(self, allocator, input, options);
    }

    /// Returns information about snapshots for a specified elastic cluster.
    pub fn listClusterSnapshots(self: *Self, allocator: std.mem.Allocator, input: list_cluster_snapshots.ListClusterSnapshotsInput, options: CallOptions) !list_cluster_snapshots.ListClusterSnapshotsOutput {
    ...
    pub fn listPendingMaintenanceActions(self: *Self, allocator: std.mem.Allocator, input: list_pending_maintenance_actions.ListPendingMaintenanceActionsInput, options: CallOptions) !list_pending_maintenance_actions.ListPendingMaintenanceActionsOutput {
    ...
    pub fn restoreClusterFromSnapshot(self: *Self, allocator: std.mem.Allocator, input: restore_cluster_from_snapshot.RestoreClusterFromSnapshotInput, options: CallOptions) !restore_cluster_from_snapshot.RestoreClusterFromSnapshotOutput {
        return restore_cluster_from_snapshot.execute(self, allocator, input, options);
    }

    /// Restarts the stopped elastic cluster that is specified by `clusterARN`.
    pub fn startCluster(self: *Self, allocator: std.mem.Allocator, input: start_cluster.StartClusterInput, options: CallOptions) !start_cluster.StartClusterOutput {
        return start_cluster.execute(self, allocator, input, options);
    }

    /// Stops the running elastic cluster that is specified by `clusterArn`.
    /// The elastic cluster must be in the *available* state.
    pub fn stopCluster(self: *Self, allocator: std.mem.Allocator, input: stop_cluster.StopClusterInput, options: CallOptions) !stop_cluster.StopClusterOutput {
