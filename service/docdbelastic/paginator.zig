...
pub const ListClusterSnapshotsPaginator = struct {
    client: *Client,
    params: list_cluster_snapshots.ListClusterSnapshotsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_cluster_snapshots.Options) !list_cluster_snapshots.ListClusterSnapshotsOutput {
        ...
        const output = try list_cluster_snapshots.execute(self.client, allocator, self.params, options);
...
pub const ListPendingMaintenanceActionsPaginator = struct {
    client: *Client,
    params: list_pending_maintenance_actions.ListPendingMaintenanceActionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_pending_maintenance_actions.Options) !list_pending_maintenance_actions.ListPendingMaintenanceActionsOutput {
        ...
        const output = try list_pending_maintenance_actions.execute(self.client, allocator, self.params, options);
