...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopClusterInput, options: CallOptions) !StopClusterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopClusterInput, config: *aws.Config) !aws.http.Request {
