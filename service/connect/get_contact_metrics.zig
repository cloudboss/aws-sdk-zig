...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContactMetricsInput, options: CallOptions) !GetContactMetricsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetContactMetricsInput, config: *aws.Config) !aws.http.Request {
