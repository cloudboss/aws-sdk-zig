...
pub const AssociateQueueQuickConnectsInput = struct {
...
pub const AssociateQueueQuickConnectsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateQueueQuickConnectsInput, options: CallOptions) !AssociateQueueQuickConnectsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateQueueQuickConnectsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/associate-quick-connects");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateQueueQuickConnectsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateQueueQuickConnectsOutput = .{};
