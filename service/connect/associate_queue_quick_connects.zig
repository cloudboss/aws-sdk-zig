...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateQueueQuickConnectsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/associate-quick-connects");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateQueueQuickConnectsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
