...
pub const DeleteEvaluationFormInput = struct {
...
pub const DeleteEvaluationFormOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEvaluationFormInput, options: CallOptions) !DeleteEvaluationFormOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEvaluationFormInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEvaluationFormOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEvaluationFormOutput = .{};
