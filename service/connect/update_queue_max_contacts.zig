...
pub const UpdateQueueMaxContactsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQueueMaxContactsInput, options: CallOptions) !UpdateQueueMaxContactsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQueueMaxContactsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/max-contacts");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateQueueMaxContactsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
