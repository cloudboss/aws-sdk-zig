...
pub const UpdateQueueMaxContactsInput = struct {
...
const UpdateQueueMaxContactsOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQueueMaxContactsInput, options: Options) !UpdateQueueMaxContactsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateQueueMaxContactsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/max-contacts");
    ...
    if (input.max_contacts) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"MaxContacts\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateQueueMaxContactsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateQueueMaxContactsOutput = .{};
