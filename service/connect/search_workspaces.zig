...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchWorkspacesInput, options: CallOptions) !SearchWorkspacesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchWorkspacesInput, config: *aws.Config) !aws.http.Request {
