...
pub const DeleteSecurityProfileInput = struct {
...
const DeleteSecurityProfileOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSecurityProfileInput, options: Options) !DeleteSecurityProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSecurityProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSecurityProfileOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSecurityProfileOutput = .{};
