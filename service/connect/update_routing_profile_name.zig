...
pub const UpdateRoutingProfileNameInput = struct {
...
const UpdateRoutingProfileNameOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRoutingProfileNameInput, options: Options) !UpdateRoutingProfileNameOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateRoutingProfileNameInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/name");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateRoutingProfileNameOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateRoutingProfileNameOutput = .{};
