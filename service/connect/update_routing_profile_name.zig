...
pub const UpdateRoutingProfileNameOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRoutingProfileNameInput, options: CallOptions) !UpdateRoutingProfileNameOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateRoutingProfileNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateRoutingProfileNameOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
