...
pub const DisassociateApprovedOriginInput = struct {
...
pub const DisassociateApprovedOriginOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateApprovedOriginInput, options: CallOptions) !DisassociateApprovedOriginOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateApprovedOriginInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/approved-origin");
    ...
    try aws.url.appendUrlEncoded(allocator, &query_buf, input.origin);
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateApprovedOriginOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateApprovedOriginOutput = .{};
