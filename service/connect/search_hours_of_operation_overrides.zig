...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchHoursOfOperationOverridesInput, options: Options) !SearchHoursOfOperationOverridesOutput {
