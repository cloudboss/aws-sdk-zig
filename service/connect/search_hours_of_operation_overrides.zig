...
const HoursOfOperationOverrideSearchCriteria = @import("hours_of_operation_override_search_criteria.zig").HoursOfOperationOverrideSearchCriteria;
...
pub const SearchHoursOfOperationOverridesInput = struct {
    ...
    search_criteria: ?HoursOfOperationOverrideSearchCriteria = null,
...
pub const SearchHoursOfOperationOverridesOutput = struct {
    /// The total number of hours of operations which matched your search query.
    approximate_total_count: ?i64 = null,

    /// Information about the hours of operations overrides.
    hours_of_operation_overrides: ?[]const HoursOfOperationOverride = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchHoursOfOperationOverridesInput, options: CallOptions) !SearchHoursOfOperationOverridesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchHoursOfOperationOverridesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/search-hours-of-operation-overrides";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SearchHoursOfOperationOverridesOutput {
    var result: SearchHoursOfOperationOverridesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(SearchHoursOfOperationOverridesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
