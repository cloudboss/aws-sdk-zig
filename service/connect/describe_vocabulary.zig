...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVocabularyInput, options: CallOptions) !DescribeVocabularyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeVocabularyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.vocabulary_id);
