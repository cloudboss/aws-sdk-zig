...
const UpdateHoursOfOperationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateHoursOfOperationInput, options: Options) !UpdateHoursOfOperationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateHoursOfOperationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateHoursOfOperationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
