...
pub const UpdateUserPhoneConfigOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateUserPhoneConfigInput, options: CallOptions) !UpdateUserPhoneConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateUserPhoneConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/phone-config");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateUserPhoneConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
