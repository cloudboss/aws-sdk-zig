...
pub const AssociateBotInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateBotInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateBotOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateBotOutput = .{};
