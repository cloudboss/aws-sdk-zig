...
pub const UpdateContactFlowContentInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateContactFlowContentInput, options: Options) !UpdateContactFlowContentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateContactFlowContentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateContactFlowContentOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateContactFlowContentOutput = .{};
