...
pub const DeleteEmailAddressInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEmailAddressInput, options: CallOptions) !DeleteEmailAddressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEmailAddressInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEmailAddressOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEmailAddressOutput = .{};
