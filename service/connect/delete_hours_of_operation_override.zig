...
pub const DeleteHoursOfOperationOverrideInput = struct {
...
pub const DeleteHoursOfOperationOverrideOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteHoursOfOperationOverrideInput, options: CallOptions) !DeleteHoursOfOperationOverrideOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteHoursOfOperationOverrideInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteHoursOfOperationOverrideOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteHoursOfOperationOverrideOutput = .{};
