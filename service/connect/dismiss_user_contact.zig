...
pub const DismissUserContactInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DismissUserContactInput, options: Options) !DismissUserContactOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DismissUserContactInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DismissUserContactOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DismissUserContactOutput = .{};
