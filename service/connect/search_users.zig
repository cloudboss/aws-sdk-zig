...
const UserSearchCriteria = @import("user_search_criteria.zig").UserSearchCriteria;
const UserSearchFilter = @import("user_search_filter.zig").UserSearchFilter;
const UserSearchSummary = @import("user_search_summary.zig").UserSearchSummary;
...
pub const SearchUsersInput = struct {
    ...
    search_criteria: ?UserSearchCriteria = null,

    /// Filters to be applied to search results.
    search_filter: ?UserSearchFilter = null,
...
pub const SearchUsersOutput = struct {
    ...
    users: ?[]const UserSearchSummary = null,
