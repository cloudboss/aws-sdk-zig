...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchEmailAddressesInput, options: CallOptions) !SearchEmailAddressesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchEmailAddressesInput, config: *aws.Config) !aws.http.Request {
