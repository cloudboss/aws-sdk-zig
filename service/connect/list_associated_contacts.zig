...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssociatedContactsInput, options: CallOptions) !ListAssociatedContactsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAssociatedContactsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/contact/associated/");
