...
pub const UpdateContactFlowModuleMetadataInput = struct {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateContactFlowModuleMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateContactFlowModuleMetadataOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateContactFlowModuleMetadataOutput = .{};
