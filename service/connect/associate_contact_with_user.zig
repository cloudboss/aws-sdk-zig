...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateContactWithUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/associate-user");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateContactWithUserOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
