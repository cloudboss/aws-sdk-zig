...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTrafficDistributionGroupInput, options: Options) !CreateTrafficDistributionGroupOutput {
