...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchPredefinedAttributesInput, options: CallOptions) !SearchPredefinedAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchPredefinedAttributesInput, config: *aws.Config) !aws.http.Request {
