...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateViewInput, options: CallOptions) !CreateViewOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateViewInput, config: *aws.Config) !aws.http.Request {
