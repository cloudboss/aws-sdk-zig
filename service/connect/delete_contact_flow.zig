...
pub const DeleteContactFlowInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactFlowInput, options: Options) !DeleteContactFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContactFlowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContactFlowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContactFlowOutput = .{};
