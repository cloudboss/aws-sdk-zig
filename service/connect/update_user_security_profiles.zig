...
pub const UpdateUserSecurityProfilesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateUserSecurityProfilesInput, options: CallOptions) !UpdateUserSecurityProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateUserSecurityProfilesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateUserSecurityProfilesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
