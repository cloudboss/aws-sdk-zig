...
pub const DeleteTaskTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTaskTemplateInput, options: Options) !DeleteTaskTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTaskTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTaskTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTaskTemplateOutput = .{};
