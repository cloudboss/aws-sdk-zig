...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateWorkspaceThemeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/theme");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateWorkspaceThemeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
