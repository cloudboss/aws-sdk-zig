...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDefaultVocabulariesInput, options: CallOptions) !ListDefaultVocabulariesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDefaultVocabulariesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/default-vocabulary-summary/");
