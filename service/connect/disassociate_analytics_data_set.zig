...
const DisassociateAnalyticsDataSetOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateAnalyticsDataSetInput, options: Options) !DisassociateAnalyticsDataSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateAnalyticsDataSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "\"DataSetId\":");
    try aws.json.writeValue(@TypeOf(input.data_set_id), input.data_set_id, alloc, &body_buf);
    has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateAnalyticsDataSetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
