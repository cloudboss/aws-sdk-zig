...
pub const DeleteContactFlowModuleInput = struct {
...
pub const DeleteContactFlowModuleOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactFlowModuleInput, options: Options) !DeleteContactFlowModuleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteContactFlowModuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteContactFlowModuleOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContactFlowModuleOutput = .{};
