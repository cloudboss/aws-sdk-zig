...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactFlowModuleInput, options: CallOptions) !DeleteContactFlowModuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContactFlowModuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContactFlowModuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
