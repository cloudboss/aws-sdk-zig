...
const DisassociateSecurityProfilesOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateSecurityProfilesInput, options: Options) !DisassociateSecurityProfilesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateSecurityProfilesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/disassociate-security-profiles/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateSecurityProfilesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
