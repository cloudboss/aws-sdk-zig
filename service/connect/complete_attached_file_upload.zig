...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CompleteAttachedFileUploadInput, options: Options) !CompleteAttachedFileUploadOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CompleteAttachedFileUploadInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CompleteAttachedFileUploadOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
