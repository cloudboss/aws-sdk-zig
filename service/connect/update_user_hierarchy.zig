...
pub const UpdateUserHierarchyInput = struct {
...
const UpdateUserHierarchyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateUserHierarchyInput, options: Options) !UpdateUserHierarchyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateUserHierarchyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/hierarchy");
    ...
    if (input.hierarchy_group_id) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"HierarchyGroupId\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateUserHierarchyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateUserHierarchyOutput = .{};
