...
pub const UpdateUserHierarchyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateUserHierarchyInput, options: CallOptions) !UpdateUserHierarchyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateUserHierarchyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/hierarchy");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateUserHierarchyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
