...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateEmailAddressInput, options: CallOptions) !CreateEmailAddressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateEmailAddressInput, config: *aws.Config) !aws.http.Request {
