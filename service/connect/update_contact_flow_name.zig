...
pub const UpdateContactFlowNameInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateContactFlowNameInput, options: Options) !UpdateContactFlowNameOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateContactFlowNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateContactFlowNameOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateContactFlowNameOutput = .{};
