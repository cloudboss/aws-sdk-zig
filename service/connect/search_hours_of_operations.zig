...
const HoursOfOperationSearchCriteria = @import("hours_of_operation_search_criteria.zig").HoursOfOperationSearchCriteria;
const HoursOfOperationSearchFilter = @import("hours_of_operation_search_filter.zig").HoursOfOperationSearchFilter;
const HoursOfOperation = @import("hours_of_operation.zig").HoursOfOperation;

pub const SearchHoursOfOperationsInput = struct {
    ...
    search_criteria: ?HoursOfOperationSearchCriteria = null,

    /// Filters to be applied to search results.
    search_filter: ?HoursOfOperationSearchFilter = null,
...
pub const SearchHoursOfOperationsOutput = struct {
    /// The total number of hours of operations which matched your search query.
    approximate_total_count: ?i64 = null,

    /// Information about the hours of operations.
    hours_of_operations: ?[]const HoursOfOperation = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchHoursOfOperationsInput, options: Options) !SearchHoursOfOperationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SearchHoursOfOperationsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/search-hours-of-operations";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SearchHoursOfOperationsOutput {
    var result: SearchHoursOfOperationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(SearchHoursOfOperationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
