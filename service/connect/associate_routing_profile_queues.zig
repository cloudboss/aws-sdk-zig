...
pub const AssociateRoutingProfileQueuesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateRoutingProfileQueuesInput, options: CallOptions) !AssociateRoutingProfileQueuesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateRoutingProfileQueuesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/associate-queues");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateRoutingProfileQueuesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
