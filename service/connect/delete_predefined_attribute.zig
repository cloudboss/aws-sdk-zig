...
pub const DeletePredefinedAttributeOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePredefinedAttributeInput, options: CallOptions) !DeletePredefinedAttributeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePredefinedAttributeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePredefinedAttributeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePredefinedAttributeOutput = .{};
