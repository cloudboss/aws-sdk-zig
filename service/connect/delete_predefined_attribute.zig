...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePredefinedAttributeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePredefinedAttributeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
