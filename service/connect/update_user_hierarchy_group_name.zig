...
pub const UpdateUserHierarchyGroupNameInput = struct {
...
pub const UpdateUserHierarchyGroupNameOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateUserHierarchyGroupNameInput, options: CallOptions) !UpdateUserHierarchyGroupNameOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateUserHierarchyGroupNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateUserHierarchyGroupNameOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateUserHierarchyGroupNameOutput = .{};
