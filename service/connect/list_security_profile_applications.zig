...
pub const ListSecurityProfileApplicationsInput = struct {
...
pub const ListSecurityProfileApplicationsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSecurityProfileApplicationsInput, options: CallOptions) !ListSecurityProfileApplicationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSecurityProfileApplicationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/security-profiles-applications/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListSecurityProfileApplicationsOutput {
    var result: ListSecurityProfileApplicationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListSecurityProfileApplicationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
