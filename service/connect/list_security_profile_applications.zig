...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSecurityProfileApplicationsInput, options: Options) !ListSecurityProfileApplicationsOutput {
