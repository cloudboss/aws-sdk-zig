...
pub const DeleteUserHierarchyGroupInput = struct {
...
pub const DeleteUserHierarchyGroupOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserHierarchyGroupInput, options: CallOptions) !DeleteUserHierarchyGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserHierarchyGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserHierarchyGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteUserHierarchyGroupOutput = .{};
