...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateInstanceStorageConfigInput, options: Options) !AssociateInstanceStorageConfigOutput {
