...
const EvaluationForm = @import("evaluation_form.zig").EvaluationForm;

pub const DescribeEvaluationFormInput = struct {
...
pub const DescribeEvaluationFormOutput = struct {
    /// Information about the evaluation form.
    evaluation_form: ?EvaluationForm = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeEvaluationFormInput, options: Options) !DescribeEvaluationFormOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeEvaluationFormInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeEvaluationFormOutput {
    var result: DescribeEvaluationFormOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeEvaluationFormOutput, body, alloc);
    }
    _ = status;
    _ = headers;
