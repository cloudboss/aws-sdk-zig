...
const ContactFlowModuleAliasSummary = @import("contact_flow_module_alias_summary.zig").ContactFlowModuleAliasSummary;

pub const ListContactFlowModuleAliasesInput = struct {
...
pub const ListContactFlowModuleAliasesOutput = struct {
    /// Information about the flow module aliases.
    contact_flow_module_alias_summary_list: ?[]const ContactFlowModuleAliasSummary = null,
    ...
    pub const json_field_names = .{
        .contact_flow_module_alias_summary_list = "ContactFlowModuleAliasSummaryList",
        .next_token = "NextToken",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListContactFlowModuleAliasesInput, options: CallOptions) !ListContactFlowModuleAliasesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListContactFlowModuleAliasesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListContactFlowModuleAliasesOutput {
    var result: ListContactFlowModuleAliasesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListContactFlowModuleAliasesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
