...
pub const UpdateWorkspaceMetadataInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateWorkspaceMetadataInput, options: Options) !UpdateWorkspaceMetadataOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateWorkspaceMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateWorkspaceMetadataOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateWorkspaceMetadataOutput = .{};
