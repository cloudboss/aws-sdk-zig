...
pub const DeleteContactFlowVersionInput = struct {
    /// The identifier of the flow.
    contact_flow_id: []const u8,

    /// The identifier of the flow version.
    contact_flow_version: i64,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactFlowVersionInput, options: Options) !DeleteContactFlowVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContactFlowVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.contact_flow_version);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContactFlowVersionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContactFlowVersionOutput = .{};
