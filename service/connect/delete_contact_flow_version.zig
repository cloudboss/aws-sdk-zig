...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteContactFlowVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.contact_flow_version);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteContactFlowVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
