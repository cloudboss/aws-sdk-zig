...
pub const UpdateQuickConnectConfigOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQuickConnectConfigInput, options: CallOptions) !UpdateQuickConnectConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQuickConnectConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateQuickConnectConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
