...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateEmailAddressAliasInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/associate-alias");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateEmailAddressAliasOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
