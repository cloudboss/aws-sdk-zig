...
pub const DeactivateEvaluationFormInput = struct {
...
pub const DeactivateEvaluationFormOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeactivateEvaluationFormInput, options: Options) !DeactivateEvaluationFormOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeactivateEvaluationFormInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeactivateEvaluationFormOutput {
    var result: DeactivateEvaluationFormOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeactivateEvaluationFormOutput, body, alloc);
    }
    _ = status;
    _ = headers;
