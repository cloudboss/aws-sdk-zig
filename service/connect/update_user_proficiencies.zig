...
pub const UpdateUserProficienciesInput = struct {
    ...
    /// associated to the user. You can do
    /// this using AssociateUserProficiencies API.
    user_proficiencies: []const UserProficiency,
...
pub const UpdateUserProficienciesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateUserProficienciesInput, options: CallOptions) !UpdateUserProficienciesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateUserProficienciesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateUserProficienciesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateUserProficienciesOutput = .{};
