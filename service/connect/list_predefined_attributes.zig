...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPredefinedAttributesInput, options: CallOptions) !ListPredefinedAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPredefinedAttributesInput, config: *aws.Config) !aws.http.Request {
