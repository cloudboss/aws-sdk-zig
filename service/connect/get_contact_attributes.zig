...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContactAttributesInput, options: CallOptions) !GetContactAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetContactAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/contact/attributes/");
