...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRoutingProfilesInput, options: CallOptions) !ListRoutingProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRoutingProfilesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/routing-profiles-summary/");
