...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteContactFlowModuleVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.contact_flow_module_version);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteContactFlowModuleVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
