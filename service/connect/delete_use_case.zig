...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteUseCaseInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.use_case_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteUseCaseOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
