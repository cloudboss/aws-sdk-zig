...
pub const AssociateSecurityProfilesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateSecurityProfilesInput, options: CallOptions) !AssociateSecurityProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateSecurityProfilesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/associate-security-profiles/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateSecurityProfilesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
