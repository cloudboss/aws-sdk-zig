...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSecurityProfilePermissionsInput, options: Options) !ListSecurityProfilePermissionsOutput {
