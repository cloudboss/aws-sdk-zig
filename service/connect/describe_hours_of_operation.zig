...
pub const DescribeHoursOfOperationInput = struct {
...
pub const DescribeHoursOfOperationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeHoursOfOperationInput, options: CallOptions) !DescribeHoursOfOperationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeHoursOfOperationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeHoursOfOperationOutput {
    var result: DescribeHoursOfOperationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeHoursOfOperationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
