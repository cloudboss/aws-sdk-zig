...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ActivateEvaluationFormInput, options: CallOptions) !ActivateEvaluationFormOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ActivateEvaluationFormInput, config: *aws.Config) !aws.http.Request {
