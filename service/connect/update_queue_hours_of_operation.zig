...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateQueueHoursOfOperationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/hours-of-operation");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateQueueHoursOfOperationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
