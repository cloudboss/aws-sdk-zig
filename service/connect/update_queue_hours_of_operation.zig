...
pub const UpdateQueueHoursOfOperationInput = struct {
...
pub const UpdateQueueHoursOfOperationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQueueHoursOfOperationInput, options: CallOptions) !UpdateQueueHoursOfOperationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQueueHoursOfOperationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/hours-of-operation");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateQueueHoursOfOperationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateQueueHoursOfOperationOutput = .{};
