...
pub const UpdateQueueStatusInput = struct {
...
pub const UpdateQueueStatusOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQueueStatusInput, options: CallOptions) !UpdateQueueStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQueueStatusInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateQueueStatusOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateQueueStatusOutput = .{};
