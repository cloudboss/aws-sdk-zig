...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateTrafficDistributionGroupUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(alloc, &query_buf, input.user_id);
    query_has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateTrafficDistributionGroupUserOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
