...
pub const DisassociateTrafficDistributionGroupUserInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateTrafficDistributionGroupUserInput, options: CallOptions) !DisassociateTrafficDistributionGroupUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateTrafficDistributionGroupUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(allocator, &query_buf, input.user_id);
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateTrafficDistributionGroupUserOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateTrafficDistributionGroupUserOutput = .{};
