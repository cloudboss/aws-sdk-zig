...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateContactFlowMetadataInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.contact_flow_state) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"ContactFlowState\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateContactFlowMetadataOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
