...
pub const DeleteIntegrationAssociationInput = struct {
...
const DeleteIntegrationAssociationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIntegrationAssociationInput, options: Options) !DeleteIntegrationAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIntegrationAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIntegrationAssociationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteIntegrationAssociationOutput = .{};
