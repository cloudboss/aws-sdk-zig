...
pub const DeleteIntegrationAssociationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIntegrationAssociationInput, options: CallOptions) !DeleteIntegrationAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIntegrationAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIntegrationAssociationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
