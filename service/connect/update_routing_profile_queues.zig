...
pub const UpdateRoutingProfileQueuesInput = struct {
    ...
    queue_configs: []const RoutingProfileQueueConfig,
...
pub const UpdateRoutingProfileQueuesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRoutingProfileQueuesInput, options: CallOptions) !UpdateRoutingProfileQueuesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateRoutingProfileQueuesInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.queue_configs), input.queue_configs, allocator, &body_buf);
    has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateRoutingProfileQueuesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateRoutingProfileQueuesOutput = .{};
