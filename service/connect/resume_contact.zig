...
pub const ResumeContactInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResumeContactInput, options: Options) !ResumeContactOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ResumeContactInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ResumeContactOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: ResumeContactOutput = .{};
