...
pub const UpdateRoutingProfileConcurrencyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRoutingProfileConcurrencyInput, options: CallOptions) !UpdateRoutingProfileConcurrencyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateRoutingProfileConcurrencyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/concurrency");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateRoutingProfileConcurrencyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
