...
pub const UpdateRoutingProfileConcurrencyInput = struct {
...
const UpdateRoutingProfileConcurrencyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRoutingProfileConcurrencyInput, options: Options) !UpdateRoutingProfileConcurrencyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateRoutingProfileConcurrencyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/concurrency");
    ...
    try body_buf.appendSlice(alloc, "\"MediaConcurrencies\":");
    try aws.json.writeValue(@TypeOf(input.media_concurrencies), input.media_concurrencies, alloc, &body_buf);
    has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateRoutingProfileConcurrencyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateRoutingProfileConcurrencyOutput = .{};
