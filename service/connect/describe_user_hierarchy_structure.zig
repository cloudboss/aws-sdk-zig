...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeUserHierarchyStructureInput, options: CallOptions) !DescribeUserHierarchyStructureOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeUserHierarchyStructureInput, config: *aws.Config) !aws.http.Request {
