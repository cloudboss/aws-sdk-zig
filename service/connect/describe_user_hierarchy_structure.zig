...
pub const DescribeUserHierarchyStructureOutput = struct {
    /// Information about the hierarchy structure.
    hierarchy_structure: ?HierarchyStructure = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeUserHierarchyStructureInput, options: Options) !DescribeUserHierarchyStructureOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeUserHierarchyStructureInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeUserHierarchyStructureOutput {
    var result: DescribeUserHierarchyStructureOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeUserHierarchyStructureOutput, body, alloc);
    }
    _ = status;
    _ = headers;
