...
pub const ResumeContactRecordingInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResumeContactRecordingInput, options: Options) !ResumeContactRecordingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ResumeContactRecordingInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/contact/resume-recording";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ResumeContactRecordingOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ResumeContactRecordingOutput = .{};
