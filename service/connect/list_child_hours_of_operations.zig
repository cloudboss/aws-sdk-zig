...
pub const ListChildHoursOfOperationsInput = struct {
...
pub const ListChildHoursOfOperationsOutput = struct {
    /// Information about the hours of operation.
    child_hours_of_operations_summary_list: ?[]const HoursOfOperationsIdentifier = null,
    ...
    pub const json_field_names = .{
        .child_hours_of_operations_summary_list = "ChildHoursOfOperationsSummaryList",
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListChildHoursOfOperationsInput, options: CallOptions) !ListChildHoursOfOperationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListChildHoursOfOperationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/hours");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListChildHoursOfOperationsOutput {
    var result: ListChildHoursOfOperationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListChildHoursOfOperationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
