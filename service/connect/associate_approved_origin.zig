...
pub const AssociateApprovedOriginInput = struct {
...
pub const AssociateApprovedOriginOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateApprovedOriginInput, options: CallOptions) !AssociateApprovedOriginOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateApprovedOriginInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateApprovedOriginOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateApprovedOriginOutput = .{};
