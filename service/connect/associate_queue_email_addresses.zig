...
pub const AssociateQueueEmailAddressesInput = struct {
    ...
    email_addresses_config: []const EmailAddressConfig,
...
pub const AssociateQueueEmailAddressesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateQueueEmailAddressesInput, options: CallOptions) !AssociateQueueEmailAddressesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateQueueEmailAddressesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/associate-email-addresses");
    ...
    try aws.json.writeValue(@TypeOf(input.email_addresses_config), input.email_addresses_config, allocator, &body_buf);
    has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateQueueEmailAddressesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateQueueEmailAddressesOutput = .{};
