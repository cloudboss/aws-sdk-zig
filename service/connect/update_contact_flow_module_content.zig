...
pub const UpdateContactFlowModuleContentInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateContactFlowModuleContentInput, options: Options) !UpdateContactFlowModuleContentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateContactFlowModuleContentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateContactFlowModuleContentOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateContactFlowModuleContentOutput = .{};
