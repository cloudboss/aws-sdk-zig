...
pub const DescribeNotificationInput = struct {
...
pub const DescribeNotificationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeNotificationInput, options: CallOptions) !DescribeNotificationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeNotificationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeNotificationOutput {
    var result: DescribeNotificationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeNotificationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
