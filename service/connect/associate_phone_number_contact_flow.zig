...
pub const AssociatePhoneNumberContactFlowInput = struct {
...
pub const AssociatePhoneNumberContactFlowOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociatePhoneNumberContactFlowInput, options: CallOptions) !AssociatePhoneNumberContactFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociatePhoneNumberContactFlowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociatePhoneNumberContactFlowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociatePhoneNumberContactFlowOutput = .{};
