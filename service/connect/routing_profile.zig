...
pub const RoutingProfile = struct {
    ...
    associated_manual_assignment_queue_ids: ?[]const []const u8,

    /// The IDs of the associated queue.
    associated_queue_ids: ?[]const []const u8,
    ...
    number_of_associated_manual_assignment_queues: ?i64,

    /// The number of associated queues in routing profile.
    number_of_associated_queues: ?i64,

    /// The number of associated users in routing profile.
    number_of_associated_users: ?i64,

    /// The Amazon Resource Name (ARN) of the routing profile.
    routing_profile_arn: ?[]const u8,
