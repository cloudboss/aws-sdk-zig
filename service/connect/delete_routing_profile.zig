...
pub const DeleteRoutingProfileInput = struct {
...
const DeleteRoutingProfileOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRoutingProfileInput, options: Options) !DeleteRoutingProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteRoutingProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteRoutingProfileOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRoutingProfileOutput = .{};
