...
pub const DeleteRoutingProfileOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRoutingProfileInput, options: CallOptions) !DeleteRoutingProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRoutingProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRoutingProfileOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
