...
pub const StopContactMediaProcessingInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopContactMediaProcessingInput, options: Options) !StopContactMediaProcessingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopContactMediaProcessingInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/contact/stop-contact-media-processing";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopContactMediaProcessingOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopContactMediaProcessingOutput = .{};
