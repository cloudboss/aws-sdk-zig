...
pub const DescribeContactFlowModuleInput = struct {
...
pub const DescribeContactFlowModuleOutput = struct {
    /// Information about the flow module.
    contact_flow_module: ?ContactFlowModule = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeContactFlowModuleInput, options: CallOptions) !DescribeContactFlowModuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeContactFlowModuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeContactFlowModuleOutput {
    var result: DescribeContactFlowModuleOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeContactFlowModuleOutput, body, allocator);
    }
    _ = status;
    _ = headers;
