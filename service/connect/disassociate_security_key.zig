...
pub const DisassociateSecurityKeyInput = struct {
...
const DisassociateSecurityKeyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateSecurityKeyInput, options: Options) !DisassociateSecurityKeyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateSecurityKeyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateSecurityKeyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateSecurityKeyOutput = .{};
