...
pub const DisassociateSecurityKeyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateSecurityKeyInput, options: CallOptions) !DisassociateSecurityKeyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateSecurityKeyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateSecurityKeyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
