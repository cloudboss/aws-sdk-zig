...
pub const UpdateRoutingProfileDefaultOutboundQueueOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRoutingProfileDefaultOutboundQueueInput, options: CallOptions) !UpdateRoutingProfileDefaultOutboundQueueOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateRoutingProfileDefaultOutboundQueueInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/default-outbound-queue");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateRoutingProfileDefaultOutboundQueueOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
