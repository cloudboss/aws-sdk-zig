...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEvaluationFormsInput, options: CallOptions) !ListEvaluationFormsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEvaluationFormsInput, config: *aws.Config) !aws.http.Request {
