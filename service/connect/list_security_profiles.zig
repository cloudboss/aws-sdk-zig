...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSecurityProfilesInput, options: CallOptions) !ListSecurityProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSecurityProfilesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/security-profiles-summary/");
