...
pub const DeleteContactFlowModuleAliasInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactFlowModuleAliasInput, options: Options) !DeleteContactFlowModuleAliasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContactFlowModuleAliasInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContactFlowModuleAliasOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContactFlowModuleAliasOutput = .{};
