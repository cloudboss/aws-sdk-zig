...
pub const DeleteQuickConnectInput = struct {
...
const DeleteQuickConnectOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteQuickConnectInput, options: Options) !DeleteQuickConnectOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteQuickConnectInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteQuickConnectOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteQuickConnectOutput = .{};
