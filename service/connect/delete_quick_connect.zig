...
pub const DeleteQuickConnectOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteQuickConnectInput, options: CallOptions) !DeleteQuickConnectOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteQuickConnectInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteQuickConnectOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
