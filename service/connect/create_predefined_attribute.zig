...
pub const CreatePredefinedAttributeInput = struct {
...
pub const CreatePredefinedAttributeOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreatePredefinedAttributeInput, options: CallOptions) !CreatePredefinedAttributeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreatePredefinedAttributeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreatePredefinedAttributeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreatePredefinedAttributeOutput = .{};
