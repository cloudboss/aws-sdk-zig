...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTaskTemplateInput, options: CallOptions) !CreateTaskTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateTaskTemplateInput, config: *aws.Config) !aws.http.Request {
