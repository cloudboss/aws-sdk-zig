...
fn serializeRequest(allocator: std.mem.Allocator, input: StopTestCaseExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/stop-execution");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopTestCaseExecutionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
