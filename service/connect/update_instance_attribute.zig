...
const UpdateInstanceAttributeOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateInstanceAttributeInput, options: Options) !UpdateInstanceAttributeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateInstanceAttributeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/attribute/");
    try path_buf.appendSlice(alloc, input.attribute_type);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateInstanceAttributeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
