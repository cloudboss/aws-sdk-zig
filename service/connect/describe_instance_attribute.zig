...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInstanceAttributeInput, options: CallOptions) !DescribeInstanceAttributeOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeInstanceAttributeOutput {
    ...
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeInstanceAttributeOutput, body, allocator);
    }
    _ = status;
    _ = headers;
