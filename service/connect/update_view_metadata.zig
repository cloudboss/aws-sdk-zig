...
pub const UpdateViewMetadataInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateViewMetadataInput, options: Options) !UpdateViewMetadataOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateViewMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateViewMetadataOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateViewMetadataOutput = .{};
