...
pub const UpdateQueueNameInput = struct {
...
pub const UpdateQueueNameOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQueueNameInput, options: CallOptions) !UpdateQueueNameOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQueueNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateQueueNameOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateQueueNameOutput = .{};
