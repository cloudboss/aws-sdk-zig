...
pub const UpdateQueueOutboundCallerConfigInput = struct {
...
pub const UpdateQueueOutboundCallerConfigOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQueueOutboundCallerConfigInput, options: CallOptions) !UpdateQueueOutboundCallerConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQueueOutboundCallerConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/outbound-caller-config");
    ...
    try aws.json.writeValue(@TypeOf(input.outbound_caller_config), input.outbound_caller_config, allocator, &body_buf);
    has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateQueueOutboundCallerConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateQueueOutboundCallerConfigOutput = .{};
