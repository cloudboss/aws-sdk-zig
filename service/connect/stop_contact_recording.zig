...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopContactRecordingInput, options: Options) !StopContactRecordingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopContactRecordingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopContactRecordingOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
