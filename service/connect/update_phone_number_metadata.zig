...
pub const UpdatePhoneNumberMetadataInput = struct {
...
const UpdatePhoneNumberMetadataOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdatePhoneNumberMetadataInput, options: Options) !UpdatePhoneNumberMetadataOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdatePhoneNumberMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdatePhoneNumberMetadataOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdatePhoneNumberMetadataOutput = .{};
