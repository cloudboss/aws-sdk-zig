...
pub const UpdatePhoneNumberMetadataOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdatePhoneNumberMetadataInput, options: CallOptions) !UpdatePhoneNumberMetadataOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdatePhoneNumberMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdatePhoneNumberMetadataOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
