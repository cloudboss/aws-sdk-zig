...
pub const DeleteTrafficDistributionGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTrafficDistributionGroupInput, options: Options) !DeleteTrafficDistributionGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTrafficDistributionGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTrafficDistributionGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTrafficDistributionGroupOutput = .{};
