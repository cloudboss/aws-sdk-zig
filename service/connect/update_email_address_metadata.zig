...
pub const UpdateEmailAddressMetadataInput = struct {
...
pub const UpdateEmailAddressMetadataOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEmailAddressMetadataInput, options: Options) !UpdateEmailAddressMetadataOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateEmailAddressMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateEmailAddressMetadataOutput {
    var result: UpdateEmailAddressMetadataOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateEmailAddressMetadataOutput, body, alloc);
    }
    _ = status;
    _ = headers;
