...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListContactFlowVersionsInput, options: CallOptions) !ListContactFlowVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListContactFlowVersionsInput, config: *aws.Config) !aws.http.Request {
