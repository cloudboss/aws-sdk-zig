...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListViewVersionsInput, options: CallOptions) !ListViewVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListViewVersionsInput, config: *aws.Config) !aws.http.Request {
