...
const UserHierarchyGroupSearchCriteria = @import("user_hierarchy_group_search_criteria.zig").UserHierarchyGroupSearchCriteria;
const UserHierarchyGroupSearchFilter = @import("user_hierarchy_group_search_filter.zig").UserHierarchyGroupSearchFilter;
...
pub const SearchUserHierarchyGroupsInput = struct {
    ...
    search_criteria: ?UserHierarchyGroupSearchCriteria = null,

    /// Filters to be applied to search results.
    search_filter: ?UserHierarchyGroupSearchFilter = null,
...
pub const SearchUserHierarchyGroupsOutput = struct {
    ...
    user_hierarchy_groups: ?[]const HierarchyGroup = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchUserHierarchyGroupsInput, options: Options) !SearchUserHierarchyGroupsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SearchUserHierarchyGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/search-user-hierarchy-groups";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SearchUserHierarchyGroupsOutput {
    var result: SearchUserHierarchyGroupsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(SearchUserHierarchyGroupsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
