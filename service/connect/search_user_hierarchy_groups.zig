...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchUserHierarchyGroupsInput, options: CallOptions) !SearchUserHierarchyGroupsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchUserHierarchyGroupsInput, config: *aws.Config) !aws.http.Request {
