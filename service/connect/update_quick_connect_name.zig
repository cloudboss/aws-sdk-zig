...
const UpdateQuickConnectNameOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQuickConnectNameInput, options: Options) !UpdateQuickConnectNameOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateQuickConnectNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateQuickConnectNameOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
