...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAnalyticsDataAssociationsInput, options: CallOptions) !ListAnalyticsDataAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAnalyticsDataAssociationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAnalyticsDataAssociationsOutput {
    var result: ListAnalyticsDataAssociationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAnalyticsDataAssociationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
