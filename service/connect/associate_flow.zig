...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateFlowInput, options: CallOptions) !AssociateFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateFlowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateFlowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
