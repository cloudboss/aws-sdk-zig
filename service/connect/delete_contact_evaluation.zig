...
pub const DeleteContactEvaluationInput = struct {
...
pub const DeleteContactEvaluationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactEvaluationInput, options: CallOptions) !DeleteContactEvaluationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContactEvaluationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContactEvaluationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContactEvaluationOutput = .{};
