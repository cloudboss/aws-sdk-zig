...
pub const DisassociateHoursOfOperationsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateHoursOfOperationsInput, options: CallOptions) !DisassociateHoursOfOperationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateHoursOfOperationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/disassociate-hours");
    ...
    try body_buf.appendSlice(allocator, "\"ParentHoursOfOperationIds\":");
    try aws.json.writeValue(@TypeOf(input.parent_hours_of_operation_ids), input.parent_hours_of_operation_ids, allocator, &body_buf);
    has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateHoursOfOperationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
