...
const UserNotificationSummary = @import("user_notification_summary.zig").UserNotificationSummary;

pub const ListUserNotificationsInput = struct {
...
pub const ListUserNotificationsOutput = struct {
    ...
    user_notifications: ?[]const UserNotificationSummary = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListUserNotificationsInput, options: CallOptions) !ListUserNotificationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListUserNotificationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListUserNotificationsOutput {
    var result: ListUserNotificationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListUserNotificationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
