...
pub const DeleteHoursOfOperationInput = struct {
...
pub const DeleteHoursOfOperationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteHoursOfOperationInput, options: CallOptions) !DeleteHoursOfOperationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteHoursOfOperationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteHoursOfOperationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteHoursOfOperationOutput = .{};
