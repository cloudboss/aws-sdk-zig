...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateUserProficienciesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/associate-proficiencies");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateUserProficienciesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
