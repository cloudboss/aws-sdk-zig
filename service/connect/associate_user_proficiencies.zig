...
pub const AssociateUserProficienciesInput = struct {
...
pub const AssociateUserProficienciesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateUserProficienciesInput, options: CallOptions) !AssociateUserProficienciesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateUserProficienciesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/associate-proficiencies");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateUserProficienciesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateUserProficienciesOutput = .{};
