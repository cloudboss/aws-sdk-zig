...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRoutingProfileManualAssignmentQueuesInput, options: Options) !ListRoutingProfileManualAssignmentQueuesOutput {
