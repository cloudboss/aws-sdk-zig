...
fn serializeRequest(alloc: std.mem.Allocator, input: UntagContactInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/contact/tags/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UntagContactOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
