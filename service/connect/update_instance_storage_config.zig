...
pub const UpdateInstanceStorageConfigInput = struct {
...
pub const UpdateInstanceStorageConfigOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateInstanceStorageConfigInput, options: CallOptions) !UpdateInstanceStorageConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateInstanceStorageConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateInstanceStorageConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateInstanceStorageConfigOutput = .{};
