...
pub const AssociateTrafficDistributionGroupUserInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateTrafficDistributionGroupUserInput, options: Options) !AssociateTrafficDistributionGroupUserOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateTrafficDistributionGroupUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/traffic-distribution-group/");
    try path_buf.appendSlice(alloc, input.traffic_distribution_group_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateTrafficDistributionGroupUserOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateTrafficDistributionGroupUserOutput = .{};
