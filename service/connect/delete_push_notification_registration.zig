...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePushNotificationRegistrationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.registration_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePushNotificationRegistrationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
