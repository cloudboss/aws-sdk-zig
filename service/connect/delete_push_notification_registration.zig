...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePushNotificationRegistrationInput, options: Options) !DeletePushNotificationRegistrationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePushNotificationRegistrationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.registration_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePushNotificationRegistrationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePushNotificationRegistrationOutput = .{};
