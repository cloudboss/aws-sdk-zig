...
pub const DeleteDirectConnectGatewayAssociationInput = struct {
...
pub const DeleteDirectConnectGatewayAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDirectConnectGatewayAssociationInput, options: CallOptions) !DeleteDirectConnectGatewayAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDirectConnectGatewayAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "OvertureService.DeleteDirectConnectGatewayAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDirectConnectGatewayAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DeleteDirectConnectGatewayAssociationOutput, body, allocator);
}
