...
pub const UpdateDirectConnectGatewayAssociationInput = struct {
...
pub const UpdateDirectConnectGatewayAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDirectConnectGatewayAssociationInput, options: CallOptions) !UpdateDirectConnectGatewayAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDirectConnectGatewayAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "OvertureService.UpdateDirectConnectGatewayAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDirectConnectGatewayAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateDirectConnectGatewayAssociationOutput, body, allocator);
}
