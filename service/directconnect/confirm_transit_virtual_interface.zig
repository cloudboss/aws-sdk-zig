...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ConfirmTransitVirtualInterfaceInput, options: Options) !ConfirmTransitVirtualInterfaceOutput {
