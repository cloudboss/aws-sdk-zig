...
const AllocatePrivateVirtualInterfaceOutput = @import("virtual_interface.zig").VirtualInterface;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AllocatePrivateVirtualInterfaceInput, options: Options) !AllocatePrivateVirtualInterfaceOutput {
