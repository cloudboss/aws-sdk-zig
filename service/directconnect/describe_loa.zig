...
const DescribeLoaOutput = @import("loa.zig").Loa;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeLoaInput, options: Options) !DescribeLoaOutput {
