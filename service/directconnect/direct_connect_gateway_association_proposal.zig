...
pub const DirectConnectGatewayAssociationProposal = struct {
    ...
    existing_allowed_prefixes_to_direct_connect_gateway: ?[]const RouteFilterPrefix,
    ...
    requested_allowed_prefixes_to_direct_connect_gateway: ?[]const RouteFilterPrefix,
