...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptDirectConnectGatewayAssociationProposalInput, options: Options) !AcceptDirectConnectGatewayAssociationProposalOutput {
