...
const AssociateHostedConnectionOutput = @import("connection.zig").Connection;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateHostedConnectionInput, options: Options) !AssociateHostedConnectionOutput {
