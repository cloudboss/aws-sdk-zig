...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCodeSecurityScanConfigurationInput, options: Options) !UpdateCodeSecurityScanConfigurationOutput {
