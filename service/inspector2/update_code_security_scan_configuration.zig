...
pub const UpdateCodeSecurityScanConfigurationInput = struct {
...
pub const UpdateCodeSecurityScanConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCodeSecurityScanConfigurationInput, options: CallOptions) !UpdateCodeSecurityScanConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCodeSecurityScanConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/codesecurity/scan-configuration/update";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateCodeSecurityScanConfigurationOutput {
    var result: UpdateCodeSecurityScanConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateCodeSecurityScanConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
