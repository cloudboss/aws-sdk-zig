...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateMemberInput, options: CallOptions) !AssociateMemberOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateMemberInput, config: *aws.Config) !aws.http.Request {
