...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableInput, options: CallOptions) !DisableOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableInput, config: *aws.Config) !aws.http.Request {
