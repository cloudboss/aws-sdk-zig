...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCodeSecurityScanConfigurationAssociationsInput, options: Options) !ListCodeSecurityScanConfigurationAssociationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListCodeSecurityScanConfigurationAssociationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListCodeSecurityScanConfigurationAssociationsOutput {
    var result: ListCodeSecurityScanConfigurationAssociationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListCodeSecurityScanConfigurationAssociationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
