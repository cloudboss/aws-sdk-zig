...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCodeSecurityScanConfigurationInput, options: Options) !GetCodeSecurityScanConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCodeSecurityScanConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetCodeSecurityScanConfigurationOutput {
    var result: GetCodeSecurityScanConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetCodeSecurityScanConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
