...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchUpdateMemberEc2DeepInspectionStatusInput, options: Options) !BatchUpdateMemberEc2DeepInspectionStatusOutput {
