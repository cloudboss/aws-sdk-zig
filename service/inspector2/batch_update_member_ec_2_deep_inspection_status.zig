...
const MemberAccountEc2DeepInspectionStatus = @import("member_account_ec_2_deep_inspection_status.zig").MemberAccountEc2DeepInspectionStatus;
...
pub const BatchUpdateMemberEc2DeepInspectionStatusInput = struct {
    /// The unique identifiers for the Amazon Web Services accounts to change Amazon
    /// Inspector deep inspection status
    /// for.
    account_ids: []const MemberAccountEc2DeepInspectionStatus,
...
pub const BatchUpdateMemberEc2DeepInspectionStatusOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchUpdateMemberEc2DeepInspectionStatusInput, options: CallOptions) !BatchUpdateMemberEc2DeepInspectionStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchUpdateMemberEc2DeepInspectionStatusInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/ec2deepinspectionstatus/member/batch/update";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !BatchUpdateMemberEc2DeepInspectionStatusOutput {
    var result: BatchUpdateMemberEc2DeepInspectionStatusOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(BatchUpdateMemberEc2DeepInspectionStatusOutput, body, allocator);
    }
    _ = status;
    _ = headers;
