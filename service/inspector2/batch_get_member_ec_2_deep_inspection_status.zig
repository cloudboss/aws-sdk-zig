...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchGetMemberEc2DeepInspectionStatusInput, options: Options) !BatchGetMemberEc2DeepInspectionStatusOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: BatchGetMemberEc2DeepInspectionStatusInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !BatchGetMemberEc2DeepInspectionStatusOutput {
    var result: BatchGetMemberEc2DeepInspectionStatusOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(BatchGetMemberEc2DeepInspectionStatusOutput, body, alloc);
    }
    _ = status;
    _ = headers;
