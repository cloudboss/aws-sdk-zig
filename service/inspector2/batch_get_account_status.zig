...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchGetAccountStatusInput, options: CallOptions) !BatchGetAccountStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchGetAccountStatusInput, config: *aws.Config) !aws.http.Request {
