...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCodeSecurityIntegrationInput, options: CallOptions) !DeleteCodeSecurityIntegrationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCodeSecurityIntegrationInput, config: *aws.Config) !aws.http.Request {
