...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDataIntegrationFlowExecutionsInput, options: CallOptions) !ListDataIntegrationFlowExecutionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDataIntegrationFlowExecutionsInput, config: *aws.Config) !aws.http.Request {
