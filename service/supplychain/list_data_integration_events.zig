...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDataIntegrationEventsInput, options: CallOptions) !ListDataIntegrationEventsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDataIntegrationEventsInput, config: *aws.Config) !aws.http.Request {
