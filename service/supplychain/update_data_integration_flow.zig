...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataIntegrationFlowInput, options: CallOptions) !UpdateDataIntegrationFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDataIntegrationFlowInput, config: *aws.Config) !aws.http.Request {
