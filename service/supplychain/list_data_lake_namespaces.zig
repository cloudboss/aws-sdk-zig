...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDataLakeNamespacesInput, options: CallOptions) !ListDataLakeNamespacesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDataLakeNamespacesInput, config: *aws.Config) !aws.http.Request {
