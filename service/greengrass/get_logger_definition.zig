...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetLoggerDefinitionInput, options: CallOptions) !GetLoggerDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetLoggerDefinitionInput, config: *aws.Config) !aws.http.Request {
