...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResourceDefinitionsInput, options: CallOptions) !ListResourceDefinitionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListResourceDefinitionsInput, config: *aws.Config) !aws.http.Request {
