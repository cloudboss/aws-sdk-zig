...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSubscriptionDefinitionInput, options: CallOptions) !GetSubscriptionDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSubscriptionDefinitionInput, config: *aws.Config) !aws.http.Request {
