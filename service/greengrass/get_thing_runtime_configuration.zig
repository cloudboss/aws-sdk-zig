...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetThingRuntimeConfigurationInput, options: CallOptions) !GetThingRuntimeConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetThingRuntimeConfigurationInput, config: *aws.Config) !aws.http.Request {
