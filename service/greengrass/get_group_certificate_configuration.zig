...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetGroupCertificateConfigurationInput, options: CallOptions) !GetGroupCertificateConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetGroupCertificateConfigurationInput, config: *aws.Config) !aws.http.Request {
