...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetResourceDefinitionInput, options: CallOptions) !GetResourceDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetResourceDefinitionInput, config: *aws.Config) !aws.http.Request {
