...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConnectorDefinitionInput, options: CallOptions) !GetConnectorDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetConnectorDefinitionInput, config: *aws.Config) !aws.http.Request {
