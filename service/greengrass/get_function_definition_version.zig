...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFunctionDefinitionVersionInput, options: CallOptions) !GetFunctionDefinitionVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFunctionDefinitionVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.function_definition_version_id);
