...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBulkDeploymentDetailedReportsInput, options: CallOptions) !ListBulkDeploymentDetailedReportsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBulkDeploymentDetailedReportsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/detailed-reports");
