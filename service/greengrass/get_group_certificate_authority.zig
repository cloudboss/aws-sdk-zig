...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetGroupCertificateAuthorityInput, options: CallOptions) !GetGroupCertificateAuthorityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetGroupCertificateAuthorityInput, config: *aws.Config) !aws.http.Request {
