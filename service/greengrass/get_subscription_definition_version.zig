...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSubscriptionDefinitionVersionInput, options: CallOptions) !GetSubscriptionDefinitionVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSubscriptionDefinitionVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.subscription_definition_version_id);
