...
pub const GetDeploymentStatusInput = struct {
...
pub const GetDeploymentStatusOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDeploymentStatusInput, options: CallOptions) !GetDeploymentStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDeploymentStatusInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDeploymentStatusOutput {
    var result: GetDeploymentStatusOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetDeploymentStatusOutput, body, allocator);
    }
    _ = status;
    _ = headers;
