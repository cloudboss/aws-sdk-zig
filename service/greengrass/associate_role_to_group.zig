...
pub const AssociateRoleToGroupInput = struct {
...
pub const AssociateRoleToGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateRoleToGroupInput, options: CallOptions) !AssociateRoleToGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateRoleToGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateRoleToGroupOutput {
    var result: AssociateRoleToGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(AssociateRoleToGroupOutput, body, allocator);
    }
    _ = status;
    _ = headers;
