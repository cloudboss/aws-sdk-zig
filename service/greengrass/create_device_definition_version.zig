...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDeviceDefinitionVersionInput, options: CallOptions) !CreateDeviceDefinitionVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDeviceDefinitionVersionInput, config: *aws.Config) !aws.http.Request {
