...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelBatchJobExecutionInput, options: Options) !CancelBatchJobExecutionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelBatchJobExecutionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelBatchJobExecutionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
