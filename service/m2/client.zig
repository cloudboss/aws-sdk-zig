...
pub const Client = struct {
    ...
    pub fn cancelBatchJobExecution(self: *Self, allocator: std.mem.Allocator, input: cancel_batch_job_execution.CancelBatchJobExecutionInput, options: CallOptions) !cancel_batch_job_execution.CancelBatchJobExecutionOutput {
    ...
    pub fn createDataSetExportTask(self: *Self, allocator: std.mem.Allocator, input: create_data_set_export_task.CreateDataSetExportTaskInput, options: CallOptions) !create_data_set_export_task.CreateDataSetExportTaskOutput {
        return create_data_set_export_task.execute(self, allocator, input, options);
    }

    /// Starts a data set import task for a specific application.
    pub fn createDataSetImportTask(self: *Self, allocator: std.mem.Allocator, input: create_data_set_import_task.CreateDataSetImportTaskInput, options: CallOptions) !create_data_set_import_task.CreateDataSetImportTaskOutput {
    ...
    /// smoothly.
    pub fn deleteApplicationFromEnvironment(self: *Self, allocator: std.mem.Allocator, input: delete_application_from_environment.DeleteApplicationFromEnvironmentInput, options: CallOptions) !delete_application_from_environment.DeleteApplicationFromEnvironmentOutput {
    ...
    pub fn getApplicationVersion(self: *Self, allocator: std.mem.Allocator, input: get_application_version.GetApplicationVersionInput, options: CallOptions) !get_application_version.GetApplicationVersionOutput {
    ...
    /// application.
    pub fn getBatchJobExecution(self: *Self, allocator: std.mem.Allocator, input: get_batch_job_execution.GetBatchJobExecutionInput, options: CallOptions) !get_batch_job_execution.GetBatchJobExecutionOutput {
        return get_batch_job_execution.execute(self, allocator, input, options);
    }

    /// Gets the details of a specific data set.
    pub fn getDataSetDetails(self: *Self, allocator: std.mem.Allocator, input: get_data_set_details.GetDataSetDetailsInput, options: CallOptions) !get_data_set_details.GetDataSetDetailsOutput {
    ...
    pub fn getDataSetExportTask(self: *Self, allocator: std.mem.Allocator, input: get_data_set_export_task.GetDataSetExportTaskInput, options: CallOptions) !get_data_set_export_task.GetDataSetExportTaskOutput {
        return get_data_set_export_task.execute(self, allocator, input, options);
    }

    /// Gets the status of a data set import task initiated with the
    /// CreateDataSetImportTask operation.
    pub fn getDataSetImportTask(self: *Self, allocator: std.mem.Allocator, input: get_data_set_import_task.GetDataSetImportTaskInput, options: CallOptions) !get_data_set_import_task.GetDataSetImportTaskOutput {
    ...
    pub fn getSignedBluinsightsUrl(self: *Self, allocator: std.mem.Allocator, input: get_signed_bluinsights_url.GetSignedBluinsightsUrlInput, options: CallOptions) !get_signed_bluinsights_url.GetSignedBluinsightsUrlOutput {
    ...
    /// the list to start
    /// a batch job.
    pub fn listBatchJobDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_batch_job_definitions.ListBatchJobDefinitionsInput, options: CallOptions) !list_batch_job_definitions.ListBatchJobDefinitionsOutput {
    ...
    /// application.
    pub fn listBatchJobExecutions(self: *Self, allocator: std.mem.Allocator, input: list_batch_job_executions.ListBatchJobExecutionsInput, options: CallOptions) !list_batch_job_executions.ListBatchJobExecutionsOutput {
    ...
    pub fn listBatchJobRestartPoints(self: *Self, allocator: std.mem.Allocator, input: list_batch_job_restart_points.ListBatchJobRestartPointsInput, options: CallOptions) !list_batch_job_restart_points.ListBatchJobRestartPointsOutput {
    ...
    pub fn listDataSetExportHistory(self: *Self, allocator: std.mem.Allocator, input: list_data_set_export_history.ListDataSetExportHistoryInput, options: CallOptions) !list_data_set_export_history.ListDataSetExportHistoryOutput {
        return list_data_set_export_history.execute(self, allocator, input, options);
    }

    /// Lists the data set imports for the specified application.
    pub fn listDataSetImportHistory(self: *Self, allocator: std.mem.Allocator, input: list_data_set_import_history.ListDataSetImportHistoryInput, options: CallOptions) !list_data_set_import_history.ListDataSetImportHistoryOutput {
    ...
    pub fn startBatchJob(self: *Self, allocator: std.mem.Allocator, input: start_batch_job.StartBatchJobInput, options: CallOptions) !start_batch_job.StartBatchJobOutput {
