...
const GetDeploymentInput = @import("get_deployment_request.zig").GetDeploymentRequest;

const GetDeploymentOutput = @import("get_deployment_response.zig").GetDeploymentResponse;
