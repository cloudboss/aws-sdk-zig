...
pub const DescribeVirtualClusterInput = struct {
...
pub const DescribeVirtualClusterOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVirtualClusterInput, options: Options) !DescribeVirtualClusterOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeVirtualClusterInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeVirtualClusterOutput {
    var result: DescribeVirtualClusterOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeVirtualClusterOutput, body, alloc);
    }
    _ = status;
    _ = headers;
