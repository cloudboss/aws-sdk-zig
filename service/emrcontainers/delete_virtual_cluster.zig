...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVirtualClusterInput, options: CallOptions) !DeleteVirtualClusterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVirtualClusterInput, config: *aws.Config) !aws.http.Request {
