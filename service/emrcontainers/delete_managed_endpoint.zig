...
pub const DeleteManagedEndpointInput = struct {
...
pub const DeleteManagedEndpointOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteManagedEndpointInput, options: CallOptions) !DeleteManagedEndpointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteManagedEndpointInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteManagedEndpointOutput {
    var result: DeleteManagedEndpointOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteManagedEndpointOutput, body, allocator);
    }
    _ = status;
    _ = headers;
