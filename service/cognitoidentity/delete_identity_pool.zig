...
pub const DeleteIdentityPoolInput = struct {
...
pub const DeleteIdentityPoolOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdentityPoolInput, options: CallOptions) !DeleteIdentityPoolOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIdentityPoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSCognitoIdentityService.DeleteIdentityPool");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIdentityPoolOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
