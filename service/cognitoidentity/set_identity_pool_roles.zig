...
const SetIdentityPoolRolesOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetIdentityPoolRolesInput, options: Options) !SetIdentityPoolRolesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SetIdentityPoolRolesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSCognitoIdentityService.SetIdentityPoolRoles");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetIdentityPoolRolesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
