...
pub const DeleteLibraryItemInput = struct {
...
pub const DeleteLibraryItemOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLibraryItemInput, options: CallOptions) !DeleteLibraryItemOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLibraryItemInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLibraryItemOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLibraryItemOutput = .{};
