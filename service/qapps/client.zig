...
pub const Client = struct {
    ...
    /// item.
    pub fn associateLibraryItemReview(self: *Self, allocator: std.mem.Allocator, input: associate_library_item_review.AssociateLibraryItemReviewInput, options: associate_library_item_review.Options) !associate_library_item_review.AssociateLibraryItemReviewOutput {
    ...
    pub fn associateQAppWithUser(self: *Self, allocator: std.mem.Allocator, input: associate_q_app_with_user.AssociateQAppWithUserInput, options: associate_q_app_with_user.Options) !associate_q_app_with_user.AssociateQAppWithUserOutput {
    ...
    pub fn batchCreateCategory(self: *Self, allocator: std.mem.Allocator, input: batch_create_category.BatchCreateCategoryInput, options: batch_create_category.Options) !batch_create_category.BatchCreateCategoryOutput {
    ...
    /// items. For more information, see [Custom labels for Amazon Q
    /// Apps](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/qapps-custom-labels.html).
    pub fn batchDeleteCategory(self: *Self, allocator: std.mem.Allocator, input: batch_delete_category.BatchDeleteCategoryInput, options: batch_delete_category.Options) !batch_delete_category.BatchDeleteCategoryOutput {
    ...
    /// items. For more information, see [Custom labels for Amazon Q
    /// Apps](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/qapps-custom-labels.html).
    pub fn batchUpdateCategory(self: *Self, allocator: std.mem.Allocator, input: batch_update_category.BatchUpdateCategoryInput, options: batch_update_category.Options) !batch_update_category.BatchUpdateCategoryOutput {
    ...
    pub fn createLibraryItem(self: *Self, allocator: std.mem.Allocator, input: create_library_item.CreateLibraryItemInput, options: create_library_item.Options) !create_library_item.CreateLibraryItemOutput {
    ...
    pub fn createPresignedUrl(self: *Self, allocator: std.mem.Allocator, input: create_presigned_url.CreatePresignedUrlInput, options: create_presigned_url.Options) !create_presigned_url.CreatePresignedUrlOutput {
    ...
    /// in the prompts.
    pub fn createQApp(self: *Self, allocator: std.mem.Allocator, input: create_q_app.CreateQAppInput, options: create_q_app.Options) !create_q_app.CreateQAppOutput {
    ...
    pub fn deleteLibraryItem(self: *Self, allocator: std.mem.Allocator, input: delete_library_item.DeleteLibraryItemInput, options: delete_library_item.Options) !delete_library_item.DeleteLibraryItemOutput {
    ...
    pub fn deleteQApp(self: *Self, allocator: std.mem.Allocator, input: delete_q_app.DeleteQAppInput, options: delete_q_app.Options) !delete_q_app.DeleteQAppOutput {
    ...
    pub fn describeQAppPermissions(self: *Self, allocator: std.mem.Allocator, input: describe_q_app_permissions.DescribeQAppPermissionsInput, options: describe_q_app_permissions.Options) !describe_q_app_permissions.DescribeQAppPermissionsOutput {
    ...
    /// item.
    pub fn disassociateLibraryItemReview(self: *Self, allocator: std.mem.Allocator, input: disassociate_library_item_review.DisassociateLibraryItemReviewInput, options: disassociate_library_item_review.Options) !disassociate_library_item_review.DisassociateLibraryItemReviewOutput {
    ...
    /// App.
    pub fn disassociateQAppFromUser(self: *Self, allocator: std.mem.Allocator, input: disassociate_q_app_from_user.DisassociateQAppFromUserInput, options: disassociate_q_app_from_user.Options) !disassociate_q_app_from_user.DisassociateQAppFromUserOutput {
        return disassociate_q_app_from_user.execute(self, allocator, input, options);
    }

    /// Exports the collected data of a Q App data collection session.
    pub fn exportQAppSessionData(self: *Self, allocator: std.mem.Allocator, input: export_q_app_session_data.ExportQAppSessionDataInput, options: export_q_app_session_data.Options) !export_q_app_session_data.ExportQAppSessionDataOutput {
    ...
    pub fn getLibraryItem(self: *Self, allocator: std.mem.Allocator, input: get_library_item.GetLibraryItemInput, options: get_library_item.Options) !get_library_item.GetLibraryItemOutput {
    ...
    /// the cards and flow.
    pub fn getQApp(self: *Self, allocator: std.mem.Allocator, input: get_q_app.GetQAppInput, options: get_q_app.Options) !get_q_app.GetQAppOutput {
    ...
    /// App.
    pub fn getQAppSession(self: *Self, allocator: std.mem.Allocator, input: get_q_app_session.GetQAppSessionInput, options: get_q_app_session.Options) !get_q_app_session.GetQAppSessionOutput {
        return get_q_app_session.execute(self, allocator, input, options);
    }

    /// Retrieves the current configuration of a Q App session.
    pub fn getQAppSessionMetadata(self: *Self, allocator: std.mem.Allocator, input: get_q_app_session_metadata.GetQAppSessionMetadataInput, options: get_q_app_session_metadata.Options) !get_q_app_session_metadata.GetQAppSessionMetadataOutput {
    ...
    /// app session level.
    pub fn importDocument(self: *Self, allocator: std.mem.Allocator, input: import_document.ImportDocumentInput, options: import_document.Options) !import_document.ImportDocumentOutput {
    ...
    /// Apps](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/qapps-custom-labels.html).
    pub fn listCategories(self: *Self, allocator: std.mem.Allocator, input: list_categories.ListCategoriesInput, options: list_categories.Options) !list_categories.ListCategoriesOutput {
    ...
    pub fn listLibraryItems(self: *Self, allocator: std.mem.Allocator, input: list_library_items.ListLibraryItemsInput, options: list_library_items.Options) !list_library_items.ListLibraryItemsOutput {
        return list_library_items.execute(self, allocator, input, options);
    }

    /// Lists the collected data of a Q App data collection session.
    pub fn listQAppSessionData(self: *Self, allocator: std.mem.Allocator, input: list_q_app_session_data.ListQAppSessionDataInput, options: list_q_app_session_data.Options) !list_q_app_session_data.ListQAppSessionDataOutput {
    ...
    /// operation..
    pub fn listQApps(self: *Self, allocator: std.mem.Allocator, input: list_q_apps.ListQAppsInput, options: list_q_apps.Options) !list_q_apps.ListQAppsOutput {
    ...
    pub fn predictQApp(self: *Self, allocator: std.mem.Allocator, input: predict_q_app.PredictQAppInput, options: predict_q_app.Options) !predict_q_app.PredictQAppOutput {
    ...
    /// experience.
    pub fn startQAppSession(self: *Self, allocator: std.mem.Allocator, input: start_q_app_session.StartQAppSessionInput, options: start_q_app_session.Options) !start_q_app_session.StartQAppSessionOutput {
    ...
    pub fn stopQAppSession(self: *Self, allocator: std.mem.Allocator, input: stop_q_app_session.StopQAppSessionInput, options: stop_q_app_session.Options) !stop_q_app_session.StopQAppSessionOutput {
    ...
    pub fn updateLibraryItem(self: *Self, allocator: std.mem.Allocator, input: update_library_item.UpdateLibraryItemInput, options: update_library_item.Options) !update_library_item.UpdateLibraryItemOutput {
        return update_library_item.execute(self, allocator, input, options);
    }

    /// Updates the verification status of a library item for an Amazon Q App.
    pub fn updateLibraryItemMetadata(self: *Self, allocator: std.mem.Allocator, input: update_library_item_metadata.UpdateLibraryItemMetadataInput, options: update_library_item_metadata.Options) !update_library_item_metadata.UpdateLibraryItemMetadataOutput {
    ...
    pub fn updateQApp(self: *Self, allocator: std.mem.Allocator, input: update_q_app.UpdateQAppInput, options: update_q_app.Options) !update_q_app.UpdateQAppOutput {
    ...
    pub fn updateQAppPermissions(self: *Self, allocator: std.mem.Allocator, input: update_q_app_permissions.UpdateQAppPermissionsInput, options: update_q_app_permissions.Options) !update_q_app_permissions.UpdateQAppPermissionsOutput {
    ...
    pub fn updateQAppSession(self: *Self, allocator: std.mem.Allocator, input: update_q_app_session.UpdateQAppSessionInput, options: update_q_app_session.Options) !update_q_app_session.UpdateQAppSessionOutput {
    ...
    /// `sessionId`.
    pub fn updateQAppSessionMetadata(self: *Self, allocator: std.mem.Allocator, input: update_q_app_session_metadata.UpdateQAppSessionMetadataInput, options: update_q_app_session_metadata.Options) !update_q_app_session_metadata.UpdateQAppSessionMetadataOutput {
