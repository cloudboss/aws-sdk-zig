...
pub const AssociateLibraryItemReviewInput = struct {
...
pub const AssociateLibraryItemReviewOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateLibraryItemReviewInput, options: CallOptions) !AssociateLibraryItemReviewOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateLibraryItemReviewInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/catalog.associateItemRating";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateLibraryItemReviewOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateLibraryItemReviewOutput = .{};
