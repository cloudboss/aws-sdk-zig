...
pub const DeleteQAppInput = struct {
...
pub const DeleteQAppOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteQAppInput, options: CallOptions) !DeleteQAppOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteQAppInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteQAppOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteQAppOutput = .{};
