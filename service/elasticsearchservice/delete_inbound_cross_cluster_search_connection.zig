...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInboundCrossClusterSearchConnectionInput, options: Options) !DeleteInboundCrossClusterSearchConnectionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteInboundCrossClusterSearchConnectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteInboundCrossClusterSearchConnectionOutput {
    var result: DeleteInboundCrossClusterSearchConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteInboundCrossClusterSearchConnectionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
