...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelElasticsearchServiceSoftwareUpdateInput, options: CallOptions) !CancelElasticsearchServiceSoftwareUpdateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelElasticsearchServiceSoftwareUpdateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelElasticsearchServiceSoftwareUpdateOutput {
    var result: CancelElasticsearchServiceSoftwareUpdateOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CancelElasticsearchServiceSoftwareUpdateOutput, body, allocator);
    }
    _ = status;
    _ = headers;
