...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptInboundCrossClusterSearchConnectionInput, options: CallOptions) !AcceptInboundCrossClusterSearchConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AcceptInboundCrossClusterSearchConnectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AcceptInboundCrossClusterSearchConnectionOutput {
    var result: AcceptInboundCrossClusterSearchConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(AcceptInboundCrossClusterSearchConnectionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
