...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOutboundCrossClusterSearchConnectionInput, options: Options) !DeleteOutboundCrossClusterSearchConnectionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteOutboundCrossClusterSearchConnectionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2015-01-01/es/ccs/outboundConnection/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteOutboundCrossClusterSearchConnectionOutput {
    var result: DeleteOutboundCrossClusterSearchConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteOutboundCrossClusterSearchConnectionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
