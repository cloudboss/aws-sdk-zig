...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInboundCrossClusterSearchConnectionsInput, options: CallOptions) !DescribeInboundCrossClusterSearchConnectionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeInboundCrossClusterSearchConnectionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeInboundCrossClusterSearchConnectionsOutput {
    var result: DescribeInboundCrossClusterSearchConnectionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeInboundCrossClusterSearchConnectionsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
