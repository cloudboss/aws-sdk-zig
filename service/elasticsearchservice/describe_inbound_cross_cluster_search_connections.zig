...
pub const DescribeInboundCrossClusterSearchConnectionsInput = struct {
...
pub const DescribeInboundCrossClusterSearchConnectionsOutput = struct {
    /// Consists of list of `InboundCrossClusterSearchConnection` matching the
    /// specified filter criteria.
    cross_cluster_search_connections: ?[]const InboundCrossClusterSearchConnection = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInboundCrossClusterSearchConnectionsInput, options: Options) !DescribeInboundCrossClusterSearchConnectionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeInboundCrossClusterSearchConnectionsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/2015-01-01/es/ccs/inboundConnection/search";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeInboundCrossClusterSearchConnectionsOutput {
    var result: DescribeInboundCrossClusterSearchConnectionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeInboundCrossClusterSearchConnectionsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
