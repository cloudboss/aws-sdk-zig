...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociatePackageInput, options: Options) !AssociatePackageOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociatePackageInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2015-01-01/packages/associate/");
