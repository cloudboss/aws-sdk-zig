...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetUpgradeHistoryInput, options: CallOptions) !GetUpgradeHistoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetUpgradeHistoryInput, config: *aws.Config) !aws.http.Request {
