...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteElasticsearchServiceRoleInput, options: CallOptions) !DeleteElasticsearchServiceRoleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteElasticsearchServiceRoleInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteElasticsearchServiceRoleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteElasticsearchServiceRoleOutput = .{};
