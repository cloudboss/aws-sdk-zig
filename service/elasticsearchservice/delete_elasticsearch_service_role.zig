...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteElasticsearchServiceRoleInput, options: Options) !DeleteElasticsearchServiceRoleOutput {
