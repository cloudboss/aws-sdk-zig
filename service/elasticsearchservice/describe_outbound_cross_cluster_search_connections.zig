...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOutboundCrossClusterSearchConnectionsInput, options: Options) !DescribeOutboundCrossClusterSearchConnectionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeOutboundCrossClusterSearchConnectionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeOutboundCrossClusterSearchConnectionsOutput {
    var result: DescribeOutboundCrossClusterSearchConnectionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeOutboundCrossClusterSearchConnectionsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
