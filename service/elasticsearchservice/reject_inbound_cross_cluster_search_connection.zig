...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectInboundCrossClusterSearchConnectionInput, options: CallOptions) !RejectInboundCrossClusterSearchConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RejectInboundCrossClusterSearchConnectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RejectInboundCrossClusterSearchConnectionOutput {
    var result: RejectInboundCrossClusterSearchConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(RejectInboundCrossClusterSearchConnectionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
