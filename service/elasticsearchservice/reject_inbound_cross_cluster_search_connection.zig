...
pub const RejectInboundCrossClusterSearchConnectionInput = struct {
...
pub const RejectInboundCrossClusterSearchConnectionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectInboundCrossClusterSearchConnectionInput, options: Options) !RejectInboundCrossClusterSearchConnectionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RejectInboundCrossClusterSearchConnectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RejectInboundCrossClusterSearchConnectionOutput {
    var result: RejectInboundCrossClusterSearchConnectionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(RejectInboundCrossClusterSearchConnectionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
