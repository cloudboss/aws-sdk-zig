...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartElasticsearchServiceSoftwareUpdateInput, options: CallOptions) !StartElasticsearchServiceSoftwareUpdateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartElasticsearchServiceSoftwareUpdateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartElasticsearchServiceSoftwareUpdateOutput {
    var result: StartElasticsearchServiceSoftwareUpdateOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(StartElasticsearchServiceSoftwareUpdateOutput, body, allocator);
    }
    _ = status;
    _ = headers;
