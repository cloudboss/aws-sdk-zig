...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionsByKeyGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distributionsByKeyGroupId/");
    try path_buf.appendSlice(alloc, input.key_group_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionsByKeyGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
