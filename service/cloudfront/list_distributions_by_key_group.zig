...
pub const ListDistributionsByKeyGroupInput = struct {
...
pub const ListDistributionsByKeyGroupOutput = struct {
    distribution_id_list: ?DistributionIdList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByKeyGroupInput, options: CallOptions) !ListDistributionsByKeyGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsByKeyGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/distributionsByKeyGroupId/");
    try path_buf.appendSlice(allocator, input.key_group_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsByKeyGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByKeyGroupOutput = .{};
