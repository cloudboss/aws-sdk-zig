...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionTenantsByCustomizationInput, options: Options) !ListDistributionTenantsByCustomizationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionTenantsByCustomizationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<ListDistributionTenantsByCustomizationRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionTenantsByCustomizationOutput {
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "DistributionTenantList")) {
                    result.distribution_tenant_list = try serde.deserializeDistributionTenantList(&reader, alloc, "DistributionTenantSummary");
