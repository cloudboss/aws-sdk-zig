...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteStreamingDistributionInput, options: CallOptions) !DeleteStreamingDistributionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteStreamingDistributionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteStreamingDistributionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
