...
pub const DeleteStreamingDistributionInput = struct {
    /// The distribution ID.
    id: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteStreamingDistributionInput, options: Options) !DeleteStreamingDistributionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteStreamingDistributionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteStreamingDistributionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteStreamingDistributionOutput = .{};
