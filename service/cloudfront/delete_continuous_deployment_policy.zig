...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContinuousDeploymentPolicyInput, options: Options) !DeleteContinuousDeploymentPolicyOutput {
