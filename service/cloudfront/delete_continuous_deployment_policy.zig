...
pub const DeleteContinuousDeploymentPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContinuousDeploymentPolicyInput, options: CallOptions) !DeleteContinuousDeploymentPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContinuousDeploymentPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContinuousDeploymentPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContinuousDeploymentPolicyOutput = .{};
