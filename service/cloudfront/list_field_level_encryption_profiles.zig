...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFieldLevelEncryptionProfilesInput, options: Options) !ListFieldLevelEncryptionProfilesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListFieldLevelEncryptionProfilesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListFieldLevelEncryptionProfilesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
