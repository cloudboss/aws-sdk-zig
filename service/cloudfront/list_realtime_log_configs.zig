...
pub const ListRealtimeLogConfigsInput = struct {
...
pub const ListRealtimeLogConfigsOutput = struct {
    /// A list of real-time log configurations.
    realtime_log_configs: ?RealtimeLogConfigs = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRealtimeLogConfigsInput, options: CallOptions) !ListRealtimeLogConfigsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRealtimeLogConfigsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListRealtimeLogConfigsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListRealtimeLogConfigsOutput = .{};
