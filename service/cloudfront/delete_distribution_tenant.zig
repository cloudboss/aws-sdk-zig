...
pub const DeleteDistributionTenantInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDistributionTenantInput, options: CallOptions) !DeleteDistributionTenantOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDistributionTenantInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDistributionTenantOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDistributionTenantOutput = .{};
