...
pub const DisassociateDistributionWebACLInput = struct {
...
pub const DisassociateDistributionWebACLOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateDistributionWebACLInput, options: Options) !DisassociateDistributionWebACLOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateDistributionWebACLInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distribution/");
    try path_buf.appendSlice(alloc, input.id);
    try path_buf.appendSlice(alloc, "/disassociate-web-acl");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateDistributionWebACLOutput {
    var result: DisassociateDistributionWebACLOutput = .{};
    _ = status;
