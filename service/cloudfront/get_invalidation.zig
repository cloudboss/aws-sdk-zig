...
pub const GetInvalidationInput = struct {
...
pub const GetInvalidationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetInvalidationInput, options: CallOptions) !GetInvalidationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetInvalidationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetInvalidationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetInvalidationOutput = .{};
