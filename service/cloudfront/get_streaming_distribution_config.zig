...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetStreamingDistributionConfigInput, options: Options) !GetStreamingDistributionConfigOutput {
