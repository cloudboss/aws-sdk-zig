...
pub const GetStreamingDistributionConfigInput = struct {
    /// The streaming distribution's ID.
    id: []const u8,
};

pub const GetStreamingDistributionConfigOutput = struct {
    /// The current version of the configuration. For example: `E2QWRUHAPOMQZL`.
    e_tag: ?[]const u8 = null,

    /// The streaming distribution's configuration information.
    streaming_distribution_config: ?StreamingDistributionConfig = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetStreamingDistributionConfigInput, options: CallOptions) !GetStreamingDistributionConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetStreamingDistributionConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetStreamingDistributionConfigOutput {
    var result: GetStreamingDistributionConfigOutput = .{};
    _ = status;
    _ = body;
