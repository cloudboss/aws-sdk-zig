...
pub const DeleteConnectionFunctionInput = struct {
...
pub const DeleteConnectionFunctionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConnectionFunctionInput, options: CallOptions) !DeleteConnectionFunctionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConnectionFunctionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteConnectionFunctionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteConnectionFunctionOutput = .{};
