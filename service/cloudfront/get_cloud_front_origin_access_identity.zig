...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCloudFrontOriginAccessIdentityInput, options: Options) !GetCloudFrontOriginAccessIdentityOutput {
