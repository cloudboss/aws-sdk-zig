...
pub const GetCloudFrontOriginAccessIdentityInput = struct {
    /// The identity's ID.
    id: []const u8,
};

pub const GetCloudFrontOriginAccessIdentityOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCloudFrontOriginAccessIdentityInput, options: CallOptions) !GetCloudFrontOriginAccessIdentityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCloudFrontOriginAccessIdentityInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetCloudFrontOriginAccessIdentityOutput {
    var result: GetCloudFrontOriginAccessIdentityOutput = .{};
    _ = status;
    _ = body;
