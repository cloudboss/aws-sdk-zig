...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByResponseHeadersPolicyIdInput, options: Options) !ListDistributionsByResponseHeadersPolicyIdOutput {
