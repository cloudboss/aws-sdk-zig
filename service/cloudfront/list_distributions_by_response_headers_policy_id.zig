...
pub const ListDistributionsByResponseHeadersPolicyIdInput = struct {
...
pub const ListDistributionsByResponseHeadersPolicyIdOutput = struct {
    distribution_id_list: ?DistributionIdList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByResponseHeadersPolicyIdInput, options: CallOptions) !ListDistributionsByResponseHeadersPolicyIdOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsByResponseHeadersPolicyIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/distributionsByResponseHeadersPolicyId/");
    try path_buf.appendSlice(allocator, input.response_headers_policy_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsByResponseHeadersPolicyIdOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByResponseHeadersPolicyIdOutput = .{};
