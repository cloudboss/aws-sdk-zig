...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCloudFrontOriginAccessIdentitiesInput, options: Options) !ListCloudFrontOriginAccessIdentitiesOutput {
