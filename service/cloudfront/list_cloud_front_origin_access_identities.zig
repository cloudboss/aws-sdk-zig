...
pub const ListCloudFrontOriginAccessIdentitiesInput = struct {
...
pub const ListCloudFrontOriginAccessIdentitiesOutput = struct {
    /// The `CloudFrontOriginAccessIdentityList` type.
    cloud_front_origin_access_identity_list: ?CloudFrontOriginAccessIdentityList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCloudFrontOriginAccessIdentitiesInput, options: CallOptions) !ListCloudFrontOriginAccessIdentitiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCloudFrontOriginAccessIdentitiesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListCloudFrontOriginAccessIdentitiesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListCloudFrontOriginAccessIdentitiesOutput = .{};
