...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetStreamingDistributionInput, options: CallOptions) !GetStreamingDistributionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetStreamingDistributionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetStreamingDistributionOutput {
