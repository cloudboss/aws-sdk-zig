...
pub const GetStreamingDistributionInput = struct {
    /// The streaming distribution's ID.
    id: []const u8,
};

pub const GetStreamingDistributionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetStreamingDistributionInput, options: Options) !GetStreamingDistributionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetStreamingDistributionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/streaming-distribution/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetStreamingDistributionOutput {
    var result: GetStreamingDistributionOutput = .{};
    _ = status;
    _ = body;
