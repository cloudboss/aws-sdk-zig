...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCachePoliciesInput, options: Options) !ListCachePoliciesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListCachePoliciesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListCachePoliciesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
