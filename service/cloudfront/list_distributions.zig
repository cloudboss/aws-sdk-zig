...
pub const ListDistributionsInput = struct {
...
pub const ListDistributionsOutput = struct {
    /// The `DistributionList` type.
    distribution_list: ?DistributionList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsInput, options: CallOptions) !ListDistributionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsOutput = .{};
