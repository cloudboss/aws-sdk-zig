...
pub const ListDistributionsByOwnedResourceInput = struct {
...
pub const ListDistributionsByOwnedResourceOutput = struct {
    /// The list of distributions that are using the shared resource.
    distribution_list: ?DistributionIdOwnerList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByOwnedResourceInput, options: CallOptions) !ListDistributionsByOwnedResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsByOwnedResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/distributionsByOwnedResource/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsByOwnedResourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByOwnedResourceOutput = .{};
