...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionsByOwnedResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distributionsByOwnedResource/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionsByOwnedResourceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
