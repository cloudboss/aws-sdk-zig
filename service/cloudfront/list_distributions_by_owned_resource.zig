...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByOwnedResourceInput, options: Options) !ListDistributionsByOwnedResourceOutput {
