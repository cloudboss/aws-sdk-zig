...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDistributionConfigInput, options: CallOptions) !GetDistributionConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDistributionConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDistributionConfigOutput {
