...
pub const DescribeFunctionInput = struct {
...
pub const DescribeFunctionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeFunctionInput, options: CallOptions) !DescribeFunctionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeFunctionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeFunctionOutput {
    var result: DescribeFunctionOutput = .{};
    _ = status;
    _ = body;
