...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCloudFrontOriginAccessIdentityInput, options: Options) !DeleteCloudFrontOriginAccessIdentityOutput {
