...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCloudFrontOriginAccessIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/origin-access-identity/cloudfront/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCloudFrontOriginAccessIdentityOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
