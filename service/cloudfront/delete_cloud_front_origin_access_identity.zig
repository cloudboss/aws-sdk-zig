...
pub const DeleteCloudFrontOriginAccessIdentityInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCloudFrontOriginAccessIdentityInput, options: CallOptions) !DeleteCloudFrontOriginAccessIdentityOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCloudFrontOriginAccessIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/origin-access-identity/cloudfront/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCloudFrontOriginAccessIdentityOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCloudFrontOriginAccessIdentityOutput = .{};
