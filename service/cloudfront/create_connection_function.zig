...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateConnectionFunctionInput, options: Options) !CreateConnectionFunctionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateConnectionFunctionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<CreateConnectionFunctionRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateConnectionFunctionOutput {
