...
pub const UpdateCloudFrontOriginAccessIdentityInput = struct {
...
pub const UpdateCloudFrontOriginAccessIdentityOutput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCloudFrontOriginAccessIdentityInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateCloudFrontOriginAccessIdentityOutput {
    var result: UpdateCloudFrontOriginAccessIdentityOutput = .{};
    _ = status;
    _ = body;
