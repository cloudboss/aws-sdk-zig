...
pub const DeleteCachePolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCachePolicyInput, options: Options) !DeleteCachePolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCachePolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCachePolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCachePolicyOutput = .{};
