...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCachePolicyInput, options: CallOptions) !DeleteCachePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCachePolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCachePolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
