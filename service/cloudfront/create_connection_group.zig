...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateConnectionGroupInput, options: CallOptions) !CreateConnectionGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateConnectionGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateConnectionGroupOutput {
