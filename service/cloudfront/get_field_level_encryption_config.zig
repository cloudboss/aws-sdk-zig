...
pub const GetFieldLevelEncryptionConfigInput = struct {
    /// Request the ID for the field-level encryption configuration information.
    id: []const u8,
};

pub const GetFieldLevelEncryptionConfigOutput = struct {
    /// The current version of the field level encryption configuration. For
    /// example: `E2QWRUHAPOMQZL`.
    e_tag: ?[]const u8 = null,

    /// Return the field-level encryption configuration information.
    field_level_encryption_config: ?FieldLevelEncryptionConfig = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFieldLevelEncryptionConfigInput, options: CallOptions) !GetFieldLevelEncryptionConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFieldLevelEncryptionConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetFieldLevelEncryptionConfigOutput {
    var result: GetFieldLevelEncryptionConfigOutput = .{};
    _ = status;
    _ = body;
