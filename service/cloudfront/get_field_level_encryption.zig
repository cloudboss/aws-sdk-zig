...
pub const GetFieldLevelEncryptionInput = struct {
    /// Request the ID for the field-level encryption configuration information.
    id: []const u8,
};

pub const GetFieldLevelEncryptionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFieldLevelEncryptionInput, options: Options) !GetFieldLevelEncryptionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetFieldLevelEncryptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/field-level-encryption/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetFieldLevelEncryptionOutput {
    var result: GetFieldLevelEncryptionOutput = .{};
    _ = status;
    _ = body;
