...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByRealtimeLogConfigInput, options: Options) !ListDistributionsByRealtimeLogConfigOutput {
