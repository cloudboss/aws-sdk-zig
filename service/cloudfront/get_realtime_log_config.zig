...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRealtimeLogConfigInput, options: Options) !GetRealtimeLogConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetRealtimeLogConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<GetRealtimeLogConfigRequest>");
    if (input.arn) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetRealtimeLogConfigOutput {
