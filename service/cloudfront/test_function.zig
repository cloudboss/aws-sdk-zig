...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TestFunctionInput, options: Options) !TestFunctionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: TestFunctionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !TestFunctionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
