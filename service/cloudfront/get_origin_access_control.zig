...
pub const GetOriginAccessControlInput = struct {
    /// The unique identifier of the origin access control.
    id: []const u8,
};

pub const GetOriginAccessControlOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOriginAccessControlInput, options: CallOptions) !GetOriginAccessControlOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetOriginAccessControlInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetOriginAccessControlOutput {
    var result: GetOriginAccessControlOutput = .{};
    _ = status;
    _ = body;
