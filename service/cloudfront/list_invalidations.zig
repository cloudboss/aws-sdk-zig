...
pub const ListInvalidationsInput = struct {
...
pub const ListInvalidationsOutput = struct {
    /// Information about invalidation batches.
    invalidation_list: ?InvalidationList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListInvalidationsInput, options: CallOptions) !ListInvalidationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListInvalidationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListInvalidationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListInvalidationsOutput = .{};
