...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListInvalidationsForDistributionTenantInput, options: Options) !ListInvalidationsForDistributionTenantOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListInvalidationsForDistributionTenantInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListInvalidationsForDistributionTenantOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
