...
pub const ListDistributionsByOriginRequestPolicyIdInput = struct {
...
pub const ListDistributionsByOriginRequestPolicyIdOutput = struct {
    /// A list of distribution IDs.
    distribution_id_list: ?DistributionIdList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByOriginRequestPolicyIdInput, options: CallOptions) !ListDistributionsByOriginRequestPolicyIdOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsByOriginRequestPolicyIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/distributionsByOriginRequestPolicyId/");
    try path_buf.appendSlice(allocator, input.origin_request_policy_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsByOriginRequestPolicyIdOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByOriginRequestPolicyIdOutput = .{};
