...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByOriginRequestPolicyIdInput, options: Options) !ListDistributionsByOriginRequestPolicyIdOutput {
