...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFunctionInput, options: Options) !GetFunctionOutput {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetFunctionOutput {
    ...
    _ = status;
    if (body.len > 0) {
        result.function_code = try alloc.dupe(u8, body);
    }
