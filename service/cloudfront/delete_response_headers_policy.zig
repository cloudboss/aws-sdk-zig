...
pub const DeleteResponseHeadersPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteResponseHeadersPolicyInput, options: CallOptions) !DeleteResponseHeadersPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteResponseHeadersPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteResponseHeadersPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteResponseHeadersPolicyOutput = .{};
