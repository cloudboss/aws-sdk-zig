...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateConnectionGroupInput, options: Options) !UpdateConnectionGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateConnectionGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<UpdateConnectionGroupRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateConnectionGroupOutput {
