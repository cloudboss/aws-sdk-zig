...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAnycastIpListInput, options: Options) !UpdateAnycastIpListOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateAnycastIpListInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<UpdateAnycastIpListRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateAnycastIpListOutput {
