...
pub const GetDistributionTenantByDomainInput = struct {
    /// A domain name associated with the target distribution tenant.
    domain: []const u8,
};

pub const GetDistributionTenantByDomainOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDistributionTenantByDomainInput, options: CallOptions) !GetDistributionTenantByDomainOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDistributionTenantByDomainInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDistributionTenantByDomainOutput {
    var result: GetDistributionTenantByDomainOutput = .{};
    _ = status;
    _ = body;
