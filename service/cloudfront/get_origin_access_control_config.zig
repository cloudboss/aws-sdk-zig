...
pub const GetOriginAccessControlConfigInput = struct {
    /// The unique identifier of the origin access control.
    id: []const u8,
};

pub const GetOriginAccessControlConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOriginAccessControlConfigInput, options: CallOptions) !GetOriginAccessControlConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetOriginAccessControlConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetOriginAccessControlConfigOutput {
    var result: GetOriginAccessControlConfigOutput = .{};
    _ = status;
    _ = body;
