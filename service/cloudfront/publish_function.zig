...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PublishFunctionInput, options: Options) !PublishFunctionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PublishFunctionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PublishFunctionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
