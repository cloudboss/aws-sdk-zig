...
pub const GetMonitoringSubscriptionInput = struct {
    /// The ID of the distribution that you are getting metrics information for.
    distribution_id: []const u8,
};

pub const GetMonitoringSubscriptionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMonitoringSubscriptionInput, options: CallOptions) !GetMonitoringSubscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetMonitoringSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetMonitoringSubscriptionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetMonitoringSubscriptionOutput = .{};
