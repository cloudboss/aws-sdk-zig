...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCloudFrontOriginAccessIdentityInput, options: Options) !CreateCloudFrontOriginAccessIdentityOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateCloudFrontOriginAccessIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<CloudFrontOriginAccessIdentityConfig xmlns=" ++ &[_]u8{0x22} ++ "http://cloudfront.amazonaws.com/doc/2020-05-31/" ++ &[_]u8{0x22} ++ ">");
    try serde.serializeCloudFrontOriginAccessIdentityConfig(alloc, &body_buf, input.cloud_front_origin_access_identity_config);
    try body_buf.appendSlice(alloc, "</CloudFrontOriginAccessIdentityConfig>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateCloudFrontOriginAccessIdentityOutput {
