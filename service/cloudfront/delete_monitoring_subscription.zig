...
pub const DeleteMonitoringSubscriptionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMonitoringSubscriptionInput, options: Options) !DeleteMonitoringSubscriptionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteMonitoringSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteMonitoringSubscriptionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMonitoringSubscriptionOutput = .{};
