...
pub const DeleteOriginAccessControlInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOriginAccessControlInput, options: CallOptions) !DeleteOriginAccessControlOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteOriginAccessControlInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteOriginAccessControlOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteOriginAccessControlOutput = .{};
