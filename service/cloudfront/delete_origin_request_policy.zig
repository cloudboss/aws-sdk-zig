...
pub const DeleteOriginRequestPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOriginRequestPolicyInput, options: CallOptions) !DeleteOriginRequestPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteOriginRequestPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteOriginRequestPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteOriginRequestPolicyOutput = .{};
