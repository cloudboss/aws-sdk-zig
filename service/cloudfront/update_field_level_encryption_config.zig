...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFieldLevelEncryptionConfigInput, options: Options) !UpdateFieldLevelEncryptionConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateFieldLevelEncryptionConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<FieldLevelEncryptionConfig xmlns=" ++ &[_]u8{0x22} ++ "http://cloudfront.amazonaws.com/doc/2020-05-31/" ++ &[_]u8{0x22} ++ ">");
    try serde.serializeFieldLevelEncryptionConfig(alloc, &body_buf, input.field_level_encryption_config);
    try body_buf.appendSlice(alloc, "</FieldLevelEncryptionConfig>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateFieldLevelEncryptionConfigOutput {
