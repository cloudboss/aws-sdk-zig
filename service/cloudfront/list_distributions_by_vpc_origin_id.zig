...
pub const ListDistributionsByVpcOriginIdInput = struct {
...
pub const ListDistributionsByVpcOriginIdOutput = struct {
    distribution_id_list: ?DistributionIdList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByVpcOriginIdInput, options: CallOptions) !ListDistributionsByVpcOriginIdOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsByVpcOriginIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/distributionsByVpcOriginId/");
    try path_buf.appendSlice(allocator, input.vpc_origin_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsByVpcOriginIdOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByVpcOriginIdOutput = .{};
