...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionsByVpcOriginIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distributionsByVpcOriginId/");
    try path_buf.appendSlice(alloc, input.vpc_origin_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionsByVpcOriginIdOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
