...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByVpcOriginIdInput, options: Options) !ListDistributionsByVpcOriginIdOutput {
