...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateResponseHeadersPolicyInput, options: CallOptions) !UpdateResponseHeadersPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateResponseHeadersPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/response-headers-policy/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateResponseHeadersPolicyOutput {
