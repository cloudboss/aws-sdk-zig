...
pub const DeleteConnectionGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConnectionGroupInput, options: Options) !DeleteConnectionGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConnectionGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConnectionGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteConnectionGroupOutput = .{};
