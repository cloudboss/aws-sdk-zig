...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConnectionGroupInput, options: CallOptions) !DeleteConnectionGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConnectionGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteConnectionGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
