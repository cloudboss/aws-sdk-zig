...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateKeyValueStoreInput, options: Options) !UpdateKeyValueStoreOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateKeyValueStoreInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<UpdateKeyValueStoreRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateKeyValueStoreOutput {
