...
pub const GetCachePolicyInput = struct {
...
pub const GetCachePolicyOutput = struct {
    /// The cache policy.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCachePolicyInput, options: Options) !GetCachePolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCachePolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetCachePolicyOutput {
    var result: GetCachePolicyOutput = .{};
    _ = status;
    _ = body;
