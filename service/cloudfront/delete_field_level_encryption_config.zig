...
pub const DeleteFieldLevelEncryptionConfigInput = struct {
...
pub const DeleteFieldLevelEncryptionConfigOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFieldLevelEncryptionConfigInput, options: CallOptions) !DeleteFieldLevelEncryptionConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFieldLevelEncryptionConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFieldLevelEncryptionConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFieldLevelEncryptionConfigOutput = .{};
