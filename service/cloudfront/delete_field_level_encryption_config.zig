...
const DeleteFieldLevelEncryptionConfigOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFieldLevelEncryptionConfigInput, options: Options) !DeleteFieldLevelEncryptionConfigOutput {
