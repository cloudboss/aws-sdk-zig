...
pub const ListStreamingDistributionsInput = struct {
...
pub const ListStreamingDistributionsOutput = struct {
    /// The `StreamingDistributionList` type.
    streaming_distribution_list: ?StreamingDistributionList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListStreamingDistributionsInput, options: CallOptions) !ListStreamingDistributionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListStreamingDistributionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListStreamingDistributionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListStreamingDistributionsOutput = .{};
