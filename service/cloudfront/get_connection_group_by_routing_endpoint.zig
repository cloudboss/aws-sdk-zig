...
pub const GetConnectionGroupByRoutingEndpointInput = struct {
    /// The routing endpoint for the target connection group, such as
    /// d111111abcdef8.cloudfront.net.
    routing_endpoint: []const u8,
};

pub const GetConnectionGroupByRoutingEndpointOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConnectionGroupByRoutingEndpointInput, options: CallOptions) !GetConnectionGroupByRoutingEndpointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetConnectionGroupByRoutingEndpointInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "RoutingEndpoint=");
    try aws.url.appendUrlEncoded(allocator, &query_buf, input.routing_endpoint);
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetConnectionGroupByRoutingEndpointOutput {
    var result: GetConnectionGroupByRoutingEndpointOutput = .{};
    _ = status;
    _ = body;
