...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConnectionGroupByRoutingEndpointInput, options: Options) !GetConnectionGroupByRoutingEndpointOutput {
