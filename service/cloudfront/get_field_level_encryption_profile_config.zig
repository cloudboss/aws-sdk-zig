...
pub const GetFieldLevelEncryptionProfileConfigInput = struct {
    /// Get the ID for the field-level encryption profile configuration information.
    id: []const u8,
};

pub const GetFieldLevelEncryptionProfileConfigOutput = struct {
    /// The current version of the field-level encryption profile configuration
    /// result. For example: `E2QWRUHAPOMQZL`.
    e_tag: ?[]const u8 = null,

    /// Return the field-level encryption profile configuration information.
    field_level_encryption_profile_config: ?FieldLevelEncryptionProfileConfig = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFieldLevelEncryptionProfileConfigInput, options: CallOptions) !GetFieldLevelEncryptionProfileConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFieldLevelEncryptionProfileConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetFieldLevelEncryptionProfileConfigOutput {
    var result: GetFieldLevelEncryptionProfileConfigOutput = .{};
    _ = status;
    _ = body;
