...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetManagedCertificateDetailsInput, options: Options) !GetManagedCertificateDetailsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetManagedCertificateDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/managed-certificate/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetManagedCertificateDetailsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
