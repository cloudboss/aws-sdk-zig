...
pub const ListDistributionsByAnycastIpListIdInput = struct {
...
pub const ListDistributionsByAnycastIpListIdOutput = struct {
    distribution_list: ?DistributionList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByAnycastIpListIdInput, options: CallOptions) !ListDistributionsByAnycastIpListIdOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionsByAnycastIpListIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2020-05-31/distributionsByAnycastIpListId/");
    try path_buf.appendSlice(allocator, input.anycast_ip_list_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionsByAnycastIpListIdOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByAnycastIpListIdOutput = .{};
