...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionsByAnycastIpListIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distributionsByAnycastIpListId/");
    try path_buf.appendSlice(alloc, input.anycast_ip_list_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionsByAnycastIpListIdOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
