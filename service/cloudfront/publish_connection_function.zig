...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PublishConnectionFunctionInput, options: CallOptions) !PublishConnectionFunctionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PublishConnectionFunctionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PublishConnectionFunctionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
