...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByConnectionFunctionInput, options: Options) !ListDistributionsByConnectionFunctionOutput {
