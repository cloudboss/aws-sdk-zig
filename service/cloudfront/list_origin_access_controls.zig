...
pub const ListOriginAccessControlsInput = struct {
...
pub const ListOriginAccessControlsOutput = struct {
    /// A list of origin access controls.
    origin_access_control_list: ?OriginAccessControlList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListOriginAccessControlsInput, options: CallOptions) !ListOriginAccessControlsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListOriginAccessControlsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListOriginAccessControlsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListOriginAccessControlsOutput = .{};
