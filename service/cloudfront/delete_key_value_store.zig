...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKeyValueStoreInput, options: CallOptions) !DeleteKeyValueStoreOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKeyValueStoreInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteKeyValueStoreOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
