...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateAliasInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.target_distribution_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateAliasOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
