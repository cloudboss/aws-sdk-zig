...
pub const DeleteAnycastIpListInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAnycastIpListInput, options: Options) !DeleteAnycastIpListOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAnycastIpListInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAnycastIpListOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAnycastIpListOutput = .{};
