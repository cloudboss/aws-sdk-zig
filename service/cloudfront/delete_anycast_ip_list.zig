...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAnycastIpListInput, options: CallOptions) !DeleteAnycastIpListOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAnycastIpListInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAnycastIpListOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
