...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFieldLevelEncryptionProfileInput, options: Options) !GetFieldLevelEncryptionProfileOutput {
