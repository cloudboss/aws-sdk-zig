...
pub const GetFieldLevelEncryptionProfileInput = struct {
    /// Get the ID for the field-level encryption profile information.
    id: []const u8,
};

pub const GetFieldLevelEncryptionProfileOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFieldLevelEncryptionProfileInput, options: CallOptions) !GetFieldLevelEncryptionProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFieldLevelEncryptionProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetFieldLevelEncryptionProfileOutput {
    var result: GetFieldLevelEncryptionProfileOutput = .{};
    _ = status;
    _ = body;
