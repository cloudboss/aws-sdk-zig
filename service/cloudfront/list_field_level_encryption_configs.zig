...
pub const ListFieldLevelEncryptionConfigsInput = struct {
...
pub const ListFieldLevelEncryptionConfigsOutput = struct {
    /// Returns a list of all field-level encryption configurations that have been
    /// created in CloudFront for this account.
    field_level_encryption_list: ?FieldLevelEncryptionList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFieldLevelEncryptionConfigsInput, options: CallOptions) !ListFieldLevelEncryptionConfigsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFieldLevelEncryptionConfigsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListFieldLevelEncryptionConfigsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListFieldLevelEncryptionConfigsOutput = .{};
