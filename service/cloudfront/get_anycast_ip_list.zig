...
pub const GetAnycastIpListInput = struct {
    /// The ID of the Anycast static IP list.
    id: []const u8,
};

pub const GetAnycastIpListOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAnycastIpListInput, options: Options) !GetAnycastIpListOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAnycastIpListInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/anycast-ip-list/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetAnycastIpListOutput {
    var result: GetAnycastIpListOutput = .{};
    _ = status;
    _ = body;
