...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreatePublicKeyInput, options: Options) !CreatePublicKeyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreatePublicKeyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreatePublicKeyOutput {
