...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateVpcOriginInput, options: CallOptions) !UpdateVpcOriginOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateVpcOriginInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "<VpcOriginEndpointConfig xmlns=" ++ &[_]u8{0x22} ++ "http://cloudfront.amazonaws.com/doc/2020-05-31/" ++ &[_]u8{0x22} ++ ">");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateVpcOriginOutput {
