...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetKeyGroupInput, options: CallOptions) !GetKeyGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetKeyGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetKeyGroupOutput {
