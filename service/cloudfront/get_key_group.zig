...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetKeyGroupInput, options: Options) !GetKeyGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetKeyGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetKeyGroupOutput {
    var result: GetKeyGroupOutput = .{};
    _ = status;
    _ = body;
