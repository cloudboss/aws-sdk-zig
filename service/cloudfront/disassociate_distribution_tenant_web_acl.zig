...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateDistributionTenantWebACLInput, options: Options) !DisassociateDistributionTenantWebACLOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateDistributionTenantWebACLInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateDistributionTenantWebACLOutput {
