...
pub const ListContinuousDeploymentPoliciesInput = struct {
...
pub const ListContinuousDeploymentPoliciesOutput = struct {
    /// A list of continuous deployment policies.
    continuous_deployment_policy_list: ?ContinuousDeploymentPolicyList = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListContinuousDeploymentPoliciesInput, options: CallOptions) !ListContinuousDeploymentPoliciesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListContinuousDeploymentPoliciesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListContinuousDeploymentPoliciesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListContinuousDeploymentPoliciesOutput = .{};
