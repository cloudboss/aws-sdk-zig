...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListContinuousDeploymentPoliciesInput, options: Options) !ListContinuousDeploymentPoliciesOutput {
