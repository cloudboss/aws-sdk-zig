...
pub const CustomErrorResponse = struct {
    ...
    ///   must include a cache behavior for which the path pattern routes requests
    ///   for your custom error pages to that location, for example,
    ///   `/4xx-errors/*`.
