...
pub const ListDistributionsByConnectionModeInput = struct {
...
pub const ListDistributionsByConnectionModeOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByConnectionModeInput, options: Options) !ListDistributionsByConnectionModeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionsByConnectionModeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distributionsByConnectionMode/");
    try path_buf.appendSlice(alloc, input.connection_mode);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionsByConnectionModeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListDistributionsByConnectionModeOutput = .{};
