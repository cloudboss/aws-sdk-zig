...
pub const DescribeConnectionFunctionInput = struct {
...
pub const DescribeConnectionFunctionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeConnectionFunctionInput, options: CallOptions) !DescribeConnectionFunctionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeConnectionFunctionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeConnectionFunctionOutput {
    var result: DescribeConnectionFunctionOutput = .{};
    _ = status;
    _ = body;
