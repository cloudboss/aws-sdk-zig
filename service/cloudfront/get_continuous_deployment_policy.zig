...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContinuousDeploymentPolicyInput, options: CallOptions) !GetContinuousDeploymentPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetContinuousDeploymentPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetContinuousDeploymentPolicyOutput {
