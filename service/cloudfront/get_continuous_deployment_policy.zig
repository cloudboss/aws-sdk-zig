...
pub const GetContinuousDeploymentPolicyInput = struct {
    /// The identifier of the continuous deployment policy that you are getting.
    id: []const u8,
};

pub const GetContinuousDeploymentPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContinuousDeploymentPolicyInput, options: Options) !GetContinuousDeploymentPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetContinuousDeploymentPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetContinuousDeploymentPolicyOutput {
    var result: GetContinuousDeploymentPolicyOutput = .{};
    _ = status;
    _ = body;
