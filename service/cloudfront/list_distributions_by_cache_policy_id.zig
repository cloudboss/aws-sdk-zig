...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDistributionsByCachePolicyIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/distributionsByCachePolicyId/");
    try path_buf.appendSlice(alloc, input.cache_policy_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDistributionsByCachePolicyIdOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
