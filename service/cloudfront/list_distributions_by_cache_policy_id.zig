...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionsByCachePolicyIdInput, options: Options) !ListDistributionsByCachePolicyIdOutput {
