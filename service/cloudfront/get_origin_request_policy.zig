...
pub const GetOriginRequestPolicyInput = struct {
...
pub const GetOriginRequestPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOriginRequestPolicyInput, options: Options) !GetOriginRequestPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetOriginRequestPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-05-31/origin-request-policy/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetOriginRequestPolicyOutput {
    var result: GetOriginRequestPolicyOutput = .{};
    _ = status;
    _ = body;
