...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFieldLevelEncryptionProfileInput, options: CallOptions) !DeleteFieldLevelEncryptionProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFieldLevelEncryptionProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFieldLevelEncryptionProfileOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
