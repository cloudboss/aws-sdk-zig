...
pub const GetResponseHeadersPolicyConfigInput = struct {
...
pub const GetResponseHeadersPolicyConfigOutput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetResponseHeadersPolicyConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetResponseHeadersPolicyConfigOutput {
    var result: GetResponseHeadersPolicyConfigOutput = .{};
    _ = status;
    _ = body;
