...
pub const AssociateDistributionWebACLInput = struct {
...
pub const AssociateDistributionWebACLOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateDistributionWebACLInput, options: CallOptions) !AssociateDistributionWebACLOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateDistributionWebACLInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "<AssociateDistributionWebACLRequest xmlns=\"http://cloudfront.amazonaws.com/doc/2020-05-31/\">");
    try body_buf.appendSlice(allocator, "<WebACLArn>");
    try aws.xml.appendXmlEscaped(allocator, &body_buf, input.web_acl_arn);
    try body_buf.appendSlice(allocator, "</WebACLArn>");
    try body_buf.appendSlice(allocator, "</AssociateDistributionWebACLRequest>");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateDistributionWebACLOutput {
    var result: AssociateDistributionWebACLOutput = .{};
    _ = status;
