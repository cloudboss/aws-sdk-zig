...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateDistributionWebACLInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<AssociateDistributionWebACLRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateDistributionWebACLOutput {
