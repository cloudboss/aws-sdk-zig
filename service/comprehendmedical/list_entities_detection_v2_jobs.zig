...
pub const ListEntitiesDetectionV2JobsInput = struct {
...
pub const ListEntitiesDetectionV2JobsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEntitiesDetectionV2JobsInput, options: CallOptions) !ListEntitiesDetectionV2JobsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEntitiesDetectionV2JobsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ComprehendMedical_20181030.ListEntitiesDetectionV2Jobs");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListEntitiesDetectionV2JobsOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListEntitiesDetectionV2JobsOutput, body, allocator);
}
