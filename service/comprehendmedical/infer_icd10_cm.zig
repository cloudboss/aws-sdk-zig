...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: InferICD10CMInput, options: Options) !InferICD10CMOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: InferICD10CMInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "ComprehendMedical_20181030.InferICD10CM");
