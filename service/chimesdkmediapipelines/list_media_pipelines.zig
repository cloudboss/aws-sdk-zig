...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMediaPipelinesInput, options: CallOptions) !ListMediaPipelinesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListMediaPipelinesInput, config: *aws.Config) !aws.http.Request {
