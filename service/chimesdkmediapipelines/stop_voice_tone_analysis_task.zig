...
pub const StopVoiceToneAnalysisTaskOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopVoiceToneAnalysisTaskInput, options: CallOptions) !StopVoiceToneAnalysisTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopVoiceToneAnalysisTaskInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopVoiceToneAnalysisTaskOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
