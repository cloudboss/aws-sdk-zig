...
pub const StopVoiceToneAnalysisTaskInput = struct {
...
const StopVoiceToneAnalysisTaskOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopVoiceToneAnalysisTaskInput, options: Options) !StopVoiceToneAnalysisTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopVoiceToneAnalysisTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/voice-tone-analysis-tasks/");
    try path_buf.appendSlice(alloc, input.voice_tone_analysis_task_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopVoiceToneAnalysisTaskOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopVoiceToneAnalysisTaskOutput = .{};
