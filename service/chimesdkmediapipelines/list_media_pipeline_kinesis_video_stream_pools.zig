...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMediaPipelineKinesisVideoStreamPoolsInput, options: Options) !ListMediaPipelineKinesisVideoStreamPoolsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListMediaPipelineKinesisVideoStreamPoolsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListMediaPipelineKinesisVideoStreamPoolsOutput {
    var result: ListMediaPipelineKinesisVideoStreamPoolsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListMediaPipelineKinesisVideoStreamPoolsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
