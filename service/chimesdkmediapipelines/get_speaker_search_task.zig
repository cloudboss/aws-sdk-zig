...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSpeakerSearchTaskInput, options: CallOptions) !GetSpeakerSearchTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSpeakerSearchTaskInput, config: *aws.Config) !aws.http.Request {
