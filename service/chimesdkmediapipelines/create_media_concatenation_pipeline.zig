...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateMediaConcatenationPipelineInput, options: Options) !CreateMediaConcatenationPipelineOutput {
