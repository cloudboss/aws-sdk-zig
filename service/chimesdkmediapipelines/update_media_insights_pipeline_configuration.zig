...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateMediaInsightsPipelineConfigurationInput, options: Options) !UpdateMediaInsightsPipelineConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateMediaInsightsPipelineConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateMediaInsightsPipelineConfigurationOutput {
    var result: UpdateMediaInsightsPipelineConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateMediaInsightsPipelineConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
