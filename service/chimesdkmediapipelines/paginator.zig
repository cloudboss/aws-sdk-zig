...
pub const ListMediaCapturePipelinesPaginator = struct {
    client: *Client,
    params: list_media_capture_pipelines.ListMediaCapturePipelinesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_media_capture_pipelines.ListMediaCapturePipelinesOutput {
        ...
        const output = try list_media_capture_pipelines.execute(self.client, allocator, self.params, options);
...
pub const ListMediaInsightsPipelineConfigurationsPaginator = struct {
    client: *Client,
    params: list_media_insights_pipeline_configurations.ListMediaInsightsPipelineConfigurationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_media_insights_pipeline_configurations.ListMediaInsightsPipelineConfigurationsOutput {
        ...
        const output = try list_media_insights_pipeline_configurations.execute(self.client, allocator, self.params, options);
...
pub const ListMediaPipelineKinesisVideoStreamPoolsPaginator = struct {
    client: *Client,
    params: list_media_pipeline_kinesis_video_stream_pools.ListMediaPipelineKinesisVideoStreamPoolsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_media_pipeline_kinesis_video_stream_pools.ListMediaPipelineKinesisVideoStreamPoolsOutput {
        ...
        const output = try list_media_pipeline_kinesis_video_stream_pools.execute(self.client, allocator, self.params, options);
...
pub const ListMediaPipelinesPaginator = struct {
    client: *Client,
    params: list_media_pipelines.ListMediaPipelinesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_media_pipelines.ListMediaPipelinesOutput {
        ...
        const output = try list_media_pipelines.execute(self.client, allocator, self.params, options);
