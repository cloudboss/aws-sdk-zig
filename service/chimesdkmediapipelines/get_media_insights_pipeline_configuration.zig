...
pub const GetMediaInsightsPipelineConfigurationInput = struct {
...
pub const GetMediaInsightsPipelineConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMediaInsightsPipelineConfigurationInput, options: CallOptions) !GetMediaInsightsPipelineConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetMediaInsightsPipelineConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetMediaInsightsPipelineConfigurationOutput {
    var result: GetMediaInsightsPipelineConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetMediaInsightsPipelineConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
