...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMediaInsightsPipelineConfigurationInput, options: Options) !GetMediaInsightsPipelineConfigurationOutput {
