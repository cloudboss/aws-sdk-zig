...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateLinkInput, options: CallOptions) !AssociateLinkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateLinkInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.link_id), input.link_id, allocator, &body_buf);
    has_prev = true;
