...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGlobalNetworkInput, options: CallOptions) !DeleteGlobalNetworkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteGlobalNetworkInput, config: *aws.Config) !aws.http.Request {
