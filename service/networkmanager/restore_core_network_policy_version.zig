...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestoreCoreNetworkPolicyVersionInput, options: CallOptions) !RestoreCoreNetworkPolicyVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RestoreCoreNetworkPolicyVersionInput, config: *aws.Config) !aws.http.Request {
