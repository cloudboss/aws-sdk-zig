...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTransitGatewayPeeringInput, options: CallOptions) !GetTransitGatewayPeeringOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTransitGatewayPeeringInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/transit-gateway-peerings/");
    try path_buf.appendSlice(allocator, input.peering_id);
