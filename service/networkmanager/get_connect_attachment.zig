...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetConnectAttachmentInput, options: CallOptions) !GetConnectAttachmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetConnectAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/connect-attachments/");
