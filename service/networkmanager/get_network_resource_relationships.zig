...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetNetworkResourceRelationshipsInput, options: Options) !GetNetworkResourceRelationshipsOutput {
