...
pub const UpdateLinkInput = @import("update_link_request.zig").UpdateLinkRequest;

pub const UpdateLinkOutput = @import("update_link_response.zig").UpdateLinkResponse;
