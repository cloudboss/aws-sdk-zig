...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterTransitGatewayInput, options: CallOptions) !DeregisterTransitGatewayOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterTransitGatewayInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.transit_gateway_arn);
