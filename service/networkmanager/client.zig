...
pub const Client = struct {
    ...
    pub fn acceptAttachment(self: *Self, allocator: std.mem.Allocator, input: accept_attachment.AcceptAttachmentInput, options: CallOptions) !accept_attachment.AcceptAttachmentOutput {
    ...
    pub fn associateConnectPeer(self: *Self, allocator: std.mem.Allocator, input: associate_connect_peer.AssociateConnectPeerInput, options: CallOptions) !associate_connect_peer.AssociateConnectPeerOutput {
    ...
    pub fn associateCustomerGateway(self: *Self, allocator: std.mem.Allocator, input: associate_customer_gateway.AssociateCustomerGatewayInput, options: CallOptions) !associate_customer_gateway.AssociateCustomerGatewayOutput {
    ...
    pub fn associateLink(self: *Self, allocator: std.mem.Allocator, input: associate_link.AssociateLinkInput, options: CallOptions) !associate_link.AssociateLinkOutput {
    ...
    /// device and link.
    pub fn associateTransitGatewayConnectPeer(self: *Self, allocator: std.mem.Allocator, input: associate_transit_gateway_connect_peer.AssociateTransitGatewayConnectPeerInput, options: CallOptions) !associate_transit_gateway_connect_peer.AssociateTransitGatewayConnectPeerOutput {
    ...
    /// mechanism.
    pub fn createConnectAttachment(self: *Self, allocator: std.mem.Allocator, input: create_connect_attachment.CreateConnectAttachmentInput, options: CallOptions) !create_connect_attachment.CreateConnectAttachmentOutput {
    ...
    /// family (IPv4 or IPv6).
    pub fn createConnectPeer(self: *Self, allocator: std.mem.Allocator, input: create_connect_peer.CreateConnectPeerInput, options: CallOptions) !create_connect_peer.CreateConnectPeerOutput {
    ...
    pub fn createCoreNetwork(self: *Self, allocator: std.mem.Allocator, input: create_core_network.CreateCoreNetworkInput, options: CallOptions) !create_core_network.CreateCoreNetworkOutput {
    ...
    /// control.
    pub fn createCoreNetworkPrefixListAssociation(self: *Self, allocator: std.mem.Allocator, input: create_core_network_prefix_list_association.CreateCoreNetworkPrefixListAssociationInput, options: CallOptions) !create_core_network_prefix_list_association.CreateCoreNetworkPrefixListAssociationOutput {
    ...
    /// Manager console.
    pub fn createDevice(self: *Self, allocator: std.mem.Allocator, input: create_device.CreateDeviceInput, options: CallOptions) !create_device.CreateDeviceOutput {
        return create_device.execute(self, allocator, input, options);
    }

    /// Creates an Amazon Web Services Direct Connect gateway attachment
    pub fn createDirectConnectGatewayAttachment(self: *Self, allocator: std.mem.Allocator, input: create_direct_connect_gateway_attachment.CreateDirectConnectGatewayAttachmentInput, options: CallOptions) !create_direct_connect_gateway_attachment.CreateDirectConnectGatewayAttachmentOutput {
        return create_direct_connect_gateway_attachment.execute(self, allocator, input, options);
    }

    /// Creates a new, empty global network.
    pub fn createGlobalNetwork(self: *Self, allocator: std.mem.Allocator, input: create_global_network.CreateGlobalNetworkInput, options: CallOptions) !create_global_network.CreateGlobalNetworkOutput {
    ...
    pub fn createSiteToSiteVpnAttachment(self: *Self, allocator: std.mem.Allocator, input: create_site_to_site_vpn_attachment.CreateSiteToSiteVpnAttachmentInput, options: CallOptions) !create_site_to_site_vpn_attachment.CreateSiteToSiteVpnAttachmentOutput {
        return create_site_to_site_vpn_attachment.execute(self, allocator, input, options);
    }

    /// Creates a transit gateway peering connection.
    pub fn createTransitGatewayPeering(self: *Self, allocator: std.mem.Allocator, input: create_transit_gateway_peering.CreateTransitGatewayPeeringInput, options: CallOptions) !create_transit_gateway_peering.CreateTransitGatewayPeeringOutput {
        return create_transit_gateway_peering.execute(self, allocator, input, options);
    }

    /// Creates a transit gateway route table attachment.
    pub fn createTransitGatewayRouteTableAttachment(self: *Self, allocator: std.mem.Allocator, input: create_transit_gateway_route_table_attachment.CreateTransitGatewayRouteTableAttachmentInput, options: CallOptions) !create_transit_gateway_route_table_attachment.CreateTransitGatewayRouteTableAttachmentOutput {
        return create_transit_gateway_route_table_attachment.execute(self, allocator, input, options);
    }

    /// Creates a VPC attachment on an edge location of a core network.
    pub fn createVpcAttachment(self: *Self, allocator: std.mem.Allocator, input: create_vpc_attachment.CreateVpcAttachmentInput, options: CallOptions) !create_vpc_attachment.CreateVpcAttachmentOutput {
    ...
    pub fn deleteConnectPeer(self: *Self, allocator: std.mem.Allocator, input: delete_connect_peer.DeleteConnectPeerInput, options: CallOptions) !delete_connect_peer.DeleteConnectPeerOutput {
    ...
    pub fn deleteCoreNetwork(self: *Self, allocator: std.mem.Allocator, input: delete_core_network.DeleteCoreNetworkInput, options: CallOptions) !delete_core_network.DeleteCoreNetworkOutput {
    ...
    /// LIVE policy.
    pub fn deleteCoreNetworkPolicyVersion(self: *Self, allocator: std.mem.Allocator, input: delete_core_network_policy_version.DeleteCoreNetworkPolicyVersionInput, options: CallOptions) !delete_core_network_policy_version.DeleteCoreNetworkPolicyVersionOutput {
    ...
    pub fn deleteCoreNetworkPrefixListAssociation(self: *Self, allocator: std.mem.Allocator, input: delete_core_network_prefix_list_association.DeleteCoreNetworkPrefixListAssociationInput, options: CallOptions) !delete_core_network_prefix_list_association.DeleteCoreNetworkPrefixListAssociationOutput {
    ...
    /// core networks.
    pub fn deleteGlobalNetwork(self: *Self, allocator: std.mem.Allocator, input: delete_global_network.DeleteGlobalNetworkInput, options: CallOptions) !delete_global_network.DeleteGlobalNetworkOutput {
    ...
    pub fn deletePeering(self: *Self, allocator: std.mem.Allocator, input: delete_peering.DeletePeeringInput, options: CallOptions) !delete_peering.DeletePeeringOutput {
    ...
    pub fn deregisterTransitGateway(self: *Self, allocator: std.mem.Allocator, input: deregister_transit_gateway.DeregisterTransitGatewayInput, options: CallOptions) !deregister_transit_gateway.DeregisterTransitGatewayOutput {
    ...
    pub fn describeGlobalNetworks(self: *Self, allocator: std.mem.Allocator, input: describe_global_networks.DescribeGlobalNetworksInput, options: CallOptions) !describe_global_networks.DescribeGlobalNetworksOutput {
        return describe_global_networks.execute(self, allocator, input, options);
    }

    /// Disassociates a core network Connect peer from a device and a link.
    pub fn disassociateConnectPeer(self: *Self, allocator: std.mem.Allocator, input: disassociate_connect_peer.DisassociateConnectPeerInput, options: CallOptions) !disassociate_connect_peer.DisassociateConnectPeerOutput {
        return disassociate_connect_peer.execute(self, allocator, input, options);
    }

    /// Disassociates a customer gateway from a device and a link.
    pub fn disassociateCustomerGateway(self: *Self, allocator: std.mem.Allocator, input: disassociate_customer_gateway.DisassociateCustomerGatewayInput, options: CallOptions) !disassociate_customer_gateway.DisassociateCustomerGatewayOutput {
    ...
    pub fn disassociateLink(self: *Self, allocator: std.mem.Allocator, input: disassociate_link.DisassociateLinkInput, options: CallOptions) !disassociate_link.DisassociateLinkOutput {
        return disassociate_link.execute(self, allocator, input, options);
    }

    /// Disassociates a transit gateway Connect peer from a device and link.
    pub fn disassociateTransitGatewayConnectPeer(self: *Self, allocator: std.mem.Allocator, input: disassociate_transit_gateway_connect_peer.DisassociateTransitGatewayConnectPeerInput, options: CallOptions) !disassociate_transit_gateway_connect_peer.DisassociateTransitGatewayConnectPeerOutput {
    ...
    pub fn executeCoreNetworkChangeSet(self: *Self, allocator: std.mem.Allocator, input: execute_core_network_change_set.ExecuteCoreNetworkChangeSetInput, options: CallOptions) !execute_core_network_change_set.ExecuteCoreNetworkChangeSetOutput {
        return execute_core_network_change_set.execute(self, allocator, input, options);
    }

    /// Returns information about a core network Connect attachment.
    pub fn getConnectAttachment(self: *Self, allocator: std.mem.Allocator, input: get_connect_attachment.GetConnectAttachmentInput, options: CallOptions) !get_connect_attachment.GetConnectAttachmentOutput {
        return get_connect_attachment.execute(self, allocator, input, options);
    }

    /// Returns information about a core network Connect peer.
    pub fn getConnectPeer(self: *Self, allocator: std.mem.Allocator, input: get_connect_peer.GetConnectPeerInput, options: CallOptions) !get_connect_peer.GetConnectPeerOutput {
        return get_connect_peer.execute(self, allocator, input, options);
    }

    /// Returns information about a core network Connect peer associations.
    pub fn getConnectPeerAssociations(self: *Self, allocator: std.mem.Allocator, input: get_connect_peer_associations.GetConnectPeerAssociationsInput, options: CallOptions) !get_connect_peer_associations.GetConnectPeerAssociationsOutput {
    ...
    pub fn getCoreNetwork(self: *Self, allocator: std.mem.Allocator, input: get_core_network.GetCoreNetworkInput, options: CallOptions) !get_core_network.GetCoreNetworkOutput {
        return get_core_network.execute(self, allocator, input, options);
    }

    /// Returns information about a core network change event.
    pub fn getCoreNetworkChangeEvents(self: *Self, allocator: std.mem.Allocator, input: get_core_network_change_events.GetCoreNetworkChangeEventsInput, options: CallOptions) !get_core_network_change_events.GetCoreNetworkChangeEventsOutput {
    ...
    /// policy.
    pub fn getCoreNetworkChangeSet(self: *Self, allocator: std.mem.Allocator, input: get_core_network_change_set.GetCoreNetworkChangeSetInput, options: CallOptions) !get_core_network_change_set.GetCoreNetworkChangeSetOutput {
    ...
    pub fn getCoreNetworkPolicy(self: *Self, allocator: std.mem.Allocator, input: get_core_network_policy.GetCoreNetworkPolicyInput, options: CallOptions) !get_core_network_policy.GetCoreNetworkPolicyOutput {
    ...
    pub fn getCustomerGatewayAssociations(self: *Self, allocator: std.mem.Allocator, input: get_customer_gateway_associations.GetCustomerGatewayAssociationsInput, options: CallOptions) !get_customer_gateway_associations.GetCustomerGatewayAssociationsOutput {
        return get_customer_gateway_associations.execute(self, allocator, input, options);
    }

    /// Gets information about one or more of your devices in a global network.
    pub fn getDevices(self: *Self, allocator: std.mem.Allocator, input: get_devices.GetDevicesInput, options: CallOptions) !get_devices.GetDevicesOutput {
    ...
    /// gateway attachment.
    pub fn getDirectConnectGatewayAttachment(self: *Self, allocator: std.mem.Allocator, input: get_direct_connect_gateway_attachment.GetDirectConnectGatewayAttachmentInput, options: CallOptions) !get_direct_connect_gateway_attachment.GetDirectConnectGatewayAttachmentOutput {
    ...
    /// the link ID
    /// must be specified.
    pub fn getLinkAssociations(self: *Self, allocator: std.mem.Allocator, input: get_link_associations.GetLinkAssociationsInput, options: CallOptions) !get_link_associations.GetLinkAssociationsOutput {
    ...
    pub fn getLinks(self: *Self, allocator: std.mem.Allocator, input: get_links.GetLinksInput, options: CallOptions) !get_links.GetLinksOutput {
    ...
    /// global network.
    pub fn getNetworkResourceCounts(self: *Self, allocator: std.mem.Allocator, input: get_network_resource_counts.GetNetworkResourceCountsInput, options: CallOptions) !get_network_resource_counts.GetNetworkResourceCountsOutput {
        return get_network_resource_counts.execute(self, allocator, input, options);
    }

    /// Gets the network resource relationships for the specified global network.
    pub fn getNetworkResourceRelationships(self: *Self, allocator: std.mem.Allocator, input: get_network_resource_relationships.GetNetworkResourceRelationshipsInput, options: CallOptions) !get_network_resource_relationships.GetNetworkResourceRelationshipsOutput {
    ...
    pub fn getNetworkResources(self: *Self, allocator: std.mem.Allocator, input: get_network_resources.GetNetworkResourcesInput, options: CallOptions) !get_network_resources.GetNetworkResourcesOutput {
        return get_network_resources.execute(self, allocator, input, options);
    }

    /// Gets the network routes of the specified global network.
    pub fn getNetworkRoutes(self: *Self, allocator: std.mem.Allocator, input: get_network_routes.GetNetworkRoutesInput, options: CallOptions) !get_network_routes.GetNetworkRoutesOutput {
        return get_network_routes.execute(self, allocator, input, options);
    }

    /// Gets the network telemetry of the specified global network.
    pub fn getNetworkTelemetry(self: *Self, allocator: std.mem.Allocator, input: get_network_telemetry.GetNetworkTelemetryInput, options: CallOptions) !get_network_telemetry.GetNetworkTelemetryOutput {
    ...
    pub fn getRouteAnalysis(self: *Self, allocator: std.mem.Allocator, input: get_route_analysis.GetRouteAnalysisInput, options: CallOptions) !get_route_analysis.GetRouteAnalysisOutput {
        return get_route_analysis.execute(self, allocator, input, options);
    }

    /// Returns information about a site-to-site VPN attachment.
    pub fn getSiteToSiteVpnAttachment(self: *Self, allocator: std.mem.Allocator, input: get_site_to_site_vpn_attachment.GetSiteToSiteVpnAttachmentInput, options: CallOptions) !get_site_to_site_vpn_attachment.GetSiteToSiteVpnAttachmentOutput {
        return get_site_to_site_vpn_attachment.execute(self, allocator, input, options);
    }

    /// Gets information about one or more of your sites in a global network.
    pub fn getSites(self: *Self, allocator: std.mem.Allocator, input: get_sites.GetSitesInput, options: CallOptions) !get_sites.GetSitesOutput {
    ...
    pub fn getTransitGatewayConnectPeerAssociations(self: *Self, allocator: std.mem.Allocator, input: get_transit_gateway_connect_peer_associations.GetTransitGatewayConnectPeerAssociationsInput, options: CallOptions) !get_transit_gateway_connect_peer_associations.GetTransitGatewayConnectPeerAssociationsOutput {
        return get_transit_gateway_connect_peer_associations.execute(self, allocator, input, options);
    }

    /// Returns information about a transit gateway peer.
    pub fn getTransitGatewayPeering(self: *Self, allocator: std.mem.Allocator, input: get_transit_gateway_peering.GetTransitGatewayPeeringInput, options: CallOptions) !get_transit_gateway_peering.GetTransitGatewayPeeringOutput {
    ...
    /// global network.
    pub fn getTransitGatewayRegistrations(self: *Self, allocator: std.mem.Allocator, input: get_transit_gateway_registrations.GetTransitGatewayRegistrationsInput, options: CallOptions) !get_transit_gateway_registrations.GetTransitGatewayRegistrationsOutput {
        return get_transit_gateway_registrations.execute(self, allocator, input, options);
    }

    /// Returns information about a transit gateway route table attachment.
    pub fn getTransitGatewayRouteTableAttachment(self: *Self, allocator: std.mem.Allocator, input: get_transit_gateway_route_table_attachment.GetTransitGatewayRouteTableAttachmentInput, options: CallOptions) !get_transit_gateway_route_table_attachment.GetTransitGatewayRouteTableAttachmentOutput {
        return get_transit_gateway_route_table_attachment.execute(self, allocator, input, options);
    }

    /// Returns information about a VPC attachment.
    pub fn getVpcAttachment(self: *Self, allocator: std.mem.Allocator, input: get_vpc_attachment.GetVpcAttachmentInput, options: CallOptions) !get_vpc_attachment.GetVpcAttachmentOutput {
    ...
    pub fn listAttachmentRoutingPolicyAssociations(self: *Self, allocator: std.mem.Allocator, input: list_attachment_routing_policy_associations.ListAttachmentRoutingPolicyAssociationsInput, options: CallOptions) !list_attachment_routing_policy_associations.ListAttachmentRoutingPolicyAssociationsOutput {
    ...
    pub fn listConnectPeers(self: *Self, allocator: std.mem.Allocator, input: list_connect_peers.ListConnectPeersInput, options: CallOptions) !list_connect_peers.ListConnectPeersOutput {
        return list_connect_peers.execute(self, allocator, input, options);
    }

    /// Returns a list of core network policy versions.
    pub fn listCoreNetworkPolicyVersions(self: *Self, allocator: std.mem.Allocator, input: list_core_network_policy_versions.ListCoreNetworkPolicyVersionsInput, options: CallOptions) !list_core_network_policy_versions.ListCoreNetworkPolicyVersionsOutput {
    ...
    pub fn listCoreNetworkPrefixListAssociations(self: *Self, allocator: std.mem.Allocator, input: list_core_network_prefix_list_associations.ListCoreNetworkPrefixListAssociationsInput, options: CallOptions) !list_core_network_prefix_list_associations.ListCoreNetworkPrefixListAssociationsOutput {
    ...
    /// attributes.
    pub fn listCoreNetworkRoutingInformation(self: *Self, allocator: std.mem.Allocator, input: list_core_network_routing_information.ListCoreNetworkRoutingInformationInput, options: CallOptions) !list_core_network_routing_information.ListCoreNetworkRoutingInformationOutput {
        return list_core_network_routing_information.execute(self, allocator, input, options);
    }

    /// Returns a list of owned and shared core networks.
    pub fn listCoreNetworks(self: *Self, allocator: std.mem.Allocator, input: list_core_networks.ListCoreNetworksInput, options: CallOptions) !list_core_networks.ListCoreNetworksOutput {
    ...
    pub fn listOrganizationServiceAccessStatus(self: *Self, allocator: std.mem.Allocator, input: list_organization_service_access_status.ListOrganizationServiceAccessStatusInput, options: CallOptions) !list_organization_service_access_status.ListOrganizationServiceAccessStatusOutput {
        return list_organization_service_access_status.execute(self, allocator, input, options);
    }

    /// Lists the peerings for a core network.
    pub fn listPeerings(self: *Self, allocator: std.mem.Allocator, input: list_peerings.ListPeeringsInput, options: CallOptions) !list_peerings.ListPeeringsOutput {
    ...
    /// decisions.
    pub fn putAttachmentRoutingPolicyLabel(self: *Self, allocator: std.mem.Allocator, input: put_attachment_routing_policy_label.PutAttachmentRoutingPolicyLabelInput, options: CallOptions) !put_attachment_routing_policy_label.PutAttachmentRoutingPolicyLabelOutput {
    ...
    pub fn putCoreNetworkPolicy(self: *Self, allocator: std.mem.Allocator, input: put_core_network_policy.PutCoreNetworkPolicyInput, options: CallOptions) !put_core_network_policy.PutCoreNetworkPolicyOutput {
    ...
    /// network.
    pub fn registerTransitGateway(self: *Self, allocator: std.mem.Allocator, input: register_transit_gateway.RegisterTransitGatewayInput, options: CallOptions) !register_transit_gateway.RegisterTransitGatewayOutput {
        return register_transit_gateway.execute(self, allocator, input, options);
    }

    /// Rejects a core network attachment request.
    pub fn rejectAttachment(self: *Self, allocator: std.mem.Allocator, input: reject_attachment.RejectAttachmentInput, options: CallOptions) !reject_attachment.RejectAttachmentOutput {
        return reject_attachment.execute(self, allocator, input, options);
    }

    /// Removes a routing policy label from an attachment.
    pub fn removeAttachmentRoutingPolicyLabel(self: *Self, allocator: std.mem.Allocator, input: remove_attachment_routing_policy_label.RemoveAttachmentRoutingPolicyLabelInput, options: CallOptions) !remove_attachment_routing_policy_label.RemoveAttachmentRoutingPolicyLabelOutput {
    ...
    pub fn restoreCoreNetworkPolicyVersion(self: *Self, allocator: std.mem.Allocator, input: restore_core_network_policy_version.RestoreCoreNetworkPolicyVersionInput, options: CallOptions) !restore_core_network_policy_version.RestoreCoreNetworkPolicyVersionOutput {
    ...
    pub fn startOrganizationServiceAccessUpdate(self: *Self, allocator: std.mem.Allocator, input: start_organization_service_access_update.StartOrganizationServiceAccessUpdateInput, options: CallOptions) !start_organization_service_access_update.StartOrganizationServiceAccessUpdateOutput {
    ...
    pub fn startRouteAnalysis(self: *Self, allocator: std.mem.Allocator, input: start_route_analysis.StartRouteAnalysisInput, options: CallOptions) !start_route_analysis.StartRouteAnalysisOutput {
    ...
    pub fn updateCoreNetwork(self: *Self, allocator: std.mem.Allocator, input: update_core_network.UpdateCoreNetworkInput, options: CallOptions) !update_core_network.UpdateCoreNetworkOutput {
    ...
    pub fn updateDirectConnectGatewayAttachment(self: *Self, allocator: std.mem.Allocator, input: update_direct_connect_gateway_attachment.UpdateDirectConnectGatewayAttachmentInput, options: CallOptions) !update_direct_connect_gateway_attachment.UpdateDirectConnectGatewayAttachmentOutput {
    ...
    /// parameters,
    /// specify an empty string.
    pub fn updateGlobalNetwork(self: *Self, allocator: std.mem.Allocator, input: update_global_network.UpdateGlobalNetworkInput, options: CallOptions) !update_global_network.UpdateGlobalNetworkOutput {
    ...
    pub fn updateNetworkResourceMetadata(self: *Self, allocator: std.mem.Allocator, input: update_network_resource_metadata.UpdateNetworkResourceMetadataInput, options: CallOptions) !update_network_resource_metadata.UpdateNetworkResourceMetadataOutput {
    ...
    pub fn updateVpcAttachment(self: *Self, allocator: std.mem.Allocator, input: update_vpc_attachment.UpdateVpcAttachmentInput, options: CallOptions) !update_vpc_attachment.UpdateVpcAttachmentOutput {
