...
pub const CreateSiteInput = @import("create_site_request.zig").CreateSiteRequest;

pub const CreateSiteOutput = @import("create_site_response.zig").CreateSiteResponse;
