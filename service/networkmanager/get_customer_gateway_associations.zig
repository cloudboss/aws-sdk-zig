...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCustomerGatewayAssociationsInput, options: CallOptions) !GetCustomerGatewayAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCustomerGatewayAssociationsInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.customer_gateway_arns) |v| {
        for (v) |item| {
            ...
            try query_buf.appendSlice(allocator, "customerGatewayArns=");
