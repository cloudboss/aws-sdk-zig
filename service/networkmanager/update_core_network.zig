...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCoreNetworkInput, options: CallOptions) !UpdateCoreNetworkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCoreNetworkInput, config: *aws.Config) !aws.http.Request {
