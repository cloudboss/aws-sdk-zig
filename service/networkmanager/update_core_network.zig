...
pub const UpdateCoreNetworkInput = struct {
...
pub const UpdateCoreNetworkOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCoreNetworkInput, options: Options) !UpdateCoreNetworkOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateCoreNetworkInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateCoreNetworkOutput {
    var result: UpdateCoreNetworkOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateCoreNetworkOutput, body, alloc);
    }
    _ = status;
    _ = headers;
