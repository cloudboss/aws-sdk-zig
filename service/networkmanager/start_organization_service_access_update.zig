...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartOrganizationServiceAccessUpdateInput, options: Options) !StartOrganizationServiceAccessUpdateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartOrganizationServiceAccessUpdateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartOrganizationServiceAccessUpdateOutput {
    var result: StartOrganizationServiceAccessUpdateOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(StartOrganizationServiceAccessUpdateOutput, body, alloc);
    }
    _ = status;
    _ = headers;
