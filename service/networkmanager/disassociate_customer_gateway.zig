...
pub const DisassociateCustomerGatewayInput = struct {
...
pub const DisassociateCustomerGatewayOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateCustomerGatewayInput, options: CallOptions) !DisassociateCustomerGatewayOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateCustomerGatewayInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.customer_gateway_arn);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateCustomerGatewayOutput {
    var result: DisassociateCustomerGatewayOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DisassociateCustomerGatewayOutput, body, allocator);
    }
    _ = status;
    _ = headers;
