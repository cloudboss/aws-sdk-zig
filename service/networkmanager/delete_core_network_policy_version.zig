...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCoreNetworkPolicyVersionInput, options: Options) !DeleteCoreNetworkPolicyVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCoreNetworkPolicyVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCoreNetworkPolicyVersionOutput {
    var result: DeleteCoreNetworkPolicyVersionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteCoreNetworkPolicyVersionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
