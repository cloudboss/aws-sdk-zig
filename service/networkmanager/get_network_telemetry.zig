...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetNetworkTelemetryInput, options: CallOptions) !GetNetworkTelemetryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetNetworkTelemetryInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/network-telemetry");
