...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteThreatEntitySetInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.threat_entity_set_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteThreatEntitySetOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
