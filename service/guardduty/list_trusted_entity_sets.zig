...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTrustedEntitySetsInput, options: CallOptions) !ListTrustedEntitySetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTrustedEntitySetsInput, config: *aws.Config) !aws.http.Request {
