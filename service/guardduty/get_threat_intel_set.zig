...
fn serializeRequest(allocator: std.mem.Allocator, input: GetThreatIntelSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/threatintelset/");
    try path_buf.appendSlice(allocator, input.threat_intel_set_id);
