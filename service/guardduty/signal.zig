...
pub const Signal = struct {
    ...
    /// severity, see [Findings severity
    ...
    /// sources](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_data-sources.html) in the *Amazon GuardDuty User Guide*.
    ///
    ...
    ///   Activities associated with this type will show up only when you have
