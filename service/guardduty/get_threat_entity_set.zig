...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetThreatEntitySetInput, options: CallOptions) !GetThreatEntitySetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetThreatEntitySetInput, config: *aws.Config) !aws.http.Request {
