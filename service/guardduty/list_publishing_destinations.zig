...
pub const ListPublishingDestinationsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPublishingDestinationsInput, options: CallOptions) !ListPublishingDestinationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPublishingDestinationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListPublishingDestinationsOutput {
    var result: ListPublishingDestinationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListPublishingDestinationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
