...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTrustedEntitySetInput, options: CallOptions) !CreateTrustedEntitySetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateTrustedEntitySetInput, config: *aws.Config) !aws.http.Request {
