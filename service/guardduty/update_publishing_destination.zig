...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdatePublishingDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.destination_properties) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"DestinationProperties\":");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdatePublishingDestinationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
