...
pub const RuntimeContext = struct {
    ...
    ld_preload_value: ?[]const u8 = null,
    ...
    module_file_path: ?[]const u8 = null,

    /// The name of the module loaded into the kernel.
    module_name: ?[]const u8 = null,

    /// The `SHA256` hash of the module.
    module_sha_256: ?[]const u8 = null,
    ...
    runc_binary_path: ?[]const u8 = null,
    ...
    shell_history_file_path: ?[]const u8 = null,
    ...
    /// process.
    target_process: ?ProcessDetails = null,
