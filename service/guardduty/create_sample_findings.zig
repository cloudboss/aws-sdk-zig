...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateSampleFindingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/findings/create");
    ...
    if (input.finding_types) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"FindingTypes\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateSampleFindingsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
