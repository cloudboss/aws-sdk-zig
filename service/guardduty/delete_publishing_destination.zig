...
pub const DeletePublishingDestinationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePublishingDestinationInput, options: Options) !DeletePublishingDestinationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePublishingDestinationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePublishingDestinationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePublishingDestinationOutput = .{};
