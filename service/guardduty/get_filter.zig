...
pub const GetFilterOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFilterInput, options: CallOptions) !GetFilterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFilterInput, config: *aws.Config) !aws.http.Request {
