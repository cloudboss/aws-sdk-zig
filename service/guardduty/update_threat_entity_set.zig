...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateThreatEntitySetInput, options: CallOptions) !UpdateThreatEntitySetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateThreatEntitySetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateThreatEntitySetOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateThreatEntitySetOutput = .{};
