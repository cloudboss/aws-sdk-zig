...
pub const DeleteTrustedEntitySetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTrustedEntitySetInput, options: Options) !DeleteTrustedEntitySetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTrustedEntitySetInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.trusted_entity_set_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTrustedEntitySetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTrustedEntitySetOutput = .{};
