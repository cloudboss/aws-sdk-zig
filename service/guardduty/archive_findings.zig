...
fn serializeRequest(allocator: std.mem.Allocator, input: ArchiveFindingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/findings/archive");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ArchiveFindingsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
