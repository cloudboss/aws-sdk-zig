...
fn serializeRequest(allocator: std.mem.Allocator, input: UnarchiveFindingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/findings/unarchive");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UnarchiveFindingsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
