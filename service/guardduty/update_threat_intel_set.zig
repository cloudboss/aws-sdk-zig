...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateThreatIntelSetInput, options: Options) !UpdateThreatIntelSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateThreatIntelSetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateThreatIntelSetOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateThreatIntelSetOutput = .{};
