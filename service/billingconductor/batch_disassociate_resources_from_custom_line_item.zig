...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDisassociateResourcesFromCustomLineItemInput, options: Options) !BatchDisassociateResourcesFromCustomLineItemOutput {
