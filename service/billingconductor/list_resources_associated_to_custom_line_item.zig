...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResourcesAssociatedToCustomLineItemInput, options: Options) !ListResourcesAssociatedToCustomLineItemOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListResourcesAssociatedToCustomLineItemInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListResourcesAssociatedToCustomLineItemOutput {
    var result: ListResourcesAssociatedToCustomLineItemOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListResourcesAssociatedToCustomLineItemOutput, body, alloc);
    }
    _ = status;
    _ = headers;
