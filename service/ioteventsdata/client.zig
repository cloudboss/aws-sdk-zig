...
pub const Client = struct {
    ...
    pub fn batchAcknowledgeAlarm(self: *Self, allocator: std.mem.Allocator, input: batch_acknowledge_alarm.BatchAcknowledgeAlarmInput, options: CallOptions) !batch_acknowledge_alarm.BatchAcknowledgeAlarmOutput {
    ...
    pub fn batchDeleteDetector(self: *Self, allocator: std.mem.Allocator, input: batch_delete_detector.BatchDeleteDetectorInput, options: CallOptions) !batch_delete_detector.BatchDeleteDetectorOutput {
    ...
    /// you disable them.
    pub fn batchDisableAlarm(self: *Self, allocator: std.mem.Allocator, input: batch_disable_alarm.BatchDisableAlarmInput, options: CallOptions) !batch_disable_alarm.BatchDisableAlarmOutput {
    ...
    /// you
    /// enable them.
    pub fn batchEnableAlarm(self: *Self, allocator: std.mem.Allocator, input: batch_enable_alarm.BatchEnableAlarmInput, options: CallOptions) !batch_enable_alarm.BatchEnableAlarmOutput {
    ...
    /// reset them.
    pub fn batchResetAlarm(self: *Self, allocator: std.mem.Allocator, input: batch_reset_alarm.BatchResetAlarmInput, options: CallOptions) !batch_reset_alarm.BatchResetAlarmOutput {
    ...
    pub fn batchSnoozeAlarm(self: *Self, allocator: std.mem.Allocator, input: batch_snooze_alarm.BatchSnoozeAlarmInput, options: CallOptions) !batch_snooze_alarm.BatchSnoozeAlarmOutput {
    ...
    pub fn batchUpdateDetector(self: *Self, allocator: std.mem.Allocator, input: batch_update_detector.BatchUpdateDetectorInput, options: CallOptions) !batch_update_detector.BatchUpdateDetectorOutput {
        return batch_update_detector.execute(self, allocator, input, options);
    }

    /// Retrieves information about an alarm.
    pub fn describeAlarm(self: *Self, allocator: std.mem.Allocator, input: describe_alarm.DescribeAlarmInput, options: CallOptions) !describe_alarm.DescribeAlarmOutput {
    ...
    /// with each
    /// alarm.
    pub fn listAlarms(self: *Self, allocator: std.mem.Allocator, input: list_alarms.ListAlarmsInput, options: CallOptions) !list_alarms.ListAlarmsOutput {
