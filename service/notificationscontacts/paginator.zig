...
pub const ListEmailContactsPaginator = struct {
    client: *Client,
    params: list_email_contacts.ListEmailContactsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_email_contacts.ListEmailContactsOutput {
        ...
        const output = try list_email_contacts.execute(self.client, allocator, self.params, options);
