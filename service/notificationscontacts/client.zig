...
pub const Client = struct {
    ...
    /// contact.
    pub fn activateEmailContact(self: *Self, allocator: std.mem.Allocator, input: activate_email_contact.ActivateEmailContactInput, options: activate_email_contact.Options) !activate_email_contact.ActivateEmailContactOutput {
        return activate_email_contact.execute(self, allocator, input, options);
    }

    /// Creates an email contact for the provided email address.
    pub fn createEmailContact(self: *Self, allocator: std.mem.Allocator, input: create_email_contact.CreateEmailContactInput, options: create_email_contact.Options) !create_email_contact.CreateEmailContactOutput {
    ...
    /// configurations.
    pub fn deleteEmailContact(self: *Self, allocator: std.mem.Allocator, input: delete_email_contact.DeleteEmailContactInput, options: delete_email_contact.Options) !delete_email_contact.DeleteEmailContactOutput {
        return delete_email_contact.execute(self, allocator, input, options);
    }

    /// Returns an email contact.
    pub fn getEmailContact(self: *Self, allocator: std.mem.Allocator, input: get_email_contact.GetEmailContactInput, options: get_email_contact.Options) !get_email_contact.GetEmailContactOutput {
        return get_email_contact.execute(self, allocator, input, options);
    }

    /// Lists all email contacts created under the Account.
    pub fn listEmailContacts(self: *Self, allocator: std.mem.Allocator, input: list_email_contacts.ListEmailContactsInput, options: list_email_contacts.Options) !list_email_contacts.ListEmailContactsOutput {
