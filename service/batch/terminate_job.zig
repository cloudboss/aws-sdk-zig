...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TerminateJobInput, options: CallOptions) !TerminateJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TerminateJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TerminateJobOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
