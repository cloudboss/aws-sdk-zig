...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSchedulingPolicyInput, options: Options) !UpdateSchedulingPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSchedulingPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v1/updateschedulingpolicy";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateSchedulingPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateSchedulingPolicyOutput = .{};
