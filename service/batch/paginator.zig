...
pub const DescribeComputeEnvironmentsPaginator = struct {
    client: *Client,
    params: describe_compute_environments.DescribeComputeEnvironmentsInput,
...
pub const DescribeJobDefinitionsPaginator = struct {
    client: *Client,
    params: describe_job_definitions.DescribeJobDefinitionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const DescribeJobQueuesPaginator = struct {
    client: *Client,
    params: describe_job_queues.DescribeJobQueuesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const DescribeServiceEnvironmentsPaginator = struct {
    client: *Client,
    params: describe_service_environments.DescribeServiceEnvironmentsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListConsumableResourcesPaginator = struct {
    client: *Client,
    params: list_consumable_resources.ListConsumableResourcesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListJobsByConsumableResourcePaginator = struct {
    client: *Client,
    params: list_jobs_by_consumable_resource.ListJobsByConsumableResourceInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListSchedulingPoliciesPaginator = struct {
    client: *Client,
    params: list_scheduling_policies.ListSchedulingPoliciesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListServiceJobsPaginator = struct {
    client: *Client,
    params: list_service_jobs.ListServiceJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
