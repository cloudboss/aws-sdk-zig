...
pub const LogConfiguration = struct {
    ...
    /// for this parameter
    /// are log drivers that the Amazon ECS container agent can communicate with by
    /// default.
    ///
    ...
    /// Partner](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_firelens.html) in the
    ...
    /// driver](https://docs.aws.amazon.com/batch/latest/userguide/using_awslogs.html)
    /// in the *Batch User Guide* and [Amazon CloudWatch Logs logging
    /// driver](https://docs.docker.com/config/containers/logging/awslogs/) in the
    ...
    /// and options,
    /// see [Fluentd logging
    /// driver](https://docs.docker.com/config/containers/logging/fluentd/) in the
    /// *Docker documentation*.
    ///
    /// **gelf**
    ///
    ...
    /// driver](https://docs.docker.com/config/containers/logging/gelf/) in the
    /// *Docker documentation*.
    ///
    /// **journald**
    ///
    ...
    /// driver](https://docs.docker.com/config/containers/logging/journald/) in the
    /// *Docker documentation*.
    ///
    /// **json-file**
    ///
    ...
    /// see [JSON File
    /// logging
    /// driver](https://docs.docker.com/config/containers/logging/json-file/) in the
    /// *Docker documentation*.
    ///
    /// **splunk**
    ///
    ...
    /// and options,
    /// see [Splunk logging
    /// driver](https://docs.docker.com/config/containers/logging/splunk/) in the
    /// *Docker documentation*.
    ///
    /// **syslog**
    ///
    ...
    /// and options,
    /// see [Syslog logging
    /// driver](https://docs.docker.com/config/containers/logging/syslog/) in the
    /// *Docker documentation*.
    ///
    /// If you have a custom driver that's not listed earlier that you want to work
    /// with the Amazon ECS
    /// container agent, you can fork the Amazon ECS container agent project that's
    /// [available on GitHub](https://github.com/aws/amazon-ecs-agent) and customize
    /// it to
    /// work with that driver. We encourage you to submit pull requests for changes
    /// that you want to
    /// have included. However, Amazon Web Services doesn't currently support
    ...
    /// version 1.19 of the Docker Remote API or greater on your
    /// container instance. To check the Docker Remote API version on your container
    /// instance, log in to your
    /// container instance and run the following command: `sudo docker version |
    /// grep "Server API version"`
