...
pub const DeleteQuotaShareInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteQuotaShareInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v1/deletequotashare";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteQuotaShareOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteQuotaShareOutput = .{};
