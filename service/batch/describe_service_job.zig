...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeServiceJobInput, options: CallOptions) !DescribeServiceJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeServiceJobInput, config: *aws.Config) !aws.http.Request {
