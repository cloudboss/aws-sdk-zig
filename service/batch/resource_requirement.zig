...
pub const ResourceRequirement = struct {
    ...
    /// number of
    /// GPUs reserved for all containers in a job doesn't exceed the number of
    /// available GPUs on the
    ...
    /// supported for
    /// jobs that are running on Amazon EC2 resources. If your container attempts to
    /// exceed the memory
    ...
    /// to 1,024 CPU shares.
    /// For Amazon EC2 resources, you must specify at least one vCPU. This is
    ...
    /// For more
    /// information about Fargate quotas, see [Fargate
    ...
    /// 17408, 18432, 19456,
    /// 20480, 21504, 22528, 23552, 24576, 25600, 26624, 27648, 28672, 29696, or
    /// 30720
    ///
    /// **value = 8**
    ///
    /// `MEMORY` = 16384, 20480, 24576, 28672, 32768, 36864, 40960, 45056, 49152,
