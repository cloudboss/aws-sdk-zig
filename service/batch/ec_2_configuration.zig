...
pub const Ec2Configuration = struct {
    ...
    /// AMI](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#al2ami) (`ECS_AL2`) is used. If a new image type is
    ...
    /// and AL2-accelerated AMIs. Starting in January 2026, Batch will change
    /// the default AMI for new Amazon ECS compute environments from Amazon Linux 2
    /// to Amazon Linux 2023.
    /// We recommend migrating Batch Amazon ECS compute environments to Amazon Linux
    /// 2023 to maintain
    /// optimal performance and security. For more information on upgrading from AL2
    /// to AL2023, see [How to migrate
    /// from ECS AL2 to ECS
    ...
    /// `G4`) and can be used for all non Amazon Web Services Graviton-based
    /// instance types.
    ///
    /// **ECS_AL2023**
    ///
    /// [Amazon Linux
    /// 2023](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html): Batch
    ...
    ///
    /// [Amazon Linux 2023
    /// (GPU)](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html#gpuami): For all GPU instance families and can be used for all non Amazon Web Services Graviton-based instance types.
    ///
    ...
    /// support for Amazon EKS AL2-optimized and AL2-accelerated AMIs, starting
    /// 11/26/25. You can continue
    /// using Batch-provided Amazon EKS optimized Amazon Linux 2 AMIs on your Amazon
    /// EKS compute
    /// environments beyond the 11/26/25 end-of-support date, these compute
    /// environments will no
    /// longer receive any new software updates, security patches, or bug fixes from
    /// Amazon Web Services. For more information on upgrading from AL2 to AL2023,
    /// see [How to upgrade from EKS AL2 to EKS
