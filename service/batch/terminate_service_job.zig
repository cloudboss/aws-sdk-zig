...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TerminateServiceJobInput, options: Options) !TerminateServiceJobOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: TerminateServiceJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !TerminateServiceJobOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
