...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetIdentityNotificationTopicInput, options: Options) !SetIdentityNotificationTopicOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SetIdentityNotificationTopicInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=SetIdentityNotificationTopic&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetIdentityNotificationTopicOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
