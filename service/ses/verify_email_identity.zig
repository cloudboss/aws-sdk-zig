...
fn serializeRequest(allocator: std.mem.Allocator, input: VerifyEmailIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=VerifyEmailIdentity&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !VerifyEmailIdentityOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
