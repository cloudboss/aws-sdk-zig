...
pub const DeleteReceiptRuleInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReceiptRuleInput, options: Options) !DeleteReceiptRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteReceiptRuleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteReceiptRule&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteReceiptRuleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteReceiptRuleOutput = .{};
