...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCustomVerificationEmailTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteCustomVerificationEmailTemplate&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCustomVerificationEmailTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
