...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomVerificationEmailTemplateInput, options: CallOptions) !DeleteCustomVerificationEmailTemplateOutput {
