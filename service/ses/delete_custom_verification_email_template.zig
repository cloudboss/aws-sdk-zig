...
pub const DeleteCustomVerificationEmailTemplateInput = struct {
    /// The name of the custom verification email template to delete.
    template_name: []const u8,
};

const DeleteCustomVerificationEmailTemplateOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomVerificationEmailTemplateInput, options: Options) !DeleteCustomVerificationEmailTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCustomVerificationEmailTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteCustomVerificationEmailTemplate&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCustomVerificationEmailTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteCustomVerificationEmailTemplateOutput = .{};
