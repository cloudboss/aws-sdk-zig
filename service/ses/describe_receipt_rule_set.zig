...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReceiptRuleSetInput, options: Options) !DescribeReceiptRuleSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeReceiptRuleSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeReceiptRuleSet&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeReceiptRuleSetOutput {
    _ = status;
    _ = headers;
