...
pub const UpdateConfigurationSetReputationMetricsEnabledInput = struct {
...
pub const UpdateConfigurationSetReputationMetricsEnabledOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateConfigurationSetReputationMetricsEnabledInput, options: CallOptions) !UpdateConfigurationSetReputationMetricsEnabledOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateConfigurationSetReputationMetricsEnabledInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UpdateConfigurationSetReputationMetricsEnabled&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateConfigurationSetReputationMetricsEnabledOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: UpdateConfigurationSetReputationMetricsEnabledOutput = .{};
