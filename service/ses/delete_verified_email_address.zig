...
pub const DeleteVerifiedEmailAddressInput = struct {
    /// An email address to be removed from the list of verified addresses.
    email_address: []const u8,
};

pub const DeleteVerifiedEmailAddressOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVerifiedEmailAddressInput, options: CallOptions) !DeleteVerifiedEmailAddressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVerifiedEmailAddressInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteVerifiedEmailAddress&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVerifiedEmailAddressOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteVerifiedEmailAddressOutput = .{};
