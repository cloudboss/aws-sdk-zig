...
fn serializeRequest(alloc: std.mem.Allocator, input: ListTemplatesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ListTemplates&Version=2010-12-01");
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.templates_metadata = try serde.deserializeTemplateMetadataList(&reader, alloc, "member");
                } else {
