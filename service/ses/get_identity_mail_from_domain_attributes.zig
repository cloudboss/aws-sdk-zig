...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIdentityMailFromDomainAttributesInput, options: Options) !GetIdentityMailFromDomainAttributesOutput {
