...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIdentityInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteIdentity&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIdentityOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
