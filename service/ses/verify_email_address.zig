...
pub const VerifyEmailAddressInput = struct {
    /// The email address to be verified.
    email_address: []const u8,
};

pub const VerifyEmailAddressOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: VerifyEmailAddressInput, options: CallOptions) !VerifyEmailAddressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: VerifyEmailAddressInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=VerifyEmailAddress&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !VerifyEmailAddressOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: VerifyEmailAddressOutput = .{};
