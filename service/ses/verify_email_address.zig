...
const VerifyEmailAddressOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: VerifyEmailAddressInput, options: Options) !VerifyEmailAddressOutput {
