...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIdentityNotificationAttributesInput, options: Options) !GetIdentityNotificationAttributesOutput {
