...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutIdentityPolicyInput, options: Options) !PutIdentityPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutIdentityPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=PutIdentityPolicy&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutIdentityPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
