...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateConfigurationSetSendingEnabledInput, options: Options) !UpdateConfigurationSetSendingEnabledOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateConfigurationSetSendingEnabledInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdateConfigurationSetSendingEnabled&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateConfigurationSetSendingEnabledOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
