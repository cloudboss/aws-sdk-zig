...
pub const DeleteConfigurationSetTrackingOptionsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfigurationSetTrackingOptionsInput, options: Options) !DeleteConfigurationSetTrackingOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfigurationSetTrackingOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteConfigurationSetTrackingOptions&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteConfigurationSetTrackingOptionsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteConfigurationSetTrackingOptionsOutput = .{};
