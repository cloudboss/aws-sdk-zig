...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdentityPolicyInput, options: Options) !DeleteIdentityPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIdentityPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteIdentityPolicy&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIdentityPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
