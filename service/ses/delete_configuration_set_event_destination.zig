...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfigurationSetEventDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteConfigurationSetEventDestination&Version=2010-12-01");
    ...
    try aws.url.appendUrlEncoded(allocator, &body_buf, input.event_destination_name);
