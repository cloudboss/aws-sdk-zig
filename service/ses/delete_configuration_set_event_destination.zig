...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfigurationSetEventDestinationInput, options: Options) !DeleteConfigurationSetEventDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConfigurationSetEventDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteConfigurationSetEventDestination&Version=2010-12-01");
    ...
    try body_buf.appendSlice(alloc, "&EventDestinationName=");
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.event_destination_name);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConfigurationSetEventDestinationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
