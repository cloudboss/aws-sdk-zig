...
fn serializeRequest(alloc: std.mem.Allocator, input: ReorderReceiptRuleSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ReorderReceiptRuleSet&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ReorderReceiptRuleSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
