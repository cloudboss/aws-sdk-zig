...
pub const DeleteReceiptRuleSetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReceiptRuleSetInput, options: Options) !DeleteReceiptRuleSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteReceiptRuleSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteReceiptRuleSet&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteReceiptRuleSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteReceiptRuleSetOutput = .{};
