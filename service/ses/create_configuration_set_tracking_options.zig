...
pub const CreateConfigurationSetTrackingOptionsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateConfigurationSetTrackingOptionsInput, options: Options) !CreateConfigurationSetTrackingOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateConfigurationSetTrackingOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateConfigurationSetTrackingOptions&Version=2010-12-01");
    ...
    if (input.tracking_options.custom_redirect_domain) |sv| {
        try body_buf.appendSlice(allocator, "&TrackingOptions.CustomRedirectDomain=");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateConfigurationSetTrackingOptionsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: CreateConfigurationSetTrackingOptionsOutput = .{};
