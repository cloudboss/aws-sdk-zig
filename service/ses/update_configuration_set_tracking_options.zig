...
pub const UpdateConfigurationSetTrackingOptionsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateConfigurationSetTrackingOptionsInput, options: Options) !UpdateConfigurationSetTrackingOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateConfigurationSetTrackingOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UpdateConfigurationSetTrackingOptions&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateConfigurationSetTrackingOptionsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: UpdateConfigurationSetTrackingOptionsOutput = .{};
