...
fn serializeRequest(allocator: std.mem.Allocator, input: ListConfigurationSetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ListConfigurationSets&Version=2010-12-01");
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "ConfigurationSets")) {
                    result.configuration_sets = try serde.deserializeConfigurationSets(allocator, &reader, "member");
