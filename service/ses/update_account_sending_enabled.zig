...
pub const UpdateAccountSendingEnabledInput = struct {
...
pub const UpdateAccountSendingEnabledOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAccountSendingEnabledInput, options: CallOptions) !UpdateAccountSendingEnabledOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateAccountSendingEnabledInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UpdateAccountSendingEnabled&Version=2010-12-01");
    if (input.enabled) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateAccountSendingEnabledOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: UpdateAccountSendingEnabledOutput = .{};
