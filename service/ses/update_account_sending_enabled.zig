...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateAccountSendingEnabledInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdateAccountSendingEnabled&Version=2010-12-01");
    if (input.enabled) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateAccountSendingEnabledOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
