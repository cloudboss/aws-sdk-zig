...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAccountSendingEnabledInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=GetAccountSendingEnabled&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetAccountSendingEnabledOutput {
    _ = status;
    _ = headers;
    _ = alloc;
