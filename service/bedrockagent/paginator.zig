...
pub const ListAgentActionGroupsPaginator = struct {
    client: *Client,
    params: list_agent_action_groups.ListAgentActionGroupsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agent_action_groups.ListAgentActionGroupsOutput {
        if (self.done) {
...
pub const ListAgentAliasesPaginator = struct {
    client: *Client,
    params: list_agent_aliases.ListAgentAliasesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agent_aliases.ListAgentAliasesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAgentCollaboratorsPaginator = struct {
    client: *Client,
    params: list_agent_collaborators.ListAgentCollaboratorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agent_collaborators.ListAgentCollaboratorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAgentKnowledgeBasesPaginator = struct {
    client: *Client,
    params: list_agent_knowledge_bases.ListAgentKnowledgeBasesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agent_knowledge_bases.ListAgentKnowledgeBasesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAgentVersionsPaginator = struct {
    client: *Client,
    params: list_agent_versions.ListAgentVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agent_versions.ListAgentVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFlowAliasesPaginator = struct {
    client: *Client,
    params: list_flow_aliases.ListFlowAliasesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_flow_aliases.ListFlowAliasesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFlowVersionsPaginator = struct {
    client: *Client,
    params: list_flow_versions.ListFlowVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_flow_versions.ListFlowVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListIngestionJobsPaginator = struct {
    client: *Client,
    params: list_ingestion_jobs.ListIngestionJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_ingestion_jobs.ListIngestionJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListKnowledgeBaseDocumentsPaginator = struct {
    client: *Client,
    params: list_knowledge_base_documents.ListKnowledgeBaseDocumentsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_knowledge_base_documents.ListKnowledgeBaseDocumentsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
