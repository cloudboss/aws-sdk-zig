...
pub const DeleteAgentActionGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAgentActionGroupInput, options: Options) !DeleteAgentActionGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAgentActionGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAgentActionGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAgentActionGroupOutput = .{};
