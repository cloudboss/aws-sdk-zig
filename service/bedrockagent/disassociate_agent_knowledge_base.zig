...
pub const DisassociateAgentKnowledgeBaseInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateAgentKnowledgeBaseInput, options: Options) !DisassociateAgentKnowledgeBaseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateAgentKnowledgeBaseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateAgentKnowledgeBaseOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateAgentKnowledgeBaseOutput = .{};
