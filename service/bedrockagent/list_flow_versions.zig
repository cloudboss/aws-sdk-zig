...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFlowVersionsInput, options: CallOptions) !ListFlowVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFlowVersionsInput, config: *aws.Config) !aws.http.Request {
