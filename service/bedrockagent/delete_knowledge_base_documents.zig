...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKnowledgeBaseDocumentsInput, options: CallOptions) !DeleteKnowledgeBaseDocumentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKnowledgeBaseDocumentsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/documents/deleteDocuments");
