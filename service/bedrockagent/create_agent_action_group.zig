...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAgentActionGroupInput, options: CallOptions) !CreateAgentActionGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateAgentActionGroupInput, config: *aws.Config) !aws.http.Request {
