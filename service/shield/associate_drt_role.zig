...
pub const AssociateDRTRoleInput = struct {
    /// The Amazon Resource Name (ARN) of the role the SRT will use to access your
    /// Amazon Web Services account.
    ///
    /// Prior to making the `AssociateDRTRole` request, you must attach the
    /// [AWSShieldDRTAccessPolicy](https://console.aws.amazon.com/iam/home?#/policies/arn:aws:iam::aws:policy/service-role/AWSShieldDRTAccessPolicy) managed policy to this role. For more information see [Attaching and Detaching IAM Policies]( https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_manage-attach-detach.html).
    role_arn: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateDRTRoleInput, options: Options) !AssociateDRTRoleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateDRTRoleInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSShield_20160616.AssociateDRTRole");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateDRTRoleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
