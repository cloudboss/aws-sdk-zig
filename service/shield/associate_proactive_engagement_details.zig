...
pub const AssociateProactiveEngagementDetailsInput = struct {
    ...
    emergency_contact_list: []const EmergencyContact,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateProactiveEngagementDetailsInput, options: Options) !AssociateProactiveEngagementDetailsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateProactiveEngagementDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSShield_20160616.AssociateProactiveEngagementDetails");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateProactiveEngagementDetailsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
