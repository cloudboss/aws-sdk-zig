...
pub const DisableApplicationLayerAutomaticResponseInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableApplicationLayerAutomaticResponseInput, options: Options) !DisableApplicationLayerAutomaticResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableApplicationLayerAutomaticResponseInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSShield_20160616.DisableApplicationLayerAutomaticResponse");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableApplicationLayerAutomaticResponseOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
