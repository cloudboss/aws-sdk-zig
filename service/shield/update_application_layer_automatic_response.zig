...
pub const UpdateApplicationLayerAutomaticResponseInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApplicationLayerAutomaticResponseInput, options: Options) !UpdateApplicationLayerAutomaticResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateApplicationLayerAutomaticResponseInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSShield_20160616.UpdateApplicationLayerAutomaticResponse");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateApplicationLayerAutomaticResponseOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
