...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeEmergencyContactSettingsInput, options: Options) !DescribeEmergencyContactSettingsOutput {
