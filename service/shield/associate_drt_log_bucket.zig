...
pub const AssociateDRTLogBucketInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateDRTLogBucketInput, options: CallOptions) !AssociateDRTLogBucketOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateDRTLogBucketInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSShield_20160616.AssociateDRTLogBucket");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateDRTLogBucketOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
