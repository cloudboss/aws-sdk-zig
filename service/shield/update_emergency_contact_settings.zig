...
pub const UpdateEmergencyContactSettingsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEmergencyContactSettingsInput, options: Options) !UpdateEmergencyContactSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateEmergencyContactSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSShield_20160616.UpdateEmergencyContactSettings");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateEmergencyContactSettingsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
