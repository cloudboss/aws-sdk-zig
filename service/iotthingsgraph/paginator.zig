...
pub const GetFlowTemplateRevisionsPaginator = struct {
    client: *Client,
    params: get_flow_template_revisions.GetFlowTemplateRevisionsInput,
...
pub const GetSystemTemplateRevisionsPaginator = struct {
    client: *Client,
    params: get_system_template_revisions.GetSystemTemplateRevisionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListFlowExecutionMessagesPaginator = struct {
    client: *Client,
    params: list_flow_execution_messages.ListFlowExecutionMessagesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const SearchEntitiesPaginator = struct {
    client: *Client,
    params: search_entities.SearchEntitiesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const SearchFlowExecutionsPaginator = struct {
    client: *Client,
    params: search_flow_executions.SearchFlowExecutionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const SearchFlowTemplatesPaginator = struct {
    client: *Client,
    params: search_flow_templates.SearchFlowTemplatesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const SearchSystemInstancesPaginator = struct {
    client: *Client,
    params: search_system_instances.SearchSystemInstancesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const SearchSystemTemplatesPaginator = struct {
    client: *Client,
    params: search_system_templates.SearchSystemTemplatesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const SearchThingsPaginator = struct {
    client: *Client,
    params: search_things.SearchThingsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
