...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UploadEntityDefinitionsInput, options: Options) !UploadEntityDefinitionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UploadEntityDefinitionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "IotThingsGraphFrontEndService.UploadEntityDefinitions");
