...
const DeleteProjectOutput = @import("delete_project_result.zig").DeleteProjectResult;
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProjectInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "DeviceFarm_20150623.DeleteProject");
