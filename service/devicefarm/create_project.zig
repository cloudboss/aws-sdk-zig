...
const CreateProjectOutput = @import("create_project_result.zig").CreateProjectResult;
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateProjectInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DeviceFarm_20150623.CreateProject");
