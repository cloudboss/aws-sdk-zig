...
const UpdateProjectOutput = @import("update_project_result.zig").UpdateProjectResult;
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateProjectInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DeviceFarm_20150623.UpdateProject");
