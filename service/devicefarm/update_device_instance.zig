...
pub const UpdateDeviceInstanceInput = struct {
...
pub const UpdateDeviceInstanceOutput = struct {
    /// An object that contains information about your device instance.
    device_instance: ?DeviceInstance = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDeviceInstanceInput, options: CallOptions) !UpdateDeviceInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDeviceInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "DeviceFarm_20150623.UpdateDeviceInstance");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDeviceInstanceOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateDeviceInstanceOutput, body, allocator);
}
