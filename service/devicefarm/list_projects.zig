...
const ListProjectsInput = @import("list_projects_request.zig").ListProjectsRequest;

const ListProjectsOutput = @import("list_projects_result.zig").ListProjectsResult;
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListProjectsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "DeviceFarm_20150623.ListProjects");
