...
pub const DeleteDevicePoolInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDevicePoolInput, options: Options) !DeleteDevicePoolOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDevicePoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "DeviceFarm_20150623.DeleteDevicePool");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDevicePoolOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
