...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteNetworkProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DeviceFarm_20150623.DeleteNetworkProfile");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteNetworkProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
