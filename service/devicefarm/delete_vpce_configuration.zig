...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVPCEConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DeviceFarm_20150623.DeleteVPCEConfiguration");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteVPCEConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
