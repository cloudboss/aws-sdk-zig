...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateLinkAttributesInput, options: Options) !UpdateLinkAttributesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateLinkAttributesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateLinkAttributesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
