...
pub const DeleteFacetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFacetInput, options: Options) !DeleteFacetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteFacetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteFacetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFacetOutput = .{};
