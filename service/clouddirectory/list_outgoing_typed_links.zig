...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListOutgoingTypedLinksInput, options: CallOptions) !ListOutgoingTypedLinksOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListOutgoingTypedLinksInput, config: *aws.Config) !aws.http.Request {
