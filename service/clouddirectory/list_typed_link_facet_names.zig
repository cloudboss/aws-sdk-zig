...
pub const ListTypedLinkFacetNamesInput = struct {
...
pub const ListTypedLinkFacetNamesOutput = struct {
    /// The names of typed link facets that exist within the schema.
    facet_names: ?[]const []const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTypedLinkFacetNamesInput, options: CallOptions) !ListTypedLinkFacetNamesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTypedLinkFacetNamesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/amazonclouddirectory/2017-01-11/typedlink/facet/list";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListTypedLinkFacetNamesOutput {
    var result: ListTypedLinkFacetNamesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListTypedLinkFacetNamesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
