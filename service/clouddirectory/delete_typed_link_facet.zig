...
pub const DeleteTypedLinkFacetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTypedLinkFacetInput, options: Options) !DeleteTypedLinkFacetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTypedLinkFacetInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/amazonclouddirectory/2017-01-11/typedlink/facet/delete";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTypedLinkFacetOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTypedLinkFacetOutput = .{};
