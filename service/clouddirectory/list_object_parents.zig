...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListObjectParentsInput, options: CallOptions) !ListObjectParentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListObjectParentsInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.include_all_links_to_each_parent) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"IncludeAllLinksToEachParent\":");
