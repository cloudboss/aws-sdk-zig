...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFacetNamesInput, options: CallOptions) !ListFacetNamesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFacetNamesInput, config: *aws.Config) !aws.http.Request {
