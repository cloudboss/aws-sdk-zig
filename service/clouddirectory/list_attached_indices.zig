...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAttachedIndicesInput, options: CallOptions) !ListAttachedIndicesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAttachedIndicesInput, config: *aws.Config) !aws.http.Request {
