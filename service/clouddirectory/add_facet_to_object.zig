...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddFacetToObjectInput, options: Options) !AddFacetToObjectOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AddFacetToObjectInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddFacetToObjectOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
