...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachFromIndexInput, options: CallOptions) !DetachFromIndexOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachFromIndexInput, config: *aws.Config) !aws.http.Request {
