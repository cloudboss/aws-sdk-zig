...
fn serializeRequest(allocator: std.mem.Allocator, input: ExecuteStackRefactorInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ExecuteStackRefactor&Version=2010-05-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ExecuteStackRefactorOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
