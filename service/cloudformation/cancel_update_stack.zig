...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelUpdateStackInput, options: Options) !CancelUpdateStackOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelUpdateStackInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CancelUpdateStack&Version=2010-05-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelUpdateStackOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
