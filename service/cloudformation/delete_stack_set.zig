...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteStackSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteStackSet&Version=2010-05-15");
    if (input.call_as) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteStackSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
