...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListStackSetsInput, options: CallOptions) !ListStackSetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListStackSetsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListStackSetsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.summaries = try serde.deserializeStackSetSummaries(allocator, &reader, "member");
                } else {
