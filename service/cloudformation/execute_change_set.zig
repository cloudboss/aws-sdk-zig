...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ExecuteChangeSetInput, options: Options) !ExecuteChangeSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ExecuteChangeSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ExecuteChangeSet&Version=2010-05-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ExecuteChangeSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
