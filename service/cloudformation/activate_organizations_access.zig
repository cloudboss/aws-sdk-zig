...
pub const ActivateOrganizationsAccessInput = struct {
};

pub const ActivateOrganizationsAccessOutput = struct {
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ActivateOrganizationsAccessInput, options: CallOptions) !ActivateOrganizationsAccessOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ActivateOrganizationsAccessInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=ActivateOrganizationsAccess&Version=2010-05-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ActivateOrganizationsAccessOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: ActivateOrganizationsAccessOutput = .{};
