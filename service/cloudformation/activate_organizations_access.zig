...
fn serializeRequest(alloc: std.mem.Allocator, input: ActivateOrganizationsAccessInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=ActivateOrganizationsAccess&Version=2010-05-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ActivateOrganizationsAccessOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
