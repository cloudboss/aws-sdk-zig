...
fn serializeRequest(alloc: std.mem.Allocator, input: StartResourceScanInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StartResourceScan&Version=2010-05-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartResourceScanOutput {
    _ = status;
    _ = headers;
