...
fn serializeRequest(alloc: std.mem.Allocator, input: DeactivateTypeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeactivateType&Version=2010-05-15");
    if (input.arn) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeactivateTypeOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
