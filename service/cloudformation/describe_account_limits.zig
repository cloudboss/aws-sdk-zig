...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeAccountLimitsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeAccountLimits&Version=2010-05-15");
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "AccountLimits")) {
                    result.account_limits = try serde.deserializeAccountLimitList(&reader, alloc, "member");
