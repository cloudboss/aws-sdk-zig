...
pub const DeleteGeneratedTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGeneratedTemplateInput, options: CallOptions) !DeleteGeneratedTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteGeneratedTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteGeneratedTemplate&Version=2010-05-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteGeneratedTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteGeneratedTemplateOutput = .{};
