...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteGeneratedTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteGeneratedTemplate&Version=2010-05-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteGeneratedTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
