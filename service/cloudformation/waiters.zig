...
pub const ChangeSetCreateCompleteWaiter = struct {
    client: *Client,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        const output = self.client.describeChangeSet(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "ValidationError")) {
                    return .failure;
                }
            }
            return .retry;
...
pub const StackCreateCompleteWaiter = struct {
    client: *Client,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        _ = self.client.describeStacks(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "ValidationError")) {
                    return .failure;
...
pub const StackDeleteCompleteWaiter = struct {
    client: *Client,
    params: describe_stacks.DescribeStacksInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const StackExistsWaiter = struct {
    client: *Client,
    params: describe_stacks.DescribeStacksInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 5,
...
pub const StackImportCompleteWaiter = struct {
    client: *Client,
    params: describe_stacks.DescribeStacksInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const StackRefactorCreateCompleteWaiter = struct {
    client: *Client,
    params: describe_stack_refactor.DescribeStackRefactorInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 5,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        const output = self.client.describeStackRefactor(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "ValidationError")) {
                    return .failure;
...
pub const StackRefactorExecuteCompleteWaiter = struct {
    client: *Client,
    params: describe_stack_refactor.DescribeStackRefactorInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 15,
...
pub const StackRollbackCompleteWaiter = struct {
    client: *Client,
    params: describe_stacks.DescribeStacksInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const StackUpdateCompleteWaiter = struct {
    client: *Client,
    params: describe_stacks.DescribeStacksInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const TypeRegistrationCompleteWaiter = struct {
    client: *Client,
    params: describe_type_registration.DescribeTypeRegistrationInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
