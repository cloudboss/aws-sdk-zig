...
pub const StopStackSetOperationInput = struct {
    ...
    /// member account. Valid only if the
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopStackSetOperationInput, options: Options) !StopStackSetOperationOutput {
