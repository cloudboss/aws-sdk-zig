...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeactivateOrganizationsAccessInput, options: Options) !DeactivateOrganizationsAccessOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeactivateOrganizationsAccessInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=DeactivateOrganizationsAccess&Version=2010-05-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeactivateOrganizationsAccessOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeactivateOrganizationsAccessOutput = .{};
