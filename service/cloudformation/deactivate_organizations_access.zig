...
fn serializeRequest(alloc: std.mem.Allocator, input: DeactivateOrganizationsAccessInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=DeactivateOrganizationsAccess&Version=2010-05-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeactivateOrganizationsAccessOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
