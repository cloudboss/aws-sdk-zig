...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDescribeTypeConfigurationsInput, options: Options) !BatchDescribeTypeConfigurationsOutput {
