...
pub const DeleteContentInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContentInput, options: Options) !DeleteContentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteContentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteContentOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContentOutput = .{};
