...
pub const DeleteAssistantAssociationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAssistantAssociationInput, options: Options) !DeleteAssistantAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAssistantAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAssistantAssociationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAssistantAssociationOutput = .{};
