...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListQuickResponsesInput, options: CallOptions) !ListQuickResponsesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListQuickResponsesInput, config: *aws.Config) !aws.http.Request {
