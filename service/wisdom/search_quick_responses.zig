...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchQuickResponsesInput, options: CallOptions) !SearchQuickResponsesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchQuickResponsesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/search/quickResponses");
