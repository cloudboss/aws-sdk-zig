...
pub const DeleteQuickResponseInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteQuickResponseInput, options: Options) !DeleteQuickResponseOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteQuickResponseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteQuickResponseOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteQuickResponseOutput = .{};
