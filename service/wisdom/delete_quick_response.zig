...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteQuickResponseInput, options: CallOptions) !DeleteQuickResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteQuickResponseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteQuickResponseOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
