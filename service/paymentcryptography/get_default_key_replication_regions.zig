...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDefaultKeyReplicationRegionsInput, options: Options) !GetDefaultKeyReplicationRegionsOutput {
