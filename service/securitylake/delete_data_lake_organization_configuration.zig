...
pub const DeleteDataLakeOrganizationConfigurationInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDataLakeOrganizationConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v1/datalake/organization/configuration/delete";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDataLakeOrganizationConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDataLakeOrganizationConfigurationOutput = .{};
