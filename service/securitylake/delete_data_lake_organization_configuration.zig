...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDataLakeOrganizationConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.auto_enable_new_account) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"autoEnableNewAccount\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDataLakeOrganizationConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
