...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataLakeOrganizationConfigurationInput, options: CallOptions) !GetDataLakeOrganizationConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDataLakeOrganizationConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDataLakeOrganizationConfigurationOutput {
    var result: GetDataLakeOrganizationConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetDataLakeOrganizationConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
