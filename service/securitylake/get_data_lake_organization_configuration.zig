...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataLakeOrganizationConfigurationInput, options: Options) !GetDataLakeOrganizationConfigurationOutput {
