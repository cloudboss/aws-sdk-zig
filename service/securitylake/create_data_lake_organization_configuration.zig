...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDataLakeOrganizationConfigurationInput, options: Options) !CreateDataLakeOrganizationConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateDataLakeOrganizationConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateDataLakeOrganizationConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
