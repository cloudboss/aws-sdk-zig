...
pub const UpdateSubscriberNotificationInput = struct {
...
pub const UpdateSubscriberNotificationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSubscriberNotificationInput, options: CallOptions) !UpdateSubscriberNotificationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSubscriberNotificationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateSubscriberNotificationOutput {
    var result: UpdateSubscriberNotificationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateSubscriberNotificationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
