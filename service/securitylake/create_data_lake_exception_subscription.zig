...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDataLakeExceptionSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateDataLakeExceptionSubscriptionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
