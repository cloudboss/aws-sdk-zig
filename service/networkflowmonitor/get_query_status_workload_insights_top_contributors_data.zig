...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetQueryStatusWorkloadInsightsTopContributorsDataInput, options: CallOptions) !GetQueryStatusWorkloadInsightsTopContributorsDataOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetQueryStatusWorkloadInsightsTopContributorsDataInput, config: *aws.Config) !aws.http.Request {
