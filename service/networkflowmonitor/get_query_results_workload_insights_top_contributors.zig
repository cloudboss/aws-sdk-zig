...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetQueryResultsWorkloadInsightsTopContributorsInput, options: Options) !GetQueryResultsWorkloadInsightsTopContributorsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetQueryResultsWorkloadInsightsTopContributorsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetQueryResultsWorkloadInsightsTopContributorsOutput {
    var result: GetQueryResultsWorkloadInsightsTopContributorsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetQueryResultsWorkloadInsightsTopContributorsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
