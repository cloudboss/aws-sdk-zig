...
pub const DeleteScopeInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteScopeInput, options: Options) !DeleteScopeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteScopeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteScopeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteScopeOutput = .{};
