...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetQueryStatusWorkloadInsightsTopContributorsInput, options: Options) !GetQueryStatusWorkloadInsightsTopContributorsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetQueryStatusWorkloadInsightsTopContributorsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetQueryStatusWorkloadInsightsTopContributorsOutput {
    var result: GetQueryStatusWorkloadInsightsTopContributorsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetQueryStatusWorkloadInsightsTopContributorsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
