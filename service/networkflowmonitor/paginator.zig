...
pub const GetQueryResultsMonitorTopContributorsPaginator = struct {
    client: *Client,
    params: get_query_results_monitor_top_contributors.GetQueryResultsMonitorTopContributorsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_query_results_monitor_top_contributors.GetQueryResultsMonitorTopContributorsOutput {
        ...
        const output = try get_query_results_monitor_top_contributors.execute(self.client, allocator, self.params, options);
...
pub const GetQueryResultsWorkloadInsightsTopContributorsPaginator = struct {
    client: *Client,
    params: get_query_results_workload_insights_top_contributors.GetQueryResultsWorkloadInsightsTopContributorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_query_results_workload_insights_top_contributors.GetQueryResultsWorkloadInsightsTopContributorsOutput {
        ...
        const output = try get_query_results_workload_insights_top_contributors.execute(self.client, allocator, self.params, options);
...
pub const GetQueryResultsWorkloadInsightsTopContributorsDataPaginator = struct {
    client: *Client,
    params: get_query_results_workload_insights_top_contributors_data.GetQueryResultsWorkloadInsightsTopContributorsDataInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_query_results_workload_insights_top_contributors_data.GetQueryResultsWorkloadInsightsTopContributorsDataOutput {
        ...
        const output = try get_query_results_workload_insights_top_contributors_data.execute(self.client, allocator, self.params, options);
...
pub const ListScopesPaginator = struct {
    client: *Client,
    params: list_scopes.ListScopesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_scopes.ListScopesOutput {
        ...
        const output = try list_scopes.execute(self.client, allocator, self.params, options);
