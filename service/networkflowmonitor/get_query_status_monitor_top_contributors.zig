...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetQueryStatusMonitorTopContributorsInput, options: CallOptions) !GetQueryStatusMonitorTopContributorsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetQueryStatusMonitorTopContributorsInput, config: *aws.Config) !aws.http.Request {
