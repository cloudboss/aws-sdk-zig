...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetQueryResultsWorkloadInsightsTopContributorsDataInput, options: Options) !GetQueryResultsWorkloadInsightsTopContributorsDataOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetQueryResultsWorkloadInsightsTopContributorsDataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetQueryResultsWorkloadInsightsTopContributorsDataOutput {
    var result: GetQueryResultsWorkloadInsightsTopContributorsDataOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetQueryResultsWorkloadInsightsTopContributorsDataOutput, body, alloc);
    }
    _ = status;
    _ = headers;
