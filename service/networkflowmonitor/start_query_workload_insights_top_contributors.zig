...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartQueryWorkloadInsightsTopContributorsInput, options: CallOptions) !StartQueryWorkloadInsightsTopContributorsOutput {
