...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSignalingChannelInput, options: Options) !UpdateSignalingChannelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateSignalingChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateSignalingChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
