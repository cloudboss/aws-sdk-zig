...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMappedResourceConfigurationInput, options: Options) !DescribeMappedResourceConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeMappedResourceConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeMappedResourceConfigurationOutput {
    var result: DescribeMappedResourceConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeMappedResourceConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
