...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSignalingChannelInput, options: Options) !DeleteSignalingChannelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSignalingChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSignalingChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
