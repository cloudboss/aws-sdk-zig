...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateImageGenerationConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.image_generation_configuration) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"ImageGenerationConfiguration\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateImageGenerationConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
