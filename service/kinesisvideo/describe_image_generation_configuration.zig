...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeImageGenerationConfigurationInput, options: Options) !DescribeImageGenerationConfigurationOutput {
