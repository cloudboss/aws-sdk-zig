...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeStreamStorageConfigurationInput, options: Options) !DescribeStreamStorageConfigurationOutput {
