...
pub const DescribeMappedResourceConfigurationPaginator = struct {
    client: *Client,
    params: describe_mapped_resource_configuration.DescribeMappedResourceConfigurationInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_mapped_resource_configuration.DescribeMappedResourceConfigurationOutput {
        ...
        const output = try describe_mapped_resource_configuration.execute(self.client, allocator, self.params, options);
...
pub const ListEdgeAgentConfigurationsPaginator = struct {
    client: *Client,
    params: list_edge_agent_configurations.ListEdgeAgentConfigurationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_edge_agent_configurations.ListEdgeAgentConfigurationsOutput {
        ...
        const output = try list_edge_agent_configurations.execute(self.client, allocator, self.params, options);
...
pub const ListSignalingChannelsPaginator = struct {
    client: *Client,
    params: list_signaling_channels.ListSignalingChannelsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_signaling_channels.ListSignalingChannelsOutput {
        ...
        const output = try list_signaling_channels.execute(self.client, allocator, self.params, options);
