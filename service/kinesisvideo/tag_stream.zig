...
pub const TagStreamInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagStreamInput, options: CallOptions) !TagStreamOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagStreamInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagStreamOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: TagStreamOutput = .{};
