...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSignalingChannelInput, options: CallOptions) !DescribeSignalingChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeSignalingChannelInput, config: *aws.Config) !aws.http.Request {
