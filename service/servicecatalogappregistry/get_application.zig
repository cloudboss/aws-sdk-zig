...
pub const GetApplicationInput = @import("get_application_request.zig").GetApplicationRequest;

pub const GetApplicationOutput = @import("get_application_response.zig").GetApplicationResponse;
