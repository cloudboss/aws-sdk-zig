...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateAttributeGroupInput, options: CallOptions) !AssociateAttributeGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateAttributeGroupInput, config: *aws.Config) !aws.http.Request {
