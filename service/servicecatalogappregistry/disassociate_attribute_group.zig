...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateAttributeGroupInput, options: CallOptions) !DisassociateAttributeGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateAttributeGroupInput, config: *aws.Config) !aws.http.Request {
