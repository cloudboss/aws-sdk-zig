...
pub const ListAssociatedAttributeGroupsPaginator = struct {
    client: *Client,
    params: list_associated_attribute_groups.ListAssociatedAttributeGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_associated_attribute_groups.ListAssociatedAttributeGroupsOutput {
        ...
        const output = try list_associated_attribute_groups.execute(self.client, allocator, self.params, options);
...
pub const ListAssociatedResourcesPaginator = struct {
    client: *Client,
    params: list_associated_resources.ListAssociatedResourcesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_associated_resources.ListAssociatedResourcesOutput {
        ...
        const output = try list_associated_resources.execute(self.client, allocator, self.params, options);
...
pub const ListAttributeGroupsPaginator = struct {
    client: *Client,
    params: list_attribute_groups.ListAttributeGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_attribute_groups.ListAttributeGroupsOutput {
        ...
        const output = try list_attribute_groups.execute(self.client, allocator, self.params, options);
...
pub const ListAttributeGroupsForApplicationPaginator = struct {
    client: *Client,
    params: list_attribute_groups_for_application.ListAttributeGroupsForApplicationInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_attribute_groups_for_application.ListAttributeGroupsForApplicationOutput {
        ...
        const output = try list_attribute_groups_for_application.execute(self.client, allocator, self.params, options);
