...
pub const ListDataIngestionJobsPaginator = struct {
    client: *Client,
    params: list_data_ingestion_jobs.ListDataIngestionJobsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_data_ingestion_jobs.ListDataIngestionJobsOutput {
        if (self.done) {
...
pub const ListInferenceEventsPaginator = struct {
    client: *Client,
    params: list_inference_events.ListInferenceEventsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_inference_events.ListInferenceEventsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListInferenceExecutionsPaginator = struct {
    client: *Client,
    params: list_inference_executions.ListInferenceExecutionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_inference_executions.ListInferenceExecutionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListInferenceSchedulersPaginator = struct {
    client: *Client,
    params: list_inference_schedulers.ListInferenceSchedulersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_inference_schedulers.ListInferenceSchedulersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListLabelGroupsPaginator = struct {
    client: *Client,
    params: list_label_groups.ListLabelGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_label_groups.ListLabelGroupsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListLabelsPaginator = struct {
    client: *Client,
    params: list_labels.ListLabelsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_labels.ListLabelsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListModelVersionsPaginator = struct {
    client: *Client,
    params: list_model_versions.ListModelVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_model_versions.ListModelVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListRetrainingSchedulersPaginator = struct {
    client: *Client,
    params: list_retraining_schedulers.ListRetrainingSchedulersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_retraining_schedulers.ListRetrainingSchedulersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSensorStatisticsPaginator = struct {
    client: *Client,
    params: list_sensor_statistics.ListSensorStatisticsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_sensor_statistics.ListSensorStatisticsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
