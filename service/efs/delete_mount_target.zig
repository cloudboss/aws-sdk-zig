...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMountTargetInput, options: CallOptions) !DeleteMountTargetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMountTargetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMountTargetOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
