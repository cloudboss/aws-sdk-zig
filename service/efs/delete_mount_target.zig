...
pub const DeleteMountTargetInput = struct {
...
pub const DeleteMountTargetOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMountTargetInput, options: Options) !DeleteMountTargetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteMountTargetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteMountTargetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMountTargetOutput = .{};
