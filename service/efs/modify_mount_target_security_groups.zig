...
pub const ModifyMountTargetSecurityGroupsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyMountTargetSecurityGroupsInput, options: Options) !ModifyMountTargetSecurityGroupsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyMountTargetSecurityGroupsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyMountTargetSecurityGroupsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: ModifyMountTargetSecurityGroupsOutput = .{};
