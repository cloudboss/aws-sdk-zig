...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyMountTargetSecurityGroupsInput, options: CallOptions) !ModifyMountTargetSecurityGroupsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyMountTargetSecurityGroupsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyMountTargetSecurityGroupsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
