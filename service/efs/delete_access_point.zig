...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessPointInput, options: CallOptions) !DeleteAccessPointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccessPointInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2015-02-01/access-points/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccessPointOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
