...
pub const DeleteFileSystemPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFileSystemPolicyInput, options: CallOptions) !DeleteFileSystemPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFileSystemPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFileSystemPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFileSystemPolicyOutput = .{};
