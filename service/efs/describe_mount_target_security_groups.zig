...
pub const DescribeMountTargetSecurityGroupsInput = struct {
...
pub const DescribeMountTargetSecurityGroupsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMountTargetSecurityGroupsInput, options: Options) !DescribeMountTargetSecurityGroupsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeMountTargetSecurityGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2015-02-01/mount-targets/");
    try path_buf.appendSlice(alloc, input.mount_target_id);
    try path_buf.appendSlice(alloc, "/security-groups");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeMountTargetSecurityGroupsOutput {
    var result: DescribeMountTargetSecurityGroupsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeMountTargetSecurityGroupsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
