...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFileSystemInput, options: Options) !DeleteFileSystemOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteFileSystemInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteFileSystemOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
