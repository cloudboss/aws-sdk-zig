...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCacheSubnetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteCacheSubnetGroup&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCacheSubnetGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
