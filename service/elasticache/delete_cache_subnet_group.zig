...
pub const DeleteCacheSubnetGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCacheSubnetGroupInput, options: CallOptions) !DeleteCacheSubnetGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCacheSubnetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteCacheSubnetGroup&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCacheSubnetGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteCacheSubnetGroupOutput = .{};
