...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchStopUpdateActionInput, options: CallOptions) !BatchStopUpdateActionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchStopUpdateActionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=BatchStopUpdateAction&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !BatchStopUpdateActionOutput {
    _ = status;
    _ = headers;
