...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCacheSecurityGroupInput, options: CallOptions) !DeleteCacheSecurityGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCacheSecurityGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteCacheSecurityGroup&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCacheSecurityGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
