...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyCacheSubnetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyCacheSubnetGroup&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyCacheSubnetGroupOutput {
    _ = status;
    _ = headers;
