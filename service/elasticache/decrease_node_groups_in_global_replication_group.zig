...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DecreaseNodeGroupsInGlobalReplicationGroupInput, options: Options) !DecreaseNodeGroupsInGlobalReplicationGroupOutput {
