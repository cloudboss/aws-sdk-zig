...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RebalanceSlotsInGlobalReplicationGroupInput, options: CallOptions) !RebalanceSlotsInGlobalReplicationGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RebalanceSlotsInGlobalReplicationGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RebalanceSlotsInGlobalReplicationGroup&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RebalanceSlotsInGlobalReplicationGroupOutput {
    _ = status;
    _ = headers;
