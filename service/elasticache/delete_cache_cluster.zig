...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCacheClusterInput, options: Options) !DeleteCacheClusterOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCacheClusterInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteCacheCluster&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCacheClusterOutput {
    _ = status;
    _ = headers;
