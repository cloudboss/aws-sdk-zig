...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RevokeCacheSecurityGroupIngressInput, options: Options) !RevokeCacheSecurityGroupIngressOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RevokeCacheSecurityGroupIngressInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RevokeCacheSecurityGroupIngress&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RevokeCacheSecurityGroupIngressOutput {
    _ = status;
    _ = headers;
