...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyCacheParameterGroupInput, options: Options) !ModifyCacheParameterGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyCacheParameterGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyCacheParameterGroup&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyCacheParameterGroupOutput {
    _ = status;
    _ = headers;
