...
fn serializeRequest(alloc: std.mem.Allocator, input: IncreaseReplicaCountInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=IncreaseReplicaCount&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !IncreaseReplicaCountOutput {
    _ = status;
    _ = headers;
