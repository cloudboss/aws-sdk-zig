...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ExportServerlessCacheSnapshotInput, options: Options) !ExportServerlessCacheSnapshotOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ExportServerlessCacheSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ExportServerlessCacheSnapshot&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ExportServerlessCacheSnapshotOutput {
    _ = status;
    _ = headers;
