...
pub const ReplicationGroup = struct {
    ...
    member_clusters: ?[]const []const u8,

    /// The outpost ARNs of the replication group's member clusters.
    member_clusters_outpost_arns: ?[]const []const u8,
    ...
    replication_group_create_time: ?i64,
    ...
    /// group.
    snapshotting_cluster_id: ?[]const u8,
