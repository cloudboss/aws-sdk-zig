...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateServerlessCacheSnapshotInput, options: Options) !CreateServerlessCacheSnapshotOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateServerlessCacheSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateServerlessCacheSnapshot&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateServerlessCacheSnapshotOutput {
    _ = status;
    _ = headers;
