...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyReplicationGroupShardConfigurationInput, options: Options) !ModifyReplicationGroupShardConfigurationOutput {
