...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeServerlessCacheSnapshotsInput, options: Options) !DescribeServerlessCacheSnapshotsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeServerlessCacheSnapshotsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeServerlessCacheSnapshots&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeServerlessCacheSnapshotsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.serverless_cache_snapshots = try serde.deserializeServerlessCacheSnapshotList(&reader, alloc, "ServerlessCacheSnapshot");
                } else {
