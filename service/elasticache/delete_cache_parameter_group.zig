...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCacheParameterGroupInput, options: CallOptions) !DeleteCacheParameterGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCacheParameterGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteCacheParameterGroup&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCacheParameterGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
