...
pub const DeleteCacheParameterGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCacheParameterGroupInput, options: Options) !DeleteCacheParameterGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCacheParameterGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteCacheParameterGroup&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCacheParameterGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteCacheParameterGroupOutput = .{};
