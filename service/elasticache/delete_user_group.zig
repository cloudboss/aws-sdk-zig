...
pub const DeleteUserGroupOutput = @import("user_group.zig").UserGroup;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserGroupInput, options: CallOptions) !DeleteUserGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteUserGroup&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserGroupOutput {
    _ = status;
    _ = headers;
