...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchApplyUpdateActionInput, options: Options) !BatchApplyUpdateActionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: BatchApplyUpdateActionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=BatchApplyUpdateAction&Version=2015-02-02");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !BatchApplyUpdateActionOutput {
    _ = status;
    _ = headers;
