...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AuthorizeCacheSecurityGroupIngressInput, options: CallOptions) !AuthorizeCacheSecurityGroupIngressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AuthorizeCacheSecurityGroupIngressInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AuthorizeCacheSecurityGroupIngress&Version=2015-02-02");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AuthorizeCacheSecurityGroupIngressOutput {
    _ = status;
    _ = headers;
