...
pub const ListInvoiceSummariesPaginator = struct {
    client: *Client,
    params: list_invoice_summaries.ListInvoiceSummariesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_invoice_summaries.ListInvoiceSummariesOutput {
        ...
        const output = try list_invoice_summaries.execute(self.client, allocator, self.params, options);
...
pub const ListInvoiceUnitsPaginator = struct {
    client: *Client,
    params: list_invoice_units.ListInvoiceUnitsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_invoice_units.ListInvoiceUnitsOutput {
        ...
        const output = try list_invoice_units.execute(self.client, allocator, self.params, options);
...
pub const ListProcurementPortalPreferencesPaginator = struct {
    client: *Client,
    params: list_procurement_portal_preferences.ListProcurementPortalPreferencesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_procurement_portal_preferences.ListProcurementPortalPreferencesOutput {
        ...
        const output = try list_procurement_portal_preferences.execute(self.client, allocator, self.params, options);
