...
pub const StartCanaryInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartCanaryInput, options: Options) !StartCanaryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartCanaryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartCanaryOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: StartCanaryOutput = .{};
