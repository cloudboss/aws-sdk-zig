...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopCanaryInput, options: Options) !StopCanaryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopCanaryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopCanaryOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
