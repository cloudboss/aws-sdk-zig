...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataProtectionSettingsInput, options: CallOptions) !UpdateDataProtectionSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDataProtectionSettingsInput, config: *aws.Config) !aws.http.Request {
