...
pub const CreateNetworkSettingsInput = struct {
...
pub const CreateNetworkSettingsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateNetworkSettingsInput, options: Options) !CreateNetworkSettingsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateNetworkSettingsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateNetworkSettingsOutput {
    var result: CreateNetworkSettingsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateNetworkSettingsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
