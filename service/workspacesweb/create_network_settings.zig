...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateNetworkSettingsInput, options: CallOptions) !CreateNetworkSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateNetworkSettingsInput, config: *aws.Config) !aws.http.Request {
