...
pub const ReportInstanceStatusOutput = struct {
    ...
    pub fn deinit(self: *const ReportInstanceStatusOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: ReportInstanceStatusInput, options: Options) !ReportInstanceStatusOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ReportInstanceStatusOutput {
    _ = status;
    _ = body;
    const result: ReportInstanceStatusOutput = .{ .allocator = alloc };
