...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCapacityReservationFleetInput, options: CallOptions) !CreateCapacityReservationFleetOutput {
