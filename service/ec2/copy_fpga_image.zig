...
fn serializeRequest(alloc: std.mem.Allocator, input: CopyFpgaImageInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CopyFpgaImage&Version=2016-11-15");
    ...
    try body_buf.appendSlice(alloc, "&SourceFpgaImageId=");
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.source_fpga_image_id);
