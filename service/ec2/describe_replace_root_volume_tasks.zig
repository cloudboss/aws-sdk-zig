...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReplaceRootVolumeTasksInput, options: Options) !DescribeReplaceRootVolumeTasksOutput {
