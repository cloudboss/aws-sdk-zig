...
pub const StartNetworkInsightsAccessScopeAnalysisOutput = struct {
    ...
    pub fn deinit(self: *StartNetworkInsightsAccessScopeAnalysisOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: StartNetworkInsightsAccessScopeAnalysisInput, options: Options) !StartNetworkInsightsAccessScopeAnalysisOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartNetworkInsightsAccessScopeAnalysisInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StartNetworkInsightsAccessScopeAnalysis&Version=2016-11-15");
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "networkInsightsAccessScopeAnalysis")) {
                    result.network_insights_access_scope_analysis = try serde.deserializeNetworkInsightsAccessScopeAnalysis(&reader, alloc);
                } else {
