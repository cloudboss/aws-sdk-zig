...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartNetworkInsightsAccessScopeAnalysisInput, options: Options) !StartNetworkInsightsAccessScopeAnalysisOutput {
