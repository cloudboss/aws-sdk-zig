...
pub const DescribeHostReservationOfferingsOutput = struct {
    ...
    pub fn deinit(self: *const DescribeHostReservationOfferingsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeHostReservationOfferingsOutput {
    _ = status;
    var result: DescribeHostReservationOfferingsOutput = .{ .allocator = alloc };
