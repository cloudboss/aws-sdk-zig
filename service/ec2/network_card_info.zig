...
pub const NetworkCardInfo = struct {
    ...
    additional_flexible_network_interfaces: ?i32,

    /// The baseline network performance of the network card, in Gbps.
    baseline_bandwidth_in_gbps: ?f64,

    /// The default number of the ENA queues for each interface.
    default_ena_queue_count_per_interface: ?i32,

    /// The maximum number of the ENA queues.
    maximum_ena_queue_count: ?i32,

    /// The maximum number of the ENA queues for each interface.
    maximum_ena_queue_count_per_interface: ?i32,
