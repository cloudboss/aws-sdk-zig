...
pub const CreateIpamExternalResourceVerificationTokenOutput = struct {
    ...
    pub fn deinit(self: *const CreateIpamExternalResourceVerificationTokenOutput) void {
        _ = self;
    }
};
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateIpamExternalResourceVerificationTokenInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateIpamExternalResourceVerificationToken&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateIpamExternalResourceVerificationTokenOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: CreateIpamExternalResourceVerificationTokenOutput = .{ .allocator = alloc };
