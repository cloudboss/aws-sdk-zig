...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDefaultSubnetInput, options: Options) !CreateDefaultSubnetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateDefaultSubnetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateDefaultSubnet&Version=2016-11-15");
