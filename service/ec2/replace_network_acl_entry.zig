...
fn serializeRequest(allocator: std.mem.Allocator, input: ReplaceNetworkAclEntryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ReplaceNetworkAclEntry&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ReplaceNetworkAclEntryOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
