...
pub fn execute(client: *Client, input: DescribeVerifiedAccessInstancesInput, options: Options) !DescribeVerifiedAccessInstancesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeVerifiedAccessInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeVerifiedAccessInstances&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeVerifiedAccessInstancesOutput {
    _ = status;
