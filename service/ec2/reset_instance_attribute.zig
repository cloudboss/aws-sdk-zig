...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResetInstanceAttributeInput, options: CallOptions) !ResetInstanceAttributeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ResetInstanceAttributeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ResetInstanceAttribute&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ResetInstanceAttributeOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
