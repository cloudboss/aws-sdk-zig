...
pub const DescribeClientVpnAuthorizationRulesOutput = struct {
    ...
    pub fn deinit(self: *DescribeClientVpnAuthorizationRulesOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DescribeClientVpnAuthorizationRulesInput, options: Options) !DescribeClientVpnAuthorizationRulesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeClientVpnAuthorizationRulesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeClientVpnAuthorizationRules&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeClientVpnAuthorizationRulesOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "authorizationRule")) {
                    result.authorization_rules = try serde.deserializeAuthorizationRuleSet(&reader, alloc, "item");
