...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeClientVpnAuthorizationRulesInput, options: Options) !DescribeClientVpnAuthorizationRulesOutput {
