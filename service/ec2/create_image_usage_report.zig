...
pub const CreateImageUsageReportOutput = struct {
    ...
    pub fn deinit(self: *const CreateImageUsageReportOutput) void {
        if (self.report_id) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateImageUsageReportOutput {
    _ = status;
    var result: CreateImageUsageReportOutput = .{ .allocator = alloc };
