...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVpcBlockPublicAccessExclusionsInput, options: Options) !DescribeVpcBlockPublicAccessExclusionsOutput {
