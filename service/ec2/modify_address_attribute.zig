...
pub fn execute(client: *Client, input: ModifyAddressAttributeInput, options: Options) !ModifyAddressAttributeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyAddressAttributeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyAddressAttribute&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ModifyAddressAttributeOutput {
    _ = status;
    _ = body;
