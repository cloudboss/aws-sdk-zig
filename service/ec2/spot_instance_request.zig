...
pub const SpotInstanceRequest = struct {
    /// Deprecated.
    actual_block_hourly_price: ?[]const u8 = null,
    ...
    launched_availability_zone: ?[]const u8 = null,

    /// The ID of the Availability Zone in which the request is launched.
    ///
    /// Either `launchedAvailabilityZone` or `launchedAvailabilityZoneId` can be
    /// specified, but not both
    launched_availability_zone_id: ?[]const u8 = null,
    ...
    launch_specification: ?LaunchSpecification = null,
