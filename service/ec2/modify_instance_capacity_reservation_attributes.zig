...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyInstanceCapacityReservationAttributesInput, options: CallOptions) !ModifyInstanceCapacityReservationAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyInstanceCapacityReservationAttributesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyInstanceCapacityReservationAttributesOutput {
    _ = status;
    _ = headers;
    _ = allocator;
    ...
    var result: ModifyInstanceCapacityReservationAttributesOutput = .{};
    while (try reader.next()) |event| {
        switch (event) {
            .element_start => |e| {
