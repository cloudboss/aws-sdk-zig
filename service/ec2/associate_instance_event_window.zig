...
pub const AssociateInstanceEventWindowOutput = struct {
    /// Information about the event window.
    instance_event_window: ?InstanceEventWindow = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateInstanceEventWindowInput, options: CallOptions) !AssociateInstanceEventWindowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateInstanceEventWindowInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AssociateInstanceEventWindow&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateInstanceEventWindowOutput {
    _ = status;
    _ = headers;
