...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSecurityGroupRuleDescriptionsIngressInput, options: Options) !UpdateSecurityGroupRuleDescriptionsIngressOutput {
