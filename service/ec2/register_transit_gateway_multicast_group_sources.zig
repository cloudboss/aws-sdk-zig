...
pub const RegisterTransitGatewayMulticastGroupSourcesOutput = struct {
    ...
    pub fn deinit(self: *const RegisterTransitGatewayMulticastGroupSourcesOutput) void {
        _ = self;
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RegisterTransitGatewayMulticastGroupSourcesOutput {
    ...
    _ = headers;
    _ = body;
    const result: RegisterTransitGatewayMulticastGroupSourcesOutput = .{ .allocator = alloc };
