...
pub const CreateTransitGatewayPrefixListReferenceOutput = struct {
    ...
    pub fn deinit(self: *const CreateTransitGatewayPrefixListReferenceOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: CreateTransitGatewayPrefixListReferenceInput, options: Options) !CreateTransitGatewayPrefixListReferenceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTransitGatewayPrefixListReferenceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateTransitGatewayPrefixListReference&Version=2016-11-15");
    ...
    try body_buf.appendSlice(alloc, "&PrefixListId=");
    try appendUrlEncoded(alloc, &body_buf, input.prefix_list_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTransitGatewayPrefixListReferenceOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: CreateTransitGatewayPrefixListReferenceOutput = .{ .allocator = alloc };
