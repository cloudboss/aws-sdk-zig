...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTransitGatewayPrefixListReferenceInput, options: Options) !CreateTransitGatewayPrefixListReferenceOutput {
