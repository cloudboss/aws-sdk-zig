...
pub fn execute(client: *Client, input: DeleteLaunchTemplateInput, options: Options) !DeleteLaunchTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLaunchTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteLaunchTemplate&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteLaunchTemplateOutput {
    _ = status;
    _ = body;
