...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateClientVpnTargetNetworkInput, options: Options) !AssociateClientVpnTargetNetworkOutput {
