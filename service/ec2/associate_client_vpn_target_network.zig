...
pub const AssociateClientVpnTargetNetworkOutput = struct {
    ...
    pub fn deinit(self: *AssociateClientVpnTargetNetworkOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: AssociateClientVpnTargetNetworkInput, options: Options) !AssociateClientVpnTargetNetworkOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateClientVpnTargetNetworkInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateClientVpnTargetNetwork&Version=2016-11-15");
