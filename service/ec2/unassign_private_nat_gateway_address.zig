...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UnassignPrivateNatGatewayAddressInput, options: Options) !UnassignPrivateNatGatewayAddressOutput {
