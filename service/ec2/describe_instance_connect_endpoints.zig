...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInstanceConnectEndpointsInput, options: Options) !DescribeInstanceConnectEndpointsOutput {
