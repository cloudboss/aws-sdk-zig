...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVerifiedAccessEndpointPolicyInput, options: CallOptions) !ModifyVerifiedAccessEndpointPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyVerifiedAccessEndpointPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyVerifiedAccessEndpointPolicy&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyVerifiedAccessEndpointPolicyOutput {
    _ = status;
    _ = headers;
