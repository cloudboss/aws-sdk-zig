...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVerifiedAccessEndpointPolicyInput, options: Options) !ModifyVerifiedAccessEndpointPolicyOutput {
