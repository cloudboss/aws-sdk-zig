...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssignPrivateNatGatewayAddressInput, options: Options) !AssignPrivateNatGatewayAddressOutput {
