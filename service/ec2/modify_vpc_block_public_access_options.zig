...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVpcBlockPublicAccessOptionsInput, options: Options) !ModifyVpcBlockPublicAccessOptionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyVpcBlockPublicAccessOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(alloc, &body_buf, @tagName(input.internet_gateway_block_mode));
