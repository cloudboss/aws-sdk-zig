...
pub const CreateCoipPoolOutput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateCoipPoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateCoipPool&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateCoipPoolOutput {
    _ = status;
    _ = headers;
