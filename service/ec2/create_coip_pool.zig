...
pub fn execute(client: *Client, input: CreateCoipPoolInput, options: Options) !CreateCoipPoolOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateCoipPoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateCoipPool&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateCoipPoolOutput {
    _ = status;
    _ = body;
