...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateEnclaveCertificateIamRoleInput, options: CallOptions) !AssociateEnclaveCertificateIamRoleOutput {
