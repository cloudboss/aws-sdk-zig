...
pub const DescribeImportSnapshotTasksOutput = struct {
    ...
    pub fn deinit(self: *const DescribeImportSnapshotTasksOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeImportSnapshotTasksOutput {
    _ = status;
    var result: DescribeImportSnapshotTasksOutput = .{ .allocator = alloc };
