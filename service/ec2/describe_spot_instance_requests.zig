...
pub const DescribeSpotInstanceRequestsOutput = struct {
    ...
    pub fn deinit(self: *DescribeSpotInstanceRequestsOutput) void {
        self._arena.deinit();
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeSpotInstanceRequestsOutput {
    _ = status;
    _ = headers;
