...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSpotInstanceRequestsInput, options: CallOptions) !DescribeSpotInstanceRequestsOutput {
