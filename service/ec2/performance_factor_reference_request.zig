...
pub const PerformanceFactorReferenceRequest = struct {
    ...
    /// conventions](https://docs.aws.amazon.com/ec2/latest/instancetypes/instance-type-names.html) in *Amazon EC2 Instance
    /// Types*.
    ///
