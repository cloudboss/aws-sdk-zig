...
pub const ReplaceRouteOutput = struct {
    ...
    pub fn deinit(self: *const ReplaceRouteOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: ReplaceRouteInput, options: Options) !ReplaceRouteOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ReplaceRouteOutput {
    _ = status;
    _ = body;
    const result: ReplaceRouteOutput = .{ .allocator = alloc };
