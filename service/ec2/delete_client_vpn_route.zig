...
pub fn execute(client: *Client, input: DeleteClientVpnRouteInput, options: Options) !DeleteClientVpnRouteOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteClientVpnRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteClientVpnRoute&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteClientVpnRouteOutput {
    _ = status;
    _ = body;
