...
pub const DeleteClientVpnRouteOutput = struct {
    /// The current state of the route.
    status: ?ClientVpnRouteStatus = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClientVpnRouteInput, options: CallOptions) !DeleteClientVpnRouteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteClientVpnRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteClientVpnRoute&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteClientVpnRouteOutput {
    _ = status;
    _ = headers;
