...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLocalGatewayRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteLocalGatewayRoute&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLocalGatewayRouteOutput {
    _ = status;
    _ = headers;
