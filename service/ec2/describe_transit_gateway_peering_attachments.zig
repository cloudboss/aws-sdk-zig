...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTransitGatewayPeeringAttachmentsInput, options: CallOptions) !DescribeTransitGatewayPeeringAttachmentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTransitGatewayPeeringAttachmentsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeTransitGatewayPeeringAttachments&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeTransitGatewayPeeringAttachmentsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "nextToken")) {
                    ...
                    result.transit_gateway_peering_attachments = try serde.deserializeTransitGatewayPeeringAttachmentList(allocator, &reader, "item");
                } else {
