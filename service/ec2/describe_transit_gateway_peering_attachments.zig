...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTransitGatewayPeeringAttachmentsInput, options: Options) !DescribeTransitGatewayPeeringAttachmentsOutput {
