...
pub fn execute(client: *Client, input: DisableAllowedImagesSettingsInput, options: Options) !DisableAllowedImagesSettingsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisableAllowedImagesSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DisableAllowedImagesSettings&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DisableAllowedImagesSettingsOutput {
    _ = status;
    _ = body;
