...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTransitGatewayMeteringPolicyEntryInput, options: Options) !DeleteTransitGatewayMeteringPolicyEntryOutput {
