...
pub const DeleteTransitGatewayMeteringPolicyEntryInput = struct {
...
pub const DeleteTransitGatewayMeteringPolicyEntryOutput = struct {
    ...
    pub fn deinit(self: *const DeleteTransitGatewayMeteringPolicyEntryOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteTransitGatewayMeteringPolicyEntryInput, options: Options) !DeleteTransitGatewayMeteringPolicyEntryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTransitGatewayMeteringPolicyEntryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteTransitGatewayMeteringPolicyEntry&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTransitGatewayMeteringPolicyEntryOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteTransitGatewayMeteringPolicyEntryOutput = .{ .allocator = alloc };
