...
pub const SpotCapacityRebalance = struct {
    ...
    /// can
    /// terminate the old instances, or you can leave them running. You are charged
    /// for all
    ...
    replacement_strategy: ?ReplacementStrategy = null,
