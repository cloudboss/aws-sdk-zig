...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVpcEndpointServiceConfigurationInput, options: Options) !ModifyVpcEndpointServiceConfigurationOutput {
