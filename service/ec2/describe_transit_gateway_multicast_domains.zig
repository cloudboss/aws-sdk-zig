...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTransitGatewayMulticastDomainsInput, options: Options) !DescribeTransitGatewayMulticastDomainsOutput {
