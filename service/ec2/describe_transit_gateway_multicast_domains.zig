...
pub const DescribeTransitGatewayMulticastDomainsOutput = struct {
    ...
    pub fn deinit(self: *const DescribeTransitGatewayMulticastDomainsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeTransitGatewayMulticastDomainsOutput {
    _ = status;
    var result: DescribeTransitGatewayMulticastDomainsOutput = .{ .allocator = alloc };
