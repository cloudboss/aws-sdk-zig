...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateNetworkInsightsAccessScopeInput, options: Options) !CreateNetworkInsightsAccessScopeOutput {
