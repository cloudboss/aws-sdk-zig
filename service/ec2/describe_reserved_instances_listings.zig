...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReservedInstancesListingsInput, options: Options) !DescribeReservedInstancesListingsOutput {
