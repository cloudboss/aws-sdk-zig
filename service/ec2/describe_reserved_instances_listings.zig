...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReservedInstancesListingsInput, options: CallOptions) !DescribeReservedInstancesListingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeReservedInstancesListingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeReservedInstancesListings&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeReservedInstancesListingsOutput {
    _ = status;
    _ = headers;
