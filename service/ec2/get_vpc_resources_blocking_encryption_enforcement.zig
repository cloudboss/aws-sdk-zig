...
pub fn execute(client: *Client, input: GetVpcResourcesBlockingEncryptionEnforcementInput, options: Options) !GetVpcResourcesBlockingEncryptionEnforcementOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetVpcResourcesBlockingEncryptionEnforcementInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetVpcResourcesBlockingEncryptionEnforcement&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetVpcResourcesBlockingEncryptionEnforcementOutput {
    _ = status;
