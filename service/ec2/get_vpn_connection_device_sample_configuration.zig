...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVpnConnectionDeviceSampleConfigurationInput, options: Options) !GetVpnConnectionDeviceSampleConfigurationOutput {
