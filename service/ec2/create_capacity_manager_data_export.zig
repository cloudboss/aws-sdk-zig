...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCapacityManagerDataExportInput, options: Options) !CreateCapacityManagerDataExportOutput {
