...
pub const AcceptTransitGatewayMulticastDomainAssociationsOutput = struct {
    ...
    pub fn deinit(self: *const AcceptTransitGatewayMulticastDomainAssociationsOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AcceptTransitGatewayMulticastDomainAssociationsInput, options: Options) !AcceptTransitGatewayMulticastDomainAssociationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AcceptTransitGatewayMulticastDomainAssociationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AcceptTransitGatewayMulticastDomainAssociations&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AcceptTransitGatewayMulticastDomainAssociationsOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: AcceptTransitGatewayMulticastDomainAssociationsOutput = .{ .allocator = alloc };
