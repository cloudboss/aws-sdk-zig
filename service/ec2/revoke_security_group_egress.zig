...
pub const RevokeSecurityGroupEgressOutput = struct {
    ...
    pub fn deinit(self: *RevokeSecurityGroupEgressOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: RevokeSecurityGroupEgressInput, options: Options) !RevokeSecurityGroupEgressOutput {
