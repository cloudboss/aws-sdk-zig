...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSpotFleetRequestHistoryInput, options: Options) !DescribeSpotFleetRequestHistoryOutput {
