...
pub fn execute(client: *Client, input: DeleteVpcEndpointServiceConfigurationsInput, options: Options) !DeleteVpcEndpointServiceConfigurationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVpcEndpointServiceConfigurationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteVpcEndpointServiceConfigurations&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteVpcEndpointServiceConfigurationsOutput {
    _ = status;
    _ = body;
