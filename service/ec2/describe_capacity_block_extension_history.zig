...
pub const DescribeCapacityBlockExtensionHistoryOutput = struct {
    ...
    pub fn deinit(self: *const DescribeCapacityBlockExtensionHistoryOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeCapacityBlockExtensionHistoryOutput {
    _ = status;
    var result: DescribeCapacityBlockExtensionHistoryOutput = .{ .allocator = alloc };
