...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCapacityBlockExtensionHistoryInput, options: Options) !DescribeCapacityBlockExtensionHistoryOutput {
