...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCapacityBlockExtensionHistoryInput, options: CallOptions) !DescribeCapacityBlockExtensionHistoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCapacityBlockExtensionHistoryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeCapacityBlockExtensionHistory&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCapacityBlockExtensionHistoryOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "capacityBlockExtensionSet")) {
                    result.capacity_block_extensions = try serde.deserializeCapacityBlockExtensionSet(allocator, &reader, "item");
