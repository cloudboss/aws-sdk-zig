...
pub const TunnelOption = struct {
    ...
    ike_versions: ?[]const IKEVersionsListValue = null,

    /// Options for logging VPN tunnel activity.
    log_options: ?VpnTunnelLogOptions = null,
    ...
    /// IKE
    /// negotiations.
    phase_1_dh_group_numbers: ?[]const Phase1DHGroupNumbersListValue = null,

    /// The permitted encryption algorithms for the VPN tunnel for phase 1 IKE
    /// negotiations.
    phase_1_encryption_algorithms: ?[]const Phase1EncryptionAlgorithmsListValue = null,

    /// The permitted integrity algorithms for the VPN tunnel for phase 1 IKE
    /// negotiations.
    phase_1_integrity_algorithms: ?[]const Phase1IntegrityAlgorithmsListValue = null,
    ...
    /// IKE
    /// negotiations.
    phase_2_dh_group_numbers: ?[]const Phase2DHGroupNumbersListValue = null,

    /// The permitted encryption algorithms for the VPN tunnel for phase 2 IKE
    /// negotiations.
    phase_2_encryption_algorithms: ?[]const Phase2EncryptionAlgorithmsListValue = null,

    /// The permitted integrity algorithms for the VPN tunnel for phase 2 IKE
    /// negotiations.
    phase_2_integrity_algorithms: ?[]const Phase2IntegrityAlgorithmsListValue = null,
