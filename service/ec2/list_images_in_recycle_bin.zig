...
pub const ListImagesInRecycleBinOutput = struct {
    ...
    pub fn deinit(self: *const ListImagesInRecycleBinOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListImagesInRecycleBinOutput {
    _ = status;
    var result: ListImagesInRecycleBinOutput = .{ .allocator = alloc };
