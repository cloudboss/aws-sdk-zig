...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartDeclarativePoliciesReportInput, options: Options) !StartDeclarativePoliciesReportOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartDeclarativePoliciesReportInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.target_id);
