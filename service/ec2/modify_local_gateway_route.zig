...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyLocalGatewayRouteInput, options: CallOptions) !ModifyLocalGatewayRouteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyLocalGatewayRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyLocalGatewayRoute&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyLocalGatewayRouteOutput {
    _ = status;
    _ = headers;
