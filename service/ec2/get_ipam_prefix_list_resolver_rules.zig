...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIpamPrefixListResolverRulesInput, options: Options) !GetIpamPrefixListResolverRulesOutput {
