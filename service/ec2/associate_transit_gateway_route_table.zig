...
pub fn execute(client: *Client, input: AssociateTransitGatewayRouteTableInput, options: Options) !AssociateTransitGatewayRouteTableOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateTransitGatewayRouteTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateTransitGatewayRouteTable&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !AssociateTransitGatewayRouteTableOutput {
    _ = status;
    _ = body;
