...
pub const Ipam = struct {
    ...
    default_resource_discovery_association_id: ?[]const u8 = null,

    /// The IPAM's default resource discovery ID.
    default_resource_discovery_id: ?[]const u8 = null,
    ...
    private_default_scope_id: ?[]const u8 = null,

    /// The ID of the IPAM's default public scope.
    public_default_scope_id: ?[]const u8 = null,

    /// The IPAM's resource discovery association count.
    resource_discovery_association_count: ?i32 = null,
