...
pub const GetCapacityManagerMetricDataOutput = struct {
    ...
    pub fn deinit(self: *const GetCapacityManagerMetricDataOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetCapacityManagerMetricDataOutput {
    _ = status;
    var result: GetCapacityManagerMetricDataOutput = .{ .allocator = alloc };
