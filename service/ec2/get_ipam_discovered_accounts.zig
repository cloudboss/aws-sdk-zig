...
pub const GetIpamDiscoveredAccountsOutput = struct {
    ...
    pub fn deinit(self: *const GetIpamDiscoveredAccountsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetIpamDiscoveredAccountsOutput {
    _ = status;
    var result: GetIpamDiscoveredAccountsOutput = .{ .allocator = alloc };
