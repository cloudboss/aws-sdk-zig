...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCapacityReservationFleetsInput, options: Options) !DescribeCapacityReservationFleetsOutput {
