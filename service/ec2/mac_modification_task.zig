...
pub const MacModificationTask = struct {
    ...
    /// The ID of task.
    mac_modification_task_id: ?[]const u8,

    /// [SIP modification tasks only] Information about the SIP
    /// configuration.
    mac_system_integrity_protection_config: ?MacSystemIntegrityProtectionConfiguration,
    ...
    task_state: ?MacModificationTaskState,

    /// The type of task.
    task_type: ?MacModificationTaskType,
};
