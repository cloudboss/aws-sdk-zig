...
pub const NetworkInfo = struct {
    ...
    /// instance type, if
    /// supported.
    bandwidth_weightings: ?[]const BandwidthWeightingType,

    /// The index of the default network card, starting at 0.
    default_network_card_index: ?i32,
    ...
    flexible_ena_queues_support: ?FlexibleEnaQueuesSupport,

    /// The maximum number of IPv4 addresses per network interface.
    ipv_4_addresses_per_interface: ?i32,

    /// The maximum number of IPv6 addresses per network interface.
    ipv_6_addresses_per_interface: ?i32,

    /// Indicates whether IPv6 is supported.
    ipv_6_supported: ?bool,

    /// The maximum number of physical network cards that can be allocated to the
    /// instance.
    maximum_network_cards: ?i32,

    /// The maximum number of network interfaces for the instance type.
    maximum_network_interfaces: ?i32,

    /// Describes the network cards for the instance type.
    network_cards: ?[]const NetworkCardInfo,
