...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyIpamPrefixListResolverInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyIpamPrefixListResolver&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyIpamPrefixListResolverOutput {
    _ = status;
    _ = headers;
