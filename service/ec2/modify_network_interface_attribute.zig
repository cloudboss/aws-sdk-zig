...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyNetworkInterfaceAttributeInput, options: Options) !ModifyNetworkInterfaceAttributeOutput {
