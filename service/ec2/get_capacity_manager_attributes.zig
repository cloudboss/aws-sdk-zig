...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCapacityManagerAttributesInput, options: CallOptions) !GetCapacityManagerAttributesOutput {
