...
pub fn execute(client: *Client, input: GetCapacityManagerAttributesInput, options: Options) !GetCapacityManagerAttributesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCapacityManagerAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetCapacityManagerAttributes&Version=2016-11-15");
    if (input.dry_run) |v| {
