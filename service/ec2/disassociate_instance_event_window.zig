...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateInstanceEventWindowInput, options: Options) !DisassociateInstanceEventWindowOutput {
