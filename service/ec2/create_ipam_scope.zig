...
pub const CreateIpamScopeInput = struct {
...
pub const CreateIpamScopeOutput = struct {
    /// Information about the created scope.
    ipam_scope: ?IpamScope = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateIpamScopeInput, options: CallOptions) !CreateIpamScopeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateIpamScopeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateIpamScope&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateIpamScopeOutput {
    _ = status;
    _ = headers;
