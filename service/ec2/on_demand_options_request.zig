...
pub const OnDemandOptionsRequest = struct {
    ...
    capacity_reservation_options: ?CapacityReservationOptionsRequest = null,
    ...
    /// than what you
    /// specified for `MaxTotalPrice`. For more information, see [Surplus credits
    /// can incur
    /// charges](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances-unlimited-mode-concepts.html#unlimited-mode-surplus-credits) in the *Amazon EC2 User Guide*.
