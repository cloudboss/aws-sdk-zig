...
pub fn execute(client: *Client, input: GetRouteServerAssociationsInput, options: Options) !GetRouteServerAssociationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetRouteServerAssociationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetRouteServerAssociations&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetRouteServerAssociationsOutput {
    _ = status;
    _ = body;
