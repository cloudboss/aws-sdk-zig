...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyTrafficMirrorFilterRuleInput, options: CallOptions) !ModifyTrafficMirrorFilterRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyTrafficMirrorFilterRuleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyTrafficMirrorFilterRule&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyTrafficMirrorFilterRuleOutput {
    _ = status;
    _ = headers;
