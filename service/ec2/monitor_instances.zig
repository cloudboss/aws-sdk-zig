...
pub fn execute(client: *Client, input: MonitorInstancesInput, options: Options) !MonitorInstancesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: MonitorInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=MonitorInstances&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !MonitorInstancesOutput {
    _ = status;
    _ = body;
