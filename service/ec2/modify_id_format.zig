...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyIdFormatInput, options: CallOptions) !ModifyIdFormatOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyIdFormatInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyIdFormat&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyIdFormatOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
