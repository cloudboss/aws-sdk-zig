...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyIpamPrefixListResolverTargetInput, options: CallOptions) !ModifyIpamPrefixListResolverTargetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyIpamPrefixListResolverTargetInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyIpamPrefixListResolverTarget&Version=2016-11-15");
    ...
    try body_buf.appendSlice(allocator, "&IpamPrefixListResolverTargetId=");
    try aws.url.appendUrlEncoded(allocator, &body_buf, input.ipam_prefix_list_resolver_target_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyIpamPrefixListResolverTargetOutput {
    _ = status;
    _ = headers;
