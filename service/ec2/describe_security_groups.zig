...
pub const DescribeSecurityGroupsOutput = struct {
    ...
    pub fn deinit(self: *const DescribeSecurityGroupsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeSecurityGroupsOutput {
    _ = status;
    var result: DescribeSecurityGroupsOutput = .{ .allocator = alloc };
