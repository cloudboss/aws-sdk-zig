...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateSecurityGroupVpcInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AssociateSecurityGroupVpc&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateSecurityGroupVpcOutput {
    _ = status;
    _ = headers;
    _ = allocator;
