...
pub const DeleteVpnConnectionRouteOutput = struct {
    ...
    pub fn deinit(self: *DeleteVpnConnectionRouteOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteVpnConnectionRouteInput, options: Options) !DeleteVpnConnectionRouteOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVpnConnectionRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteVpnConnectionRoute&Version=2016-11-15");
