...
pub const ServiceLinkVirtualInterface = struct {
    ...
    configuration_state: ?ServiceLinkVirtualInterfaceConfigurationState = null,
    ...
    peer_bgp_asn: ?i64 = null,

    /// The Amazon Resource Number (ARN) for the service link virtual interface.
    service_link_virtual_interface_arn: ?[]const u8 = null,

    /// The ID of the service link virtual interface.
    service_link_virtual_interface_id: ?[]const u8 = null,
