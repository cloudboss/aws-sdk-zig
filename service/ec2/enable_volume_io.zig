...
pub const EnableVolumeIOOutput = struct {
    ...
    pub fn deinit(self: *EnableVolumeIOOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: EnableVolumeIOInput, options: Options) !EnableVolumeIOOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableVolumeIOInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableVolumeIO&Version=2016-11-15");
    if (input.dry_run) |v| {
