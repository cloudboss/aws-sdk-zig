...
pub const AssociateTransitGatewayMulticastDomainOutput = struct {
    ...
    pub fn deinit(self: *const AssociateTransitGatewayMulticastDomainOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AssociateTransitGatewayMulticastDomainInput, options: Options) !AssociateTransitGatewayMulticastDomainOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateTransitGatewayMulticastDomainInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateTransitGatewayMulticastDomain&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateTransitGatewayMulticastDomainOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: AssociateTransitGatewayMulticastDomainOutput = .{ .allocator = alloc };
