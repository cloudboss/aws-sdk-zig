...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateInterruptibleCapacityReservationAllocationInput, options: Options) !UpdateInterruptibleCapacityReservationAllocationOutput {
