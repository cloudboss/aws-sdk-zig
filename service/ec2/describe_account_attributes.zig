...
pub const DescribeAccountAttributesOutput = struct {
    ...
    pub fn deinit(self: *const DescribeAccountAttributesOutput) void {
        _ = self;
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeAccountAttributesOutput {
    _ = status;
    _ = body;
    const result: DescribeAccountAttributesOutput = .{ .allocator = alloc };
