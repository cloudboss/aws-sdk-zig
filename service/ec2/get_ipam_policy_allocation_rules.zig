...
pub const GetIpamPolicyAllocationRulesOutput = struct {
    ...
    pub fn deinit(self: *const GetIpamPolicyAllocationRulesOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetIpamPolicyAllocationRulesOutput {
    _ = status;
    var result: GetIpamPolicyAllocationRulesOutput = .{ .allocator = alloc };
