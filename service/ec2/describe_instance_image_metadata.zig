...
pub const DescribeInstanceImageMetadataOutput = struct {
    ...
    pub fn deinit(self: *DescribeInstanceImageMetadataOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DescribeInstanceImageMetadataInput, options: Options) !DescribeInstanceImageMetadataOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeInstanceImageMetadataInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeInstanceImageMetadata&Version=2016-11-15");
    if (input.dry_run) |v| {
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "instanceImageMetadataSet")) {
                    result.instance_image_metadata = try serde.deserializeInstanceImageMetadataList(&reader, alloc, "item");
