...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTransitGatewayPolicyTableInput, options: Options) !CreateTransitGatewayPolicyTableOutput {
