...
pub fn execute(client: *Client, input: CreateTransitGatewayPolicyTableInput, options: Options) !CreateTransitGatewayPolicyTableOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTransitGatewayPolicyTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateTransitGatewayPolicyTable&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateTransitGatewayPolicyTableOutput {
    _ = status;
    _ = body;
