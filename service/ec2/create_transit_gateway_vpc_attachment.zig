...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTransitGatewayVpcAttachmentInput, options: Options) !CreateTransitGatewayVpcAttachmentOutput {
