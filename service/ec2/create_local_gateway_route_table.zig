...
pub const CreateLocalGatewayRouteTableInput = struct {
    ...
    mode: ?LocalGatewayRouteTableMode = null,

    /// The tags assigned to the local gateway route table.
    tag_specifications: ?[]const TagSpecification = null,
};

pub const CreateLocalGatewayRouteTableOutput = struct {
    /// Information about the local gateway route table.
    local_gateway_route_table: ?LocalGatewayRouteTable = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateLocalGatewayRouteTableInput, options: CallOptions) !CreateLocalGatewayRouteTableOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateLocalGatewayRouteTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateLocalGatewayRouteTable&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateLocalGatewayRouteTableOutput {
    _ = status;
    _ = headers;
