...
pub fn execute(client: *Client, input: DisassociateIpamByoasnInput, options: Options) !DisassociateIpamByoasnOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateIpamByoasnInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DisassociateIpamByoasn&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DisassociateIpamByoasnOutput {
    _ = status;
    _ = body;
