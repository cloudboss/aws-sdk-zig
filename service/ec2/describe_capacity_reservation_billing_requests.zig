...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCapacityReservationBillingRequestsInput, options: Options) !DescribeCapacityReservationBillingRequestsOutput {
