...
pub fn execute(client: *Client, input: ReplaceRouteTableAssociationInput, options: Options) !ReplaceRouteTableAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ReplaceRouteTableAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ReplaceRouteTableAssociation&Version=2016-11-15");
