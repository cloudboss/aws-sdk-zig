...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestoreSnapshotFromRecycleBinInput, options: CallOptions) !RestoreSnapshotFromRecycleBinOutput {
