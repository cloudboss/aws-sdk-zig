...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateInstanceConnectEndpointInput, options: CallOptions) !CreateInstanceConnectEndpointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateInstanceConnectEndpointInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateInstanceConnectEndpoint&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateInstanceConnectEndpointOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "clientToken")) {
                    ...
                    result.instance_connect_endpoint = try serde.deserializeEc2InstanceConnectEndpoint(allocator, &reader);
                } else {
