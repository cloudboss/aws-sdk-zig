...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHostReservationPurchasePreviewInput, options: Options) !GetHostReservationPurchasePreviewOutput {
