...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHostReservationPurchasePreviewInput, options: CallOptions) !GetHostReservationPurchasePreviewOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetHostReservationPurchasePreviewInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=GetHostReservationPurchasePreview&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetHostReservationPurchasePreviewOutput {
    _ = status;
    _ = headers;
