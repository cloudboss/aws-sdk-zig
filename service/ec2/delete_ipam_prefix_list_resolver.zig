...
pub fn execute(client: *Client, input: DeleteIpamPrefixListResolverInput, options: Options) !DeleteIpamPrefixListResolverOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIpamPrefixListResolverInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteIpamPrefixListResolver&Version=2016-11-15");
    if (input.dry_run) |v| {
