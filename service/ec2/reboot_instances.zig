...
pub const RebootInstancesOutput = struct {
    ...
    pub fn deinit(self: *RebootInstancesOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: RebootInstancesInput, options: Options) !RebootInstancesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RebootInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RebootInstances&Version=2016-11-15");
    if (input.dry_run) |v| {
