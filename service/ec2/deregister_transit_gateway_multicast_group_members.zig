...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterTransitGatewayMulticastGroupMembersInput, options: Options) !DeregisterTransitGatewayMulticastGroupMembersOutput {
