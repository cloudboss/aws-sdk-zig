...
pub fn execute(client: *Client, input: DeleteTransitGatewayPrefixListReferenceInput, options: Options) !DeleteTransitGatewayPrefixListReferenceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTransitGatewayPrefixListReferenceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteTransitGatewayPrefixListReference&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteTransitGatewayPrefixListReferenceOutput {
    _ = status;
    _ = body;
