...
pub const DeleteTransitGatewayPrefixListReferenceInput = struct {
...
pub const DeleteTransitGatewayPrefixListReferenceOutput = struct {
    /// Information about the deleted prefix list reference.
    transit_gateway_prefix_list_reference: ?TransitGatewayPrefixListReference = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTransitGatewayPrefixListReferenceInput, options: CallOptions) !DeleteTransitGatewayPrefixListReferenceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTransitGatewayPrefixListReferenceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteTransitGatewayPrefixListReference&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTransitGatewayPrefixListReferenceOutput {
    _ = status;
    _ = headers;
