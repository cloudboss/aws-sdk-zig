...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTransitGatewayPrefixListReferenceInput, options: Options) !DeleteTransitGatewayPrefixListReferenceOutput {
