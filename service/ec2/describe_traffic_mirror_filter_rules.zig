...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTrafficMirrorFilterRulesInput, options: Options) !DescribeTrafficMirrorFilterRulesOutput {
