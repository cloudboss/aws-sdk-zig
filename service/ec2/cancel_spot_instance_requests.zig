...
pub fn execute(client: *Client, input: CancelSpotInstanceRequestsInput, options: Options) !CancelSpotInstanceRequestsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelSpotInstanceRequestsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CancelSpotInstanceRequests&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CancelSpotInstanceRequestsOutput {
    _ = status;
    _ = body;
