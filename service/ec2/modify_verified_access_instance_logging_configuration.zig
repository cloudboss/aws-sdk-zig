...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVerifiedAccessInstanceLoggingConfigurationInput, options: Options) !ModifyVerifiedAccessInstanceLoggingConfigurationOutput {
