...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PurchaseReservedInstancesOfferingInput, options: CallOptions) !PurchaseReservedInstancesOfferingOutput {
