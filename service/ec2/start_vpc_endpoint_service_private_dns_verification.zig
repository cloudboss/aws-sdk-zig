...
pub const StartVpcEndpointServicePrivateDnsVerificationOutput = struct {
    ...
    pub fn deinit(self: *StartVpcEndpointServicePrivateDnsVerificationOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: StartVpcEndpointServicePrivateDnsVerificationInput, options: Options) !StartVpcEndpointServicePrivateDnsVerificationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartVpcEndpointServicePrivateDnsVerificationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StartVpcEndpointServicePrivateDnsVerification&Version=2016-11-15");
    if (input.dry_run) |v| {
