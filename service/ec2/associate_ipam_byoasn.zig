...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateIpamByoasnInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateIpamByoasn&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !AssociateIpamByoasnOutput {
    _ = status;
    _ = body;
