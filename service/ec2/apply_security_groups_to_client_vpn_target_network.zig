...
pub fn execute(client: *Client, input: ApplySecurityGroupsToClientVpnTargetNetworkInput, options: Options) !ApplySecurityGroupsToClientVpnTargetNetworkOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ApplySecurityGroupsToClientVpnTargetNetworkInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ApplySecurityGroupsToClientVpnTargetNetwork&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ApplySecurityGroupsToClientVpnTargetNetworkOutput {
    _ = status;
    _ = body;
