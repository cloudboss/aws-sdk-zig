...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateReservedInstancesListingInput, options: Options) !CreateReservedInstancesListingOutput {
