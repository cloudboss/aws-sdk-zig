...
pub fn execute(client: *Client, input: DeprovisionByoipCidrInput, options: Options) !DeprovisionByoipCidrOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeprovisionByoipCidrInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeprovisionByoipCidr&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeprovisionByoipCidrOutput {
    _ = status;
    _ = body;
