...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyInstanceNetworkPerformanceOptionsInput, options: CallOptions) !ModifyInstanceNetworkPerformanceOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyInstanceNetworkPerformanceOptionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyInstanceNetworkPerformanceOptionsOutput {
    _ = status;
    _ = headers;
