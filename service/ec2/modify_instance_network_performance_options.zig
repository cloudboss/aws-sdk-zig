...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyInstanceNetworkPerformanceOptionsInput, options: Options) !ModifyInstanceNetworkPerformanceOptionsOutput {
