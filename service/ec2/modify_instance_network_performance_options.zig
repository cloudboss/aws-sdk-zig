...
pub const ModifyInstanceNetworkPerformanceOptionsOutput = struct {
    ...
    pub fn deinit(self: *const ModifyInstanceNetworkPerformanceOptionsOutput) void {
...
pub fn execute(client: *Client, input: ModifyInstanceNetworkPerformanceOptionsInput, options: Options) !ModifyInstanceNetworkPerformanceOptionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyInstanceNetworkPerformanceOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyInstanceNetworkPerformanceOptions&Version=2016-11-15");
    try body_buf.appendSlice(alloc, "&BandwidthWeighting=");
    try appendUrlEncoded(alloc, &body_buf, @tagName(input.bandwidth_weighting));
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyInstanceNetworkPerformanceOptionsOutput {
    _ = status;
    _ = headers;
    var result: ModifyInstanceNetworkPerformanceOptionsOutput = .{ .allocator = alloc };
