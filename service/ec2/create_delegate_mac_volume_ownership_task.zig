...
pub const CreateDelegateMacVolumeOwnershipTaskOutput = struct {
    ...
    pub fn deinit(self: *const CreateDelegateMacVolumeOwnershipTaskOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: CreateDelegateMacVolumeOwnershipTaskInput, options: Options) !CreateDelegateMacVolumeOwnershipTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateDelegateMacVolumeOwnershipTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateDelegateMacVolumeOwnershipTask&Version=2016-11-15");
    ...
    try appendUrlEncoded(alloc, &body_buf, input.mac_credentials);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateDelegateMacVolumeOwnershipTaskOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: CreateDelegateMacVolumeOwnershipTaskOutput = .{ .allocator = alloc };
