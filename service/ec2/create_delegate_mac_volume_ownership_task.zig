...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDelegateMacVolumeOwnershipTaskInput, options: Options) !CreateDelegateMacVolumeOwnershipTaskOutput {
