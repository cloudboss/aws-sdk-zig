...
pub const CapacityManagerDimension = struct {
    ...
    instance_platform: ?[]const u8 = null,
    ...
    reservation_create_timestamp: ?i64 = null,
    ...
    /// termination pattern.
    reservation_end_date_type: ?ReservationEndDateType = null,
    ...
    reservation_end_timestamp: ?i64 = null,
    ...
    reservation_instance_match_criteria: ?[]const u8 = null,
    ...
    /// providing capacity.
    reservation_start_timestamp: ?i64 = null,
    ...
    reservation_unused_financial_owner: ?[]const u8 = null,
