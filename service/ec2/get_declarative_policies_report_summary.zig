...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDeclarativePoliciesReportSummaryInput, options: Options) !GetDeclarativePoliciesReportSummaryOutput {
