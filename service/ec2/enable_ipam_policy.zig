...
pub fn execute(client: *Client, input: EnableIpamPolicyInput, options: Options) !EnableIpamPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableIpamPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableIpamPolicy&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !EnableIpamPolicyOutput {
    _ = status;
