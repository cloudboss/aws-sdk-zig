...
pub fn execute(client: *Client, input: DescribeVolumeAttributeInput, options: Options) !DescribeVolumeAttributeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeVolumeAttributeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeVolumeAttribute&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeVolumeAttributeOutput {
    _ = status;
