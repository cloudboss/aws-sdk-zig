...
pub const RejectVpcEndpointConnectionsOutput = struct {
    ...
    pub fn deinit(self: *RejectVpcEndpointConnectionsOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: RejectVpcEndpointConnectionsInput, options: Options) !RejectVpcEndpointConnectionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RejectVpcEndpointConnectionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RejectVpcEndpointConnections&Version=2016-11-15");
    if (input.dry_run) |v| {
