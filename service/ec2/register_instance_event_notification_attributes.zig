...
pub fn execute(client: *Client, input: RegisterInstanceEventNotificationAttributesInput, options: Options) !RegisterInstanceEventNotificationAttributesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RegisterInstanceEventNotificationAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RegisterInstanceEventNotificationAttributes&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !RegisterInstanceEventNotificationAttributesOutput {
    _ = status;
    _ = body;
