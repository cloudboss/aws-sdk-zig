...
pub const DescribeInstanceStatusOutput = struct {
    ...
    pub fn deinit(self: *const DescribeInstanceStatusOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeInstanceStatusOutput {
    _ = status;
    var result: DescribeInstanceStatusOutput = .{ .allocator = alloc };
