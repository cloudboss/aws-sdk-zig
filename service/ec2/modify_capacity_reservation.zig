...
const ModifyCapacityReservationInput = @import("modify_capacity_reservation_request.zig").ModifyCapacityReservationRequest;

const ModifyCapacityReservationOutput = @import("modify_capacity_reservation_result.zig").ModifyCapacityReservationResult;
