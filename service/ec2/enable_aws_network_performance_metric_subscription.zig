...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableAwsNetworkPerformanceMetricSubscriptionInput, options: CallOptions) !EnableAwsNetworkPerformanceMetricSubscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: EnableAwsNetworkPerformanceMetricSubscriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=EnableAwsNetworkPerformanceMetricSubscription&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !EnableAwsNetworkPerformanceMetricSubscriptionOutput {
    _ = status;
    _ = headers;
    _ = allocator;
