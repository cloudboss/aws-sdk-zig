...
pub const EnableAwsNetworkPerformanceMetricSubscriptionOutput = struct {
    ...
    pub fn deinit(self: *const EnableAwsNetworkPerformanceMetricSubscriptionOutput) void {
        _ = self;
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !EnableAwsNetworkPerformanceMetricSubscriptionOutput {
    _ = status;
    var result: EnableAwsNetworkPerformanceMetricSubscriptionOutput = .{ .allocator = alloc };
