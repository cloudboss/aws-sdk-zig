...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVerifiedAccessGroupPolicyInput, options: Options) !ModifyVerifiedAccessGroupPolicyOutput {
