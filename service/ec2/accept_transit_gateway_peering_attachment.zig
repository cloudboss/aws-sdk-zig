...
pub const AcceptTransitGatewayPeeringAttachmentOutput = struct {
    ...
    pub fn deinit(self: *AcceptTransitGatewayPeeringAttachmentOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: AcceptTransitGatewayPeeringAttachmentInput, options: Options) !AcceptTransitGatewayPeeringAttachmentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AcceptTransitGatewayPeeringAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AcceptTransitGatewayPeeringAttachment&Version=2016-11-15");
    if (input.dry_run) |v| {
