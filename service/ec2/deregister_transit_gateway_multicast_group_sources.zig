...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterTransitGatewayMulticastGroupSourcesInput, options: CallOptions) !DeregisterTransitGatewayMulticastGroupSourcesOutput {
