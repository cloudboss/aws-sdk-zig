...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIpamDiscoveredResourceCidrsInput, options: Options) !GetIpamDiscoveredResourceCidrsOutput {
