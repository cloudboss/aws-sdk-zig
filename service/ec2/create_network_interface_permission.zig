...
pub fn execute(client: *Client, input: CreateNetworkInterfacePermissionInput, options: Options) !CreateNetworkInterfacePermissionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateNetworkInterfacePermissionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateNetworkInterfacePermission&Version=2016-11-15");
    ...
    try aws.url.appendUrlEncoded(alloc, &body_buf, @tagName(input.permission));
