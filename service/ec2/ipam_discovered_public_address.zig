...
pub const IpamDiscoveredPublicAddress = struct {
    ...
    address_allocation_id: ?[]const u8 = null,

    /// The ID of the owner of the resource the IP address is assigned to.
    address_owner_id: ?[]const u8 = null,

    /// The Region of the resource the IP address is assigned to.
    address_region: ?[]const u8 = null,

    /// The IP address type.
    address_type: ?IpamPublicAddressType = null,

    /// The association status.
    association_status: ?IpamPublicAddressAssociationStatus = null,
    ...
    network_interface_description: ?[]const u8 = null,
    ...
    /// address is from.
    public_ipv_4_pool_id: ?[]const u8 = null,
    ...
    /// to.
    security_groups: ?[]const IpamPublicAddressSecurityGroup = null,

    /// The Amazon Web Services service associated with the IP address.
    service: ?IpamPublicAddressAwsService = null,

    /// The resource ARN or ID.
    service_resource: ?[]const u8 = null,
