...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeprovisionPublicIpv4PoolCidrInput, options: CallOptions) !DeprovisionPublicIpv4PoolCidrOutput {
