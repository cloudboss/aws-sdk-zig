...
pub const ClientVpnConnection = struct {
    ...
    /// connectivity.
    client_ipv_6_address: ?[]const u8 = null,
    ...
    connection_end_time: ?[]const u8 = null,

    /// The date and time the client connection was established.
    connection_established_time: ?[]const u8 = null,

    /// The ID of the client connection.
    connection_id: ?[]const u8 = null,

    /// The number of bytes received by the client.
    egress_bytes: ?[]const u8 = null,

    /// The number of packets received by the client.
    egress_packets: ?[]const u8 = null,

    /// The number of bytes sent by the client.
    ingress_bytes: ?[]const u8 = null,

    /// The number of packets sent by the client.
    ingress_packets: ?[]const u8 = null,

    /// The statuses returned by the client connect handler for posture compliance,
    /// if applicable.
    posture_compliance_statuses: ?[]const []const u8 = null,
