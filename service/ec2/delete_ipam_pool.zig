...
pub fn execute(client: *Client, input: DeleteIpamPoolInput, options: Options) !DeleteIpamPoolOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIpamPoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteIpamPool&Version=2016-11-15");
    if (input.cascade) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteIpamPoolOutput {
    _ = status;
    _ = body;
