...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableVgwRoutePropagationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableVgwRoutePropagation&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !EnableVgwRoutePropagationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
