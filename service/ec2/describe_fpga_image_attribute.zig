...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeFpgaImageAttributeInput, options: CallOptions) !DescribeFpgaImageAttributeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeFpgaImageAttributeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeFpgaImageAttribute&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeFpgaImageAttributeOutput {
    _ = status;
    _ = headers;
