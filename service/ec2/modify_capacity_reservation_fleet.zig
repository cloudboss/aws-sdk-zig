...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyCapacityReservationFleetInput, options: Options) !ModifyCapacityReservationFleetOutput {
