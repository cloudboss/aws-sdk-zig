...
pub const DeleteVpcEndpointsOutput = struct {
    ...
    pub fn deinit(self: *DeleteVpcEndpointsOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteVpcEndpointsInput, options: Options) !DeleteVpcEndpointsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVpcEndpointsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteVpcEndpoints&Version=2016-11-15");
    if (input.dry_run) |v| {
