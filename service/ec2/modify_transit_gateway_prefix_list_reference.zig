...
pub const ModifyTransitGatewayPrefixListReferenceOutput = struct {
    /// Information about the prefix list reference.
    transit_gateway_prefix_list_reference: ?TransitGatewayPrefixListReference = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyTransitGatewayPrefixListReferenceInput, options: CallOptions) !ModifyTransitGatewayPrefixListReferenceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyTransitGatewayPrefixListReferenceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyTransitGatewayPrefixListReference&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyTransitGatewayPrefixListReferenceOutput {
    _ = status;
    _ = headers;
