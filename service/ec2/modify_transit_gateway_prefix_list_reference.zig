...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyTransitGatewayPrefixListReferenceInput, options: Options) !ModifyTransitGatewayPrefixListReferenceOutput {
