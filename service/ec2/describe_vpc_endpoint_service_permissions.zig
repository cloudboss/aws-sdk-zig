...
pub const DescribeVpcEndpointServicePermissionsOutput = struct {
    ...
    pub fn deinit(self: *const DescribeVpcEndpointServicePermissionsOutput) void {
...
pub fn execute(client: *Client, input: DescribeVpcEndpointServicePermissionsInput, options: Options) !DescribeVpcEndpointServicePermissionsOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeVpcEndpointServicePermissionsOutput {
    _ = status;
    var result: DescribeVpcEndpointServicePermissionsOutput = .{ .allocator = alloc };
