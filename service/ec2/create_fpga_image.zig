...
pub fn execute(client: *Client, input: CreateFpgaImageInput, options: Options) !CreateFpgaImageOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateFpgaImageOutput {
    _ = status;
