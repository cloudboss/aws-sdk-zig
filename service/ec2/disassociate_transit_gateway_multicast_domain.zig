...
pub fn execute(client: *Client, input: DisassociateTransitGatewayMulticastDomainInput, options: Options) !DisassociateTransitGatewayMulticastDomainOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateTransitGatewayMulticastDomainInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DisassociateTransitGatewayMulticastDomain&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DisassociateTransitGatewayMulticastDomainOutput {
    _ = status;
    _ = body;
