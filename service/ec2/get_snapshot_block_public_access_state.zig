...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSnapshotBlockPublicAccessStateInput, options: Options) !GetSnapshotBlockPublicAccessStateOutput {
