...
pub fn execute(client: *Client, input: ExportClientVpnClientCertificateRevocationListInput, options: Options) !ExportClientVpnClientCertificateRevocationListOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ExportClientVpnClientCertificateRevocationListInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ExportClientVpnClientCertificateRevocationList&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ExportClientVpnClientCertificateRevocationListOutput {
    _ = status;
