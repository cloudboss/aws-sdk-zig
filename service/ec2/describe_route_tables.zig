...
pub const DescribeRouteTablesOutput = struct {
    ...
    pub fn deinit(self: *const DescribeRouteTablesOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeRouteTablesOutput {
    _ = status;
    var result: DescribeRouteTablesOutput = .{ .allocator = alloc };
