...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyVpnConnectionInput, options: CallOptions) !ModifyVpnConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyVpnConnectionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyVpnConnection&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyVpnConnectionOutput {
    _ = status;
    _ = headers;
