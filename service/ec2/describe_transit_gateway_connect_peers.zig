...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTransitGatewayConnectPeersInput, options: Options) !DescribeTransitGatewayConnectPeersOutput {
