...
pub const DescribeTransitGatewayConnectPeersOutput = struct {
    ...
    pub fn deinit(self: *const DescribeTransitGatewayConnectPeersOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeTransitGatewayConnectPeersOutput {
    _ = status;
    var result: DescribeTransitGatewayConnectPeersOutput = .{ .allocator = alloc };
