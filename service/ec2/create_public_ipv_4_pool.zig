...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreatePublicIpv4PoolInput, options: Options) !CreatePublicIpv4PoolOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreatePublicIpv4PoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreatePublicIpv4Pool&Version=2016-11-15");
    if (input.dry_run) |v| {
