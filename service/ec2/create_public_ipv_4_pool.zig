...
pub const CreatePublicIpv4PoolOutput = struct {
    /// The ID of the public IPv4 pool.
    pool_id: ?[]const u8 = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreatePublicIpv4PoolInput, options: CallOptions) !CreatePublicIpv4PoolOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreatePublicIpv4PoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreatePublicIpv4Pool&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreatePublicIpv4PoolOutput {
    _ = status;
    _ = headers;
