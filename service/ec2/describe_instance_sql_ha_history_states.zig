...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInstanceSqlHaHistoryStatesInput, options: Options) !DescribeInstanceSqlHaHistoryStatesOutput {
