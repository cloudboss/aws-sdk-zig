...
pub const DescribeInstanceSqlHaHistoryStatesOutput = struct {
    ...
    pub fn deinit(self: *const DescribeInstanceSqlHaHistoryStatesOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeInstanceSqlHaHistoryStatesOutput {
    _ = status;
    var result: DescribeInstanceSqlHaHistoryStatesOutput = .{ .allocator = alloc };
