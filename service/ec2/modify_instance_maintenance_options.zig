...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyInstanceMaintenanceOptionsInput, options: CallOptions) !ModifyInstanceMaintenanceOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyInstanceMaintenanceOptionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyInstanceMaintenanceOptionsOutput {
    _ = status;
    _ = headers;
