...
pub const ModifyInstanceMaintenanceOptionsOutput = struct {
    ...
    pub fn deinit(self: *const ModifyInstanceMaintenanceOptionsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ModifyInstanceMaintenanceOptionsOutput {
    _ = status;
    var result: ModifyInstanceMaintenanceOptionsOutput = .{ .allocator = alloc };
