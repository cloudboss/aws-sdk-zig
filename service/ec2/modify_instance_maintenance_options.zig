...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyInstanceMaintenanceOptionsInput, options: Options) !ModifyInstanceMaintenanceOptionsOutput {
