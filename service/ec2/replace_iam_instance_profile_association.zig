...
pub fn execute(client: *Client, input: ReplaceIamInstanceProfileAssociationInput, options: Options) !ReplaceIamInstanceProfileAssociationOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ReplaceIamInstanceProfileAssociationOutput {
    _ = status;
    _ = body;
