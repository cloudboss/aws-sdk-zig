...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ReplaceIamInstanceProfileAssociationInput, options: CallOptions) !ReplaceIamInstanceProfileAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ReplaceIamInstanceProfileAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ReplaceIamInstanceProfileAssociation&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ReplaceIamInstanceProfileAssociationOutput {
    _ = status;
    _ = headers;
