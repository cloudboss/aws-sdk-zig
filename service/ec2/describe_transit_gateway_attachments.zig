...
pub const DescribeTransitGatewayAttachmentsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTransitGatewayAttachmentsInput, options: CallOptions) !DescribeTransitGatewayAttachmentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTransitGatewayAttachmentsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeTransitGatewayAttachments&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeTransitGatewayAttachmentsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "nextToken")) {
                    ...
                    result.transit_gateway_attachments = try serde.deserializeTransitGatewayAttachmentList(allocator, &reader, "item");
                } else {
