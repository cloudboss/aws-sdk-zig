...
pub const DescribeVolumesOutput = struct {
    ...
    pub fn deinit(self: *const DescribeVolumesOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeVolumesOutput {
    _ = status;
    var result: DescribeVolumesOutput = .{ .allocator = alloc };
