...
pub fn execute(client: *Client, input: DescribeFleetInstancesInput, options: Options) !DescribeFleetInstancesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeFleetInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeFleetInstances&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeFleetInstancesOutput {
    _ = status;
