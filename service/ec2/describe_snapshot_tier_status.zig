...
pub const DescribeSnapshotTierStatusOutput = struct {
    ...
    pub fn deinit(self: *DescribeSnapshotTierStatusOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DescribeSnapshotTierStatusInput, options: Options) !DescribeSnapshotTierStatusOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeSnapshotTierStatusInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeSnapshotTierStatus&Version=2016-11-15");
    if (input.dry_run) |v| {
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "nextToken")) {
                    ...
                    result.snapshot_tier_statuses = try serde.deserializesnapshotTierStatusSet(&reader, alloc, "item");
                } else {
