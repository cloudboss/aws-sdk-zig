...
pub fn execute(client: *Client, input: GetAssociatedIpv6PoolCidrsInput, options: Options) !GetAssociatedIpv6PoolCidrsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAssociatedIpv6PoolCidrsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetAssociatedIpv6PoolCidrs&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetAssociatedIpv6PoolCidrsOutput {
    _ = status;
