...
pub fn execute(client: *Client, input: GetAssociatedEnclaveCertificateIamRolesInput, options: Options) !GetAssociatedEnclaveCertificateIamRolesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAssociatedEnclaveCertificateIamRolesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetAssociatedEnclaveCertificateIamRoles&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetAssociatedEnclaveCertificateIamRolesOutput {
    _ = status;
    _ = body;
