...
pub const DeleteVerifiedAccessTrustProviderOutput = struct {
    ...
    pub fn deinit(self: *DeleteVerifiedAccessTrustProviderOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteVerifiedAccessTrustProviderInput, options: Options) !DeleteVerifiedAccessTrustProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVerifiedAccessTrustProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteVerifiedAccessTrustProvider&Version=2016-11-15");
