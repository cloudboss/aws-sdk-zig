...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelExportTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CancelExportTask&Version=2016-11-15");
    try body_buf.appendSlice(allocator, "&ExportTaskId=");
    try aws.url.appendUrlEncoded(allocator, &body_buf, input.export_task_id);
