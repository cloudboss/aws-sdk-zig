...
pub const AssociateIamInstanceProfileOutput = struct {
    /// Information about the IAM instance profile association.
    iam_instance_profile_association: ?IamInstanceProfileAssociation = null,

    allocator: std.mem.Allocator,

    pub fn deinit(self: *const AssociateIamInstanceProfileOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AssociateIamInstanceProfileInput, options: Options) !AssociateIamInstanceProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateIamInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateIamInstanceProfile&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateIamInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: AssociateIamInstanceProfileOutput = .{ .allocator = alloc };
