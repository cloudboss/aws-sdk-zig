...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateIamInstanceProfileInput, options: CallOptions) !AssociateIamInstanceProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateIamInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AssociateIamInstanceProfile&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateIamInstanceProfileOutput {
    _ = status;
    _ = headers;
