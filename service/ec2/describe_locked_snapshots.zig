...
pub fn execute(client: *Client, input: DescribeLockedSnapshotsInput, options: Options) !DescribeLockedSnapshotsOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeLockedSnapshotsOutput {
    _ = status;
