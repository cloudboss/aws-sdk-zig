...
pub const UpdateSecurityGroupRuleDescriptionsEgressOutput = struct {
    ...
    pub fn deinit(self: *const UpdateSecurityGroupRuleDescriptionsEgressOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: UpdateSecurityGroupRuleDescriptionsEgressInput, options: Options) !UpdateSecurityGroupRuleDescriptionsEgressOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !UpdateSecurityGroupRuleDescriptionsEgressOutput {
    _ = status;
    var result: UpdateSecurityGroupRuleDescriptionsEgressOutput = .{ .allocator = alloc };
