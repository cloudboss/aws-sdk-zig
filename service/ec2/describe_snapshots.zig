...
pub const DescribeSnapshotsOutput = struct {
    ...
    pub fn deinit(self: *const DescribeSnapshotsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeSnapshotsOutput {
    _ = status;
    var result: DescribeSnapshotsOutput = .{ .allocator = alloc };
