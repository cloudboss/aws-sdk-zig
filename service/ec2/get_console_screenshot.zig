...
pub const GetConsoleScreenshotOutput = struct {
    ...
    pub fn deinit(self: *const GetConsoleScreenshotOutput) void {
        if (self.image_data) |v| {
...
pub fn execute(client: *Client, input: GetConsoleScreenshotInput, options: Options) !GetConsoleScreenshotOutput {
