...
pub const UnassignPrivateIpAddressesOutput = struct {
    ...
    pub fn deinit(self: *const UnassignPrivateIpAddressesOutput) void {
        _ = self;
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !UnassignPrivateIpAddressesOutput {
    _ = status;
    _ = body;
    const result: UnassignPrivateIpAddressesOutput = .{ .allocator = alloc };
