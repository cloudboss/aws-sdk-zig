...
fn serializeRequest(alloc: std.mem.Allocator, input: StartNetworkInsightsAnalysisInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StartNetworkInsightsAnalysis&Version=2016-11-15");
    ...
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.network_insights_path_id);
