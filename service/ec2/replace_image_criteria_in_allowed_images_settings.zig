...
pub const ReplaceImageCriteriaInAllowedImagesSettingsOutput = struct {
    ...
    pub fn deinit(self: *const ReplaceImageCriteriaInAllowedImagesSettingsOutput) void {
        _ = self;
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ReplaceImageCriteriaInAllowedImagesSettingsOutput {
    _ = status;
    var result: ReplaceImageCriteriaInAllowedImagesSettingsOutput = .{ .allocator = alloc };
