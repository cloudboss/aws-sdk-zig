...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ReplaceImageCriteriaInAllowedImagesSettingsInput, options: Options) !ReplaceImageCriteriaInAllowedImagesSettingsOutput {
