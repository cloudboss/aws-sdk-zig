...
fn serializeRequest(alloc: std.mem.Allocator, input: ExportVerifiedAccessInstanceClientConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ExportVerifiedAccessInstanceClientConfiguration&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ExportVerifiedAccessInstanceClientConfigurationOutput {
    _ = status;
