...
pub fn execute(client: *Client, input: EnableIpamOrganizationAdminAccountInput, options: Options) !EnableIpamOrganizationAdminAccountOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableIpamOrganizationAdminAccountInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableIpamOrganizationAdminAccount&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !EnableIpamOrganizationAdminAccountOutput {
    _ = status;
