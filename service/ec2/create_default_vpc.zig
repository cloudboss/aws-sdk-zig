...
pub fn execute(client: *Client, input: CreateDefaultVpcInput, options: Options) !CreateDefaultVpcOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateDefaultVpcInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateDefaultVpc&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateDefaultVpcOutput {
    _ = status;
    _ = body;
