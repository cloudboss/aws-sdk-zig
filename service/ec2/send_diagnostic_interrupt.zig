...
fn serializeRequest(allocator: std.mem.Allocator, input: SendDiagnosticInterruptInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=SendDiagnosticInterrupt&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SendDiagnosticInterruptOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
