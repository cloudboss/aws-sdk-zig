...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCapacityManagerMetricDimensionsInput, options: Options) !GetCapacityManagerMetricDimensionsOutput {
