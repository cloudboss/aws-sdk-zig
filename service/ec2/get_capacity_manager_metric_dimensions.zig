...
pub const GetCapacityManagerMetricDimensionsOutput = struct {
    ...
    pub fn deinit(self: *const GetCapacityManagerMetricDimensionsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetCapacityManagerMetricDimensionsOutput {
    _ = status;
    var result: GetCapacityManagerMetricDimensionsOutput = .{ .allocator = alloc };
