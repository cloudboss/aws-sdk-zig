...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ReplaceTransitGatewayRouteInput, options: CallOptions) !ReplaceTransitGatewayRouteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ReplaceTransitGatewayRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ReplaceTransitGatewayRoute&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ReplaceTransitGatewayRouteOutput {
    _ = status;
    _ = headers;
