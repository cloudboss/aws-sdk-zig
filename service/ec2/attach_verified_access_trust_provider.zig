...
pub fn execute(client: *Client, input: AttachVerifiedAccessTrustProviderInput, options: Options) !AttachVerifiedAccessTrustProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AttachVerifiedAccessTrustProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AttachVerifiedAccessTrustProvider&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !AttachVerifiedAccessTrustProviderOutput {
    _ = status;
    _ = body;
