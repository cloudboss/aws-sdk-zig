...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetImageBlockPublicAccessStateInput, options: CallOptions) !GetImageBlockPublicAccessStateOutput {
