...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateInterruptibleCapacityReservationAllocationInput, options: CallOptions) !CreateInterruptibleCapacityReservationAllocationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateInterruptibleCapacityReservationAllocationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateInterruptibleCapacityReservationAllocation&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateInterruptibleCapacityReservationAllocationOutput {
    _ = status;
    _ = headers;
