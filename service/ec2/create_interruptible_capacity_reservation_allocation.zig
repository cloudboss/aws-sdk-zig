...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateInterruptibleCapacityReservationAllocationInput, options: Options) !CreateInterruptibleCapacityReservationAllocationOutput {
