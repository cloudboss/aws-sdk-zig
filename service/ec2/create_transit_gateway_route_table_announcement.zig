...
pub const CreateTransitGatewayRouteTableAnnouncementOutput = struct {
    ...
    pub fn deinit(self: *const CreateTransitGatewayRouteTableAnnouncementOutput) void {
        _ = self;
    }
};
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTransitGatewayRouteTableAnnouncementOutput {
    ...
    _ = headers;
    _ = body;
    const result: CreateTransitGatewayRouteTableAnnouncementOutput = .{ .allocator = alloc };
