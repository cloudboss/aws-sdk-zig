...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateInstanceEventWindowInput, options: CallOptions) !CreateInstanceEventWindowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateInstanceEventWindowInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateInstanceEventWindow&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateInstanceEventWindowOutput {
    _ = status;
    _ = headers;
