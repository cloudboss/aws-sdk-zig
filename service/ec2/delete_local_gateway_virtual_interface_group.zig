...
pub fn execute(client: *Client, input: DeleteLocalGatewayVirtualInterfaceGroupInput, options: Options) !DeleteLocalGatewayVirtualInterfaceGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLocalGatewayVirtualInterfaceGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteLocalGatewayVirtualInterfaceGroup&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteLocalGatewayVirtualInterfaceGroupOutput {
    _ = status;
    _ = body;
