...
pub fn execute(client: *Client, input: DescribeSpotFleetInstancesInput, options: Options) !DescribeSpotFleetInstancesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeSpotFleetInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeSpotFleetInstances&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeSpotFleetInstancesOutput {
    _ = status;
