...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCapacityBlocksInput, options: CallOptions) !DescribeCapacityBlocksOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCapacityBlocksInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeCapacityBlocks&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCapacityBlocksOutput {
    _ = status;
    _ = headers;
