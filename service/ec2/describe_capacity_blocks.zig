...
pub const DescribeCapacityBlocksOutput = struct {
    /// The Capacity Blocks.
    ...
    pub fn deinit(self: *const DescribeCapacityBlocksOutput) void {
...
pub fn execute(client: *Client, input: DescribeCapacityBlocksInput, options: Options) !DescribeCapacityBlocksOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeCapacityBlocksInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeCapacityBlocks&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeCapacityBlocksOutput {
    _ = status;
    _ = headers;
    var result: DescribeCapacityBlocksOutput = .{ .allocator = alloc };
