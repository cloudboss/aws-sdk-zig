...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateCapacityReservationBySplittingInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateCapacityReservationBySplitting&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateCapacityReservationBySplittingOutput {
    _ = status;
    _ = headers;
