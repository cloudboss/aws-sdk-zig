...
pub const CreateCapacityReservationBySplittingOutput = struct {
    ...
    pub fn deinit(self: *const CreateCapacityReservationBySplittingOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: CreateCapacityReservationBySplittingInput, options: Options) !CreateCapacityReservationBySplittingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateCapacityReservationBySplittingInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateCapacityReservationBySplitting&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateCapacityReservationBySplittingOutput {
    _ = status;
    _ = headers;
    var result: CreateCapacityReservationBySplittingOutput = .{ .allocator = alloc };
