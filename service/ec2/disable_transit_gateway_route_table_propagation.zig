...
pub fn execute(client: *Client, input: DisableTransitGatewayRouteTablePropagationInput, options: Options) !DisableTransitGatewayRouteTablePropagationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisableTransitGatewayRouteTablePropagationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DisableTransitGatewayRouteTablePropagation&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DisableTransitGatewayRouteTablePropagationOutput {
    _ = status;
    _ = body;
