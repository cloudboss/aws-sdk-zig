...
pub fn execute(client: *Client, input: GetDefaultCreditSpecificationInput, options: Options) !GetDefaultCreditSpecificationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetDefaultCreditSpecificationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetDefaultCreditSpecification&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetDefaultCreditSpecificationOutput {
    _ = status;
    _ = body;
