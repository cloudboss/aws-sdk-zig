...
pub const GetDefaultCreditSpecificationOutput = struct {
    /// The default credit option for CPU usage of the instance family.
    instance_family_credit_specification: ?InstanceFamilyCreditSpecification = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDefaultCreditSpecificationInput, options: CallOptions) !GetDefaultCreditSpecificationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDefaultCreditSpecificationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=GetDefaultCreditSpecification&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDefaultCreditSpecificationOutput {
    _ = status;
    _ = headers;
