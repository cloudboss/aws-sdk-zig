...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachVolumeInput, options: Options) !DetachVolumeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachVolumeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DetachVolume&Version=2016-11-15");
    if (input.device) |v| {
