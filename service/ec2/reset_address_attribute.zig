...
pub fn execute(client: *Client, input: ResetAddressAttributeInput, options: Options) !ResetAddressAttributeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ResetAddressAttributeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ResetAddressAttribute&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ResetAddressAttributeOutput {
    _ = status;
    _ = body;
