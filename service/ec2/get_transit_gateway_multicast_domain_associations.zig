...
pub const GetTransitGatewayMulticastDomainAssociationsOutput = struct {
    ...
    pub fn deinit(self: *const GetTransitGatewayMulticastDomainAssociationsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetTransitGatewayMulticastDomainAssociationsOutput {
    _ = status;
    var result: GetTransitGatewayMulticastDomainAssociationsOutput = .{ .allocator = alloc };
