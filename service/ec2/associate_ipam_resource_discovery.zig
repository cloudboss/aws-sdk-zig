...
pub const AssociateIpamResourceDiscoveryOutput = struct {
    ...
    pub fn deinit(self: *const AssociateIpamResourceDiscoveryOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AssociateIpamResourceDiscoveryInput, options: Options) !AssociateIpamResourceDiscoveryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateIpamResourceDiscoveryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateIpamResourceDiscovery&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateIpamResourceDiscoveryOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: AssociateIpamResourceDiscoveryOutput = .{ .allocator = alloc };
