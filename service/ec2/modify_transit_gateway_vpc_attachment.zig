...
pub const ModifyTransitGatewayVpcAttachmentOutput = struct {
    ...
    pub fn deinit(self: *const ModifyTransitGatewayVpcAttachmentOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: ModifyTransitGatewayVpcAttachmentInput, options: Options) !ModifyTransitGatewayVpcAttachmentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyTransitGatewayVpcAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyTransitGatewayVpcAttachment&Version=2016-11-15");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyTransitGatewayVpcAttachmentOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: ModifyTransitGatewayVpcAttachmentOutput = .{ .allocator = alloc };
