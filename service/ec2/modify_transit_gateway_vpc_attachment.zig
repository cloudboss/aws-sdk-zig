...
pub const ModifyTransitGatewayVpcAttachmentOutput = struct {
    /// Information about the modified attachment.
    transit_gateway_vpc_attachment: ?TransitGatewayVpcAttachment = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyTransitGatewayVpcAttachmentInput, options: CallOptions) !ModifyTransitGatewayVpcAttachmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyTransitGatewayVpcAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyTransitGatewayVpcAttachment&Version=2016-11-15");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyTransitGatewayVpcAttachmentOutput {
    _ = status;
    _ = headers;
    ...
    var result: ModifyTransitGatewayVpcAttachmentOutput = .{};
    while (try reader.next()) |event| {
        switch (event) {
            .element_start => |e| {
