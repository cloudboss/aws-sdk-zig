...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyTransitGatewayVpcAttachmentInput, options: Options) !ModifyTransitGatewayVpcAttachmentOutput {
