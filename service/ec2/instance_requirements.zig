...
/// the [launch instance
/// wizard](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-instance-wizard.html) or with the [RunInstances API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html), you
/// can't specify `InstanceRequirements`.
///
/// For more information, see [Create mixed instances group using
/// attribute-based instance type
/// selection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-mixed-instances-group-attribute-based-instance-type-selection.html) in
/// the *Amazon EC2 Auto Scaling User Guide*, and also [Specify attributes for
/// instance type selection for EC2 Fleet or Spot
...
pub const InstanceRequirements = struct {
    ...
    /// than an identified On-Demand price. The identified On-Demand price is the
    /// price of the
