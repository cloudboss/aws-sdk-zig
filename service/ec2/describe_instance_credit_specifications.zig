...
pub const DescribeInstanceCreditSpecificationsOutput = struct {
    ...
    pub fn deinit(self: *const DescribeInstanceCreditSpecificationsOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DescribeInstanceCreditSpecificationsOutput {
    _ = status;
    var result: DescribeInstanceCreditSpecificationsOutput = .{ .allocator = alloc };
