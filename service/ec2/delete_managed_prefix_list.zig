...
pub fn execute(client: *Client, input: DeleteManagedPrefixListInput, options: Options) !DeleteManagedPrefixListOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteManagedPrefixListInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteManagedPrefixList&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteManagedPrefixListOutput {
    _ = status;
    _ = body;
