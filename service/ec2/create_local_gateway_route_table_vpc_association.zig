...
pub fn execute(client: *Client, input: CreateLocalGatewayRouteTableVpcAssociationInput, options: Options) !CreateLocalGatewayRouteTableVpcAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateLocalGatewayRouteTableVpcAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateLocalGatewayRouteTableVpcAssociation&Version=2016-11-15");
    if (input.dry_run) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateLocalGatewayRouteTableVpcAssociationOutput {
    _ = status;
    _ = body;
