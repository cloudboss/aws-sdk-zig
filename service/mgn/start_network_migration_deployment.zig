...
pub const StartNetworkMigrationDeploymentInput = struct {
...
pub const StartNetworkMigrationDeploymentOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartNetworkMigrationDeploymentInput, options: CallOptions) !StartNetworkMigrationDeploymentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartNetworkMigrationDeploymentInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/network-migration/StartNetworkMigrationDeployment";
