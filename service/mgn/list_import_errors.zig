...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListImportErrorsInput, options: CallOptions) !ListImportErrorsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListImportErrorsInput, config: *aws.Config) !aws.http.Request {
