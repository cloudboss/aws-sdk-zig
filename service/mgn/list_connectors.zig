...
const ListConnectorsRequestFilters = @import("list_connectors_request_filters.zig").ListConnectorsRequestFilters;
const Connector = @import("connector.zig").Connector;

pub const ListConnectorsInput = struct {
    /// List Connectors Request filters.
    filters: ?ListConnectorsRequestFilters = null,
