...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTemplateActionsInput, options: CallOptions) !ListTemplateActionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTemplateActionsInput, config: *aws.Config) !aws.http.Request {
