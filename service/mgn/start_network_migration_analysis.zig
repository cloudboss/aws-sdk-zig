...
pub const StartNetworkMigrationAnalysisInput = struct {
...
pub const StartNetworkMigrationAnalysisOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartNetworkMigrationAnalysisInput, options: CallOptions) !StartNetworkMigrationAnalysisOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartNetworkMigrationAnalysisInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/network-migration/StartNetworkMigrationAnalysis";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartNetworkMigrationAnalysisOutput {
    var result: StartNetworkMigrationAnalysisOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(StartNetworkMigrationAnalysisOutput, body, allocator);
    }
    _ = status;
    _ = headers;
