...
pub const DisconnectFromServiceOutput = @import("source_server.zig").SourceServer;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisconnectFromServiceInput, options: CallOptions) !DisconnectFromServiceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisconnectFromServiceInput, config: *aws.Config) !aws.http.Request {
