...
const ListNetworkMigrationDeployerJobFilters = @import("list_network_migration_deployer_job_filters.zig").ListNetworkMigrationDeployerJobFilters;
const NetworkMigrationDeployerJobDetails = @import("network_migration_deployer_job_details.zig").NetworkMigrationDeployerJobDetails;

pub const ListNetworkMigrationDeploymentsInput = struct {
    /// Filters to apply when listing deployment jobs.
    filters: ?ListNetworkMigrationDeployerJobFilters = null,
...
pub const ListNetworkMigrationDeploymentsOutput = struct {
    /// A list of deployer job details.
    items: ?[]const NetworkMigrationDeployerJobDetails = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListNetworkMigrationDeploymentsInput, options: CallOptions) !ListNetworkMigrationDeploymentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListNetworkMigrationDeploymentsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/network-migration/ListNetworkMigrationDeployments";
