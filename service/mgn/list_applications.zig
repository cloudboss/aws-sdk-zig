...
const ListApplicationsRequestFilters = @import("list_applications_request_filters.zig").ListApplicationsRequestFilters;
...
pub const ListApplicationsInput = struct {
    ...
    filters: ?ListApplicationsRequestFilters = null,
