...
const ListNetworkMigrationCodeGenerationSegmentsFilters = @import("list_network_migration_code_generation_segments_filters.zig").ListNetworkMigrationCodeGenerationSegmentsFilters;
const NetworkMigrationCodeGenerationSegment = @import("network_migration_code_generation_segment.zig").NetworkMigrationCodeGenerationSegment;

pub const ListNetworkMigrationCodeGenerationSegmentsInput = struct {
    /// Filters to apply when listing code generation segments.
    filters: ?ListNetworkMigrationCodeGenerationSegmentsFilters = null,
...
pub const ListNetworkMigrationCodeGenerationSegmentsOutput = struct {
    /// A list of network migration code generation segments.
    items: ?[]const NetworkMigrationCodeGenerationSegment = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListNetworkMigrationCodeGenerationSegmentsInput, options: CallOptions) !ListNetworkMigrationCodeGenerationSegmentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListNetworkMigrationCodeGenerationSegmentsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/network-migration/ListNetworkMigrationCodeGenerationSegments";
