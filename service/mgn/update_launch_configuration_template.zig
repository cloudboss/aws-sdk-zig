...
const UpdateLaunchConfigurationTemplateOutput = @import("launch_configuration_template.zig").LaunchConfigurationTemplate;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateLaunchConfigurationTemplateInput, options: Options) !UpdateLaunchConfigurationTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateLaunchConfigurationTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateLaunchConfigurationTemplateOutput {
    var result: UpdateLaunchConfigurationTemplateOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateLaunchConfigurationTemplateOutput, body, alloc);
    }
    _ = status;
    _ = headers;
