...
pub const UpdateWaveOutput = @import("wave.zig").Wave;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateWaveInput, options: CallOptions) !UpdateWaveOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateWaveInput, config: *aws.Config) !aws.http.Request {
