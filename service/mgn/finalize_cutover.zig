...
pub const FinalizeCutoverOutput = @import("source_server.zig").SourceServer;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: FinalizeCutoverInput, options: CallOptions) !FinalizeCutoverOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: FinalizeCutoverInput, config: *aws.Config) !aws.http.Request {
