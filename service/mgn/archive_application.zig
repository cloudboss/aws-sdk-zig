...
pub const ArchiveApplicationOutput = @import("application.zig").Application;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ArchiveApplicationInput, options: CallOptions) !ArchiveApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ArchiveApplicationInput, config: *aws.Config) !aws.http.Request {
