...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSecurityControlDefinitionsInput, options: CallOptions) !ListSecurityControlDefinitionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSecurityControlDefinitionsInput, config: *aws.Config) !aws.http.Request {
