...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeActionTargetsInput, options: CallOptions) !DescribeActionTargetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeActionTargetsInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.action_target_arns) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"ActionTargetArns\":");
