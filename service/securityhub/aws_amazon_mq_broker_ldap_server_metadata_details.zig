...
pub const AwsAmazonMqBrokerLdapServerMetadataDetails = struct {
    ...
    role_search_matching: ?[]const u8 = null,
    ...
    user_search_matching: ?[]const u8 = null,
