...
pub const AwsRdsDbInstanceDetails = struct {
    ...
    /// instance.
    associated_roles: ?[]const AwsRdsDbInstanceAssociatedRole,
    ...
    db_parameter_groups: ?[]const AwsRdsDbParameterGroup,

    /// A list of the DB security groups to assign to the DB instance.
    db_security_groups: ?[]const []const u8,

    /// Information about the subnet group that is associated with the DB instance.
    db_subnet_group: ?AwsRdsDbSubnetGroup,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    latest_restorable_time: ?[]const u8,

    /// License model information for this DB instance.
    license_model: ?[]const u8,

    listener_endpoint: ?AwsRdsDbInstanceEndpoint,
    ...
    option_group_memberships: ?[]const AwsRdsDbOptionGroupMembership,

    /// Changes to the DB instance that are currently pending.
    pending_modified_values: ?AwsRdsDbPendingModifiedValues,
    ...
    /// empty.
    status_infos: ?[]const AwsRdsDbStatusInfo,
