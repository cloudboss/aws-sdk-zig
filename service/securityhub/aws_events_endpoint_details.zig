...
pub const AwsEventsEndpointDetails = struct {
    ...
    event_buses: ?[]const AwsEventsEndpointEventBusesDetails,
    ...
    replication_config: ?AwsEventsEndpointReplicationConfigDetails,

    /// The ARN of the role used by event replication for the endpoint.
    role_arn: ?[]const u8,

    /// The routing configuration of the endpoint.
    routing_config: ?AwsEventsEndpointRoutingConfigDetails,
