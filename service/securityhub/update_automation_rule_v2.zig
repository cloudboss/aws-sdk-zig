...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAutomationRuleV2Input, options: Options) !UpdateAutomationRuleV2Output {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateAutomationRuleV2Input, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateAutomationRuleV2Output {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
