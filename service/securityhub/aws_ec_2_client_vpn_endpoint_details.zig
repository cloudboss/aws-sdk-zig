...
pub const AwsEc2ClientVpnEndpointDetails = struct {
    ...
    authentication_options: ?[]const AwsEc2ClientVpnEndpointAuthenticationOptionsDetails,
    ...
    /// connections.
    client_connect_options: ?AwsEc2ClientVpnEndpointClientConnectOptionsDetails,

    /// Options for enabling a customizable text banner that will be displayed on
    /// Amazon Web Services provided clients when a
    /// VPN session is established.
    client_login_banner_options: ?AwsEc2ClientVpnEndpointClientLoginBannerOptionsDetails,
    ...
    /// endpoint.
    connection_log_options: ?AwsEc2ClientVpnEndpointConnectionLogOptionsDetails,

    /// A brief description of the endpoint.
    description: ?[]const u8,

    /// Information about the DNS servers to be used for DNS resolution.
    dns_server: ?[]const []const u8,
