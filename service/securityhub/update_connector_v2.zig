...
pub const UpdateConnectorV2Input = struct {
    ...
    provider: ?ProviderUpdateConfiguration = null,
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateConnectorV2Input, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateConnectorV2Output {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
