...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartConfigurationPolicyDisassociationInput, options: Options) !StartConfigurationPolicyDisassociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartConfigurationPolicyDisassociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartConfigurationPolicyDisassociationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
