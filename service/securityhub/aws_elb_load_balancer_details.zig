...
pub const AwsElbLoadBalancerDetails = struct {
    ...
    backend_server_descriptions: ?[]const AwsElbLoadBalancerBackendServerDescription,
    ...
    health_check: ?AwsElbLoadBalancerHealthCheck,

    /// List of EC2 instances for the load balancer.
    instances: ?[]const AwsElbLoadBalancerInstance,

    /// The policies that are enabled for the load balancer listeners.
    listener_descriptions: ?[]const AwsElbLoadBalancerListenerDescription,

    /// The attributes for a load balancer.
    load_balancer_attributes: ?AwsElbLoadBalancerAttributes,
    ...
    source_security_group: ?AwsElbLoadBalancerSourceSecurityGroup,
