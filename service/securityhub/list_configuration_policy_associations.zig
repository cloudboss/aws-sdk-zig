...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConfigurationPolicyAssociationsInput, options: Options) !ListConfigurationPolicyAssociationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListConfigurationPolicyAssociationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListConfigurationPolicyAssociationsOutput {
    var result: ListConfigurationPolicyAssociationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListConfigurationPolicyAssociationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
