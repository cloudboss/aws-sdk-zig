...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEnabledStandardsInput, options: CallOptions) !GetEnabledStandardsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetEnabledStandardsInput, config: *aws.Config) !aws.http.Request {
