...
pub const Client = struct {
    ...
    /// Standards](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards.html) section of the *Security Hub CSPM User
    /// Guide*.
    ...
    /// the following finding fields and objects, which Security Hub CSPM customers
    /// use to manage their
    ...
    /// Also note that it can take several minutes for Security Hub CSPM to process
    ...
    /// BatchUpdateFindings](https://docs.aws.amazon.com/securityhub/latest/userguide/finding-update-batchupdatefindings.html#batchupdatefindings-configure-access) in the *Security Hub CSPM User Guide*.
    ...
    /// action.
    /// You can configure IAM policies to restrict access to specific finding fields
    /// or field values by using the `securityhub:OCSFSyntaxPath/` condition key,
    /// where `` is one of the following supported fields: `SeverityId`, `StatusId`,
    /// or `Comment`.
    ///
    /// To prevent a user from updating a specific field, use a `Null` condition
    /// with `securityhub:OCSFSyntaxPath/` set to `"false"`.
    /// To prevent a user from setting a field to a specific value, use a
    /// `StringEquals` condition with `securityhub:OCSFSyntaxPath/` set to the
    /// disallowed value or list of values.
    ///
    ...
    /// cross-Region aggregation in Security Hub
    /// CSPM](https://docs.aws.amazon.com/securityhub/latest/userguide/finding-aggregation.html) in the *Security Hub CSPM User Guide*.
    ...
    /// Creates a custom insight in Security Hub CSPM. An insight is a consolidation
    ...
    /// Disables a Security Hub CSPM administrator account. Can only be called by
    /// the organization
    /// management account.
    ...
    /// Services Region. To disable Security Hub CSPM in all
    ...
    /// Security Hub CSPM administrator.
    ///
    /// When you disable Security Hub CSPM, your existing findings and insights and
    /// any Security Hub CSPM configuration
    ...
    /// `DisassociateFromAdministratorAccount`. Any IAM policies that specifically
    /// control access to this function must continue to use
    ...
    ///
    /// When you use the `EnableSecurityHub` operation to enable Security Hub CSPM,
    /// you also
    ...
    /// information](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-settingup.html) in the *Security Hub CSPM User Guide*.
    ...
    /// CSPM delegated administrator can invoke
    ...
    /// Lists the results of the Security Hub CSPM insight specified by the insight
    /// ARN.
    ...
    ///
    /// When the account owner enables Security Hub CSPM and accepts the invitation
    /// to become a member
    ...
    /// Lists the Security Hub CSPM administrator accounts. Can only be called by
    /// the organization
    /// management account.
    ...
    /// Updates the Security Hub CSPM insight identified by the specified insight
    /// ARN.
    ...
    /// Updates the configuration of your organization in Security Hub CSPM. Only
    /// the
    /// Security Hub CSPM administrator account can invoke this operation.
