...
pub const Client = struct {
    ...
    pub fn batchDeleteAutomationRules(self: *Self, allocator: std.mem.Allocator, input: batch_delete_automation_rules.BatchDeleteAutomationRulesInput, options: batch_delete_automation_rules.Options) !batch_delete_automation_rules.BatchDeleteAutomationRulesOutput {
    ...
    /// Guide*.
    pub fn batchDisableStandards(self: *Self, allocator: std.mem.Allocator, input: batch_disable_standards.BatchDisableStandardsInput, options: batch_disable_standards.Options) !batch_disable_standards.BatchDisableStandardsOutput {
    ...
    pub fn batchEnableStandards(self: *Self, allocator: std.mem.Allocator, input: batch_enable_standards.BatchEnableStandardsInput, options: batch_enable_standards.Options) !batch_enable_standards.BatchEnableStandardsOutput {
    ...
    /// Resource Names
    /// (ARNs).
    pub fn batchGetAutomationRules(self: *Self, allocator: std.mem.Allocator, input: batch_get_automation_rules.BatchGetAutomationRulesInput, options: batch_get_automation_rules.Options) !batch_get_automation_rules.BatchGetAutomationRulesOutput {
    ...
    pub fn batchGetConfigurationPolicyAssociations(self: *Self, allocator: std.mem.Allocator, input: batch_get_configuration_policy_associations.BatchGetConfigurationPolicyAssociationsInput, options: batch_get_configuration_policy_associations.Options) !batch_get_configuration_policy_associations.BatchGetConfigurationPolicyAssociationsOutput {
    ...
    pub fn batchGetSecurityControls(self: *Self, allocator: std.mem.Allocator, input: batch_get_security_controls.BatchGetSecurityControlsInput, options: batch_get_security_controls.Options) !batch_get_security_controls.BatchGetSecurityControlsOutput {
    ...
    pub fn batchGetStandardsControlAssociations(self: *Self, allocator: std.mem.Allocator, input: batch_get_standards_control_associations.BatchGetStandardsControlAssociationsInput, options: batch_get_standards_control_associations.Options) !batch_get_standards_control_associations.BatchGetStandardsControlAssociationsOutput {
    ...
    /// these attributes.
    pub fn batchImportFindings(self: *Self, allocator: std.mem.Allocator, input: batch_import_findings.BatchImportFindingsInput, options: batch_import_findings.Options) !batch_import_findings.BatchImportFindingsOutput {
    ...
    pub fn batchUpdateAutomationRules(self: *Self, allocator: std.mem.Allocator, input: batch_update_automation_rules.BatchUpdateAutomationRulesInput, options: batch_update_automation_rules.Options) !batch_update_automation_rules.BatchUpdateAutomationRulesOutput {
    ...
    pub fn batchUpdateFindings(self: *Self, allocator: std.mem.Allocator, input: batch_update_findings.BatchUpdateFindingsInput, options: batch_update_findings.Options) !batch_update_findings.BatchUpdateFindingsOutput {
    ...
    pub fn batchUpdateFindingsV2(self: *Self, allocator: std.mem.Allocator, input: batch_update_findings_v2.BatchUpdateFindingsV2Input, options: batch_update_findings_v2.Options) !batch_update_findings_v2.BatchUpdateFindingsV2Output {
    ...
    pub fn batchUpdateStandardsControlAssociations(self: *Self, allocator: std.mem.Allocator, input: batch_update_standards_control_associations.BatchUpdateStandardsControlAssociationsInput, options: batch_update_standards_control_associations.Options) !batch_update_standards_control_associations.BatchUpdateStandardsControlAssociationsOutput {
    ...
    pub fn createActionTarget(self: *Self, allocator: std.mem.Allocator, input: create_action_target.CreateActionTargetInput, options: create_action_target.Options) !create_action_target.CreateActionTargetOutput {
        return create_action_target.execute(self, allocator, input, options);
    }

    /// Enables aggregation across Amazon Web Services Regions.
    pub fn createAggregatorV2(self: *Self, allocator: std.mem.Allocator, input: create_aggregator_v2.CreateAggregatorV2Input, options: create_aggregator_v2.Options) !create_aggregator_v2.CreateAggregatorV2Output {
    ...
    pub fn createAutomationRuleV2(self: *Self, allocator: std.mem.Allocator, input: create_automation_rule_v2.CreateAutomationRuleV2Input, options: create_automation_rule_v2.Options) !create_automation_rule_v2.CreateAutomationRuleV2Output {
    ...
    pub fn createConfigurationPolicy(self: *Self, allocator: std.mem.Allocator, input: create_configuration_policy.CreateConfigurationPolicyInput, options: create_configuration_policy.Options) !create_configuration_policy.CreateConfigurationPolicyOutput {
        return create_configuration_policy.execute(self, allocator, input, options);
    }

    /// Grants permission to create a connectorV2 based on input parameters.
    pub fn createConnectorV2(self: *Self, allocator: std.mem.Allocator, input: create_connector_v2.CreateConnectorV2Input, options: create_connector_v2.Options) !create_connector_v2.CreateConnectorV2Output {
    ...
    pub fn createFindingAggregator(self: *Self, allocator: std.mem.Allocator, input: create_finding_aggregator.CreateFindingAggregatorInput, options: create_finding_aggregator.Options) !create_finding_aggregator.CreateFindingAggregatorOutput {
    ...
    /// `GroupByAttribute`.
    pub fn createInsight(self: *Self, allocator: std.mem.Allocator, input: create_insight.CreateInsightInput, options: create_insight.Options) !create_insight.CreateInsightOutput {
    ...
    pub fn createTicketV2(self: *Self, allocator: std.mem.Allocator, input: create_ticket_v2.CreateTicketV2Input, options: create_ticket_v2.Options) !create_ticket_v2.CreateTicketV2Output {
    ...
    pub fn deleteActionTarget(self: *Self, allocator: std.mem.Allocator, input: delete_action_target.DeleteActionTargetInput, options: delete_action_target.Options) !delete_action_target.DeleteActionTargetOutput {
        return delete_action_target.execute(self, allocator, input, options);
    }

    /// Deletes the Aggregator V2.
    pub fn deleteAggregatorV2(self: *Self, allocator: std.mem.Allocator, input: delete_aggregator_v2.DeleteAggregatorV2Input, options: delete_aggregator_v2.Options) !delete_aggregator_v2.DeleteAggregatorV2Output {
        return delete_aggregator_v2.execute(self, allocator, input, options);
    }

    /// Deletes a V2 automation rule.
    pub fn deleteAutomationRuleV2(self: *Self, allocator: std.mem.Allocator, input: delete_automation_rule_v2.DeleteAutomationRuleV2Input, options: delete_automation_rule_v2.Options) !delete_automation_rule_v2.DeleteAutomationRuleV2Output {
    ...
    pub fn deleteConfigurationPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_configuration_policy.DeleteConfigurationPolicyInput, options: delete_configuration_policy.Options) !delete_configuration_policy.DeleteConfigurationPolicyOutput {
        return delete_configuration_policy.execute(self, allocator, input, options);
    }

    /// Grants permission to delete a connectorV2.
    pub fn deleteConnectorV2(self: *Self, allocator: std.mem.Allocator, input: delete_connector_v2.DeleteConnectorV2Input, options: delete_connector_v2.Options) !delete_connector_v2.DeleteConnectorV2Output {
    ...
    pub fn deleteFindingAggregator(self: *Self, allocator: std.mem.Allocator, input: delete_finding_aggregator.DeleteFindingAggregatorInput, options: delete_finding_aggregator.Options) !delete_finding_aggregator.DeleteFindingAggregatorOutput {
    ...
    pub fn describeActionTargets(self: *Self, allocator: std.mem.Allocator, input: describe_action_targets.DescribeActionTargetsInput, options: describe_action_targets.Options) !describe_action_targets.DescribeActionTargetsOutput {
    ...
    pub fn describeProducts(self: *Self, allocator: std.mem.Allocator, input: describe_products.DescribeProductsInput, options: describe_products.Options) !describe_products.DescribeProductsOutput {
        return describe_products.execute(self, allocator, input, options);
    }

    /// Gets information about the product integration.
    pub fn describeProductsV2(self: *Self, allocator: std.mem.Allocator, input: describe_products_v2.DescribeProductsV2Input, options: describe_products_v2.Options) !describe_products_v2.DescribeProductsV2Output {
        return describe_products_v2.execute(self, allocator, input, options);
    }

    /// Returns details about the service resource in your account.
    pub fn describeSecurityHubV2(self: *Self, allocator: std.mem.Allocator, input: describe_security_hub_v2.DescribeSecurityHubV2Input, options: describe_security_hub_v2.Options) !describe_security_hub_v2.DescribeSecurityHubV2Output {
    ...
    /// description.
    pub fn describeStandards(self: *Self, allocator: std.mem.Allocator, input: describe_standards.DescribeStandardsInput, options: describe_standards.Options) !describe_standards.DescribeStandardsOutput {
    ...
    pub fn describeStandardsControls(self: *Self, allocator: std.mem.Allocator, input: describe_standards_controls.DescribeStandardsControlsInput, options: describe_standards_controls.Options) !describe_standards_controls.DescribeStandardsControlsOutput {
    ...
    pub fn disableImportFindingsForProduct(self: *Self, allocator: std.mem.Allocator, input: disable_import_findings_for_product.DisableImportFindingsForProductInput, options: disable_import_findings_for_product.Options) !disable_import_findings_for_product.DisableImportFindingsForProductOutput {
    ...
    /// disable
    /// Security Hub.
    pub fn disableSecurityHub(self: *Self, allocator: std.mem.Allocator, input: disable_security_hub.DisableSecurityHubInput, options: disable_security_hub.Options) !disable_security_hub.DisableSecurityHubOutput {
    ...
    pub fn disableSecurityHubV2(self: *Self, allocator: std.mem.Allocator, input: disable_security_hub_v2.DisableSecurityHubV2Input, options: disable_security_hub_v2.Options) !disable_security_hub_v2.DisableSecurityHubV2Output {
    ...
    pub fn enableImportFindingsForProduct(self: *Self, allocator: std.mem.Allocator, input: enable_import_findings_for_product.EnableImportFindingsForProductInput, options: enable_import_findings_for_product.Options) !enable_import_findings_for_product.EnableImportFindingsForProductOutput {
    ...
    pub fn enableSecurityHub(self: *Self, allocator: std.mem.Allocator, input: enable_security_hub.EnableSecurityHubInput, options: enable_security_hub.Options) !enable_security_hub.EnableSecurityHubOutput {
    ...
    pub fn enableSecurityHubV2(self: *Self, allocator: std.mem.Allocator, input: enable_security_hub_v2.EnableSecurityHubV2Input, options: enable_security_hub_v2.Options) !enable_security_hub_v2.EnableSecurityHubV2Output {
    ...
    pub fn getAggregatorV2(self: *Self, allocator: std.mem.Allocator, input: get_aggregator_v2.GetAggregatorV2Input, options: get_aggregator_v2.Options) !get_aggregator_v2.GetAggregatorV2Output {
        return get_aggregator_v2.execute(self, allocator, input, options);
    }

    /// Returns an automation rule for the V2 service.
    pub fn getAutomationRuleV2(self: *Self, allocator: std.mem.Allocator, input: get_automation_rule_v2.GetAutomationRuleV2Input, options: get_automation_rule_v2.Options) !get_automation_rule_v2.GetAutomationRuleV2Output {
    ...
    pub fn getConfigurationPolicy(self: *Self, allocator: std.mem.Allocator, input: get_configuration_policy.GetConfigurationPolicyInput, options: get_configuration_policy.Options) !get_configuration_policy.GetConfigurationPolicyOutput {
    ...
    pub fn getConfigurationPolicyAssociation(self: *Self, allocator: std.mem.Allocator, input: get_configuration_policy_association.GetConfigurationPolicyAssociationInput, options: get_configuration_policy_association.Options) !get_configuration_policy_association.GetConfigurationPolicyAssociationOutput {
    ...
    /// id.
    pub fn getConnectorV2(self: *Self, allocator: std.mem.Allocator, input: get_connector_v2.GetConnectorV2Input, options: get_connector_v2.Options) !get_connector_v2.GetConnectorV2Output {
        return get_connector_v2.execute(self, allocator, input, options);
    }

    /// Returns a list of the standards that are currently enabled.
    pub fn getEnabledStandards(self: *Self, allocator: std.mem.Allocator, input: get_enabled_standards.GetEnabledStandardsInput, options: get_enabled_standards.Options) !get_enabled_standards.GetEnabledStandardsOutput {
    ...
    pub fn getFindingAggregator(self: *Self, allocator: std.mem.Allocator, input: get_finding_aggregator.GetFindingAggregatorInput, options: get_finding_aggregator.Options) !get_finding_aggregator.GetFindingAggregatorOutput {
    ...
    pub fn getFindingHistory(self: *Self, allocator: std.mem.Allocator, input: get_finding_history.GetFindingHistoryInput, options: get_finding_history.Options) !get_finding_history.GetFindingHistoryOutput {
    ...
    pub fn getFindingStatisticsV2(self: *Self, allocator: std.mem.Allocator, input: get_finding_statistics_v2.GetFindingStatisticsV2Input, options: get_finding_statistics_v2.Options) !get_finding_statistics_v2.GetFindingStatisticsV2Output {
    ...
    pub fn getFindingsTrendsV2(self: *Self, allocator: std.mem.Allocator, input: get_findings_trends_v2.GetFindingsTrendsV2Input, options: get_findings_trends_v2.Options) !get_findings_trends_v2.GetFindingsTrendsV2Output {
    ...
    pub fn getFindingsV2(self: *Self, allocator: std.mem.Allocator, input: get_findings_v2.GetFindingsV2Input, options: get_findings_v2.Options) !get_findings_v2.GetFindingsV2Output {
        return get_findings_v2.execute(self, allocator, input, options);
    }

    /// Lists the results of the Security Hub insight specified by the insight ARN.
    pub fn getInsightResults(self: *Self, allocator: std.mem.Allocator, input: get_insight_results.GetInsightResultsInput, options: get_insight_results.Options) !get_insight_results.GetInsightResultsOutput {
    ...
    pub fn getResourcesStatisticsV2(self: *Self, allocator: std.mem.Allocator, input: get_resources_statistics_v2.GetResourcesStatisticsV2Input, options: get_resources_statistics_v2.Options) !get_resources_statistics_v2.GetResourcesStatisticsV2Output {
    ...
    pub fn getResourcesTrendsV2(self: *Self, allocator: std.mem.Allocator, input: get_resources_trends_v2.GetResourcesTrendsV2Input, options: get_resources_trends_v2.Options) !get_resources_trends_v2.GetResourcesTrendsV2Output {
        return get_resources_trends_v2.execute(self, allocator, input, options);
    }

    /// Returns a list of resources.
    pub fn getResourcesV2(self: *Self, allocator: std.mem.Allocator, input: get_resources_v2.GetResourcesV2Input, options: get_resources_v2.Options) !get_resources_v2.GetResourcesV2Output {
    ...
    /// other details.
    pub fn getSecurityControlDefinition(self: *Self, allocator: std.mem.Allocator, input: get_security_control_definition.GetSecurityControlDefinitionInput, options: get_security_control_definition.Options) !get_security_control_definition.GetSecurityControlDefinitionOutput {
    ...
    pub fn listAggregatorsV2(self: *Self, allocator: std.mem.Allocator, input: list_aggregators_v2.ListAggregatorsV2Input, options: list_aggregators_v2.Options) !list_aggregators_v2.ListAggregatorsV2Output {
    ...
    pub fn listAutomationRulesV2(self: *Self, allocator: std.mem.Allocator, input: list_automation_rules_v2.ListAutomationRulesV2Input, options: list_automation_rules_v2.Options) !list_automation_rules_v2.ListAutomationRulesV2Output {
    ...
    pub fn listConfigurationPolicies(self: *Self, allocator: std.mem.Allocator, input: list_configuration_policies.ListConfigurationPoliciesInput, options: list_configuration_policies.Options) !list_configuration_policies.ListConfigurationPoliciesOutput {
    ...
    /// Region.
    pub fn listConfigurationPolicyAssociations(self: *Self, allocator: std.mem.Allocator, input: list_configuration_policy_associations.ListConfigurationPolicyAssociationsInput, options: list_configuration_policy_associations.Options) !list_configuration_policy_associations.ListConfigurationPolicyAssociationsOutput {
    ...
    /// the calling account.
    pub fn listConnectorsV2(self: *Self, allocator: std.mem.Allocator, input: list_connectors_v2.ListConnectorsV2Input, options: list_connectors_v2.Options) !list_connectors_v2.ListConnectorsV2Output {
    ...
    pub fn listEnabledProductsForImport(self: *Self, allocator: std.mem.Allocator, input: list_enabled_products_for_import.ListEnabledProductsForImportInput, options: list_enabled_products_for_import.Options) !list_enabled_products_for_import.ListEnabledProductsForImportOutput {
    ...
    /// Services Region.
    pub fn listFindingAggregators(self: *Self, allocator: std.mem.Allocator, input: list_finding_aggregators.ListFindingAggregatorsInput, options: list_finding_aggregators.Options) !list_finding_aggregators.ListFindingAggregatorsOutput {
    ...
    pub fn listSecurityControlDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_security_control_definitions.ListSecurityControlDefinitionsInput, options: list_security_control_definitions.Options) !list_security_control_definitions.ListSecurityControlDefinitionsOutput {
    ...
    pub fn listStandardsControlAssociations(self: *Self, allocator: std.mem.Allocator, input: list_standards_control_associations.ListStandardsControlAssociationsInput, options: list_standards_control_associations.Options) !list_standards_control_associations.ListStandardsControlAssociationsOutput {
    ...
    pub fn registerConnectorV2(self: *Self, allocator: std.mem.Allocator, input: register_connector_v2.RegisterConnectorV2Input, options: register_connector_v2.Options) !register_connector_v2.RegisterConnectorV2Output {
    ...
    /// invoke this operation from the home Region.
    pub fn startConfigurationPolicyAssociation(self: *Self, allocator: std.mem.Allocator, input: start_configuration_policy_association.StartConfigurationPolicyAssociationInput, options: start_configuration_policy_association.Options) !start_configuration_policy_association.StartConfigurationPolicyAssociationOutput {
    ...
    pub fn startConfigurationPolicyDisassociation(self: *Self, allocator: std.mem.Allocator, input: start_configuration_policy_disassociation.StartConfigurationPolicyDisassociationInput, options: start_configuration_policy_disassociation.Options) !start_configuration_policy_disassociation.StartConfigurationPolicyDisassociationOutput {
    ...
    pub fn updateActionTarget(self: *Self, allocator: std.mem.Allocator, input: update_action_target.UpdateActionTargetInput, options: update_action_target.Options) !update_action_target.UpdateActionTargetOutput {
        return update_action_target.execute(self, allocator, input, options);
    }

    /// Udpates the configuration for the Aggregator V2.
    pub fn updateAggregatorV2(self: *Self, allocator: std.mem.Allocator, input: update_aggregator_v2.UpdateAggregatorV2Input, options: update_aggregator_v2.Options) !update_aggregator_v2.UpdateAggregatorV2Output {
        return update_aggregator_v2.execute(self, allocator, input, options);
    }

    /// Updates a V2 automation rule.
    pub fn updateAutomationRuleV2(self: *Self, allocator: std.mem.Allocator, input: update_automation_rule_v2.UpdateAutomationRuleV2Input, options: update_automation_rule_v2.Options) !update_automation_rule_v2.UpdateAutomationRuleV2Output {
    ...
    pub fn updateConfigurationPolicy(self: *Self, allocator: std.mem.Allocator, input: update_configuration_policy.UpdateConfigurationPolicyInput, options: update_configuration_policy.Options) !update_configuration_policy.UpdateConfigurationPolicyOutput {
    ...
    /// parameters.
    pub fn updateConnectorV2(self: *Self, allocator: std.mem.Allocator, input: update_connector_v2.UpdateConnectorV2Input, options: update_connector_v2.Options) !update_connector_v2.UpdateConnectorV2Output {
    ...
    pub fn updateFindingAggregator(self: *Self, allocator: std.mem.Allocator, input: update_finding_aggregator.UpdateFindingAggregatorInput, options: update_finding_aggregator.Options) !update_finding_aggregator.UpdateFindingAggregatorOutput {
    ...
    pub fn updateInsight(self: *Self, allocator: std.mem.Allocator, input: update_insight.UpdateInsightInput, options: update_insight.Options) !update_insight.UpdateInsightOutput {
    ...
    pub fn updateSecurityControl(self: *Self, allocator: std.mem.Allocator, input: update_security_control.UpdateSecurityControlInput, options: update_security_control.Options) !update_security_control.UpdateSecurityControlOutput {
        return update_security_control.execute(self, allocator, input, options);
    }

    /// Updates configuration options for Security Hub.
    pub fn updateSecurityHubConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_security_hub_configuration.UpdateSecurityHubConfigurationInput, options: update_security_hub_configuration.Options) !update_security_hub_configuration.UpdateSecurityHubConfigurationOutput {
    ...
    pub fn updateStandardsControl(self: *Self, allocator: std.mem.Allocator, input: update_standards_control.UpdateStandardsControlInput, options: update_standards_control.Options) !update_standards_control.UpdateStandardsControlOutput {
