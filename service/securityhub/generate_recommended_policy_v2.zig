...
pub const GenerateRecommendedPolicyV2Input = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GenerateRecommendedPolicyV2Input, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GenerateRecommendedPolicyV2Output {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GenerateRecommendedPolicyV2Output = .{};
