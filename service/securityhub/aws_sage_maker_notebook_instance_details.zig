...
pub const AwsSageMakerNotebookInstanceDetails = struct {
    ...
    direct_internet_access: ?[]const u8 = null,

    /// If status of the instance is `Failed`, the reason it failed.
    failure_reason: ?[]const u8 = null,

    /// Information on the IMDS configuration of the notebook instance.
    instance_metadata_service_configuration: ?AwsSageMakerNotebookInstanceMetadataServiceConfigurationDetails = null,
    ...
    notebook_instance_status: ?[]const u8 = null,
