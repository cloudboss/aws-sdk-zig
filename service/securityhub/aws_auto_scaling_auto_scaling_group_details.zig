...
pub const AwsAutoScalingAutoScalingGroupDetails = struct {
    ...
    availability_zones: ?[]const AwsAutoScalingAutoScalingGroupAvailabilityZonesListDetails = null,
    ...
    launch_template: ?AwsAutoScalingAutoScalingGroupLaunchTemplateLaunchTemplateSpecification = null,

    /// The list of load balancers associated with the group.
    load_balancer_names: ?[]const []const u8 = null,

    /// The mixed instances policy for the automatic scaling group.
    mixed_instances_policy: ?AwsAutoScalingAutoScalingGroupMixedInstancesPolicyDetails = null,
