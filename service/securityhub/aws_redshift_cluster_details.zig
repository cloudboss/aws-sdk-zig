...
pub const AwsRedshiftClusterDetails = struct {
    ...
    cluster_nodes: ?[]const AwsRedshiftClusterClusterNode,

    /// The list of cluster parameter groups that are associated with this cluster.
    cluster_parameter_groups: ?[]const AwsRedshiftClusterClusterParameterGroup,
    ...
    cluster_security_groups: ?[]const AwsRedshiftClusterClusterSecurityGroup,

    /// Information about the destination Region and retention period for the
    /// cross-Region
    /// snapshot copy.
    cluster_snapshot_copy_status: ?AwsRedshiftClusterClusterSnapshotCopyStatus,
    ...
    deferred_maintenance_windows: ?[]const AwsRedshiftClusterDeferredMaintenanceWindow,

    /// Information about the status of the Elastic IP (EIP) address.
    elastic_ip_status: ?AwsRedshiftClusterElasticIpStatus,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    expected_next_snapshot_schedule_time: ?[]const u8,
    ...
    /// cluster
    /// command.
    hsm_status: ?AwsRedshiftClusterHsmStatus,

    /// A list of IAM roles that the cluster can use to access other Amazon Web
    /// Services services.
    iam_roles: ?[]const AwsRedshiftClusterIamRole,
    ...
    logging_status: ?AwsRedshiftClusterLoggingStatus,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    next_maintenance_window_start_time: ?[]const u8,
    ...
    pending_modified_values: ?AwsRedshiftClusterPendingModifiedValues,
    ...
    snapshot_schedule_state: ?[]const u8,
    ...
    /// is in a
    /// VPC.
    vpc_security_groups: ?[]const AwsRedshiftClusterVpcSecurityGroup,
