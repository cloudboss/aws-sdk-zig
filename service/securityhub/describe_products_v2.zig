...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeProductsV2Input, options: CallOptions) !DescribeProductsV2Output {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeProductsV2Input, config: *aws.Config) !aws.http.Request {
