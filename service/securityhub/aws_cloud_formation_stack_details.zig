...
pub const AwsCloudFormationStackDetails = struct {
    ...
    /// template parameters.
    drift_information: ?AwsCloudFormationStackDriftInformationDetails,
    ...
    outputs: ?[]const AwsCloudFormationStackOutputsDetails,
    ...
    stack_status: ?[]const u8,

    /// Success or failure message associated with the stack status.
    stack_status_reason: ?[]const u8,
