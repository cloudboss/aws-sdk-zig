...
pub const AwsEc2NetworkInterfaceDetails = struct {
    ...
    ip_v6_addresses: ?[]const AwsEc2NetworkInterfaceIpV6AddressDetail = null,

    /// The ID of the network interface.
    network_interface_id: ?[]const u8 = null,

    /// The private IPv4 addresses associated with the network interface.
    private_ip_addresses: ?[]const AwsEc2NetworkInterfacePrivateIpAddressDetail = null,
    ...
    security_groups: ?[]const AwsEc2NetworkInterfaceSecurityGroup = null,
