...
pub const AwsCodeBuildProjectDetails = struct {
    ...
    artifacts: ?[]const AwsCodeBuildProjectArtifactsDetails,
    ...
    logs_config: ?AwsCodeBuildProjectLogsConfigDetails,

    /// The name of the build project.
    name: ?[]const u8,

    /// Information about the secondary artifacts for the CodeBuild project.
    secondary_artifacts: ?[]const AwsCodeBuildProjectArtifactsDetails,
