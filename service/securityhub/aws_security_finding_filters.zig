...
pub const AwsSecurityFindingFilters = struct {
    ...
    compliance_security_control_parameters_name: ?[]const StringFilter,

    /// The current value of a security control parameter.
    compliance_security_control_parameters_value: ?[]const StringFilter,
    ...
    /// zero percent
    /// confidence and 100 means 100 percent confidence.
    finding_provider_fields_confidence: ?[]const NumberFilter,
    ...
    /// score of 100
    /// is reserved for the most critical resources.
    finding_provider_fields_criticality: ?[]const NumberFilter,

    /// The finding identifier of a related finding that is identified by the
    /// finding provider.
    finding_provider_fields_related_findings_id: ?[]const StringFilter,

    /// The ARN of the solution that generated a related finding that is identified
    /// by the finding provider.
    finding_provider_fields_related_findings_product_arn: ?[]const StringFilter,

    /// The finding provider value for the severity label.
    finding_provider_fields_severity_label: ?[]const StringFilter,

    /// The finding provider's original value for the severity.
    finding_provider_fields_severity_original: ?[]const StringFilter,
    ...
    finding_provider_fields_types: ?[]const StringFilter,
    ...
    malware_name: ?[]const StringFilter,

    /// The filesystem path of the malware that was observed.
    malware_path: ?[]const StringFilter,

    /// The state of the malware that was observed.
    malware_state: ?[]const StringFilter,

    /// The type of the malware that was observed.
    malware_type: ?[]const StringFilter,

    /// The destination domain of network-related information about a finding.
    network_destination_domain: ?[]const StringFilter,

    /// The destination IPv4 address of network-related information about a finding.
    network_destination_ip_v4: ?[]const IpFilter,

    /// The destination IPv6 address of network-related information about a finding.
    network_destination_ip_v6: ?[]const IpFilter,

    /// The destination port of network-related information about a finding.
    network_destination_port: ?[]const NumberFilter,

    /// Indicates the direction of network traffic associated with a finding.
    network_direction: ?[]const StringFilter,

    /// The protocol of network-related information about a finding.
    network_protocol: ?[]const StringFilter,

    /// The source domain of network-related information about a finding.
    network_source_domain: ?[]const StringFilter,

    /// The source IPv4 address of network-related information about a finding.
    network_source_ip_v4: ?[]const IpFilter,

    /// The source IPv6 address of network-related information about a finding.
    network_source_ip_v6: ?[]const IpFilter,

    /// The source media access control (MAC) address of network-related information
    /// about a
    /// finding.
    network_source_mac: ?[]const StringFilter,

    /// The source port of network-related information about a finding.
    network_source_port: ?[]const NumberFilter,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    process_launched_at: ?[]const DateFilter,

    /// The name of the process.
    process_name: ?[]const StringFilter,

    /// The parent process ID. This field accepts positive integers between `O` and
    /// `2147483647`.
    process_parent_pid: ?[]const NumberFilter,

    /// The path to the process executable.
    process_path: ?[]const StringFilter,

    /// The process ID.
    process_pid: ?[]const NumberFilter,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    process_terminated_at: ?[]const DateFilter,
    ...
    resource_aws_ec_2_instance_iam_instance_profile_arn: ?[]const StringFilter,

    /// The Amazon Machine Image (AMI) ID of the instance.
    resource_aws_ec_2_instance_image_id: ?[]const StringFilter,

    /// The IPv4 addresses associated with the instance.
    resource_aws_ec_2_instance_ip_v4_addresses: ?[]const IpFilter,

    /// The IPv6 addresses associated with the instance.
    resource_aws_ec_2_instance_ip_v6_addresses: ?[]const IpFilter,

    /// The key name associated with the instance.
    resource_aws_ec_2_instance_key_name: ?[]const StringFilter,

    /// The date and time the instance was launched.
    resource_aws_ec_2_instance_launched_at: ?[]const DateFilter,

    /// The identifier of the subnet that the instance was launched in.
    resource_aws_ec_2_instance_subnet_id: ?[]const StringFilter,

    /// The instance type of the instance.
    resource_aws_ec_2_instance_type: ?[]const StringFilter,

    /// The identifier of the VPC that the instance was launched in.
    resource_aws_ec_2_instance_vpc_id: ?[]const StringFilter,

    /// The creation date/time of the IAM access key related to a finding.
    resource_aws_iam_access_key_created_at: ?[]const DateFilter,

    /// The name of the principal that is associated with an IAM access key.
    resource_aws_iam_access_key_principal_name: ?[]const StringFilter,

    /// The status of the IAM access key related to a finding.
    resource_aws_iam_access_key_status: ?[]const StringFilter,

    /// The user associated with the IAM access key related to a finding.
    resource_aws_iam_access_key_user_name: ?[]const StringFilter,

    /// The name of an IAM user.
    resource_aws_iam_user_user_name: ?[]const StringFilter,

    /// The canonical user ID of the owner of the S3 bucket.
    resource_aws_s3_bucket_owner_id: ?[]const StringFilter,

    /// The display name of the owner of the S3 bucket.
    resource_aws_s3_bucket_owner_name: ?[]const StringFilter,

    /// The identifier of the image related to a finding.
    resource_container_image_id: ?[]const StringFilter,

    /// The name of the image related to a finding.
    resource_container_image_name: ?[]const StringFilter,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    resource_container_launched_at: ?[]const DateFilter,

    /// The name of the container related to a finding.
    resource_container_name: ?[]const StringFilter,
    ...
    threat_intel_indicator_category: ?[]const StringFilter,
    ...
    /// in Security Hub, see
    /// [Timestamps](https://docs.aws.amazon.com/securityhub/1.0/APIReference/Welcome.html#timestamps).
    threat_intel_indicator_last_observed_at: ?[]const DateFilter,

    /// The source of the threat intelligence.
    threat_intel_indicator_source: ?[]const StringFilter,

    /// The URL for more details from the source of the threat intelligence.
    threat_intel_indicator_source_url: ?[]const StringFilter,

    /// The type of a threat intelligence indicator.
    threat_intel_indicator_type: ?[]const StringFilter,

    /// The value of a threat intelligence indicator.
    threat_intel_indicator_value: ?[]const StringFilter,
    ...
    vulnerabilities_exploit_available: ?[]const StringFilter,
    ...
    vulnerabilities_fix_available: ?[]const StringFilter,
    ...
    workflow_state: ?[]const StringFilter,
