...
pub const AwsEcsClusterDetails = struct {
    ...
    cluster_settings: ?[]const AwsEcsClusterClusterSettingsDetails,
    ...
    default_capacity_provider_strategy: ?[]const AwsEcsClusterDefaultCapacityProviderStrategyDetails,
