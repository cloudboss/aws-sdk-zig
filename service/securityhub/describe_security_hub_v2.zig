...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSecurityHubV2Input, options: CallOptions) !DescribeSecurityHubV2Output {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeSecurityHubV2Input, config: *aws.Config) !aws.http.Request {
    _ = input;
