...
pub const DeleteCoreDeviceInput = struct {
...
pub const DeleteCoreDeviceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCoreDeviceInput, options: CallOptions) !DeleteCoreDeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCoreDeviceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCoreDeviceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCoreDeviceOutput = .{};
