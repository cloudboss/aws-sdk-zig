...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListComponentVersionsInput, options: CallOptions) !ListComponentVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListComponentVersionsInput, config: *aws.Config) !aws.http.Request {
