...
pub const LambdaExecutionParameters = struct {
    ...
    /// messages.
    event_sources: ?[]const LambdaEventSource,
    ...
    linux_process_params: ?LambdaLinuxProcessParams,
