...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDisassociateClientDeviceFromCoreDeviceInput, options: Options) !BatchDisassociateClientDeviceFromCoreDeviceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: BatchDisassociateClientDeviceFromCoreDeviceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/disassociateClientDevices");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !BatchDisassociateClientDeviceFromCoreDeviceOutput {
    var result: BatchDisassociateClientDeviceFromCoreDeviceOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(BatchDisassociateClientDeviceFromCoreDeviceOutput, body, alloc);
    }
    _ = status;
    _ = headers;
