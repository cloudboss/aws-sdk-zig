...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEffectiveDeploymentsInput, options: CallOptions) !ListEffectiveDeploymentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEffectiveDeploymentsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/effectiveDeployments");
