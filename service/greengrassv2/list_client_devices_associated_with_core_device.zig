...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListClientDevicesAssociatedWithCoreDeviceInput, options: CallOptions) !ListClientDevicesAssociatedWithCoreDeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListClientDevicesAssociatedWithCoreDeviceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/associatedClientDevices");
