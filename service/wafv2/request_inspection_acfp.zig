const AddressField = @import("address_field.zig").AddressField;
const EmailField = @import("email_field.zig").EmailField;
const PasswordField = @import("password_field.zig").PasswordField;
const PayloadType = @import("payload_type.zig").PayloadType;
const PhoneNumberField = @import("phone_number_field.zig").PhoneNumberField;
...
pub const RequestInspectionACFP = struct {
