...
/// WAF applies any custom request handling and labels that you've configured
/// and then allows the web request inspection to
...
///   the response includes a JavaScript page interstitial with a challenge
///   script.
///
...
/// the challenge, it receives a new token from WAF, which the challenge script
/// uses to resubmit the original request.
///
...
/// default actions.
pub const ChallengeAction = struct {
    ...
    custom_request_handling: ?CustomRequestHandling = null,
