const AndStatement = @import("and_statement.zig").AndStatement;
const AsnMatchStatement = @import("asn_match_statement.zig").AsnMatchStatement;
const ByteMatchStatement = @import("byte_match_statement.zig").ByteMatchStatement;
const GeoMatchStatement = @import("geo_match_statement.zig").GeoMatchStatement;
const IPSetReferenceStatement = @import("ip_set_reference_statement.zig").IPSetReferenceStatement;
const LabelMatchStatement = @import("label_match_statement.zig").LabelMatchStatement;
const ManagedRuleGroupStatement = @import("managed_rule_group_statement.zig").ManagedRuleGroupStatement;
const NotStatement = @import("not_statement.zig").NotStatement;
const OrStatement = @import("or_statement.zig").OrStatement;
const RateBasedStatement = @import("rate_based_statement.zig").RateBasedStatement;
const RegexMatchStatement = @import("regex_match_statement.zig").RegexMatchStatement;
const RegexPatternSetReferenceStatement = @import("regex_pattern_set_reference_statement.zig").RegexPatternSetReferenceStatement;
const RuleGroupReferenceStatement = @import("rule_group_reference_statement.zig").RuleGroupReferenceStatement;
const SizeConstraintStatement = @import("size_constraint_statement.zig").SizeConstraintStatement;
const SqliMatchStatement = @import("sqli_match_statement.zig").SqliMatchStatement;
const XssMatchStatement = @import("xss_match_statement.zig").XssMatchStatement;
...
pub const Statement = struct {
    ...
    and_statement: ?*AndStatement = null,
    ...
    ///   geo match rule and configure them to match against the geographic labels
    ...
    not_statement: ?*NotStatement = null,
    ...
    ///   each. The aggregation instances and request counts for our example would
    ///   be the following:
    ///
    ...
    /// inside a `NotStatement` or `OrStatement`. You can define a
    ...
    /// you can retrieve the list of IP addresses that WAF
    /// is currently rate limiting for a rule through the API call
    /// `GetRateBasedStatementManagedKeys`. This option is not available
    ...
    rate_based_statement: ?*RateBasedStatement = null,
