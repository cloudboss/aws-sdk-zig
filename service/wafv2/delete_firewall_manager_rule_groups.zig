...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFirewallManagerRuleGroupsInput, options: Options) !DeleteFirewallManagerRuleGroupsOutput {
