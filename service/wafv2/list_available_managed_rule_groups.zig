...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAvailableManagedRuleGroupsInput, options: Options) !ListAvailableManagedRuleGroupsOutput {
