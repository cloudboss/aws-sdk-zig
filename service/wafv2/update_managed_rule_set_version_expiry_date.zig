...
pub const UpdateManagedRuleSetVersionExpiryDateInput = struct {
    ...
    pub const json_field_names = .{
        ...
        .name = "Name",
        .scope = "Scope",
        .version_to_expire = "VersionToExpire",
    };
};

pub const UpdateManagedRuleSetVersionExpiryDateOutput = struct {
    /// The version that is set to expire.
    expiring_version: ?[]const u8 = null,
    ...
    pub const json_field_names = .{
        .expiring_version = "ExpiringVersion",
        .expiry_timestamp = "ExpiryTimestamp",
        .next_lock_token = "NextLockToken",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateManagedRuleSetVersionExpiryDateInput, options: CallOptions) !UpdateManagedRuleSetVersionExpiryDateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateManagedRuleSetVersionExpiryDateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSWAF_20190729.UpdateManagedRuleSetVersionExpiryDate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateManagedRuleSetVersionExpiryDateOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateManagedRuleSetVersionExpiryDateOutput, body, allocator);
}
