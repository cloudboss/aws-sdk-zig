...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateManagedRuleSetVersionExpiryDateInput, options: Options) !UpdateManagedRuleSetVersionExpiryDateOutput {
