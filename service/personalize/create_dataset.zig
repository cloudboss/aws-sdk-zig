...
pub const CreateDatasetInput = struct {
    ...
    /// A list of
    /// [tags](https://docs.aws.amazon.com/personalize/latest/dg/tagging-resources.html) to apply to the dataset.
    tags: ?[]const Tag = null,
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateDatasetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonPersonalize.CreateDataset");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateDatasetOutput {
    ...
    return aws.json.parseJsonObject(CreateDatasetOutput, body, alloc);
}
