...
pub const ListBatchInferenceJobsPaginator = struct {
    client: *Client,
    params: list_batch_inference_jobs.ListBatchInferenceJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_batch_inference_jobs.ListBatchInferenceJobsOutput {
        if (self.done) {
...
pub const ListBatchSegmentJobsPaginator = struct {
    client: *Client,
    params: list_batch_segment_jobs.ListBatchSegmentJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_batch_segment_jobs.ListBatchSegmentJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListEventTrackersPaginator = struct {
    client: *Client,
    params: list_event_trackers.ListEventTrackersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_event_trackers.ListEventTrackersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFiltersPaginator = struct {
    client: *Client,
    params: list_filters.ListFiltersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_filters.ListFiltersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListMetricAttributionMetricsPaginator = struct {
    client: *Client,
    params: list_metric_attribution_metrics.ListMetricAttributionMetricsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_metric_attribution_metrics.ListMetricAttributionMetricsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListMetricAttributionsPaginator = struct {
    client: *Client,
    params: list_metric_attributions.ListMetricAttributionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_metric_attributions.ListMetricAttributionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListRecipesPaginator = struct {
    client: *Client,
    params: list_recipes.ListRecipesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_recipes.ListRecipesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListRecommendersPaginator = struct {
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_recommenders.ListRecommendersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSolutionVersionsPaginator = struct {
    client: *Client,
    params: list_solution_versions.ListSolutionVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_solution_versions.ListSolutionVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
