...
pub const CreateDatasetImportJobInput = struct {
    ...
    /// existing data in your dataset. Amazon Personalize replaces any record with
    /// the
    ...
    /// A list of
    /// [tags](https://docs.aws.amazon.com/personalize/latest/dg/tagging-resources.html) to apply to the dataset import job.
    tags: ?[]const Tag = null,
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDatasetImportJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonPersonalize.CreateDatasetImportJob");
