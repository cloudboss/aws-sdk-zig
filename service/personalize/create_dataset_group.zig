...
pub const CreateDatasetGroupInput = struct {
    ...
    /// A list of
    /// [tags](https://docs.aws.amazon.com/personalize/latest/dg/tagging-resources.html) to apply to the dataset group.
    tags: ?[]const Tag = null,
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDatasetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonPersonalize.CreateDatasetGroup");
