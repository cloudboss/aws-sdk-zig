...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTableInput, options: Options) !DescribeTableOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "RedshiftData.DescribeTable");
