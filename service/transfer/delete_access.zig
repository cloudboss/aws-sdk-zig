...
const DeleteAccessOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessInput, options: Options) !DeleteAccessOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccessInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "TransferService.DeleteAccess");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccessOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
