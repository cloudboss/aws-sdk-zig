...
const ListExecutionsInput = @import("list_executions_request.zig").ListExecutionsRequest;

const ListExecutionsOutput = @import("list_executions_response.zig").ListExecutionsResponse;
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListExecutionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "TransferService.ListExecutions");
