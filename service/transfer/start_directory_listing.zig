...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartDirectoryListingInput, options: Options) !StartDirectoryListingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartDirectoryListingInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "TransferService.StartDirectoryListing");
