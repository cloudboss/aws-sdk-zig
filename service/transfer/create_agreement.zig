...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateAgreementInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "TransferService.CreateAgreement");
