...
pub const DeleteTenantInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTenantInput, options: Options) !DeleteTenantOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTenantInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v2/email/tenants/delete";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTenantOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTenantOutput = .{};
