...
pub const UpdateContactListInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateContactListInput, options: Options) !UpdateContactListOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateContactListInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateContactListOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateContactListOutput = .{};
