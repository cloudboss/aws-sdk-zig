...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateEmailIdentityPolicyInput, options: Options) !CreateEmailIdentityPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateEmailIdentityPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateEmailIdentityPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
