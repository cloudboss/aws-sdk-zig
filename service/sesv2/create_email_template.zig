...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateEmailTemplateInput, options: Options) !CreateEmailTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateEmailTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateEmailTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
