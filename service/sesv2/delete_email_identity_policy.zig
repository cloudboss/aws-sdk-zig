...
pub const DeleteEmailIdentityPolicyInput = struct {
    /// The email identity.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEmailIdentityPolicyInput, options: Options) !DeleteEmailIdentityPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEmailIdentityPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEmailIdentityPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEmailIdentityPolicyOutput = .{};
