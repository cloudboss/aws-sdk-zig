...
fn serializeRequest(alloc: std.mem.Allocator, input: PutEmailIdentityConfigurationSetAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/configuration-set");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutEmailIdentityConfigurationSetAttributesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
