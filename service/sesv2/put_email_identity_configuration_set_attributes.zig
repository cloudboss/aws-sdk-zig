...
pub const PutEmailIdentityConfigurationSetAttributesInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutEmailIdentityConfigurationSetAttributesInput, options: Options) !PutEmailIdentityConfigurationSetAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutEmailIdentityConfigurationSetAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/configuration-set");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutEmailIdentityConfigurationSetAttributesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutEmailIdentityConfigurationSetAttributesOutput = .{};
