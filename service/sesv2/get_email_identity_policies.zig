...
pub const GetEmailIdentityPoliciesInput = struct {
    /// The email identity.
...
pub const GetEmailIdentityPoliciesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEmailIdentityPoliciesInput, options: CallOptions) !GetEmailIdentityPoliciesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetEmailIdentityPoliciesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetEmailIdentityPoliciesOutput {
    var result: GetEmailIdentityPoliciesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetEmailIdentityPoliciesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
