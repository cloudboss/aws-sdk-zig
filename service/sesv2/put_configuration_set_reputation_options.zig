...
pub const PutConfigurationSetReputationOptionsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutConfigurationSetReputationOptionsInput, options: Options) !PutConfigurationSetReputationOptionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutConfigurationSetReputationOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/reputation-options");
    ...
    if (input.reputation_metrics_enabled) |v| {
        if (has_prev) try body_buf.appendSlice(alloc, ",");
        try body_buf.appendSlice(alloc, "\"ReputationMetricsEnabled\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutConfigurationSetReputationOptionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutConfigurationSetReputationOptionsOutput = .{};
