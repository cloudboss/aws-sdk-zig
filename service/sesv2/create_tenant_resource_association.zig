...
pub const CreateTenantResourceAssociationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTenantResourceAssociationInput, options: Options) !CreateTenantResourceAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTenantResourceAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v2/email/tenants/resources";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTenantResourceAssociationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateTenantResourceAssociationOutput = .{};
