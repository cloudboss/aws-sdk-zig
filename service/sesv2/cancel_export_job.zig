...
pub const CancelExportJobInput = struct {
    /// The export job ID.
    job_id: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelExportJobInput, options: Options) !CancelExportJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelExportJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelExportJobOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelExportJobOutput = .{};
