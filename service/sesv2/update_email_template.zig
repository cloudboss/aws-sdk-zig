...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateEmailTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateEmailTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
