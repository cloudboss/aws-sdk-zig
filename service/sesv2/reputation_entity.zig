...
pub const ReputationEntity = struct {
    ...
    reputation_impact: ?RecommendationImpact,
    ...
    reputation_management_policy: ?[]const u8,
    ...
    sending_status_aggregate: ?SendingStatus,
