...
const ListContactsFilter = @import("list_contacts_filter.zig").ListContactsFilter;
...
pub const ListContactsInput = struct {
    ...
    /// if there
    /// are more or less contacts than the value of the PageSize. Use this parameter
    /// to paginate
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListContactsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/contacts/list");
