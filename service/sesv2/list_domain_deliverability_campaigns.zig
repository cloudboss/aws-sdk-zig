...
pub const ListDomainDeliverabilityCampaignsInput = struct {
    ...
    /// The first day that you want to obtain deliverability data
    /// for.
    start_date: i64,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDomainDeliverabilityCampaignsInput, options: Options) !ListDomainDeliverabilityCampaignsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDomainDeliverabilityCampaignsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/v2/email/deliverability-dashboard/domains/");
