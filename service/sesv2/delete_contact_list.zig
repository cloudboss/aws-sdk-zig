...
pub const DeleteContactListInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContactListInput, options: Options) !DeleteContactListOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContactListInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContactListOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContactListOutput = .{};
