...
pub const PutConfigurationSetSendingOptionsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutConfigurationSetSendingOptionsInput, options: Options) !PutConfigurationSetSendingOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutConfigurationSetSendingOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/sending");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutConfigurationSetSendingOptionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutConfigurationSetSendingOptionsOutput = .{};
