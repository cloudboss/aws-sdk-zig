...
fn serializeRequest(alloc: std.mem.Allocator, input: PutConfigurationSetSendingOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/sending");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutConfigurationSetSendingOptionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
