...
pub const UpdateEmailIdentityPolicyInput = struct {
    /// The email identity.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEmailIdentityPolicyInput, options: Options) !UpdateEmailIdentityPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateEmailIdentityPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateEmailIdentityPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateEmailIdentityPolicyOutput = .{};
