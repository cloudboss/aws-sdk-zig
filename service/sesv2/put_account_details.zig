...
pub const PutAccountDetailsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccountDetailsInput, options: Options) !PutAccountDetailsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutAccountDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v2/email/account/details";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutAccountDetailsOutput {
    ...
    _ = status;
    _ = headers;
    const result: PutAccountDetailsOutput = .{};
