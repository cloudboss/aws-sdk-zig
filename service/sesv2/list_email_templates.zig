...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEmailTemplatesInput, options: CallOptions) !ListEmailTemplatesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEmailTemplatesInput, config: *aws.Config) !aws.http.Request {
