...
pub const DeleteDedicatedIpPoolInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDedicatedIpPoolInput, options: Options) !DeleteDedicatedIpPoolOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDedicatedIpPoolInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDedicatedIpPoolOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDedicatedIpPoolOutput = .{};
