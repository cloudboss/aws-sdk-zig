...
fn serializeRequest(alloc: std.mem.Allocator, input: PutConfigurationSetVdmOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/vdm-options");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutConfigurationSetVdmOptionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
