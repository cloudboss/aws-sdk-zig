...
pub const PutConfigurationSetVdmOptionsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutConfigurationSetVdmOptionsInput, options: Options) !PutConfigurationSetVdmOptionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutConfigurationSetVdmOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/vdm-options");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutConfigurationSetVdmOptionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutConfigurationSetVdmOptionsOutput = .{};
