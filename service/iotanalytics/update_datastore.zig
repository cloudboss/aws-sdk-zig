...
pub const UpdateDatastoreInput = struct {
...
pub const UpdateDatastoreOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDatastoreInput, options: CallOptions) !UpdateDatastoreOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDatastoreInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDatastoreOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateDatastoreOutput = .{};
