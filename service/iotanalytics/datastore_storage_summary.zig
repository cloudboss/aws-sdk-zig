...
pub const DatastoreStorageSummary = struct {
    ...
    customer_managed_s3: ?CustomerManagedDatastoreS3StorageSummary = null,

    /// Used to store data used by IoT SiteWise in an Amazon S3 bucket that you
    /// manage.
    iot_site_wise_multi_layer_storage: ?DatastoreIotSiteWiseMultiLayerStorageSummary = null,

    /// Used to store data in an Amazon S3 bucket managed by IoT Analytics.
    service_managed_s3: ?ServiceManagedDatastoreS3StorageSummary = null,
