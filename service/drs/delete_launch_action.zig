...
pub const DeleteLaunchActionInput = struct {
    action_id: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLaunchActionInput, options: Options) !DeleteLaunchActionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLaunchActionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLaunchActionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLaunchActionOutput = .{};
