...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLaunchActionsInput, options: CallOptions) !ListLaunchActionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListLaunchActionsInput, config: *aws.Config) !aws.http.Request {
