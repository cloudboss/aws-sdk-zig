...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartFailbackLaunchInput, options: CallOptions) !StartFailbackLaunchOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartFailbackLaunchInput, config: *aws.Config) !aws.http.Request {
