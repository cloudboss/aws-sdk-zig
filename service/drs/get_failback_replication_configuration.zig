...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFailbackReplicationConfigurationInput, options: Options) !GetFailbackReplicationConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetFailbackReplicationConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetFailbackReplicationConfigurationOutput {
    var result: GetFailbackReplicationConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetFailbackReplicationConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
