...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListStagingAccountsInput, options: CallOptions) !ListStagingAccountsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListStagingAccountsInput, config: *aws.Config) !aws.http.Request {
