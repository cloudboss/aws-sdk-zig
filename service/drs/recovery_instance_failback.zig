...
pub const RecoveryInstanceFailback = struct {
    ...
    /// service.
    agent_last_seen_by_service_date_time: ?[]const u8,
    ...
    /// with.
    failback_client_id: ?[]const u8,

    /// The date and time that the failback client was last seen by the service.
    failback_client_last_seen_by_service_date_time: ?[]const u8,

    /// The date and time that the failback initiation started.
    failback_initiation_time: ?[]const u8,

    /// The Job ID of the last failback log for this Recovery Instance.
    failback_job_id: ?[]const u8,
    ...
    /// Instance.
    failback_to_original_server: ?bool,
