...
pub const RecoveryInstanceDataReplicationInfo = struct {
    /// Information about Data Replication
    data_replication_error: ?RecoveryInstanceDataReplicationError,

    /// Information about whether the data replication has been initiated.
    data_replication_initiation: ?RecoveryInstanceDataReplicationInitiation,

    /// The state of the data replication.
    data_replication_state: ?RecoveryInstanceDataReplicationState,
    ...
    replicated_disks: ?[]const RecoveryInstanceDataReplicationInfoReplicatedDisk,
