...
pub const Client = struct {
    ...
    pub fn associateSourceNetworkStack(self: *Self, allocator: std.mem.Allocator, input: associate_source_network_stack.AssociateSourceNetworkStackInput, options: CallOptions) !associate_source_network_stack.AssociateSourceNetworkStackOutput {
    ...
    pub fn createSourceNetwork(self: *Self, allocator: std.mem.Allocator, input: create_source_network.CreateSourceNetworkInput, options: CallOptions) !create_source_network.CreateSourceNetworkOutput {
    ...
    pub fn deleteLaunchAction(self: *Self, allocator: std.mem.Allocator, input: delete_launch_action.DeleteLaunchActionInput, options: CallOptions) !delete_launch_action.DeleteLaunchActionOutput {
    ...
    pub fn deleteSourceNetwork(self: *Self, allocator: std.mem.Allocator, input: delete_source_network.DeleteSourceNetworkInput, options: CallOptions) !delete_source_network.DeleteSourceNetworkOutput {
    ...
    pub fn describeRecoveryInstances(self: *Self, allocator: std.mem.Allocator, input: describe_recovery_instances.DescribeRecoveryInstancesInput, options: CallOptions) !describe_recovery_instances.DescribeRecoveryInstancesOutput {
        return describe_recovery_instances.execute(self, allocator, input, options);
    }

    /// Lists all Recovery Snapshots for a single Source Server.
    pub fn describeRecoverySnapshots(self: *Self, allocator: std.mem.Allocator, input: describe_recovery_snapshots.DescribeRecoverySnapshotsInput, options: CallOptions) !describe_recovery_snapshots.DescribeRecoverySnapshotsOutput {
    ...
    pub fn describeSourceNetworks(self: *Self, allocator: std.mem.Allocator, input: describe_source_networks.DescribeSourceNetworksInput, options: CallOptions) !describe_source_networks.DescribeSourceNetworksOutput {
    ...
    /// nullified.
    pub fn disconnectRecoveryInstance(self: *Self, allocator: std.mem.Allocator, input: disconnect_recovery_instance.DisconnectRecoveryInstanceInput, options: CallOptions) !disconnect_recovery_instance.DisconnectRecoveryInstanceOutput {
    ...
    /// dataReplicationInfo.lagDuration and dataReplicationInfo.lagDuration will be
    /// nullified.
    pub fn disconnectSourceServer(self: *Self, allocator: std.mem.Allocator, input: disconnect_source_server.DisconnectSourceServerInput, options: CallOptions) !disconnect_source_server.DisconnectSourceServerOutput {
        return disconnect_source_server.execute(self, allocator, input, options);
    }

    /// Export the Source Network CloudFormation template to an S3 bucket.
    pub fn exportSourceNetworkCfnTemplate(self: *Self, allocator: std.mem.Allocator, input: export_source_network_cfn_template.ExportSourceNetworkCfnTemplateInput, options: CallOptions) !export_source_network_cfn_template.ExportSourceNetworkCfnTemplateOutput {
    ...
    /// ID.
    pub fn getFailbackReplicationConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_failback_replication_configuration.GetFailbackReplicationConfigurationInput, options: CallOptions) !get_failback_replication_configuration.GetFailbackReplicationConfigurationOutput {
    ...
    pub fn listLaunchActions(self: *Self, allocator: std.mem.Allocator, input: list_launch_actions.ListLaunchActionsInput, options: CallOptions) !list_launch_actions.ListLaunchActionsOutput {
    ...
    pub fn putLaunchAction(self: *Self, allocator: std.mem.Allocator, input: put_launch_action.PutLaunchActionInput, options: CallOptions) !put_launch_action.PutLaunchActionOutput {
    ...
    pub fn startFailbackLaunch(self: *Self, allocator: std.mem.Allocator, input: start_failback_launch.StartFailbackLaunchInput, options: CallOptions) !start_failback_launch.StartFailbackLaunchOutput {
    ...
    /// stack.
    pub fn startSourceNetworkRecovery(self: *Self, allocator: std.mem.Allocator, input: start_source_network_recovery.StartSourceNetworkRecoveryInput, options: CallOptions) !start_source_network_recovery.StartSourceNetworkRecoveryOutput {
    ...
    /// Network protected.
    pub fn startSourceNetworkReplication(self: *Self, allocator: std.mem.Allocator, input: start_source_network_replication.StartSourceNetworkReplicationInput, options: CallOptions) !start_source_network_replication.StartSourceNetworkReplicationOutput {
    ...
    pub fn stopFailback(self: *Self, allocator: std.mem.Allocator, input: stop_failback.StopFailbackInput, options: CallOptions) !stop_failback.StopFailbackOutput {
    ...
    /// Network unprotected.
    pub fn stopSourceNetworkReplication(self: *Self, allocator: std.mem.Allocator, input: stop_source_network_replication.StopSourceNetworkReplicationInput, options: CallOptions) !stop_source_network_replication.StopSourceNetworkReplicationOutput {
    ...
    pub fn terminateRecoveryInstances(self: *Self, allocator: std.mem.Allocator, input: terminate_recovery_instances.TerminateRecoveryInstancesInput, options: CallOptions) !terminate_recovery_instances.TerminateRecoveryInstancesOutput {
    ...
    /// Instance by ID.
    pub fn updateFailbackReplicationConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_failback_replication_configuration.UpdateFailbackReplicationConfigurationInput, options: CallOptions) !update_failback_replication_configuration.UpdateFailbackReplicationConfigurationOutput {
