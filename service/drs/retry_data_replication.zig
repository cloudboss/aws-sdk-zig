...
pub const RetryDataReplicationOutput = @import("source_server.zig").SourceServer;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RetryDataReplicationInput, options: CallOptions) !RetryDataReplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RetryDataReplicationInput, config: *aws.Config) !aws.http.Request {
