...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSolNetworkPackageContentInput, options: CallOptions) !GetSolNetworkPackageContentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSolNetworkPackageContentInput, config: *aws.Config) !aws.http.Request {
