...
pub const GetSolFunctionPackageDescriptorInput = struct {
...
pub const GetSolFunctionPackageDescriptorOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSolFunctionPackageDescriptorInput, options: Options) !GetSolFunctionPackageDescriptorOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetSolFunctionPackageDescriptorInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/vnfd");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetSolFunctionPackageDescriptorOutput {
    var result: GetSolFunctionPackageDescriptorOutput = .{};
    if (body.len > 0) {
        result.vnfd = try alloc.dupe(u8, body);
    }
    _ = status;
