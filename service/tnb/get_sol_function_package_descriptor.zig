...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSolFunctionPackageDescriptorInput, options: CallOptions) !GetSolFunctionPackageDescriptorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSolFunctionPackageDescriptorInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/vnfd");
