...
pub const GetSolFunctionPackageContentInput = struct {
...
pub const GetSolFunctionPackageContentOutput = struct {
    /// Indicates the media type of the resource.
    content_type: ?PackageContentType = null,

    /// Contents of the function package.
    package_content: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSolFunctionPackageContentInput, options: CallOptions) !GetSolFunctionPackageContentOutput {
