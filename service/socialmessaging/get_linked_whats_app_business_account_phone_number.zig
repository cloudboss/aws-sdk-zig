...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetLinkedWhatsAppBusinessAccountPhoneNumberInput, options: Options) !GetLinkedWhatsAppBusinessAccountPhoneNumberOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetLinkedWhatsAppBusinessAccountPhoneNumberInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetLinkedWhatsAppBusinessAccountPhoneNumberOutput {
    var result: GetLinkedWhatsAppBusinessAccountPhoneNumberOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetLinkedWhatsAppBusinessAccountPhoneNumberOutput, body, alloc);
    }
    _ = status;
    _ = headers;
