...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListWhatsAppMessageTemplatesInput, options: Options) !ListWhatsAppMessageTemplatesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListWhatsAppMessageTemplatesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListWhatsAppMessageTemplatesOutput {
    var result: ListWhatsAppMessageTemplatesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListWhatsAppMessageTemplatesOutput, body, alloc);
    }
    _ = status;
    _ = headers;
