...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        throttled_request_exception: ThrottledRequestException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .throttled_request_exception => |e| e.message,
        ...
        pub fn httpStatus(self: Kind) u16 {
            return switch (self) {
                ...
                .throttled_request_exception => 429,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .throttled_request_exception => |e| e.request_id,
...
pub const AccessDeniedByMetaException = struct {
    message: []const u8 = "",
    request_id: []const u8 = "",
};
...
pub const ThrottledRequestException = struct {
    message: []const u8 = "",
    request_id: []const u8 = "",
};
