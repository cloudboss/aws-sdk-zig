...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyTargetGroupInput, options: Options) !ModifyTargetGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyTargetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyTargetGroup&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyTargetGroupOutput {
    _ = status;
    _ = headers;
