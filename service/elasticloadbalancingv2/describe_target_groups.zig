...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeTargetGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeTargetGroups&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeTargetGroupsOutput {
    _ = status;
    _ = headers;
