...
pub const DeleteSharedTrustStoreAssociationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSharedTrustStoreAssociationInput, options: Options) !DeleteSharedTrustStoreAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSharedTrustStoreAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteSharedTrustStoreAssociation&Version=2015-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSharedTrustStoreAssociationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteSharedTrustStoreAssociationOutput = .{};
