...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSharedTrustStoreAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteSharedTrustStoreAssociation&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSharedTrustStoreAssociationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
