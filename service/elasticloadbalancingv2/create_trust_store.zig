...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTrustStoreInput, options: Options) !CreateTrustStoreOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTrustStoreInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateTrustStore&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTrustStoreOutput {
    _ = status;
    _ = headers;
