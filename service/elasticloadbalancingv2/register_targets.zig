...
fn serializeRequest(allocator: std.mem.Allocator, input: RegisterTargetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RegisterTargets&Version=2015-12-01");
