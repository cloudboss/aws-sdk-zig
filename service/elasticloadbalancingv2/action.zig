...
pub const Action = struct {
    ...
    authenticate_cognito_config: ?AuthenticateCognitoActionConfig = null,
    ...
    authenticate_oidc_config: ?AuthenticateOidcActionConfig = null,
    ...
    fixed_response_config: ?FixedResponseActionConfig = null,
    ...
    /// Specify only when
    /// `Type` is `redirect`.
    redirect_config: ?RedirectActionConfig = null,
