...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTrustStoreRevocationContentInput, options: CallOptions) !GetTrustStoreRevocationContentOutput {
