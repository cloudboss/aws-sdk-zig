...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCapacityReservationInput, options: CallOptions) !DescribeCapacityReservationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCapacityReservationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeCapacityReservation&Version=2015-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCapacityReservationOutput {
    _ = status;
    _ = headers;
