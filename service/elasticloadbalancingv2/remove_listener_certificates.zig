...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveListenerCertificatesInput, options: Options) !RemoveListenerCertificatesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveListenerCertificatesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RemoveListenerCertificates&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RemoveListenerCertificatesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
