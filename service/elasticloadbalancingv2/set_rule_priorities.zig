...
fn serializeRequest(alloc: std.mem.Allocator, input: SetRulePrioritiesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=SetRulePriorities&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetRulePrioritiesOutput {
    _ = status;
    _ = headers;
