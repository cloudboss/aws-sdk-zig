...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeListenersInput, options: Options) !DescribeListenersOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeListenersInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeListeners&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeListenersOutput {
    _ = status;
    _ = headers;
