...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeRulesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeRules&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeRulesOutput {
    _ = status;
    _ = headers;
