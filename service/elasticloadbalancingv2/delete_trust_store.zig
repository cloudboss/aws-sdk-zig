...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTrustStoreInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteTrustStore&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTrustStoreOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
