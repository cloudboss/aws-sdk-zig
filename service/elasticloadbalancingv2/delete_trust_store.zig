...
pub const DeleteTrustStoreInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTrustStoreInput, options: Options) !DeleteTrustStoreOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTrustStoreInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteTrustStore&Version=2015-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTrustStoreOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteTrustStoreOutput = .{};
