...
fn serializeRequest(alloc: std.mem.Allocator, input: GetTrustStoreCaCertificatesBundleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetTrustStoreCaCertificatesBundle&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetTrustStoreCaCertificatesBundleOutput {
    _ = status;
    _ = headers;
