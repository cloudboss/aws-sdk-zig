...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTrustStoreCaCertificatesBundleInput, options: Options) !GetTrustStoreCaCertificatesBundleOutput {
