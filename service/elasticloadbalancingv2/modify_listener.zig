...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyListenerInput, options: Options) !ModifyListenerOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyListenerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyListener&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyListenerOutput {
    _ = status;
    _ = headers;
