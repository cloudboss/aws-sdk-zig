...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTargetGroupInput, options: Options) !DeleteTargetGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTargetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteTargetGroup&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTargetGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteTargetGroupOutput = .{};
