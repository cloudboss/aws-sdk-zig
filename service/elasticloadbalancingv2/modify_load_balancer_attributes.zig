...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyLoadBalancerAttributesInput, options: Options) !ModifyLoadBalancerAttributesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyLoadBalancerAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyLoadBalancerAttributes&Version=2015-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyLoadBalancerAttributesOutput {
    _ = status;
    _ = headers;
