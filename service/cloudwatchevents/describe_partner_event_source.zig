...
pub const DescribePartnerEventSourceInput = struct {
...
pub const DescribePartnerEventSourceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribePartnerEventSourceInput, options: CallOptions) !DescribePartnerEventSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribePartnerEventSourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSEvents.DescribePartnerEventSource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribePartnerEventSourceOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribePartnerEventSourceOutput, body, allocator);
}
