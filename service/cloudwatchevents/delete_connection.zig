...
const DeleteConnectionInput = @import("delete_connection_request.zig").DeleteConnectionRequest;
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConnectionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSEvents.DeleteConnection");
