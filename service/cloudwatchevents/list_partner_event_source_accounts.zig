...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPartnerEventSourceAccountsInput, options: Options) !ListPartnerEventSourceAccountsOutput {
