...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterNotificationHubInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/notification-hubs/");
    try path_buf.appendSlice(allocator, input.notification_hub_region);
