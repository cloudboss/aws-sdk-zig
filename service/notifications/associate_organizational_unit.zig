...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateOrganizationalUnitInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/organizational-units/associate/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateOrganizationalUnitOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
