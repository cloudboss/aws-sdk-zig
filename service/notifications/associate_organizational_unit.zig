...
pub const AssociateOrganizationalUnitInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateOrganizationalUnitInput, options: CallOptions) !AssociateOrganizationalUnitOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateOrganizationalUnitInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/organizational-units/associate/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateOrganizationalUnitOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateOrganizationalUnitOutput = .{};
