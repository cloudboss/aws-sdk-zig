...
pub const AssociateManagedNotificationAdditionalChannelInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateManagedNotificationAdditionalChannelInput, options: Options) !AssociateManagedNotificationAdditionalChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateManagedNotificationAdditionalChannelInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/channels/associate-managed-notification/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateManagedNotificationAdditionalChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateManagedNotificationAdditionalChannelOutput = .{};
