...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateChannelInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/channels/associate/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
