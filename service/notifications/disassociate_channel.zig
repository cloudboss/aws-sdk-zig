...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateChannelInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/channels/disassociate/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
