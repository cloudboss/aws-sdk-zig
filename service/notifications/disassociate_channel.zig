...
pub const DisassociateChannelInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateChannelInput, options: CallOptions) !DisassociateChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateChannelInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/channels/disassociate/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateChannelOutput = .{};
