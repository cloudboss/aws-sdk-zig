...
pub const DisassociateOrganizationalUnitInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateOrganizationalUnitInput, options: Options) !DisassociateOrganizationalUnitOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateOrganizationalUnitInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/organizational-units/disassociate/");
    try path_buf.appendSlice(allocator, input.organizational_unit_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateOrganizationalUnitOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateOrganizationalUnitOutput = .{};
