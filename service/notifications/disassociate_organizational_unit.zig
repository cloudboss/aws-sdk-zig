...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateOrganizationalUnitInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/organizational-units/disassociate/");
    try path_buf.appendSlice(alloc, input.organizational_unit_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateOrganizationalUnitOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
