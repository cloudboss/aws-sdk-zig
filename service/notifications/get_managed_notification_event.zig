...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetManagedNotificationEventInput, options: CallOptions) !GetManagedNotificationEventOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetManagedNotificationEventInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/managed-notification-events/");
