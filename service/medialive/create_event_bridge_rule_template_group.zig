...
pub const CreateEventBridgeRuleTemplateGroupInput = struct {
...
pub const CreateEventBridgeRuleTemplateGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateEventBridgeRuleTemplateGroupInput, options: Options) !CreateEventBridgeRuleTemplateGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateEventBridgeRuleTemplateGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateEventBridgeRuleTemplateGroupOutput {
    var result: CreateEventBridgeRuleTemplateGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateEventBridgeRuleTemplateGroupOutput, body, alloc);
    }
    _ = status;
    _ = headers;
