...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateEventBridgeRuleTemplateGroupInput, options: CallOptions) !CreateEventBridgeRuleTemplateGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateEventBridgeRuleTemplateGroupInput, config: *aws.Config) !aws.http.Request {
