...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSdiSourceInput, options: CallOptions) !DeleteSdiSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSdiSourceInput, config: *aws.Config) !aws.http.Request {
