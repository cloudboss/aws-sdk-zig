...
pub const UpdateEventBridgeRuleTemplateGroupInput = struct {
...
pub const UpdateEventBridgeRuleTemplateGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEventBridgeRuleTemplateGroupInput, options: Options) !UpdateEventBridgeRuleTemplateGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateEventBridgeRuleTemplateGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateEventBridgeRuleTemplateGroupOutput {
    var result: UpdateEventBridgeRuleTemplateGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateEventBridgeRuleTemplateGroupOutput, body, alloc);
    }
    _ = status;
    _ = headers;
