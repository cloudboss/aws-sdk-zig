...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEventBridgeRuleTemplateGroupInput, options: CallOptions) !UpdateEventBridgeRuleTemplateGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateEventBridgeRuleTemplateGroupInput, config: *aws.Config) !aws.http.Request {
