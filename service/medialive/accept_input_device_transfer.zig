...
pub const AcceptInputDeviceTransferInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptInputDeviceTransferInput, options: Options) !AcceptInputDeviceTransferOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AcceptInputDeviceTransferInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AcceptInputDeviceTransferOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: AcceptInputDeviceTransferOutput = .{};
