...
pub const DescribeMultiplexProgramInput = struct {
...
pub const DescribeMultiplexProgramOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMultiplexProgramInput, options: CallOptions) !DescribeMultiplexProgramOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeMultiplexProgramInput, config: *aws.Config) !aws.http.Request {
