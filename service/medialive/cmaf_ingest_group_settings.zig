...
pub const CmafIngestGroupSettings = struct {
    ...
    /// OutputGroup outputs
    additional_destinations: ?[]const AdditionalDestinations = null,

    /// An array that identifies the languages in the four caption channels in the
    /// embedded captions.
    caption_language_mappings: ?[]const CmafIngestCaptionLanguageMapping = null,
    ...
    /// characters.
    id_3_name_modifier: ?[]const u8 = null,
    ...
    /// minus (-), underscore (_) and period (.) and has a maximum length of 100
    /// characters.
    klv_name_modifier: ?[]const u8 = null,
    ...
    /// of 100 characters.
    nielsen_id_3_name_modifier: ?[]const u8 = null,
