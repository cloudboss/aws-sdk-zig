...
pub const RejectInputDeviceTransferInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectInputDeviceTransferInput, options: Options) !RejectInputDeviceTransferOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RejectInputDeviceTransferInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RejectInputDeviceTransferOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: RejectInputDeviceTransferOutput = .{};
