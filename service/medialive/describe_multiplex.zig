...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMultiplexInput, options: CallOptions) !DescribeMultiplexOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeMultiplexInput, config: *aws.Config) !aws.http.Request {
