...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListClusterAlertsInput, options: CallOptions) !ListClusterAlertsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListClusterAlertsInput, config: *aws.Config) !aws.http.Request {
