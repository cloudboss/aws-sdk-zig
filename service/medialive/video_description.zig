...
pub const VideoDescription = struct {
    ...
    respond_to_afd: ?VideoDescriptionRespondToAfd = null,
    ...
    /// Use DEFAULT to insert pillar boxes or letter boxes around the video to fill
    /// the output frame. The video won't get distorted.
    /// Use SMART_CROP to enable the smart crop feature that uses the Elemental
    /// Inference service to crop the frame using AI - see the MediaLive User Guide
    /// for more information.
    scaling_behavior: ?VideoDescriptionScalingBehavior = null,
