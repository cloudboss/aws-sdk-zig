...
pub const CancelInputDeviceTransferInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelInputDeviceTransferInput, options: Options) !CancelInputDeviceTransferOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelInputDeviceTransferInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelInputDeviceTransferOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelInputDeviceTransferOutput = .{};
