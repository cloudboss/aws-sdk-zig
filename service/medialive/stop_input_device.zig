...
pub const StopInputDeviceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopInputDeviceInput, options: Options) !StopInputDeviceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopInputDeviceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopInputDeviceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopInputDeviceOutput = .{};
