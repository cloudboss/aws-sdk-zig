...
fn serializeRequest(allocator: std.mem.Allocator, input: StartInputDeviceMaintenanceWindowInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/startInputDeviceMaintenanceWindow");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartInputDeviceMaintenanceWindowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
