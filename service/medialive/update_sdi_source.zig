...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSdiSourceInput, options: CallOptions) !UpdateSdiSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSdiSourceInput, config: *aws.Config) !aws.http.Request {
