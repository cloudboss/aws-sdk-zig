...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInputDeviceThumbnailInput, options: Options) !DescribeInputDeviceThumbnailOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeInputDeviceThumbnailInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/thumbnailData");
...
fn deserializeStreamingResponse(stream_resp: *aws.http.StreamingResponse, alloc: std.mem.Allocator) !DescribeInputDeviceThumbnailOutput {
