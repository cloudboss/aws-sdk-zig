...
pub const DeleteSignalMapInput = struct {
...
pub const DeleteSignalMapOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSignalMapInput, options: CallOptions) !DeleteSignalMapOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSignalMapInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSignalMapOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSignalMapOutput = .{};
