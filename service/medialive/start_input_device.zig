...
pub const StartInputDeviceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartInputDeviceInput, options: Options) !StartInputDeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartInputDeviceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartInputDeviceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: StartInputDeviceOutput = .{};
