...
pub const DeleteEventBridgeRuleTemplateOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEventBridgeRuleTemplateInput, options: CallOptions) !DeleteEventBridgeRuleTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEventBridgeRuleTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEventBridgeRuleTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
