...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMultiplexInput, options: CallOptions) !DeleteMultiplexOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMultiplexInput, config: *aws.Config) !aws.http.Request {
