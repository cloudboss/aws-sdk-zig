...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateChannelPlacementGroupInput, options: CallOptions) !CreateChannelPlacementGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateChannelPlacementGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateChannelPlacementGroupOutput {
    var result: CreateChannelPlacementGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateChannelPlacementGroupOutput, body, allocator);
    }
    _ = status;
    _ = headers;
