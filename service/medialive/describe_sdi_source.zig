...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSdiSourceInput, options: CallOptions) !DescribeSdiSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeSdiSourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/prod/sdiSources/");
    try path_buf.appendSlice(allocator, input.sdi_source_id);
