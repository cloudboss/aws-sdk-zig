...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAccountConfigurationInput, options: CallOptions) !DescribeAccountConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAccountConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
