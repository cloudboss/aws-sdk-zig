...
pub const DescribeChannelPlacementGroupInput = struct {
...
pub const DescribeChannelPlacementGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelPlacementGroupInput, options: Options) !DescribeChannelPlacementGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeChannelPlacementGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.channel_placement_group_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeChannelPlacementGroupOutput {
    var result: DescribeChannelPlacementGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeChannelPlacementGroupOutput, body, alloc);
    }
    _ = status;
    _ = headers;
