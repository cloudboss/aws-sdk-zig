...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelPlacementGroupInput, options: CallOptions) !DescribeChannelPlacementGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeChannelPlacementGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeChannelPlacementGroupOutput {
    var result: DescribeChannelPlacementGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeChannelPlacementGroupOutput, body, allocator);
    }
    _ = status;
    _ = headers;
