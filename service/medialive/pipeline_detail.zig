...
pub const PipelineDetail = struct {
    ...
    /// pipeline.
    active_input_attachment_name: ?[]const u8,
    ...
    /// pipeline.
    active_input_switch_action_name: ?[]const u8,
    ...
    active_motion_graphics_action_name: ?[]const u8,

    /// The current URI being used for HTML5 motion graphics for this pipeline.
    active_motion_graphics_uri: ?[]const u8,
