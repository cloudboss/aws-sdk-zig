...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCloudWatchAlarmTemplateGroupInput, options: Options) !CreateCloudWatchAlarmTemplateGroupOutput {
