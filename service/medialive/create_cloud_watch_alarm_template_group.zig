...
pub const CreateCloudWatchAlarmTemplateGroupInput = struct {
...
pub const CreateCloudWatchAlarmTemplateGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCloudWatchAlarmTemplateGroupInput, options: CallOptions) !CreateCloudWatchAlarmTemplateGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateCloudWatchAlarmTemplateGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateCloudWatchAlarmTemplateGroupOutput {
    var result: CreateCloudWatchAlarmTemplateGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateCloudWatchAlarmTemplateGroupOutput, body, allocator);
    }
    _ = status;
    _ = headers;
