...
pub const RtmpGroupSettings = struct {
    ...
    ad_markers: ?[]const RtmpAdMarkers = null,

    /// Authentication scheme to use when connecting with CDN
    authentication_scheme: ?AuthenticationScheme = null,
    ...
    cache_full_behavior: ?RtmpCacheFullBehavior = null,

    /// Cache length, in seconds, is used to calculate buffer size.
    cache_length: ?i32 = null,
    ...
    caption_data: ?RtmpCaptionData = null,
    ...
    include_filler_nal_units: ?IncludeFillerNalUnits = null,
    ...
    input_loss_action: ?InputLossActionForRtmpOut = null,
