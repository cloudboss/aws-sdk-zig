...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopMultiplexInput, options: CallOptions) !StopMultiplexOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopMultiplexInput, config: *aws.Config) !aws.http.Request {
