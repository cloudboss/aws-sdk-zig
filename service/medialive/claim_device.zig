...
pub const ClaimDeviceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ClaimDeviceInput, options: Options) !ClaimDeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ClaimDeviceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ClaimDeviceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ClaimDeviceOutput = .{};
