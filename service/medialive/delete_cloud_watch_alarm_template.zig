...
pub const DeleteCloudWatchAlarmTemplateInput = struct {
...
pub const DeleteCloudWatchAlarmTemplateOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCloudWatchAlarmTemplateInput, options: CallOptions) !DeleteCloudWatchAlarmTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCloudWatchAlarmTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCloudWatchAlarmTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCloudWatchAlarmTemplateOutput = .{};
