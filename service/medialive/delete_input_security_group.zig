...
pub const DeleteInputSecurityGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInputSecurityGroupInput, options: Options) !DeleteInputSecurityGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteInputSecurityGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteInputSecurityGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteInputSecurityGroupOutput = .{};
