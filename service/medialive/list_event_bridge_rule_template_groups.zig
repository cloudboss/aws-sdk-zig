...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEventBridgeRuleTemplateGroupsInput, options: CallOptions) !ListEventBridgeRuleTemplateGroupsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEventBridgeRuleTemplateGroupsInput, config: *aws.Config) !aws.http.Request {
