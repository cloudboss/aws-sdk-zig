...
pub const GetEventBridgeRuleTemplateInput = struct {
...
pub const GetEventBridgeRuleTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEventBridgeRuleTemplateInput, options: CallOptions) !GetEventBridgeRuleTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetEventBridgeRuleTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetEventBridgeRuleTemplateOutput {
    var result: GetEventBridgeRuleTemplateOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetEventBridgeRuleTemplateOutput, body, allocator);
    }
    _ = status;
    _ = headers;
