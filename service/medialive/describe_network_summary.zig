...
pub const DescribeNetworkSummary = struct {
    ...
    /// collection of IP addresses in your organization's network that are reserved
    ...
    /// destinations (only in Bridge networks). Each IpPool specifies one CIDR
    /// block.
