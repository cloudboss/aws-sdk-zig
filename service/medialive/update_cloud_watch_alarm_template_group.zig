...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCloudWatchAlarmTemplateGroupInput, options: CallOptions) !UpdateCloudWatchAlarmTemplateGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCloudWatchAlarmTemplateGroupInput, config: *aws.Config) !aws.http.Request {
