...
pub const UpdateCloudWatchAlarmTemplateGroupInput = struct {
...
pub const UpdateCloudWatchAlarmTemplateGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCloudWatchAlarmTemplateGroupInput, options: Options) !UpdateCloudWatchAlarmTemplateGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateCloudWatchAlarmTemplateGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateCloudWatchAlarmTemplateGroupOutput {
    var result: UpdateCloudWatchAlarmTemplateGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateCloudWatchAlarmTemplateGroupOutput, body, alloc);
    }
    _ = status;
    _ = headers;
