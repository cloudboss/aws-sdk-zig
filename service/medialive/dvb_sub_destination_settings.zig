const DvbSubDestinationAlignment = @import("dvb_sub_destination_alignment.zig").DvbSubDestinationAlignment;
const DvbSubDestinationBackgroundColor = @import("dvb_sub_destination_background_color.zig").DvbSubDestinationBackgroundColor;
const InputLocation = @import("input_location.zig").InputLocation;
const DvbSubDestinationFontColor = @import("dvb_sub_destination_font_color.zig").DvbSubDestinationFontColor;
const DvbSubDestinationOutlineColor = @import("dvb_sub_destination_outline_color.zig").DvbSubDestinationOutlineColor;
const DvbSubDestinationShadowColor = @import("dvb_sub_destination_shadow_color.zig").DvbSubDestinationShadowColor;
const DvbSubDestinationSubtitleRows = @import("dvb_sub_destination_subtitle_rows.zig").DvbSubDestinationSubtitleRows;
const DvbSubDestinationTeletextGridControl = @import("dvb_sub_destination_teletext_grid_control.zig").DvbSubDestinationTeletextGridControl;
...
pub const DvbSubDestinationSettings = struct {
    ...
    background_color: ?DvbSubDestinationBackgroundColor = null,
    ...
    /// DVB-Sub font settings must match.
    font_color: ?DvbSubDestinationFontColor = null,
    ...
    /// must match.
    outline_color: ?DvbSubDestinationOutlineColor = null,
    ...
    /// DVB-Sub font settings must match.
    shadow_color: ?DvbSubDestinationShadowColor = null,
    ...
    /// The captions bitmap is 700 wide × 576 high and will be laid over the video.
    /// For example, a value of 16 divides the bitmap into 16 lines, with each line
    ...
    subtitle_rows: ?DvbSubDestinationSubtitleRows = null,
    ...
    /// outputs.
    teletext_grid_control: ?DvbSubDestinationTeletextGridControl = null,
