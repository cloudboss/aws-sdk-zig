...
fn serializeRequest(allocator: std.mem.Allocator, input: RestartChannelPipelinesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/restartChannelPipelines");
    ...
    if (input.pipeline_ids) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"PipelineIds\":");
