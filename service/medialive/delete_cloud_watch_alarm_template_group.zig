...
pub const DeleteCloudWatchAlarmTemplateGroupInput = struct {
...
pub const DeleteCloudWatchAlarmTemplateGroupOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCloudWatchAlarmTemplateGroupInput, options: CallOptions) !DeleteCloudWatchAlarmTemplateGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCloudWatchAlarmTemplateGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCloudWatchAlarmTemplateGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCloudWatchAlarmTemplateGroupOutput = .{};
