...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeActionConnectorPermissionsInput, options: Options) !DescribeActionConnectorPermissionsOutput {
