...
pub const DescribeActionConnectorPermissionsInput = struct {
...
pub const DescribeActionConnectorPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeActionConnectorPermissionsInput, options: CallOptions) !DescribeActionConnectorPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeActionConnectorPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeActionConnectorPermissionsOutput {
    var result: DescribeActionConnectorPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeActionConnectorPermissionsOutput, body, allocator);
    }
