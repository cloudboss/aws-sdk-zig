...
pub const UpdateDataSourcePermissionsInput = struct {
...
pub const UpdateDataSourcePermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataSourcePermissionsInput, options: Options) !UpdateDataSourcePermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateDataSourcePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateDataSourcePermissionsOutput {
    var result: UpdateDataSourcePermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateDataSourcePermissionsOutput, body, alloc);
    }
