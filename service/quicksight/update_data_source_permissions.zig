...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataSourcePermissionsInput, options: CallOptions) !UpdateDataSourcePermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDataSourcePermissionsInput, config: *aws.Config) !aws.http.Request {
