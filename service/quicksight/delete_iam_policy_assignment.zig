...
pub const DeleteIAMPolicyAssignmentInput = struct {
...
pub const DeleteIAMPolicyAssignmentOutput = struct {
    /// The name of the assignment.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIAMPolicyAssignmentInput, options: Options) !DeleteIAMPolicyAssignmentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIAMPolicyAssignmentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIAMPolicyAssignmentOutput {
    var result: DeleteIAMPolicyAssignmentOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteIAMPolicyAssignmentOutput, body, alloc);
    }
