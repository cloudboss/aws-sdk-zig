...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateCustomPermissionsInput, options: CallOptions) !CreateCustomPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateCustomPermissionsInput, config: *aws.Config) !aws.http.Request {
