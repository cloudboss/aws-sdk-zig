...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAccountCustomizationInput, options: CallOptions) !UpdateAccountCustomizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateAccountCustomizationInput, config: *aws.Config) !aws.http.Request {
