...
pub const DeleteDefaultQBusinessApplicationInput = struct {
    /// The ID of the Quick Sight account that you want to disconnect from a Amazon
...
pub const DeleteDefaultQBusinessApplicationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDefaultQBusinessApplicationInput, options: CallOptions) !DeleteDefaultQBusinessApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDefaultQBusinessApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/default-qbusiness-application");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDefaultQBusinessApplicationOutput {
    var result: DeleteDefaultQBusinessApplicationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteDefaultQBusinessApplicationOutput, body, allocator);
    }
