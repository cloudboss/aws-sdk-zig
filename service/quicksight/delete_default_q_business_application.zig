...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDefaultQBusinessApplicationInput, options: Options) !DeleteDefaultQBusinessApplicationOutput {
