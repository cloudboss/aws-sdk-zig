...
pub const RadarChartConfiguration = struct {
    ...
    /// chart.
    alternate_band_colors_visibility: ?Visibility,

    /// The color of the even-numbered alternate bands of a radar chart.
    alternate_band_even_color: ?[]const u8,

    /// The color of the odd-numbered alternate bands of a radar chart.
    alternate_band_odd_color: ?[]const u8,

    /// The axis behavior options of a radar chart.
    axes_range_scale: ?RadarChartAxesRangeScale,

    /// The base sreies settings of a radar chart.
    base_series_settings: ?RadarChartSeriesSettings,
    ...
    color_axis: ?AxisDisplayOptions,

    /// The color label options of a radar chart.
    color_label_options: ?ChartAxisLabelOptions,

    /// The field well configuration of a `RadarChartVisual`.
    field_wells: ?RadarChartFieldWells,
    ...
    sort_configuration: ?RadarChartSortConfiguration,
