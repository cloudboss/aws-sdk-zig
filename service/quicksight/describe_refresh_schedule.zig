...
pub const DescribeRefreshScheduleInput = struct {
...
pub const DescribeRefreshScheduleOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRefreshScheduleInput, options: CallOptions) !DescribeRefreshScheduleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeRefreshScheduleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeRefreshScheduleOutput {
    var result: DescribeRefreshScheduleOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeRefreshScheduleOutput, body, allocator);
    }
