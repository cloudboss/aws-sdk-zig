...
pub const DeleteAccountCustomPermissionInput = struct {
...
pub const DeleteAccountCustomPermissionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccountCustomPermissionInput, options: Options) !DeleteAccountCustomPermissionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccountCustomPermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccountCustomPermissionOutput {
    var result: DeleteAccountCustomPermissionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteAccountCustomPermissionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
