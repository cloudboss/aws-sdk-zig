...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListIAMPolicyAssignmentsForUserInput, options: CallOptions) !ListIAMPolicyAssignmentsForUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListIAMPolicyAssignmentsForUserInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListIAMPolicyAssignmentsForUserOutput {
    var result: ListIAMPolicyAssignmentsForUserOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListIAMPolicyAssignmentsForUserOutput, body, allocator);
    }
