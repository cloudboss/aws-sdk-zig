...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeActionConnectorInput, options: CallOptions) !DescribeActionConnectorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeActionConnectorInput, config: *aws.Config) !aws.http.Request {
