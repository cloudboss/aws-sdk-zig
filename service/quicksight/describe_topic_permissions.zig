...
pub const DescribeTopicPermissionsInput = struct {
...
pub const DescribeTopicPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTopicPermissionsInput, options: CallOptions) !DescribeTopicPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTopicPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeTopicPermissionsOutput {
    var result: DescribeTopicPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeTopicPermissionsOutput, body, allocator);
    }
