...
pub const UpdateTopicPermissionsInput = struct {
...
pub const UpdateTopicPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateTopicPermissionsInput, options: CallOptions) !UpdateTopicPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateTopicPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateTopicPermissionsOutput {
    var result: UpdateTopicPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateTopicPermissionsOutput, body, allocator);
    }
