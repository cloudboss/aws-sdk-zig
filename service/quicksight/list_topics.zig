...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTopicsInput, options: CallOptions) !ListTopicsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTopicsInput, config: *aws.Config) !aws.http.Request {
