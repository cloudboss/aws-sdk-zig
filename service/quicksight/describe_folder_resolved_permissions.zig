...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeFolderResolvedPermissionsInput, options: Options) !DescribeFolderResolvedPermissionsOutput {
