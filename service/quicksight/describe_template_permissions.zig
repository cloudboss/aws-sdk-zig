...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTemplatePermissionsInput, options: CallOptions) !DescribeTemplatePermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTemplatePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeTemplatePermissionsOutput {
    var result: DescribeTemplatePermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeTemplatePermissionsOutput, body, allocator);
    }
