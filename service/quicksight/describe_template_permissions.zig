...
pub const DescribeTemplatePermissionsInput = struct {
...
pub const DescribeTemplatePermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTemplatePermissionsInput, options: Options) !DescribeTemplatePermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeTemplatePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeTemplatePermissionsOutput {
    var result: DescribeTemplatePermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeTemplatePermissionsOutput, body, alloc);
    }
