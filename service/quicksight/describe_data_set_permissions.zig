...
pub const DescribeDataSetPermissionsInput = struct {
...
pub const DescribeDataSetPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSetPermissionsInput, options: CallOptions) !DescribeDataSetPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDataSetPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeDataSetPermissionsOutput {
    var result: DescribeDataSetPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDataSetPermissionsOutput, body, allocator);
    }
