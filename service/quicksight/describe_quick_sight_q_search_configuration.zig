...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeQuickSightQSearchConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeQuickSightQSearchConfigurationOutput {
    var result: DescribeQuickSightQSearchConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeQuickSightQSearchConfigurationOutput, body, alloc);
    }
