...
pub const DescribeQuickSightQSearchConfigurationInput = struct {
...
pub const DescribeQuickSightQSearchConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeQuickSightQSearchConfigurationInput, options: CallOptions) !DescribeQuickSightQSearchConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeQuickSightQSearchConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/quicksight-q-search-configuration");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeQuickSightQSearchConfigurationOutput {
    var result: DescribeQuickSightQSearchConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeQuickSightQSearchConfigurationOutput, body, allocator);
    }
