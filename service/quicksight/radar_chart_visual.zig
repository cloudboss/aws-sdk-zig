...
const RadarChartConfiguration = @import("radar_chart_configuration.zig").RadarChartConfiguration;
...
pub const RadarChartVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration settings of the visual.
    chart_configuration: ?RadarChartConfiguration = null,
