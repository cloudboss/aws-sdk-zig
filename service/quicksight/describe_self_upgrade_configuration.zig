...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSelfUpgradeConfigurationInput, options: CallOptions) !DescribeSelfUpgradeConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeSelfUpgradeConfigurationInput, config: *aws.Config) !aws.http.Request {
