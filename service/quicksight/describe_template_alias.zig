...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTemplateAliasInput, options: CallOptions) !DescribeTemplateAliasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTemplateAliasInput, config: *aws.Config) !aws.http.Request {
