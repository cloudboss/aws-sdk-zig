...
pub const Capabilities = struct {
    ...
    bamboo_hr_action: ?CapabilityState,

    /// The ability to perform actions using Box Agent connectors.
    box_agent_action: ?CapabilityState,

    /// The ability to perform actions using Canva Agent connectors.
    canva_agent_action: ?CapabilityState,

    /// The ability to perform chat-related actions.
    chat_agent: ?CapabilityState,

    /// The ability to perform actions using Comprehend connectors.
    comprehend_action: ?CapabilityState,

    /// The ability to perform actions using Comprehend Medical connectors.
    comprehend_medical_action: ?CapabilityState,

    /// The ability to perform actions using Atlassian Confluence Cloud connectors.
    confluence_action: ?CapabilityState,

    /// The ability to create and update Bedrock Agent actions.
    create_and_update_amazon_bedrock_ars_action: ?CapabilityState,

    /// The ability to create and update Bedrock Runtime actions.
    create_and_update_amazon_bedrock_fs_action: ?CapabilityState,

    /// The ability to create and update Bedrock Data Automation Runtime actions.
    create_and_update_amazon_bedrock_krs_action: ?CapabilityState,

    /// The ability to create and update Amazon S3 actions.
    create_and_update_amazon_s_three_action: ?CapabilityState,

    /// The ability to create and update Asana actions.
    create_and_update_asana_action: ?CapabilityState,

    /// The ability to create and update BambooHR actions.
    create_and_update_bamboo_hr_action: ?CapabilityState,

    /// The ability to create and update Box Agent actions.
    create_and_update_box_agent_action: ?CapabilityState,

    /// The ability to create and update Canva Agent actions.
    create_and_update_canva_agent_action: ?CapabilityState,

    /// The ability to create and update Comprehend actions.
    create_and_update_comprehend_action: ?CapabilityState,

    /// The ability to create and update Comprehend Medical actions.
    create_and_update_comprehend_medical_action: ?CapabilityState,

    /// The ability to create and update Atlassian Confluence Cloud actions.
    create_and_update_confluence_action: ?CapabilityState,

    /// The ability to create and update email reports.
    create_and_update_dashboard_email_reports: ?CapabilityState,

    /// The ability to create and update datasets.
    create_and_update_datasets: ?CapabilityState,

    /// The ability to create and update data sources.
    create_and_update_data_sources: ?CapabilityState,

    /// The ability to create and update FactSet actions.
    create_and_update_fact_set_action: ?CapabilityState,

    /// The ability to create and update REST API connection actions.
    create_and_update_generic_http_action: ?CapabilityState,

    /// The ability to create and update GitHub actions.
    create_and_update_github_action: ?CapabilityState,

    /// The ability to create and update Google Calendar actions.
    create_and_update_google_calendar_action: ?CapabilityState,

    /// The ability to create and update Hubspot actions.
    create_and_update_hubspot_action: ?CapabilityState,

    /// The ability to create and update HuggingFace actions.
    create_and_update_hugging_face_action: ?CapabilityState,

    /// The ability to create and update Intercom actions.
    create_and_update_intercom_action: ?CapabilityState,

    /// The ability to create and update Jira actions.
    create_and_update_jira_action: ?CapabilityState,

    /// The ability to create and update Linear actions.
    create_and_update_linear_action: ?CapabilityState,

    /// The ability to create and update Model Context Protocol actions.
    create_and_update_mcp_action: ?CapabilityState,

    /// The ability to create and update Monday actions.
    create_and_update_monday_action: ?CapabilityState,

    /// The ability to create and update Microsoft Outlook actions.
    create_and_update_ms_exchange_action: ?CapabilityState,

    /// The ability to create and update Microsoft Teams actions.
    create_and_update_ms_teams_action: ?CapabilityState,

    /// The ability to create and update New Relic actions.
    create_and_update_new_relic_action: ?CapabilityState,

    /// The ability to create and update Notion actions.
    create_and_update_notion_action: ?CapabilityState,

    /// The ability to create and update Microsoft OneDrive actions.
    create_and_update_one_drive_action: ?CapabilityState,

    /// The ability to create and update OpenAPI Specification actions.
    create_and_update_open_api_action: ?CapabilityState,

    /// The ability to create and update PagerDuty Advance actions.
    create_and_update_pager_duty_action: ?CapabilityState,

    /// The ability to create and update Salesforce actions.
    create_and_update_salesforce_action: ?CapabilityState,

    /// The ability to create and update S&P Global Energy actions.
    create_and_update_sand_p_global_energy_action: ?CapabilityState,

    /// The ability to create and update S&P Global Market Intelligence actions.
    create_and_update_sand_pgmi_action: ?CapabilityState,

    /// The ability to create and update SAP Bill of Materials actions.
    create_and_update_sap_bill_of_material_action: ?CapabilityState,

    /// The ability to create and update SAP Business Partner actions.
    create_and_update_sap_business_partner_action: ?CapabilityState,

    /// The ability to create and update SAP Material Stock actions.
    create_and_update_sap_material_stock_action: ?CapabilityState,

    /// The ability to create and update SAP Physical Inventory actions.
    create_and_update_sap_physical_inventory_action: ?CapabilityState,

    /// The ability to create and update SAP Product Master actions.
    create_and_update_sap_product_master_data_action: ?CapabilityState,

    /// The ability to create and update ServiceNow actions.
    create_and_update_service_now_action: ?CapabilityState,

    /// The ability to create and update Microsoft SharePoint Online actions.
    create_and_update_share_point_action: ?CapabilityState,

    /// The ability to create and update Slack actions.
    create_and_update_slack_action: ?CapabilityState,

    /// The ability to create and update Smartsheet actions.
    create_and_update_smartsheet_action: ?CapabilityState,

    /// The ability to create and update Textract actions.
    create_and_update_textract_action: ?CapabilityState,

    /// The ability to export to Create and Update themes.
    create_and_update_themes: ?CapabilityState,

    /// The ability to create and update threshold alerts.
    create_and_update_threshold_alerts: ?CapabilityState,

    /// The ability to create and update Zendesk actions.
    create_and_update_zendesk_action: ?CapabilityState,

    /// The ability to create chat agents.
    create_chat_agents: ?CapabilityState,

    /// The ability to create shared folders.
    create_shared_folders: ?CapabilityState,

    /// The ability to create a SPICE dataset.
    create_spice_dataset: ?CapabilityState,

    /// The ability to perform dashboard-related actions.
    dashboard: ?CapabilityState,

    /// The ability to export to CSV files from the UI.
    export_to_csv: ?CapabilityState,

    /// The ability to export to CSV files in scheduled email reports.
    export_to_csv_in_scheduled_reports: ?CapabilityState,

    /// The ability to export to Excel files from the UI.
    export_to_excel: ?CapabilityState,

    /// The ability to export to Excel files in scheduled email reports.
    export_to_excel_in_scheduled_reports: ?CapabilityState,

    /// The ability to export to PDF files from the UI.
    export_to_pdf: ?CapabilityState,

    /// The ability to export to PDF files in scheduled email reports.
    export_to_pdf_in_scheduled_reports: ?CapabilityState,

    /// The ability to perform actions using FactSet connectors.
    fact_set_action: ?CapabilityState,
