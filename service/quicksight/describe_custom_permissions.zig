...
pub const DescribeCustomPermissionsInput = struct {
...
pub const DescribeCustomPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomPermissionsInput, options: Options) !DescribeCustomPermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeCustomPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeCustomPermissionsOutput {
    var result: DescribeCustomPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeCustomPermissionsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
