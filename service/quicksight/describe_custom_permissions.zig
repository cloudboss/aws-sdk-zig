...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomPermissionsInput, options: CallOptions) !DescribeCustomPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCustomPermissionsInput, config: *aws.Config) !aws.http.Request {
