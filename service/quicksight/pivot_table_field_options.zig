...
pub const PivotTableFieldOptions = struct {
    ...
    collapse_state_options: ?[]const PivotTableFieldCollapseStateOption,

    /// The data path options for the pivot table field options.
    data_path_options: ?[]const PivotTableDataPathOption,

    /// The selected field options for the pivot table field options.
    selected_field_options: ?[]const PivotTableFieldOption,
