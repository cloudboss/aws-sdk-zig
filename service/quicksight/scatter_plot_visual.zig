...
const ScatterPlotConfiguration = @import("scatter_plot_configuration.zig").ScatterPlotConfiguration;
...
pub const ScatterPlotVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration settings of the visual.
    chart_configuration: ?ScatterPlotConfiguration = null,
