...
pub const DeleteAccountCustomizationInput = struct {
...
pub const DeleteAccountCustomizationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccountCustomizationInput, options: CallOptions) !DeleteAccountCustomizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccountCustomizationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccountCustomizationOutput {
    var result: DeleteAccountCustomizationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteAccountCustomizationOutput, body, allocator);
    }
