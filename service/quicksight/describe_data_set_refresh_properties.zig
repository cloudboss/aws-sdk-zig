...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSetRefreshPropertiesInput, options: Options) !DescribeDataSetRefreshPropertiesOutput {
