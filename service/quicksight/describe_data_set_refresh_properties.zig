...
pub const DescribeDataSetRefreshPropertiesInput = struct {
...
pub const DescribeDataSetRefreshPropertiesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSetRefreshPropertiesInput, options: CallOptions) !DescribeDataSetRefreshPropertiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDataSetRefreshPropertiesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeDataSetRefreshPropertiesOutput {
    var result: DescribeDataSetRefreshPropertiesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDataSetRefreshPropertiesOutput, body, allocator);
    }
