...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDashboardsQAConfigurationInput, options: CallOptions) !DescribeDashboardsQAConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDashboardsQAConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeDashboardsQAConfigurationOutput {
    var result: DescribeDashboardsQAConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDashboardsQAConfigurationOutput, body, allocator);
    }
