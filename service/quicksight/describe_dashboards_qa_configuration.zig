...
pub const DescribeDashboardsQAConfigurationInput = struct {
...
pub const DescribeDashboardsQAConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDashboardsQAConfigurationInput, options: Options) !DescribeDashboardsQAConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeDashboardsQAConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/dashboards-qa-configuration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeDashboardsQAConfigurationOutput {
    var result: DescribeDashboardsQAConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDashboardsQAConfigurationOutput, body, alloc);
    }
