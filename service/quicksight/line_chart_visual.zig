...
const LineChartConfiguration = @import("line_chart_configuration.zig").LineChartConfiguration;
...
pub const LineChartVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration of a line chart.
    chart_configuration: ?LineChartConfiguration = null,
