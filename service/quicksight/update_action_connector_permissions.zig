...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateActionConnectorPermissionsInput, options: Options) !UpdateActionConnectorPermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateActionConnectorPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateActionConnectorPermissionsOutput {
    var result: UpdateActionConnectorPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateActionConnectorPermissionsOutput, body, alloc);
    }
