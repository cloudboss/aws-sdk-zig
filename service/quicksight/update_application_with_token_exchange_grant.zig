...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApplicationWithTokenExchangeGrantInput, options: Options) !UpdateApplicationWithTokenExchangeGrantOutput {
