...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchDataSetsInput, options: CallOptions) !SearchDataSetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchDataSetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/search/data-sets");
