...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSourcePermissionsInput, options: CallOptions) !DescribeDataSourcePermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDataSourcePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeDataSourcePermissionsOutput {
    var result: DescribeDataSourcePermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDataSourcePermissionsOutput, body, allocator);
    }
