...
pub const DescribeDataSourcePermissionsInput = struct {
...
pub const DescribeDataSourcePermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSourcePermissionsInput, options: Options) !DescribeDataSourcePermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeDataSourcePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeDataSourcePermissionsOutput {
    var result: DescribeDataSourcePermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDataSourcePermissionsOutput, body, alloc);
    }
