...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListIdentityPropagationConfigsInput, options: Options) !ListIdentityPropagationConfigsOutput {
