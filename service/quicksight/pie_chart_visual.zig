...
const PieChartConfiguration = @import("pie_chart_configuration.zig").PieChartConfiguration;
...
///
/// The `PieChartVisual` structure describes a visual that is a member of the
/// pie chart family.
///
...
/// charts](https://docs.aws.amazon.com/quicksight/latest/user/donut-chart.html)
/// in the *Amazon Quick Suite User Guide*.
pub const PieChartVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration of a pie chart.
    chart_configuration: ?PieChartConfiguration = null,
