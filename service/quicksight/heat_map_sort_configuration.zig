...
pub const HeatMapSortConfiguration = struct {
    ...
    heat_map_column_items_limit_configuration: ?ItemsLimitConfiguration = null,

    /// The column sort configuration for heat map for columns that aren't a part of
    /// a field well.
    heat_map_column_sort: ?[]const FieldSortOptions = null,

    /// The limit on the number of rows that are displayed in a heat map.
    heat_map_row_items_limit_configuration: ?ItemsLimitConfiguration = null,

    /// The field sort configuration of the rows fields.
    heat_map_row_sort: ?[]const FieldSortOptions = null,
