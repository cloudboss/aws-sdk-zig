...
pub const DeleteRoleCustomPermissionInput = struct {
...
pub const DeleteRoleCustomPermissionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRoleCustomPermissionInput, options: CallOptions) !DeleteRoleCustomPermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRoleCustomPermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRoleCustomPermissionOutput {
    var result: DeleteRoleCustomPermissionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteRoleCustomPermissionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
