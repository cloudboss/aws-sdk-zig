...
pub const DeleteUserCustomPermissionInput = struct {
...
pub const DeleteUserCustomPermissionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserCustomPermissionInput, options: CallOptions) !DeleteUserCustomPermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserCustomPermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserCustomPermissionOutput {
    var result: DeleteUserCustomPermissionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteUserCustomPermissionOutput, body, allocator);
    }
