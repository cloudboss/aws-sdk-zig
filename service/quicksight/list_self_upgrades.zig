...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSelfUpgradesInput, options: CallOptions) !ListSelfUpgradesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSelfUpgradesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/self-upgrade-requests");
