...
pub const DescribeFolderPermissionsPaginator = struct {
    client: *Client,
    params: describe_folder_permissions.DescribeFolderPermissionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_folder_permissions.DescribeFolderPermissionsOutput {
        if (self.done) {
...
pub const DescribeFolderResolvedPermissionsPaginator = struct {
    client: *Client,
    params: describe_folder_resolved_permissions.DescribeFolderResolvedPermissionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_folder_resolved_permissions.DescribeFolderResolvedPermissionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListActionConnectorsPaginator = struct {
    client: *Client,
    params: list_action_connectors.ListActionConnectorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_action_connectors.ListActionConnectorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAnalysesPaginator = struct {
    client: *Client,
    params: list_analyses.ListAnalysesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_analyses.ListAnalysesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAssetBundleExportJobsPaginator = struct {
    client: *Client,
    params: list_asset_bundle_export_jobs.ListAssetBundleExportJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_asset_bundle_export_jobs.ListAssetBundleExportJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAssetBundleImportJobsPaginator = struct {
    client: *Client,
    params: list_asset_bundle_import_jobs.ListAssetBundleImportJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_asset_bundle_import_jobs.ListAssetBundleImportJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListBrandsPaginator = struct {
    client: *Client,
    params: list_brands.ListBrandsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_brands.ListBrandsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListCustomPermissionsPaginator = struct {
    client: *Client,
    params: list_custom_permissions.ListCustomPermissionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_custom_permissions.ListCustomPermissionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDashboardVersionsPaginator = struct {
    client: *Client,
    params: list_dashboard_versions.ListDashboardVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_dashboard_versions.ListDashboardVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFlowsPaginator = struct {
    client: *Client,
    params: list_flows.ListFlowsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListFolderMembersPaginator = struct {
    client: *Client,
    params: list_folder_members.ListFolderMembersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_folder_members.ListFolderMembersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFoldersPaginator = struct {
    client: *Client,
    params: list_folders.ListFoldersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_folders.ListFoldersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFoldersForResourcePaginator = struct {
    client: *Client,
    params: list_folders_for_resource.ListFoldersForResourceInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_folders_for_resource.ListFoldersForResourceOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListGroupMembershipsPaginator = struct {
    client: *Client,
    params: list_group_memberships.ListGroupMembershipsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_group_memberships.ListGroupMembershipsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListIAMPolicyAssignmentsPaginator = struct {
    client: *Client,
    params: list_iam_policy_assignments.ListIAMPolicyAssignmentsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_iam_policy_assignments.ListIAMPolicyAssignmentsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListIAMPolicyAssignmentsForUserPaginator = struct {
    client: *Client,
    params: list_iam_policy_assignments_for_user.ListIAMPolicyAssignmentsForUserInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_iam_policy_assignments_for_user.ListIAMPolicyAssignmentsForUserOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListIngestionsPaginator = struct {
    client: *Client,
    params: list_ingestions.ListIngestionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_ingestions.ListIngestionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListRoleMembershipsPaginator = struct {
    client: *Client,
    params: list_role_memberships.ListRoleMembershipsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_role_memberships.ListRoleMembershipsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTemplateAliasesPaginator = struct {
    client: *Client,
    params: list_template_aliases.ListTemplateAliasesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_template_aliases.ListTemplateAliasesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTemplateVersionsPaginator = struct {
    client: *Client,
    params: list_template_versions.ListTemplateVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_template_versions.ListTemplateVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListThemeVersionsPaginator = struct {
    client: *Client,
    params: list_theme_versions.ListThemeVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_theme_versions.ListThemeVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListUserGroupsPaginator = struct {
    client: *Client,
    params: list_user_groups.ListUserGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_user_groups.ListUserGroupsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchActionConnectorsPaginator = struct {
    client: *Client,
    params: search_action_connectors.SearchActionConnectorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_action_connectors.SearchActionConnectorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchAnalysesPaginator = struct {
    client: *Client,
    params: search_analyses.SearchAnalysesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_analyses.SearchAnalysesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchDashboardsPaginator = struct {
    client: *Client,
    params: search_dashboards.SearchDashboardsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_dashboards.SearchDashboardsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchDataSetsPaginator = struct {
    client: *Client,
    params: search_data_sets.SearchDataSetsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_data_sets.SearchDataSetsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchDataSourcesPaginator = struct {
    client: *Client,
    params: search_data_sources.SearchDataSourcesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_data_sources.SearchDataSourcesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchFlowsPaginator = struct {
    client: *Client,
    params: search_flows.SearchFlowsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_flows.SearchFlowsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchFoldersPaginator = struct {
    client: *Client,
    params: search_folders.SearchFoldersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_folders.SearchFoldersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchTopicsPaginator = struct {
    client: *Client,
    params: search_topics.SearchTopicsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_topics.SearchTopicsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
