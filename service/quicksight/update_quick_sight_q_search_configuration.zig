...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQuickSightQSearchConfigurationInput, options: CallOptions) !UpdateQuickSightQSearchConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateQuickSightQSearchConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "\"QSearchStatus\":");
    try aws.json.writeValue(@TypeOf(input.q_search_status), input.q_search_status, allocator, &body_buf);
    has_prev = true;
