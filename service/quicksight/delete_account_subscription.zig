...
pub const DeleteAccountSubscriptionInput = struct {
...
pub const DeleteAccountSubscriptionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccountSubscriptionInput, options: Options) !DeleteAccountSubscriptionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccountSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccountSubscriptionOutput {
    var result: DeleteAccountSubscriptionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteAccountSubscriptionOutput, body, alloc);
    }
