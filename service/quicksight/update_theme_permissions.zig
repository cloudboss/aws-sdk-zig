...
pub const UpdateThemePermissionsInput = struct {
...
pub const UpdateThemePermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateThemePermissionsInput, options: CallOptions) !UpdateThemePermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateThemePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateThemePermissionsOutput {
    var result: UpdateThemePermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateThemePermissionsOutput, body, allocator);
    }
