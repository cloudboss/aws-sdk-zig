...
pub const DescribeBrandAssignmentInput = struct {
...
pub const DescribeBrandAssignmentOutput = struct {
    /// The Amazon Resource Name (ARN) of the brand.
    brand_arn: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeBrandAssignmentInput, options: CallOptions) !DescribeBrandAssignmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeBrandAssignmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/brandassignments");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeBrandAssignmentOutput {
    var result: DescribeBrandAssignmentOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeBrandAssignmentOutput, body, allocator);
    }
    _ = status;
    _ = headers;
