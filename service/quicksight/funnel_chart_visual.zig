...
const FunnelChartConfiguration = @import("funnel_chart_configuration.zig").FunnelChartConfiguration;
...
pub const FunnelChartVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration of a `FunnelChartVisual`.
    chart_configuration: ?FunnelChartConfiguration = null,
