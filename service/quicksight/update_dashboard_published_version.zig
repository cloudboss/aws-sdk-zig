...
pub const UpdateDashboardPublishedVersionInput = struct {
...
pub const UpdateDashboardPublishedVersionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDashboardPublishedVersionInput, options: CallOptions) !UpdateDashboardPublishedVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDashboardPublishedVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDashboardPublishedVersionOutput {
    var result: UpdateDashboardPublishedVersionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateDashboardPublishedVersionOutput, body, allocator);
    }
