...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDashboardPublishedVersionInput, options: Options) !UpdateDashboardPublishedVersionOutput {
