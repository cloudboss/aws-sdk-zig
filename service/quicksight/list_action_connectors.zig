...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListActionConnectorsInput, options: CallOptions) !ListActionConnectorsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListActionConnectorsInput, config: *aws.Config) !aws.http.Request {
