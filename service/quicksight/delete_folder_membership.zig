...
pub const DeleteFolderMembershipInput = struct {
...
pub const DeleteFolderMembershipOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFolderMembershipInput, options: CallOptions) !DeleteFolderMembershipOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFolderMembershipInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFolderMembershipOutput {
    var result: DeleteFolderMembershipOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteFolderMembershipOutput, body, allocator);
    }
    _ = status;
    _ = headers;
