...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataSetRefreshPropertiesInput, options: Options) !DeleteDataSetRefreshPropertiesOutput {
