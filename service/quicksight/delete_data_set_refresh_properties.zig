...
pub const DeleteDataSetRefreshPropertiesInput = struct {
...
pub const DeleteDataSetRefreshPropertiesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataSetRefreshPropertiesInput, options: CallOptions) !DeleteDataSetRefreshPropertiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDataSetRefreshPropertiesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDataSetRefreshPropertiesOutput {
    var result: DeleteDataSetRefreshPropertiesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteDataSetRefreshPropertiesOutput, body, allocator);
    }
