...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAnalysisInput, options: CallOptions) !DescribeAnalysisOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAnalysisInput, config: *aws.Config) !aws.http.Request {
