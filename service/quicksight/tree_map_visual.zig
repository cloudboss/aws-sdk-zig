...
const TreeMapConfiguration = @import("tree_map_configuration.zig").TreeMapConfiguration;
...
pub const TreeMapVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration settings of the visual.
    chart_configuration: ?TreeMapConfiguration = null,
