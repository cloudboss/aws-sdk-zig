...
const HeatMapConfiguration = @import("heat_map_configuration.zig").HeatMapConfiguration;
...
pub const HeatMapVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration of a heat map.
    chart_configuration: ?HeatMapConfiguration = null,
