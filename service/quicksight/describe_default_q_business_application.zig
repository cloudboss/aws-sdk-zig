...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDefaultQBusinessApplicationInput, options: Options) !DescribeDefaultQBusinessApplicationOutput {
