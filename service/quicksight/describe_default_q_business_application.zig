...
pub const DescribeDefaultQBusinessApplicationInput = struct {
...
pub const DescribeDefaultQBusinessApplicationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDefaultQBusinessApplicationInput, options: CallOptions) !DescribeDefaultQBusinessApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeDefaultQBusinessApplicationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeDefaultQBusinessApplicationOutput {
    var result: DescribeDefaultQBusinessApplicationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDefaultQBusinessApplicationOutput, body, allocator);
    }
