...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRoleCustomPermissionInput, options: CallOptions) !DescribeRoleCustomPermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeRoleCustomPermissionInput, config: *aws.Config) !aws.http.Request {
