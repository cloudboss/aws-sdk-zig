...
pub const DescribeRoleCustomPermissionInput = struct {
...
pub const DescribeRoleCustomPermissionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRoleCustomPermissionInput, options: Options) !DescribeRoleCustomPermissionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeRoleCustomPermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeRoleCustomPermissionOutput {
    var result: DescribeRoleCustomPermissionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeRoleCustomPermissionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
