...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCustomPermissionsInput, options: CallOptions) !UpdateCustomPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCustomPermissionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.custom_permissions_name);
