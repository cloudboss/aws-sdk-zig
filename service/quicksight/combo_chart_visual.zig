...
const ComboChartConfiguration = @import("combo_chart_configuration.zig").ComboChartConfiguration;
...
pub const ComboChartVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration settings of the visual.
    chart_configuration: ?ComboChartConfiguration = null,
