...
const AssetBundleExportJobSummary = @import("asset_bundle_export_job_summary.zig").AssetBundleExportJobSummary;

pub const ListAssetBundleExportJobsInput = struct {
...
pub const ListAssetBundleExportJobsOutput = struct {
    /// A list of export job summaries.
    asset_bundle_export_job_summary_list: ?[]const AssetBundleExportJobSummary = null,
    ...
    pub const json_field_names = .{
        .asset_bundle_export_job_summary_list = "AssetBundleExportJobSummaryList",
        .next_token = "NextToken",
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssetBundleExportJobsInput, options: Options) !ListAssetBundleExportJobsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListAssetBundleExportJobsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/asset-bundle-export-jobs");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListAssetBundleExportJobsOutput {
    var result: ListAssetBundleExportJobsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAssetBundleExportJobsOutput, body, alloc);
    }
