...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdentityPropagationConfigInput, options: CallOptions) !DeleteIdentityPropagationConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIdentityPropagationConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIdentityPropagationConfigOutput {
    var result: DeleteIdentityPropagationConfigOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteIdentityPropagationConfigOutput, body, allocator);
    }
