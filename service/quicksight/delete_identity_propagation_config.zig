...
pub const DeleteIdentityPropagationConfigInput = struct {
...
pub const DeleteIdentityPropagationConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdentityPropagationConfigInput, options: Options) !DeleteIdentityPropagationConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIdentityPropagationConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/identity-propagation-config/");
    try path_buf.appendSlice(alloc, input.service);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIdentityPropagationConfigOutput {
    var result: DeleteIdentityPropagationConfigOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteIdentityPropagationConfigOutput, body, alloc);
    }
