...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelIngestionInput, options: CallOptions) !CancelIngestionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelIngestionInput, config: *aws.Config) !aws.http.Request {
