...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteThemeAliasInput, options: CallOptions) !DeleteThemeAliasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteThemeAliasInput, config: *aws.Config) !aws.http.Request {
