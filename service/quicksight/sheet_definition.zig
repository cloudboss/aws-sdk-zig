...
pub const SheetDefinition = struct {
    ...
    filter_controls: ?[]const FilterControl,
    ...
    parameter_controls: ?[]const ParameterControl,

    /// The control layouts of the sheet.
    sheet_control_layouts: ?[]const SheetControlLayout,

    /// The unique identifier of a sheet.
    sheet_id: []const u8,

    /// The text boxes that are on a sheet.
    text_boxes: ?[]const SheetTextBox,
