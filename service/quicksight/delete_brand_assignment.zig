...
pub const DeleteBrandAssignmentInput = struct {
...
pub const DeleteBrandAssignmentOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBrandAssignmentInput, options: CallOptions) !DeleteBrandAssignmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBrandAssignmentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBrandAssignmentOutput {
    var result: DeleteBrandAssignmentOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteBrandAssignmentOutput, body, allocator);
    }
    _ = status;
    _ = headers;
