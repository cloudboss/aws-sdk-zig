...
pub const ListFoldersForResourceInput = struct {
...
pub const ListFoldersForResourceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFoldersForResourceInput, options: CallOptions) !ListFoldersForResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFoldersForResourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListFoldersForResourceOutput {
    var result: ListFoldersForResourceOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListFoldersForResourceOutput, body, allocator);
    }
