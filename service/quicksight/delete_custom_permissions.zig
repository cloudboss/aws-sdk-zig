...
pub const DeleteCustomPermissionsInput = struct {
...
pub const DeleteCustomPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomPermissionsInput, options: Options) !DeleteCustomPermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCustomPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCustomPermissionsOutput {
    var result: DeleteCustomPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteCustomPermissionsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
