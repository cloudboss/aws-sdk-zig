...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataSetPermissionsInput, options: CallOptions) !UpdateDataSetPermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDataSetPermissionsInput, config: *aws.Config) !aws.http.Request {
