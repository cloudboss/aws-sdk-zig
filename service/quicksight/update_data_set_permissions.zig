...
pub const UpdateDataSetPermissionsInput = struct {
...
pub const UpdateDataSetPermissionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataSetPermissionsInput, options: Options) !UpdateDataSetPermissionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateDataSetPermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateDataSetPermissionsOutput {
    var result: UpdateDataSetPermissionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateDataSetPermissionsOutput, body, alloc);
    }
