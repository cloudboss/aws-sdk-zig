...
pub const DescribeAccountSubscriptionInput = struct {
...
pub const DescribeAccountSubscriptionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAccountSubscriptionInput, options: Options) !DescribeAccountSubscriptionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeAccountSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeAccountSubscriptionOutput {
    var result: DescribeAccountSubscriptionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeAccountSubscriptionOutput, body, alloc);
    }
