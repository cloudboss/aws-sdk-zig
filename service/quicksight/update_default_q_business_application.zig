...
pub const UpdateDefaultQBusinessApplicationInput = struct {
...
pub const UpdateDefaultQBusinessApplicationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDefaultQBusinessApplicationInput, options: CallOptions) !UpdateDefaultQBusinessApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDefaultQBusinessApplicationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDefaultQBusinessApplicationOutput {
    var result: UpdateDefaultQBusinessApplicationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateDefaultQBusinessApplicationOutput, body, allocator);
    }
