...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDefaultQBusinessApplicationInput, options: Options) !UpdateDefaultQBusinessApplicationOutput {
