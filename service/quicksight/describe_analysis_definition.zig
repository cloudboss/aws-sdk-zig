...
pub const DescribeAnalysisDefinitionInput = struct {
...
pub const DescribeAnalysisDefinitionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAnalysisDefinitionInput, options: CallOptions) !DescribeAnalysisDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAnalysisDefinitionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeAnalysisDefinitionOutput {
    var result: DescribeAnalysisDefinitionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeAnalysisDefinitionOutput, body, allocator);
    }
