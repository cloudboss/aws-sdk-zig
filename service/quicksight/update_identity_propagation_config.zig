...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateIdentityPropagationConfigInput, options: Options) !UpdateIdentityPropagationConfigOutput {
