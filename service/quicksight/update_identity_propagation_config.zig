...
pub const UpdateIdentityPropagationConfigInput = struct {
...
pub const UpdateIdentityPropagationConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateIdentityPropagationConfigInput, options: CallOptions) !UpdateIdentityPropagationConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateIdentityPropagationConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.authorized_targets) |v| {
        if (has_prev) try body_buf.appendSlice(allocator, ",");
        try body_buf.appendSlice(allocator, "\"AuthorizedTargets\":");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateIdentityPropagationConfigOutput {
    var result: UpdateIdentityPropagationConfigOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateIdentityPropagationConfigOutput, body, allocator);
    }
