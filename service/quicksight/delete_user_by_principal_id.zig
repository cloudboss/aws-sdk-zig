...
pub const DeleteUserByPrincipalIdInput = struct {
...
pub const DeleteUserByPrincipalIdOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserByPrincipalIdInput, options: CallOptions) !DeleteUserByPrincipalIdOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserByPrincipalIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/user-principals/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserByPrincipalIdOutput {
    var result: DeleteUserByPrincipalIdOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteUserByPrincipalIdOutput, body, allocator);
    }
