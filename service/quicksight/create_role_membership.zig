...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateRoleMembershipInput, options: CallOptions) !CreateRoleMembershipOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateRoleMembershipInput, config: *aws.Config) !aws.http.Request {
