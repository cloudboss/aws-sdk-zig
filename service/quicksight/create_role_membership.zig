...
pub const CreateRoleMembershipInput = struct {
...
pub const CreateRoleMembershipOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateRoleMembershipInput, options: Options) !CreateRoleMembershipOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateRoleMembershipInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateRoleMembershipOutput {
    var result: CreateRoleMembershipOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateRoleMembershipOutput, body, alloc);
    }
