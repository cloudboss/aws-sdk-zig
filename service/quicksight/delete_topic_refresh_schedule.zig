...
pub const DeleteTopicRefreshScheduleInput = struct {
...
pub const DeleteTopicRefreshScheduleOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTopicRefreshScheduleInput, options: Options) !DeleteTopicRefreshScheduleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTopicRefreshScheduleInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/schedules/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTopicRefreshScheduleOutput {
    var result: DeleteTopicRefreshScheduleOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteTopicRefreshScheduleOutput, body, alloc);
    }
