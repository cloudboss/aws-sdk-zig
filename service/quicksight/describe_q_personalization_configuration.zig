...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeQPersonalizationConfigurationInput, options: Options) !DescribeQPersonalizationConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeQPersonalizationConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/q-personalization-configuration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeQPersonalizationConfigurationOutput {
    var result: DescribeQPersonalizationConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeQPersonalizationConfigurationOutput, body, alloc);
    }
