...
const BoxPlotChartConfiguration = @import("box_plot_chart_configuration.zig").BoxPlotChartConfiguration;
...
pub const BoxPlotVisual = struct {
    /// The list of custom actions that are configured for a visual.
    actions: ?[]const VisualCustomAction = null,

    /// The configuration settings of the visual.
    chart_configuration: ?BoxPlotChartConfiguration = null,
