...
pub const DescribeAccountCustomPermissionInput = struct {
...
pub const DescribeAccountCustomPermissionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAccountCustomPermissionInput, options: CallOptions) !DescribeAccountCustomPermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAccountCustomPermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeAccountCustomPermissionOutput {
    var result: DescribeAccountCustomPermissionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeAccountCustomPermissionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
