...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAccountCustomPermissionInput, options: Options) !DescribeAccountCustomPermissionOutput {
