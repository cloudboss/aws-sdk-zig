...
const DashboardVersionSummary = @import("dashboard_version_summary.zig").DashboardVersionSummary;

pub const ListDashboardVersionsInput = struct {
...
pub const ListDashboardVersionsOutput = struct {
    /// A structure that contains information about each version of the dashboard.
    dashboard_version_summary_list: ?[]const DashboardVersionSummary = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDashboardVersionsInput, options: Options) !ListDashboardVersionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDashboardVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDashboardVersionsOutput {
    var result: ListDashboardVersionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListDashboardVersionsOutput, body, alloc);
    }
