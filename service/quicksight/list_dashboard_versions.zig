...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDashboardVersionsInput, options: CallOptions) !ListDashboardVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDashboardVersionsInput, config: *aws.Config) !aws.http.Request {
