...
pub const Client = struct {
    ...
    pub fn deleteEarthObservationJob(self: *Self, allocator: std.mem.Allocator, input: delete_earth_observation_job.DeleteEarthObservationJobInput, options: delete_earth_observation_job.Options) !delete_earth_observation_job.DeleteEarthObservationJobOutput {
        return delete_earth_observation_job.execute(self, allocator, input, options);
    }

    /// Use this operation to delete a Vector Enrichment job.
    pub fn deleteVectorEnrichmentJob(self: *Self, allocator: std.mem.Allocator, input: delete_vector_enrichment_job.DeleteVectorEnrichmentJobInput, options: delete_vector_enrichment_job.Options) !delete_vector_enrichment_job.DeleteVectorEnrichmentJobOutput {
    ...
    pub fn exportEarthObservationJob(self: *Self, allocator: std.mem.Allocator, input: export_earth_observation_job.ExportEarthObservationJobInput, options: export_earth_observation_job.Options) !export_earth_observation_job.ExportEarthObservationJobOutput {
    ...
    /// S3 location.
    pub fn exportVectorEnrichmentJob(self: *Self, allocator: std.mem.Allocator, input: export_vector_enrichment_job.ExportVectorEnrichmentJobInput, options: export_vector_enrichment_job.Options) !export_vector_enrichment_job.ExportVectorEnrichmentJobOutput {
        return export_vector_enrichment_job.execute(self, allocator, input, options);
    }

    /// Get the details for a previously initiated Earth Observation job.
    pub fn getEarthObservationJob(self: *Self, allocator: std.mem.Allocator, input: get_earth_observation_job.GetEarthObservationJobInput, options: get_earth_observation_job.Options) !get_earth_observation_job.GetEarthObservationJobOutput {
        return get_earth_observation_job.execute(self, allocator, input, options);
    }

    /// Use this operation to get details of a specific raster data collection.
    pub fn getRasterDataCollection(self: *Self, allocator: std.mem.Allocator, input: get_raster_data_collection.GetRasterDataCollectionInput, options: get_raster_data_collection.Options) !get_raster_data_collection.GetRasterDataCollectionOutput {
    ...
    /// Name (ARN).
    pub fn getVectorEnrichmentJob(self: *Self, allocator: std.mem.Allocator, input: get_vector_enrichment_job.GetVectorEnrichmentJobInput, options: get_vector_enrichment_job.Options) !get_vector_enrichment_job.GetVectorEnrichmentJobOutput {
    ...
    pub fn listEarthObservationJobs(self: *Self, allocator: std.mem.Allocator, input: list_earth_observation_jobs.ListEarthObservationJobsInput, options: list_earth_observation_jobs.Options) !list_earth_observation_jobs.ListEarthObservationJobsOutput {
        return list_earth_observation_jobs.execute(self, allocator, input, options);
    }

    /// Use this operation to get raster data collections.
    pub fn listRasterDataCollections(self: *Self, allocator: std.mem.Allocator, input: list_raster_data_collections.ListRasterDataCollectionsInput, options: list_raster_data_collections.Options) !list_raster_data_collections.ListRasterDataCollectionsOutput {
    ...
    pub fn listVectorEnrichmentJobs(self: *Self, allocator: std.mem.Allocator, input: list_vector_enrichment_jobs.ListVectorEnrichmentJobsInput, options: list_vector_enrichment_jobs.Options) !list_vector_enrichment_jobs.ListVectorEnrichmentJobsOutput {
    ...
    pub fn searchRasterDataCollection(self: *Self, allocator: std.mem.Allocator, input: search_raster_data_collection.SearchRasterDataCollectionInput, options: search_raster_data_collection.Options) !search_raster_data_collection.SearchRasterDataCollectionOutput {
        return search_raster_data_collection.execute(self, allocator, input, options);
    }

    /// Use this operation to create an Earth observation job.
    pub fn startEarthObservationJob(self: *Self, allocator: std.mem.Allocator, input: start_earth_observation_job.StartEarthObservationJobInput, options: start_earth_observation_job.Options) !start_earth_observation_job.StartEarthObservationJobOutput {
    ...
    pub fn startVectorEnrichmentJob(self: *Self, allocator: std.mem.Allocator, input: start_vector_enrichment_job.StartVectorEnrichmentJobInput, options: start_vector_enrichment_job.Options) !start_vector_enrichment_job.StartVectorEnrichmentJobOutput {
        return start_vector_enrichment_job.execute(self, allocator, input, options);
    }

    /// Use this operation to stop an existing earth observation job.
    pub fn stopEarthObservationJob(self: *Self, allocator: std.mem.Allocator, input: stop_earth_observation_job.StopEarthObservationJobInput, options: stop_earth_observation_job.Options) !stop_earth_observation_job.StopEarthObservationJobOutput {
        return stop_earth_observation_job.execute(self, allocator, input, options);
    }

    /// Stops the Vector Enrichment job for a given job ARN.
    pub fn stopVectorEnrichmentJob(self: *Self, allocator: std.mem.Allocator, input: stop_vector_enrichment_job.StopVectorEnrichmentJobInput, options: stop_vector_enrichment_job.Options) !stop_vector_enrichment_job.StopVectorEnrichmentJobOutput {
