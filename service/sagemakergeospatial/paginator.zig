...
pub const ListEarthObservationJobsPaginator = struct {
    client: *Client,
    params: list_earth_observation_jobs.ListEarthObservationJobsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_earth_observation_jobs.ListEarthObservationJobsOutput {
        ...
        const output = try list_earth_observation_jobs.execute(self.client, allocator, self.params, options);
...
pub const ListRasterDataCollectionsPaginator = struct {
    client: *Client,
    params: list_raster_data_collections.ListRasterDataCollectionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_raster_data_collections.ListRasterDataCollectionsOutput {
        ...
        const output = try list_raster_data_collections.execute(self.client, allocator, self.params, options);
...
pub const ListVectorEnrichmentJobsPaginator = struct {
    client: *Client,
    params: list_vector_enrichment_jobs.ListVectorEnrichmentJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_vector_enrichment_jobs.ListVectorEnrichmentJobsOutput {
        ...
        const output = try list_vector_enrichment_jobs.execute(self.client, allocator, self.params, options);
...
pub const SearchRasterDataCollectionPaginator = struct {
    client: *Client,
    params: search_raster_data_collection.SearchRasterDataCollectionInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_raster_data_collection.SearchRasterDataCollectionOutput {
        ...
        const output = try search_raster_data_collection.execute(self.client, allocator, self.params, options);
