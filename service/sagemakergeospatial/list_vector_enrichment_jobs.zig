...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListVectorEnrichmentJobsInput, options: Options) !ListVectorEnrichmentJobsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListVectorEnrichmentJobsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListVectorEnrichmentJobsOutput {
    var result: ListVectorEnrichmentJobsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListVectorEnrichmentJobsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
