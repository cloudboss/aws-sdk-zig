...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetPersistentAppUIPresignedURLInput, options: Options) !GetPersistentAppUIPresignedURLOutput {
