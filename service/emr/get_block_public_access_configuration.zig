...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBlockPublicAccessConfigurationInput, options: Options) !GetBlockPublicAccessConfigurationOutput {
