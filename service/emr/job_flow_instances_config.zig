...
pub const JobFlowInstancesConfig = struct {
    ...
    ec_2_subnet_ids: ?[]const []const u8 = null,
    ...
    instance_fleets: ?[]const InstanceFleetConfig = null,

    /// Configuration for the instance groups in a cluster.
    instance_groups: ?[]const InstanceGroupConfig = null,
    ...
    master_instance_type: ?[]const u8 = null,
    ...
    slave_instance_type: ?[]const u8 = null,
