...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOnClusterAppUIPresignedURLInput, options: CallOptions) !GetOnClusterAppUIPresignedURLOutput {
