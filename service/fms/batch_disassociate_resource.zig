...
pub const BatchDisassociateResourceInput = struct {
...
pub const BatchDisassociateResourceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDisassociateResourceInput, options: CallOptions) !BatchDisassociateResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchDisassociateResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSFMS_20180101.BatchDisassociateResource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !BatchDisassociateResourceOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(BatchDisassociateResourceOutput, body, allocator);
}
