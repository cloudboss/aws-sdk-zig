...
pub const DisassociateAdminAccountInput = struct {
};

pub const DisassociateAdminAccountOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateAdminAccountInput, options: CallOptions) !DisassociateAdminAccountOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateAdminAccountInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSFMS_20180101.DisassociateAdminAccount");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateAdminAccountOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
