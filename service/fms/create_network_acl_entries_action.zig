...
pub const CreateNetworkAclEntriesAction = struct {
    ...
    network_acl_entries_to_be_created: ?[]const EntryDescription = null,
    ...
    pub const json_field_names = .{
        ...
        .network_acl_entries_to_be_created = "NetworkAclEntriesToBeCreated",
