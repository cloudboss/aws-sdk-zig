...
pub const DeleteAppsListInput = struct {
...
pub const DeleteAppsListOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppsListInput, options: CallOptions) !DeleteAppsListOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppsListInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSFMS_20180101.DeleteAppsList");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAppsListOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
