...
const AssociateAdminAccountOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateAdminAccountInput, options: Options) !AssociateAdminAccountOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateAdminAccountInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSFMS_20180101.AssociateAdminAccount");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateAdminAccountOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
