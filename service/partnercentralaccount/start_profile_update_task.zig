...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartProfileUpdateTaskInput, options: Options) !StartProfileUpdateTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartProfileUpdateTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PartnerCentralAccount.StartProfileUpdateTask");
