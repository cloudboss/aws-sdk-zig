...
pub const Client = struct {
    ...
    pub fn acceptConnectionInvitation(self: *Self, allocator: std.mem.Allocator, input: accept_connection_invitation.AcceptConnectionInvitationInput, options: accept_connection_invitation.Options) !accept_connection_invitation.AcceptConnectionInvitationOutput {
    ...
    /// relationship.
    pub fn cancelConnection(self: *Self, allocator: std.mem.Allocator, input: cancel_connection.CancelConnectionInput, options: cancel_connection.Options) !cancel_connection.CancelConnectionOutput {
    ...
    /// rejected.
    pub fn cancelConnectionInvitation(self: *Self, allocator: std.mem.Allocator, input: cancel_connection_invitation.CancelConnectionInvitationInput, options: cancel_connection_invitation.Options) !cancel_connection_invitation.CancelConnectionInvitationOutput {
    ...
    /// the partner profile.
    pub fn cancelProfileUpdateTask(self: *Self, allocator: std.mem.Allocator, input: cancel_profile_update_task.CancelProfileUpdateTaskInput, options: cancel_profile_update_task.Options) !cancel_profile_update_task.CancelProfileUpdateTaskOutput {
    ...
    /// organization.
    pub fn createConnectionInvitation(self: *Self, allocator: std.mem.Allocator, input: create_connection_invitation.CreateConnectionInvitationInput, options: create_connection_invitation.Options) !create_connection_invitation.CreateConnectionInvitationOutput {
    ...
    pub fn createPartner(self: *Self, allocator: std.mem.Allocator, input: create_partner.CreatePartnerInput, options: create_partner.Options) !create_partner.CreatePartnerOutput {
    ...
    pub fn getAllianceLeadContact(self: *Self, allocator: std.mem.Allocator, input: get_alliance_lead_contact.GetAllianceLeadContactInput, options: get_alliance_lead_contact.Options) !get_alliance_lead_contact.GetAllianceLeadContactOutput {
    ...
    pub fn getConnectionInvitation(self: *Self, allocator: std.mem.Allocator, input: get_connection_invitation.GetConnectionInvitationInput, options: get_connection_invitation.Options) !get_connection_invitation.GetConnectionInvitationOutput {
    ...
    pub fn getConnectionPreferences(self: *Self, allocator: std.mem.Allocator, input: get_connection_preferences.GetConnectionPreferencesInput, options: get_connection_preferences.Options) !get_connection_preferences.GetConnectionPreferencesOutput {
    ...
    pub fn getPartner(self: *Self, allocator: std.mem.Allocator, input: get_partner.GetPartnerInput, options: get_partner.Options) !get_partner.GetPartnerOutput {
        return get_partner.execute(self, allocator, input, options);
    }

    /// Retrieves information about a specific profile update task.
    pub fn getProfileUpdateTask(self: *Self, allocator: std.mem.Allocator, input: get_profile_update_task.GetProfileUpdateTaskInput, options: get_profile_update_task.Options) !get_profile_update_task.GetProfileUpdateTaskOutput {
    ...
    pub fn getProfileVisibility(self: *Self, allocator: std.mem.Allocator, input: get_profile_visibility.GetProfileVisibilityInput, options: get_profile_visibility.Options) !get_profile_visibility.GetProfileVisibilityOutput {
    ...
    pub fn getVerification(self: *Self, allocator: std.mem.Allocator, input: get_verification.GetVerificationInput, options: get_verification.Options) !get_verification.GetVerificationOutput {
    ...
    pub fn listConnectionInvitations(self: *Self, allocator: std.mem.Allocator, input: list_connection_invitations.ListConnectionInvitationsInput, options: list_connection_invitations.Options) !list_connection_invitations.ListConnectionInvitationsOutput {
    ...
    /// partners.
    pub fn listPartners(self: *Self, allocator: std.mem.Allocator, input: list_partners.ListPartnersInput, options: list_partners.Options) !list_partners.ListPartnersOutput {
    ...
    /// account.
    pub fn putAllianceLeadContact(self: *Self, allocator: std.mem.Allocator, input: put_alliance_lead_contact.PutAllianceLeadContactInput, options: put_alliance_lead_contact.Options) !put_alliance_lead_contact.PutAllianceLeadContactOutput {
    ...
    pub fn putProfileVisibility(self: *Self, allocator: std.mem.Allocator, input: put_profile_visibility.PutProfileVisibilityInput, options: put_profile_visibility.Options) !put_profile_visibility.PutProfileVisibilityOutput {
    ...
    /// partnership request.
    pub fn rejectConnectionInvitation(self: *Self, allocator: std.mem.Allocator, input: reject_connection_invitation.RejectConnectionInvitationInput, options: reject_connection_invitation.Options) !reject_connection_invitation.RejectConnectionInvitationOutput {
    ...
    pub fn sendEmailVerificationCode(self: *Self, allocator: std.mem.Allocator, input: send_email_verification_code.SendEmailVerificationCodeInput, options: send_email_verification_code.Options) !send_email_verification_code.SendEmailVerificationCodeOutput {
    ...
    /// asynchronously.
    pub fn startProfileUpdateTask(self: *Self, allocator: std.mem.Allocator, input: start_profile_update_task.StartProfileUpdateTaskInput, options: start_profile_update_task.Options) !start_profile_update_task.StartProfileUpdateTaskOutput {
    ...
    /// Central.
    pub fn startVerification(self: *Self, allocator: std.mem.Allocator, input: start_verification.StartVerificationInput, options: start_verification.Options) !start_verification.StartVerificationOutput {
    ...
    /// settings and exclusions.
    pub fn updateConnectionPreferences(self: *Self, allocator: std.mem.Allocator, input: update_connection_preferences.UpdateConnectionPreferencesInput, options: update_connection_preferences.Options) !update_connection_preferences.UpdateConnectionPreferencesOutput {
