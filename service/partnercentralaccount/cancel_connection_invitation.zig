...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelConnectionInvitationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PartnerCentralAccount.CancelConnectionInvitation");
