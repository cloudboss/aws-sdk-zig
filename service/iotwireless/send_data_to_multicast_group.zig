...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SendDataToMulticastGroupInput, options: CallOptions) !SendDataToMulticastGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SendDataToMulticastGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.wireless_metadata), input.wireless_metadata, allocator, &body_buf);
    has_prev = true;
