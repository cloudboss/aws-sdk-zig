...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEventConfigurationsInput, options: Options) !ListEventConfigurationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListEventConfigurationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListEventConfigurationsOutput {
    var result: ListEventConfigurationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListEventConfigurationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
