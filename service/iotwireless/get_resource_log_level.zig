...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetResourceLogLevelInput, options: CallOptions) !GetResourceLogLevelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetResourceLogLevelInput, config: *aws.Config) !aws.http.Request {
