...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartWirelessDeviceImportTaskInput, options: CallOptions) !StartWirelessDeviceImportTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartWirelessDeviceImportTaskInput, config: *aws.Config) !aws.http.Request {
