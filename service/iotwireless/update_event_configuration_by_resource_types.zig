...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEventConfigurationByResourceTypesInput, options: Options) !UpdateEventConfigurationByResourceTypesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateEventConfigurationByResourceTypesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateEventConfigurationByResourceTypesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
