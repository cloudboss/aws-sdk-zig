...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterWirelessDeviceInput, options: CallOptions) !DeregisterWirelessDeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterWirelessDeviceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/deregister");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterWirelessDeviceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
