...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListWirelessDeviceImportTasksInput, options: CallOptions) !ListWirelessDeviceImportTasksOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListWirelessDeviceImportTasksInput, config: *aws.Config) !aws.http.Request {
