...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateWirelessGatewayTaskDefinitionInput, options: Options) !CreateWirelessGatewayTaskDefinitionOutput {
