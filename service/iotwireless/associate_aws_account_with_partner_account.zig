...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateAwsAccountWithPartnerAccountInput, options: CallOptions) !AssociateAwsAccountWithPartnerAccountOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateAwsAccountWithPartnerAccountInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateAwsAccountWithPartnerAccountOutput {
    var result: AssociateAwsAccountWithPartnerAccountOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(AssociateAwsAccountWithPartnerAccountOutput, body, allocator);
    }
    _ = status;
    _ = headers;
