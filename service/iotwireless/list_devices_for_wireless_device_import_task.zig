...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDevicesForWirelessDeviceImportTaskInput, options: Options) !ListDevicesForWirelessDeviceImportTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDevicesForWirelessDeviceImportTaskInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDevicesForWirelessDeviceImportTaskOutput {
    var result: ListDevicesForWirelessDeviceImportTaskOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListDevicesForWirelessDeviceImportTaskOutput, body, alloc);
    }
    _ = status;
    _ = headers;
