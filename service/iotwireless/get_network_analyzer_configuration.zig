...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetNetworkAnalyzerConfigurationInput, options: Options) !GetNetworkAnalyzerConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetNetworkAnalyzerConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetNetworkAnalyzerConfigurationOutput {
    var result: GetNetworkAnalyzerConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetNetworkAnalyzerConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
