...
const UpdateQuerySuggestionsConfigOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateQuerySuggestionsConfigInput, options: Options) !UpdateQuerySuggestionsConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateQuerySuggestionsConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSKendraFrontendService.UpdateQuerySuggestionsConfig");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateQuerySuggestionsConfigOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
