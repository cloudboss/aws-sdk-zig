...
const DeletePrincipalMappingOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePrincipalMappingInput, options: Options) !DeletePrincipalMappingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePrincipalMappingInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSKendraFrontendService.DeletePrincipalMapping");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePrincipalMappingOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
