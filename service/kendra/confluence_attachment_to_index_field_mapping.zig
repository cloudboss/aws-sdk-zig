const ConfluenceAttachmentFieldName = @import("confluence_attachment_field_name.zig").ConfluenceAttachmentFieldName;
...
/// metadata.
pub const ConfluenceAttachmentToIndexFieldMapping = struct {
    /// The name of the field in the data source.
    ///
    /// You must first create the index field using the `UpdateIndex` API.
    data_source_field_name: ?ConfluenceAttachmentFieldName = null,
