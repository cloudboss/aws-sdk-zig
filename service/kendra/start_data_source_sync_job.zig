...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartDataSourceSyncJobInput, options: CallOptions) !StartDataSourceSyncJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartDataSourceSyncJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSKendraFrontendService.StartDataSourceSyncJob");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartDataSourceSyncJobOutput {
    ...
    return aws.json.parseJsonObject(StartDataSourceSyncJobOutput, body, allocator);
}
