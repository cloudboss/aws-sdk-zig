...
const UpdateExperienceOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateExperienceInput, options: Options) !UpdateExperienceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateExperienceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSKendraFrontendService.UpdateExperience");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateExperienceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
