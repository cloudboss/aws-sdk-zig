...
pub const AssociateEntitiesToExperienceInput = struct {
...
pub const AssociateEntitiesToExperienceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateEntitiesToExperienceInput, options: CallOptions) !AssociateEntitiesToExperienceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateEntitiesToExperienceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSKendraFrontendService.AssociateEntitiesToExperience");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateEntitiesToExperienceOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(AssociateEntitiesToExperienceOutput, body, allocator);
}
