...
const DeleteDataSourceInput = @import("delete_data_source_request.zig").DeleteDataSourceRequest;

const DeleteDataSourceOutput = struct {};
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDataSourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSKendraFrontendService.DeleteDataSource");
