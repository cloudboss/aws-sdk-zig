...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEksAnywhereSubscriptionInput, options: CallOptions) !DeleteEksAnywhereSubscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEksAnywhereSubscriptionInput, config: *aws.Config) !aws.http.Request {
