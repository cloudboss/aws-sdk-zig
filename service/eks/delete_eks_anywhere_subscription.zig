...
pub const DeleteEksAnywhereSubscriptionInput = struct {
...
pub const DeleteEksAnywhereSubscriptionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEksAnywhereSubscriptionInput, options: Options) !DeleteEksAnywhereSubscriptionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteEksAnywhereSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteEksAnywhereSubscriptionOutput {
    var result: DeleteEksAnywhereSubscriptionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteEksAnywhereSubscriptionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
