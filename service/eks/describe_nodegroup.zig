...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeNodegroupInput, options: CallOptions) !DescribeNodegroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeNodegroupInput, config: *aws.Config) !aws.http.Request {
