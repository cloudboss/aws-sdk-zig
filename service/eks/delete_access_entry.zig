...
pub const DeleteAccessEntryInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessEntryInput, options: Options) !DeleteAccessEntryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccessEntryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccessEntryOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessEntryOutput = .{};
