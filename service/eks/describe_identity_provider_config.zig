...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeIdentityProviderConfigInput, options: Options) !DescribeIdentityProviderConfigOutput {
