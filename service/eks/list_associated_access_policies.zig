...
pub const ListAssociatedAccessPoliciesInput = struct {
...
pub const ListAssociatedAccessPoliciesOutput = struct {
    /// The list of access policies associated with the access entry.
    associated_access_policies: ?[]const AssociatedAccessPolicy = null,
    ...
    pub const json_field_names = .{
        .associated_access_policies = "associatedAccessPolicies",
        .cluster_name = "clusterName",
        .next_token = "nextToken",
        .principal_arn = "principalArn",
    };
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssociatedAccessPoliciesInput, options: Options) !ListAssociatedAccessPoliciesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListAssociatedAccessPoliciesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListAssociatedAccessPoliciesOutput {
    var result: ListAssociatedAccessPoliciesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAssociatedAccessPoliciesOutput, body, alloc);
    }
    _ = status;
    _ = headers;
