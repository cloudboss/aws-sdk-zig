...
pub const DescribePodIdentityAssociationInput = struct {
...
pub const DescribePodIdentityAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribePodIdentityAssociationInput, options: CallOptions) !DescribePodIdentityAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribePodIdentityAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribePodIdentityAssociationOutput {
    var result: DescribePodIdentityAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribePodIdentityAssociationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
