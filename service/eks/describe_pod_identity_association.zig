...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribePodIdentityAssociationInput, options: Options) !DescribePodIdentityAssociationOutput {
