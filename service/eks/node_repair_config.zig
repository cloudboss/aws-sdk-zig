...
pub const NodeRepairConfig = struct {
    ...
    max_parallel_nodes_repaired_count: ?i32,
    ...
    max_parallel_nodes_repaired_percentage: ?i32,
    ...
    node_repair_config_overrides: ?[]const NodeRepairConfigOverrides,
