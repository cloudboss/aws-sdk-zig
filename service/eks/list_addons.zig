...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAddonsInput, options: CallOptions) !ListAddonsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAddonsInput, config: *aws.Config) !aws.http.Request {
