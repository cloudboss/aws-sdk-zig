...
pub const DeletePodIdentityAssociationInput = struct {
...
pub const DeletePodIdentityAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePodIdentityAssociationInput, options: CallOptions) !DeletePodIdentityAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePodIdentityAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePodIdentityAssociationOutput {
    var result: DeletePodIdentityAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeletePodIdentityAssociationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
