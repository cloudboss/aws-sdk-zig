...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeFargateProfileInput, options: CallOptions) !DescribeFargateProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeFargateProfileInput, config: *aws.Config) !aws.http.Request {
