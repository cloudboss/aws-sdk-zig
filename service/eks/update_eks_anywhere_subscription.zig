...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEksAnywhereSubscriptionInput, options: CallOptions) !UpdateEksAnywhereSubscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateEksAnywhereSubscriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.auto_renew), input.auto_renew, allocator, &body_buf);
    has_prev = true;
