...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInsightsRefreshInput, options: CallOptions) !DescribeInsightsRefreshOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeInsightsRefreshInput, config: *aws.Config) !aws.http.Request {
