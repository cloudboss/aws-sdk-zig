...
pub const GetCustomDomainAssociationInput = struct {
...
pub const GetCustomDomainAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCustomDomainAssociationInput, options: CallOptions) !GetCustomDomainAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCustomDomainAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "RedshiftServerless.GetCustomDomainAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetCustomDomainAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetCustomDomainAssociationOutput, body, allocator);
}
