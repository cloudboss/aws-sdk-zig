...
pub const Client = struct {
    ...
    pub fn convertRecoveryPointToSnapshot(self: *Self, allocator: std.mem.Allocator, input: convert_recovery_point_to_snapshot.ConvertRecoveryPointToSnapshotInput, options: convert_recovery_point_to_snapshot.Options) !convert_recovery_point_to_snapshot.ConvertRecoveryPointToSnapshotOutput {
    ...
    pub fn createReservation(self: *Self, allocator: std.mem.Allocator, input: create_reservation.CreateReservationInput, options: create_reservation.Options) !create_reservation.CreateReservationOutput {
    ...
    pub fn createSnapshotCopyConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_snapshot_copy_configuration.CreateSnapshotCopyConfigurationInput, options: create_snapshot_copy_configuration.Options) !create_snapshot_copy_configuration.CreateSnapshotCopyConfigurationOutput {
    ...
    pub fn createWorkgroup(self: *Self, allocator: std.mem.Allocator, input: create_workgroup.CreateWorkgroupInput, options: create_workgroup.Options) !create_workgroup.CreateWorkgroupOutput {
    ...
    pub fn deleteSnapshotCopyConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_snapshot_copy_configuration.DeleteSnapshotCopyConfigurationInput, options: delete_snapshot_copy_configuration.Options) !delete_snapshot_copy_configuration.DeleteSnapshotCopyConfigurationOutput {
    ...
    /// Deletes a workgroup.
    pub fn deleteWorkgroup(self: *Self, allocator: std.mem.Allocator, input: delete_workgroup.DeleteWorkgroupInput, options: delete_workgroup.Options) !delete_workgroup.DeleteWorkgroupOutput {
    ...
    pub fn getCredentials(self: *Self, allocator: std.mem.Allocator, input: get_credentials.GetCredentialsInput, options: get_credentials.Options) !get_credentials.GetCredentialsOutput {
        return get_credentials.execute(self, allocator, input, options);
    }

    /// Gets information about a specific custom domain association.
    pub fn getCustomDomainAssociation(self: *Self, allocator: std.mem.Allocator, input: get_custom_domain_association.GetCustomDomainAssociationInput, options: get_custom_domain_association.Options) !get_custom_domain_association.GetCustomDomainAssociationOutput {
        return get_custom_domain_association.execute(self, allocator, input, options);
    }

    /// Returns information, such as the name, about a VPC endpoint.
    pub fn getEndpointAccess(self: *Self, allocator: std.mem.Allocator, input: get_endpoint_access.GetEndpointAccessInput, options: get_endpoint_access.Options) !get_endpoint_access.GetEndpointAccessOutput {
    ...
    pub fn getRecoveryPoint(self: *Self, allocator: std.mem.Allocator, input: get_recovery_point.GetRecoveryPointInput, options: get_recovery_point.Options) !get_recovery_point.GetRecoveryPointOutput {
    ...
    /// option to commit to a specified number of Redshift Processing Units (RPUs)
    /// for a year at a discount from Serverless on-demand (OD) rates.
    pub fn getReservation(self: *Self, allocator: std.mem.Allocator, input: get_reservation.GetReservationInput, options: get_reservation.Options) !get_reservation.GetReservationOutput {
    ...
    pub fn getReservationOffering(self: *Self, allocator: std.mem.Allocator, input: get_reservation_offering.GetReservationOfferingInput, options: get_reservation_offering.Options) !get_reservation_offering.GetReservationOfferingOutput {
    ...
    pub fn getScheduledAction(self: *Self, allocator: std.mem.Allocator, input: get_scheduled_action.GetScheduledActionInput, options: get_scheduled_action.Options) !get_scheduled_action.GetScheduledActionOutput {
        return get_scheduled_action.execute(self, allocator, input, options);
    }

    /// Returns information about a specific snapshot.
    pub fn getSnapshot(self: *Self, allocator: std.mem.Allocator, input: get_snapshot.GetSnapshotInput, options: get_snapshot.Options) !get_snapshot.GetSnapshotOutput {
        return get_snapshot.execute(self, allocator, input, options);
    }

    /// Returns information about a `TableRestoreStatus` object.
    pub fn getTableRestoreStatus(self: *Self, allocator: std.mem.Allocator, input: get_table_restore_status.GetTableRestoreStatusInput, options: get_table_restore_status.Options) !get_table_restore_status.GetTableRestoreStatusOutput {
        return get_table_restore_status.execute(self, allocator, input, options);
    }

    /// Get the Redshift Serverless version for a specified track.
    pub fn getTrack(self: *Self, allocator: std.mem.Allocator, input: get_track.GetTrackInput, options: get_track.Options) !get_track.GetTrackOutput {
        return get_track.execute(self, allocator, input, options);
    }

    /// Returns information about a usage limit.
    pub fn getUsageLimit(self: *Self, allocator: std.mem.Allocator, input: get_usage_limit.GetUsageLimitInput, options: get_usage_limit.Options) !get_usage_limit.GetUsageLimitOutput {
        return get_usage_limit.execute(self, allocator, input, options);
    }

    /// Returns information about a specific workgroup.
    pub fn getWorkgroup(self: *Self, allocator: std.mem.Allocator, input: get_workgroup.GetWorkgroupInput, options: get_workgroup.Options) !get_workgroup.GetWorkgroupOutput {
        return get_workgroup.execute(self, allocator, input, options);
    }

    /// Lists custom domain associations for Amazon Redshift Serverless.
    pub fn listCustomDomainAssociations(self: *Self, allocator: std.mem.Allocator, input: list_custom_domain_associations.ListCustomDomainAssociationsInput, options: list_custom_domain_associations.Options) !list_custom_domain_associations.ListCustomDomainAssociationsOutput {
        return list_custom_domain_associations.execute(self, allocator, input, options);
    }

    /// Returns an array of `EndpointAccess` objects and relevant information.
    pub fn listEndpointAccess(self: *Self, allocator: std.mem.Allocator, input: list_endpoint_access.ListEndpointAccessInput, options: list_endpoint_access.Options) !list_endpoint_access.ListEndpointAccessOutput {
    ...
    /// account.
    pub fn listManagedWorkgroups(self: *Self, allocator: std.mem.Allocator, input: list_managed_workgroups.ListManagedWorkgroupsInput, options: list_managed_workgroups.Options) !list_managed_workgroups.ListManagedWorkgroupsOutput {
    ...
    pub fn listRecoveryPoints(self: *Self, allocator: std.mem.Allocator, input: list_recovery_points.ListRecoveryPointsInput, options: list_recovery_points.Options) !list_recovery_points.ListRecoveryPointsOutput {
    ...
    pub fn listReservationOfferings(self: *Self, allocator: std.mem.Allocator, input: list_reservation_offerings.ListReservationOfferingsInput, options: list_reservation_offerings.Options) !list_reservation_offerings.ListReservationOfferingsOutput {
    ...
    pub fn listSnapshotCopyConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_snapshot_copy_configurations.ListSnapshotCopyConfigurationsInput, options: list_snapshot_copy_configurations.Options) !list_snapshot_copy_configurations.ListSnapshotCopyConfigurationsOutput {
        return list_snapshot_copy_configurations.execute(self, allocator, input, options);
    }

    /// Returns a list of snapshots.
    pub fn listSnapshots(self: *Self, allocator: std.mem.Allocator, input: list_snapshots.ListSnapshotsInput, options: list_snapshots.Options) !list_snapshots.ListSnapshotsOutput {
        return list_snapshots.execute(self, allocator, input, options);
    }

    /// Returns information about an array of `TableRestoreStatus` objects.
    pub fn listTableRestoreStatus(self: *Self, allocator: std.mem.Allocator, input: list_table_restore_status.ListTableRestoreStatusInput, options: list_table_restore_status.Options) !list_table_restore_status.ListTableRestoreStatusOutput {
    ...
    pub fn listTracks(self: *Self, allocator: std.mem.Allocator, input: list_tracks.ListTracksInput, options: list_tracks.Options) !list_tracks.ListTracksOutput {
        return list_tracks.execute(self, allocator, input, options);
    }

    /// Lists all usage limits within Amazon Redshift Serverless.
    pub fn listUsageLimits(self: *Self, allocator: std.mem.Allocator, input: list_usage_limits.ListUsageLimitsInput, options: list_usage_limits.Options) !list_usage_limits.ListUsageLimitsOutput {
        return list_usage_limits.execute(self, allocator, input, options);
    }

    /// Returns information about a list of specified workgroups.
    pub fn listWorkgroups(self: *Self, allocator: std.mem.Allocator, input: list_workgroups.ListWorkgroupsInput, options: list_workgroups.Options) !list_workgroups.ListWorkgroupsOutput {
    ...
    pub fn restoreFromRecoveryPoint(self: *Self, allocator: std.mem.Allocator, input: restore_from_recovery_point.RestoreFromRecoveryPointInput, options: restore_from_recovery_point.Options) !restore_from_recovery_point.RestoreFromRecoveryPointOutput {
    ...
    /// sort keys.
    pub fn restoreTableFromRecoveryPoint(self: *Self, allocator: std.mem.Allocator, input: restore_table_from_recovery_point.RestoreTableFromRecoveryPointInput, options: restore_table_from_recovery_point.Options) !restore_table_from_recovery_point.RestoreTableFromRecoveryPointOutput {
    ...
    pub fn restoreTableFromSnapshot(self: *Self, allocator: std.mem.Allocator, input: restore_table_from_snapshot.RestoreTableFromSnapshotInput, options: restore_table_from_snapshot.Options) !restore_table_from_snapshot.RestoreTableFromSnapshotOutput {
    ...
    /// domain.
    pub fn updateCustomDomainAssociation(self: *Self, allocator: std.mem.Allocator, input: update_custom_domain_association.UpdateCustomDomainAssociationInput, options: update_custom_domain_association.Options) !update_custom_domain_association.UpdateCustomDomainAssociationOutput {
        return update_custom_domain_association.execute(self, allocator, input, options);
    }

    /// Updates an Amazon Redshift Serverless managed endpoint.
    pub fn updateEndpointAccess(self: *Self, allocator: std.mem.Allocator, input: update_endpoint_access.UpdateEndpointAccessInput, options: update_endpoint_access.Options) !update_endpoint_access.UpdateEndpointAccessOutput {
    ...
    pub fn updateLakehouseConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_lakehouse_configuration.UpdateLakehouseConfigurationInput, options: update_lakehouse_configuration.Options) !update_lakehouse_configuration.UpdateLakehouseConfigurationOutput {
    ...
    pub fn updateNamespace(self: *Self, allocator: std.mem.Allocator, input: update_namespace.UpdateNamespaceInput, options: update_namespace.Options) !update_namespace.UpdateNamespaceOutput {
    ...
    pub fn updateSnapshotCopyConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_snapshot_copy_configuration.UpdateSnapshotCopyConfigurationInput, options: update_snapshot_copy_configuration.Options) !update_snapshot_copy_configuration.UpdateSnapshotCopyConfigurationOutput {
    ...
    pub fn updateUsageLimit(self: *Self, allocator: std.mem.Allocator, input: update_usage_limit.UpdateUsageLimitInput, options: update_usage_limit.Options) !update_usage_limit.UpdateUsageLimitOutput {
    ...
    /// For more information about VPC BPA, see [Block public access to VPCs and
    /// subnets](https://docs.aws.amazon.com/vpc/latest/userguide/security-vpc-bpa.html) in the *Amazon VPC User Guide*.
    pub fn updateWorkgroup(self: *Self, allocator: std.mem.Allocator, input: update_workgroup.UpdateWorkgroupInput, options: update_workgroup.Options) !update_workgroup.UpdateWorkgroupOutput {
