...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        dry_run_exception: DryRunException,
        insufficient_capacity_exception: InsufficientCapacityException,
        internal_server_exception: InternalServerException,
        invalid_pagination_exception: InvalidPaginationException,
        ipv_6_cidr_block_not_found_exception: Ipv6CidrBlockNotFoundException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .dry_run_exception => |e| e.message,
                .insufficient_capacity_exception => |e| e.message,
                .internal_server_exception => |e| e.message,
                .invalid_pagination_exception => |e| e.message,
                .ipv_6_cidr_block_not_found_exception => |e| e.message,
        ...
        pub fn httpStatus(self: Kind) u16 {
            return switch (self) {
                ...
                .dry_run_exception => 400,
                .insufficient_capacity_exception => 400,
                .internal_server_exception => 500,
                .invalid_pagination_exception => 400,
                .ipv_6_cidr_block_not_found_exception => 400,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .dry_run_exception => |e| e.request_id,
                .insufficient_capacity_exception => |e| e.request_id,
                .internal_server_exception => |e| e.request_id,
                .invalid_pagination_exception => |e| e.request_id,
                .ipv_6_cidr_block_not_found_exception => |e| e.request_id,
