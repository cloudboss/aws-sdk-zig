...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateWorkgroupInput, options: Options) !UpdateWorkgroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateWorkgroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "RedshiftServerless.UpdateWorkgroup");
