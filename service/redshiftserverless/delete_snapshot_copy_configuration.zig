...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSnapshotCopyConfigurationInput, options: Options) !DeleteSnapshotCopyConfigurationOutput {
