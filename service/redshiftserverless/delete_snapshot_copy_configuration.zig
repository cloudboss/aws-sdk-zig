...
pub const DeleteSnapshotCopyConfigurationInput = struct {
...
pub const DeleteSnapshotCopyConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSnapshotCopyConfigurationInput, options: CallOptions) !DeleteSnapshotCopyConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSnapshotCopyConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "RedshiftServerless.DeleteSnapshotCopyConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSnapshotCopyConfigurationOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DeleteSnapshotCopyConfigurationOutput, body, allocator);
}
