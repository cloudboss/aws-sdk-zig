...
pub const UpdateCustomDomainAssociationInput = struct {
...
pub const UpdateCustomDomainAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCustomDomainAssociationInput, options: CallOptions) !UpdateCustomDomainAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCustomDomainAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "RedshiftServerless.UpdateCustomDomainAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateCustomDomainAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateCustomDomainAssociationOutput, body, allocator);
}
