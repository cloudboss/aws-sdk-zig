...
pub const ListConfigurationProfilesPaginator = struct {
    client: *Client,
    params: list_configuration_profiles.ListConfigurationProfilesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_configuration_profiles.Options) !list_configuration_profiles.ListConfigurationProfilesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDeploymentStrategiesPaginator = struct {
    client: *Client,
    params: list_deployment_strategies.ListDeploymentStrategiesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_deployment_strategies.Options) !list_deployment_strategies.ListDeploymentStrategiesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListExtensionAssociationsPaginator = struct {
    client: *Client,
    params: list_extension_associations.ListExtensionAssociationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_extension_associations.Options) !list_extension_associations.ListExtensionAssociationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListExtensionsPaginator = struct {
    client: *Client,
    params: list_extensions.ListExtensionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_extensions.Options) !list_extensions.ListExtensionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListHostedConfigurationVersionsPaginator = struct {
    client: *Client,
    params: list_hosted_configuration_versions.ListHostedConfigurationVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_hosted_configuration_versions.Options) !list_hosted_configuration_versions.ListHostedConfigurationVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
