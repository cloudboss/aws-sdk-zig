...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateExtensionAssociationInput, options: CallOptions) !UpdateExtensionAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateExtensionAssociationInput, config: *aws.Config) !aws.http.Request {
