...
pub const GetHostedConfigurationVersionInput = struct {
    /// The application ID.
...
pub const GetHostedConfigurationVersionOutput = struct {
    /// The application ID.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHostedConfigurationVersionInput, options: CallOptions) !GetHostedConfigurationVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetHostedConfigurationVersionInput, config: *aws.Config) !aws.http.Request {
