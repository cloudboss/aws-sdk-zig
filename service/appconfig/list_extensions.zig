...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListExtensionsInput, options: CallOptions) !ListExtensionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListExtensionsInput, config: *aws.Config) !aws.http.Request {
