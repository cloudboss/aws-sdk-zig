...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateExtensionInput, options: CallOptions) !CreateExtensionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateExtensionInput, config: *aws.Config) !aws.http.Request {
