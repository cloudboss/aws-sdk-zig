...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListHostedConfigurationVersionsInput, options: CallOptions) !ListHostedConfigurationVersionsOutput {
