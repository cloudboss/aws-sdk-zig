...
pub const DeleteConfigurationProfileOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfigurationProfileInput, options: CallOptions) !DeleteConfigurationProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfigurationProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteConfigurationProfileOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
