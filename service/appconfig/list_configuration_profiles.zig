...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConfigurationProfilesInput, options: CallOptions) !ListConfigurationProfilesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListConfigurationProfilesInput, config: *aws.Config) !aws.http.Request {
