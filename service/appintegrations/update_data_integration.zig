...
pub const UpdateDataIntegrationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataIntegrationInput, options: Options) !UpdateDataIntegrationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateDataIntegrationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateDataIntegrationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateDataIntegrationOutput = .{};
