...
pub const UpdateEventIntegrationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEventIntegrationInput, options: Options) !UpdateEventIntegrationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateEventIntegrationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateEventIntegrationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateEventIntegrationOutput = .{};
