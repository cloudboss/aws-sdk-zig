...
pub const DeleteEventIntegrationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEventIntegrationInput, options: Options) !DeleteEventIntegrationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteEventIntegrationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteEventIntegrationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEventIntegrationOutput = .{};
