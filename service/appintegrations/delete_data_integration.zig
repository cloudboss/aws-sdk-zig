...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDataIntegrationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDataIntegrationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
