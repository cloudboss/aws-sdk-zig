...
pub const DeleteDataIntegrationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataIntegrationInput, options: Options) !DeleteDataIntegrationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDataIntegrationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDataIntegrationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDataIntegrationOutput = .{};
