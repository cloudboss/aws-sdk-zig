...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDataIntegrationAssociationsInput, options: Options) !ListDataIntegrationAssociationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDataIntegrationAssociationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDataIntegrationAssociationsOutput {
    var result: ListDataIntegrationAssociationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListDataIntegrationAssociationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
