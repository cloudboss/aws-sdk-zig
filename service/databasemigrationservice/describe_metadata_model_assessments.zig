...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMetadataModelAssessmentsInput, options: Options) !DescribeMetadataModelAssessmentsOutput {
