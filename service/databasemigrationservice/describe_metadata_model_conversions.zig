...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMetadataModelConversionsInput, options: Options) !DescribeMetadataModelConversionsOutput {
