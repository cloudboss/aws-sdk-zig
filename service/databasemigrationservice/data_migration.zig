...
pub const DataMigration = struct {
    ...
    data_migration_arn: ?[]const u8 = null,

    /// The CIDR blocks of the endpoints for the data migration.
    data_migration_cidr_blocks: ?[]const []const u8 = null,

    /// The UTC time when DMS created the data migration.
    data_migration_create_time: ?i64 = null,

    /// The UTC time when data migration ended.
    data_migration_end_time: ?i64 = null,

    /// The user-friendly name for the data migration.
    data_migration_name: ?[]const u8 = null,

    /// Specifies CloudWatch settings and selection rules for the data migration.
    data_migration_settings: ?DataMigrationSettings = null,

    /// The UTC time when DMS started the data migration.
    data_migration_start_time: ?i64 = null,

    /// Provides information about the data migration's run, including start and
    /// stop time,
    /// latency, and data migration progress.
    data_migration_statistics: ?DataMigrationStatistics = null,

    /// The current status of the data migration.
    data_migration_status: ?[]const u8 = null,
    ...
    public_ip_addresses: ?[]const []const u8 = null,
