...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReplicationTableStatisticsInput, options: Options) !DescribeReplicationTableStatisticsOutput {
