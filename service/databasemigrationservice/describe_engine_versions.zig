...
pub const DescribeEngineVersionsOutput = struct {
    /// Returned `EngineVersion` objects that describe the replication instance
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeEngineVersionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonDMSv20160101.DescribeEngineVersions");
