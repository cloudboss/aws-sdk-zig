...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEventSubscriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonDMSv20160101.DeleteEventSubscription");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEventSubscriptionOutput {
    ...
    return aws.json.parseJsonObject(DeleteEventSubscriptionOutput, body, allocator);
}
