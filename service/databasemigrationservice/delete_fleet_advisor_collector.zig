...
pub const DeleteFleetAdvisorCollectorInput = struct {
    /// The reference ID of the Fleet Advisor collector to delete.
    collector_referenced_id: []const u8,
...
pub const DeleteFleetAdvisorCollectorOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFleetAdvisorCollectorInput, options: CallOptions) !DeleteFleetAdvisorCollectorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFleetAdvisorCollectorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonDMSv20160101.DeleteFleetAdvisorCollector");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFleetAdvisorCollectorOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
