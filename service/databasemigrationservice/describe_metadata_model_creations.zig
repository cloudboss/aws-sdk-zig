...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMetadataModelCreationsInput, options: Options) !DescribeMetadataModelCreationsOutput {
