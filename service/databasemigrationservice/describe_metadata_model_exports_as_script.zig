...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMetadataModelExportsAsScriptInput, options: Options) !DescribeMetadataModelExportsAsScriptOutput {
