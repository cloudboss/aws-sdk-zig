...
pub const StartReplicationTaskAssessmentInput = struct {
...
pub const StartReplicationTaskAssessmentOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartReplicationTaskAssessmentInput, options: CallOptions) !StartReplicationTaskAssessmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartReplicationTaskAssessmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonDMSv20160101.StartReplicationTaskAssessment");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartReplicationTaskAssessmentOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(StartReplicationTaskAssessmentOutput, body, allocator);
}
