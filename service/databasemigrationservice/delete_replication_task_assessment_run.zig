...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReplicationTaskAssessmentRunInput, options: Options) !DeleteReplicationTaskAssessmentRunOutput {
