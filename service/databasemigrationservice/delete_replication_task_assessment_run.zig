...
pub const DeleteReplicationTaskAssessmentRunInput = struct {
...
pub const DeleteReplicationTaskAssessmentRunOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteReplicationTaskAssessmentRunInput, options: CallOptions) !DeleteReplicationTaskAssessmentRunOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteReplicationTaskAssessmentRunInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonDMSv20160101.DeleteReplicationTaskAssessmentRun");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteReplicationTaskAssessmentRunOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DeleteReplicationTaskAssessmentRunOutput, body, allocator);
}
