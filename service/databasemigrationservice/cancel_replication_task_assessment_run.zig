...
pub const CancelReplicationTaskAssessmentRunInput = struct {
...
pub const CancelReplicationTaskAssessmentRunOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelReplicationTaskAssessmentRunInput, options: CallOptions) !CancelReplicationTaskAssessmentRunOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelReplicationTaskAssessmentRunInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonDMSv20160101.CancelReplicationTaskAssessmentRun");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelReplicationTaskAssessmentRunOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CancelReplicationTaskAssessmentRunOutput, body, allocator);
}
