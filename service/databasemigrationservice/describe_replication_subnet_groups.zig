...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeReplicationSubnetGroupsInput, options: Options) !DescribeReplicationSubnetGroupsOutput {
