...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOrderableReplicationInstancesInput, options: Options) !DescribeOrderableReplicationInstancesOutput {
