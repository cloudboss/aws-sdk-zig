...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeFleetAdvisorLsaAnalysisInput, options: Options) !DescribeFleetAdvisorLsaAnalysisOutput {
