...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRelationalDatabaseParametersInput, options: Options) !GetRelationalDatabaseParametersOutput {
