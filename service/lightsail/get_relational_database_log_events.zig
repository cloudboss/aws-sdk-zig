...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRelationalDatabaseLogEventsInput, options: Options) !GetRelationalDatabaseLogEventsOutput {
