...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachInstancesFromLoadBalancerInput, options: Options) !DetachInstancesFromLoadBalancerOutput {
