...
pub const DeleteContainerServiceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContainerServiceInput, options: Options) !DeleteContainerServiceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContainerServiceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Lightsail_20161128.DeleteContainerService");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContainerServiceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
