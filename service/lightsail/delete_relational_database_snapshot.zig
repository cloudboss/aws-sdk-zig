...
pub const DeleteRelationalDatabaseSnapshotInput = struct {
...
pub const DeleteRelationalDatabaseSnapshotOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRelationalDatabaseSnapshotInput, options: CallOptions) !DeleteRelationalDatabaseSnapshotOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRelationalDatabaseSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Lightsail_20161128.DeleteRelationalDatabaseSnapshot");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRelationalDatabaseSnapshotOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DeleteRelationalDatabaseSnapshotOutput, body, allocator);
}
