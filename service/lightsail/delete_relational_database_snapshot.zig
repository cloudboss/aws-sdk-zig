...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRelationalDatabaseSnapshotInput, options: Options) !DeleteRelationalDatabaseSnapshotOutput {
