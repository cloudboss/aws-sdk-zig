...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachLoadBalancerTlsCertificateInput, options: Options) !AttachLoadBalancerTlsCertificateOutput {
