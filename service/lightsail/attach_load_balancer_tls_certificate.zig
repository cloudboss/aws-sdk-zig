...
pub const AttachLoadBalancerTlsCertificateInput = struct {
...
pub const AttachLoadBalancerTlsCertificateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachLoadBalancerTlsCertificateInput, options: CallOptions) !AttachLoadBalancerTlsCertificateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachLoadBalancerTlsCertificateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Lightsail_20161128.AttachLoadBalancerTlsCertificate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachLoadBalancerTlsCertificateOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(AttachLoadBalancerTlsCertificateOutput, body, allocator);
}
