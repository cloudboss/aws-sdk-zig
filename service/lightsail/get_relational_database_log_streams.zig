...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRelationalDatabaseLogStreamsInput, options: Options) !GetRelationalDatabaseLogStreamsOutput {
