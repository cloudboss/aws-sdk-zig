...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLoadBalancerTlsCertificateInput, options: Options) !DeleteLoadBalancerTlsCertificateOutput {
