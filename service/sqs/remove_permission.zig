...
pub const RemovePermissionInput = @import("remove_permission_request.zig").RemovePermissionRequest;
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemovePermissionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonSQS.RemovePermission");
