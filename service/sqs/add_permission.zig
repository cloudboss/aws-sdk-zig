...
const AddPermissionInput = @import("add_permission_request.zig").AddPermissionRequest;

const AddPermissionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddPermissionInput, options: Options) !AddPermissionOutput {
