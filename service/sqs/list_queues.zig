...
pub const ListQueuesOutput = struct {
    ...
    pub fn deinit(self: *ListQueuesOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: ListQueuesInput, options: Options) !ListQueuesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListQueuesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSQS.ListQueues");
