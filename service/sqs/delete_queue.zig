...
pub const DeleteQueueOutput = struct {
    ...
    pub fn deinit(self: *DeleteQueueOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteQueueInput, options: Options) !DeleteQueueOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteQueueInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSQS.DeleteQueue");
