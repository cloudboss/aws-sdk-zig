...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateApplicationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/disassociations");
