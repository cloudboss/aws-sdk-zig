...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListStreamGroupsInput, options: CallOptions) !ListStreamGroupsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListStreamGroupsInput, config: *aws.Config) !aws.http.Request {
