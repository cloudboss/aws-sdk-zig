...
pub const TerminateStreamSessionInput = struct {
...
pub const TerminateStreamSessionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TerminateStreamSessionInput, options: CallOptions) !TerminateStreamSessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TerminateStreamSessionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TerminateStreamSessionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: TerminateStreamSessionOutput = .{};
