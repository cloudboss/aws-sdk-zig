...
pub const ListResourcesInput = struct {
    ...
    ///
    /// The `ListResources` operation does not generate a `NextToken` if you set
    /// `MaxResults` to 1000.
    ...
    /// which you called this operation. If the Region either doesn't have a default
    /// view or if you don't have permission to use the default view, then the
    /// operation fails with a 401 Unauthorized exception.
