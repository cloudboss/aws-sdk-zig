...
pub const UpdateIndexTypeInput = struct {
    /// The [Amazon resource name
    /// (ARN)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the index that you want to update.
    arn: []const u8,
...
pub const UpdateIndexTypeOutput = struct {
    /// The [Amazon resource name
    /// (ARN)](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the index that you updated.
    arn: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateIndexTypeInput, options: CallOptions) !UpdateIndexTypeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateIndexTypeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateIndexTypeOutput {
    var result: UpdateIndexTypeOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateIndexTypeOutput, body, allocator);
    }
    _ = status;
    _ = headers;
