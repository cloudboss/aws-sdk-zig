...
pub const DeleteApprovalRuleTemplateInput = struct {
...
pub const DeleteApprovalRuleTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteApprovalRuleTemplateInput, options: CallOptions) !DeleteApprovalRuleTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteApprovalRuleTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.DeleteApprovalRuleTemplate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteApprovalRuleTemplateOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DeleteApprovalRuleTemplateOutput, body, allocator);
}
