...
pub const MergePullRequestByThreeWayInput = struct {
...
pub const MergePullRequestByThreeWayOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: MergePullRequestByThreeWayInput, options: CallOptions) !MergePullRequestByThreeWayOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: MergePullRequestByThreeWayInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.MergePullRequestByThreeWay");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !MergePullRequestByThreeWayOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(MergePullRequestByThreeWayOutput, body, allocator);
}
