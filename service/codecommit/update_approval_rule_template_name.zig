...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApprovalRuleTemplateNameInput, options: Options) !UpdateApprovalRuleTemplateNameOutput {
