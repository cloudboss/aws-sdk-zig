...
pub const UpdateApprovalRuleTemplateNameInput = struct {
    /// The new name you want to apply to the approval rule template.
    new_approval_rule_template_name: []const u8,

    /// The current name of the approval rule template.
    old_approval_rule_template_name: []const u8,
...
pub const UpdateApprovalRuleTemplateNameOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApprovalRuleTemplateNameInput, options: CallOptions) !UpdateApprovalRuleTemplateNameOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateApprovalRuleTemplateNameInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.UpdateApprovalRuleTemplateName");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateApprovalRuleTemplateNameOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(UpdateApprovalRuleTemplateNameOutput, body, allocator);
}
