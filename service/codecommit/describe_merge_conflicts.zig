...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeMergeConflictsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeCommit_20150413.DescribeMergeConflicts");
