...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdatePullRequestApprovalRuleContentInput, options: Options) !UpdatePullRequestApprovalRuleContentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdatePullRequestApprovalRuleContentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeCommit_20150413.UpdatePullRequestApprovalRuleContent");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdatePullRequestApprovalRuleContentOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(UpdatePullRequestApprovalRuleContentOutput, body, alloc);
}
