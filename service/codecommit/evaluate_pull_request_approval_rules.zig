...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EvaluatePullRequestApprovalRulesInput, options: Options) !EvaluatePullRequestApprovalRulesOutput {
