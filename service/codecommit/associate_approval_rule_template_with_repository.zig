...
pub const AssociateApprovalRuleTemplateWithRepositoryInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateApprovalRuleTemplateWithRepositoryInput, options: CallOptions) !AssociateApprovalRuleTemplateWithRepositoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateApprovalRuleTemplateWithRepositoryInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.AssociateApprovalRuleTemplateWithRepository");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateApprovalRuleTemplateWithRepositoryOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
