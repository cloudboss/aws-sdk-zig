...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateApprovalRuleTemplateWithRepositoryInput, options: Options) !AssociateApprovalRuleTemplateWithRepositoryOutput {
