...
pub const UpdateRepositoryNameInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRepositoryNameInput, options: CallOptions) !UpdateRepositoryNameOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateRepositoryNameInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.UpdateRepositoryName");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateRepositoryNameOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
