...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFileInput, options: Options) !DeleteFileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteFileInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeCommit_20150413.DeleteFile");
