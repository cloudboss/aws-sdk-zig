...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAssociateApprovalRuleTemplateWithRepositoriesInput, options: Options) !BatchAssociateApprovalRuleTemplateWithRepositoriesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: BatchAssociateApprovalRuleTemplateWithRepositoriesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeCommit_20150413.BatchAssociateApprovalRuleTemplateWithRepositories");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !BatchAssociateApprovalRuleTemplateWithRepositoriesOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(BatchAssociateApprovalRuleTemplateWithRepositoriesOutput, body, alloc);
}
