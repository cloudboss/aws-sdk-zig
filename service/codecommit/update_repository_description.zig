...
pub const UpdateRepositoryDescriptionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRepositoryDescriptionInput, options: CallOptions) !UpdateRepositoryDescriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateRepositoryDescriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.UpdateRepositoryDescription");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateRepositoryDescriptionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
