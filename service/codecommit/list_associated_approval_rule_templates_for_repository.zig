...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssociatedApprovalRuleTemplatesForRepositoryInput, options: Options) !ListAssociatedApprovalRuleTemplatesForRepositoryOutput {
