...
pub const ListAssociatedApprovalRuleTemplatesForRepositoryInput = struct {
...
pub const ListAssociatedApprovalRuleTemplatesForRepositoryOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssociatedApprovalRuleTemplatesForRepositoryInput, options: CallOptions) !ListAssociatedApprovalRuleTemplatesForRepositoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAssociatedApprovalRuleTemplatesForRepositoryInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeCommit_20150413.ListAssociatedApprovalRuleTemplatesForRepository");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAssociatedApprovalRuleTemplatesForRepositoryOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListAssociatedApprovalRuleTemplatesForRepositoryOutput, body, allocator);
}
