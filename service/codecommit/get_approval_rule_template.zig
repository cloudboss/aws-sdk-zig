...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApprovalRuleTemplateInput, options: Options) !GetApprovalRuleTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetApprovalRuleTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeCommit_20150413.GetApprovalRuleTemplate");
