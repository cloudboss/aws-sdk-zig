...
pub const DescribeApplicationSnapshotInput = struct {
...
pub const DescribeApplicationSnapshotOutput = struct {
    /// An object containing information about the application snapshot.
    snapshot_details: ?SnapshotDetails = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeApplicationSnapshotInput, options: CallOptions) !DescribeApplicationSnapshotOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeApplicationSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "KinesisAnalytics_20180523.DescribeApplicationSnapshot");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeApplicationSnapshotOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DescribeApplicationSnapshotOutput, body, allocator);
}
