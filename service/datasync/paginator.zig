...
pub const ListAgentsPaginator = struct {
    client: *Client,
    params: list_agents.ListAgentsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_agents.Options) !list_agents.ListAgentsOutput {
        if (self.done) {
...
pub const ListTaskExecutionsPaginator = struct {
    client: *Client,
    params: list_task_executions.ListTaskExecutionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_task_executions.Options) !list_task_executions.ListTaskExecutionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_task_executions.execute(self.client, allocator, self.params, options);
