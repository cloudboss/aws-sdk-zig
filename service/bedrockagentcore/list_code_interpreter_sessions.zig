...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCodeInterpreterSessionsInput, options: CallOptions) !ListCodeInterpreterSessionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCodeInterpreterSessionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/sessions/list");
