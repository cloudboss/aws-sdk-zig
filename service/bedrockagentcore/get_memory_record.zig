...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMemoryRecordInput, options: CallOptions) !GetMemoryRecordOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetMemoryRecordInput, config: *aws.Config) !aws.http.Request {
