...
pub const GetWorkloadAccessTokenInput = struct {
...
pub const GetWorkloadAccessTokenOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetWorkloadAccessTokenInput, options: CallOptions) !GetWorkloadAccessTokenOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetWorkloadAccessTokenInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/identities/GetWorkloadAccessToken";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetWorkloadAccessTokenOutput {
    var result: GetWorkloadAccessTokenOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetWorkloadAccessTokenOutput, body, allocator);
    }
    _ = status;
    _ = headers;
