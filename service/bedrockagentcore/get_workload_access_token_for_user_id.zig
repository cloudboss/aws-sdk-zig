...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetWorkloadAccessTokenForUserIdInput, options: CallOptions) !GetWorkloadAccessTokenForUserIdOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetWorkloadAccessTokenForUserIdInput, config: *aws.Config) !aws.http.Request {
