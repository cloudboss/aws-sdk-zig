...
pub const GetWorkloadAccessTokenForUserIdInput = struct {
...
pub const GetWorkloadAccessTokenForUserIdOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetWorkloadAccessTokenForUserIdInput, options: Options) !GetWorkloadAccessTokenForUserIdOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetWorkloadAccessTokenForUserIdInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/identities/GetWorkloadAccessTokenForUserId";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetWorkloadAccessTokenForUserIdOutput {
    var result: GetWorkloadAccessTokenForUserIdOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetWorkloadAccessTokenForUserIdOutput, body, alloc);
    }
    _ = status;
    _ = headers;
