...
pub const ListABTestsPaginator = struct {
    client: *Client,
    params: list_ab_tests.ListABTestsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_ab_tests.ListABTestsOutput {
        if (self.done) {
...
pub const ListActorsPaginator = struct {
    client: *Client,
    params: list_actors.ListActorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_actors.ListActorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListBatchEvaluationsPaginator = struct {
    client: *Client,
    params: list_batch_evaluations.ListBatchEvaluationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_batch_evaluations.ListBatchEvaluationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListEventsPaginator = struct {
    client: *Client,
    params: list_events.ListEventsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_events.ListEventsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListMemoryExtractionJobsPaginator = struct {
    client: *Client,
    params: list_memory_extraction_jobs.ListMemoryExtractionJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_memory_extraction_jobs.ListMemoryExtractionJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListMemoryRecordsPaginator = struct {
    client: *Client,
    params: list_memory_records.ListMemoryRecordsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_memory_records.ListMemoryRecordsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListPaymentInstrumentsPaginator = struct {
    client: *Client,
    params: list_payment_instruments.ListPaymentInstrumentsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_payment_instruments.ListPaymentInstrumentsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListPaymentSessionsPaginator = struct {
    client: *Client,
    params: list_payment_sessions.ListPaymentSessionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_payment_sessions.ListPaymentSessionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const RetrieveMemoryRecordsPaginator = struct {
    client: *Client,
    params: retrieve_memory_records.RetrieveMemoryRecordsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !retrieve_memory_records.RetrieveMemoryRecordsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
