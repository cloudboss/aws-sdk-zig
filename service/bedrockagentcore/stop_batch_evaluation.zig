...
pub const StopBatchEvaluationInput = struct {
...
pub const StopBatchEvaluationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopBatchEvaluationInput, options: CallOptions) !StopBatchEvaluationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopBatchEvaluationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopBatchEvaluationOutput {
    var result: StopBatchEvaluationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(StopBatchEvaluationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
