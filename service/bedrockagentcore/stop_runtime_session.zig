...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopRuntimeSessionInput, options: CallOptions) !StopRuntimeSessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopRuntimeSessionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/stopruntimesession");
