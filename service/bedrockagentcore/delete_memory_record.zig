...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMemoryRecordInput, options: CallOptions) !DeleteMemoryRecordOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMemoryRecordInput, config: *aws.Config) !aws.http.Request {
