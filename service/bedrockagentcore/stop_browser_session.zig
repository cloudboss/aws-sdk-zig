...
pub const StopBrowserSessionInput = struct {
...
pub const StopBrowserSessionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopBrowserSessionInput, options: CallOptions) !StopBrowserSessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopBrowserSessionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopBrowserSessionOutput {
    var result: StopBrowserSessionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(StopBrowserSessionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
