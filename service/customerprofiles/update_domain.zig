...
pub const UpdateDomainInput = @import("update_domain_request.zig").UpdateDomainRequest;

pub const UpdateDomainOutput = @import("update_domain_response.zig").UpdateDomainResponse;
