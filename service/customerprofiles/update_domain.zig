...
const UpdateDomainInput = @import("update_domain_request.zig").UpdateDomainRequest;

const UpdateDomainOutput = @import("update_domain_response.zig").UpdateDomainResponse;
