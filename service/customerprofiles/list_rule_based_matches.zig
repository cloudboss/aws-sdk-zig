...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRuleBasedMatchesInput, options: CallOptions) !ListRuleBasedMatchesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRuleBasedMatchesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/profiles/ruleBasedMatches");
