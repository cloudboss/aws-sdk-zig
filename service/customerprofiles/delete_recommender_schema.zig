...
pub const DeleteRecommenderSchemaInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRecommenderSchemaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRecommenderSchemaOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRecommenderSchemaOutput = .{};
