...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCalculatedAttributeForProfileInput, options: Options) !GetCalculatedAttributeForProfileOutput {
