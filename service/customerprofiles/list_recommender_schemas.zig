...
const RecommenderSchemaSummary = @import("recommender_schema_summary.zig").RecommenderSchemaSummary;

pub const ListRecommenderSchemasInput = struct {
...
pub const ListRecommenderSchemasOutput = struct {
    ...
    recommender_schemas: ?[]const RecommenderSchemaSummary = null,

    pub const json_field_names = .{
        .next_token = "NextToken",
        .recommender_schemas = "RecommenderSchemas",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRecommenderSchemasInput, options: CallOptions) !ListRecommenderSchemasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRecommenderSchemasInput, config: *aws.Config) !aws.http.Request {
