...
pub const UpdateCalculatedAttributeDefinitionInput = struct {
...
pub const UpdateCalculatedAttributeDefinitionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCalculatedAttributeDefinitionInput, options: Options) !UpdateCalculatedAttributeDefinitionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateCalculatedAttributeDefinitionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateCalculatedAttributeDefinitionOutput {
    var result: UpdateCalculatedAttributeDefinitionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateCalculatedAttributeDefinitionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
