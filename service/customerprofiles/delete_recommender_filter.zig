...
pub const DeleteRecommenderFilterInput = struct {
...
pub const DeleteRecommenderFilterOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRecommenderFilterInput, options: CallOptions) !DeleteRecommenderFilterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRecommenderFilterInput, config: *aws.Config) !aws.http.Request {
