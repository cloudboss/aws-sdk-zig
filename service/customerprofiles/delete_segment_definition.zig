...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSegmentDefinitionInput, options: CallOptions) !DeleteSegmentDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSegmentDefinitionInput, config: *aws.Config) !aws.http.Request {
