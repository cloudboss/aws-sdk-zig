...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEventTriggersInput, options: CallOptions) !ListEventTriggersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEventTriggersInput, config: *aws.Config) !aws.http.Request {
