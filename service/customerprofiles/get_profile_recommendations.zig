...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetProfileRecommendationsInput, options: CallOptions) !GetProfileRecommendationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetProfileRecommendationsInput, config: *aws.Config) !aws.http.Request {
