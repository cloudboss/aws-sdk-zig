...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartUploadJobInput, options: Options) !StartUploadJobOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartUploadJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartUploadJobOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
