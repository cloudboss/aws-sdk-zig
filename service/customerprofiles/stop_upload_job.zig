...
pub const StopUploadJobInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopUploadJobInput, options: Options) !StopUploadJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopUploadJobInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopUploadJobOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopUploadJobOutput = .{};
