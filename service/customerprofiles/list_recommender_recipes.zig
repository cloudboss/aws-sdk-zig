...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRecommenderRecipesInput, options: CallOptions) !ListRecommenderRecipesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRecommenderRecipesInput, config: *aws.Config) !aws.http.Request {
