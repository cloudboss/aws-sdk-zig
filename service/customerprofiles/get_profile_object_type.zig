...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetProfileObjectTypeInput, options: CallOptions) !GetProfileObjectTypeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetProfileObjectTypeInput, config: *aws.Config) !aws.http.Request {
