...
const UpdateRescoreExecutionPlanOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateRescoreExecutionPlanInput, options: Options) !UpdateRescoreExecutionPlanOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateRescoreExecutionPlanInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSKendraRerankingFrontendService.UpdateRescoreExecutionPlan");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateRescoreExecutionPlanOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
