...
pub const UpdateSipMediaApplicationInput = struct {
...
pub const UpdateSipMediaApplicationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSipMediaApplicationInput, options: Options) !UpdateSipMediaApplicationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateSipMediaApplicationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateSipMediaApplicationOutput {
    var result: UpdateSipMediaApplicationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateSipMediaApplicationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
