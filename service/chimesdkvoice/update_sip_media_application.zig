...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSipMediaApplicationInput, options: CallOptions) !UpdateSipMediaApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSipMediaApplicationInput, config: *aws.Config) !aws.http.Request {
