...
pub const GetVoiceConnectorExternalSystemsConfigurationInput = struct {
...
pub const GetVoiceConnectorExternalSystemsConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorExternalSystemsConfigurationInput, options: Options) !GetVoiceConnectorExternalSystemsConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetVoiceConnectorExternalSystemsConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetVoiceConnectorExternalSystemsConfigurationOutput {
    var result: GetVoiceConnectorExternalSystemsConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetVoiceConnectorExternalSystemsConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
