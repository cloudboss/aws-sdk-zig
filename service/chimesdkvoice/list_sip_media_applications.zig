...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSipMediaApplicationsInput, options: CallOptions) !ListSipMediaApplicationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSipMediaApplicationsInput, config: *aws.Config) !aws.http.Request {
