...
pub const GetVoiceConnectorOriginationInput = struct {
...
pub const GetVoiceConnectorOriginationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorOriginationInput, options: CallOptions) !GetVoiceConnectorOriginationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceConnectorOriginationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/origination");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVoiceConnectorOriginationOutput {
    var result: GetVoiceConnectorOriginationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetVoiceConnectorOriginationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
