...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorEmergencyCallingConfigurationInput, options: CallOptions) !GetVoiceConnectorEmergencyCallingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceConnectorEmergencyCallingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/emergency-calling-configuration");
