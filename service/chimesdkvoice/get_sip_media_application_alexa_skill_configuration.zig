...
pub const GetSipMediaApplicationAlexaSkillConfigurationInput = struct {
...
pub const GetSipMediaApplicationAlexaSkillConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSipMediaApplicationAlexaSkillConfigurationInput, options: Options) !GetSipMediaApplicationAlexaSkillConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetSipMediaApplicationAlexaSkillConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/alexa-skill-configuration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetSipMediaApplicationAlexaSkillConfigurationOutput {
    var result: GetSipMediaApplicationAlexaSkillConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetSipMediaApplicationAlexaSkillConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
