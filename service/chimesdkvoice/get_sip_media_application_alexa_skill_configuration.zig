...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSipMediaApplicationAlexaSkillConfigurationInput, options: CallOptions) !GetSipMediaApplicationAlexaSkillConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSipMediaApplicationAlexaSkillConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSipMediaApplicationAlexaSkillConfigurationOutput {
    var result: GetSipMediaApplicationAlexaSkillConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetSipMediaApplicationAlexaSkillConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
