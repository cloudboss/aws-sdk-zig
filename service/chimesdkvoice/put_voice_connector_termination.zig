...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutVoiceConnectorTerminationInput, options: CallOptions) !PutVoiceConnectorTerminationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutVoiceConnectorTerminationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "\"Termination\":");
    try aws.json.writeValue(@TypeOf(input.termination), input.termination, allocator, &body_buf);
    has_prev = true;
