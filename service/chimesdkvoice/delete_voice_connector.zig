...
pub const DeleteVoiceConnectorInput = struct {
...
pub const DeleteVoiceConnectorOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorInput, options: CallOptions) !DeleteVoiceConnectorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceConnectorInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceConnectorOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorOutput = .{};
