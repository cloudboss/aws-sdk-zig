...
pub const DeleteVoiceConnectorGroupInput = struct {
...
const DeleteVoiceConnectorGroupOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorGroupInput, options: Options) !DeleteVoiceConnectorGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVoiceConnectorGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteVoiceConnectorGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorGroupOutput = .{};
