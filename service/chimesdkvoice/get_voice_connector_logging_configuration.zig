...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorLoggingConfigurationInput, options: CallOptions) !GetVoiceConnectorLoggingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceConnectorLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
