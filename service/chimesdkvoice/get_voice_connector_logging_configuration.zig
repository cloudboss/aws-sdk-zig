...
pub const GetVoiceConnectorLoggingConfigurationInput = struct {
...
pub const GetVoiceConnectorLoggingConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorLoggingConfigurationInput, options: Options) !GetVoiceConnectorLoggingConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetVoiceConnectorLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetVoiceConnectorLoggingConfigurationOutput {
    var result: GetVoiceConnectorLoggingConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetVoiceConnectorLoggingConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
