...
pub const DeleteProxySessionInput = struct {
...
pub const DeleteProxySessionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProxySessionInput, options: CallOptions) !DeleteProxySessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProxySessionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteProxySessionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProxySessionOutput = .{};
