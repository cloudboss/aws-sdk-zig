...
pub const GetVoiceConnectorProxyInput = struct {
...
pub const GetVoiceConnectorProxyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorProxyInput, options: CallOptions) !GetVoiceConnectorProxyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceConnectorProxyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVoiceConnectorProxyOutput {
    var result: GetVoiceConnectorProxyOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetVoiceConnectorProxyOutput, body, allocator);
    }
    _ = status;
    _ = headers;
