...
pub const GetVoiceConnectorTerminationInput = struct {
...
pub const GetVoiceConnectorTerminationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorTerminationInput, options: CallOptions) !GetVoiceConnectorTerminationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceConnectorTerminationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/termination");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVoiceConnectorTerminationOutput {
    var result: GetVoiceConnectorTerminationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetVoiceConnectorTerminationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
