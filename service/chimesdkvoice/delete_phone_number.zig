...
pub const DeletePhoneNumberOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePhoneNumberInput, options: CallOptions) !DeletePhoneNumberOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePhoneNumberInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePhoneNumberOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
