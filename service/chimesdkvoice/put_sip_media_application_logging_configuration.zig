...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutSipMediaApplicationLoggingConfigurationInput, options: CallOptions) !PutSipMediaApplicationLoggingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutSipMediaApplicationLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.sip_media_application_logging_configuration) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"SipMediaApplicationLoggingConfiguration\":");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutSipMediaApplicationLoggingConfigurationOutput {
    var result: PutSipMediaApplicationLoggingConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(PutSipMediaApplicationLoggingConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
