...
pub const DeleteVoiceConnectorProxyInput = struct {
...
pub const DeleteVoiceConnectorProxyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorProxyInput, options: CallOptions) !DeleteVoiceConnectorProxyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceConnectorProxyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceConnectorProxyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorProxyOutput = .{};
