...
pub const ListPhoneNumberOrdersPaginator = struct {
    client: *Client,
    params: list_phone_number_orders.ListPhoneNumberOrdersInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_phone_number_orders.ListPhoneNumberOrdersOutput {
        ...
        const output = try list_phone_number_orders.execute(self.client, allocator, self.params, options);
...
pub const ListProxySessionsPaginator = struct {
    client: *Client,
    params: list_proxy_sessions.ListProxySessionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_proxy_sessions.ListProxySessionsOutput {
        ...
        const output = try list_proxy_sessions.execute(self.client, allocator, self.params, options);
...
pub const ListSipMediaApplicationsPaginator = struct {
    client: *Client,
    params: list_sip_media_applications.ListSipMediaApplicationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_sip_media_applications.ListSipMediaApplicationsOutput {
        ...
        const output = try list_sip_media_applications.execute(self.client, allocator, self.params, options);
...
pub const ListSipRulesPaginator = struct {
    client: *Client,
    params: list_sip_rules.ListSipRulesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_sip_rules.ListSipRulesOutput {
        ...
        const output = try list_sip_rules.execute(self.client, allocator, self.params, options);
...
pub const ListVoiceConnectorGroupsPaginator = struct {
    client: *Client,
    params: list_voice_connector_groups.ListVoiceConnectorGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_voice_connector_groups.ListVoiceConnectorGroupsOutput {
        ...
        const output = try list_voice_connector_groups.execute(self.client, allocator, self.params, options);
...
pub const ListVoiceConnectorsPaginator = struct {
    client: *Client,
    params: list_voice_connectors.ListVoiceConnectorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_voice_connectors.ListVoiceConnectorsOutput {
        ...
        const output = try list_voice_connectors.execute(self.client, allocator, self.params, options);
...
pub const ListVoiceProfileDomainsPaginator = struct {
    client: *Client,
    params: list_voice_profile_domains.ListVoiceProfileDomainsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_voice_profile_domains.ListVoiceProfileDomainsOutput {
        ...
        const output = try list_voice_profile_domains.execute(self.client, allocator, self.params, options);
...
pub const ListVoiceProfilesPaginator = struct {
    client: *Client,
    params: list_voice_profiles.ListVoiceProfilesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_voice_profiles.ListVoiceProfilesOutput {
        ...
        const output = try list_voice_profiles.execute(self.client, allocator, self.params, options);
