...
pub const DeleteSipRuleInput = struct {
    /// The SIP rule ID.
...
pub const DeleteSipRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSipRuleInput, options: CallOptions) !DeleteSipRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSipRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSipRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSipRuleOutput = .{};
