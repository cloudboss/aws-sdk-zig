...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetProxySessionInput, options: CallOptions) !GetProxySessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetProxySessionInput, config: *aws.Config) !aws.http.Request {
