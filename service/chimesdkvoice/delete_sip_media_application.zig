...
pub const DeleteSipMediaApplicationInput = struct {
...
pub const DeleteSipMediaApplicationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSipMediaApplicationInput, options: CallOptions) !DeleteSipMediaApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSipMediaApplicationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSipMediaApplicationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSipMediaApplicationOutput = .{};
