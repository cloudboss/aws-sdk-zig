...
pub const DeleteVoiceConnectorStreamingConfigurationInput = struct {
...
pub const DeleteVoiceConnectorStreamingConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorStreamingConfigurationInput, options: CallOptions) !DeleteVoiceConnectorStreamingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceConnectorStreamingConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceConnectorStreamingConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorStreamingConfigurationOutput = .{};
