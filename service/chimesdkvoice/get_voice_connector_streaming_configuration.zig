...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorStreamingConfigurationInput, options: Options) !GetVoiceConnectorStreamingConfigurationOutput {
