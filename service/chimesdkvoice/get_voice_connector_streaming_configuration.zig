...
pub const GetVoiceConnectorStreamingConfigurationInput = struct {
...
pub const GetVoiceConnectorStreamingConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceConnectorStreamingConfigurationInput, options: CallOptions) !GetVoiceConnectorStreamingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceConnectorStreamingConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVoiceConnectorStreamingConfigurationOutput {
    var result: GetVoiceConnectorStreamingConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetVoiceConnectorStreamingConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
