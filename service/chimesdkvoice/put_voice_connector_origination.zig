...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutVoiceConnectorOriginationInput, options: CallOptions) !PutVoiceConnectorOriginationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutVoiceConnectorOriginationInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.origination), input.origination, allocator, &body_buf);
    has_prev = true;
