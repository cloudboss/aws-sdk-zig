...
pub const DeleteVoiceProfileDomainInput = struct {
...
pub const DeleteVoiceProfileDomainOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceProfileDomainInput, options: CallOptions) !DeleteVoiceProfileDomainOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceProfileDomainInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceProfileDomainOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceProfileDomainOutput = .{};
