...
pub const DisassociatePhoneNumbersFromVoiceConnectorGroupInput = struct {
...
pub const DisassociatePhoneNumbersFromVoiceConnectorGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociatePhoneNumbersFromVoiceConnectorGroupInput, options: CallOptions) !DisassociatePhoneNumbersFromVoiceConnectorGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociatePhoneNumbersFromVoiceConnectorGroupInput, config: *aws.Config) !aws.http.Request {
