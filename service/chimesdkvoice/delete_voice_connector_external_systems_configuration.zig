...
pub const DeleteVoiceConnectorExternalSystemsConfigurationInput = struct {
...
pub const DeleteVoiceConnectorExternalSystemsConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorExternalSystemsConfigurationInput, options: CallOptions) !DeleteVoiceConnectorExternalSystemsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceConnectorExternalSystemsConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceConnectorExternalSystemsConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorExternalSystemsConfigurationOutput = .{};
