...
pub const DeleteVoiceConnectorTerminationInput = struct {
...
pub const DeleteVoiceConnectorTerminationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorTerminationInput, options: CallOptions) !DeleteVoiceConnectorTerminationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceConnectorTerminationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceConnectorTerminationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorTerminationOutput = .{};
