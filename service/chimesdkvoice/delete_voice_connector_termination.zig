...
const DeleteVoiceConnectorTerminationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorTerminationInput, options: Options) !DeleteVoiceConnectorTerminationOutput {
