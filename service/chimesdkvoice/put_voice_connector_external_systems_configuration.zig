...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutVoiceConnectorExternalSystemsConfigurationInput, options: Options) !PutVoiceConnectorExternalSystemsConfigurationOutput {
