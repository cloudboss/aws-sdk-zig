...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSipMediaApplicationLoggingConfigurationInput, options: Options) !GetSipMediaApplicationLoggingConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetSipMediaApplicationLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetSipMediaApplicationLoggingConfigurationOutput {
    var result: GetSipMediaApplicationLoggingConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetSipMediaApplicationLoggingConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
