...
pub const DeleteVoiceConnectorOriginationInput = struct {
...
pub const DeleteVoiceConnectorOriginationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceConnectorOriginationInput, options: CallOptions) !DeleteVoiceConnectorOriginationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceConnectorOriginationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceConnectorOriginationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceConnectorOriginationOutput = .{};
