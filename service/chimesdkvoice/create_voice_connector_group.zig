...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateVoiceConnectorGroupInput, options: CallOptions) !CreateVoiceConnectorGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateVoiceConnectorGroupInput, config: *aws.Config) !aws.http.Request {
