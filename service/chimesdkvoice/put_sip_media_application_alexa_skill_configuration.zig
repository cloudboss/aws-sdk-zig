...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutSipMediaApplicationAlexaSkillConfigurationInput, options: Options) !PutSipMediaApplicationAlexaSkillConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutSipMediaApplicationAlexaSkillConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.sip_media_application_alexa_skill_configuration) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"SipMediaApplicationAlexaSkillConfiguration\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutSipMediaApplicationAlexaSkillConfigurationOutput {
    var result: PutSipMediaApplicationAlexaSkillConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(PutSipMediaApplicationAlexaSkillConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
