...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociatePhoneNumbersWithVoiceConnectorGroupInput, options: CallOptions) !AssociatePhoneNumbersWithVoiceConnectorGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociatePhoneNumbersWithVoiceConnectorGroupInput, config: *aws.Config) !aws.http.Request {
