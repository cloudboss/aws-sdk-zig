...
pub const AssociatePhoneNumbersWithVoiceConnectorGroupInput = struct {
...
pub const AssociatePhoneNumbersWithVoiceConnectorGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociatePhoneNumbersWithVoiceConnectorGroupInput, options: Options) !AssociatePhoneNumbersWithVoiceConnectorGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociatePhoneNumbersWithVoiceConnectorGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociatePhoneNumbersWithVoiceConnectorGroupOutput {
    var result: AssociatePhoneNumbersWithVoiceConnectorGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(AssociatePhoneNumbersWithVoiceConnectorGroupOutput, body, alloc);
    }
    _ = status;
    _ = headers;
