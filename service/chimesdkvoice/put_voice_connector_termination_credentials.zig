...
pub const PutVoiceConnectorTerminationCredentialsInput = struct {
    /// The termination credentials being updated.
    credentials: ?[]const Credential = null,
...
pub const PutVoiceConnectorTerminationCredentialsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutVoiceConnectorTerminationCredentialsInput, options: CallOptions) !PutVoiceConnectorTerminationCredentialsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutVoiceConnectorTerminationCredentialsInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "operation=put");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutVoiceConnectorTerminationCredentialsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutVoiceConnectorTerminationCredentialsOutput = .{};
