...
fn serializeRequest(alloc: std.mem.Allocator, input: PutVoiceConnectorTerminationCredentialsInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(alloc, "operation=put");
    query_has_prev = true;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutVoiceConnectorTerminationCredentialsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
