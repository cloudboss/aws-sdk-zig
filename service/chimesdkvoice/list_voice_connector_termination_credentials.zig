...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListVoiceConnectorTerminationCredentialsInput, options: Options) !ListVoiceConnectorTerminationCredentialsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListVoiceConnectorTerminationCredentialsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListVoiceConnectorTerminationCredentialsOutput {
    var result: ListVoiceConnectorTerminationCredentialsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListVoiceConnectorTerminationCredentialsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
