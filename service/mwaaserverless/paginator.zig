...
pub const ListTaskInstancesPaginator = struct {
    client: *Client,
    params: list_task_instances.ListTaskInstancesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_task_instances.Options) !list_task_instances.ListTaskInstancesOutput {
        ...
        const output = try list_task_instances.execute(self.client, allocator, self.params, options);
...
pub const ListWorkflowVersionsPaginator = struct {
    client: *Client,
    params: list_workflow_versions.ListWorkflowVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
