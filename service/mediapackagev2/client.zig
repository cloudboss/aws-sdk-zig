...
pub const Client = struct {
    ...
    pub fn cancelHarvestJob(self: *Self, allocator: std.mem.Allocator, input: cancel_harvest_job.CancelHarvestJobInput, options: CallOptions) !cancel_harvest_job.CancelHarvestJobOutput {
    ...
    /// each request.
    pub fn createChannelGroup(self: *Self, allocator: std.mem.Allocator, input: create_channel_group.CreateChannelGroupInput, options: CallOptions) !create_channel_group.CreateChannelGroupOutput {
    ...
    pub fn deleteChannelGroup(self: *Self, allocator: std.mem.Allocator, input: delete_channel_group.DeleteChannelGroupInput, options: CallOptions) !delete_channel_group.DeleteChannelGroupOutput {
    ...
    pub fn deleteOriginEndpointPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_origin_endpoint_policy.DeleteOriginEndpointPolicyInput, options: CallOptions) !delete_origin_endpoint_policy.DeleteOriginEndpointPolicyOutput {
    ...
    /// MediaPackage.
    pub fn getChannelGroup(self: *Self, allocator: std.mem.Allocator, input: get_channel_group.GetChannelGroupInput, options: CallOptions) !get_channel_group.GetChannelGroupOutput {
    ...
    pub fn getHarvestJob(self: *Self, allocator: std.mem.Allocator, input: get_harvest_job.GetHarvestJobInput, options: CallOptions) !get_harvest_job.GetHarvestJobOutput {
    ...
    pub fn getOriginEndpoint(self: *Self, allocator: std.mem.Allocator, input: get_origin_endpoint.GetOriginEndpointInput, options: CallOptions) !get_origin_endpoint.GetOriginEndpointOutput {
    ...
    pub fn getOriginEndpointPolicy(self: *Self, allocator: std.mem.Allocator, input: get_origin_endpoint_policy.GetOriginEndpointPolicyInput, options: CallOptions) !get_origin_endpoint_policy.GetOriginEndpointPolicyOutput {
    ...
    pub fn listChannelGroups(self: *Self, allocator: std.mem.Allocator, input: list_channel_groups.ListChannelGroupsInput, options: CallOptions) !list_channel_groups.ListChannelGroupsOutput {
    ...
    pub fn putOriginEndpointPolicy(self: *Self, allocator: std.mem.Allocator, input: put_origin_endpoint_policy.PutOriginEndpointPolicyInput, options: CallOptions) !put_origin_endpoint_policy.PutOriginEndpointPolicyOutput {
    ...
    pub fn resetChannelState(self: *Self, allocator: std.mem.Allocator, input: reset_channel_state.ResetChannelStateInput, options: CallOptions) !reset_channel_state.ResetChannelStateOutput {
    ...
    pub fn resetOriginEndpointState(self: *Self, allocator: std.mem.Allocator, input: reset_origin_endpoint_state.ResetOriginEndpointStateInput, options: CallOptions) !reset_origin_endpoint_state.ResetOriginEndpointStateOutput {
    ...
    /// Any edits you make that impact the video output may not be reflected for a
    /// few minutes.
    pub fn updateChannelGroup(self: *Self, allocator: std.mem.Allocator, input: update_channel_group.UpdateChannelGroupInput, options: CallOptions) !update_channel_group.UpdateChannelGroupOutput {
