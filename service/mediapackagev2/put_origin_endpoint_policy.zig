...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutOriginEndpointPolicyInput, options: Options) !PutOriginEndpointPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutOriginEndpointPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.cdn_auth_configuration) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"CdnAuthConfiguration\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutOriginEndpointPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
