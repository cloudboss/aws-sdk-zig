...
pub const DeleteOriginEndpointPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOriginEndpointPolicyInput, options: Options) !DeleteOriginEndpointPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteOriginEndpointPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteOriginEndpointPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteOriginEndpointPolicyOutput = .{};
