...
pub const ListChannelHandshakesPaginator = struct {
    client: *Client,
    params: list_channel_handshakes.ListChannelHandshakesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_channel_handshakes.Options) !list_channel_handshakes.ListChannelHandshakesOutput {
        ...
        const output = try list_channel_handshakes.execute(self.client, allocator, self.params, options);
...
pub const ListProgramManagementAccountsPaginator = struct {
    client: *Client,
    params: list_program_management_accounts.ListProgramManagementAccountsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_program_management_accounts.Options) !list_program_management_accounts.ListProgramManagementAccountsOutput {
        ...
        const output = try list_program_management_accounts.execute(self.client, allocator, self.params, options);
...
pub const ListRelationshipsPaginator = struct {
    client: *Client,
    params: list_relationships.ListRelationshipsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_relationships.Options) !list_relationships.ListRelationshipsOutput {
        ...
        const output = try list_relationships.execute(self.client, allocator, self.params, options);
