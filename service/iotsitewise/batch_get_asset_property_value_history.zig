...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchGetAssetPropertyValueHistoryInput, options: Options) !BatchGetAssetPropertyValueHistoryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: BatchGetAssetPropertyValueHistoryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !BatchGetAssetPropertyValueHistoryOutput {
    var result: BatchGetAssetPropertyValueHistoryOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(BatchGetAssetPropertyValueHistoryOutput, body, alloc);
    }
    _ = status;
    _ = headers;
