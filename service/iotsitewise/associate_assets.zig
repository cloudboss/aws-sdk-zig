...
pub const AssociateAssetsInput = struct {
    ...
    /// The ID of the child asset to be associated. This can be either the actual ID
...
pub const AssociateAssetsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateAssetsInput, options: CallOptions) !AssociateAssetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateAssetsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateAssetsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateAssetsOutput = .{};
