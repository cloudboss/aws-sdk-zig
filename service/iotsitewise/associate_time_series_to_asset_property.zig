...
pub const AssociateTimeSeriesToAssetPropertyInput = struct {
...
const AssociateTimeSeriesToAssetPropertyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateTimeSeriesToAssetPropertyInput, options: Options) !AssociateTimeSeriesToAssetPropertyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateTimeSeriesToAssetPropertyInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/timeseries/associate";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateTimeSeriesToAssetPropertyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: AssociateTimeSeriesToAssetPropertyOutput = .{};
