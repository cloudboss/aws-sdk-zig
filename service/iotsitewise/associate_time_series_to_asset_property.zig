...
pub const AssociateTimeSeriesToAssetPropertyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateTimeSeriesToAssetPropertyInput, options: CallOptions) !AssociateTimeSeriesToAssetPropertyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateTimeSeriesToAssetPropertyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateTimeSeriesToAssetPropertyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
