...
pub const AssetActiveWaiter = struct {
    client: *Client,
    params: describe_asset.DescribeAssetInput,
...
pub const AssetModelActiveWaiter = struct {
    client: *Client,
    params: describe_asset_model.DescribeAssetModelInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 3,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
...
pub const AssetModelNotExistsWaiter = struct {
    client: *Client,
    params: describe_asset_model.DescribeAssetModelInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 3,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        _ = self.client.describeAssetModel(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
...
pub const AssetNotExistsWaiter = struct {
    client: *Client,
    params: describe_asset.DescribeAssetInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 3,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        _ = self.client.describeAsset(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "ResourceNotFoundException")) {
                    return .success;
...
pub const PortalActiveWaiter = struct {
    client: *Client,
    params: describe_portal.DescribePortalInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 3,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
...
pub const PortalNotExistsWaiter = struct {
    client: *Client,
    params: describe_portal.DescribePortalInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 3,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        _ = self.client.describePortal(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "ResourceNotFoundException")) {
                    return .success;
