...
fn serializeRequest(alloc: std.mem.Allocator, input: PutDefaultEncryptionConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutDefaultEncryptionConfigurationOutput {
    var result: PutDefaultEncryptionConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(PutDefaultEncryptionConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
