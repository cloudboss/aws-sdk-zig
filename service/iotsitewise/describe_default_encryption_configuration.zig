...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDefaultEncryptionConfigurationInput, options: Options) !DescribeDefaultEncryptionConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeDefaultEncryptionConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeDefaultEncryptionConfigurationOutput {
    var result: DescribeDefaultEncryptionConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeDefaultEncryptionConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
