...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAssociateProjectAssetsInput, options: CallOptions) !BatchAssociateProjectAssetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchAssociateProjectAssetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/assets/associate");
