...
pub const ListAssetModelCompositeModelsInput = struct {
...
pub const ListAssetModelCompositeModelsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssetModelCompositeModelsInput, options: CallOptions) !ListAssetModelCompositeModelsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAssetModelCompositeModelsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAssetModelCompositeModelsOutput {
    var result: ListAssetModelCompositeModelsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAssetModelCompositeModelsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
