...
/// non-overlapping, and
/// contiguous time window. You can use this window in metrics to aggregate data
/// from properties
/// and other assets.
///
...
pub const TumblingWindow = struct {
    ...
    /// get the first aggregation result at 2:03 PM (UTC). You get the second
    /// aggregation result
    /// at 2:08 PM (UTC).
    ///
    ...
    /// and `1d` for `interval`, IoT SiteWise aggregates data in one of the
    /// following ways:
    ///
