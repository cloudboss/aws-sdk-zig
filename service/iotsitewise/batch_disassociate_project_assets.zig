...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDisassociateProjectAssetsInput, options: CallOptions) !BatchDisassociateProjectAssetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchDisassociateProjectAssetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/assets/disassociate");
    ...
    try aws.json.writeValue(@TypeOf(input.asset_ids), input.asset_ids, allocator, &body_buf);
    has_prev = true;
