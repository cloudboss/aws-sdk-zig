...
pub const DeleteTimeSeriesInput = struct {
...
const DeleteTimeSeriesOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTimeSeriesInput, options: Options) !DeleteTimeSeriesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTimeSeriesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteTimeSeriesOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTimeSeriesOutput = .{};
