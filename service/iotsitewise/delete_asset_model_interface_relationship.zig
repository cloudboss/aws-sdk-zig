...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAssetModelInterfaceRelationshipInput, options: Options) !DeleteAssetModelInterfaceRelationshipOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAssetModelInterfaceRelationshipInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAssetModelInterfaceRelationshipOutput {
    var result: DeleteAssetModelInterfaceRelationshipOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteAssetModelInterfaceRelationshipOutput, body, alloc);
    }
    _ = status;
    _ = headers;
