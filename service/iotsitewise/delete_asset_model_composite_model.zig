...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAssetModelCompositeModelInput, options: Options) !DeleteAssetModelCompositeModelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAssetModelCompositeModelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAssetModelCompositeModelOutput {
    var result: DeleteAssetModelCompositeModelOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteAssetModelCompositeModelOutput, body, alloc);
    }
    _ = status;
    _ = headers;
