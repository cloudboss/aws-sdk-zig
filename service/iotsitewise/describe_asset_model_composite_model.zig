...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAssetModelCompositeModelInput, options: Options) !DescribeAssetModelCompositeModelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeAssetModelCompositeModelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeAssetModelCompositeModelOutput {
    var result: DescribeAssetModelCompositeModelOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeAssetModelCompositeModelOutput, body, alloc);
    }
    _ = status;
    _ = headers;
