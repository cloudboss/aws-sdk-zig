...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBClusterSnapshotInput, options: CallOptions) !DeleteDBClusterSnapshotOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDBClusterSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteDBClusterSnapshot&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDBClusterSnapshotOutput {
    _ = status;
    _ = headers;
