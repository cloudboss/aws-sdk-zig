...
pub const Client = struct {
    ...
    pub fn associateGatewayToServer(self: *Self, allocator: std.mem.Allocator, input: associate_gateway_to_server.AssociateGatewayToServerInput, options: associate_gateway_to_server.Options) !associate_gateway_to_server.AssociateGatewayToServerOutput {
    ...
    pub fn deleteHypervisor(self: *Self, allocator: std.mem.Allocator, input: delete_hypervisor.DeleteHypervisorInput, options: delete_hypervisor.Options) !delete_hypervisor.DeleteHypervisorOutput {
    ...
    /// server.
    pub fn disassociateGatewayFromServer(self: *Self, allocator: std.mem.Allocator, input: disassociate_gateway_from_server.DisassociateGatewayFromServerInput, options: disassociate_gateway_from_server.Options) !disassociate_gateway_from_server.DisassociateGatewayFromServerOutput {
    ...
    pub fn getBandwidthRateLimitSchedule(self: *Self, allocator: std.mem.Allocator, input: get_bandwidth_rate_limit_schedule.GetBandwidthRateLimitScheduleInput, options: get_bandwidth_rate_limit_schedule.Options) !get_bandwidth_rate_limit_schedule.GetBandwidthRateLimitScheduleOutput {
    ...
    pub fn getHypervisor(self: *Self, allocator: std.mem.Allocator, input: get_hypervisor.GetHypervisorInput, options: get_hypervisor.Options) !get_hypervisor.GetHypervisorOutput {
    ...
    /// Amazon Web Services.
    pub fn getHypervisorPropertyMappings(self: *Self, allocator: std.mem.Allocator, input: get_hypervisor_property_mappings.GetHypervisorPropertyMappingsInput, options: get_hypervisor_property_mappings.Options) !get_hypervisor_property_mappings.GetHypervisorPropertyMappingsOutput {
    ...
    /// machine.
    pub fn getVirtualMachine(self: *Self, allocator: std.mem.Allocator, input: get_virtual_machine.GetVirtualMachineInput, options: get_virtual_machine.Options) !get_virtual_machine.GetVirtualMachineOutput {
        return get_virtual_machine.execute(self, allocator, input, options);
    }

    /// Connect to a hypervisor by importing its configuration.
    pub fn importHypervisorConfiguration(self: *Self, allocator: std.mem.Allocator, input: import_hypervisor_configuration.ImportHypervisorConfigurationInput, options: import_hypervisor_configuration.Options) !import_hypervisor_configuration.ImportHypervisorConfigurationOutput {
    ...
    pub fn listHypervisors(self: *Self, allocator: std.mem.Allocator, input: list_hypervisors.ListHypervisorsInput, options: list_hypervisors.Options) !list_hypervisors.ListHypervisorsOutput {
    ...
    pub fn listVirtualMachines(self: *Self, allocator: std.mem.Allocator, input: list_virtual_machines.ListVirtualMachinesInput, options: list_virtual_machines.Options) !list_virtual_machines.ListVirtualMachinesOutput {
    ...
    pub fn putBandwidthRateLimitSchedule(self: *Self, allocator: std.mem.Allocator, input: put_bandwidth_rate_limit_schedule.PutBandwidthRateLimitScheduleInput, options: put_bandwidth_rate_limit_schedule.Options) !put_bandwidth_rate_limit_schedule.PutBandwidthRateLimitScheduleOutput {
    ...
    /// available from the on-premises hypervisor to the properties available in
    /// Amazon Web Services.
    pub fn putHypervisorPropertyMappings(self: *Self, allocator: std.mem.Allocator, input: put_hypervisor_property_mappings.PutHypervisorPropertyMappingsInput, options: put_hypervisor_property_mappings.Options) !put_hypervisor_property_mappings.PutHypervisorPropertyMappingsOutput {
        return put_hypervisor_property_mappings.execute(self, allocator, input, options);
    }

    /// Set the maintenance start time for a gateway.
    pub fn putMaintenanceStartTime(self: *Self, allocator: std.mem.Allocator, input: put_maintenance_start_time.PutMaintenanceStartTimeInput, options: put_maintenance_start_time.Options) !put_maintenance_start_time.PutMaintenanceStartTimeOutput {
    ...
    /// machines.
    pub fn startVirtualMachinesMetadataSync(self: *Self, allocator: std.mem.Allocator, input: start_virtual_machines_metadata_sync.StartVirtualMachinesMetadataSyncInput, options: start_virtual_machines_metadata_sync.Options) !start_virtual_machines_metadata_sync.StartVirtualMachinesMetadataSyncOutput {
    ...
    pub fn testHypervisorConfiguration(self: *Self, allocator: std.mem.Allocator, input: test_hypervisor_configuration.TestHypervisorConfigurationInput, options: test_hypervisor_configuration.Options) !test_hypervisor_configuration.TestHypervisorConfigurationOutput {
    ...
    /// in your
    /// request.
    pub fn updateHypervisor(self: *Self, allocator: std.mem.Allocator, input: update_hypervisor.UpdateHypervisorInput, options: update_hypervisor.Options) !update_hypervisor.UpdateHypervisorOutput {
