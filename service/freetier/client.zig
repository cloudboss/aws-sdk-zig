...
pub const Client = struct {
    ...
    pub fn getAccountActivity(self: *Self, allocator: std.mem.Allocator, input: get_account_activity.GetAccountActivityInput, options: get_account_activity.Options) !get_account_activity.GetAccountActivityOutput {
    ...
    pub fn getAccountPlanState(self: *Self, allocator: std.mem.Allocator, input: get_account_plan_state.GetAccountPlanStateInput, options: get_account_plan_state.Options) !get_account_plan_state.GetAccountPlanStateOutput {
        return get_account_plan_state.execute(self, allocator, input, options);
    }

    /// Returns a list of all Free Tier usage objects that match your filters.
    pub fn getFreeTierUsage(self: *Self, allocator: std.mem.Allocator, input: get_free_tier_usage.GetFreeTierUsageInput, options: get_free_tier_usage.Options) !get_free_tier_usage.GetFreeTierUsageOutput {
    ...
    pub fn listAccountActivities(self: *Self, allocator: std.mem.Allocator, input: list_account_activities.ListAccountActivitiesInput, options: list_account_activities.Options) !list_account_activities.ListAccountActivitiesOutput {
        return list_account_activities.execute(self, allocator, input, options);
    }

    /// The account plan type for the Amazon Web Services account.
    pub fn upgradeAccountPlan(self: *Self, allocator: std.mem.Allocator, input: upgrade_account_plan.UpgradeAccountPlanInput, options: upgrade_account_plan.Options) !upgrade_account_plan.UpgradeAccountPlanOutput {
