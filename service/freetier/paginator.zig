...
pub const GetFreeTierUsagePaginator = struct {
    client: *Client,
    params: get_free_tier_usage.GetFreeTierUsageInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_free_tier_usage.GetFreeTierUsageOutput {
        ...
        const output = try get_free_tier_usage.execute(self.client, allocator, self.params, options);
...
pub const ListAccountActivitiesPaginator = struct {
    client: *Client,
    params: list_account_activities.ListAccountActivitiesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_account_activities.ListAccountActivitiesOutput {
        ...
        const output = try list_account_activities.execute(self.client, allocator, self.params, options);
