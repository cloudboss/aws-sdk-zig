...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListIdMappingWorkflowsInput, options: CallOptions) !ListIdMappingWorkflowsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListIdMappingWorkflowsInput, config: *aws.Config) !aws.http.Request {
