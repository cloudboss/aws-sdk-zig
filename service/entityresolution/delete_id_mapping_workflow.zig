...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIdMappingWorkflowInput, options: CallOptions) !DeleteIdMappingWorkflowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIdMappingWorkflowInput, config: *aws.Config) !aws.http.Request {
