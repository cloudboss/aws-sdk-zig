...
pub const Client = struct {
    ...
    pub fn addPolicyStatement(self: *Self, allocator: std.mem.Allocator, input: add_policy_statement.AddPolicyStatementInput, options: add_policy_statement.Options) !add_policy_statement.AddPolicyStatementOutput {
        return add_policy_statement.execute(self, allocator, input, options);
    }

    /// Deletes multiple unique IDs in a matching workflow.
    pub fn batchDeleteUniqueId(self: *Self, allocator: std.mem.Allocator, input: batch_delete_unique_id.BatchDeleteUniqueIdInput, options: batch_delete_unique_id.Options) !batch_delete_unique_id.BatchDeleteUniqueIdOutput {
    ...
    pub fn createIdMappingWorkflow(self: *Self, allocator: std.mem.Allocator, input: create_id_mapping_workflow.CreateIdMappingWorkflowInput, options: create_id_mapping_workflow.Options) !create_id_mapping_workflow.CreateIdMappingWorkflowOutput {
    ...
    /// API.
    pub fn createIdNamespace(self: *Self, allocator: std.mem.Allocator, input: create_id_namespace.CreateIdNamespaceInput, options: create_id_namespace.Options) !create_id_namespace.CreateIdNamespaceOutput {
    ...
    pub fn createMatchingWorkflow(self: *Self, allocator: std.mem.Allocator, input: create_matching_workflow.CreateMatchingWorkflowInput, options: create_matching_workflow.Options) !create_matching_workflow.CreateMatchingWorkflowOutput {
    ...
    pub fn createSchemaMapping(self: *Self, allocator: std.mem.Allocator, input: create_schema_mapping.CreateSchemaMappingInput, options: create_schema_mapping.Options) !create_schema_mapping.CreateSchemaMappingOutput {
    ...
    pub fn deleteIdMappingWorkflow(self: *Self, allocator: std.mem.Allocator, input: delete_id_mapping_workflow.DeleteIdMappingWorkflowInput, options: delete_id_mapping_workflow.Options) !delete_id_mapping_workflow.DeleteIdMappingWorkflowOutput {
        return delete_id_mapping_workflow.execute(self, allocator, input, options);
    }

    /// Deletes the `IdNamespace` with a given name.
    pub fn deleteIdNamespace(self: *Self, allocator: std.mem.Allocator, input: delete_id_namespace.DeleteIdNamespaceInput, options: delete_id_namespace.Options) !delete_id_namespace.DeleteIdNamespaceOutput {
    ...
    /// succeed even if a workflow with the given name does not exist.
    pub fn deleteMatchingWorkflow(self: *Self, allocator: std.mem.Allocator, input: delete_matching_workflow.DeleteMatchingWorkflowInput, options: delete_matching_workflow.Options) !delete_matching_workflow.DeleteMatchingWorkflowOutput {
        return delete_matching_workflow.execute(self, allocator, input, options);
    }

    /// Deletes the policy statement.
    pub fn deletePolicyStatement(self: *Self, allocator: std.mem.Allocator, input: delete_policy_statement.DeletePolicyStatementInput, options: delete_policy_statement.Options) !delete_policy_statement.DeletePolicyStatementOutput {
    ...
    pub fn deleteSchemaMapping(self: *Self, allocator: std.mem.Allocator, input: delete_schema_mapping.DeleteSchemaMappingInput, options: delete_schema_mapping.Options) !delete_schema_mapping.DeleteSchemaMappingOutput {
    ...
    pub fn generateMatchId(self: *Self, allocator: std.mem.Allocator, input: generate_match_id.GenerateMatchIdInput, options: generate_match_id.Options) !generate_match_id.GenerateMatchIdOutput {
    ...
    pub fn getIdMappingJob(self: *Self, allocator: std.mem.Allocator, input: get_id_mapping_job.GetIdMappingJobInput, options: get_id_mapping_job.Options) !get_id_mapping_job.GetIdMappingJobOutput {
        return get_id_mapping_job.execute(self, allocator, input, options);
    }

    /// Returns the `IdMappingWorkflow` with a given name, if it exists.
    pub fn getIdMappingWorkflow(self: *Self, allocator: std.mem.Allocator, input: get_id_mapping_workflow.GetIdMappingWorkflowInput, options: get_id_mapping_workflow.Options) !get_id_mapping_workflow.GetIdMappingWorkflowOutput {
        return get_id_mapping_workflow.execute(self, allocator, input, options);
    }

    /// Returns the `IdNamespace` with a given name, if it exists.
    pub fn getIdNamespace(self: *Self, allocator: std.mem.Allocator, input: get_id_namespace.GetIdNamespaceInput, options: get_id_namespace.Options) !get_id_namespace.GetIdNamespaceOutput {
    ...
    /// matching workflow.
    pub fn getMatchId(self: *Self, allocator: std.mem.Allocator, input: get_match_id.GetMatchIdInput, options: get_match_id.Options) !get_match_id.GetMatchIdOutput {
        return get_match_id.execute(self, allocator, input, options);
    }

    /// Returns the status, metrics, and errors (if there are any) that are
    /// associated with a job.
    pub fn getMatchingJob(self: *Self, allocator: std.mem.Allocator, input: get_matching_job.GetMatchingJobInput, options: get_matching_job.Options) !get_matching_job.GetMatchingJobOutput {
        return get_matching_job.execute(self, allocator, input, options);
    }

    /// Returns the `MatchingWorkflow` with a given name, if it exists.
    pub fn getMatchingWorkflow(self: *Self, allocator: std.mem.Allocator, input: get_matching_workflow.GetMatchingWorkflowInput, options: get_matching_workflow.Options) !get_matching_workflow.GetMatchingWorkflowOutput {
    ...
    pub fn getProviderService(self: *Self, allocator: std.mem.Allocator, input: get_provider_service.GetProviderServiceInput, options: get_provider_service.Options) !get_provider_service.GetProviderServiceOutput {
        return get_provider_service.execute(self, allocator, input, options);
    }

    /// Returns the SchemaMapping of a given name.
    pub fn getSchemaMapping(self: *Self, allocator: std.mem.Allocator, input: get_schema_mapping.GetSchemaMappingInput, options: get_schema_mapping.Options) !get_schema_mapping.GetSchemaMappingOutput {
        return get_schema_mapping.execute(self, allocator, input, options);
    }

    /// Lists all ID mapping jobs for a given workflow.
    pub fn listIdMappingJobs(self: *Self, allocator: std.mem.Allocator, input: list_id_mapping_jobs.ListIdMappingJobsInput, options: list_id_mapping_jobs.Options) !list_id_mapping_jobs.ListIdMappingJobsOutput {
    ...
    pub fn listIdMappingWorkflows(self: *Self, allocator: std.mem.Allocator, input: list_id_mapping_workflows.ListIdMappingWorkflowsInput, options: list_id_mapping_workflows.Options) !list_id_mapping_workflows.ListIdMappingWorkflowsOutput {
        return list_id_mapping_workflows.execute(self, allocator, input, options);
    }

    /// Returns a list of all ID namespaces.
    pub fn listIdNamespaces(self: *Self, allocator: std.mem.Allocator, input: list_id_namespaces.ListIdNamespacesInput, options: list_id_namespaces.Options) !list_id_namespaces.ListIdNamespacesOutput {
        return list_id_namespaces.execute(self, allocator, input, options);
    }

    /// Lists all jobs for a given workflow.
    pub fn listMatchingJobs(self: *Self, allocator: std.mem.Allocator, input: list_matching_jobs.ListMatchingJobsInput, options: list_matching_jobs.Options) !list_matching_jobs.ListMatchingJobsOutput {
    ...
    /// Amazon Web Services account.
    pub fn listMatchingWorkflows(self: *Self, allocator: std.mem.Allocator, input: list_matching_workflows.ListMatchingWorkflowsInput, options: list_matching_workflows.Options) !list_matching_workflows.ListMatchingWorkflowsOutput {
    ...
    pub fn listProviderServices(self: *Self, allocator: std.mem.Allocator, input: list_provider_services.ListProviderServicesInput, options: list_provider_services.Options) !list_provider_services.ListProviderServicesOutput {
    ...
    /// Amazon Web Services account.
    pub fn listSchemaMappings(self: *Self, allocator: std.mem.Allocator, input: list_schema_mappings.ListSchemaMappingsInput, options: list_schema_mappings.Options) !list_schema_mappings.ListSchemaMappingsOutput {
    ...
    pub fn startIdMappingJob(self: *Self, allocator: std.mem.Allocator, input: start_id_mapping_job.StartIdMappingJobInput, options: start_id_mapping_job.Options) !start_id_mapping_job.StartIdMappingJobOutput {
    ...
    pub fn startMatchingJob(self: *Self, allocator: std.mem.Allocator, input: start_matching_job.StartMatchingJobInput, options: start_matching_job.Options) !start_matching_job.StartMatchingJobOutput {
    ...
    ///
    /// Incremental processing is not supported for ID mapping workflows.
    pub fn updateIdMappingWorkflow(self: *Self, allocator: std.mem.Allocator, input: update_id_mapping_workflow.UpdateIdMappingWorkflowInput, options: update_id_mapping_workflow.Options) !update_id_mapping_workflow.UpdateIdMappingWorkflowOutput {
        return update_id_mapping_workflow.execute(self, allocator, input, options);
    }

    /// Updates an existing ID namespace.
    pub fn updateIdNamespace(self: *Self, allocator: std.mem.Allocator, input: update_id_namespace.UpdateIdNamespaceInput, options: update_id_namespace.Options) !update_id_namespace.UpdateIdNamespaceOutput {
    ...
    /// For workflows where `resolutionType` is `ML_MATCHING` or `PROVIDER`,
    /// incremental processing is not supported.
    pub fn updateMatchingWorkflow(self: *Self, allocator: std.mem.Allocator, input: update_matching_workflow.UpdateMatchingWorkflowInput, options: update_matching_workflow.Options) !update_matching_workflow.UpdateMatchingWorkflowOutput {
    ...
    pub fn updateSchemaMapping(self: *Self, allocator: std.mem.Allocator, input: update_schema_mapping.UpdateSchemaMappingInput, options: update_schema_mapping.Options) !update_schema_mapping.UpdateSchemaMappingOutput {
