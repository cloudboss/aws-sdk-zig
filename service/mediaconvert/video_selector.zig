const AlphaBehavior = @import("alpha_behavior.zig").AlphaBehavior;
const ColorSpace = @import("color_space.zig").ColorSpace;
const ColorSpaceUsage = @import("color_space_usage.zig").ColorSpaceUsage;
const EmbeddedTimecodeOverride = @import("embedded_timecode_override.zig").EmbeddedTimecodeOverride;
const Hdr10Metadata = @import("hdr_10_metadata.zig").Hdr10Metadata;
const PadVideo = @import("pad_video.zig").PadVideo;
const InputRotate = @import("input_rotate.zig").InputRotate;
const InputSampleRange = @import("input_sample_range.zig").InputSampleRange;
const VideoSelectorType = @import("video_selector_type.zig").VideoSelectorType;
...
pub const VideoSelector = struct {
    ...
    /// stream in your HLS multivariant playlist starting at 1. For re-encoding
    /// workflows, MediaConvert uses the video stream that you select with the
