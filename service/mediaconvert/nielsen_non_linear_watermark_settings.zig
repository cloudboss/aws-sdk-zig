...
pub const NielsenNonLinearWatermarkSettings = struct {
    ...
    /// settings.
    active_watermark_process: ?NielsenActiveWatermarkProcessType = null,
    ...
    /// to Nielsen.
    metadata_destination: ?[]const u8 = null,
    ...
    source_watermark_status: ?NielsenSourceWatermarkStatusType = null,
    ...
    unique_tic_per_audio_track: ?NielsenUniqueTicPerAudioTrackType = null,
