const ProresChromaSampling = @import("prores_chroma_sampling.zig").ProresChromaSampling;
const ProresCodecProfile = @import("prores_codec_profile.zig").ProresCodecProfile;
const ProresFramerateControl = @import("prores_framerate_control.zig").ProresFramerateControl;
const ProresFramerateConversionAlgorithm = @import("prores_framerate_conversion_algorithm.zig").ProresFramerateConversionAlgorithm;
const ProresInterlaceMode = @import("prores_interlace_mode.zig").ProresInterlaceMode;
const ProresParControl = @import("prores_par_control.zig").ProresParControl;
const FrameMetricType = @import("frame_metric_type.zig").FrameMetricType;
const ProresScanTypeConversionMode = @import("prores_scan_type_conversion_mode.zig").ProresScanTypeConversionMode;
const ProresSlowPal = @import("prores_slow_pal.zig").ProresSlowPal;
const ProresTelecine = @import("prores_telecine.zig").ProresTelecine;

/// Required when you set Codec to the value PRORES.
pub const ProresSettings = struct {
