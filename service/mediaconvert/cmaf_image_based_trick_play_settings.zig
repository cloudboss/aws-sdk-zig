const CmafIntervalCadence = @import("cmaf_interval_cadence.zig").CmafIntervalCadence;

/// Tile and thumbnail settings applicable when imageBasedTrickPlay is ADVANCED
pub const CmafImageBasedTrickPlaySettings = struct {
    ...
    interval_cadence: ?CmafIntervalCadence = null,
