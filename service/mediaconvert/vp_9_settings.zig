const Vp9FramerateControl = @import("vp_9_framerate_control.zig").Vp9FramerateControl;
const Vp9FramerateConversionAlgorithm = @import("vp_9_framerate_conversion_algorithm.zig").Vp9FramerateConversionAlgorithm;
const Vp9ParControl = @import("vp_9_par_control.zig").Vp9ParControl;
const Vp9QualityTuningLevel = @import("vp_9_quality_tuning_level.zig").Vp9QualityTuningLevel;
const Vp9RateControlMode = @import("vp_9_rate_control_mode.zig").Vp9RateControlMode;

/// Required when you set Codec to the value VP9.
pub const Vp9Settings = struct {
    ...
    framerate_control: ?Vp9FramerateControl = null,
    ...
    framerate_conversion_algorithm: ?Vp9FramerateConversionAlgorithm = null,
    ...
    /// input video.
    par_control: ?Vp9ParControl = null,
    ...
    quality_tuning_level: ?Vp9QualityTuningLevel = null,

    /// With the VP9 codec, you can use only the variable bitrate (VBR) rate control
    /// mode.
    rate_control_mode: ?Vp9RateControlMode = null,
