const DashIsoIntervalCadence = @import("dash_iso_interval_cadence.zig").DashIsoIntervalCadence;

/// Tile and thumbnail settings applicable when imageBasedTrickPlay is ADVANCED
pub const DashIsoImageBasedTrickPlaySettings = struct {
    ...
    /// thumbnailInterval.
    interval_cadence: ?DashIsoIntervalCadence = null,
