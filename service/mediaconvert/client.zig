...
pub const Client = struct {
    ...
    pub fn associateCertificate(self: *Self, allocator: std.mem.Allocator, input: associate_certificate.AssociateCertificateInput, options: associate_certificate.Options) !associate_certificate.AssociateCertificateOutput {
    ...
    pub fn createPreset(self: *Self, allocator: std.mem.Allocator, input: create_preset.CreatePresetInput, options: create_preset.Options) !create_preset.CreatePresetOutput {
    ...
    pub fn deletePreset(self: *Self, allocator: std.mem.Allocator, input: delete_preset.DeletePresetInput, options: delete_preset.Options) !delete_preset.DeletePresetOutput {
    ...
    /// resource.
    pub fn disassociateCertificate(self: *Self, allocator: std.mem.Allocator, input: disassociate_certificate.DisassociateCertificateInput, options: disassociate_certificate.Options) !disassociate_certificate.DisassociateCertificateOutput {
    ...
    pub fn getJobTemplate(self: *Self, allocator: std.mem.Allocator, input: get_job_template.GetJobTemplateInput, options: get_job_template.Options) !get_job_template.GetJobTemplateOutput {
    ...
    /// jobs query.
    pub fn getJobsQueryResults(self: *Self, allocator: std.mem.Allocator, input: get_jobs_query_results.GetJobsQueryResultsInput, options: get_jobs_query_results.Options) !get_jobs_query_results.GetJobsQueryResultsOutput {
    ...
    pub fn getPreset(self: *Self, allocator: std.mem.Allocator, input: get_preset.GetPresetInput, options: get_preset.Options) !get_preset.GetPresetOutput {
    ...
    pub fn listPresets(self: *Self, allocator: std.mem.Allocator, input: list_presets.ListPresetsInput, options: list_presets.Options) !list_presets.ListPresetsOutput {
    ...
    pub fn probe(self: *Self, allocator: std.mem.Allocator, input: probe_.ProbeInput, options: probe_.Options) !probe_.ProbeOutput {
    ...
    pub fn startJobsQuery(self: *Self, allocator: std.mem.Allocator, input: start_jobs_query.StartJobsQueryInput, options: start_jobs_query.Options) !start_jobs_query.StartJobsQueryOutput {
    ...
    pub fn updateJobTemplate(self: *Self, allocator: std.mem.Allocator, input: update_job_template.UpdateJobTemplateInput, options: update_job_template.Options) !update_job_template.UpdateJobTemplateOutput {
        return update_job_template.execute(self, allocator, input, options);
    }

    /// Modify one of your existing presets.
    pub fn updatePreset(self: *Self, allocator: std.mem.Allocator, input: update_preset.UpdatePresetInput, options: update_preset.Options) !update_preset.UpdatePresetOutput {
