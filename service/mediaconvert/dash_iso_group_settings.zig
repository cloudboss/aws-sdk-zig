const DashAdditionalManifest = @import("dash_additional_manifest.zig").DashAdditionalManifest;
const DashIsoGroupAudioChannelConfigSchemeIdUri = @import("dash_iso_group_audio_channel_config_scheme_id_uri.zig").DashIsoGroupAudioChannelConfigSchemeIdUri;
...
const DashIsoEncryptionSettings = @import("dash_iso_encryption_settings.zig").DashIsoEncryptionSettings;
...
const DashIsoSegmentControl = @import("dash_iso_segment_control.zig").DashIsoSegmentControl;
const DashIsoSegmentLengthControl = @import("dash_iso_segment_length_control.zig").DashIsoSegmentLengthControl;
const DashIsoVideoCompositionOffsets = @import("dash_iso_video_composition_offsets.zig").DashIsoVideoCompositionOffsets;
const DashIsoWriteSegmentTimelineInRepresentation = @import("dash_iso_write_segment_timeline_in_representation.zig").DashIsoWriteSegmentTimelineInRepresentation;

/// Settings related to your DASH output package. For more information, see
/// https://docs.aws.amazon.com/mediaconvert/latest/ug/outputs-file-ABR.html.
pub const DashIsoGroupSettings = struct {
