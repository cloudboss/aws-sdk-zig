...
pub const Client = struct {
    ...
    pub fn addProfilePermission(self: *Self, allocator: std.mem.Allocator, input: add_profile_permission.AddProfilePermissionInput, options: CallOptions) !add_profile_permission.AddProfilePermissionOutput {
    ...
    pub fn cancelSigningProfile(self: *Self, allocator: std.mem.Allocator, input: cancel_signing_profile.CancelSigningProfileInput, options: CallOptions) !cancel_signing_profile.CancelSigningProfileOutput {
    ...
    /// operation.
    pub fn describeSigningJob(self: *Self, allocator: std.mem.Allocator, input: describe_signing_job.DescribeSigningJobInput, options: CallOptions) !describe_signing_job.DescribeSigningJobOutput {
    ...
    pub fn getSigningPlatform(self: *Self, allocator: std.mem.Allocator, input: get_signing_platform.GetSigningPlatformInput, options: CallOptions) !get_signing_platform.GetSigningPlatformOutput {
        return get_signing_platform.execute(self, allocator, input, options);
    }

    /// Returns information on a specific signing profile.
    pub fn getSigningProfile(self: *Self, allocator: std.mem.Allocator, input: get_signing_profile.GetSigningProfileInput, options: CallOptions) !get_signing_profile.GetSigningProfileOutput {
        return get_signing_profile.execute(self, allocator, input, options);
    }

    /// Lists the cross-account permissions associated with a signing profile.
    pub fn listProfilePermissions(self: *Self, allocator: std.mem.Allocator, input: list_profile_permissions.ListProfilePermissionsInput, options: CallOptions) !list_profile_permissions.ListProfilePermissionsOutput {
    ...
    pub fn listSigningJobs(self: *Self, allocator: std.mem.Allocator, input: list_signing_jobs.ListSigningJobsInput, options: CallOptions) !list_signing_jobs.ListSigningJobsOutput {
    ...
    /// returned.
    pub fn listSigningPlatforms(self: *Self, allocator: std.mem.Allocator, input: list_signing_platforms.ListSigningPlatformsInput, options: CallOptions) !list_signing_platforms.ListSigningPlatformsOutput {
    ...
    pub fn listSigningProfiles(self: *Self, allocator: std.mem.Allocator, input: list_signing_profiles.ListSigningProfilesInput, options: CallOptions) !list_signing_profiles.ListSigningProfilesOutput {
    ...
    pub fn putSigningProfile(self: *Self, allocator: std.mem.Allocator, input: put_signing_profile.PutSigningProfileInput, options: CallOptions) !put_signing_profile.PutSigningProfileOutput {
        return put_signing_profile.execute(self, allocator, input, options);
    }

    /// Removes cross-account permissions from a signing profile.
    pub fn removeProfilePermission(self: *Self, allocator: std.mem.Allocator, input: remove_profile_permission.RemoveProfilePermissionInput, options: CallOptions) !remove_profile_permission.RemoveProfilePermissionOutput {
    ...
    /// signature is no
    /// longer valid.
    pub fn revokeSignature(self: *Self, allocator: std.mem.Allocator, input: revoke_signature.RevokeSignatureInput, options: CallOptions) !revoke_signature.RevokeSignatureOutput {
    ...
    pub fn revokeSigningProfile(self: *Self, allocator: std.mem.Allocator, input: revoke_signing_profile.RevokeSigningProfileInput, options: CallOptions) !revoke_signing_profile.RevokeSigningProfileOutput {
        return revoke_signing_profile.execute(self, allocator, input, options);
    }

    /// Signs a binary payload and returns a signature envelope.
    pub fn signPayload(self: *Self, allocator: std.mem.Allocator, input: sign_payload.SignPayloadInput, options: CallOptions) !sign_payload.SignPayloadOutput {
    ...
    pub fn startSigningJob(self: *Self, allocator: std.mem.Allocator, input: start_signing_job.StartSigningJobInput, options: CallOptions) !start_signing_job.StartSigningJobOutput {
