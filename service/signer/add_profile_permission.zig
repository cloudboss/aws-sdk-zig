...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddProfilePermissionInput, options: CallOptions) !AddProfilePermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddProfilePermissionInput, config: *aws.Config) !aws.http.Request {
