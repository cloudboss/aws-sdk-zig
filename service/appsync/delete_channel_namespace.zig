...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelNamespaceInput, options: CallOptions) !DeleteChannelNamespaceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteChannelNamespaceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteChannelNamespaceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
