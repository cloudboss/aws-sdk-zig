...
pub const DeleteChannelNamespaceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelNamespaceInput, options: Options) !DeleteChannelNamespaceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteChannelNamespaceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteChannelNamespaceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteChannelNamespaceOutput = .{};
