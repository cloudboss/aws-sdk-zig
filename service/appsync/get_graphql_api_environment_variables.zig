...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetGraphqlApiEnvironmentVariablesInput, options: CallOptions) !GetGraphqlApiEnvironmentVariablesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetGraphqlApiEnvironmentVariablesInput, config: *aws.Config) !aws.http.Request {
