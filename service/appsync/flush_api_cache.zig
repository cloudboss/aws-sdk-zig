...
fn serializeRequest(alloc: std.mem.Allocator, input: FlushApiCacheInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/FlushCache");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !FlushApiCacheOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
