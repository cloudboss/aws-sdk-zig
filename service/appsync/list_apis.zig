...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListApisInput, options: CallOptions) !ListApisOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListApisInput, config: *aws.Config) !aws.http.Request {
