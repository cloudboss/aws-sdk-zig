...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTypesByAssociationInput, options: CallOptions) !ListTypesByAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTypesByAssociationInput, config: *aws.Config) !aws.http.Request {
