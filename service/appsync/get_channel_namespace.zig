...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChannelNamespaceInput, options: CallOptions) !GetChannelNamespaceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetChannelNamespaceInput, config: *aws.Config) !aws.http.Request {
