...
pub const DisassociateApiInput = struct {
    /// The domain name.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateApiInput, options: Options) !DisassociateApiOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateApiInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateApiOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateApiOutput = .{};
