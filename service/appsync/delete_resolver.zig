...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteResolverInput, options: CallOptions) !DeleteResolverOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteResolverInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteResolverOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
