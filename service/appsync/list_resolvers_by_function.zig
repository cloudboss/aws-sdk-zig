...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResolversByFunctionInput, options: CallOptions) !ListResolversByFunctionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListResolversByFunctionInput, config: *aws.Config) !aws.http.Request {
