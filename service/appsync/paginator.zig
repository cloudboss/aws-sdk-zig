...
pub const ListApiKeysPaginator = struct {
    client: *Client,
    params: list_api_keys.ListApiKeysInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_api_keys.ListApiKeysOutput {
        if (self.done) {
...
pub const ListApisPaginator = struct {
    client: *Client,
    params: list_apis.ListApisInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_apis.ListApisOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListChannelNamespacesPaginator = struct {
    client: *Client,
    params: list_channel_namespaces.ListChannelNamespacesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_channel_namespaces.ListChannelNamespacesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDomainNamesPaginator = struct {
    client: *Client,
    params: list_domain_names.ListDomainNamesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_domain_names.ListDomainNamesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListGraphqlApisPaginator = struct {
    client: *Client,
    params: list_graphql_apis.ListGraphqlApisInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_graphql_apis.ListGraphqlApisOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListResolversPaginator = struct {
    client: *Client,
    params: list_resolvers.ListResolversInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_resolvers.ListResolversOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListResolversByFunctionPaginator = struct {
    client: *Client,
    params: list_resolvers_by_function.ListResolversByFunctionInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_resolvers_by_function.ListResolversByFunctionOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSourceApiAssociationsPaginator = struct {
    client: *Client,
    params: list_source_api_associations.ListSourceApiAssociationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_source_api_associations.ListSourceApiAssociationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTypesPaginator = struct {
    client: *Client,
    params: list_types.ListTypesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_types.ListTypesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTypesByAssociationPaginator = struct {
    client: *Client,
    params: list_types_by_association.ListTypesByAssociationInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_types_by_association.ListTypesByAssociationOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
