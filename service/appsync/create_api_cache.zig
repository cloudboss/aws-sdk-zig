...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateApiCacheInput, options: CallOptions) !CreateApiCacheOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateApiCacheInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/ApiCaches");
