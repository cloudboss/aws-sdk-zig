...
pub const DeleteDomainNameInput = struct {
    /// The domain name.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDomainNameInput, options: Options) !DeleteDomainNameOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDomainNameInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/v1/domainnames/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDomainNameOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDomainNameOutput = .{};
