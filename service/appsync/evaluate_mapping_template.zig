...
pub const EvaluateMappingTemplateInput = struct {
...
pub const EvaluateMappingTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EvaluateMappingTemplateInput, options: Options) !EvaluateMappingTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EvaluateMappingTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v1/dataplane-evaluatetemplate";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !EvaluateMappingTemplateOutput {
    var result: EvaluateMappingTemplateOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(EvaluateMappingTemplateOutput, body, alloc);
    }
    _ = status;
    _ = headers;
