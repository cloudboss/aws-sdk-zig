...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApiAssociationInput, options: CallOptions) !GetApiAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetApiAssociationInput, config: *aws.Config) !aws.http.Request {
