...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateChannelNamespaceInput, options: CallOptions) !UpdateChannelNamespaceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateChannelNamespaceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateChannelNamespaceOutput {
    var result: UpdateChannelNamespaceOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateChannelNamespaceOutput, body, allocator);
    }
    _ = status;
    _ = headers;
