...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListOrganizationRecommendationAccountsInput, options: Options) !ListOrganizationRecommendationAccountsOutput {
