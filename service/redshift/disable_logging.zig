...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableLoggingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableLoggingOutput {
    _ = status;
    _ = headers;
