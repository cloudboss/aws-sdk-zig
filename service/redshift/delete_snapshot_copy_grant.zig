...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSnapshotCopyGrantInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteSnapshotCopyGrant&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSnapshotCopyGrantOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
