...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyClusterSubnetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyClusterSubnetGroup&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyClusterSubnetGroupOutput {
    _ = status;
    _ = headers;
