...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDefaultClusterParametersInput, options: Options) !DescribeDefaultClusterParametersOutput {
