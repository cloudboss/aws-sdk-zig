...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeStorageInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeStorage&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeStorageOutput {
    _ = status;
    _ = headers;
    _ = alloc;
