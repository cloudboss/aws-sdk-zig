...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteHsmConfigurationInput, options: CallOptions) !DeleteHsmConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteHsmConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteHsmConfiguration&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteHsmConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
