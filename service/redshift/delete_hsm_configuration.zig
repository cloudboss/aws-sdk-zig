...
pub const DeleteHsmConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteHsmConfigurationInput, options: Options) !DeleteHsmConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteHsmConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteHsmConfiguration&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteHsmConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteHsmConfigurationOutput = .{};
