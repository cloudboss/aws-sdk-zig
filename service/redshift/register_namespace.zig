...
fn serializeRequest(allocator: std.mem.Allocator, input: RegisterNamespaceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RegisterNamespace&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RegisterNamespaceOutput {
    _ = status;
    _ = headers;
    _ = allocator;
