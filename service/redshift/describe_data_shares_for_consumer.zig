...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSharesForConsumerInput, options: Options) !DescribeDataSharesForConsumerOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeDataSharesForConsumerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeDataSharesForConsumer&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeDataSharesForConsumerOutput {
    _ = status;
    _ = headers;
