...
pub const DeleteClusterSecurityGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClusterSecurityGroupInput, options: Options) !DeleteClusterSecurityGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteClusterSecurityGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteClusterSecurityGroup&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteClusterSecurityGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteClusterSecurityGroupOutput = .{};
