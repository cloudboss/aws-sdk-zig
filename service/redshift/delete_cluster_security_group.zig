...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClusterSecurityGroupInput, options: CallOptions) !DeleteClusterSecurityGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteClusterSecurityGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteClusterSecurityGroup&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteClusterSecurityGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
