...
pub const Snapshot = struct {
    ...
    accounts_with_restore_access: ?[]const AccountWithRestoreAccess,
    ...
    manual_snapshot_remaining_days: ?i32,
    ...
    /// into.
    restorable_node_types: ?[]const []const u8,
    ...
    snapshot_retention_start_time: ?i64,
