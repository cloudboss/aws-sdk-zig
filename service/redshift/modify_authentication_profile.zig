...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyAuthenticationProfileInput, options: CallOptions) !ModifyAuthenticationProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyAuthenticationProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ModifyAuthenticationProfile&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyAuthenticationProfileOutput {
    _ = status;
    _ = headers;
