...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTagsInput, options: Options) !CreateTagsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTagsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateTags&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTagsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
