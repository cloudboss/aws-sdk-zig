...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetReservedNodeExchangeConfigurationOptionsInput, options: Options) !GetReservedNodeExchangeConfigurationOptionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetReservedNodeExchangeConfigurationOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetReservedNodeExchangeConfigurationOptions&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetReservedNodeExchangeConfigurationOptionsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "Marker")) {
                    ...
                    result.reserved_node_configuration_option_list = try serde.deserializeReservedNodeConfigurationOptionList(&reader, alloc, "ReservedNodeConfigurationOption");
                } else {
