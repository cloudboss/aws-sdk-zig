...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAuthenticationProfileInput, options: Options) !CreateAuthenticationProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateAuthenticationProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateAuthenticationProfile&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateAuthenticationProfileOutput {
    _ = status;
    _ = headers;
