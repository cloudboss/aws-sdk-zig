...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdatePartnerStatusInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdatePartnerStatus&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdatePartnerStatusOutput {
    _ = status;
    _ = headers;
