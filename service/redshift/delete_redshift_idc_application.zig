...
pub const DeleteRedshiftIdcApplicationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRedshiftIdcApplicationInput, options: Options) !DeleteRedshiftIdcApplicationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteRedshiftIdcApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteRedshiftIdcApplication&Version=2012-12-01");
    try body_buf.appendSlice(alloc, "&RedshiftIdcApplicationArn=");
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.redshift_idc_application_arn);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteRedshiftIdcApplicationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteRedshiftIdcApplicationOutput = .{};
