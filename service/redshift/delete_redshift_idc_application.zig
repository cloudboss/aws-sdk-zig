...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRedshiftIdcApplicationInput, options: CallOptions) !DeleteRedshiftIdcApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRedshiftIdcApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteRedshiftIdcApplication&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRedshiftIdcApplicationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
