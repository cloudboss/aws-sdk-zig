...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOrderableClusterOptionsInput, options: Options) !DescribeOrderableClusterOptionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeOrderableClusterOptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeOrderableClusterOptions&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeOrderableClusterOptionsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "Marker")) {
                    ...
                    result.orderable_cluster_options = try serde.deserializeOrderableClusterOptionsList(&reader, alloc, "OrderableClusterOption");
                } else {
