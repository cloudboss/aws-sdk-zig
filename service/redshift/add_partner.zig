...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddPartnerInput, options: CallOptions) !AddPartnerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddPartnerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AddPartner&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddPartnerOutput {
    _ = status;
    _ = headers;
