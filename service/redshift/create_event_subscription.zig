...
pub const CreateEventSubscriptionInput = struct {
    ...
    /// event
    /// notifications. The ARN is created by Amazon SNS when you create a topic and
    /// subscribe to
    /// it.
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateEventSubscriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateEventSubscription&Version=2012-12-01");
    if (input.enabled) |v| {
