...
pub const DeleteClusterSnapshotInput = @import("delete_cluster_snapshot_message.zig").DeleteClusterSnapshotMessage;

pub const DeleteClusterSnapshotOutput = struct {
    snapshot: ?Snapshot = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClusterSnapshotInput, options: CallOptions) !DeleteClusterSnapshotOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteClusterSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteClusterSnapshot&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteClusterSnapshotOutput {
    _ = status;
    _ = headers;
