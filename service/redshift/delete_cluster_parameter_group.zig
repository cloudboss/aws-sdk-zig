...
pub const DeleteClusterParameterGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClusterParameterGroupInput, options: Options) !DeleteClusterParameterGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteClusterParameterGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteClusterParameterGroup&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteClusterParameterGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteClusterParameterGroupOutput = .{};
