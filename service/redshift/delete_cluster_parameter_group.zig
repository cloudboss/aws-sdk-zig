...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClusterParameterGroupInput, options: CallOptions) !DeleteClusterParameterGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteClusterParameterGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteClusterParameterGroup&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteClusterParameterGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
