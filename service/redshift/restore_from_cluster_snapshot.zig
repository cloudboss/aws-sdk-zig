...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestoreFromClusterSnapshotInput, options: Options) !RestoreFromClusterSnapshotOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RestoreFromClusterSnapshotInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RestoreFromClusterSnapshot&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RestoreFromClusterSnapshotOutput {
    _ = status;
    _ = headers;
