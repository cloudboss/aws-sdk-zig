...
const CreateSnapshotScheduleOutput = @import("snapshot_schedule.zig").SnapshotSchedule;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSnapshotScheduleInput, options: Options) !CreateSnapshotScheduleOutput {
