...
pub const DeleteClusterSubnetGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClusterSubnetGroupInput, options: CallOptions) !DeleteClusterSubnetGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteClusterSubnetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteClusterSubnetGroup&Version=2012-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteClusterSubnetGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteClusterSubnetGroupOutput = .{};
