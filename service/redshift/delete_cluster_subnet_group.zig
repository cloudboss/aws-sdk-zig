...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteClusterSubnetGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteClusterSubnetGroup&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteClusterSubnetGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
