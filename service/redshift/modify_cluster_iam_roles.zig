...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyClusterIamRolesInput, options: Options) !ModifyClusterIamRolesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ModifyClusterIamRolesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ModifyClusterIamRoles&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ModifyClusterIamRolesOutput {
    _ = status;
    _ = headers;
