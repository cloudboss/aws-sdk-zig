...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeClusterParameterGroupsInput, options: Options) !DescribeClusterParameterGroupsOutput {
