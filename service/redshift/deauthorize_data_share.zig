...
fn serializeRequest(alloc: std.mem.Allocator, input: DeauthorizeDataShareInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeauthorizeDataShare&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeauthorizeDataShareOutput {
    _ = status;
    _ = headers;
