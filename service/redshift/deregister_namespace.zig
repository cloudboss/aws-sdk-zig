...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterNamespaceInput, options: Options) !DeregisterNamespaceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeregisterNamespaceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeregisterNamespace&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeregisterNamespaceOutput {
    _ = status;
    _ = headers;
    _ = alloc;
