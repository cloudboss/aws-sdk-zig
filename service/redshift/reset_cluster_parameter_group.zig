...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResetClusterParameterGroupInput, options: Options) !ResetClusterParameterGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ResetClusterParameterGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ResetClusterParameterGroup&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ResetClusterParameterGroupOutput {
    _ = status;
    _ = headers;
