...
pub const RedshiftIdcApplication = struct {
    ...
    /// application.
    authorized_token_issuer_list: ?[]const AuthorizedTokenIssuer,
    ...
    /// application.
    service_integrations: ?[]const ServiceIntegrationsUnion,
