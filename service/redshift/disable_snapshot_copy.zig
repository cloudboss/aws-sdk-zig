...
fn serializeRequest(alloc: std.mem.Allocator, input: DisableSnapshotCopyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DisableSnapshotCopy&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisableSnapshotCopyOutput {
    _ = status;
    _ = headers;
