...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeDataSharesInput, options: Options) !DescribeDataSharesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeDataSharesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeDataShares&Version=2012-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeDataSharesOutput {
    _ = status;
    _ = headers;
