...
pub const ListKeyspacesPaginator = struct {
    client: *Client,
    params: list_keyspaces.ListKeyspacesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_keyspaces.ListKeyspacesOutput {
        if (self.done) {
