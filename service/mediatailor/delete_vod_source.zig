...
pub const DeleteVodSourceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVodSourceInput, options: Options) !DeleteVodSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVodSourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVodSourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVodSourceOutput = .{};
