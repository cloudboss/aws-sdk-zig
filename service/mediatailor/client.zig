...
pub const Client = struct {
    ...
    pub fn configureLogsForChannel(self: *Self, allocator: std.mem.Allocator, input: configure_logs_for_channel.ConfigureLogsForChannelInput, options: CallOptions) !configure_logs_for_channel.ConfigureLogsForChannelOutput {
    ...
    /// configuration.
    pub fn configureLogsForPlaybackConfiguration(self: *Self, allocator: std.mem.Allocator, input: configure_logs_for_playback_configuration.ConfigureLogsForPlaybackConfigurationInput, options: CallOptions) !configure_logs_for_playback_configuration.ConfigureLogsForPlaybackConfigurationOutput {
    ...
    pub fn createLiveSource(self: *Self, allocator: std.mem.Allocator, input: create_live_source.CreateLiveSourceInput, options: CallOptions) !create_live_source.CreateLiveSourceOutput {
    ...
    pub fn createPrefetchSchedule(self: *Self, allocator: std.mem.Allocator, input: create_prefetch_schedule.CreatePrefetchScheduleInput, options: CallOptions) !create_prefetch_schedule.CreatePrefetchScheduleOutput {
    ...
    pub fn createProgram(self: *Self, allocator: std.mem.Allocator, input: create_program.CreateProgramInput, options: CallOptions) !create_program.CreateProgramOutput {
    ...
    pub fn createSourceLocation(self: *Self, allocator: std.mem.Allocator, input: create_source_location.CreateSourceLocationInput, options: CallOptions) !create_source_location.CreateSourceLocationOutput {
        return create_source_location.execute(self, allocator, input, options);
    }

    /// The VOD source configuration parameters.
    pub fn createVodSource(self: *Self, allocator: std.mem.Allocator, input: create_vod_source.CreateVodSourceInput, options: CallOptions) !create_vod_source.CreateVodSourceOutput {
    ...
    pub fn deleteChannelPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_channel_policy.DeleteChannelPolicyInput, options: CallOptions) !delete_channel_policy.DeleteChannelPolicyOutput {
    ...
    pub fn deletePlaybackConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_playback_configuration.DeletePlaybackConfigurationInput, options: CallOptions) !delete_playback_configuration.DeletePlaybackConfigurationOutput {
    ...
    /// see [Using ad
    /// prefetching](https://docs.aws.amazon.com/mediatailor/latest/ug/prefetching-ads.html) in the *MediaTailor User Guide*.
    pub fn deletePrefetchSchedule(self: *Self, allocator: std.mem.Allocator, input: delete_prefetch_schedule.DeletePrefetchScheduleInput, options: CallOptions) !delete_prefetch_schedule.DeletePrefetchScheduleOutput {
    ...
    /// [Working with
    /// programs](https://docs.aws.amazon.com/mediatailor/latest/ug/channel-assembly-programs.html) in the *MediaTailor User Guide*.
    pub fn deleteProgram(self: *Self, allocator: std.mem.Allocator, input: delete_program.DeleteProgramInput, options: CallOptions) !delete_program.DeleteProgramOutput {
    ...
    /// more information about source locations, see [Working with source
    /// locations](https://docs.aws.amazon.com/mediatailor/latest/ug/channel-assembly-source-locations.html) in the *MediaTailor User Guide*.
    pub fn deleteSourceLocation(self: *Self, allocator: std.mem.Allocator, input: delete_source_location.DeleteSourceLocationInput, options: CallOptions) !delete_source_location.DeleteSourceLocationOutput {
        return delete_source_location.execute(self, allocator, input, options);
    }

    /// The video on demand (VOD) source to delete.
    pub fn deleteVodSource(self: *Self, allocator: std.mem.Allocator, input: delete_vod_source.DeleteVodSourceInput, options: CallOptions) !delete_vod_source.DeleteVodSourceOutput {
    ...
    pub fn describeLiveSource(self: *Self, allocator: std.mem.Allocator, input: describe_live_source.DescribeLiveSourceInput, options: CallOptions) !describe_live_source.DescribeLiveSourceOutput {
    ...
    /// [Working with
    /// programs](https://docs.aws.amazon.com/mediatailor/latest/ug/channel-assembly-programs.html) in the *MediaTailor User Guide*.
    pub fn describeProgram(self: *Self, allocator: std.mem.Allocator, input: describe_program.DescribeProgramInput, options: CallOptions) !describe_program.DescribeProgramOutput {
    ...
    /// locations](https://docs.aws.amazon.com/mediatailor/latest/ug/channel-assembly-source-locations.html) in the *MediaTailor User Guide*.
    pub fn describeSourceLocation(self: *Self, allocator: std.mem.Allocator, input: describe_source_location.DescribeSourceLocationInput, options: CallOptions) !describe_source_location.DescribeSourceLocationOutput {
    ...
    /// source location.
    pub fn describeVodSource(self: *Self, allocator: std.mem.Allocator, input: describe_vod_source.DescribeVodSourceInput, options: CallOptions) !describe_vod_source.DescribeVodSourceOutput {
    ...
    /// your channel.
    pub fn getChannelPolicy(self: *Self, allocator: std.mem.Allocator, input: get_channel_policy.GetChannelPolicyInput, options: CallOptions) !get_channel_policy.GetChannelPolicyOutput {
        return get_channel_policy.execute(self, allocator, input, options);
    }

    /// Retrieves information about your channel's schedule.
    pub fn getChannelSchedule(self: *Self, allocator: std.mem.Allocator, input: get_channel_schedule.GetChannelScheduleInput, options: CallOptions) !get_channel_schedule.GetChannelScheduleOutput {
    ...
    /// configurations, see [Working with configurations in AWS Elemental
    /// MediaTailor](https://docs.aws.amazon.com/mediatailor/latest/ug/configurations.html).
    pub fn getPlaybackConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_playback_configuration.GetPlaybackConfigurationInput, options: CallOptions) !get_playback_configuration.GetPlaybackConfigurationOutput {
    ...
    /// [Using ad
    /// prefetching](https://docs.aws.amazon.com/mediatailor/latest/ug/prefetching-ads.html) in the *MediaTailor User Guide*.
    pub fn getPrefetchSchedule(self: *Self, allocator: std.mem.Allocator, input: get_prefetch_schedule.GetPrefetchScheduleInput, options: CallOptions) !get_prefetch_schedule.GetPrefetchScheduleOutput {
    ...
    /// piece of content.
    pub fn listLiveSources(self: *Self, allocator: std.mem.Allocator, input: list_live_sources.ListLiveSourcesInput, options: CallOptions) !list_live_sources.ListLiveSourcesOutput {
    ...
    /// Elemental
    /// MediaTailor](https://docs.aws.amazon.com/mediatailor/latest/ug/configurations.html).
    pub fn listPlaybackConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_playback_configurations.ListPlaybackConfigurationsInput, options: CallOptions) !list_playback_configurations.ListPlaybackConfigurationsOutput {
        return list_playback_configurations.execute(self, allocator, input, options);
    }

    /// Lists the prefetch schedules for a playback configuration.
    pub fn listPrefetchSchedules(self: *Self, allocator: std.mem.Allocator, input: list_prefetch_schedules.ListPrefetchSchedulesInput, options: CallOptions) !list_prefetch_schedules.ListPrefetchSchedulesOutput {
    ...
    pub fn listSourceLocations(self: *Self, allocator: std.mem.Allocator, input: list_source_locations.ListSourceLocationsInput, options: CallOptions) !list_source_locations.ListSourceLocationsOutput {
    ...
    /// piece of content.
    pub fn listVodSources(self: *Self, allocator: std.mem.Allocator, input: list_vod_sources.ListVodSourcesInput, options: CallOptions) !list_vod_sources.ListVodSourcesOutput {
    ...
    /// configurations, see [Working with configurations in AWS Elemental
    /// MediaTailor](https://docs.aws.amazon.com/mediatailor/latest/ug/configurations.html).
    pub fn putPlaybackConfiguration(self: *Self, allocator: std.mem.Allocator, input: put_playback_configuration.PutPlaybackConfigurationInput, options: CallOptions) !put_playback_configuration.PutPlaybackConfigurationOutput {
    ...
    pub fn updateLiveSource(self: *Self, allocator: std.mem.Allocator, input: update_live_source.UpdateLiveSourceInput, options: CallOptions) !update_live_source.UpdateLiveSourceOutput {
        return update_live_source.execute(self, allocator, input, options);
    }

    /// Updates a program within a channel.
    pub fn updateProgram(self: *Self, allocator: std.mem.Allocator, input: update_program.UpdateProgramInput, options: CallOptions) !update_program.UpdateProgramOutput {
    ...
    /// more information about source locations, see [Working with source
    /// locations](https://docs.aws.amazon.com/mediatailor/latest/ug/channel-assembly-source-locations.html) in the *MediaTailor User Guide*.
    pub fn updateSourceLocation(self: *Self, allocator: std.mem.Allocator, input: update_source_location.UpdateSourceLocationInput, options: CallOptions) !update_source_location.UpdateSourceLocationOutput {
        return update_source_location.execute(self, allocator, input, options);
    }

    /// Updates a VOD source's configuration.
    pub fn updateVodSource(self: *Self, allocator: std.mem.Allocator, input: update_vod_source.UpdateVodSourceInput, options: CallOptions) !update_vod_source.UpdateVodSourceOutput {
