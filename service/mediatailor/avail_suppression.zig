const FillPolicy = @import("fill_policy.zig").FillPolicy;
...
pub const AvailSuppression = struct {
    ...
    /// the ad suppression Value time in the manifest lookback window. When Mode is
