...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutChannelPolicyInput, options: Options) !PutChannelPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutChannelPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutChannelPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
