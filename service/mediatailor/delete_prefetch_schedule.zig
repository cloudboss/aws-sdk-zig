...
pub const DeletePrefetchScheduleInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePrefetchScheduleInput, options: CallOptions) !DeletePrefetchScheduleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePrefetchScheduleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePrefetchScheduleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePrefetchScheduleOutput = .{};
