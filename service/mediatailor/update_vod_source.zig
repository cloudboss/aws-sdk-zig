...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateVodSourceInput, options: CallOptions) !UpdateVodSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateVodSourceInput, config: *aws.Config) !aws.http.Request {
