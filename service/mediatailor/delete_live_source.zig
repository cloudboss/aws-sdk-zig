...
pub const DeleteLiveSourceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLiveSourceInput, options: Options) !DeleteLiveSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLiveSourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLiveSourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLiveSourceOutput = .{};
