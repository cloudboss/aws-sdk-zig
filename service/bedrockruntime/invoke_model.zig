...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: InvokeModelInput, options: Options) !InvokeModelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: InvokeModelInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/invoke");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !InvokeModelOutput {
