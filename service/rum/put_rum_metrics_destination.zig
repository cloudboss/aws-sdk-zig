...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutRumMetricsDestinationInput, options: Options) !PutRumMetricsDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutRumMetricsDestinationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutRumMetricsDestinationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
