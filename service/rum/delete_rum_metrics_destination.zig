...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRumMetricsDestinationInput, options: Options) !DeleteRumMetricsDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteRumMetricsDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/metricsdestination");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteRumMetricsDestinationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
