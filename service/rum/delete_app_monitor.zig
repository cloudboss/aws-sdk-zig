...
pub const DeleteAppMonitorInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppMonitorInput, options: Options) !DeleteAppMonitorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppMonitorInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAppMonitorOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAppMonitorOutput = .{};
