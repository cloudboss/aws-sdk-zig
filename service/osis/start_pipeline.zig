...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartPipelineInput, options: CallOptions) !StartPipelineOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartPipelineInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2022-01-01/osis/startPipeline/");
