...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RevokePipelineEndpointConnectionsInput, options: Options) !RevokePipelineEndpointConnectionsOutput {
