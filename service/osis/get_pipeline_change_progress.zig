...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetPipelineChangeProgressInput, options: CallOptions) !GetPipelineChangeProgressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetPipelineChangeProgressInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2022-01-01/osis/getPipelineChangeProgress/");
