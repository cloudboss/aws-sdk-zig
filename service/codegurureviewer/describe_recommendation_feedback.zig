...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRecommendationFeedbackInput, options: Options) !DescribeRecommendationFeedbackOutput {
