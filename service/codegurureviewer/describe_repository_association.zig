...
pub const DescribeRepositoryAssociationInput = struct {
...
pub const DescribeRepositoryAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRepositoryAssociationInput, options: CallOptions) !DescribeRepositoryAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeRepositoryAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.association_arn);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeRepositoryAssociationOutput {
    var result: DescribeRepositoryAssociationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeRepositoryAssociationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
