...
pub const DisassociateRepositoryInput = struct {
...
pub const DisassociateRepositoryOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateRepositoryInput, options: CallOptions) !DisassociateRepositoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateRepositoryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateRepositoryOutput {
    var result: DisassociateRepositoryOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DisassociateRepositoryOutput, body, allocator);
    }
    _ = status;
    _ = headers;
