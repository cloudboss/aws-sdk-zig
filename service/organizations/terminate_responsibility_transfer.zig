...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TerminateResponsibilityTransferInput, options: Options) !TerminateResponsibilityTransferOutput {
