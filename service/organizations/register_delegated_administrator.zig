...
pub const RegisterDelegatedAdministratorInput = struct {
...
pub const RegisterDelegatedAdministratorOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RegisterDelegatedAdministratorInput, options: CallOptions) !RegisterDelegatedAdministratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RegisterDelegatedAdministratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSOrganizationsV20161128.RegisterDelegatedAdministrator");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RegisterDelegatedAdministratorOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
