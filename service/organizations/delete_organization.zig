...
const DeleteOrganizationInput = struct {};

const DeleteOrganizationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteOrganizationInput, options: Options) !DeleteOrganizationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteOrganizationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSOrganizationsV20161128.DeleteOrganization");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteOrganizationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
