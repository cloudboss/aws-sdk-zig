...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListInboundResponsibilityTransfersInput, options: Options) !ListInboundResponsibilityTransfersOutput {
