...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDelegatedServicesForAccountInput, options: Options) !ListDelegatedServicesForAccountOutput {
