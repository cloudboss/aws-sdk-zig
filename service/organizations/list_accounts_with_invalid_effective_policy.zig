...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAccountsWithInvalidEffectivePolicyInput, options: Options) !ListAccountsWithInvalidEffectivePolicyOutput {
