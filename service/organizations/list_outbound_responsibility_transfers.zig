...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListOutboundResponsibilityTransfersInput, options: Options) !ListOutboundResponsibilityTransfersOutput {
