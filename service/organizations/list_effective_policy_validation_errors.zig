...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEffectivePolicyValidationErrorsInput, options: Options) !ListEffectivePolicyValidationErrorsOutput {
