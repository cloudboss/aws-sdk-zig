...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeResponsibilityTransferInput, options: Options) !DescribeResponsibilityTransferOutput {
