...
pub const PutCorsPolicyInput = struct {
    /// The name of the container that you want to assign the CORS policy to.
    container_name: []const u8,

    /// The CORS policy to apply to the container.
    cors_policy: []const CorsRule,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutCorsPolicyInput, options: Options) !PutCorsPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutCorsPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "MediaStore_20170901.PutCorsPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutCorsPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
