...
pub const DeleteMetricPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMetricPolicyInput, options: Options) !DeleteMetricPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMetricPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "MediaStore_20170901.DeleteMetricPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMetricPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
