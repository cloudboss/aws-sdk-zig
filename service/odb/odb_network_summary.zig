...
pub const OdbNetworkSummary = struct {
    ...
    client_subnet_cidr: ?[]const u8 = null,
    ...
    oci_dns_forwarding_configs: ?[]const OciDnsForwardingConfig = null,

    /// The unique identifier of the OCI network anchor for the ODB network.
    oci_network_anchor_id: ?[]const u8 = null,

    /// The URL of the OCI network anchor for the ODB network.
    oci_network_anchor_url: ?[]const u8 = null,
    ...
    oci_vcn_id: ?[]const u8 = null,

    /// The URL for the VCN that's associated with the ODB network.
    oci_vcn_url: ?[]const u8 = null,
    ...
    /// ODB network.
    peered_cidrs: ?[]const []const u8 = null,
