...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAutonomousVirtualMachinesInput, options: Options) !ListAutonomousVirtualMachinesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListAutonomousVirtualMachinesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Odb.ListAutonomousVirtualMachines");
