...
pub const Client = struct {
    ...
    pub fn createTokenWithIam(self: *Self, allocator: std.mem.Allocator, input: create_token_with_iam.CreateTokenWithIAMInput, options: CallOptions) !create_token_with_iam.CreateTokenWithIAMOutput {
    ...
    /// or the device
    /// code grant.
    pub fn registerClient(self: *Self, allocator: std.mem.Allocator, input: register_client.RegisterClientInput, options: CallOptions) !register_client.RegisterClientOutput {
    ...
    pub fn startDeviceAuthorization(self: *Self, allocator: std.mem.Allocator, input: start_device_authorization.StartDeviceAuthorizationInput, options: CallOptions) !start_device_authorization.StartDeviceAuthorizationOutput {
