...
fn serializeRequest(alloc: std.mem.Allocator, input: SetAccountDefaultProtectConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PinpointSMSVoiceV2.SetAccountDefaultProtectConfiguration");
