...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateProtectConfigurationInput, options: Options) !UpdateProtectConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateProtectConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PinpointSMSVoiceV2.UpdateProtectConfiguration");
