...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutProtectConfigurationRuleSetNumberOverrideInput, options: Options) !PutProtectConfigurationRuleSetNumberOverrideOutput {
