...
pub const Client = struct {
    ...
    pub fn associateOriginationIdentity(self: *Self, allocator: std.mem.Allocator, input: associate_origination_identity.AssociateOriginationIdentityInput, options: associate_origination_identity.Options) !associate_origination_identity.AssociateOriginationIdentityOutput {
    ...
    pub fn associateProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: associate_protect_configuration.AssociateProtectConfigurationInput, options: associate_protect_configuration.Options) !associate_protect_configuration.AssociateProtectConfigurationOutput {
    ...
    pub fn carrierLookup(self: *Self, allocator: std.mem.Allocator, input: carrier_lookup.CarrierLookupInput, options: carrier_lookup.Options) !carrier_lookup.CarrierLookupOutput {
    ...
    pub fn createEventDestination(self: *Self, allocator: std.mem.Allocator, input: create_event_destination.CreateEventDestinationInput, options: create_event_destination.Options) !create_event_destination.CreateEventDestinationOutput {
    ...
    pub fn createOptOutList(self: *Self, allocator: std.mem.Allocator, input: create_opt_out_list.CreateOptOutListInput, options: create_opt_out_list.Options) !create_opt_out_list.CreateOptOutListOutput {
    ...
    /// another pool, an error is returned. A sender ID can be associated with
    /// multiple pools.
    pub fn createPool(self: *Self, allocator: std.mem.Allocator, input: create_pool.CreatePoolInput, options: create_pool.Options) !create_pool.CreatePoolOutput {
    ...
    pub fn createProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_protect_configuration.CreateProtectConfigurationInput, options: create_protect_configuration.Options) !create_protect_configuration.CreateProtectConfigurationOutput {
        return create_protect_configuration.execute(self, allocator, input, options);
    }

    /// Creates a new registration based on the **RegistrationType** field.
    pub fn createRegistration(self: *Self, allocator: std.mem.Allocator, input: create_registration.CreateRegistrationInput, options: create_registration.Options) !create_registration.CreateRegistrationOutput {
    ...
    /// number or sender ID.
    pub fn createRegistrationAssociation(self: *Self, allocator: std.mem.Allocator, input: create_registration_association.CreateRegistrationAssociationInput, options: create_registration_association.Options) !create_registration_association.CreateRegistrationAssociationOutput {
    ...
    pub fn createRegistrationAttachment(self: *Self, allocator: std.mem.Allocator, input: create_registration_attachment.CreateRegistrationAttachmentInput, options: create_registration_attachment.Options) !create_registration_attachment.CreateRegistrationAttachmentOutput {
    ...
    pub fn createRegistrationVersion(self: *Self, allocator: std.mem.Allocator, input: create_registration_version.CreateRegistrationVersionInput, options: create_registration_version.Options) !create_registration_version.CreateRegistrationVersionOutput {
    ...
    pub fn createVerifiedDestinationNumber(self: *Self, allocator: std.mem.Allocator, input: create_verified_destination_number.CreateVerifiedDestinationNumberInput, options: create_verified_destination_number.Options) !create_verified_destination_number.CreateVerifiedDestinationNumberOutput {
        return create_verified_destination_number.execute(self, allocator, input, options);
    }

    /// Removes the current account default protect configuration.
    pub fn deleteAccountDefaultProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_account_default_protect_configuration.DeleteAccountDefaultProtectConfigurationInput, options: delete_account_default_protect_configuration.Options) !delete_account_default_protect_configuration.DeleteAccountDefaultProtectConfigurationOutput {
    ...
    /// account.
    pub fn deleteDefaultMessageType(self: *Self, allocator: std.mem.Allocator, input: delete_default_message_type.DeleteDefaultMessageTypeInput, options: delete_default_message_type.Options) !delete_default_message_type.DeleteDefaultMessageTypeOutput {
    ...
    /// country or region.
    pub fn deleteDefaultSenderId(self: *Self, allocator: std.mem.Allocator, input: delete_default_sender_id.DeleteDefaultSenderIdInput, options: delete_default_sender_id.Options) !delete_default_sender_id.DeleteDefaultSenderIdOutput {
    ...
    pub fn deleteEventDestination(self: *Self, allocator: std.mem.Allocator, input: delete_event_destination.DeleteEventDestinationInput, options: delete_event_destination.Options) !delete_event_destination.DeleteEventDestinationOutput {
    ...
    pub fn deleteKeyword(self: *Self, allocator: std.mem.Allocator, input: delete_keyword.DeleteKeywordInput, options: delete_keyword.Options) !delete_keyword.DeleteKeywordOutput {
    ...
    pub fn deleteMediaMessageSpendLimitOverride(self: *Self, allocator: std.mem.Allocator, input: delete_media_message_spend_limit_override.DeleteMediaMessageSpendLimitOverrideInput, options: delete_media_message_spend_limit_override.Options) !delete_media_message_spend_limit_override.DeleteMediaMessageSpendLimitOverrideOutput {
    ...
    pub fn deleteOptOutList(self: *Self, allocator: std.mem.Allocator, input: delete_opt_out_list.DeleteOptOutListInput, options: delete_opt_out_list.Options) !delete_opt_out_list.DeleteOptOutListOutput {
    ...
    pub fn deleteOptedOutNumber(self: *Self, allocator: std.mem.Allocator, input: delete_opted_out_number.DeleteOptedOutNumberInput, options: delete_opted_out_number.Options) !delete_opted_out_number.DeleteOptedOutNumberOutput {
    ...
    pub fn deletePool(self: *Self, allocator: std.mem.Allocator, input: delete_pool.DeletePoolInput, options: delete_pool.Options) !delete_pool.DeletePoolOutput {
    ...
    pub fn deleteProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_protect_configuration.DeleteProtectConfigurationInput, options: delete_protect_configuration.Options) !delete_protect_configuration.DeleteProtectConfigurationOutput {
        return delete_protect_configuration.execute(self, allocator, input, options);
    }

    /// Permanently delete the protect configuration rule set number override.
    pub fn deleteProtectConfigurationRuleSetNumberOverride(self: *Self, allocator: std.mem.Allocator, input: delete_protect_configuration_rule_set_number_override.DeleteProtectConfigurationRuleSetNumberOverrideInput, options: delete_protect_configuration_rule_set_number_override.Options) !delete_protect_configuration_rule_set_number_override.DeleteProtectConfigurationRuleSetNumberOverrideOutput {
        return delete_protect_configuration_rule_set_number_override.execute(self, allocator, input, options);
    }

    /// Permanently delete an existing registration from your account.
    pub fn deleteRegistration(self: *Self, allocator: std.mem.Allocator, input: delete_registration.DeleteRegistrationInput, options: delete_registration.Options) !delete_registration.DeleteRegistrationOutput {
        return delete_registration.execute(self, allocator, input, options);
    }

    /// Permanently delete the specified registration attachment.
    pub fn deleteRegistrationAttachment(self: *Self, allocator: std.mem.Allocator, input: delete_registration_attachment.DeleteRegistrationAttachmentInput, options: delete_registration_attachment.Options) !delete_registration_attachment.DeleteRegistrationAttachmentOutput {
        return delete_registration_attachment.execute(self, allocator, input, options);
    }

    /// Delete the value in a registration form field.
    pub fn deleteRegistrationFieldValue(self: *Self, allocator: std.mem.Allocator, input: delete_registration_field_value.DeleteRegistrationFieldValueInput, options: delete_registration_field_value.Options) !delete_registration_field_value.DeleteRegistrationFieldValueOutput {
    ...
    pub fn deleteTextMessageSpendLimitOverride(self: *Self, allocator: std.mem.Allocator, input: delete_text_message_spend_limit_override.DeleteTextMessageSpendLimitOverrideInput, options: delete_text_message_spend_limit_override.Options) !delete_text_message_spend_limit_override.DeleteTextMessageSpendLimitOverrideOutput {
        return delete_text_message_spend_limit_override.execute(self, allocator, input, options);
    }

    /// Delete a verified destination phone number.
    pub fn deleteVerifiedDestinationNumber(self: *Self, allocator: std.mem.Allocator, input: delete_verified_destination_number.DeleteVerifiedDestinationNumberInput, options: delete_verified_destination_number.Options) !delete_verified_destination_number.DeleteVerifiedDestinationNumberOutput {
    ...
    /// ](https://docs.aws.amazon.com/sms-voice/latest/userguide/quotas.html) in the
    /// *End User Messaging SMS User Guide*.
    pub fn deleteVoiceMessageSpendLimitOverride(self: *Self, allocator: std.mem.Allocator, input: delete_voice_message_spend_limit_override.DeleteVoiceMessageSpendLimitOverrideInput, options: delete_voice_message_spend_limit_override.Options) !delete_voice_message_spend_limit_override.DeleteVoiceMessageSpendLimitOverrideOutput {
    ...
    /// returned.
    pub fn describeConfigurationSets(self: *Self, allocator: std.mem.Allocator, input: describe_configuration_sets.DescribeConfigurationSetsInput, options: describe_configuration_sets.Options) !describe_configuration_sets.DescribeConfigurationSetsOutput {
    ...
    pub fn describeKeywords(self: *Self, allocator: std.mem.Allocator, input: describe_keywords.DescribeKeywordsInput, options: describe_keywords.Options) !describe_keywords.DescribeKeywordsOutput {
    ...
    pub fn describeOptOutLists(self: *Self, allocator: std.mem.Allocator, input: describe_opt_out_lists.DescribeOptOutListsInput, options: describe_opt_out_lists.Options) !describe_opt_out_lists.DescribeOptOutListsOutput {
    ...
    /// returned.
    pub fn describeOptedOutNumbers(self: *Self, allocator: std.mem.Allocator, input: describe_opted_out_numbers.DescribeOptedOutNumbersInput, options: describe_opted_out_numbers.Options) !describe_opted_out_numbers.DescribeOptedOutNumbersOutput {
    ...
    pub fn describePhoneNumbers(self: *Self, allocator: std.mem.Allocator, input: describe_phone_numbers.DescribePhoneNumbersInput, options: describe_phone_numbers.Options) !describe_phone_numbers.DescribePhoneNumbersOutput {
    ...
    /// one or more phone numbers and SenderIds that are associated with your Amazon
    /// Web Services account.
    pub fn describePools(self: *Self, allocator: std.mem.Allocator, input: describe_pools.DescribePoolsInput, options: describe_pools.Options) !describe_pools.DescribePoolsOutput {
    ...
    pub fn describeProtectConfigurations(self: *Self, allocator: std.mem.Allocator, input: describe_protect_configurations.DescribeProtectConfigurationsInput, options: describe_protect_configurations.Options) !describe_protect_configurations.DescribeProtectConfigurationsOutput {
    ...
    pub fn describeRegistrationAttachments(self: *Self, allocator: std.mem.Allocator, input: describe_registration_attachments.DescribeRegistrationAttachmentsInput, options: describe_registration_attachments.Options) !describe_registration_attachments.DescribeRegistrationAttachmentsOutput {
    ...
    pub fn describeRegistrationFieldDefinitions(self: *Self, allocator: std.mem.Allocator, input: describe_registration_field_definitions.DescribeRegistrationFieldDefinitionsInput, options: describe_registration_field_definitions.Options) !describe_registration_field_definitions.DescribeRegistrationFieldDefinitionsOutput {
        return describe_registration_field_definitions.execute(self, allocator, input, options);
    }

    /// Retrieves the specified registration field values.
    pub fn describeRegistrationFieldValues(self: *Self, allocator: std.mem.Allocator, input: describe_registration_field_values.DescribeRegistrationFieldValuesInput, options: describe_registration_field_values.Options) !describe_registration_field_values.DescribeRegistrationFieldValuesOutput {
    ...
    pub fn describeRegistrationSectionDefinitions(self: *Self, allocator: std.mem.Allocator, input: describe_registration_section_definitions.DescribeRegistrationSectionDefinitionsInput, options: describe_registration_section_definitions.Options) !describe_registration_section_definitions.DescribeRegistrationSectionDefinitionsOutput {
    ...
    /// filling out, and submitting each registration type.
    pub fn describeRegistrationTypeDefinitions(self: *Self, allocator: std.mem.Allocator, input: describe_registration_type_definitions.DescribeRegistrationTypeDefinitionsInput, options: describe_registration_type_definitions.Options) !describe_registration_type_definitions.DescribeRegistrationTypeDefinitionsOutput {
        return describe_registration_type_definitions.execute(self, allocator, input, options);
    }

    /// Retrieves the specified registration version.
    pub fn describeRegistrationVersions(self: *Self, allocator: std.mem.Allocator, input: describe_registration_versions.DescribeRegistrationVersionsInput, options: describe_registration_versions.Options) !describe_registration_versions.DescribeRegistrationVersionsOutput {
        return describe_registration_versions.execute(self, allocator, input, options);
    }

    /// Retrieves the specified registrations.
    pub fn describeRegistrations(self: *Self, allocator: std.mem.Allocator, input: describe_registrations.DescribeRegistrationsInput, options: describe_registrations.Options) !describe_registrations.DescribeRegistrationsOutput {
    ...
    pub fn describeSenderIds(self: *Self, allocator: std.mem.Allocator, input: describe_sender_ids.DescribeSenderIdsInput, options: describe_sender_ids.Options) !describe_sender_ids.DescribeSenderIdsOutput {
    ...
    pub fn describeSpendLimits(self: *Self, allocator: std.mem.Allocator, input: describe_spend_limits.DescribeSpendLimitsInput, options: describe_spend_limits.Options) !describe_spend_limits.DescribeSpendLimitsOutput {
        return describe_spend_limits.execute(self, allocator, input, options);
    }

    /// Retrieves the specified verified destination numbers.
    pub fn describeVerifiedDestinationNumbers(self: *Self, allocator: std.mem.Allocator, input: describe_verified_destination_numbers.DescribeVerifiedDestinationNumbersInput, options: describe_verified_destination_numbers.Options) !describe_verified_destination_numbers.DescribeVerifiedDestinationNumbersOutput {
    ...
    /// error is returned.
    pub fn disassociateOriginationIdentity(self: *Self, allocator: std.mem.Allocator, input: disassociate_origination_identity.DisassociateOriginationIdentityInput, options: disassociate_origination_identity.Options) !disassociate_origination_identity.DisassociateOriginationIdentityOutput {
        return disassociate_origination_identity.execute(self, allocator, input, options);
    }

    /// Disassociate a protect configuration from a configuration set.
    pub fn disassociateProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: disassociate_protect_configuration.DisassociateProtectConfigurationInput, options: disassociate_protect_configuration.Options) !disassociate_protect_configuration.DisassociateProtectConfigurationOutput {
        return disassociate_protect_configuration.execute(self, allocator, input, options);
    }

    /// Discard the current version of the registration.
    pub fn discardRegistrationVersion(self: *Self, allocator: std.mem.Allocator, input: discard_registration_version.DiscardRegistrationVersionInput, options: discard_registration_version.Options) !discard_registration_version.DiscardRegistrationVersionOutput {
    ...
    /// protect configuration.
    pub fn getProtectConfigurationCountryRuleSet(self: *Self, allocator: std.mem.Allocator, input: get_protect_configuration_country_rule_set.GetProtectConfigurationCountryRuleSetInput, options: get_protect_configuration_country_rule_set.Options) !get_protect_configuration_country_rule_set.GetProtectConfigurationCountryRuleSetOutput {
    ...
    pub fn listPoolOriginationIdentities(self: *Self, allocator: std.mem.Allocator, input: list_pool_origination_identities.ListPoolOriginationIdentitiesInput, options: list_pool_origination_identities.Options) !list_pool_origination_identities.ListPoolOriginationIdentitiesOutput {
    ...
    /// registration.
    pub fn listRegistrationAssociations(self: *Self, allocator: std.mem.Allocator, input: list_registration_associations.ListRegistrationAssociationsInput, options: list_registration_associations.Options) !list_registration_associations.ListRegistrationAssociationsOutput {
    ...
    ///
    /// If you specify a keyword that isn't valid, an error is returned.
    pub fn putKeyword(self: *Self, allocator: std.mem.Allocator, input: put_keyword.PutKeywordInput, options: put_keyword.Options) !put_keyword.PutKeywordOutput {
    ...
    pub fn putMessageFeedback(self: *Self, allocator: std.mem.Allocator, input: put_message_feedback.PutMessageFeedbackInput, options: put_message_feedback.Options) !put_message_feedback.PutMessageFeedbackOutput {
    ...
    pub fn putOptedOutNumber(self: *Self, allocator: std.mem.Allocator, input: put_opted_out_number.PutOptedOutNumberInput, options: put_opted_out_number.Options) !put_opted_out_number.PutOptedOutNumberOutput {
    ...
    pub fn releaseSenderId(self: *Self, allocator: std.mem.Allocator, input: release_sender_id.ReleaseSenderIdInput, options: release_sender_id.Options) !release_sender_id.ReleaseSenderIdOutput {
    ...
    pub fn requestPhoneNumber(self: *Self, allocator: std.mem.Allocator, input: request_phone_number.RequestPhoneNumberInput, options: request_phone_number.Options) !request_phone_number.RequestPhoneNumberOutput {
        return request_phone_number.execute(self, allocator, input, options);
    }

    /// Request a new sender ID that doesn't require registration.
    pub fn requestSenderId(self: *Self, allocator: std.mem.Allocator, input: request_sender_id.RequestSenderIdInput, options: request_sender_id.Options) !request_sender_id.RequestSenderIdOutput {
    ...
    pub fn sendDestinationNumberVerificationCode(self: *Self, allocator: std.mem.Allocator, input: send_destination_number_verification_code.SendDestinationNumberVerificationCodeInput, options: send_destination_number_verification_code.Options) !send_destination_number_verification_code.SendDestinationNumberVerificationCodeOutput {
    ...
    /// number.
    pub fn sendMediaMessage(self: *Self, allocator: std.mem.Allocator, input: send_media_message.SendMediaMessageInput, options: send_media_message.Options) !send_media_message.SendMediaMessageOutput {
    ...
    pub fn sendTextMessage(self: *Self, allocator: std.mem.Allocator, input: send_text_message.SendTextMessageInput, options: send_text_message.Options) !send_text_message.SendTextMessageOutput {
    ...
    pub fn setAccountDefaultProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: set_account_default_protect_configuration.SetAccountDefaultProtectConfigurationInput, options: set_account_default_protect_configuration.Options) !set_account_default_protect_configuration.SetAccountDefaultProtectConfigurationOutput {
        return set_account_default_protect_configuration.execute(self, allocator, input, options);
    }

    /// Sets a configuration set's default for message feedback.
    pub fn setDefaultMessageFeedbackEnabled(self: *Self, allocator: std.mem.Allocator, input: set_default_message_feedback_enabled.SetDefaultMessageFeedbackEnabledInput, options: set_default_message_feedback_enabled.Options) !set_default_message_feedback_enabled.SetDefaultMessageFeedbackEnabledOutput {
    ...
    /// **Promotional**. This setting applies to your entire Amazon Web Services
    /// account.
    pub fn setDefaultMessageType(self: *Self, allocator: std.mem.Allocator, input: set_default_message_type.SetDefaultMessageTypeInput, options: set_default_message_type.Options) !set_default_message_type.SetDefaultMessageTypeOutput {
    ...
    pub fn setDefaultSenderId(self: *Self, allocator: std.mem.Allocator, input: set_default_sender_id.SetDefaultSenderIdInput, options: set_default_sender_id.Options) !set_default_sender_id.SetDefaultSenderIdOutput {
    ...
    pub fn setMediaMessageSpendLimitOverride(self: *Self, allocator: std.mem.Allocator, input: set_media_message_spend_limit_override.SetMediaMessageSpendLimitOverrideInput, options: set_media_message_spend_limit_override.Options) !set_media_message_spend_limit_override.SetMediaMessageSpendLimitOverrideOutput {
    ...
    pub fn setTextMessageSpendLimitOverride(self: *Self, allocator: std.mem.Allocator, input: set_text_message_spend_limit_override.SetTextMessageSpendLimitOverrideInput, options: set_text_message_spend_limit_override.Options) !set_text_message_spend_limit_override.SetTextMessageSpendLimitOverrideOutput {
    ...
    /// messages. The requested spend limit must be less than or equal to the
    /// `MaxLimit`, which is set by Amazon Web Services.
    pub fn setVoiceMessageSpendLimitOverride(self: *Self, allocator: std.mem.Allocator, input: set_voice_message_spend_limit_override.SetVoiceMessageSpendLimitOverrideInput, options: set_voice_message_spend_limit_override.Options) !set_voice_message_spend_limit_override.SetVoiceMessageSpendLimitOverrideOutput {
        return set_voice_message_spend_limit_override.execute(self, allocator, input, options);
    }

    /// Submit the specified registration for review and approval.
    pub fn submitRegistrationVersion(self: *Self, allocator: std.mem.Allocator, input: submit_registration_version.SubmitRegistrationVersionInput, options: submit_registration_version.Options) !submit_registration_version.SubmitRegistrationVersionOutput {
    ...
    pub fn updateEventDestination(self: *Self, allocator: std.mem.Allocator, input: update_event_destination.UpdateEventDestinationInput, options: update_event_destination.Options) !update_event_destination.UpdateEventDestinationOutput {
    ...
    pub fn updatePool(self: *Self, allocator: std.mem.Allocator, input: update_pool.UpdatePoolInput, options: update_pool.Options) !update_pool.UpdatePoolOutput {
        return update_pool.execute(self, allocator, input, options);
    }

    /// Update the setting for an existing protect configuration.
    pub fn updateProtectConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_protect_configuration.UpdateProtectConfigurationInput, options: update_protect_configuration.Options) !update_protect_configuration.UpdateProtectConfigurationOutput {
    ...
    pub fn updateProtectConfigurationCountryRuleSet(self: *Self, allocator: std.mem.Allocator, input: update_protect_configuration_country_rule_set.UpdateProtectConfigurationCountryRuleSetInput, options: update_protect_configuration_country_rule_set.Options) !update_protect_configuration_country_rule_set.UpdateProtectConfigurationCountryRuleSetOutput {
        return update_protect_configuration_country_rule_set.execute(self, allocator, input, options);
    }

    /// Updates the configuration of an existing sender ID.
    pub fn updateSenderId(self: *Self, allocator: std.mem.Allocator, input: update_sender_id.UpdateSenderIdInput, options: update_sender_id.Options) !update_sender_id.UpdateSenderIdOutput {
    ...
    /// messages.
    pub fn verifyDestinationNumber(self: *Self, allocator: std.mem.Allocator, input: verify_destination_number.VerifyDestinationNumberInput, options: verify_destination_number.Options) !verify_destination_number.VerifyDestinationNumberOutput {
