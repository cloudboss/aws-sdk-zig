...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListProtectConfigurationRuleSetNumberOverridesInput, options: Options) !ListProtectConfigurationRuleSetNumberOverridesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListProtectConfigurationRuleSetNumberOverridesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PinpointSMSVoiceV2.ListProtectConfigurationRuleSetNumberOverrides");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListProtectConfigurationRuleSetNumberOverridesOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(ListProtectConfigurationRuleSetNumberOverridesOutput, body, alloc);
}
