...
pub const GetProtectConfigurationCountryRuleSetInput = struct {
...
pub const GetProtectConfigurationCountryRuleSetOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetProtectConfigurationCountryRuleSetInput, options: CallOptions) !GetProtectConfigurationCountryRuleSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetProtectConfigurationCountryRuleSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "PinpointSMSVoiceV2.GetProtectConfigurationCountryRuleSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetProtectConfigurationCountryRuleSetOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(GetProtectConfigurationCountryRuleSetOutput, body, allocator);
}
