...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetProtectConfigurationCountryRuleSetInput, options: Options) !GetProtectConfigurationCountryRuleSetOutput {
