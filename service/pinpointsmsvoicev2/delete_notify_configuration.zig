...
pub const DeleteNotifyConfigurationInput = struct {
...
pub const DeleteNotifyConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteNotifyConfigurationInput, options: CallOptions) !DeleteNotifyConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteNotifyConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "PinpointSMSVoiceV2.DeleteNotifyConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteNotifyConfigurationOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DeleteNotifyConfigurationOutput, body, allocator);
}
