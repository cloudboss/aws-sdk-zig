...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEnvironmentBlueprintConfigurationsInput, options: CallOptions) !ListEnvironmentBlueprintConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListEnvironmentBlueprintConfigurationsInput, config: *aws.Config) !aws.http.Request {
