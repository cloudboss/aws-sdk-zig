...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDataProductRevisionsInput, options: CallOptions) !ListDataProductRevisionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDataProductRevisionsInput, config: *aws.Config) !aws.http.Request {
