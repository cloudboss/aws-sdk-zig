...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEnvironmentBlueprintConfigurationInput, options: Options) !GetEnvironmentBlueprintConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetEnvironmentBlueprintConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetEnvironmentBlueprintConfigurationOutput {
    var result: GetEnvironmentBlueprintConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetEnvironmentBlueprintConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
