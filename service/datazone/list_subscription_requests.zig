...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSubscriptionRequestsInput, options: CallOptions) !ListSubscriptionRequestsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSubscriptionRequestsInput, config: *aws.Config) !aws.http.Request {
