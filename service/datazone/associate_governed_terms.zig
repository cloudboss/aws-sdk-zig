...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateGovernedTermsInput, options: Options) !AssociateGovernedTermsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateGovernedTermsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/associate-governed-terms");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateGovernedTermsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
