...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAssetFiltersInput, options: CallOptions) !ListAssetFiltersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAssetFiltersInput, config: *aws.Config) !aws.http.Request {
