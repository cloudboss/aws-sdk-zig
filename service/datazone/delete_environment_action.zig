...
pub const DeleteEnvironmentActionInput = struct {
...
const DeleteEnvironmentActionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEnvironmentActionInput, options: Options) !DeleteEnvironmentActionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteEnvironmentActionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteEnvironmentActionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEnvironmentActionOutput = .{};
