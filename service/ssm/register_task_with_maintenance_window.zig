...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RegisterTaskWithMaintenanceWindowInput, options: Options) !RegisterTaskWithMaintenanceWindowOutput {
