...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDeployablePatchSnapshotForInstanceInput, options: Options) !GetDeployablePatchSnapshotForInstanceOutput {
