...
const AddTagsToResourceInput = @import("add_tags_to_resource_request.zig").AddTagsToResourceRequest;

const AddTagsToResourceOutput = @import("add_tags_to_resource_result.zig").AddTagsToResourceResult;
...
fn serializeRequest(alloc: std.mem.Allocator, input: AddTagsToResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.AddTagsToResource");
