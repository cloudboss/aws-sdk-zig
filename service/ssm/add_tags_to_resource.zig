...
pub const AddTagsToResourceInput = @import("add_tags_to_resource_request.zig").AddTagsToResourceRequest;

pub const AddTagsToResourceOutput = @import("add_tags_to_resource_result.zig").AddTagsToResourceResult;
