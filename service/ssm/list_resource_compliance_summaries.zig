...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResourceComplianceSummariesInput, options: Options) !ListResourceComplianceSummariesOutput {
