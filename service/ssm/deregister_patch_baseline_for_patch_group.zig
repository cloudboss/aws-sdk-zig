...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterPatchBaselineForPatchGroupInput, options: Options) !DeregisterPatchBaselineForPatchGroupOutput {
