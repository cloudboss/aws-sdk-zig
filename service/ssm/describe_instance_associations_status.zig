...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInstanceAssociationsStatusInput, options: Options) !DescribeInstanceAssociationsStatusOutput {
