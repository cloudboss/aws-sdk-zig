...
pub const RemoveTagsFromResourceInput = @import("remove_tags_from_resource_request.zig").RemoveTagsFromResourceRequest;

pub const RemoveTagsFromResourceOutput = @import("remove_tags_from_resource_result.zig").RemoveTagsFromResourceResult;
