...
pub const RemoveTagsFromResourceOutput = struct {
    ...
    pub fn deinit(self: *RemoveTagsFromResourceOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: RemoveTagsFromResourceInput, options: Options) !RemoveTagsFromResourceOutput {
