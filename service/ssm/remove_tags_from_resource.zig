...
const RemoveTagsFromResourceInput = @import("remove_tags_from_resource_request.zig").RemoveTagsFromResourceRequest;

const RemoveTagsFromResourceOutput = @import("remove_tags_from_resource_result.zig").RemoveTagsFromResourceResult;
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveTagsFromResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.RemoveTagsFromResource");
