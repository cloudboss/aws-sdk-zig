...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterTaskFromMaintenanceWindowInput, options: Options) !DeregisterTaskFromMaintenanceWindowOutput {
