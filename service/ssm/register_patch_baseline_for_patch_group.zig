...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RegisterPatchBaselineForPatchGroupInput, options: Options) !RegisterPatchBaselineForPatchGroupOutput {
