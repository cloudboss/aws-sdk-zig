...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAssociationExecutionTargetsInput, options: Options) !DescribeAssociationExecutionTargetsOutput {
