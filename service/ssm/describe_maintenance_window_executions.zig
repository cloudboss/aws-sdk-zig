...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMaintenanceWindowExecutionsInput, options: Options) !DescribeMaintenanceWindowExecutionsOutput {
