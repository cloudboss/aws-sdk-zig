...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMaintenanceWindowExecutionTaskInvocationsInput, options: Options) !DescribeMaintenanceWindowExecutionTaskInvocationsOutput {
