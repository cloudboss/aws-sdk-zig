...
pub const StartSessionOutput = struct {
    ...
    pub fn deinit(self: *StartSessionOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: StartSessionInput, options: Options) !StartSessionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartSessionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.StartSession");
