...
pub const GetResourcePoliciesOutput = struct {
    ...
    pub fn deinit(self: *GetResourcePoliciesOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: GetResourcePoliciesInput, options: Options) !GetResourcePoliciesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetResourcePoliciesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.GetResourcePolicies");
