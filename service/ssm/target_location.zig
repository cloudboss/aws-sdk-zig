...
pub const TargetLocation = struct {
    ...
    /// targets.
    exclude_accounts: ?[]const []const u8 = null,
    ...
    target_location_alarm_configuration: ?AlarmConfiguration = null,
    ...
    target_location_max_concurrency: ?[]const u8 = null,
    ...
    /// has a
    /// default value of 0.
    target_location_max_errors: ?[]const u8 = null,
    ...
    targets_max_concurrency: ?[]const u8 = null,
    ...
    targets_max_errors: ?[]const u8 = null,
