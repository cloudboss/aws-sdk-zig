...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterTargetFromMaintenanceWindowInput, options: Options) !DeregisterTargetFromMaintenanceWindowOutput {
