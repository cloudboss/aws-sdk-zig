...
pub const DescribeParametersOutput = struct {
    ...
    pub fn deinit(self: *DescribeParametersOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: DescribeParametersInput, options: Options) !DescribeParametersOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeParametersInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.DescribeParameters");
