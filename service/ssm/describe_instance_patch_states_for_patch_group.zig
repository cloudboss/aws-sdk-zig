...
pub const DescribeInstancePatchStatesForPatchGroupOutput = struct {
    ...
    pub fn deinit(self: *DescribeInstancePatchStatesForPatchGroupOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: DescribeInstancePatchStatesForPatchGroupInput, options: Options) !DescribeInstancePatchStatesForPatchGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeInstancePatchStatesForPatchGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.DescribeInstancePatchStatesForPatchGroup");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeInstancePatchStatesForPatchGroupOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeInstancePatchStatesForPatchGroupOutput, body, alloc);
}
