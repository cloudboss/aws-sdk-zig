...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInstancePatchStatesForPatchGroupInput, options: Options) !DescribeInstancePatchStatesForPatchGroupOutput {
