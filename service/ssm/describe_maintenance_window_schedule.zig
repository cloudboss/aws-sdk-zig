...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMaintenanceWindowScheduleInput, options: Options) !DescribeMaintenanceWindowScheduleOutput {
