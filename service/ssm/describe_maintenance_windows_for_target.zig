...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMaintenanceWindowsForTargetInput, options: Options) !DescribeMaintenanceWindowsForTargetOutput {
