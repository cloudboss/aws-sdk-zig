...
pub const ListTagsForResourceOutput = struct {
    ...
    pub fn deinit(self: *ListTagsForResourceOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: ListTagsForResourceInput, options: Options) !ListTagsForResourceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListTagsForResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonSSM.ListTagsForResource");
