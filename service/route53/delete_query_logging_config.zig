...
pub const DeleteQueryLoggingConfigInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteQueryLoggingConfigInput, options: Options) !DeleteQueryLoggingConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteQueryLoggingConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2013-04-01/queryloggingconfig/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteQueryLoggingConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteQueryLoggingConfigOutput = .{};
