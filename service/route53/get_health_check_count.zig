...
fn serializeRequest(alloc: std.mem.Allocator, input: GetHealthCheckCountInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetHealthCheckCountOutput {
    _ = alloc;
