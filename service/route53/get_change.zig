...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChangeInput, options: CallOptions) !GetChangeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetChangeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2013-04-01/change/");
