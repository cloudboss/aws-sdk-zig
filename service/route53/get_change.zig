...
pub const GetChangeInput = struct {
...
pub const GetChangeOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChangeInput, options: Options) !GetChangeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetChangeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2013-04-01/change/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetChangeOutput {
