...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTrafficPolicyInput, options: Options) !GetTrafficPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetTrafficPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetTrafficPolicyOutput {
    var result: GetTrafficPolicyOutput = .{};
    _ = status;
