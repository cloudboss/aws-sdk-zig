...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHealthCheckInput, options: Options) !GetHealthCheckOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetHealthCheckInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetHealthCheckOutput {
    var result: GetHealthCheckOutput = .{};
    _ = status;
