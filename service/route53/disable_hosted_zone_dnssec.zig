...
pub const DisableHostedZoneDNSSECInput = struct {
    /// A unique string used to identify a hosted zone.
    hosted_zone_id: []const u8,
};

pub const DisableHostedZoneDNSSECOutput = struct {
    change_info: ?ChangeInfo = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableHostedZoneDNSSECInput, options: CallOptions) !DisableHostedZoneDNSSECOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableHostedZoneDNSSECInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/disable-dnssec");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableHostedZoneDNSSECOutput {
    var result: DisableHostedZoneDNSSECOutput = undefined;
    _ = status;
