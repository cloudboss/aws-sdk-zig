...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateTrafficPolicyInstanceInput, options: Options) !CreateTrafficPolicyInstanceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateTrafficPolicyInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<CreateTrafficPolicyInstanceRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateTrafficPolicyInstanceOutput {
