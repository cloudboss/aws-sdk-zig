...
pub const GetTrafficPolicyInstanceInput = struct {
    /// The ID of the traffic policy instance that you want to get information
    /// about.
    id: []const u8,
};

pub const GetTrafficPolicyInstanceOutput = struct {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetTrafficPolicyInstanceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetTrafficPolicyInstanceOutput {
