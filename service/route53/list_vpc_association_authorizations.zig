...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListVPCAssociationAuthorizationsInput, options: Options) !ListVPCAssociationAuthorizationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListVPCAssociationAuthorizationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListVPCAssociationAuthorizationsOutput {
    var result: ListVPCAssociationAuthorizationsOutput = .{};
    _ = status;
