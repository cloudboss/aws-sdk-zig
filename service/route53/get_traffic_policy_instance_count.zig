...
pub const GetTrafficPolicyInstanceCountOutput = struct {
    ...
    traffic_policy_instance_count: i32,
};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTrafficPolicyInstanceCountInput, options: Options) !GetTrafficPolicyInstanceCountOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetTrafficPolicyInstanceCountInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    const path = "/2013-04-01/trafficpolicyinstancecount";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetTrafficPolicyInstanceCountOutput {
    _ = alloc;
