...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHostedZoneInput, options: CallOptions) !GetHostedZoneOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetHostedZoneInput, config: *aws.Config) !aws.http.Request {
