...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTrafficPolicyInstancesByPolicyInput, options: Options) !ListTrafficPolicyInstancesByPolicyOutput {
