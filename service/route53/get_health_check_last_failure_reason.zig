...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHealthCheckLastFailureReasonInput, options: CallOptions) !GetHealthCheckLastFailureReasonOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetHealthCheckLastFailureReasonInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/lastfailurereason");
