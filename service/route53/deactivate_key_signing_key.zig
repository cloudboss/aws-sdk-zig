...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeactivateKeySigningKeyInput, options: CallOptions) !DeactivateKeySigningKeyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeactivateKeySigningKeyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2013-04-01/keysigningkey/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeactivateKeySigningKeyOutput {
    var result: DeactivateKeySigningKeyOutput = undefined;
    _ = status;
