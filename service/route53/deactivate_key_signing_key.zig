...
pub const DeactivateKeySigningKeyInput = struct {
...
pub const DeactivateKeySigningKeyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeactivateKeySigningKeyInput, options: Options) !DeactivateKeySigningKeyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeactivateKeySigningKeyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2013-04-01/keysigningkey/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeactivateKeySigningKeyOutput {
    var result: DeactivateKeySigningKeyOutput = .{};
    _ = status;
