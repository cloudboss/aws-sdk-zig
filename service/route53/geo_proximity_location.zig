...
/// routing](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-policy-geoproximity.html) in the
...
pub const GeoProximityLocation = struct {
    ...
    /// positive integer from 1 to 99 for the bias. Route 53 shrinks the size of
    /// adjacent regions.
    ///
    ...
    /// if the Local Zone is `us-east-1-bue-1a` the Local Zone Group is
    /// `us-east-1-bue-1`.
    ///
    /// You can identify the Local Zones Group for a specific Local Zone by using
    /// the
    /// [describe-availability-zones](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-availability-zones.html) CLI command:
    ///
