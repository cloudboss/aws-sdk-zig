...
pub const DeleteTrafficPolicyInstanceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTrafficPolicyInstanceInput, options: Options) !DeleteTrafficPolicyInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTrafficPolicyInstanceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTrafficPolicyInstanceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTrafficPolicyInstanceOutput = .{};
