...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ActivateKeySigningKeyInput, options: CallOptions) !ActivateKeySigningKeyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ActivateKeySigningKeyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ActivateKeySigningKeyOutput {
    var result: ActivateKeySigningKeyOutput = undefined;
    _ = status;
