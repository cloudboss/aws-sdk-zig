...
pub const ActivateKeySigningKeyInput = struct {
...
pub const ActivateKeySigningKeyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ActivateKeySigningKeyInput, options: Options) !ActivateKeySigningKeyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ActivateKeySigningKeyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/activate");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ActivateKeySigningKeyOutput {
    var result: ActivateKeySigningKeyOutput = .{};
    _ = status;
