...
pub const AliasTarget = struct {
    ...
    /// Alternate
    /// Domain Names
    /// (CNAMEs)](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/CNAMEs.html) in the *Amazon CloudFront
    /// Developer Guide*.
    ///
    ...
    /// [DescribeEnvironments](https://docs.aws.amazon.com/elasticbeanstalk/latest/api/API_DescribeEnvironments.html) in the *Elastic Beanstalk API Reference*.
    ///
    /// * *CLI*: Use the
    /// `describe-environments` command to get the value of
    /// the `CNAME` attribute. For more information, see
    /// [describe-environments](https://docs.aws.amazon.com/cli/latest/reference/elasticbeanstalk/describe-environments.html) in the *CLI Command Reference*.
    ///
    /// **ELB load balancer**
    ///
    /// Specify the DNS name that is associated with the load balancer. Get the
    /// DNS name by using the Amazon Web Services Management Console, the ELB API,
    /// or the CLI.
    ///
    ...
    /// Website
    /// Endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_website_region_endpoints) in the *Amazon Web Services General
    /// Reference*. For more information about using S3 buckets for
    /// websites, see [Getting Started
    /// with Amazon Route
    /// 53](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html) in the *Amazon Route 53 Developer
    /// Guide.*
    ///
    ...
    /// inherits the health of the referenced Amazon Web Services resource, such as
    /// an ELB load
    ...
    /// target. For more information, see [What Happens When You Omit Health
    /// Checks?](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-complex-configs.html#dns-failover-complex-configs-hc-omitting) in the
    /// *Amazon Route 53 Developer Guide*.
    ///
    /// While `EvaluateTargetHealth` can be set to `true` for highly
    /// available Amazon Web Services services (such as S3 buckets, VPC interface
    /// endpoints,
    /// and API Gateway), these services are designed for high availability and
    /// rarely
    ...
    /// and DNS
    /// Failover](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover.html) in the *Amazon Route 53 Developer
    /// Guide*.
    ...
    ///   quotas](https://docs.aws.amazon.com/general/latest/gr/elb.html) topic in
    ...
    ///   [DescribeLoadBalancers](https://docs.aws.amazon.com/elasticloadbalancing/2012-06-01/APIReference/API_DescribeLoadBalancers.html) to get the value of
    /// `CanonicalHostedZoneNameId`.
    ///
    /// * Application and Network Load Balancers: Use
    ///   [DescribeLoadBalancers](https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_DescribeLoadBalancers.html) to get the value of
    ...
    ///
    /// * Classic Load Balancers: Use
    ///   [describe-load-balancers](http://docs.aws.amazon.com/cli/latest/reference/elb/describe-load-balancers.html) to get the value of
    /// `CanonicalHostedZoneNameId`.
    ///
    /// * Application and Network Load Balancers: Use
    ///   [describe-load-balancers](http://docs.aws.amazon.com/cli/latest/reference/elbv2/describe-load-balancers.html) to get the value of
    /// `CanonicalHostedZoneId`.
    ///
    /// **Global Accelerator accelerator**
    ///
