...
pub const GetReusableDelegationSetInput = struct {
...
pub const GetReusableDelegationSetOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetReusableDelegationSetInput, options: Options) !GetReusableDelegationSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetReusableDelegationSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2013-04-01/delegationset/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetReusableDelegationSetOutput {
