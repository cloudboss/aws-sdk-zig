...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetReusableDelegationSetInput, options: CallOptions) !GetReusableDelegationSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetReusableDelegationSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/2013-04-01/delegationset/");
