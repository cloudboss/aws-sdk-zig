...
pub const DeleteHostedZoneInput = struct {
    /// The ID of the hosted zone you want to delete.
    id: []const u8,
};

pub const DeleteHostedZoneOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteHostedZoneInput, options: CallOptions) !DeleteHostedZoneOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteHostedZoneInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteHostedZoneOutput {
    var result: DeleteHostedZoneOutput = undefined;
    _ = status;
