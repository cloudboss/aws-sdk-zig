...
pub const GetQueryLoggingConfigInput = struct {
...
pub const GetQueryLoggingConfigOutput = struct {
    /// A complex type that contains information about the query logging
    /// configuration that
    /// you specified in a
    /// [GetQueryLoggingConfig](https://docs.aws.amazon.com/Route53/latest/APIReference/API_GetQueryLoggingConfig.html) request.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetQueryLoggingConfigInput, options: Options) !GetQueryLoggingConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetQueryLoggingConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2013-04-01/queryloggingconfig/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetQueryLoggingConfigOutput {
