...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableHostedZoneDNSSECInput, options: CallOptions) !EnableHostedZoneDNSSECOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: EnableHostedZoneDNSSECInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/enable-dnssec");
