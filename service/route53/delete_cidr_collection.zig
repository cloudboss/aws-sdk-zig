...
pub const DeleteCidrCollectionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCidrCollectionInput, options: Options) !DeleteCidrCollectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCidrCollectionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCidrCollectionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCidrCollectionOutput = .{};
