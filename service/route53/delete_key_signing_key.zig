...
pub const DeleteKeySigningKeyInput = struct {
...
pub const DeleteKeySigningKeyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKeySigningKeyInput, options: Options) !DeleteKeySigningKeyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteKeySigningKeyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteKeySigningKeyOutput {
