...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKeySigningKeyInput, options: CallOptions) !DeleteKeySigningKeyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKeySigningKeyInput, config: *aws.Config) !aws.http.Request {
