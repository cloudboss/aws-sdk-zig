...
pub const DeleteLogPatternInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLogPatternInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "EC2WindowsBarleyService.DeleteLogPattern");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLogPatternOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
