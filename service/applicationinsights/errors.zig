...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        tags_already_exist_exception: TagsAlreadyExistException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .tags_already_exist_exception => |e| e.message,
        ...
        pub fn httpStatus(self: Kind) u16 {
            return switch (self) {
                ...
                .tags_already_exist_exception => 400,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .tags_already_exist_exception => |e| e.request_id,
