...
pub const ConfigurationEvent = struct {
    ...
    event_detail: ?[]const u8 = null,

    /// The name of the resource Application Insights attempted to configure.
    event_resource_name: ?[]const u8 = null,

    /// The resource type that Application Insights attempted to configure, for
    /// example,
    /// CLOUDWATCH_ALARM.
    event_resource_type: ?ConfigurationEventResourceType = null,
    ...
    monitored_resource_arn: ?[]const u8 = null,
