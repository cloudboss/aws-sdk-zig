...
pub const Client = struct {
    ...
    /// workloads.
    pub fn addWorkload(self: *Self, allocator: std.mem.Allocator, input: add_workload.AddWorkloadInput, options: CallOptions) !add_workload.AddWorkloadOutput {
    ...
    pub fn createLogPattern(self: *Self, allocator: std.mem.Allocator, input: create_log_pattern.CreateLogPatternInput, options: CallOptions) !create_log_pattern.CreateLogPatternOutput {
    ...
    pub fn deleteLogPattern(self: *Self, allocator: std.mem.Allocator, input: delete_log_pattern.DeleteLogPatternInput, options: CallOptions) !delete_log_pattern.DeleteLogPatternOutput {
    ...
    pub fn describeComponentConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_component_configuration.DescribeComponentConfigurationInput, options: CallOptions) !describe_component_configuration.DescribeComponentConfigurationOutput {
        return describe_component_configuration.execute(self, allocator, input, options);
    }

    /// Describes the recommended monitoring configuration of the component.
    pub fn describeComponentConfigurationRecommendation(self: *Self, allocator: std.mem.Allocator, input: describe_component_configuration_recommendation.DescribeComponentConfigurationRecommendationInput, options: CallOptions) !describe_component_configuration_recommendation.DescribeComponentConfigurationRecommendationOutput {
        return describe_component_configuration_recommendation.execute(self, allocator, input, options);
    }

    /// Describe a specific log pattern from a `LogPatternSet`.
    pub fn describeLogPattern(self: *Self, allocator: std.mem.Allocator, input: describe_log_pattern.DescribeLogPatternInput, options: CallOptions) !describe_log_pattern.DescribeLogPatternOutput {
        return describe_log_pattern.execute(self, allocator, input, options);
    }

    /// Describes an anomaly or error with the application.
    pub fn describeObservation(self: *Self, allocator: std.mem.Allocator, input: describe_observation.DescribeObservationInput, options: CallOptions) !describe_observation.DescribeObservationOutput {
        return describe_observation.execute(self, allocator, input, options);
    }

    /// Describes an application problem.
    pub fn describeProblem(self: *Self, allocator: std.mem.Allocator, input: describe_problem.DescribeProblemInput, options: CallOptions) !describe_problem.DescribeProblemOutput {
        return describe_problem.execute(self, allocator, input, options);
    }

    /// Describes the anomalies or errors associated with the problem.
    pub fn describeProblemObservations(self: *Self, allocator: std.mem.Allocator, input: describe_problem_observations.DescribeProblemObservationsInput, options: CallOptions) !describe_problem_observations.DescribeProblemObservationsOutput {
        return describe_problem_observations.execute(self, allocator, input, options);
    }

    /// Describes a workload and its configuration.
    pub fn describeWorkload(self: *Self, allocator: std.mem.Allocator, input: describe_workload.DescribeWorkloadInput, options: CallOptions) !describe_workload.DescribeWorkloadOutput {
    ...
    pub fn listConfigurationHistory(self: *Self, allocator: std.mem.Allocator, input: list_configuration_history.ListConfigurationHistoryInput, options: CallOptions) !list_configuration_history.ListConfigurationHistoryOutput {
        return list_configuration_history.execute(self, allocator, input, options);
    }

    /// Lists the log pattern sets in the specific application.
    pub fn listLogPatternSets(self: *Self, allocator: std.mem.Allocator, input: list_log_pattern_sets.ListLogPatternSetsInput, options: CallOptions) !list_log_pattern_sets.ListLogPatternSetsOutput {
        return list_log_pattern_sets.execute(self, allocator, input, options);
    }

    /// Lists the log patterns in the specific log `LogPatternSet`.
    pub fn listLogPatterns(self: *Self, allocator: std.mem.Allocator, input: list_log_patterns.ListLogPatternsInput, options: CallOptions) !list_log_patterns.ListLogPatternsOutput {
        return list_log_patterns.execute(self, allocator, input, options);
    }

    /// Lists the problems with your application.
    pub fn listProblems(self: *Self, allocator: std.mem.Allocator, input: list_problems.ListProblemsInput, options: CallOptions) !list_problems.ListProblemsOutput {
    ...
    pub fn removeWorkload(self: *Self, allocator: std.mem.Allocator, input: remove_workload.RemoveWorkloadInput, options: CallOptions) !remove_workload.RemoveWorkloadOutput {
    ...
    pub fn updateComponentConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_component_configuration.UpdateComponentConfigurationInput, options: CallOptions) !update_component_configuration.UpdateComponentConfigurationOutput {
        return update_component_configuration.execute(self, allocator, input, options);
    }

    /// Adds a log pattern to a `LogPatternSet`.
    pub fn updateLogPattern(self: *Self, allocator: std.mem.Allocator, input: update_log_pattern.UpdateLogPatternInput, options: CallOptions) !update_log_pattern.UpdateLogPatternOutput {
    ...
    /// `RESOLVED`.
    pub fn updateProblem(self: *Self, allocator: std.mem.Allocator, input: update_problem.UpdateProblemInput, options: CallOptions) !update_problem.UpdateProblemOutput {
