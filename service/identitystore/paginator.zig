...
pub const ListGroupMembershipsPaginator = struct {
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_group_memberships.Options) !list_group_memberships.ListGroupMembershipsOutput {
        if (self.done) {
...
pub const ListGroupMembershipsForMemberPaginator = struct {
    client: *Client,
    params: list_group_memberships_for_member.ListGroupMembershipsForMemberInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_group_memberships_for_member.Options) !list_group_memberships_for_member.ListGroupMembershipsForMemberOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_group_memberships_for_member.execute(self.client, allocator, self.params, options);
