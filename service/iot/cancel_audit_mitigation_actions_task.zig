...
pub const CancelAuditMitigationActionsTaskInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelAuditMitigationActionsTaskInput, options: Options) !CancelAuditMitigationActionsTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelAuditMitigationActionsTaskInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelAuditMitigationActionsTaskOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelAuditMitigationActionsTaskOutput = .{};
