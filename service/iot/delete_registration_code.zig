...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRegistrationCodeInput, options: Options) !DeleteRegistrationCodeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRegistrationCodeInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRegistrationCodeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRegistrationCodeOutput = .{};
