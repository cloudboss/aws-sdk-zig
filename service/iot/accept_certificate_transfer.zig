...
fn serializeRequest(alloc: std.mem.Allocator, input: AcceptCertificateTransferInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/accept-certificate-transfer/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AcceptCertificateTransferOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
