...
pub const AcceptCertificateTransferInput = struct {
...
pub const AcceptCertificateTransferOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptCertificateTransferInput, options: CallOptions) !AcceptCertificateTransferOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AcceptCertificateTransferInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/accept-certificate-transfer/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AcceptCertificateTransferOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AcceptCertificateTransferOutput = .{};
