...
pub const Client = struct {
    ...
    pub fn acceptCertificateTransfer(self: *Self, allocator: std.mem.Allocator, input: accept_certificate_transfer.AcceptCertificateTransferInput, options: CallOptions) !accept_certificate_transfer.AcceptCertificateTransferOutput {
    ...
    pub fn addThingToBillingGroup(self: *Self, allocator: std.mem.Allocator, input: add_thing_to_billing_group.AddThingToBillingGroupInput, options: CallOptions) !add_thing_to_billing_group.AddThingToBillingGroupOutput {
    ...
    pub fn addThingToThingGroup(self: *Self, allocator: std.mem.Allocator, input: add_thing_to_thing_group.AddThingToThingGroupInput, options: CallOptions) !add_thing_to_thing_group.AddThingToThingGroupOutput {
    ...
    pub fn associateSbomWithPackageVersion(self: *Self, allocator: std.mem.Allocator, input: associate_sbom_with_package_version.AssociateSbomWithPackageVersionInput, options: CallOptions) !associate_sbom_with_package_version.AssociateSbomWithPackageVersionOutput {
    ...
    pub fn associateTargetsWithJob(self: *Self, allocator: std.mem.Allocator, input: associate_targets_with_job.AssociateTargetsWithJobInput, options: CallOptions) !associate_targets_with_job.AssociateTargetsWithJobOutput {
    ...
    pub fn attachPrincipalPolicy(self: *Self, allocator: std.mem.Allocator, input: attach_principal_policy.AttachPrincipalPolicyInput, options: CallOptions) !attach_principal_policy.AttachPrincipalPolicyOutput {
    ...
    pub fn attachSecurityProfile(self: *Self, allocator: std.mem.Allocator, input: attach_security_profile.AttachSecurityProfileInput, options: CallOptions) !attach_security_profile.AttachSecurityProfileOutput {
    ...
    pub fn attachThingPrincipal(self: *Self, allocator: std.mem.Allocator, input: attach_thing_principal.AttachThingPrincipalInput, options: CallOptions) !attach_thing_principal.AttachThingPrincipalOutput {
    ...
    pub fn cancelAuditMitigationActionsTask(self: *Self, allocator: std.mem.Allocator, input: cancel_audit_mitigation_actions_task.CancelAuditMitigationActionsTaskInput, options: CallOptions) !cancel_audit_mitigation_actions_task.CancelAuditMitigationActionsTaskOutput {
    ...
    pub fn cancelAuditTask(self: *Self, allocator: std.mem.Allocator, input: cancel_audit_task.CancelAuditTaskInput, options: CallOptions) !cancel_audit_task.CancelAuditTaskOutput {
    ...
    pub fn cancelCertificateTransfer(self: *Self, allocator: std.mem.Allocator, input: cancel_certificate_transfer.CancelCertificateTransferInput, options: CallOptions) !cancel_certificate_transfer.CancelCertificateTransferOutput {
    ...
    pub fn cancelDetectMitigationActionsTask(self: *Self, allocator: std.mem.Allocator, input: cancel_detect_mitigation_actions_task.CancelDetectMitigationActionsTaskInput, options: CallOptions) !cancel_detect_mitigation_actions_task.CancelDetectMitigationActionsTaskOutput {
    ...
    pub fn cancelJobExecution(self: *Self, allocator: std.mem.Allocator, input: cancel_job_execution.CancelJobExecutionInput, options: CallOptions) !cancel_job_execution.CancelJobExecutionOutput {
    ...
    pub fn clearDefaultAuthorizer(self: *Self, allocator: std.mem.Allocator, input: clear_default_authorizer.ClearDefaultAuthorizerInput, options: CallOptions) !clear_default_authorizer.ClearDefaultAuthorizerOutput {
    ...
    pub fn confirmTopicRuleDestination(self: *Self, allocator: std.mem.Allocator, input: confirm_topic_rule_destination.ConfirmTopicRuleDestinationInput, options: CallOptions) !confirm_topic_rule_destination.ConfirmTopicRuleDestinationOutput {
    ...
    pub fn createAuditSuppression(self: *Self, allocator: std.mem.Allocator, input: create_audit_suppression.CreateAuditSuppressionInput, options: CallOptions) !create_audit_suppression.CreateAuditSuppressionOutput {
    ...
    /// `
    pub fn createCertificateFromCsr(self: *Self, allocator: std.mem.Allocator, input: create_certificate_from_csr.CreateCertificateFromCsrInput, options: CallOptions) !create_certificate_from_csr.CreateCertificateFromCsrOutput {
    ...
    pub fn createCertificateProvider(self: *Self, allocator: std.mem.Allocator, input: create_certificate_provider.CreateCertificateProviderInput, options: CallOptions) !create_certificate_provider.CreateCertificateProviderOutput {
    ...
    pub fn createCommand(self: *Self, allocator: std.mem.Allocator, input: create_command.CreateCommandInput, options: CallOptions) !create_command.CreateCommandOutput {
    ...
    pub fn createCustomMetric(self: *Self, allocator: std.mem.Allocator, input: create_custom_metric.CreateCustomMetricInput, options: CallOptions) !create_custom_metric.CreateCustomMetricOutput {
    ...
    pub fn createDimension(self: *Self, allocator: std.mem.Allocator, input: create_dimension.CreateDimensionInput, options: CallOptions) !create_dimension.CreateDimensionOutput {
    ...
    pub fn createDomainConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_domain_configuration.CreateDomainConfigurationInput, options: CallOptions) !create_domain_configuration.CreateDomainConfigurationOutput {
    ...
    pub fn createDynamicThingGroup(self: *Self, allocator: std.mem.Allocator, input: create_dynamic_thing_group.CreateDynamicThingGroupInput, options: CallOptions) !create_dynamic_thing_group.CreateDynamicThingGroupOutput {
    ...
    pub fn createFleetMetric(self: *Self, allocator: std.mem.Allocator, input: create_fleet_metric.CreateFleetMetricInput, options: CallOptions) !create_fleet_metric.CreateFleetMetricOutput {
    ...
    pub fn createKeysAndCertificate(self: *Self, allocator: std.mem.Allocator, input: create_keys_and_certificate.CreateKeysAndCertificateInput, options: CallOptions) !create_keys_and_certificate.CreateKeysAndCertificateOutput {
    ...
    pub fn createMitigationAction(self: *Self, allocator: std.mem.Allocator, input: create_mitigation_action.CreateMitigationActionInput, options: CallOptions) !create_mitigation_action.CreateMitigationActionOutput {
    ...
    pub fn createOtaUpdate(self: *Self, allocator: std.mem.Allocator, input: create_ota_update.CreateOTAUpdateInput, options: CallOptions) !create_ota_update.CreateOTAUpdateOutput {
    ...
    pub fn createPackageVersion(self: *Self, allocator: std.mem.Allocator, input: create_package_version.CreatePackageVersionInput, options: CallOptions) !create_package_version.CreatePackageVersionOutput {
    ...
    pub fn createProvisioningClaim(self: *Self, allocator: std.mem.Allocator, input: create_provisioning_claim.CreateProvisioningClaimInput, options: CallOptions) !create_provisioning_claim.CreateProvisioningClaimOutput {
    ...
    pub fn createProvisioningTemplate(self: *Self, allocator: std.mem.Allocator, input: create_provisioning_template.CreateProvisioningTemplateInput, options: CallOptions) !create_provisioning_template.CreateProvisioningTemplateOutput {
    ...
    pub fn createProvisioningTemplateVersion(self: *Self, allocator: std.mem.Allocator, input: create_provisioning_template_version.CreateProvisioningTemplateVersionInput, options: CallOptions) !create_provisioning_template_version.CreateProvisioningTemplateVersionOutput {
    ...
    pub fn createRoleAlias(self: *Self, allocator: std.mem.Allocator, input: create_role_alias.CreateRoleAliasInput, options: CallOptions) !create_role_alias.CreateRoleAliasOutput {
    ...
    pub fn createScheduledAudit(self: *Self, allocator: std.mem.Allocator, input: create_scheduled_audit.CreateScheduledAuditInput, options: CallOptions) !create_scheduled_audit.CreateScheduledAuditOutput {
    ...
    pub fn createThing(self: *Self, allocator: std.mem.Allocator, input: create_thing.CreateThingInput, options: CallOptions) !create_thing.CreateThingOutput {
    ...
    pub fn createThingGroup(self: *Self, allocator: std.mem.Allocator, input: create_thing_group.CreateThingGroupInput, options: CallOptions) !create_thing_group.CreateThingGroupOutput {
    ...
    pub fn createThingType(self: *Self, allocator: std.mem.Allocator, input: create_thing_type.CreateThingTypeInput, options: CallOptions) !create_thing_type.CreateThingTypeOutput {
    ...
    pub fn createTopicRule(self: *Self, allocator: std.mem.Allocator, input: create_topic_rule.CreateTopicRuleInput, options: CallOptions) !create_topic_rule.CreateTopicRuleOutput {
    ...
    pub fn createTopicRuleDestination(self: *Self, allocator: std.mem.Allocator, input: create_topic_rule_destination.CreateTopicRuleDestinationInput, options: CallOptions) !create_topic_rule_destination.CreateTopicRuleDestinationOutput {
    ...
    pub fn deleteAccountAuditConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_account_audit_configuration.DeleteAccountAuditConfigurationInput, options: CallOptions) !delete_account_audit_configuration.DeleteAccountAuditConfigurationOutput {
    ...
    pub fn deleteAuditSuppression(self: *Self, allocator: std.mem.Allocator, input: delete_audit_suppression.DeleteAuditSuppressionInput, options: CallOptions) !delete_audit_suppression.DeleteAuditSuppressionOutput {
    ...
    pub fn deleteCaCertificate(self: *Self, allocator: std.mem.Allocator, input: delete_ca_certificate.DeleteCACertificateInput, options: CallOptions) !delete_ca_certificate.DeleteCACertificateOutput {
    ...
    pub fn deleteCertificateProvider(self: *Self, allocator: std.mem.Allocator, input: delete_certificate_provider.DeleteCertificateProviderInput, options: CallOptions) !delete_certificate_provider.DeleteCertificateProviderOutput {
        return delete_certificate_provider.execute(self, allocator, input, options);
    }

    /// Delete a command resource.
    pub fn deleteCommand(self: *Self, allocator: std.mem.Allocator, input: delete_command.DeleteCommandInput, options: CallOptions) !delete_command.DeleteCommandOutput {
    ...
    /// your account.
    pub fn deleteCommandExecution(self: *Self, allocator: std.mem.Allocator, input: delete_command_execution.DeleteCommandExecutionInput, options: CallOptions) !delete_command_execution.DeleteCommandExecutionOutput {
    ...
    pub fn deleteCustomMetric(self: *Self, allocator: std.mem.Allocator, input: delete_custom_metric.DeleteCustomMetricInput, options: CallOptions) !delete_custom_metric.DeleteCustomMetricOutput {
    ...
    pub fn deleteDimension(self: *Self, allocator: std.mem.Allocator, input: delete_dimension.DeleteDimensionInput, options: CallOptions) !delete_dimension.DeleteDimensionOutput {
    ...
    pub fn deleteDomainConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_domain_configuration.DeleteDomainConfigurationInput, options: CallOptions) !delete_domain_configuration.DeleteDomainConfigurationOutput {
    ...
    pub fn deleteDynamicThingGroup(self: *Self, allocator: std.mem.Allocator, input: delete_dynamic_thing_group.DeleteDynamicThingGroupInput, options: CallOptions) !delete_dynamic_thing_group.DeleteDynamicThingGroupOutput {
    ...
    pub fn deleteFleetMetric(self: *Self, allocator: std.mem.Allocator, input: delete_fleet_metric.DeleteFleetMetricInput, options: CallOptions) !delete_fleet_metric.DeleteFleetMetricOutput {
    ...
    pub fn deleteJobExecution(self: *Self, allocator: std.mem.Allocator, input: delete_job_execution.DeleteJobExecutionInput, options: CallOptions) !delete_job_execution.DeleteJobExecutionOutput {
    ...
    pub fn deleteMitigationAction(self: *Self, allocator: std.mem.Allocator, input: delete_mitigation_action.DeleteMitigationActionInput, options: CallOptions) !delete_mitigation_action.DeleteMitigationActionOutput {
    ...
    pub fn deleteOtaUpdate(self: *Self, allocator: std.mem.Allocator, input: delete_ota_update.DeleteOTAUpdateInput, options: CallOptions) !delete_ota_update.DeleteOTAUpdateOutput {
    ...
    pub fn deletePackageVersion(self: *Self, allocator: std.mem.Allocator, input: delete_package_version.DeletePackageVersionInput, options: CallOptions) !delete_package_version.DeletePackageVersionOutput {
    ...
    pub fn deleteProvisioningTemplate(self: *Self, allocator: std.mem.Allocator, input: delete_provisioning_template.DeleteProvisioningTemplateInput, options: CallOptions) !delete_provisioning_template.DeleteProvisioningTemplateOutput {
    ...
    pub fn deleteProvisioningTemplateVersion(self: *Self, allocator: std.mem.Allocator, input: delete_provisioning_template_version.DeleteProvisioningTemplateVersionInput, options: CallOptions) !delete_provisioning_template_version.DeleteProvisioningTemplateVersionOutput {
    ...
    pub fn deleteRegistrationCode(self: *Self, allocator: std.mem.Allocator, input: delete_registration_code.DeleteRegistrationCodeInput, options: CallOptions) !delete_registration_code.DeleteRegistrationCodeOutput {
    ...
    pub fn deleteRoleAlias(self: *Self, allocator: std.mem.Allocator, input: delete_role_alias.DeleteRoleAliasInput, options: CallOptions) !delete_role_alias.DeleteRoleAliasOutput {
    ...
    pub fn deleteScheduledAudit(self: *Self, allocator: std.mem.Allocator, input: delete_scheduled_audit.DeleteScheduledAuditInput, options: CallOptions) !delete_scheduled_audit.DeleteScheduledAuditOutput {
    ...
    pub fn deleteThing(self: *Self, allocator: std.mem.Allocator, input: delete_thing.DeleteThingInput, options: CallOptions) !delete_thing.DeleteThingOutput {
    ...
    pub fn deleteThingGroup(self: *Self, allocator: std.mem.Allocator, input: delete_thing_group.DeleteThingGroupInput, options: CallOptions) !delete_thing_group.DeleteThingGroupOutput {
    ...
    pub fn deleteThingType(self: *Self, allocator: std.mem.Allocator, input: delete_thing_type.DeleteThingTypeInput, options: CallOptions) !delete_thing_type.DeleteThingTypeOutput {
    ...
    pub fn deleteTopicRule(self: *Self, allocator: std.mem.Allocator, input: delete_topic_rule.DeleteTopicRuleInput, options: CallOptions) !delete_topic_rule.DeleteTopicRuleOutput {
    ...
    pub fn deleteTopicRuleDestination(self: *Self, allocator: std.mem.Allocator, input: delete_topic_rule_destination.DeleteTopicRuleDestinationInput, options: CallOptions) !delete_topic_rule_destination.DeleteTopicRuleDestinationOutput {
    ...
    pub fn deleteV2LoggingLevel(self: *Self, allocator: std.mem.Allocator, input: delete_v2_logging_level.DeleteV2LoggingLevelInput, options: CallOptions) !delete_v2_logging_level.DeleteV2LoggingLevelOutput {
    ...
    pub fn deprecateThingType(self: *Self, allocator: std.mem.Allocator, input: deprecate_thing_type.DeprecateThingTypeInput, options: CallOptions) !deprecate_thing_type.DeprecateThingTypeOutput {
    ...
    pub fn describeAccountAuditConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_account_audit_configuration.DescribeAccountAuditConfigurationInput, options: CallOptions) !describe_account_audit_configuration.DescribeAccountAuditConfigurationOutput {
    ...
    pub fn describeAuditFinding(self: *Self, allocator: std.mem.Allocator, input: describe_audit_finding.DescribeAuditFindingInput, options: CallOptions) !describe_audit_finding.DescribeAuditFindingOutput {
    ...
    pub fn describeAuditMitigationActionsTask(self: *Self, allocator: std.mem.Allocator, input: describe_audit_mitigation_actions_task.DescribeAuditMitigationActionsTaskInput, options: CallOptions) !describe_audit_mitigation_actions_task.DescribeAuditMitigationActionsTaskOutput {
        return describe_audit_mitigation_actions_task.execute(self, allocator, input, options);
    }

    /// Gets information about a Device Defender audit suppression.
    pub fn describeAuditSuppression(self: *Self, allocator: std.mem.Allocator, input: describe_audit_suppression.DescribeAuditSuppressionInput, options: CallOptions) !describe_audit_suppression.DescribeAuditSuppressionOutput {
    ...
    pub fn describeAuditTask(self: *Self, allocator: std.mem.Allocator, input: describe_audit_task.DescribeAuditTaskInput, options: CallOptions) !describe_audit_task.DescribeAuditTaskOutput {
    ...
    pub fn describeAuthorizer(self: *Self, allocator: std.mem.Allocator, input: describe_authorizer.DescribeAuthorizerInput, options: CallOptions) !describe_authorizer.DescribeAuthorizerOutput {
    ...
    pub fn describeBillingGroup(self: *Self, allocator: std.mem.Allocator, input: describe_billing_group.DescribeBillingGroupInput, options: CallOptions) !describe_billing_group.DescribeBillingGroupOutput {
    ...
    pub fn describeCaCertificate(self: *Self, allocator: std.mem.Allocator, input: describe_ca_certificate.DescribeCACertificateInput, options: CallOptions) !describe_ca_certificate.DescribeCACertificateOutput {
    ...
    pub fn describeCertificateProvider(self: *Self, allocator: std.mem.Allocator, input: describe_certificate_provider.DescribeCertificateProviderInput, options: CallOptions) !describe_certificate_provider.DescribeCertificateProviderOutput {
    ...
    pub fn describeCustomMetric(self: *Self, allocator: std.mem.Allocator, input: describe_custom_metric.DescribeCustomMetricInput, options: CallOptions) !describe_custom_metric.DescribeCustomMetricOutput {
    ...
    pub fn describeDefaultAuthorizer(self: *Self, allocator: std.mem.Allocator, input: describe_default_authorizer.DescribeDefaultAuthorizerInput, options: CallOptions) !describe_default_authorizer.DescribeDefaultAuthorizerOutput {
    ...
    pub fn describeDetectMitigationActionsTask(self: *Self, allocator: std.mem.Allocator, input: describe_detect_mitigation_actions_task.DescribeDetectMitigationActionsTaskInput, options: CallOptions) !describe_detect_mitigation_actions_task.DescribeDetectMitigationActionsTaskOutput {
    ...
    pub fn describeDimension(self: *Self, allocator: std.mem.Allocator, input: describe_dimension.DescribeDimensionInput, options: CallOptions) !describe_dimension.DescribeDimensionOutput {
    ...
    pub fn describeDomainConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_domain_configuration.DescribeDomainConfigurationInput, options: CallOptions) !describe_domain_configuration.DescribeDomainConfigurationOutput {
    ...
    pub fn describeEncryptionConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_encryption_configuration.DescribeEncryptionConfigurationInput, options: CallOptions) !describe_encryption_configuration.DescribeEncryptionConfigurationOutput {
    ...
    pub fn describeEventConfigurations(self: *Self, allocator: std.mem.Allocator, input: describe_event_configurations.DescribeEventConfigurationsInput, options: CallOptions) !describe_event_configurations.DescribeEventConfigurationsOutput {
    ...
    pub fn describeFleetMetric(self: *Self, allocator: std.mem.Allocator, input: describe_fleet_metric.DescribeFleetMetricInput, options: CallOptions) !describe_fleet_metric.DescribeFleetMetricOutput {
    ...
    pub fn describeManagedJobTemplate(self: *Self, allocator: std.mem.Allocator, input: describe_managed_job_template.DescribeManagedJobTemplateInput, options: CallOptions) !describe_managed_job_template.DescribeManagedJobTemplateOutput {
    ...
    pub fn describeMitigationAction(self: *Self, allocator: std.mem.Allocator, input: describe_mitigation_action.DescribeMitigationActionInput, options: CallOptions) !describe_mitigation_action.DescribeMitigationActionOutput {
    ...
    pub fn describeProvisioningTemplate(self: *Self, allocator: std.mem.Allocator, input: describe_provisioning_template.DescribeProvisioningTemplateInput, options: CallOptions) !describe_provisioning_template.DescribeProvisioningTemplateOutput {
    ...
    pub fn describeProvisioningTemplateVersion(self: *Self, allocator: std.mem.Allocator, input: describe_provisioning_template_version.DescribeProvisioningTemplateVersionInput, options: CallOptions) !describe_provisioning_template_version.DescribeProvisioningTemplateVersionOutput {
    ...
    pub fn describeRoleAlias(self: *Self, allocator: std.mem.Allocator, input: describe_role_alias.DescribeRoleAliasInput, options: CallOptions) !describe_role_alias.DescribeRoleAliasOutput {
    ...
    pub fn describeScheduledAudit(self: *Self, allocator: std.mem.Allocator, input: describe_scheduled_audit.DescribeScheduledAuditInput, options: CallOptions) !describe_scheduled_audit.DescribeScheduledAuditOutput {
    ...
    pub fn describeThing(self: *Self, allocator: std.mem.Allocator, input: describe_thing.DescribeThingInput, options: CallOptions) !describe_thing.DescribeThingOutput {
    ...
    pub fn describeThingGroup(self: *Self, allocator: std.mem.Allocator, input: describe_thing_group.DescribeThingGroupInput, options: CallOptions) !describe_thing_group.DescribeThingGroupOutput {
    ...
    pub fn describeThingRegistrationTask(self: *Self, allocator: std.mem.Allocator, input: describe_thing_registration_task.DescribeThingRegistrationTaskInput, options: CallOptions) !describe_thing_registration_task.DescribeThingRegistrationTaskOutput {
    ...
    pub fn describeThingType(self: *Self, allocator: std.mem.Allocator, input: describe_thing_type.DescribeThingTypeInput, options: CallOptions) !describe_thing_type.DescribeThingTypeOutput {
    ...
    pub fn detachPrincipalPolicy(self: *Self, allocator: std.mem.Allocator, input: detach_principal_policy.DetachPrincipalPolicyInput, options: CallOptions) !detach_principal_policy.DetachPrincipalPolicyOutput {
    ...
    pub fn detachSecurityProfile(self: *Self, allocator: std.mem.Allocator, input: detach_security_profile.DetachSecurityProfileInput, options: CallOptions) !detach_security_profile.DetachSecurityProfileOutput {
    ...
    pub fn detachThingPrincipal(self: *Self, allocator: std.mem.Allocator, input: detach_thing_principal.DetachThingPrincipalInput, options: CallOptions) !detach_thing_principal.DetachThingPrincipalOutput {
    ...
    pub fn disableTopicRule(self: *Self, allocator: std.mem.Allocator, input: disable_topic_rule.DisableTopicRuleInput, options: CallOptions) !disable_topic_rule.DisableTopicRuleOutput {
    ...
    pub fn disassociateSbomFromPackageVersion(self: *Self, allocator: std.mem.Allocator, input: disassociate_sbom_from_package_version.DisassociateSbomFromPackageVersionInput, options: CallOptions) !disassociate_sbom_from_package_version.DisassociateSbomFromPackageVersionOutput {
    ...
    pub fn enableTopicRule(self: *Self, allocator: std.mem.Allocator, input: enable_topic_rule.EnableTopicRuleInput, options: CallOptions) !enable_topic_rule.EnableTopicRuleOutput {
    ...
    pub fn getBehaviorModelTrainingSummaries(self: *Self, allocator: std.mem.Allocator, input: get_behavior_model_training_summaries.GetBehaviorModelTrainingSummariesInput, options: CallOptions) !get_behavior_model_training_summaries.GetBehaviorModelTrainingSummariesOutput {
    ...
    pub fn getBucketsAggregation(self: *Self, allocator: std.mem.Allocator, input: get_buckets_aggregation.GetBucketsAggregationInput, options: CallOptions) !get_buckets_aggregation.GetBucketsAggregationOutput {
    ...
    pub fn getCardinality(self: *Self, allocator: std.mem.Allocator, input: get_cardinality.GetCardinalityInput, options: CallOptions) !get_cardinality.GetCardinalityOutput {
        return get_cardinality.execute(self, allocator, input, options);
    }

    /// Gets information about the specified command.
    pub fn getCommand(self: *Self, allocator: std.mem.Allocator, input: get_command.GetCommandInput, options: CallOptions) !get_command.GetCommandOutput {
        return get_command.execute(self, allocator, input, options);
    }

    /// Gets information about the specific command execution on a single device.
    pub fn getCommandExecution(self: *Self, allocator: std.mem.Allocator, input: get_command_execution.GetCommandExecutionInput, options: CallOptions) !get_command_execution.GetCommandExecutionOutput {
    ...
    pub fn getEffectivePolicies(self: *Self, allocator: std.mem.Allocator, input: get_effective_policies.GetEffectivePoliciesInput, options: CallOptions) !get_effective_policies.GetEffectivePoliciesOutput {
    ...
    pub fn getIndexingConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_indexing_configuration.GetIndexingConfigurationInput, options: CallOptions) !get_indexing_configuration.GetIndexingConfigurationOutput {
    ...
    pub fn getJobDocument(self: *Self, allocator: std.mem.Allocator, input: get_job_document.GetJobDocumentInput, options: CallOptions) !get_job_document.GetJobDocumentOutput {
    ...
    pub fn getLoggingOptions(self: *Self, allocator: std.mem.Allocator, input: get_logging_options.GetLoggingOptionsInput, options: CallOptions) !get_logging_options.GetLoggingOptionsOutput {
    ...
    pub fn getOtaUpdate(self: *Self, allocator: std.mem.Allocator, input: get_ota_update.GetOTAUpdateInput, options: CallOptions) !get_ota_update.GetOTAUpdateOutput {
    ...
    pub fn getPackage(self: *Self, allocator: std.mem.Allocator, input: get_package.GetPackageInput, options: CallOptions) !get_package.GetPackageOutput {
    ...
    pub fn getPackageConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_package_configuration.GetPackageConfigurationInput, options: CallOptions) !get_package_configuration.GetPackageConfigurationOutput {
    ...
    pub fn getPackageVersion(self: *Self, allocator: std.mem.Allocator, input: get_package_version.GetPackageVersionInput, options: CallOptions) !get_package_version.GetPackageVersionOutput {
    ...
    pub fn getPercentiles(self: *Self, allocator: std.mem.Allocator, input: get_percentiles.GetPercentilesInput, options: CallOptions) !get_percentiles.GetPercentilesOutput {
    ...
    pub fn getRegistrationCode(self: *Self, allocator: std.mem.Allocator, input: get_registration_code.GetRegistrationCodeInput, options: CallOptions) !get_registration_code.GetRegistrationCodeOutput {
    ...
    pub fn getStatistics(self: *Self, allocator: std.mem.Allocator, input: get_statistics.GetStatisticsInput, options: CallOptions) !get_statistics.GetStatisticsOutput {
    ...
    pub fn getTopicRule(self: *Self, allocator: std.mem.Allocator, input: get_topic_rule.GetTopicRuleInput, options: CallOptions) !get_topic_rule.GetTopicRuleOutput {
    ...
    pub fn getTopicRuleDestination(self: *Self, allocator: std.mem.Allocator, input: get_topic_rule_destination.GetTopicRuleDestinationInput, options: CallOptions) !get_topic_rule_destination.GetTopicRuleDestinationOutput {
    ...
    pub fn getV2LoggingOptions(self: *Self, allocator: std.mem.Allocator, input: get_v2_logging_options.GetV2LoggingOptionsInput, options: CallOptions) !get_v2_logging_options.GetV2LoggingOptionsOutput {
    ...
    pub fn listActiveViolations(self: *Self, allocator: std.mem.Allocator, input: list_active_violations.ListActiveViolationsInput, options: CallOptions) !list_active_violations.ListActiveViolationsOutput {
    ...
    pub fn listAttachedPolicies(self: *Self, allocator: std.mem.Allocator, input: list_attached_policies.ListAttachedPoliciesInput, options: CallOptions) !list_attached_policies.ListAttachedPoliciesOutput {
    ...
    pub fn listAuditMitigationActionsExecutions(self: *Self, allocator: std.mem.Allocator, input: list_audit_mitigation_actions_executions.ListAuditMitigationActionsExecutionsInput, options: CallOptions) !list_audit_mitigation_actions_executions.ListAuditMitigationActionsExecutionsOutput {
    ...
    pub fn listAuditMitigationActionsTasks(self: *Self, allocator: std.mem.Allocator, input: list_audit_mitigation_actions_tasks.ListAuditMitigationActionsTasksInput, options: CallOptions) !list_audit_mitigation_actions_tasks.ListAuditMitigationActionsTasksOutput {
    ...
    pub fn listAuditSuppressions(self: *Self, allocator: std.mem.Allocator, input: list_audit_suppressions.ListAuditSuppressionsInput, options: CallOptions) !list_audit_suppressions.ListAuditSuppressionsOutput {
    ...
    pub fn listAuditTasks(self: *Self, allocator: std.mem.Allocator, input: list_audit_tasks.ListAuditTasksInput, options: CallOptions) !list_audit_tasks.ListAuditTasksOutput {
    ...
    pub fn listAuthorizers(self: *Self, allocator: std.mem.Allocator, input: list_authorizers.ListAuthorizersInput, options: CallOptions) !list_authorizers.ListAuthorizersOutput {
    ...
    pub fn listCaCertificates(self: *Self, allocator: std.mem.Allocator, input: list_ca_certificates.ListCACertificatesInput, options: CallOptions) !list_ca_certificates.ListCACertificatesOutput {
    ...
    pub fn listCertificateProviders(self: *Self, allocator: std.mem.Allocator, input: list_certificate_providers.ListCertificateProvidersInput, options: CallOptions) !list_certificate_providers.ListCertificateProvidersOutput {
    ...
    pub fn listCertificatesByCa(self: *Self, allocator: std.mem.Allocator, input: list_certificates_by_ca.ListCertificatesByCAInput, options: CallOptions) !list_certificates_by_ca.ListCertificatesByCAOutput {
    ...
    pub fn listCommandExecutions(self: *Self, allocator: std.mem.Allocator, input: list_command_executions.ListCommandExecutionsInput, options: CallOptions) !list_command_executions.ListCommandExecutionsOutput {
    ...
    pub fn listCustomMetrics(self: *Self, allocator: std.mem.Allocator, input: list_custom_metrics.ListCustomMetricsInput, options: CallOptions) !list_custom_metrics.ListCustomMetricsOutput {
    ...
    pub fn listDetectMitigationActionsExecutions(self: *Self, allocator: std.mem.Allocator, input: list_detect_mitigation_actions_executions.ListDetectMitigationActionsExecutionsInput, options: CallOptions) !list_detect_mitigation_actions_executions.ListDetectMitigationActionsExecutionsOutput {
    ...
    pub fn listDetectMitigationActionsTasks(self: *Self, allocator: std.mem.Allocator, input: list_detect_mitigation_actions_tasks.ListDetectMitigationActionsTasksInput, options: CallOptions) !list_detect_mitigation_actions_tasks.ListDetectMitigationActionsTasksOutput {
    ...
    pub fn listDimensions(self: *Self, allocator: std.mem.Allocator, input: list_dimensions.ListDimensionsInput, options: CallOptions) !list_dimensions.ListDimensionsOutput {
    ...
    pub fn listDomainConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_domain_configurations.ListDomainConfigurationsInput, options: CallOptions) !list_domain_configurations.ListDomainConfigurationsOutput {
    ...
    pub fn listFleetMetrics(self: *Self, allocator: std.mem.Allocator, input: list_fleet_metrics.ListFleetMetricsInput, options: CallOptions) !list_fleet_metrics.ListFleetMetricsOutput {
    ...
    pub fn listJobExecutionsForJob(self: *Self, allocator: std.mem.Allocator, input: list_job_executions_for_job.ListJobExecutionsForJobInput, options: CallOptions) !list_job_executions_for_job.ListJobExecutionsForJobOutput {
    ...
    pub fn listJobExecutionsForThing(self: *Self, allocator: std.mem.Allocator, input: list_job_executions_for_thing.ListJobExecutionsForThingInput, options: CallOptions) !list_job_executions_for_thing.ListJobExecutionsForThingOutput {
    ...
    pub fn listManagedJobTemplates(self: *Self, allocator: std.mem.Allocator, input: list_managed_job_templates.ListManagedJobTemplatesInput, options: CallOptions) !list_managed_job_templates.ListManagedJobTemplatesOutput {
    ...
    pub fn listMetricValues(self: *Self, allocator: std.mem.Allocator, input: list_metric_values.ListMetricValuesInput, options: CallOptions) !list_metric_values.ListMetricValuesOutput {
    ...
    pub fn listMitigationActions(self: *Self, allocator: std.mem.Allocator, input: list_mitigation_actions.ListMitigationActionsInput, options: CallOptions) !list_mitigation_actions.ListMitigationActionsOutput {
    ...
    pub fn listOtaUpdates(self: *Self, allocator: std.mem.Allocator, input: list_ota_updates.ListOTAUpdatesInput, options: CallOptions) !list_ota_updates.ListOTAUpdatesOutput {
    ...
    pub fn listOutgoingCertificates(self: *Self, allocator: std.mem.Allocator, input: list_outgoing_certificates.ListOutgoingCertificatesInput, options: CallOptions) !list_outgoing_certificates.ListOutgoingCertificatesOutput {
    ...
    pub fn listPackageVersions(self: *Self, allocator: std.mem.Allocator, input: list_package_versions.ListPackageVersionsInput, options: CallOptions) !list_package_versions.ListPackageVersionsOutput {
    ...
    pub fn listPolicyPrincipals(self: *Self, allocator: std.mem.Allocator, input: list_policy_principals.ListPolicyPrincipalsInput, options: CallOptions) !list_policy_principals.ListPolicyPrincipalsOutput {
    ...
    pub fn listPrincipalPolicies(self: *Self, allocator: std.mem.Allocator, input: list_principal_policies.ListPrincipalPoliciesInput, options: CallOptions) !list_principal_policies.ListPrincipalPoliciesOutput {
    ...
    pub fn listPrincipalThings(self: *Self, allocator: std.mem.Allocator, input: list_principal_things.ListPrincipalThingsInput, options: CallOptions) !list_principal_things.ListPrincipalThingsOutput {
    ...
    /// Requires permission to access the
    /// [ListPrincipalThings](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsiot.html#awsiot-actions-as-permissions) action.
    pub fn listPrincipalThingsV2(self: *Self, allocator: std.mem.Allocator, input: list_principal_things_v2.ListPrincipalThingsV2Input, options: CallOptions) !list_principal_things_v2.ListPrincipalThingsV2Output {
    ...
    pub fn listProvisioningTemplateVersions(self: *Self, allocator: std.mem.Allocator, input: list_provisioning_template_versions.ListProvisioningTemplateVersionsInput, options: CallOptions) !list_provisioning_template_versions.ListProvisioningTemplateVersionsOutput {
    ...
    pub fn listProvisioningTemplates(self: *Self, allocator: std.mem.Allocator, input: list_provisioning_templates.ListProvisioningTemplatesInput, options: CallOptions) !list_provisioning_templates.ListProvisioningTemplatesOutput {
    ...
    /// certificates.
    pub fn listRelatedResourcesForAuditFinding(self: *Self, allocator: std.mem.Allocator, input: list_related_resources_for_audit_finding.ListRelatedResourcesForAuditFindingInput, options: CallOptions) !list_related_resources_for_audit_finding.ListRelatedResourcesForAuditFindingOutput {
    ...
    pub fn listRoleAliases(self: *Self, allocator: std.mem.Allocator, input: list_role_aliases.ListRoleAliasesInput, options: CallOptions) !list_role_aliases.ListRoleAliasesOutput {
    ...
    pub fn listSbomValidationResults(self: *Self, allocator: std.mem.Allocator, input: list_sbom_validation_results.ListSbomValidationResultsInput, options: CallOptions) !list_sbom_validation_results.ListSbomValidationResultsOutput {
    ...
    pub fn listScheduledAudits(self: *Self, allocator: std.mem.Allocator, input: list_scheduled_audits.ListScheduledAuditsInput, options: CallOptions) !list_scheduled_audits.ListScheduledAuditsOutput {
    ...
    pub fn listSecurityProfilesForTarget(self: *Self, allocator: std.mem.Allocator, input: list_security_profiles_for_target.ListSecurityProfilesForTargetInput, options: CallOptions) !list_security_profiles_for_target.ListSecurityProfilesForTargetOutput {
    ...
    pub fn listTargetsForSecurityProfile(self: *Self, allocator: std.mem.Allocator, input: list_targets_for_security_profile.ListTargetsForSecurityProfileInput, options: CallOptions) !list_targets_for_security_profile.ListTargetsForSecurityProfileOutput {
    ...
    pub fn listThingGroups(self: *Self, allocator: std.mem.Allocator, input: list_thing_groups.ListThingGroupsInput, options: CallOptions) !list_thing_groups.ListThingGroupsOutput {
    ...
    pub fn listThingGroupsForThing(self: *Self, allocator: std.mem.Allocator, input: list_thing_groups_for_thing.ListThingGroupsForThingInput, options: CallOptions) !list_thing_groups_for_thing.ListThingGroupsForThingOutput {
    ...
    pub fn listThingPrincipals(self: *Self, allocator: std.mem.Allocator, input: list_thing_principals.ListThingPrincipalsInput, options: CallOptions) !list_thing_principals.ListThingPrincipalsOutput {
    ...
    /// Requires permission to access the
    /// [ListThingPrincipals](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awsiot.html#awsiot-actions-as-permissions) action.
    pub fn listThingPrincipalsV2(self: *Self, allocator: std.mem.Allocator, input: list_thing_principals_v2.ListThingPrincipalsV2Input, options: CallOptions) !list_thing_principals_v2.ListThingPrincipalsV2Output {
        return list_thing_principals_v2.execute(self, allocator, input, options);
    }

    /// Information about the thing registration tasks.
    pub fn listThingRegistrationTaskReports(self: *Self, allocator: std.mem.Allocator, input: list_thing_registration_task_reports.ListThingRegistrationTaskReportsInput, options: CallOptions) !list_thing_registration_task_reports.ListThingRegistrationTaskReportsOutput {
    ...
    pub fn listThingRegistrationTasks(self: *Self, allocator: std.mem.Allocator, input: list_thing_registration_tasks.ListThingRegistrationTasksInput, options: CallOptions) !list_thing_registration_tasks.ListThingRegistrationTasksOutput {
    ...
    pub fn listThingTypes(self: *Self, allocator: std.mem.Allocator, input: list_thing_types.ListThingTypesInput, options: CallOptions) !list_thing_types.ListThingTypesOutput {
    ...
    /// returned.
    pub fn listThings(self: *Self, allocator: std.mem.Allocator, input: list_things.ListThingsInput, options: CallOptions) !list_things.ListThingsOutput {
    ...
    pub fn listThingsInBillingGroup(self: *Self, allocator: std.mem.Allocator, input: list_things_in_billing_group.ListThingsInBillingGroupInput, options: CallOptions) !list_things_in_billing_group.ListThingsInBillingGroupOutput {
    ...
    pub fn listThingsInThingGroup(self: *Self, allocator: std.mem.Allocator, input: list_things_in_thing_group.ListThingsInThingGroupInput, options: CallOptions) !list_things_in_thing_group.ListThingsInThingGroupOutput {
    ...
    pub fn listTopicRuleDestinations(self: *Self, allocator: std.mem.Allocator, input: list_topic_rule_destinations.ListTopicRuleDestinationsInput, options: CallOptions) !list_topic_rule_destinations.ListTopicRuleDestinationsOutput {
    ...
    pub fn listTopicRules(self: *Self, allocator: std.mem.Allocator, input: list_topic_rules.ListTopicRulesInput, options: CallOptions) !list_topic_rules.ListTopicRulesOutput {
    ...
    pub fn listV2LoggingLevels(self: *Self, allocator: std.mem.Allocator, input: list_v2_logging_levels.ListV2LoggingLevelsInput, options: CallOptions) !list_v2_logging_levels.ListV2LoggingLevelsOutput {
    ...
    pub fn listViolationEvents(self: *Self, allocator: std.mem.Allocator, input: list_violation_events.ListViolationEventsInput, options: CallOptions) !list_violation_events.ListViolationEventsOutput {
    ...
    pub fn registerCaCertificate(self: *Self, allocator: std.mem.Allocator, input: register_ca_certificate.RegisterCACertificateInput, options: CallOptions) !register_ca_certificate.RegisterCACertificateOutput {
    ...
    /// IoT](https://docs.aws.amazon.com/iot/latest/developerguide/x509-client-certs.html#x509-cert-algorithms).
    pub fn registerCertificateWithoutCa(self: *Self, allocator: std.mem.Allocator, input: register_certificate_without_ca.RegisterCertificateWithoutCAInput, options: CallOptions) !register_certificate_without_ca.RegisterCertificateWithoutCAOutput {
    ...
    pub fn registerThing(self: *Self, allocator: std.mem.Allocator, input: register_thing.RegisterThingInput, options: CallOptions) !register_thing.RegisterThingOutput {
    ...
    pub fn rejectCertificateTransfer(self: *Self, allocator: std.mem.Allocator, input: reject_certificate_transfer.RejectCertificateTransferInput, options: CallOptions) !reject_certificate_transfer.RejectCertificateTransferOutput {
    ...
    /// This call is asynchronous. It might take several seconds for the detachment
    /// to propagate.
    pub fn removeThingFromBillingGroup(self: *Self, allocator: std.mem.Allocator, input: remove_thing_from_billing_group.RemoveThingFromBillingGroupInput, options: CallOptions) !remove_thing_from_billing_group.RemoveThingFromBillingGroupOutput {
    ...
    pub fn removeThingFromThingGroup(self: *Self, allocator: std.mem.Allocator, input: remove_thing_from_thing_group.RemoveThingFromThingGroupInput, options: CallOptions) !remove_thing_from_thing_group.RemoveThingFromThingGroupOutput {
    ...
    pub fn replaceTopicRule(self: *Self, allocator: std.mem.Allocator, input: replace_topic_rule.ReplaceTopicRuleInput, options: CallOptions) !replace_topic_rule.ReplaceTopicRuleOutput {
    ...
    pub fn searchIndex(self: *Self, allocator: std.mem.Allocator, input: search_index.SearchIndexInput, options: CallOptions) !search_index.SearchIndexOutput {
    ...
    pub fn setDefaultAuthorizer(self: *Self, allocator: std.mem.Allocator, input: set_default_authorizer.SetDefaultAuthorizerInput, options: CallOptions) !set_default_authorizer.SetDefaultAuthorizerOutput {
    ...
    pub fn setLoggingOptions(self: *Self, allocator: std.mem.Allocator, input: set_logging_options.SetLoggingOptionsInput, options: CallOptions) !set_logging_options.SetLoggingOptionsOutput {
    ...
    pub fn setV2LoggingLevel(self: *Self, allocator: std.mem.Allocator, input: set_v2_logging_level.SetV2LoggingLevelInput, options: CallOptions) !set_v2_logging_level.SetV2LoggingLevelOutput {
    ...
    pub fn setV2LoggingOptions(self: *Self, allocator: std.mem.Allocator, input: set_v2_logging_options.SetV2LoggingOptionsInput, options: CallOptions) !set_v2_logging_options.SetV2LoggingOptionsOutput {
    ...
    pub fn startAuditMitigationActionsTask(self: *Self, allocator: std.mem.Allocator, input: start_audit_mitigation_actions_task.StartAuditMitigationActionsTaskInput, options: CallOptions) !start_audit_mitigation_actions_task.StartAuditMitigationActionsTaskOutput {
    ...
    pub fn startDetectMitigationActionsTask(self: *Self, allocator: std.mem.Allocator, input: start_detect_mitigation_actions_task.StartDetectMitigationActionsTaskInput, options: CallOptions) !start_detect_mitigation_actions_task.StartDetectMitigationActionsTaskOutput {
    ...
    pub fn startOnDemandAuditTask(self: *Self, allocator: std.mem.Allocator, input: start_on_demand_audit_task.StartOnDemandAuditTaskInput, options: CallOptions) !start_on_demand_audit_task.StartOnDemandAuditTaskOutput {
    ...
    pub fn startThingRegistrationTask(self: *Self, allocator: std.mem.Allocator, input: start_thing_registration_task.StartThingRegistrationTaskInput, options: CallOptions) !start_thing_registration_task.StartThingRegistrationTaskOutput {
    ...
    pub fn stopThingRegistrationTask(self: *Self, allocator: std.mem.Allocator, input: stop_thing_registration_task.StopThingRegistrationTaskInput, options: CallOptions) !stop_thing_registration_task.StopThingRegistrationTaskOutput {
    ...
    pub fn testAuthorization(self: *Self, allocator: std.mem.Allocator, input: test_authorization.TestAuthorizationInput, options: CallOptions) !test_authorization.TestAuthorizationOutput {
    ...
    pub fn transferCertificate(self: *Self, allocator: std.mem.Allocator, input: transfer_certificate.TransferCertificateInput, options: CallOptions) !transfer_certificate.TransferCertificateOutput {
    ...
    pub fn updateAccountAuditConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_account_audit_configuration.UpdateAccountAuditConfigurationInput, options: CallOptions) !update_account_audit_configuration.UpdateAccountAuditConfigurationOutput {
        return update_account_audit_configuration.execute(self, allocator, input, options);
    }

    /// Updates a Device Defender audit suppression.
    pub fn updateAuditSuppression(self: *Self, allocator: std.mem.Allocator, input: update_audit_suppression.UpdateAuditSuppressionInput, options: CallOptions) !update_audit_suppression.UpdateAuditSuppressionOutput {
    ...
    pub fn updateCaCertificate(self: *Self, allocator: std.mem.Allocator, input: update_ca_certificate.UpdateCACertificateInput, options: CallOptions) !update_ca_certificate.UpdateCACertificateOutput {
    ...
    pub fn updateCertificateProvider(self: *Self, allocator: std.mem.Allocator, input: update_certificate_provider.UpdateCertificateProviderInput, options: CallOptions) !update_certificate_provider.UpdateCertificateProviderOutput {
        return update_certificate_provider.execute(self, allocator, input, options);
    }

    /// Update information about a command or mark a command for deprecation.
    pub fn updateCommand(self: *Self, allocator: std.mem.Allocator, input: update_command.UpdateCommandInput, options: CallOptions) !update_command.UpdateCommandOutput {
    ...
    pub fn updateCustomMetric(self: *Self, allocator: std.mem.Allocator, input: update_custom_metric.UpdateCustomMetricInput, options: CallOptions) !update_custom_metric.UpdateCustomMetricOutput {
    ...
    pub fn updateDimension(self: *Self, allocator: std.mem.Allocator, input: update_dimension.UpdateDimensionInput, options: CallOptions) !update_dimension.UpdateDimensionOutput {
    ...
    pub fn updateDomainConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_domain_configuration.UpdateDomainConfigurationInput, options: CallOptions) !update_domain_configuration.UpdateDomainConfigurationOutput {
    ...
    pub fn updateDynamicThingGroup(self: *Self, allocator: std.mem.Allocator, input: update_dynamic_thing_group.UpdateDynamicThingGroupInput, options: CallOptions) !update_dynamic_thing_group.UpdateDynamicThingGroupOutput {
    ...
    pub fn updateEncryptionConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_encryption_configuration.UpdateEncryptionConfigurationInput, options: CallOptions) !update_encryption_configuration.UpdateEncryptionConfigurationOutput {
    ...
    pub fn updateEventConfigurations(self: *Self, allocator: std.mem.Allocator, input: update_event_configurations.UpdateEventConfigurationsInput, options: CallOptions) !update_event_configurations.UpdateEventConfigurationsOutput {
    ...
    pub fn updateFleetMetric(self: *Self, allocator: std.mem.Allocator, input: update_fleet_metric.UpdateFleetMetricInput, options: CallOptions) !update_fleet_metric.UpdateFleetMetricOutput {
    ...
    pub fn updateIndexingConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_indexing_configuration.UpdateIndexingConfigurationInput, options: CallOptions) !update_indexing_configuration.UpdateIndexingConfigurationOutput {
    ...
    pub fn updateMitigationAction(self: *Self, allocator: std.mem.Allocator, input: update_mitigation_action.UpdateMitigationActionInput, options: CallOptions) !update_mitigation_action.UpdateMitigationActionOutput {
    ...
    pub fn updatePackageConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_package_configuration.UpdatePackageConfigurationInput, options: CallOptions) !update_package_configuration.UpdatePackageConfigurationOutput {
    ...
    pub fn updatePackageVersion(self: *Self, allocator: std.mem.Allocator, input: update_package_version.UpdatePackageVersionInput, options: CallOptions) !update_package_version.UpdatePackageVersionOutput {
    ...
    pub fn updateProvisioningTemplate(self: *Self, allocator: std.mem.Allocator, input: update_provisioning_template.UpdateProvisioningTemplateInput, options: CallOptions) !update_provisioning_template.UpdateProvisioningTemplateOutput {
    ...
    pub fn updateRoleAlias(self: *Self, allocator: std.mem.Allocator, input: update_role_alias.UpdateRoleAliasInput, options: CallOptions) !update_role_alias.UpdateRoleAliasOutput {
    ...
    pub fn updateScheduledAudit(self: *Self, allocator: std.mem.Allocator, input: update_scheduled_audit.UpdateScheduledAuditInput, options: CallOptions) !update_scheduled_audit.UpdateScheduledAuditOutput {
    ...
    pub fn updateThing(self: *Self, allocator: std.mem.Allocator, input: update_thing.UpdateThingInput, options: CallOptions) !update_thing.UpdateThingOutput {
    ...
    pub fn updateThingGroup(self: *Self, allocator: std.mem.Allocator, input: update_thing_group.UpdateThingGroupInput, options: CallOptions) !update_thing_group.UpdateThingGroupOutput {
    ...
    pub fn updateThingGroupsForThing(self: *Self, allocator: std.mem.Allocator, input: update_thing_groups_for_thing.UpdateThingGroupsForThingInput, options: CallOptions) !update_thing_groups_for_thing.UpdateThingGroupsForThingOutput {
        return update_thing_groups_for_thing.execute(self, allocator, input, options);
    }

    /// Updates a thing type.
    pub fn updateThingType(self: *Self, allocator: std.mem.Allocator, input: update_thing_type.UpdateThingTypeInput, options: CallOptions) !update_thing_type.UpdateThingTypeOutput {
    ...
    pub fn updateTopicRuleDestination(self: *Self, allocator: std.mem.Allocator, input: update_topic_rule_destination.UpdateTopicRuleDestinationInput, options: CallOptions) !update_topic_rule_destination.UpdateTopicRuleDestinationOutput {
    ...
    pub fn validateSecurityProfileBehaviors(self: *Self, allocator: std.mem.Allocator, input: validate_security_profile_behaviors.ValidateSecurityProfileBehaviorsInput, options: CallOptions) !validate_security_profile_behaviors.ValidateSecurityProfileBehaviorsOutput {
