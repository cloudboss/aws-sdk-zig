...
pub const DeletePackageVersionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePackageVersionInput, options: Options) !DeletePackageVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePackageVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePackageVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePackageVersionOutput = .{};
