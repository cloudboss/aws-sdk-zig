...
pub const DeleteThingGroupInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteThingGroupInput, options: Options) !DeleteThingGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteThingGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteThingGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteThingGroupOutput = .{};
