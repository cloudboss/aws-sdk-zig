...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCommandExecutionInput, options: CallOptions) !DeleteCommandExecutionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCommandExecutionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCommandExecutionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
