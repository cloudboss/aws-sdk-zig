...
pub const DeleteCommandExecutionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCommandExecutionInput, options: Options) !DeleteCommandExecutionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCommandExecutionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCommandExecutionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCommandExecutionOutput = .{};
