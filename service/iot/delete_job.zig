...
pub const DeleteJobInput = struct {
    ...
    /// Otherwise, you
    /// can only delete a job which is in a terminal state ("COMPLETED" or
    /// "CANCELED") or an
    ...
    /// a new
    /// job. However, this is not recommended, and you must ensure that your devices
    /// are not
