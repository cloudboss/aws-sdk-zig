...
pub const DeleteDimensionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDimensionInput, options: Options) !DeleteDimensionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDimensionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDimensionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDimensionOutput = .{};
