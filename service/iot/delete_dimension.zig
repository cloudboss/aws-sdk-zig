...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDimensionInput, options: CallOptions) !DeleteDimensionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDimensionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDimensionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
