...
pub const DeleteRoleAliasInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRoleAliasInput, options: Options) !DeleteRoleAliasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRoleAliasInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRoleAliasOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRoleAliasOutput = .{};
