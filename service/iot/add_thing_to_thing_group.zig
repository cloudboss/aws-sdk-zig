...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddThingToThingGroupInput, options: CallOptions) !AddThingToThingGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddThingToThingGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddThingToThingGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
