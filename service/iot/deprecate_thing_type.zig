...
fn serializeRequest(alloc: std.mem.Allocator, input: DeprecateThingTypeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/deprecate");
    ...
    if (input.undo_deprecate) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"undoDeprecate\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeprecateThingTypeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
