...
const SetV2LoggingLevelOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetV2LoggingLevelInput, options: Options) !SetV2LoggingLevelOutput {
