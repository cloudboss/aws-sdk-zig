...
fn serializeRequest(alloc: std.mem.Allocator, input: CancelCertificateTransferInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/cancel-certificate-transfer/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CancelCertificateTransferOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
