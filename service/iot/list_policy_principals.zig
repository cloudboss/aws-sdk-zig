...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPolicyPrincipalsInput, options: CallOptions) !ListPolicyPrincipalsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPolicyPrincipalsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "x-amzn-iot-policy", input.policy_name);
