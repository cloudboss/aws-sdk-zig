...
fn serializeRequest(alloc: std.mem.Allocator, input: ClearDefaultAuthorizerInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ClearDefaultAuthorizerOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
