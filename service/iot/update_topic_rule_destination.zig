...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateTopicRuleDestinationInput, options: Options) !UpdateTopicRuleDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateTopicRuleDestinationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateTopicRuleDestinationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
