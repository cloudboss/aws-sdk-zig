...
pub const DeleteScheduledAuditInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteScheduledAuditInput, options: Options) !DeleteScheduledAuditOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteScheduledAuditInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteScheduledAuditOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteScheduledAuditOutput = .{};
