...
pub const DetachPrincipalPolicyInput = struct {
...
pub const DetachPrincipalPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachPrincipalPolicyInput, options: CallOptions) !DetachPrincipalPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachPrincipalPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachPrincipalPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DetachPrincipalPolicyOutput = .{};
