...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDomainConfigurationsInput, options: CallOptions) !ListDomainConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDomainConfigurationsInput, config: *aws.Config) !aws.http.Request {
