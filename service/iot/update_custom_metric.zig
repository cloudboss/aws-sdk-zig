...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCustomMetricInput, options: CallOptions) !UpdateCustomMetricOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCustomMetricInput, config: *aws.Config) !aws.http.Request {
