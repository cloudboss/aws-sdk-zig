...
pub const DeleteThingTypeInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteThingTypeInput, options: Options) !DeleteThingTypeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteThingTypeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteThingTypeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteThingTypeOutput = .{};
