...
pub const DeleteFleetMetricOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFleetMetricInput, options: CallOptions) !DeleteFleetMetricOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFleetMetricInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFleetMetricOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
