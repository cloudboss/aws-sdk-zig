...
pub const DeleteFleetMetricInput = struct {
...
const DeleteFleetMetricOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFleetMetricInput, options: Options) !DeleteFleetMetricOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteFleetMetricInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteFleetMetricOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFleetMetricOutput = .{};
