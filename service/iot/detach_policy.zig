...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachPolicyInput, options: Options) !DetachPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DetachPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DetachPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DetachPolicyOutput = .{};
