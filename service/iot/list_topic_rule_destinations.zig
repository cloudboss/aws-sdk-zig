...
const TopicRuleDestinationSummary = @import("topic_rule_destination_summary.zig").TopicRuleDestinationSummary;

pub const ListTopicRuleDestinationsInput = struct {
...
pub const ListTopicRuleDestinationsOutput = struct {
    /// Information about a topic rule destination.
    destination_summaries: ?[]const TopicRuleDestinationSummary = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTopicRuleDestinationsInput, options: CallOptions) !ListTopicRuleDestinationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTopicRuleDestinationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListTopicRuleDestinationsOutput {
    var result: ListTopicRuleDestinationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListTopicRuleDestinationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
