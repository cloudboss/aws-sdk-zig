...
pub const DeleteTopicRuleInput = struct {
...
pub const DeleteTopicRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTopicRuleInput, options: CallOptions) !DeleteTopicRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTopicRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTopicRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTopicRuleOutput = .{};
