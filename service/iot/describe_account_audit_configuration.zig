...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAccountAuditConfigurationInput, options: Options) !DescribeAccountAuditConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeAccountAuditConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeAccountAuditConfigurationOutput {
    var result: DescribeAccountAuditConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeAccountAuditConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
