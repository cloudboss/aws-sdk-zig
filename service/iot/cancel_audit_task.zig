...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelAuditTaskInput, options: CallOptions) !CancelAuditTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelAuditTaskInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelAuditTaskOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
