...
const RejectCertificateTransferOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectCertificateTransferInput, options: Options) !RejectCertificateTransferOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RejectCertificateTransferInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/reject-certificate-transfer/");
    ...
    if (input.reject_reason) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"rejectReason\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RejectCertificateTransferOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
