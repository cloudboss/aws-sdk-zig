...
pub const DeleteCommandInput = struct {
...
pub const DeleteCommandOutput = struct {
    ...
    /// `DeleteCommand` request, the deletion will be scheduled and a 202 status
    /// code
    ...
    /// maximum time out duration of 12 hours, when calling the `DeleteCommand`
    /// request,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCommandInput, options: CallOptions) !DeleteCommandOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCommandInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCommandOutput {
    _ = allocator;
    var result: DeleteCommandOutput = .{};
    _ = body;
