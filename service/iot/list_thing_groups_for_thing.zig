...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListThingGroupsForThingInput, options: CallOptions) !ListThingGroupsForThingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListThingGroupsForThingInput, config: *aws.Config) !aws.http.Request {
