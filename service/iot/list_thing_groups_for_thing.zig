...
pub const ListThingGroupsForThingInput = struct {
...
pub const ListThingGroupsForThingOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListThingGroupsForThingInput, options: Options) !ListThingGroupsForThingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListThingGroupsForThingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListThingGroupsForThingOutput {
    var result: ListThingGroupsForThingOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListThingGroupsForThingOutput, body, alloc);
    }
    _ = status;
    _ = headers;
