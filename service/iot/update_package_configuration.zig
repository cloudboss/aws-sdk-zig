...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdatePackageConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.version_update_by_jobs_config) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"versionUpdateByJobsConfig\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdatePackageConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
