...
pub const DeleteCACertificateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCACertificateInput, options: Options) !DeleteCACertificateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCACertificateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCACertificateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCACertificateOutput = .{};
