...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAuthorizersInput, options: CallOptions) !ListAuthorizersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAuthorizersInput, config: *aws.Config) !aws.http.Request {
