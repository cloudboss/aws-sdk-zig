...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/target-policies/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
