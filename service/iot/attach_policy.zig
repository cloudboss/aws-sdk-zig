...
pub const AttachPolicyInput = struct {
    ...
    /// The
    /// [identity](https://docs.aws.amazon.com/iot/latest/developerguide/security-iam.html) to which the policy is attached. For example, a thing group or a certificate.
    target: []const u8,
...
fn serializeRequest(alloc: std.mem.Allocator, input: AttachPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/target-policies/");
