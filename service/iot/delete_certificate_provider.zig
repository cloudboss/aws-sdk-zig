...
pub const DeleteCertificateProviderInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCertificateProviderInput, options: Options) !DeleteCertificateProviderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCertificateProviderInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCertificateProviderOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCertificateProviderOutput = .{};
