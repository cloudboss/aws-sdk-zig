...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRelatedResourcesForAuditFindingInput, options: CallOptions) !ListRelatedResourcesForAuditFindingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRelatedResourcesForAuditFindingInput, config: *aws.Config) !aws.http.Request {
