...
const SetDefaultPolicyVersionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetDefaultPolicyVersionInput, options: Options) !SetDefaultPolicyVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SetDefaultPolicyVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetDefaultPolicyVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
