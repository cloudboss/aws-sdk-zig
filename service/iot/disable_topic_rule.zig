...
pub const DisableTopicRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableTopicRuleInput, options: CallOptions) !DisableTopicRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableTopicRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableTopicRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
