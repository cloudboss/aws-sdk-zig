...
pub const DisableTopicRuleInput = struct {
...
const DisableTopicRuleOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableTopicRuleInput, options: Options) !DisableTopicRuleOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisableTopicRuleInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.rule_name);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisableTopicRuleOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisableTopicRuleOutput = .{};
