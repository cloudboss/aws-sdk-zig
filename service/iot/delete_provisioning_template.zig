...
pub const DeleteProvisioningTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProvisioningTemplateInput, options: Options) !DeleteProvisioningTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProvisioningTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteProvisioningTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProvisioningTemplateOutput = .{};
