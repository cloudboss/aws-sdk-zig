...
pub const DetachSecurityProfileInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachSecurityProfileInput, options: Options) !DetachSecurityProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DetachSecurityProfileInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DetachSecurityProfileOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DetachSecurityProfileOutput = .{};
