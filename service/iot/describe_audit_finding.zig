...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAuditFindingInput, options: CallOptions) !DescribeAuditFindingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAuditFindingInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/audit/findings/");
