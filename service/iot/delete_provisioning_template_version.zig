...
pub const DeleteProvisioningTemplateVersionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProvisioningTemplateVersionInput, options: Options) !DeleteProvisioningTemplateVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteProvisioningTemplateVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteProvisioningTemplateVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProvisioningTemplateVersionOutput = .{};
