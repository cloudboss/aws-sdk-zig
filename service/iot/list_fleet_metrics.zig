...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFleetMetricsInput, options: CallOptions) !ListFleetMetricsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFleetMetricsInput, config: *aws.Config) !aws.http.Request {
