...
pub const StopThingRegistrationTaskInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopThingRegistrationTaskInput, options: Options) !StopThingRegistrationTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopThingRegistrationTaskInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopThingRegistrationTaskOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: StopThingRegistrationTaskOutput = .{};
