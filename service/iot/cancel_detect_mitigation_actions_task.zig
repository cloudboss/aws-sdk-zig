...
pub const CancelDetectMitigationActionsTaskInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelDetectMitigationActionsTaskInput, options: Options) !CancelDetectMitigationActionsTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelDetectMitigationActionsTaskInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelDetectMitigationActionsTaskOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelDetectMitigationActionsTaskOutput = .{};
