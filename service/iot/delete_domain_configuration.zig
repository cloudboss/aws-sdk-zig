...
pub const DeleteDomainConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDomainConfigurationInput, options: Options) !DeleteDomainConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDomainConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDomainConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDomainConfigurationOutput = .{};
