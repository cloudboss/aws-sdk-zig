...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAuditSuppressionInput, options: Options) !CreateAuditSuppressionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateAuditSuppressionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateAuditSuppressionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
