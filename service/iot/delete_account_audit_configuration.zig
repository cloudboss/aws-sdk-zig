...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccountAuditConfigurationInput, options: Options) !DeleteAccountAuditConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccountAuditConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.delete_scheduled_audits) |v| {
        ...
        try query_buf.appendSlice(alloc, "deleteScheduledAudits=");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccountAuditConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
