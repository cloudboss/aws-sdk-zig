...
pub const UpdateEventConfigurationsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateEventConfigurationsInput, options: Options) !UpdateEventConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateEventConfigurationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateEventConfigurationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateEventConfigurationsOutput = .{};
