...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListProvisioningTemplateVersionsInput, options: CallOptions) !ListProvisioningTemplateVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListProvisioningTemplateVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListProvisioningTemplateVersionsOutput {
    var result: ListProvisioningTemplateVersionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListProvisioningTemplateVersionsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
