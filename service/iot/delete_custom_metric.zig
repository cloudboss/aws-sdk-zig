...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomMetricInput, options: CallOptions) !DeleteCustomMetricOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCustomMetricInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCustomMetricOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
