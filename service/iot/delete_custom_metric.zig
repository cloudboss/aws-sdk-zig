...
pub const DeleteCustomMetricInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomMetricInput, options: Options) !DeleteCustomMetricOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCustomMetricInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCustomMetricOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCustomMetricOutput = .{};
