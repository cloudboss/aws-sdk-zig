...
pub const DeleteMitigationActionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMitigationActionInput, options: Options) !DeleteMitigationActionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMitigationActionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMitigationActionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMitigationActionOutput = .{};
