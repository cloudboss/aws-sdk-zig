...
pub const DeleteAuthorizerInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAuthorizerInput, options: Options) !DeleteAuthorizerOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAuthorizerInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAuthorizerOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAuthorizerOutput = .{};
