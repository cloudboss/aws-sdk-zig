...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListThingsInBillingGroupInput, options: CallOptions) !ListThingsInBillingGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListThingsInBillingGroupInput, config: *aws.Config) !aws.http.Request {
