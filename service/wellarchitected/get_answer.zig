...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAnswerInput, options: CallOptions) !GetAnswerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAnswerInput, config: *aws.Config) !aws.http.Request {
