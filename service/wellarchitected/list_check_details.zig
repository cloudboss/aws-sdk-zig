...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCheckDetailsInput, options: CallOptions) !ListCheckDetailsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCheckDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/checks");
