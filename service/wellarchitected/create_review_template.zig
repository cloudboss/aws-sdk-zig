...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateReviewTemplateInput, options: CallOptions) !CreateReviewTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateReviewTemplateInput, config: *aws.Config) !aws.http.Request {
