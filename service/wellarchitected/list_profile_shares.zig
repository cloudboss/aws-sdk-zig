...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListProfileSharesInput, options: CallOptions) !ListProfileSharesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListProfileSharesInput, config: *aws.Config) !aws.http.Request {
