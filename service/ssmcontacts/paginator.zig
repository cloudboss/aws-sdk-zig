...
pub const ListContactChannelsPaginator = struct {
    client: *Client,
    params: list_contact_channels.ListContactChannelsInput,
...
pub const ListPageReceiptsPaginator = struct {
    client: *Client,
    params: list_page_receipts.ListPageReceiptsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListPageResolutionsPaginator = struct {
    client: *Client,
    params: list_page_resolutions.ListPageResolutionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListPagesByContactPaginator = struct {
    client: *Client,
    params: list_pages_by_contact.ListPagesByContactInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListPagesByEngagementPaginator = struct {
    client: *Client,
    params: list_pages_by_engagement.ListPagesByEngagementInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListPreviewRotationShiftsPaginator = struct {
    client: *Client,
    params: list_preview_rotation_shifts.ListPreviewRotationShiftsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListRotationOverridesPaginator = struct {
    client: *Client,
    params: list_rotation_overrides.ListRotationOverridesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListRotationShiftsPaginator = struct {
    client: *Client,
    params: list_rotation_shifts.ListRotationShiftsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
...
pub const ListRotationsPaginator = struct {
    client: *Client,
    params: list_rotations.ListRotationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
