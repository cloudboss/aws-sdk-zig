...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTrainingJobInput, options: Options) !DescribeTrainingJobOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeTrainingJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.DescribeTrainingJob");
