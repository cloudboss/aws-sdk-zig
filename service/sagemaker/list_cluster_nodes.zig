...
fn serializeRequest(alloc: std.mem.Allocator, input: ListClusterNodesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.ListClusterNodes");
