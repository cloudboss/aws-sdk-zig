...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeModelPackageInput, options: Options) !DescribeModelPackageOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeModelPackageInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.DescribeModelPackage");
