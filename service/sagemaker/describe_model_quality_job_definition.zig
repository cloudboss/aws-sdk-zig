...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeModelQualityJobDefinitionInput, options: Options) !DescribeModelQualityJobDefinitionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeModelQualityJobDefinitionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.DescribeModelQualityJobDefinition");
