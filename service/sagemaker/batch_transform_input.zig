const MonitoringDatasetFormat = @import("monitoring_dataset_format.zig").MonitoringDatasetFormat;
...
pub const BatchTransformInput = struct {
    /// The Amazon S3 location being used to capture the data.
    data_captured_destination_s3_uri: []const u8,
