...
pub const DescribeAIWorkloadConfigInput = struct {
...
pub const DescribeAIWorkloadConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAIWorkloadConfigInput, options: CallOptions) !DescribeAIWorkloadConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAIWorkloadConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SageMaker.DescribeAIWorkloadConfig");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeAIWorkloadConfigOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DescribeAIWorkloadConfigOutput, body, allocator);
}
