...
pub const Client = struct {
    ...
    pub fn addAssociation(self: *Self, allocator: std.mem.Allocator, input: add_association.AddAssociationInput, options: CallOptions) !add_association.AddAssociationOutput {
    ...
    pub fn attachClusterNodeVolume(self: *Self, allocator: std.mem.Allocator, input: attach_cluster_node_volume.AttachClusterNodeVolumeInput, options: CallOptions) !attach_cluster_node_volume.AttachClusterNodeVolumeOutput {
    ...
    pub fn batchAddClusterNodes(self: *Self, allocator: std.mem.Allocator, input: batch_add_cluster_nodes.BatchAddClusterNodesInput, options: CallOptions) !batch_add_cluster_nodes.BatchAddClusterNodesOutput {
    ...
    pub fn batchDeleteClusterNodes(self: *Self, allocator: std.mem.Allocator, input: batch_delete_cluster_nodes.BatchDeleteClusterNodesInput, options: CallOptions) !batch_delete_cluster_nodes.BatchDeleteClusterNodesOutput {
        return batch_delete_cluster_nodes.execute(self, allocator, input, options);
    }

    /// This action batch describes a list of versioned model packages
    pub fn batchDescribeModelPackage(self: *Self, allocator: std.mem.Allocator, input: batch_describe_model_package.BatchDescribeModelPackageInput, options: CallOptions) !batch_describe_model_package.BatchDescribeModelPackageOutput {
    ...
    pub fn batchRebootClusterNodes(self: *Self, allocator: std.mem.Allocator, input: batch_reboot_cluster_nodes.BatchRebootClusterNodesInput, options: CallOptions) !batch_reboot_cluster_nodes.BatchRebootClusterNodesOutput {
    ...
    pub fn batchReplaceClusterNodes(self: *Self, allocator: std.mem.Allocator, input: batch_replace_cluster_nodes.BatchReplaceClusterNodesInput, options: CallOptions) !batch_replace_cluster_nodes.BatchReplaceClusterNodesOutput {
    ...
    pub fn createAlgorithm(self: *Self, allocator: std.mem.Allocator, input: create_algorithm.CreateAlgorithmInput, options: CallOptions) !create_algorithm.CreateAlgorithmOutput {
    ...
    pub fn createAppImageConfig(self: *Self, allocator: std.mem.Allocator, input: create_app_image_config.CreateAppImageConfigInput, options: CallOptions) !create_app_image_config.CreateAppImageConfigOutput {
    ...
    /// Tracking](https://docs.aws.amazon.com/sagemaker/latest/dg/lineage-tracking.html).
    pub fn createArtifact(self: *Self, allocator: std.mem.Allocator, input: create_artifact.CreateArtifactInput, options: CallOptions) !create_artifact.CreateArtifactOutput {
    ...
    pub fn createAutoMlJob(self: *Self, allocator: std.mem.Allocator, input: create_auto_ml_job.CreateAutoMLJobInput, options: CallOptions) !create_auto_ml_job.CreateAutoMLJobOutput {
    ...
    pub fn createAutoMlJobV2(self: *Self, allocator: std.mem.Allocator, input: create_auto_ml_job_v2.CreateAutoMLJobV2Input, options: CallOptions) !create_auto_ml_job_v2.CreateAutoMLJobV2Output {
    ...
    pub fn createClusterSchedulerConfig(self: *Self, allocator: std.mem.Allocator, input: create_cluster_scheduler_config.CreateClusterSchedulerConfigInput, options: CallOptions) !create_cluster_scheduler_config.CreateClusterSchedulerConfigOutput {
    ...
    pub fn createCodeRepository(self: *Self, allocator: std.mem.Allocator, input: create_code_repository.CreateCodeRepositoryInput, options: CallOptions) !create_code_repository.CreateCodeRepositoryOutput {
    ...
    pub fn createCompilationJob(self: *Self, allocator: std.mem.Allocator, input: create_compilation_job.CreateCompilationJobInput, options: CallOptions) !create_compilation_job.CreateCompilationJobOutput {
    ...
    /// entities.
    pub fn createComputeQuota(self: *Self, allocator: std.mem.Allocator, input: create_compute_quota.CreateComputeQuotaInput, options: CallOptions) !create_compute_quota.CreateComputeQuotaOutput {
    ...
    /// Tracking](https://docs.aws.amazon.com/sagemaker/latest/dg/lineage-tracking.html).
    pub fn createContext(self: *Self, allocator: std.mem.Allocator, input: create_context.CreateContextInput, options: CallOptions) !create_context.CreateContextOutput {
    ...
    pub fn createDataQualityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: create_data_quality_job_definition.CreateDataQualityJobDefinitionInput, options: CallOptions) !create_data_quality_job_definition.CreateDataQualityJobDefinitionOutput {
        return create_data_quality_job_definition.execute(self, allocator, input, options);
    }

    /// Creates a device fleet.
    pub fn createDeviceFleet(self: *Self, allocator: std.mem.Allocator, input: create_device_fleet.CreateDeviceFleetInput, options: CallOptions) !create_device_fleet.CreateDeviceFleetOutput {
    ...
    pub fn createEdgeDeploymentPlan(self: *Self, allocator: std.mem.Allocator, input: create_edge_deployment_plan.CreateEdgeDeploymentPlanInput, options: CallOptions) !create_edge_deployment_plan.CreateEdgeDeploymentPlanOutput {
        return create_edge_deployment_plan.execute(self, allocator, input, options);
    }

    /// Creates a new stage in an existing edge deployment plan.
    pub fn createEdgeDeploymentStage(self: *Self, allocator: std.mem.Allocator, input: create_edge_deployment_stage.CreateEdgeDeploymentStageInput, options: CallOptions) !create_edge_deployment_stage.CreateEdgeDeploymentStageOutput {
    ...
    pub fn createEdgePackagingJob(self: *Self, allocator: std.mem.Allocator, input: create_edge_packaging_job.CreateEdgePackagingJobInput, options: CallOptions) !create_edge_packaging_job.CreateEdgePackagingJobOutput {
    ...
    /// When you call
    /// [CreateEndpoint](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateEndpoint.html), a load call is made to DynamoDB to verify that your endpoint configuration exists. When you read data from a DynamoDB table supporting [ `Eventually Consistent Reads` ](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.ReadConsistency.html), the response might not reflect the results of a recently completed write operation. The response might include some stale data. If the dependent entities are not yet in DynamoDB, this causes a validation error. If you repeat your read request after a short time, the response should return the latest data. So retry logic is recommended to handle these possible issues. We also recommend that customers call [DescribeEndpointConfig](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_DescribeEndpointConfig.html) before calling [CreateEndpoint](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateEndpoint.html) to minimize the potential impact of a DynamoDB eventually consistent read.
    pub fn createEndpointConfig(self: *Self, allocator: std.mem.Allocator, input: create_endpoint_config.CreateEndpointConfigInput, options: CallOptions) !create_endpoint_config.CreateEndpointConfigOutput {
    ...
    pub fn createFeatureGroup(self: *Self, allocator: std.mem.Allocator, input: create_feature_group.CreateFeatureGroupInput, options: CallOptions) !create_feature_group.CreateFeatureGroupOutput {
        return create_feature_group.execute(self, allocator, input, options);
    }

    /// Creates a flow definition.
    pub fn createFlowDefinition(self: *Self, allocator: std.mem.Allocator, input: create_flow_definition.CreateFlowDefinitionInput, options: CallOptions) !create_flow_definition.CreateFlowDefinitionOutput {
        return create_flow_definition.execute(self, allocator, input, options);
    }

    /// Create a hub.
    pub fn createHub(self: *Self, allocator: std.mem.Allocator, input: create_hub.CreateHubInput, options: CallOptions) !create_hub.CreateHubOutput {
    ...
    pub fn createHubContentPresignedUrls(self: *Self, allocator: std.mem.Allocator, input: create_hub_content_presigned_urls.CreateHubContentPresignedUrlsInput, options: CallOptions) !create_hub_content_presigned_urls.CreateHubContentPresignedUrlsOutput {
    ...
    pub fn createHubContentReference(self: *Self, allocator: std.mem.Allocator, input: create_hub_content_reference.CreateHubContentReferenceInput, options: CallOptions) !create_hub_content_reference.CreateHubContentReferenceOutput {
    ...
    pub fn createHumanTaskUi(self: *Self, allocator: std.mem.Allocator, input: create_human_task_ui.CreateHumanTaskUiInput, options: CallOptions) !create_human_task_ui.CreateHumanTaskUiOutput {
    ...
    pub fn createHyperParameterTuningJob(self: *Self, allocator: std.mem.Allocator, input: create_hyper_parameter_tuning_job.CreateHyperParameterTuningJobInput, options: CallOptions) !create_hyper_parameter_tuning_job.CreateHyperParameterTuningJobOutput {
    ...
    pub fn createImageVersion(self: *Self, allocator: std.mem.Allocator, input: create_image_version.CreateImageVersionInput, options: CallOptions) !create_image_version.CreateImageVersionOutput {
    ...
    pub fn createInferenceComponent(self: *Self, allocator: std.mem.Allocator, input: create_inference_component.CreateInferenceComponentInput, options: CallOptions) !create_inference_component.CreateInferenceComponentOutput {
    ...
    pub fn createInferenceExperiment(self: *Self, allocator: std.mem.Allocator, input: create_inference_experiment.CreateInferenceExperimentInput, options: CallOptions) !create_inference_experiment.CreateInferenceExperimentOutput {
    ...
    pub fn createLabelingJob(self: *Self, allocator: std.mem.Allocator, input: create_labeling_job.CreateLabelingJobInput, options: CallOptions) !create_labeling_job.CreateLabelingJobOutput {
    ...
    pub fn createMlflowApp(self: *Self, allocator: std.mem.Allocator, input: create_mlflow_app.CreateMlflowAppInput, options: CallOptions) !create_mlflow_app.CreateMlflowAppOutput {
    ...
    pub fn createMlflowTrackingServer(self: *Self, allocator: std.mem.Allocator, input: create_mlflow_tracking_server.CreateMlflowTrackingServerInput, options: CallOptions) !create_mlflow_tracking_server.CreateMlflowTrackingServerOutput {
    ...
    pub fn createModelBiasJobDefinition(self: *Self, allocator: std.mem.Allocator, input: create_model_bias_job_definition.CreateModelBiasJobDefinitionInput, options: CallOptions) !create_model_bias_job_definition.CreateModelBiasJobDefinitionOutput {
    ...
    pub fn createModelCard(self: *Self, allocator: std.mem.Allocator, input: create_model_card.CreateModelCardInput, options: CallOptions) !create_model_card.CreateModelCardOutput {
        return create_model_card.execute(self, allocator, input, options);
    }

    /// Creates an Amazon SageMaker Model Card export job.
    pub fn createModelCardExportJob(self: *Self, allocator: std.mem.Allocator, input: create_model_card_export_job.CreateModelCardExportJobInput, options: CallOptions) !create_model_card_export_job.CreateModelCardExportJobOutput {
        return create_model_card_export_job.execute(self, allocator, input, options);
    }

    /// Creates the definition for a model explainability job.
    pub fn createModelExplainabilityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: create_model_explainability_job_definition.CreateModelExplainabilityJobDefinitionInput, options: CallOptions) !create_model_explainability_job_definition.CreateModelExplainabilityJobDefinitionOutput {
    ...
    pub fn createModelPackage(self: *Self, allocator: std.mem.Allocator, input: create_model_package.CreateModelPackageInput, options: CallOptions) !create_model_package.CreateModelPackageOutput {
        return create_model_package.execute(self, allocator, input, options);
    }

    /// Creates a model group. A model group contains a group of model versions.
    pub fn createModelPackageGroup(self: *Self, allocator: std.mem.Allocator, input: create_model_package_group.CreateModelPackageGroupInput, options: CallOptions) !create_model_package_group.CreateModelPackageGroupOutput {
    ...
    /// information about model monitor, see [Amazon SageMaker AI Model
    /// Monitor](https://docs.aws.amazon.com/sagemaker/latest/dg/model-monitor.html).
    pub fn createModelQualityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: create_model_quality_job_definition.CreateModelQualityJobDefinitionInput, options: CallOptions) !create_model_quality_job_definition.CreateModelQualityJobDefinitionOutput {
    ...
    pub fn createMonitoringSchedule(self: *Self, allocator: std.mem.Allocator, input: create_monitoring_schedule.CreateMonitoringScheduleInput, options: CallOptions) !create_monitoring_schedule.CreateMonitoringScheduleOutput {
    ...
    pub fn createNotebookInstance(self: *Self, allocator: std.mem.Allocator, input: create_notebook_instance.CreateNotebookInstanceInput, options: CallOptions) !create_notebook_instance.CreateNotebookInstanceOutput {
    ...
    pub fn createNotebookInstanceLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: create_notebook_instance_lifecycle_config.CreateNotebookInstanceLifecycleConfigInput, options: CallOptions) !create_notebook_instance_lifecycle_config.CreateNotebookInstanceLifecycleConfigOutput {
    ...
    pub fn createOptimizationJob(self: *Self, allocator: std.mem.Allocator, input: create_optimization_job.CreateOptimizationJobInput, options: CallOptions) !create_optimization_job.CreateOptimizationJobOutput {
        return create_optimization_job.execute(self, allocator, input, options);
    }

    /// Creates an Amazon SageMaker Partner AI App.
    pub fn createPartnerApp(self: *Self, allocator: std.mem.Allocator, input: create_partner_app.CreatePartnerAppInput, options: CallOptions) !create_partner_app.CreatePartnerAppOutput {
        return create_partner_app.execute(self, allocator, input, options);
    }

    /// Creates a presigned URL to access an Amazon SageMaker Partner AI App.
    pub fn createPartnerAppPresignedUrl(self: *Self, allocator: std.mem.Allocator, input: create_partner_app_presigned_url.CreatePartnerAppPresignedUrlInput, options: CallOptions) !create_partner_app_presigned_url.CreatePartnerAppPresignedUrlOutput {
    ...
    pub fn createPresignedDomainUrl(self: *Self, allocator: std.mem.Allocator, input: create_presigned_domain_url.CreatePresignedDomainUrlInput, options: CallOptions) !create_presigned_domain_url.CreatePresignedDomainUrlOutput {
    ...
    pub fn createPresignedMlflowAppUrl(self: *Self, allocator: std.mem.Allocator, input: create_presigned_mlflow_app_url.CreatePresignedMlflowAppUrlInput, options: CallOptions) !create_presigned_mlflow_app_url.CreatePresignedMlflowAppUrlOutput {
    ...
    /// URL](https://docs.aws.amazon.com/sagemaker/latest/dg/mlflow-launch-ui.html).
    pub fn createPresignedMlflowTrackingServerUrl(self: *Self, allocator: std.mem.Allocator, input: create_presigned_mlflow_tracking_server_url.CreatePresignedMlflowTrackingServerUrlInput, options: CallOptions) !create_presigned_mlflow_tracking_server_url.CreatePresignedMlflowTrackingServerUrlOutput {
    ...
    pub fn createPresignedNotebookInstanceUrl(self: *Self, allocator: std.mem.Allocator, input: create_presigned_notebook_instance_url.CreatePresignedNotebookInstanceUrlInput, options: CallOptions) !create_presigned_notebook_instance_url.CreatePresignedNotebookInstanceUrlOutput {
        return create_presigned_notebook_instance_url.execute(self, allocator, input, options);
    }

    /// Creates a processing job.
    pub fn createProcessingJob(self: *Self, allocator: std.mem.Allocator, input: create_processing_job.CreateProcessingJobInput, options: CallOptions) !create_processing_job.CreateProcessingJobOutput {
    ...
    pub fn createStudioLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: create_studio_lifecycle_config.CreateStudioLifecycleConfigInput, options: CallOptions) !create_studio_lifecycle_config.CreateStudioLifecycleConfigOutput {
    ...
    /// Works](https://docs.aws.amazon.com/sagemaker/latest/dg/how-it-works.html).
    pub fn createTrainingJob(self: *Self, allocator: std.mem.Allocator, input: create_training_job.CreateTrainingJobInput, options: CallOptions) !create_training_job.CreateTrainingJobOutput {
    ...
    pub fn createTrainingPlan(self: *Self, allocator: std.mem.Allocator, input: create_training_plan.CreateTrainingPlanInput, options: CallOptions) !create_training_plan.CreateTrainingPlanOutput {
    ...
    pub fn createTransformJob(self: *Self, allocator: std.mem.Allocator, input: create_transform_job.CreateTransformJobInput, options: CallOptions) !create_transform_job.CreateTransformJobOutput {
    ...
    pub fn createTrial(self: *Self, allocator: std.mem.Allocator, input: create_trial.CreateTrialInput, options: CallOptions) !create_trial.CreateTrialOutput {
    ...
    /// [Search](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_Search.html) API to search for the tags.
    pub fn createTrialComponent(self: *Self, allocator: std.mem.Allocator, input: create_trial_component.CreateTrialComponentInput, options: CallOptions) !create_trial_component.CreateTrialComponentOutput {
    ...
    pub fn createWorkforce(self: *Self, allocator: std.mem.Allocator, input: create_workforce.CreateWorkforceInput, options: CallOptions) !create_workforce.CreateWorkforceOutput {
    ...
    pub fn createWorkteam(self: *Self, allocator: std.mem.Allocator, input: create_workteam.CreateWorkteamInput, options: CallOptions) !create_workteam.CreateWorkteamOutput {
        return create_workteam.execute(self, allocator, input, options);
    }

    /// Deletes an action.
    pub fn deleteAction(self: *Self, allocator: std.mem.Allocator, input: delete_action.DeleteActionInput, options: CallOptions) !delete_action.DeleteActionOutput {
    ...
    pub fn deleteAppImageConfig(self: *Self, allocator: std.mem.Allocator, input: delete_app_image_config.DeleteAppImageConfigInput, options: CallOptions) !delete_app_image_config.DeleteAppImageConfigOutput {
    ...
    pub fn deleteAssociation(self: *Self, allocator: std.mem.Allocator, input: delete_association.DeleteAssociationInput, options: CallOptions) !delete_association.DeleteAssociationOutput {
    ...
    pub fn deleteClusterSchedulerConfig(self: *Self, allocator: std.mem.Allocator, input: delete_cluster_scheduler_config.DeleteClusterSchedulerConfigInput, options: CallOptions) !delete_cluster_scheduler_config.DeleteClusterSchedulerConfigOutput {
        return delete_cluster_scheduler_config.execute(self, allocator, input, options);
    }

    /// Deletes the specified Git repository from your account.
    pub fn deleteCodeRepository(self: *Self, allocator: std.mem.Allocator, input: delete_code_repository.DeleteCodeRepositoryInput, options: CallOptions) !delete_code_repository.DeleteCodeRepositoryOutput {
    ...
    pub fn deleteCompilationJob(self: *Self, allocator: std.mem.Allocator, input: delete_compilation_job.DeleteCompilationJobInput, options: CallOptions) !delete_compilation_job.DeleteCompilationJobOutput {
        return delete_compilation_job.execute(self, allocator, input, options);
    }

    /// Deletes the compute allocation from the cluster.
    pub fn deleteComputeQuota(self: *Self, allocator: std.mem.Allocator, input: delete_compute_quota.DeleteComputeQuotaInput, options: CallOptions) !delete_compute_quota.DeleteComputeQuotaOutput {
        return delete_compute_quota.execute(self, allocator, input, options);
    }

    /// Deletes an context.
    pub fn deleteContext(self: *Self, allocator: std.mem.Allocator, input: delete_context.DeleteContextInput, options: CallOptions) !delete_context.DeleteContextOutput {
        return delete_context.execute(self, allocator, input, options);
    }

    /// Deletes a data quality monitoring job definition.
    pub fn deleteDataQualityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_data_quality_job_definition.DeleteDataQualityJobDefinitionInput, options: CallOptions) !delete_data_quality_job_definition.DeleteDataQualityJobDefinitionOutput {
        return delete_data_quality_job_definition.execute(self, allocator, input, options);
    }

    /// Deletes a fleet.
    pub fn deleteDeviceFleet(self: *Self, allocator: std.mem.Allocator, input: delete_device_fleet.DeleteDeviceFleetInput, options: CallOptions) !delete_device_fleet.DeleteDeviceFleetOutput {
    ...
    pub fn deleteEdgeDeploymentPlan(self: *Self, allocator: std.mem.Allocator, input: delete_edge_deployment_plan.DeleteEdgeDeploymentPlanInput, options: CallOptions) !delete_edge_deployment_plan.DeleteEdgeDeploymentPlanOutput {
    ...
    /// inactive.
    pub fn deleteEdgeDeploymentStage(self: *Self, allocator: std.mem.Allocator, input: delete_edge_deployment_stage.DeleteEdgeDeploymentStageInput, options: CallOptions) !delete_edge_deployment_stage.DeleteEdgeDeploymentStageOutput {
    ...
    pub fn deleteEndpointConfig(self: *Self, allocator: std.mem.Allocator, input: delete_endpoint_config.DeleteEndpointConfigInput, options: CallOptions) !delete_endpoint_config.DeleteEndpointConfigOutput {
    ...
    pub fn deleteFeatureGroup(self: *Self, allocator: std.mem.Allocator, input: delete_feature_group.DeleteFeatureGroupInput, options: CallOptions) !delete_feature_group.DeleteFeatureGroupOutput {
        return delete_feature_group.execute(self, allocator, input, options);
    }

    /// Deletes the specified flow definition.
    pub fn deleteFlowDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_flow_definition.DeleteFlowDefinitionInput, options: CallOptions) !delete_flow_definition.DeleteFlowDefinitionOutput {
        return delete_flow_definition.execute(self, allocator, input, options);
    }

    /// Delete a hub.
    pub fn deleteHub(self: *Self, allocator: std.mem.Allocator, input: delete_hub.DeleteHubInput, options: CallOptions) !delete_hub.DeleteHubOutput {
        return delete_hub.execute(self, allocator, input, options);
    }

    /// Delete the contents of a hub.
    pub fn deleteHubContent(self: *Self, allocator: std.mem.Allocator, input: delete_hub_content.DeleteHubContentInput, options: CallOptions) !delete_hub_content.DeleteHubContentOutput {
    ...
    /// hub.
    pub fn deleteHubContentReference(self: *Self, allocator: std.mem.Allocator, input: delete_hub_content_reference.DeleteHubContentReferenceInput, options: CallOptions) !delete_hub_content_reference.DeleteHubContentReferenceOutput {
    ...
    pub fn deleteHumanTaskUi(self: *Self, allocator: std.mem.Allocator, input: delete_human_task_ui.DeleteHumanTaskUiInput, options: CallOptions) !delete_human_task_ui.DeleteHumanTaskUiOutput {
    ...
    pub fn deleteHyperParameterTuningJob(self: *Self, allocator: std.mem.Allocator, input: delete_hyper_parameter_tuning_job.DeleteHyperParameterTuningJobInput, options: CallOptions) !delete_hyper_parameter_tuning_job.DeleteHyperParameterTuningJobOutput {
    ...
    pub fn deleteImageVersion(self: *Self, allocator: std.mem.Allocator, input: delete_image_version.DeleteImageVersionInput, options: CallOptions) !delete_image_version.DeleteImageVersionOutput {
        return delete_image_version.execute(self, allocator, input, options);
    }

    /// Deletes an inference component.
    pub fn deleteInferenceComponent(self: *Self, allocator: std.mem.Allocator, input: delete_inference_component.DeleteInferenceComponentInput, options: CallOptions) !delete_inference_component.DeleteInferenceComponentOutput {
    ...
    pub fn deleteInferenceExperiment(self: *Self, allocator: std.mem.Allocator, input: delete_inference_experiment.DeleteInferenceExperimentInput, options: CallOptions) !delete_inference_experiment.DeleteInferenceExperimentOutput {
    ...
    pub fn deleteMlflowTrackingServer(self: *Self, allocator: std.mem.Allocator, input: delete_mlflow_tracking_server.DeleteMlflowTrackingServerInput, options: CallOptions) !delete_mlflow_tracking_server.DeleteMlflowTrackingServerOutput {
    ...
    pub fn deleteModelBiasJobDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_model_bias_job_definition.DeleteModelBiasJobDefinitionInput, options: CallOptions) !delete_model_bias_job_definition.DeleteModelBiasJobDefinitionOutput {
        return delete_model_bias_job_definition.execute(self, allocator, input, options);
    }

    /// Deletes an Amazon SageMaker Model Card.
    pub fn deleteModelCard(self: *Self, allocator: std.mem.Allocator, input: delete_model_card.DeleteModelCardInput, options: CallOptions) !delete_model_card.DeleteModelCardOutput {
        return delete_model_card.execute(self, allocator, input, options);
    }

    /// Deletes an Amazon SageMaker AI model explainability job definition.
    pub fn deleteModelExplainabilityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_model_explainability_job_definition.DeleteModelExplainabilityJobDefinitionInput, options: CallOptions) !delete_model_explainability_job_definition.DeleteModelExplainabilityJobDefinitionOutput {
    ...
    pub fn deleteModelPackage(self: *Self, allocator: std.mem.Allocator, input: delete_model_package.DeleteModelPackageInput, options: CallOptions) !delete_model_package.DeleteModelPackageOutput {
        return delete_model_package.execute(self, allocator, input, options);
    }

    /// Deletes the specified model group.
    pub fn deleteModelPackageGroup(self: *Self, allocator: std.mem.Allocator, input: delete_model_package_group.DeleteModelPackageGroupInput, options: CallOptions) !delete_model_package_group.DeleteModelPackageGroupOutput {
        return delete_model_package_group.execute(self, allocator, input, options);
    }

    /// Deletes a model group resource policy.
    pub fn deleteModelPackageGroupPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_model_package_group_policy.DeleteModelPackageGroupPolicyInput, options: CallOptions) !delete_model_package_group_policy.DeleteModelPackageGroupPolicyOutput {
        return delete_model_package_group_policy.execute(self, allocator, input, options);
    }

    /// Deletes the secified model quality monitoring job definition.
    pub fn deleteModelQualityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_model_quality_job_definition.DeleteModelQualityJobDefinitionInput, options: CallOptions) !delete_model_quality_job_definition.DeleteModelQualityJobDefinitionOutput {
    ...
    /// schedule.
    pub fn deleteMonitoringSchedule(self: *Self, allocator: std.mem.Allocator, input: delete_monitoring_schedule.DeleteMonitoringScheduleInput, options: CallOptions) !delete_monitoring_schedule.DeleteMonitoringScheduleOutput {
    ...
    pub fn deleteNotebookInstance(self: *Self, allocator: std.mem.Allocator, input: delete_notebook_instance.DeleteNotebookInstanceInput, options: CallOptions) !delete_notebook_instance.DeleteNotebookInstanceOutput {
        return delete_notebook_instance.execute(self, allocator, input, options);
    }

    /// Deletes a notebook instance lifecycle configuration.
    pub fn deleteNotebookInstanceLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: delete_notebook_instance_lifecycle_config.DeleteNotebookInstanceLifecycleConfigInput, options: CallOptions) !delete_notebook_instance_lifecycle_config.DeleteNotebookInstanceLifecycleConfigOutput {
        return delete_notebook_instance_lifecycle_config.execute(self, allocator, input, options);
    }

    /// Deletes an optimization job.
    pub fn deleteOptimizationJob(self: *Self, allocator: std.mem.Allocator, input: delete_optimization_job.DeleteOptimizationJobInput, options: CallOptions) !delete_optimization_job.DeleteOptimizationJobOutput {
        return delete_optimization_job.execute(self, allocator, input, options);
    }

    /// Deletes a SageMaker Partner AI App.
    pub fn deletePartnerApp(self: *Self, allocator: std.mem.Allocator, input: delete_partner_app.DeletePartnerAppInput, options: CallOptions) !delete_partner_app.DeletePartnerAppOutput {
    ...
    pub fn deleteProcessingJob(self: *Self, allocator: std.mem.Allocator, input: delete_processing_job.DeleteProcessingJobInput, options: CallOptions) !delete_processing_job.DeleteProcessingJobOutput {
    ...
    pub fn deleteStudioLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: delete_studio_lifecycle_config.DeleteStudioLifecycleConfigInput, options: CallOptions) !delete_studio_lifecycle_config.DeleteStudioLifecycleConfigOutput {
    ...
    pub fn deleteTrainingJob(self: *Self, allocator: std.mem.Allocator, input: delete_training_job.DeleteTrainingJobInput, options: CallOptions) !delete_training_job.DeleteTrainingJobOutput {
    ...
    pub fn deleteTrial(self: *Self, allocator: std.mem.Allocator, input: delete_trial.DeleteTrialInput, options: CallOptions) !delete_trial.DeleteTrialOutput {
    ...
    /// [DisassociateTrialComponent](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_DisassociateTrialComponent.html) API.
    pub fn deleteTrialComponent(self: *Self, allocator: std.mem.Allocator, input: delete_trial_component.DeleteTrialComponentInput, options: CallOptions) !delete_trial_component.DeleteTrialComponentOutput {
    ...
    pub fn deleteUserProfile(self: *Self, allocator: std.mem.Allocator, input: delete_user_profile.DeleteUserProfileInput, options: CallOptions) !delete_user_profile.DeleteUserProfileOutput {
    ...
    pub fn deleteWorkforce(self: *Self, allocator: std.mem.Allocator, input: delete_workforce.DeleteWorkforceInput, options: CallOptions) !delete_workforce.DeleteWorkforceOutput {
        return delete_workforce.execute(self, allocator, input, options);
    }

    /// Deletes an existing work team. This operation can't be undone.
    pub fn deleteWorkteam(self: *Self, allocator: std.mem.Allocator, input: delete_workteam.DeleteWorkteamInput, options: CallOptions) !delete_workteam.DeleteWorkteamOutput {
    ...
    pub fn deregisterDevices(self: *Self, allocator: std.mem.Allocator, input: deregister_devices.DeregisterDevicesInput, options: CallOptions) !deregister_devices.DeregisterDevicesOutput {
    ...
    pub fn describeAppImageConfig(self: *Self, allocator: std.mem.Allocator, input: describe_app_image_config.DescribeAppImageConfigInput, options: CallOptions) !describe_app_image_config.DescribeAppImageConfigOutput {
        return describe_app_image_config.execute(self, allocator, input, options);
    }

    /// Describes an artifact.
    pub fn describeArtifact(self: *Self, allocator: std.mem.Allocator, input: describe_artifact.DescribeArtifactInput, options: CallOptions) !describe_artifact.DescribeArtifactOutput {
    ...
    pub fn describeAutoMlJob(self: *Self, allocator: std.mem.Allocator, input: describe_auto_ml_job.DescribeAutoMLJobInput, options: CallOptions) !describe_auto_ml_job.DescribeAutoMLJobOutput {
    ...
    pub fn describeAutoMlJobV2(self: *Self, allocator: std.mem.Allocator, input: describe_auto_ml_job_v2.DescribeAutoMLJobV2Input, options: CallOptions) !describe_auto_ml_job_v2.DescribeAutoMLJobV2Output {
    ...
    pub fn describeClusterEvent(self: *Self, allocator: std.mem.Allocator, input: describe_cluster_event.DescribeClusterEventInput, options: CallOptions) !describe_cluster_event.DescribeClusterEventOutput {
    ...
    pub fn describeClusterNode(self: *Self, allocator: std.mem.Allocator, input: describe_cluster_node.DescribeClusterNodeInput, options: CallOptions) !describe_cluster_node.DescribeClusterNodeOutput {
    ...
    pub fn describeClusterSchedulerConfig(self: *Self, allocator: std.mem.Allocator, input: describe_cluster_scheduler_config.DescribeClusterSchedulerConfigInput, options: CallOptions) !describe_cluster_scheduler_config.DescribeClusterSchedulerConfigOutput {
        return describe_cluster_scheduler_config.execute(self, allocator, input, options);
    }

    /// Gets details about the specified Git repository.
    pub fn describeCodeRepository(self: *Self, allocator: std.mem.Allocator, input: describe_code_repository.DescribeCodeRepositoryInput, options: CallOptions) !describe_code_repository.DescribeCodeRepositoryOutput {
    ...
    pub fn describeCompilationJob(self: *Self, allocator: std.mem.Allocator, input: describe_compilation_job.DescribeCompilationJobInput, options: CallOptions) !describe_compilation_job.DescribeCompilationJobOutput {
        return describe_compilation_job.execute(self, allocator, input, options);
    }

    /// Description of the compute allocation definition.
    pub fn describeComputeQuota(self: *Self, allocator: std.mem.Allocator, input: describe_compute_quota.DescribeComputeQuotaInput, options: CallOptions) !describe_compute_quota.DescribeComputeQuotaOutput {
        return describe_compute_quota.execute(self, allocator, input, options);
    }

    /// Describes a context.
    pub fn describeContext(self: *Self, allocator: std.mem.Allocator, input: describe_context.DescribeContextInput, options: CallOptions) !describe_context.DescribeContextOutput {
        return describe_context.execute(self, allocator, input, options);
    }

    /// Gets the details of a data quality monitoring job definition.
    pub fn describeDataQualityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_data_quality_job_definition.DescribeDataQualityJobDefinitionInput, options: CallOptions) !describe_data_quality_job_definition.DescribeDataQualityJobDefinitionOutput {
    ...
    pub fn describeDeviceFleet(self: *Self, allocator: std.mem.Allocator, input: describe_device_fleet.DescribeDeviceFleetInput, options: CallOptions) !describe_device_fleet.DescribeDeviceFleetOutput {
    ...
    pub fn describeEdgeDeploymentPlan(self: *Self, allocator: std.mem.Allocator, input: describe_edge_deployment_plan.DescribeEdgeDeploymentPlanInput, options: CallOptions) !describe_edge_deployment_plan.DescribeEdgeDeploymentPlanOutput {
        return describe_edge_deployment_plan.execute(self, allocator, input, options);
    }

    /// A description of edge packaging jobs.
    pub fn describeEdgePackagingJob(self: *Self, allocator: std.mem.Allocator, input: describe_edge_packaging_job.DescribeEdgePackagingJobInput, options: CallOptions) !describe_edge_packaging_job.DescribeEdgePackagingJobOutput {
    ...
    pub fn describeEndpointConfig(self: *Self, allocator: std.mem.Allocator, input: describe_endpoint_config.DescribeEndpointConfigInput, options: CallOptions) !describe_endpoint_config.DescribeEndpointConfigOutput {
        return describe_endpoint_config.execute(self, allocator, input, options);
    }

    /// Provides a list of an experiment's properties.
    pub fn describeExperiment(self: *Self, allocator: std.mem.Allocator, input: describe_experiment.DescribeExperimentInput, options: CallOptions) !describe_experiment.DescribeExperimentOutput {
    ...
    pub fn describeFeatureGroup(self: *Self, allocator: std.mem.Allocator, input: describe_feature_group.DescribeFeatureGroupInput, options: CallOptions) !describe_feature_group.DescribeFeatureGroupOutput {
        return describe_feature_group.execute(self, allocator, input, options);
    }

    /// Shows the metadata for a feature within a feature group.
    pub fn describeFeatureMetadata(self: *Self, allocator: std.mem.Allocator, input: describe_feature_metadata.DescribeFeatureMetadataInput, options: CallOptions) !describe_feature_metadata.DescribeFeatureMetadataOutput {
        return describe_feature_metadata.execute(self, allocator, input, options);
    }

    /// Returns information about the specified flow definition.
    pub fn describeFlowDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_flow_definition.DescribeFlowDefinitionInput, options: CallOptions) !describe_flow_definition.DescribeFlowDefinitionOutput {
    ...
    pub fn describeHubContent(self: *Self, allocator: std.mem.Allocator, input: describe_hub_content.DescribeHubContentInput, options: CallOptions) !describe_hub_content.DescribeHubContentOutput {
    ...
    /// task template).
    pub fn describeHumanTaskUi(self: *Self, allocator: std.mem.Allocator, input: describe_human_task_ui.DescribeHumanTaskUiInput, options: CallOptions) !describe_human_task_ui.DescribeHumanTaskUiOutput {
    ...
    pub fn describeHyperParameterTuningJob(self: *Self, allocator: std.mem.Allocator, input: describe_hyper_parameter_tuning_job.DescribeHyperParameterTuningJobInput, options: CallOptions) !describe_hyper_parameter_tuning_job.DescribeHyperParameterTuningJobOutput {
        return describe_hyper_parameter_tuning_job.execute(self, allocator, input, options);
    }

    /// Describes a SageMaker AI image.
    pub fn describeImage(self: *Self, allocator: std.mem.Allocator, input: describe_image.DescribeImageInput, options: CallOptions) !describe_image.DescribeImageOutput {
        return describe_image.execute(self, allocator, input, options);
    }

    /// Describes a version of a SageMaker AI image.
    pub fn describeImageVersion(self: *Self, allocator: std.mem.Allocator, input: describe_image_version.DescribeImageVersionInput, options: CallOptions) !describe_image_version.DescribeImageVersionOutput {
        return describe_image_version.execute(self, allocator, input, options);
    }

    /// Returns information about an inference component.
    pub fn describeInferenceComponent(self: *Self, allocator: std.mem.Allocator, input: describe_inference_component.DescribeInferenceComponentInput, options: CallOptions) !describe_inference_component.DescribeInferenceComponentOutput {
        return describe_inference_component.execute(self, allocator, input, options);
    }

    /// Returns details about an inference experiment.
    pub fn describeInferenceExperiment(self: *Self, allocator: std.mem.Allocator, input: describe_inference_experiment.DescribeInferenceExperimentInput, options: CallOptions) !describe_inference_experiment.DescribeInferenceExperimentOutput {
    ...
    pub fn describeInferenceRecommendationsJob(self: *Self, allocator: std.mem.Allocator, input: describe_inference_recommendations_job.DescribeInferenceRecommendationsJobInput, options: CallOptions) !describe_inference_recommendations_job.DescribeInferenceRecommendationsJobOutput {
    ...
    pub fn describeLineageGroup(self: *Self, allocator: std.mem.Allocator, input: describe_lineage_group.DescribeLineageGroupInput, options: CallOptions) !describe_lineage_group.DescribeLineageGroupOutput {
        return describe_lineage_group.execute(self, allocator, input, options);
    }

    /// Returns information about an MLflow App.
    pub fn describeMlflowApp(self: *Self, allocator: std.mem.Allocator, input: describe_mlflow_app.DescribeMlflowAppInput, options: CallOptions) !describe_mlflow_app.DescribeMlflowAppOutput {
        return describe_mlflow_app.execute(self, allocator, input, options);
    }

    /// Returns information about an MLflow Tracking Server.
    pub fn describeMlflowTrackingServer(self: *Self, allocator: std.mem.Allocator, input: describe_mlflow_tracking_server.DescribeMlflowTrackingServerInput, options: CallOptions) !describe_mlflow_tracking_server.DescribeMlflowTrackingServerOutput {
    ...
    pub fn describeModelBiasJobDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_model_bias_job_definition.DescribeModelBiasJobDefinitionInput, options: CallOptions) !describe_model_bias_job_definition.DescribeModelBiasJobDefinitionOutput {
    ...
    pub fn describeModelCardExportJob(self: *Self, allocator: std.mem.Allocator, input: describe_model_card_export_job.DescribeModelCardExportJobInput, options: CallOptions) !describe_model_card_export_job.DescribeModelCardExportJobOutput {
        return describe_model_card_export_job.execute(self, allocator, input, options);
    }

    /// Returns a description of a model explainability job definition.
    pub fn describeModelExplainabilityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_model_explainability_job_definition.DescribeModelExplainabilityJobDefinitionInput, options: CallOptions) !describe_model_explainability_job_definition.DescribeModelExplainabilityJobDefinitionOutput {
    ...
    pub fn describeModelPackage(self: *Self, allocator: std.mem.Allocator, input: describe_model_package.DescribeModelPackageInput, options: CallOptions) !describe_model_package.DescribeModelPackageOutput {
        return describe_model_package.execute(self, allocator, input, options);
    }

    /// Gets a description for the specified model group.
    pub fn describeModelPackageGroup(self: *Self, allocator: std.mem.Allocator, input: describe_model_package_group.DescribeModelPackageGroupInput, options: CallOptions) !describe_model_package_group.DescribeModelPackageGroupOutput {
        return describe_model_package_group.execute(self, allocator, input, options);
    }

    /// Returns a description of a model quality job definition.
    pub fn describeModelQualityJobDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_model_quality_job_definition.DescribeModelQualityJobDefinitionInput, options: CallOptions) !describe_model_quality_job_definition.DescribeModelQualityJobDefinitionOutput {
        return describe_model_quality_job_definition.execute(self, allocator, input, options);
    }

    /// Describes the schedule for a monitoring job.
    pub fn describeMonitoringSchedule(self: *Self, allocator: std.mem.Allocator, input: describe_monitoring_schedule.DescribeMonitoringScheduleInput, options: CallOptions) !describe_monitoring_schedule.DescribeMonitoringScheduleOutput {
        return describe_monitoring_schedule.execute(self, allocator, input, options);
    }

    /// Returns information about a notebook instance.
    pub fn describeNotebookInstance(self: *Self, allocator: std.mem.Allocator, input: describe_notebook_instance.DescribeNotebookInstanceInput, options: CallOptions) !describe_notebook_instance.DescribeNotebookInstanceOutput {
    ...
    /// 2.1: (Optional) Customize a Notebook
    /// Instance](https://docs.aws.amazon.com/sagemaker/latest/dg/notebook-lifecycle-config.html).
    pub fn describeNotebookInstanceLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: describe_notebook_instance_lifecycle_config.DescribeNotebookInstanceLifecycleConfigInput, options: CallOptions) !describe_notebook_instance_lifecycle_config.DescribeNotebookInstanceLifecycleConfigOutput {
        return describe_notebook_instance_lifecycle_config.execute(self, allocator, input, options);
    }

    /// Provides the properties of the specified optimization job.
    pub fn describeOptimizationJob(self: *Self, allocator: std.mem.Allocator, input: describe_optimization_job.DescribeOptimizationJobInput, options: CallOptions) !describe_optimization_job.DescribeOptimizationJobOutput {
        return describe_optimization_job.execute(self, allocator, input, options);
    }

    /// Gets information about a SageMaker Partner AI App.
    pub fn describePartnerApp(self: *Self, allocator: std.mem.Allocator, input: describe_partner_app.DescribePartnerAppInput, options: CallOptions) !describe_partner_app.DescribePartnerAppOutput {
    ...
    pub fn describePipelineDefinitionForExecution(self: *Self, allocator: std.mem.Allocator, input: describe_pipeline_definition_for_execution.DescribePipelineDefinitionForExecutionInput, options: CallOptions) !describe_pipeline_definition_for_execution.DescribePipelineDefinitionForExecutionOutput {
    ...
    pub fn describeProcessingJob(self: *Self, allocator: std.mem.Allocator, input: describe_processing_job.DescribeProcessingJobInput, options: CallOptions) !describe_processing_job.DescribeProcessingJobOutput {
    ...
    pub fn describeReservedCapacity(self: *Self, allocator: std.mem.Allocator, input: describe_reserved_capacity.DescribeReservedCapacityInput, options: CallOptions) !describe_reserved_capacity.DescribeReservedCapacityOutput {
    ...
    pub fn describeStudioLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: describe_studio_lifecycle_config.DescribeStudioLifecycleConfigInput, options: CallOptions) !describe_studio_lifecycle_config.DescribeStudioLifecycleConfigOutput {
    ...
    pub fn describeSubscribedWorkteam(self: *Self, allocator: std.mem.Allocator, input: describe_subscribed_workteam.DescribeSubscribedWorkteamInput, options: CallOptions) !describe_subscribed_workteam.DescribeSubscribedWorkteamOutput {
    ...
    pub fn describeTrainingJob(self: *Self, allocator: std.mem.Allocator, input: describe_training_job.DescribeTrainingJobInput, options: CallOptions) !describe_training_job.DescribeTrainingJobOutput {
        return describe_training_job.execute(self, allocator, input, options);
    }

    /// Retrieves detailed information about a specific training plan.
    pub fn describeTrainingPlan(self: *Self, allocator: std.mem.Allocator, input: describe_training_plan.DescribeTrainingPlanInput, options: CallOptions) !describe_training_plan.DescribeTrainingPlanOutput {
    ...
    pub fn describeTrial(self: *Self, allocator: std.mem.Allocator, input: describe_trial.DescribeTrialInput, options: CallOptions) !describe_trial.DescribeTrialOutput {
        return describe_trial.execute(self, allocator, input, options);
    }

    /// Provides a list of a trials component's properties.
    pub fn describeTrialComponent(self: *Self, allocator: std.mem.Allocator, input: describe_trial_component.DescribeTrialComponentInput, options: CallOptions) !describe_trial_component.DescribeTrialComponentOutput {
        return describe_trial_component.execute(self, allocator, input, options);
    }

    /// Describes a user profile. For more information, see `CreateUserProfile`.
    pub fn describeUserProfile(self: *Self, allocator: std.mem.Allocator, input: describe_user_profile.DescribeUserProfileInput, options: CallOptions) !describe_user_profile.DescribeUserProfileOutput {
    ...
    pub fn describeWorkforce(self: *Self, allocator: std.mem.Allocator, input: describe_workforce.DescribeWorkforceInput, options: CallOptions) !describe_workforce.DescribeWorkforceOutput {
    ...
    pub fn describeWorkteam(self: *Self, allocator: std.mem.Allocator, input: describe_workteam.DescribeWorkteamInput, options: CallOptions) !describe_workteam.DescribeWorkteamOutput {
    ...
    /// Storage Interface (CSI) driver to manage the lifecycle of persistent storage
    /// in your HyperPod EKS clusters.
    pub fn detachClusterNodeVolume(self: *Self, allocator: std.mem.Allocator, input: detach_cluster_node_volume.DetachClusterNodeVolumeInput, options: CallOptions) !detach_cluster_node_volume.DetachClusterNodeVolumeOutput {
    ...
    pub fn disableSagemakerServicecatalogPortfolio(self: *Self, allocator: std.mem.Allocator, input: disable_sagemaker_servicecatalog_portfolio.DisableSagemakerServicecatalogPortfolioInput, options: CallOptions) !disable_sagemaker_servicecatalog_portfolio.DisableSagemakerServicecatalogPortfolioOutput {
    ...
    pub fn disassociateTrialComponent(self: *Self, allocator: std.mem.Allocator, input: disassociate_trial_component.DisassociateTrialComponentInput, options: CallOptions) !disassociate_trial_component.DisassociateTrialComponentOutput {
    ...
    /// create SageMaker projects.
    pub fn enableSagemakerServicecatalogPortfolio(self: *Self, allocator: std.mem.Allocator, input: enable_sagemaker_servicecatalog_portfolio.EnableSagemakerServicecatalogPortfolioInput, options: CallOptions) !enable_sagemaker_servicecatalog_portfolio.EnableSagemakerServicecatalogPortfolioOutput {
    ...
    pub fn getLineageGroupPolicy(self: *Self, allocator: std.mem.Allocator, input: get_lineage_group_policy.GetLineageGroupPolicyInput, options: CallOptions) !get_lineage_group_policy.GetLineageGroupPolicyOutput {
    ...
    pub fn getModelPackageGroupPolicy(self: *Self, allocator: std.mem.Allocator, input: get_model_package_group_policy.GetModelPackageGroupPolicyInput, options: CallOptions) !get_model_package_group_policy.GetModelPackageGroupPolicyOutput {
    ...
    /// create SageMaker projects.
    pub fn getSagemakerServicecatalogPortfolioStatus(self: *Self, allocator: std.mem.Allocator, input: get_sagemaker_servicecatalog_portfolio_status.GetSagemakerServicecatalogPortfolioStatusInput, options: CallOptions) !get_sagemaker_servicecatalog_portfolio_status.GetSagemakerServicecatalogPortfolioStatusOutput {
    ...
    pub fn getScalingConfigurationRecommendation(self: *Self, allocator: std.mem.Allocator, input: get_scaling_configuration_recommendation.GetScalingConfigurationRecommendationInput, options: CallOptions) !get_scaling_configuration_recommendation.GetScalingConfigurationRecommendationOutput {
    ...
    /// `Metrics`.
    pub fn getSearchSuggestions(self: *Self, allocator: std.mem.Allocator, input: get_search_suggestions.GetSearchSuggestionsInput, options: CallOptions) !get_search_suggestions.GetSearchSuggestionsOutput {
        return get_search_suggestions.execute(self, allocator, input, options);
    }

    /// Import hub content.
    pub fn importHubContent(self: *Self, allocator: std.mem.Allocator, input: import_hub_content.ImportHubContentInput, options: CallOptions) !import_hub_content.ImportHubContentOutput {
    ...
    pub fn listAlgorithms(self: *Self, allocator: std.mem.Allocator, input: list_algorithms.ListAlgorithmsInput, options: CallOptions) !list_algorithms.ListAlgorithmsOutput {
    ...
    pub fn listAppImageConfigs(self: *Self, allocator: std.mem.Allocator, input: list_app_image_configs.ListAppImageConfigsInput, options: CallOptions) !list_app_image_configs.ListAppImageConfigsOutput {
    ...
    pub fn listAutoMlJobs(self: *Self, allocator: std.mem.Allocator, input: list_auto_ml_jobs.ListAutoMLJobsInput, options: CallOptions) !list_auto_ml_jobs.ListAutoMLJobsOutput {
        return list_auto_ml_jobs.execute(self, allocator, input, options);
    }

    /// List the candidates created for the job.
    pub fn listCandidatesForAutoMlJob(self: *Self, allocator: std.mem.Allocator, input: list_candidates_for_auto_ml_job.ListCandidatesForAutoMLJobInput, options: CallOptions) !list_candidates_for_auto_ml_job.ListCandidatesForAutoMLJobOutput {
    ...
    /// `Continuous`.
    pub fn listClusterEvents(self: *Self, allocator: std.mem.Allocator, input: list_cluster_events.ListClusterEventsInput, options: CallOptions) !list_cluster_events.ListClusterEventsOutput {
    ...
    pub fn listClusterNodes(self: *Self, allocator: std.mem.Allocator, input: list_cluster_nodes.ListClusterNodesInput, options: CallOptions) !list_cluster_nodes.ListClusterNodesOutput {
        return list_cluster_nodes.execute(self, allocator, input, options);
    }

    /// List the cluster policy configurations.
    pub fn listClusterSchedulerConfigs(self: *Self, allocator: std.mem.Allocator, input: list_cluster_scheduler_configs.ListClusterSchedulerConfigsInput, options: CallOptions) !list_cluster_scheduler_configs.ListClusterSchedulerConfigsOutput {
    ...
    pub fn listCodeRepositories(self: *Self, allocator: std.mem.Allocator, input: list_code_repositories.ListCodeRepositoriesInput, options: CallOptions) !list_code_repositories.ListCodeRepositoriesOutput {
    ...
    pub fn listCompilationJobs(self: *Self, allocator: std.mem.Allocator, input: list_compilation_jobs.ListCompilationJobsInput, options: CallOptions) !list_compilation_jobs.ListCompilationJobsOutput {
        return list_compilation_jobs.execute(self, allocator, input, options);
    }

    /// List the resource allocation definitions.
    pub fn listComputeQuotas(self: *Self, allocator: std.mem.Allocator, input: list_compute_quotas.ListComputeQuotasInput, options: CallOptions) !list_compute_quotas.ListComputeQuotasOutput {
        return list_compute_quotas.execute(self, allocator, input, options);
    }

    /// Lists the contexts in your account and their properties.
    pub fn listContexts(self: *Self, allocator: std.mem.Allocator, input: list_contexts.ListContextsInput, options: CallOptions) !list_contexts.ListContextsOutput {
        return list_contexts.execute(self, allocator, input, options);
    }

    /// Lists the data quality job definitions in your account.
    pub fn listDataQualityJobDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_data_quality_job_definitions.ListDataQualityJobDefinitionsInput, options: CallOptions) !list_data_quality_job_definitions.ListDataQualityJobDefinitionsOutput {
        return list_data_quality_job_definitions.execute(self, allocator, input, options);
    }

    /// Returns a list of devices in the fleet.
    pub fn listDeviceFleets(self: *Self, allocator: std.mem.Allocator, input: list_device_fleets.ListDeviceFleetsInput, options: CallOptions) !list_device_fleets.ListDeviceFleetsOutput {
    ...
    pub fn listEdgeDeploymentPlans(self: *Self, allocator: std.mem.Allocator, input: list_edge_deployment_plans.ListEdgeDeploymentPlansInput, options: CallOptions) !list_edge_deployment_plans.ListEdgeDeploymentPlansOutput {
        return list_edge_deployment_plans.execute(self, allocator, input, options);
    }

    /// Returns a list of edge packaging jobs.
    pub fn listEdgePackagingJobs(self: *Self, allocator: std.mem.Allocator, input: list_edge_packaging_jobs.ListEdgePackagingJobsInput, options: CallOptions) !list_edge_packaging_jobs.ListEdgePackagingJobsOutput {
        return list_edge_packaging_jobs.execute(self, allocator, input, options);
    }

    /// Lists endpoint configurations.
    pub fn listEndpointConfigs(self: *Self, allocator: std.mem.Allocator, input: list_endpoint_configs.ListEndpointConfigsInput, options: CallOptions) !list_endpoint_configs.ListEndpointConfigsOutput {
    ...
    pub fn listFeatureGroups(self: *Self, allocator: std.mem.Allocator, input: list_feature_groups.ListFeatureGroupsInput, options: CallOptions) !list_feature_groups.ListFeatureGroupsOutput {
        return list_feature_groups.execute(self, allocator, input, options);
    }

    /// Returns information about the flow definitions in your account.
    pub fn listFlowDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_flow_definitions.ListFlowDefinitionsInput, options: CallOptions) !list_flow_definitions.ListFlowDefinitionsOutput {
        return list_flow_definitions.execute(self, allocator, input, options);
    }

    /// List hub content versions.
    pub fn listHubContentVersions(self: *Self, allocator: std.mem.Allocator, input: list_hub_content_versions.ListHubContentVersionsInput, options: CallOptions) !list_hub_content_versions.ListHubContentVersionsOutput {
        return list_hub_content_versions.execute(self, allocator, input, options);
    }

    /// List the contents of a hub.
    pub fn listHubContents(self: *Self, allocator: std.mem.Allocator, input: list_hub_contents.ListHubContentsInput, options: CallOptions) !list_hub_contents.ListHubContentsOutput {
        return list_hub_contents.execute(self, allocator, input, options);
    }

    /// List all existing hubs.
    pub fn listHubs(self: *Self, allocator: std.mem.Allocator, input: list_hubs.ListHubsInput, options: CallOptions) !list_hubs.ListHubsOutput {
        return list_hubs.execute(self, allocator, input, options);
    }

    /// Returns information about the human task user interfaces in your account.
    pub fn listHumanTaskUis(self: *Self, allocator: std.mem.Allocator, input: list_human_task_uis.ListHumanTaskUisInput, options: CallOptions) !list_human_task_uis.ListHumanTaskUisOutput {
    ...
    pub fn listHyperParameterTuningJobs(self: *Self, allocator: std.mem.Allocator, input: list_hyper_parameter_tuning_jobs.ListHyperParameterTuningJobsInput, options: CallOptions) !list_hyper_parameter_tuning_jobs.ListHyperParameterTuningJobsOutput {
    ...
    pub fn listImageVersions(self: *Self, allocator: std.mem.Allocator, input: list_image_versions.ListImageVersionsInput, options: CallOptions) !list_image_versions.ListImageVersionsOutput {
    ...
    pub fn listInferenceComponents(self: *Self, allocator: std.mem.Allocator, input: list_inference_components.ListInferenceComponentsInput, options: CallOptions) !list_inference_components.ListInferenceComponentsOutput {
        return list_inference_components.execute(self, allocator, input, options);
    }

    /// Returns the list of all inference experiments.
    pub fn listInferenceExperiments(self: *Self, allocator: std.mem.Allocator, input: list_inference_experiments.ListInferenceExperimentsInput, options: CallOptions) !list_inference_experiments.ListInferenceExperimentsOutput {
    ...
    pub fn listInferenceRecommendationsJobSteps(self: *Self, allocator: std.mem.Allocator, input: list_inference_recommendations_job_steps.ListInferenceRecommendationsJobStepsInput, options: CallOptions) !list_inference_recommendations_job_steps.ListInferenceRecommendationsJobStepsOutput {
        return list_inference_recommendations_job_steps.execute(self, allocator, input, options);
    }

    /// Lists recommendation jobs that satisfy various filters.
    pub fn listInferenceRecommendationsJobs(self: *Self, allocator: std.mem.Allocator, input: list_inference_recommendations_jobs.ListInferenceRecommendationsJobsInput, options: CallOptions) !list_inference_recommendations_jobs.ListInferenceRecommendationsJobsOutput {
    ...
    pub fn listLabelingJobsForWorkteam(self: *Self, allocator: std.mem.Allocator, input: list_labeling_jobs_for_workteam.ListLabelingJobsForWorkteamInput, options: CallOptions) !list_labeling_jobs_for_workteam.ListLabelingJobsForWorkteamOutput {
    ...
    /// ](https://docs.aws.amazon.com/sagemaker/latest/dg/xaccount-lineage-tracking.html) in the *Amazon SageMaker Developer Guide*.
    pub fn listLineageGroups(self: *Self, allocator: std.mem.Allocator, input: list_lineage_groups.ListLineageGroupsInput, options: CallOptions) !list_lineage_groups.ListLineageGroupsOutput {
        return list_lineage_groups.execute(self, allocator, input, options);
    }

    /// Lists all MLflow Apps
    pub fn listMlflowApps(self: *Self, allocator: std.mem.Allocator, input: list_mlflow_apps.ListMlflowAppsInput, options: CallOptions) !list_mlflow_apps.ListMlflowAppsOutput {
        return list_mlflow_apps.execute(self, allocator, input, options);
    }

    /// Lists all MLflow Tracking Servers.
    pub fn listMlflowTrackingServers(self: *Self, allocator: std.mem.Allocator, input: list_mlflow_tracking_servers.ListMlflowTrackingServersInput, options: CallOptions) !list_mlflow_tracking_servers.ListMlflowTrackingServersOutput {
        return list_mlflow_tracking_servers.execute(self, allocator, input, options);
    }

    /// Lists model bias jobs definitions that satisfy various filters.
    pub fn listModelBiasJobDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_model_bias_job_definitions.ListModelBiasJobDefinitionsInput, options: CallOptions) !list_model_bias_job_definitions.ListModelBiasJobDefinitionsOutput {
        return list_model_bias_job_definitions.execute(self, allocator, input, options);
    }

    /// List the export jobs for the Amazon SageMaker Model Card.
    pub fn listModelCardExportJobs(self: *Self, allocator: std.mem.Allocator, input: list_model_card_export_jobs.ListModelCardExportJobsInput, options: CallOptions) !list_model_card_export_jobs.ListModelCardExportJobsOutput {
        return list_model_card_export_jobs.execute(self, allocator, input, options);
    }

    /// List existing versions of an Amazon SageMaker Model Card.
    pub fn listModelCardVersions(self: *Self, allocator: std.mem.Allocator, input: list_model_card_versions.ListModelCardVersionsInput, options: CallOptions) !list_model_card_versions.ListModelCardVersionsOutput {
        return list_model_card_versions.execute(self, allocator, input, options);
    }

    /// List existing model cards.
    pub fn listModelCards(self: *Self, allocator: std.mem.Allocator, input: list_model_cards.ListModelCardsInput, options: CallOptions) !list_model_cards.ListModelCardsOutput {
        return list_model_cards.execute(self, allocator, input, options);
    }

    /// Lists model explainability job definitions that satisfy various filters.
    pub fn listModelExplainabilityJobDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_model_explainability_job_definitions.ListModelExplainabilityJobDefinitionsInput, options: CallOptions) !list_model_explainability_job_definitions.ListModelExplainabilityJobDefinitionsOutput {
    ...
    pub fn listModelMetadata(self: *Self, allocator: std.mem.Allocator, input: list_model_metadata.ListModelMetadataInput, options: CallOptions) !list_model_metadata.ListModelMetadataOutput {
        return list_model_metadata.execute(self, allocator, input, options);
    }

    /// Gets a list of the model groups in your Amazon Web Services account.
    pub fn listModelPackageGroups(self: *Self, allocator: std.mem.Allocator, input: list_model_package_groups.ListModelPackageGroupsInput, options: CallOptions) !list_model_package_groups.ListModelPackageGroupsOutput {
        return list_model_package_groups.execute(self, allocator, input, options);
    }

    /// Lists the model packages that have been created.
    pub fn listModelPackages(self: *Self, allocator: std.mem.Allocator, input: list_model_packages.ListModelPackagesInput, options: CallOptions) !list_model_packages.ListModelPackagesOutput {
        return list_model_packages.execute(self, allocator, input, options);
    }

    /// Gets a list of model quality monitoring job definitions in your account.
    pub fn listModelQualityJobDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_model_quality_job_definitions.ListModelQualityJobDefinitionsInput, options: CallOptions) !list_model_quality_job_definitions.ListModelQualityJobDefinitionsOutput {
    ...
    pub fn listMonitoringAlertHistory(self: *Self, allocator: std.mem.Allocator, input: list_monitoring_alert_history.ListMonitoringAlertHistoryInput, options: CallOptions) !list_monitoring_alert_history.ListMonitoringAlertHistoryOutput {
        return list_monitoring_alert_history.execute(self, allocator, input, options);
    }

    /// Gets the alerts for a single monitoring schedule.
    pub fn listMonitoringAlerts(self: *Self, allocator: std.mem.Allocator, input: list_monitoring_alerts.ListMonitoringAlertsInput, options: CallOptions) !list_monitoring_alerts.ListMonitoringAlertsOutput {
        return list_monitoring_alerts.execute(self, allocator, input, options);
    }

    /// Returns list of all monitoring job executions.
    pub fn listMonitoringExecutions(self: *Self, allocator: std.mem.Allocator, input: list_monitoring_executions.ListMonitoringExecutionsInput, options: CallOptions) !list_monitoring_executions.ListMonitoringExecutionsOutput {
        return list_monitoring_executions.execute(self, allocator, input, options);
    }

    /// Returns list of all monitoring schedules.
    pub fn listMonitoringSchedules(self: *Self, allocator: std.mem.Allocator, input: list_monitoring_schedules.ListMonitoringSchedulesInput, options: CallOptions) !list_monitoring_schedules.ListMonitoringSchedulesOutput {
    ...
    pub fn listNotebookInstanceLifecycleConfigs(self: *Self, allocator: std.mem.Allocator, input: list_notebook_instance_lifecycle_configs.ListNotebookInstanceLifecycleConfigsInput, options: CallOptions) !list_notebook_instance_lifecycle_configs.ListNotebookInstanceLifecycleConfigsOutput {
    ...
    pub fn listNotebookInstances(self: *Self, allocator: std.mem.Allocator, input: list_notebook_instances.ListNotebookInstancesInput, options: CallOptions) !list_notebook_instances.ListNotebookInstancesOutput {
        return list_notebook_instances.execute(self, allocator, input, options);
    }

    /// Lists the optimization jobs in your account and their properties.
    pub fn listOptimizationJobs(self: *Self, allocator: std.mem.Allocator, input: list_optimization_jobs.ListOptimizationJobsInput, options: CallOptions) !list_optimization_jobs.ListOptimizationJobsOutput {
        return list_optimization_jobs.execute(self, allocator, input, options);
    }

    /// Lists all of the SageMaker Partner AI Apps in an account.
    pub fn listPartnerApps(self: *Self, allocator: std.mem.Allocator, input: list_partner_apps.ListPartnerAppsInput, options: CallOptions) !list_partner_apps.ListPartnerAppsOutput {
        return list_partner_apps.execute(self, allocator, input, options);
    }

    /// Gets a list of `PipeLineExecutionStep` objects.
    pub fn listPipelineExecutionSteps(self: *Self, allocator: std.mem.Allocator, input: list_pipeline_execution_steps.ListPipelineExecutionStepsInput, options: CallOptions) !list_pipeline_execution_steps.ListPipelineExecutionStepsOutput {
    ...
    pub fn listPipelineParametersForExecution(self: *Self, allocator: std.mem.Allocator, input: list_pipeline_parameters_for_execution.ListPipelineParametersForExecutionInput, options: CallOptions) !list_pipeline_parameters_for_execution.ListPipelineParametersForExecutionOutput {
        return list_pipeline_parameters_for_execution.execute(self, allocator, input, options);
    }

    /// Gets a list of all versions of the pipeline.
    pub fn listPipelineVersions(self: *Self, allocator: std.mem.Allocator, input: list_pipeline_versions.ListPipelineVersionsInput, options: CallOptions) !list_pipeline_versions.ListPipelineVersionsOutput {
    ...
    pub fn listProcessingJobs(self: *Self, allocator: std.mem.Allocator, input: list_processing_jobs.ListProcessingJobsInput, options: CallOptions) !list_processing_jobs.ListProcessingJobsOutput {
    ...
    pub fn listResourceCatalogs(self: *Self, allocator: std.mem.Allocator, input: list_resource_catalogs.ListResourceCatalogsInput, options: CallOptions) !list_resource_catalogs.ListResourceCatalogsOutput {
    ...
    pub fn listStageDevices(self: *Self, allocator: std.mem.Allocator, input: list_stage_devices.ListStageDevicesInput, options: CallOptions) !list_stage_devices.ListStageDevicesOutput {
    ...
    pub fn listStudioLifecycleConfigs(self: *Self, allocator: std.mem.Allocator, input: list_studio_lifecycle_configs.ListStudioLifecycleConfigsInput, options: CallOptions) !list_studio_lifecycle_configs.ListStudioLifecycleConfigsOutput {
    ...
    pub fn listSubscribedWorkteams(self: *Self, allocator: std.mem.Allocator, input: list_subscribed_workteams.ListSubscribedWorkteamsInput, options: CallOptions) !list_subscribed_workteams.ListSubscribedWorkteamsOutput {
    ...
    /// InProgress`
    pub fn listTrainingJobs(self: *Self, allocator: std.mem.Allocator, input: list_training_jobs.ListTrainingJobsInput, options: CallOptions) !list_training_jobs.ListTrainingJobsOutput {
    ...
    pub fn listTrainingJobsForHyperParameterTuningJob(self: *Self, allocator: std.mem.Allocator, input: list_training_jobs_for_hyper_parameter_tuning_job.ListTrainingJobsForHyperParameterTuningJobInput, options: CallOptions) !list_training_jobs_for_hyper_parameter_tuning_job.ListTrainingJobsForHyperParameterTuningJobOutput {
        return list_training_jobs_for_hyper_parameter_tuning_job.execute(self, allocator, input, options);
    }

    /// Retrieves a list of training plans for the current account.
    pub fn listTrainingPlans(self: *Self, allocator: std.mem.Allocator, input: list_training_plans.ListTrainingPlansInput, options: CallOptions) !list_training_plans.ListTrainingPlansOutput {
        return list_training_plans.execute(self, allocator, input, options);
    }

    /// Lists transform jobs.
    pub fn listTransformJobs(self: *Self, allocator: std.mem.Allocator, input: list_transform_jobs.ListTransformJobsInput, options: CallOptions) !list_transform_jobs.ListTransformJobsOutput {
    ...
    /// * `SourceArn`
    /// * `TrialName`
    pub fn listTrialComponents(self: *Self, allocator: std.mem.Allocator, input: list_trial_components.ListTrialComponentsInput, options: CallOptions) !list_trial_components.ListTrialComponentsOutput {
    ...
    /// creation time.
    pub fn listTrials(self: *Self, allocator: std.mem.Allocator, input: list_trials.ListTrialsInput, options: CallOptions) !list_trials.ListTrialsOutput {
    ...
    pub fn listUltraServersByReservedCapacity(self: *Self, allocator: std.mem.Allocator, input: list_ultra_servers_by_reserved_capacity.ListUltraServersByReservedCapacityInput, options: CallOptions) !list_ultra_servers_by_reserved_capacity.ListUltraServersByReservedCapacityOutput {
        return list_ultra_servers_by_reserved_capacity.execute(self, allocator, input, options);
    }

    /// Lists user profiles.
    pub fn listUserProfiles(self: *Self, allocator: std.mem.Allocator, input: list_user_profiles.ListUserProfilesInput, options: CallOptions) !list_user_profiles.ListUserProfilesOutput {
    ...
    pub fn listWorkforces(self: *Self, allocator: std.mem.Allocator, input: list_workforces.ListWorkforcesInput, options: CallOptions) !list_workforces.ListWorkforcesOutput {
    ...
    pub fn listWorkteams(self: *Self, allocator: std.mem.Allocator, input: list_workteams.ListWorkteamsInput, options: CallOptions) !list_workteams.ListWorkteamsOutput {
    ...
    /// policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_identity-vs-resource.html) in the *Amazon Web Services Identity and Access Management User Guide.*.
    pub fn putModelPackageGroupPolicy(self: *Self, allocator: std.mem.Allocator, input: put_model_package_group_policy.PutModelPackageGroupPolicyInput, options: CallOptions) !put_model_package_group_policy.PutModelPackageGroupPolicyOutput {
    ...
    pub fn queryLineage(self: *Self, allocator: std.mem.Allocator, input: query_lineage.QueryLineageInput, options: CallOptions) !query_lineage.QueryLineageOutput {
        return query_lineage.execute(self, allocator, input, options);
    }

    /// Register devices.
    pub fn registerDevices(self: *Self, allocator: std.mem.Allocator, input: register_devices.RegisterDevicesInput, options: CallOptions) !register_devices.RegisterDevicesOutput {
        return register_devices.execute(self, allocator, input, options);
    }

    /// Renders the UI template so that you can preview the worker's experience.
    pub fn renderUiTemplate(self: *Self, allocator: std.mem.Allocator, input: render_ui_template.RenderUiTemplateInput, options: CallOptions) !render_ui_template.RenderUiTemplateOutput {
        return render_ui_template.execute(self, allocator, input, options);
    }

    /// Retry the execution of the pipeline.
    pub fn retryPipelineExecution(self: *Self, allocator: std.mem.Allocator, input: retry_pipeline_execution.RetryPipelineExecutionInput, options: CallOptions) !retry_pipeline_execution.RetryPipelineExecutionOutput {
    ...
    pub fn searchTrainingPlanOfferings(self: *Self, allocator: std.mem.Allocator, input: search_training_plan_offerings.SearchTrainingPlanOfferingsInput, options: CallOptions) !search_training_plan_offerings.SearchTrainingPlanOfferingsOutput {
    ...
    pub fn sendPipelineExecutionStepFailure(self: *Self, allocator: std.mem.Allocator, input: send_pipeline_execution_step_failure.SendPipelineExecutionStepFailureInput, options: CallOptions) !send_pipeline_execution_step_failure.SendPipelineExecutionStepFailureOutput {
    ...
    pub fn sendPipelineExecutionStepSuccess(self: *Self, allocator: std.mem.Allocator, input: send_pipeline_execution_step_success.SendPipelineExecutionStepSuccessInput, options: CallOptions) !send_pipeline_execution_step_success.SendPipelineExecutionStepSuccessOutput {
    ...
    pub fn startInferenceExperiment(self: *Self, allocator: std.mem.Allocator, input: start_inference_experiment.StartInferenceExperimentInput, options: CallOptions) !start_inference_experiment.StartInferenceExperimentOutput {
        return start_inference_experiment.execute(self, allocator, input, options);
    }

    /// Programmatically start an MLflow Tracking Server.
    pub fn startMlflowTrackingServer(self: *Self, allocator: std.mem.Allocator, input: start_mlflow_tracking_server.StartMlflowTrackingServerInput, options: CallOptions) !start_mlflow_tracking_server.StartMlflowTrackingServerOutput {
    ...
    pub fn startMonitoringSchedule(self: *Self, allocator: std.mem.Allocator, input: start_monitoring_schedule.StartMonitoringScheduleInput, options: CallOptions) !start_monitoring_schedule.StartMonitoringScheduleOutput {
    ...
    /// notebook.
    pub fn startNotebookInstance(self: *Self, allocator: std.mem.Allocator, input: start_notebook_instance.StartNotebookInstanceInput, options: CallOptions) !start_notebook_instance.StartNotebookInstanceOutput {
    ...
    pub fn stopAutoMlJob(self: *Self, allocator: std.mem.Allocator, input: stop_auto_ml_job.StopAutoMLJobInput, options: CallOptions) !stop_auto_ml_job.StopAutoMLJobOutput {
    ...
    pub fn stopCompilationJob(self: *Self, allocator: std.mem.Allocator, input: stop_compilation_job.StopCompilationJobInput, options: CallOptions) !stop_compilation_job.StopCompilationJobOutput {
        return stop_compilation_job.execute(self, allocator, input, options);
    }

    /// Stops a stage in an edge deployment plan.
    pub fn stopEdgeDeploymentStage(self: *Self, allocator: std.mem.Allocator, input: stop_edge_deployment_stage.StopEdgeDeploymentStageInput, options: CallOptions) !stop_edge_deployment_stage.StopEdgeDeploymentStageOutput {
        return stop_edge_deployment_stage.execute(self, allocator, input, options);
    }

    /// Request to stop an edge packaging job.
    pub fn stopEdgePackagingJob(self: *Self, allocator: std.mem.Allocator, input: stop_edge_packaging_job.StopEdgePackagingJobInput, options: CallOptions) !stop_edge_packaging_job.StopEdgePackagingJobOutput {
    ...
    /// tuning job.
    pub fn stopHyperParameterTuningJob(self: *Self, allocator: std.mem.Allocator, input: stop_hyper_parameter_tuning_job.StopHyperParameterTuningJobInput, options: CallOptions) !stop_hyper_parameter_tuning_job.StopHyperParameterTuningJobOutput {
        return stop_hyper_parameter_tuning_job.execute(self, allocator, input, options);
    }

    /// Stops an inference experiment.
    pub fn stopInferenceExperiment(self: *Self, allocator: std.mem.Allocator, input: stop_inference_experiment.StopInferenceExperimentInput, options: CallOptions) !stop_inference_experiment.StopInferenceExperimentOutput {
    ...
    /// output bucket.
    pub fn stopLabelingJob(self: *Self, allocator: std.mem.Allocator, input: stop_labeling_job.StopLabelingJobInput, options: CallOptions) !stop_labeling_job.StopLabelingJobOutput {
        return stop_labeling_job.execute(self, allocator, input, options);
    }

    /// Programmatically stop an MLflow Tracking Server.
    pub fn stopMlflowTrackingServer(self: *Self, allocator: std.mem.Allocator, input: stop_mlflow_tracking_server.StopMlflowTrackingServerInput, options: CallOptions) !stop_mlflow_tracking_server.StopMlflowTrackingServerOutput {
        return stop_mlflow_tracking_server.execute(self, allocator, input, options);
    }

    /// Stops a previously started monitoring schedule.
    pub fn stopMonitoringSchedule(self: *Self, allocator: std.mem.Allocator, input: stop_monitoring_schedule.StopMonitoringScheduleInput, options: CallOptions) !stop_monitoring_schedule.StopMonitoringScheduleOutput {
    ...
    pub fn stopNotebookInstance(self: *Self, allocator: std.mem.Allocator, input: stop_notebook_instance.StopNotebookInstanceInput, options: CallOptions) !stop_notebook_instance.StopNotebookInstanceOutput {
        return stop_notebook_instance.execute(self, allocator, input, options);
    }

    /// Ends a running inference optimization job.
    pub fn stopOptimizationJob(self: *Self, allocator: std.mem.Allocator, input: stop_optimization_job.StopOptimizationJobInput, options: CallOptions) !stop_optimization_job.StopOptimizationJobOutput {
    ...
    pub fn stopProcessingJob(self: *Self, allocator: std.mem.Allocator, input: stop_processing_job.StopProcessingJobInput, options: CallOptions) !stop_processing_job.StopProcessingJobOutput {
    ...
    /// to `Stopped`.
    pub fn stopTrainingJob(self: *Self, allocator: std.mem.Allocator, input: stop_training_job.StopTrainingJobInput, options: CallOptions) !stop_training_job.StopTrainingJobOutput {
    ...
    pub fn stopTransformJob(self: *Self, allocator: std.mem.Allocator, input: stop_transform_job.StopTransformJobInput, options: CallOptions) !stop_transform_job.StopTransformJobOutput {
        return stop_transform_job.execute(self, allocator, input, options);
    }

    /// Updates an action.
    pub fn updateAction(self: *Self, allocator: std.mem.Allocator, input: update_action.UpdateActionInput, options: CallOptions) !update_action.UpdateActionOutput {
        return update_action.execute(self, allocator, input, options);
    }

    /// Updates the properties of an AppImageConfig.
    pub fn updateAppImageConfig(self: *Self, allocator: std.mem.Allocator, input: update_app_image_config.UpdateAppImageConfigInput, options: CallOptions) !update_app_image_config.UpdateAppImageConfigOutput {
        return update_app_image_config.execute(self, allocator, input, options);
    }

    /// Updates an artifact.
    pub fn updateArtifact(self: *Self, allocator: std.mem.Allocator, input: update_artifact.UpdateArtifactInput, options: CallOptions) !update_artifact.UpdateArtifactOutput {
    ...
    pub fn updateClusterSchedulerConfig(self: *Self, allocator: std.mem.Allocator, input: update_cluster_scheduler_config.UpdateClusterSchedulerConfigInput, options: CallOptions) !update_cluster_scheduler_config.UpdateClusterSchedulerConfigOutput {
    ...
    pub fn updateClusterSoftware(self: *Self, allocator: std.mem.Allocator, input: update_cluster_software.UpdateClusterSoftwareInput, options: CallOptions) !update_cluster_software.UpdateClusterSoftwareOutput {
        return update_cluster_software.execute(self, allocator, input, options);
    }

    /// Updates the specified Git repository with the specified values.
    pub fn updateCodeRepository(self: *Self, allocator: std.mem.Allocator, input: update_code_repository.UpdateCodeRepositoryInput, options: CallOptions) !update_code_repository.UpdateCodeRepositoryOutput {
        return update_code_repository.execute(self, allocator, input, options);
    }

    /// Update the compute allocation definition.
    pub fn updateComputeQuota(self: *Self, allocator: std.mem.Allocator, input: update_compute_quota.UpdateComputeQuotaInput, options: CallOptions) !update_compute_quota.UpdateComputeQuotaOutput {
        return update_compute_quota.execute(self, allocator, input, options);
    }

    /// Updates a context.
    pub fn updateContext(self: *Self, allocator: std.mem.Allocator, input: update_context.UpdateContextInput, options: CallOptions) !update_context.UpdateContextOutput {
        return update_context.execute(self, allocator, input, options);
    }

    /// Updates a fleet of devices.
    pub fn updateDeviceFleet(self: *Self, allocator: std.mem.Allocator, input: update_device_fleet.UpdateDeviceFleetInput, options: CallOptions) !update_device_fleet.UpdateDeviceFleetOutput {
        return update_device_fleet.execute(self, allocator, input, options);
    }

    /// Updates one or more devices in a fleet.
    pub fn updateDevices(self: *Self, allocator: std.mem.Allocator, input: update_devices.UpdateDevicesInput, options: CallOptions) !update_devices.UpdateDevicesOutput {
    ...
    /// To check the status of an endpoint, use the
    /// [DescribeEndpoint](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_DescribeEndpoint.html) API.
    pub fn updateEndpointWeightsAndCapacities(self: *Self, allocator: std.mem.Allocator, input: update_endpoint_weights_and_capacities.UpdateEndpointWeightsAndCapacitiesInput, options: CallOptions) !update_endpoint_weights_and_capacities.UpdateEndpointWeightsAndCapacitiesOutput {
    ...
    pub fn updateFeatureGroup(self: *Self, allocator: std.mem.Allocator, input: update_feature_group.UpdateFeatureGroupInput, options: CallOptions) !update_feature_group.UpdateFeatureGroupOutput {
        return update_feature_group.execute(self, allocator, input, options);
    }

    /// Updates the description and parameters of the feature group.
    pub fn updateFeatureMetadata(self: *Self, allocator: std.mem.Allocator, input: update_feature_metadata.UpdateFeatureMetadataInput, options: CallOptions) !update_feature_metadata.UpdateFeatureMetadataOutput {
        return update_feature_metadata.execute(self, allocator, input, options);
    }

    /// Update a hub.
    pub fn updateHub(self: *Self, allocator: std.mem.Allocator, input: update_hub.UpdateHubInput, options: CallOptions) !update_hub.UpdateHubOutput {
    ...
    pub fn updateHubContent(self: *Self, allocator: std.mem.Allocator, input: update_hub_content.UpdateHubContentInput, options: CallOptions) !update_hub_content.UpdateHubContentOutput {
    ...
    pub fn updateHubContentReference(self: *Self, allocator: std.mem.Allocator, input: update_hub_content_reference.UpdateHubContentReferenceInput, options: CallOptions) !update_hub_content_reference.UpdateHubContentReferenceOutput {
    ...
    pub fn updateImage(self: *Self, allocator: std.mem.Allocator, input: update_image.UpdateImageInput, options: CallOptions) !update_image.UpdateImageOutput {
        return update_image.execute(self, allocator, input, options);
    }

    /// Updates the properties of a SageMaker AI image version.
    pub fn updateImageVersion(self: *Self, allocator: std.mem.Allocator, input: update_image_version.UpdateImageVersionInput, options: CallOptions) !update_image_version.UpdateImageVersionOutput {
        return update_image_version.execute(self, allocator, input, options);
    }

    /// Updates an inference component.
    pub fn updateInferenceComponent(self: *Self, allocator: std.mem.Allocator, input: update_inference_component.UpdateInferenceComponentInput, options: CallOptions) !update_inference_component.UpdateInferenceComponentOutput {
        return update_inference_component.execute(self, allocator, input, options);
    }

    /// Runtime settings for a model that is deployed with an inference component.
    pub fn updateInferenceComponentRuntimeConfig(self: *Self, allocator: std.mem.Allocator, input: update_inference_component_runtime_config.UpdateInferenceComponentRuntimeConfigInput, options: CallOptions) !update_inference_component_runtime_config.UpdateInferenceComponentRuntimeConfigOutput {
    ...
    pub fn updateInferenceExperiment(self: *Self, allocator: std.mem.Allocator, input: update_inference_experiment.UpdateInferenceExperimentInput, options: CallOptions) !update_inference_experiment.UpdateInferenceExperimentOutput {
        return update_inference_experiment.execute(self, allocator, input, options);
    }

    /// Updates an MLflow App.
    pub fn updateMlflowApp(self: *Self, allocator: std.mem.Allocator, input: update_mlflow_app.UpdateMlflowAppInput, options: CallOptions) !update_mlflow_app.UpdateMlflowAppOutput {
        return update_mlflow_app.execute(self, allocator, input, options);
    }

    /// Updates properties of an existing MLflow Tracking Server.
    pub fn updateMlflowTrackingServer(self: *Self, allocator: std.mem.Allocator, input: update_mlflow_tracking_server.UpdateMlflowTrackingServerInput, options: CallOptions) !update_mlflow_tracking_server.UpdateMlflowTrackingServerOutput {
    ...
    /// call.
    pub fn updateModelCard(self: *Self, allocator: std.mem.Allocator, input: update_model_card.UpdateModelCardInput, options: CallOptions) !update_model_card.UpdateModelCardOutput {
        return update_model_card.execute(self, allocator, input, options);
    }

    /// Updates a versioned model.
    pub fn updateModelPackage(self: *Self, allocator: std.mem.Allocator, input: update_model_package.UpdateModelPackageInput, options: CallOptions) !update_model_package.UpdateModelPackageOutput {
        return update_model_package.execute(self, allocator, input, options);
    }

    /// Update the parameters of a model monitor alert.
    pub fn updateMonitoringAlert(self: *Self, allocator: std.mem.Allocator, input: update_monitoring_alert.UpdateMonitoringAlertInput, options: CallOptions) !update_monitoring_alert.UpdateMonitoringAlertOutput {
        return update_monitoring_alert.execute(self, allocator, input, options);
    }

    /// Updates a previously created schedule.
    pub fn updateMonitoringSchedule(self: *Self, allocator: std.mem.Allocator, input: update_monitoring_schedule.UpdateMonitoringScheduleInput, options: CallOptions) !update_monitoring_schedule.UpdateMonitoringScheduleOutput {
    ...
    /// Configuration
    /// Script](https://docs.aws.amazon.com/sagemaker/latest/dg/notebook-lifecycle-config.html) for security best practices.
    pub fn updateNotebookInstance(self: *Self, allocator: std.mem.Allocator, input: update_notebook_instance.UpdateNotebookInstanceInput, options: CallOptions) !update_notebook_instance.UpdateNotebookInstanceOutput {
    ...
    /// Script](https://docs.aws.amazon.com/sagemaker/latest/dg/notebook-lifecycle-config.html) for security best practices.
    pub fn updateNotebookInstanceLifecycleConfig(self: *Self, allocator: std.mem.Allocator, input: update_notebook_instance_lifecycle_config.UpdateNotebookInstanceLifecycleConfigInput, options: CallOptions) !update_notebook_instance_lifecycle_config.UpdateNotebookInstanceLifecycleConfigOutput {
        return update_notebook_instance_lifecycle_config.execute(self, allocator, input, options);
    }

    /// Updates all of the SageMaker Partner AI Apps in an account.
    pub fn updatePartnerApp(self: *Self, allocator: std.mem.Allocator, input: update_partner_app.UpdatePartnerAppInput, options: CallOptions) !update_partner_app.UpdatePartnerAppOutput {
    ...
    pub fn updatePipelineExecution(self: *Self, allocator: std.mem.Allocator, input: update_pipeline_execution.UpdatePipelineExecutionInput, options: CallOptions) !update_pipeline_execution.UpdatePipelineExecutionOutput {
        return update_pipeline_execution.execute(self, allocator, input, options);
    }

    /// Updates a pipeline version.
    pub fn updatePipelineVersion(self: *Self, allocator: std.mem.Allocator, input: update_pipeline_version.UpdatePipelineVersionInput, options: CallOptions) !update_pipeline_version.UpdatePipelineVersionOutput {
    ...
    pub fn updateTrainingJob(self: *Self, allocator: std.mem.Allocator, input: update_training_job.UpdateTrainingJobInput, options: CallOptions) !update_training_job.UpdateTrainingJobOutput {
        return update_training_job.execute(self, allocator, input, options);
    }

    /// Updates the display name of a trial.
    pub fn updateTrial(self: *Self, allocator: std.mem.Allocator, input: update_trial.UpdateTrialInput, options: CallOptions) !update_trial.UpdateTrialOutput {
        return update_trial.execute(self, allocator, input, options);
    }

    /// Updates one or more properties of a trial component.
    pub fn updateTrialComponent(self: *Self, allocator: std.mem.Allocator, input: update_trial_component.UpdateTrialComponentInput, options: CallOptions) !update_trial_component.UpdateTrialComponentOutput {
    ...
    pub fn updateWorkforce(self: *Self, allocator: std.mem.Allocator, input: update_workforce.UpdateWorkforceInput, options: CallOptions) !update_workforce.UpdateWorkforceOutput {
        return update_workforce.execute(self, allocator, input, options);
    }

    /// Updates an existing work team with new member definitions or description.
    pub fn updateWorkteam(self: *Self, allocator: std.mem.Allocator, input: update_workteam.UpdateWorkteamInput, options: CallOptions) !update_workteam.UpdateWorkteamOutput {
