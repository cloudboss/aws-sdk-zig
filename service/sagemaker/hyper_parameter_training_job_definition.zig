...
pub const HyperParameterTrainingJobDefinition = struct {
    ...
    hyper_parameter_ranges: ?ParameterRanges = null,
    ...
    hyper_parameter_tuning_resource_config: ?HyperParameterTuningResourceConfig = null,
    ...
    /// job.
    static_hyper_parameters: ?[]const aws.map.StringMapEntry = null,
    ...
    tuning_objective: ?HyperParameterTuningJobObjective = null,
