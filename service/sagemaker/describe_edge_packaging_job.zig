...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeEdgePackagingJobInput, options: Options) !DescribeEdgePackagingJobOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeEdgePackagingJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.DescribeEdgePackagingJob");
