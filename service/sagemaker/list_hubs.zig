...
fn serializeRequest(alloc: std.mem.Allocator, input: ListHubsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.ListHubs");
