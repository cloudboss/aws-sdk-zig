...
/// output data.
pub const AnnotationConsolidationConfig = struct {
    /// The Amazon Resource Name (ARN) of a Lambda function implements the logic for
    /// [annotation
    /// consolidation](https://docs.aws.amazon.com/sagemaker/latest/dg/sms-annotation-consolidation.html) and to process output data.
    ///
    /// For [built-in task
    ...
    ///
    /// **3D Point Cloud Object Tracking Adjustment** - Use this task type when you
    /// want workers to adjust 3D cuboids around objects that appear in a sequence
    /// of 3D point cloud frames.
    ///
    /// *
    ...
    ///
    /// **3D Point Cloud Semantic Segmentation Adjustment** - Use this task type
