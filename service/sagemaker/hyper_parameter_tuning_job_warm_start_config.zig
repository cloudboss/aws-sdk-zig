const ParentHyperParameterTuningJob = @import("parent_hyper_parameter_tuning_job.zig").ParentHyperParameterTuningJob;
const HyperParameterTuningJobWarmStartType = @import("hyper_parameter_tuning_job_warm_start_type.zig").HyperParameterTuningJobWarmStartType;
...
/// tuning job.
pub const HyperParameterTuningJobWarmStartConfig = struct {
    ...
    parent_hyper_parameter_tuning_jobs: []const ParentHyperParameterTuningJob,
