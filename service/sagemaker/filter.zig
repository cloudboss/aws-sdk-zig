...
pub const Filter = struct {
    ...
    /// names, see
    /// [SearchRecord](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_SearchRecord.html). You must specify a valid property for the resource.
    name: []const u8,
    ...
    ///
    /// The value of `Name` is greater than or equal to `Value`. Not supported for
    /// text properties.
    ///
    /// **LessThan**
    ///
