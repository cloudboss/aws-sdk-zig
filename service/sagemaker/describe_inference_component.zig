...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeInferenceComponentInput, options: Options) !DescribeInferenceComponentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeInferenceComponentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.DescribeInferenceComponent");
