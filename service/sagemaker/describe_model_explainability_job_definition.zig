...
pub const DescribeModelExplainabilityJobDefinitionInput = struct {
...
pub const DescribeModelExplainabilityJobDefinitionOutput = struct {
    ...
    /// image.
    model_explainability_app_specification: ?ModelExplainabilityAppSpecification = null,

    /// The baseline configuration for a model explainability job.
    model_explainability_baseline_config: ?ModelExplainabilityBaselineConfig = null,

    /// Inputs for the model explainability job.
    model_explainability_job_input: ?ModelExplainabilityJobInput = null,

    model_explainability_job_output_config: ?MonitoringOutputConfig = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeModelExplainabilityJobDefinitionInput, options: CallOptions) !DescribeModelExplainabilityJobDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeModelExplainabilityJobDefinitionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SageMaker.DescribeModelExplainabilityJobDefinition");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeModelExplainabilityJobDefinitionOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DescribeModelExplainabilityJobDefinitionOutput, body, allocator);
}
