...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeModelExplainabilityJobDefinitionInput, options: Options) !DescribeModelExplainabilityJobDefinitionOutput {
