...
pub const CreateModelCardExportJobInput = struct {
...
pub const CreateModelCardExportJobOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateModelCardExportJobInput, options: CallOptions) !CreateModelCardExportJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateModelCardExportJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SageMaker.CreateModelCardExportJob");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateModelCardExportJobOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(CreateModelCardExportJobOutput, body, allocator);
}
