...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMonitoringSchedulesInput, options: Options) !ListMonitoringSchedulesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListMonitoringSchedulesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SageMaker.ListMonitoringSchedules");
