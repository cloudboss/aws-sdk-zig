...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBotResourceGenerationsInput, options: CallOptions) !ListBotResourceGenerationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBotResourceGenerationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListBotResourceGenerationsOutput {
    var result: ListBotResourceGenerationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListBotResourceGenerationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
