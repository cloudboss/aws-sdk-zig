...
pub const DeleteIntentInput = struct {
...
const DeleteIntentOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIntentInput, options: Options) !DeleteIntentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteIntentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteIntentOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteIntentOutput = .{};
