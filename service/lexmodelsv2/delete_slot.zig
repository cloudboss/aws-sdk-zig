...
pub const DeleteSlotInput = struct {
...
const DeleteSlotOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSlotInput, options: Options) !DeleteSlotOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSlotInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.slot_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSlotOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSlotOutput = .{};
