...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteResourcePolicyStatementInput, options: CallOptions) !DeleteResourcePolicyStatementOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteResourcePolicyStatementInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteResourcePolicyStatementOutput {
    var result: DeleteResourcePolicyStatementOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteResourcePolicyStatementOutput, body, allocator);
    }
    _ = status;
    _ = headers;
