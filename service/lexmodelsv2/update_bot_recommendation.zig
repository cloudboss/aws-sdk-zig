...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateBotRecommendationInput, options: CallOptions) !UpdateBotRecommendationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateBotRecommendationInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.encryption_setting), input.encryption_setting, allocator, &body_buf);
    has_prev = true;
