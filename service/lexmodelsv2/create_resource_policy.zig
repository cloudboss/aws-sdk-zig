...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateResourcePolicyInput, options: CallOptions) !CreateResourcePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateResourcePolicyInput, config: *aws.Config) !aws.http.Request {
