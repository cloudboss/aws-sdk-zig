...
pub const AggregatedUtterancesSummary = struct {
    ...
    contains_data_from_deleted_resources: ?bool = null,
    ...
    /// counted.
    utterance_first_recorded_in_aggregation_duration: ?i64 = null,
    ...
    utterance_last_recorded_in_aggregation_duration: ?i64 = null,
