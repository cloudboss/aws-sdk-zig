...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteImportInput, options: CallOptions) !DeleteImportOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteImportInput, config: *aws.Config) !aws.http.Request {
