...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListUtteranceMetricsInput, options: CallOptions) !ListUtteranceMetricsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListUtteranceMetricsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/analytics/utterancemetrics");
