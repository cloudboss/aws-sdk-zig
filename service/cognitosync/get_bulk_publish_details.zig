...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBulkPublishDetailsInput, options: CallOptions) !GetBulkPublishDetailsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBulkPublishDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/getBulkPublishDetails");
