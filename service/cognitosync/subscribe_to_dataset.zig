...
pub const SubscribeToDatasetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SubscribeToDatasetInput, options: Options) !SubscribeToDatasetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SubscribeToDatasetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SubscribeToDatasetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: SubscribeToDatasetOutput = .{};
