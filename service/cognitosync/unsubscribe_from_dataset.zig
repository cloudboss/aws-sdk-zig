...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UnsubscribeFromDatasetInput, options: Options) !UnsubscribeFromDatasetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UnsubscribeFromDatasetInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UnsubscribeFromDatasetOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
