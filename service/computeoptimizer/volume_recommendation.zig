...
pub const VolumeRecommendation = struct {
    ...
    current_configuration: ?VolumeConfiguration,
    ...
    effective_recommendation_preferences: ?EBSEffectiveRecommendationPreferences,
    ...
    utilization_metrics: ?[]const EBSUtilizationMetric,

    /// The Amazon Resource Name (ARN) of the current volume.
    volume_arn: ?[]const u8,

    /// An array of objects that describe the recommendation options for the volume.
    volume_recommendation_options: ?[]const VolumeRecommendationOption,
