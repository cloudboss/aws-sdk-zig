...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ExportEC2InstanceRecommendationsInput, options: Options) !ExportEC2InstanceRecommendationsOutput {
