...
pub const ListGroupsForMemberPaginator = struct {
    client: *Client,
    params: list_groups_for_member.ListGroupsForMemberInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_groups_for_member.Options) !list_groups_for_member.ListGroupsForMemberOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_groups_for_member.execute(self.client, allocator, self.params, options);
...
pub const SearchGroupsPaginator = struct {
    client: *Client,
    params: search_groups.SearchGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: search_groups.Options) !search_groups.SearchGroupsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const SearchUsersPaginator = struct {
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: search_users.Options) !search_users.SearchUsersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
