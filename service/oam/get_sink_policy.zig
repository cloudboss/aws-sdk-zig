...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSinkPolicyInput, options: CallOptions) !GetSinkPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSinkPolicyInput, config: *aws.Config) !aws.http.Request {
