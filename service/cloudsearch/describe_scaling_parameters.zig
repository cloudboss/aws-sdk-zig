...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeScalingParametersInput, options: CallOptions) !DescribeScalingParametersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeScalingParametersInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DescribeScalingParameters&Version=2013-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeScalingParametersOutput {
    _ = status;
    _ = headers;
