...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartOutpostDecommissionInput, options: CallOptions) !StartOutpostDecommissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartOutpostDecommissionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/decommission");
    ...
    if (input.validate_only) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"ValidateOnly\":");
