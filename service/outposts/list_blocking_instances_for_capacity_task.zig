...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListBlockingInstancesForCapacityTaskInput, options: CallOptions) !ListBlockingInstancesForCapacityTaskOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListBlockingInstancesForCapacityTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/blockingInstances");
