...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOutpostInstanceTypesInput, options: CallOptions) !GetOutpostInstanceTypesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetOutpostInstanceTypesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/instanceTypes");
