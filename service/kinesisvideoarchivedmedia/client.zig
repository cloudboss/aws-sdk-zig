...
const get_clip = @import("get_clip.zig");
const get_dash_streaming_session_url = @import("get_dash_streaming_session_url.zig");
const get_hls_streaming_session_url = @import("get_hls_streaming_session_url.zig");
...
pub const Client = struct {
    ...
    const Self = @This();
    pub const sdk_id = "Kinesis Video Archived Media";
    ...
    /// Video
    /// Streams](http://docs.aws.amazon.com/kinesisvideostreams/latest/dg/monitoring.html). For pricing information, see [Amazon Kinesis Video
    ...
    /// Streaming](https://developer.apple.com/streaming/) on the
    ...
    /// H.265). Optionally, the codec ID of track 2 should be `A_AAC`. For audio
    ...
    /// MPEG-4 form
    /// (also called fMP4 or CMAF) or the MPEG-2 form (also called TS chunks, which
    /// the HLS
    /// specification also supports). For more information about HLS fragment types,
    /// see the
    /// [HLS
    ...
    pub fn getImagesPaginator(self: *Self, params: get_images.GetImagesInput) paginator.GetImagesPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listFragmentsPaginator(self: *Self, params: list_fragments.ListFragmentsInput) paginator.ListFragmentsPaginator {
        return .{
            .client = self,
            .params = params,
        };
