...
pub const Client = struct {
    ...
    pub fn deregisterSubscriptionProvider(self: *Self, allocator: std.mem.Allocator, input: deregister_subscription_provider.DeregisterSubscriptionProviderInput, options: CallOptions) !deregister_subscription_provider.DeregisterSubscriptionProviderOutput {
    ...
    /// registered to your account.
    pub fn getRegisteredSubscriptionProvider(self: *Self, allocator: std.mem.Allocator, input: get_registered_subscription_provider.GetRegisteredSubscriptionProviderInput, options: CallOptions) !get_registered_subscription_provider.GetRegisteredSubscriptionProviderOutput {
    ...
    /// Linux
    /// subscriptions.
    pub fn listLinuxSubscriptionInstances(self: *Self, allocator: std.mem.Allocator, input: list_linux_subscription_instances.ListLinuxSubscriptionInstancesInput, options: CallOptions) !list_linux_subscription_instances.ListLinuxSubscriptionInstancesOutput {
    ...
    /// accounts in
    /// Organizations.
    pub fn listLinuxSubscriptions(self: *Self, allocator: std.mem.Allocator, input: list_linux_subscriptions.ListLinuxSubscriptionsInput, options: CallOptions) !list_linux_subscriptions.ListLinuxSubscriptionsOutput {
    ...
    /// your account.
    pub fn listRegisteredSubscriptionProviders(self: *Self, allocator: std.mem.Allocator, input: list_registered_subscription_providers.ListRegisteredSubscriptionProvidersInput, options: CallOptions) !list_registered_subscription_providers.ListRegisteredSubscriptionProvidersOutput {
    ...
    pub fn registerSubscriptionProvider(self: *Self, allocator: std.mem.Allocator, input: register_subscription_provider.RegisterSubscriptionProviderInput, options: CallOptions) !register_subscription_provider.RegisterSubscriptionProviderOutput {
