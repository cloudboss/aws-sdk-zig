...
pub const ListLinuxSubscriptionInstancesPaginator = struct {
    client: *Client,
    params: list_linux_subscription_instances.ListLinuxSubscriptionInstancesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_linux_subscription_instances.Options) !list_linux_subscription_instances.ListLinuxSubscriptionInstancesOutput {
        ...
        const output = try list_linux_subscription_instances.execute(self.client, allocator, self.params, options);
...
pub const ListLinuxSubscriptionsPaginator = struct {
    client: *Client,
    params: list_linux_subscriptions.ListLinuxSubscriptionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_linux_subscriptions.Options) !list_linux_subscriptions.ListLinuxSubscriptionsOutput {
        ...
        const output = try list_linux_subscriptions.execute(self.client, allocator, self.params, options);
...
pub const ListRegisteredSubscriptionProvidersPaginator = struct {
    client: *Client,
    params: list_registered_subscription_providers.ListRegisteredSubscriptionProvidersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_registered_subscription_providers.Options) !list_registered_subscription_providers.ListRegisteredSubscriptionProvidersOutput {
        ...
        const output = try list_registered_subscription_providers.execute(self.client, allocator, self.params, options);
