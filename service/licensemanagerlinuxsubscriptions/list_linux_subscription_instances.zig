...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLinuxSubscriptionInstancesInput, options: CallOptions) !ListLinuxSubscriptionInstancesOutput {
