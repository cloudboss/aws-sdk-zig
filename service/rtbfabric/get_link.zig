...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetLinkInput, options: CallOptions) !GetLinkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetLinkInput, config: *aws.Config) !aws.http.Request {
