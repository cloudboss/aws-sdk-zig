...
pub const InboundExternalLinkActiveWaiter = struct {
    client: *Client,
    params: get_inbound_external_link.GetInboundExternalLinkInput,
...
pub const InboundExternalLinkDeletedWaiter = struct {
    client: *Client,
    params: get_inbound_external_link.GetInboundExternalLinkInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const LinkAcceptedWaiter = struct {
    client: *Client,
    params: get_link.GetLinkInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
...
pub const LinkActiveWaiter = struct {
    client: *Client,
    params: get_link.GetLinkInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const LinkDeletedWaiter = struct {
    client: *Client,
    params: get_link.GetLinkInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const OutboundExternalLinkActiveWaiter = struct {
    client: *Client,
    params: get_outbound_external_link.GetOutboundExternalLinkInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
...
pub const OutboundExternalLinkDeletedWaiter = struct {
    client: *Client,
    params: get_outbound_external_link.GetOutboundExternalLinkInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
...
pub const RequesterGatewayActiveWaiter = struct {
    client: *Client,
    params: get_requester_gateway.GetRequesterGatewayInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
...
pub const RequesterGatewayDeletedWaiter = struct {
    client: *Client,
    params: get_requester_gateway.GetRequesterGatewayInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        const output = self.client.getRequesterGateway(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
...
pub const ResponderGatewayActiveWaiter = struct {
    client: *Client,
    params: get_responder_gateway.GetResponderGatewayInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
        .max_delay_s = 120,
        .max_wait_time_s = 300,
...
pub const ResponderGatewayDeletedWaiter = struct {
    client: *Client,
    params: get_responder_gateway.GetResponderGatewayInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 30,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        var diagnostic: @import("errors.zig").ServiceError = undefined;
        const output = self.client.getResponderGateway(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
            if (err == error.ServiceError) {
                defer diagnostic.deinit();
                if (std.mem.eql(u8, diagnostic.code(), "ResourceNotFoundException")) {
                    return .success;
