...
pub const ListLifecyclePoliciesInput = struct {
    ...
    /// can include the returned `nextToken` in subsequent `ListLifecyclePolicies`
...
pub const ListLifecyclePoliciesOutput = struct {
    /// Details about the requested lifecycle policies.
    lifecycle_policy_summaries: ?[]const LifecyclePolicySummary = null,
    ...
    pub const json_field_names = .{
        .lifecycle_policy_summaries = "lifecyclePolicySummaries",
        .next_token = "nextToken",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLifecyclePoliciesInput, options: CallOptions) !ListLifecyclePoliciesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListLifecyclePoliciesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "OpenSearchServerless.ListLifecyclePolicies");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListLifecyclePoliciesOutput {
    ...
    return aws.json.parseJsonObject(ListLifecyclePoliciesOutput, body, allocator);
}
