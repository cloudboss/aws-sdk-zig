...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteNotificationRuleInput, options: CallOptions) !DeleteNotificationRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteNotificationRuleInput, config: *aws.Config) !aws.http.Request {
