...
pub const Client = struct {
    ...
    /// them.
    pub fn createNotificationRule(self: *Self, allocator: std.mem.Allocator, input: create_notification_rule.CreateNotificationRuleInput, options: CallOptions) !create_notification_rule.CreateNotificationRuleOutput {
        return create_notification_rule.execute(self, allocator, input, options);
    }

    /// Deletes a notification rule for a resource.
    pub fn deleteNotificationRule(self: *Self, allocator: std.mem.Allocator, input: delete_notification_rule.DeleteNotificationRuleInput, options: CallOptions) !delete_notification_rule.DeleteNotificationRuleOutput {
        return delete_notification_rule.execute(self, allocator, input, options);
    }

    /// Deletes a specified target for notifications.
    pub fn deleteTarget(self: *Self, allocator: std.mem.Allocator, input: delete_target.DeleteTargetInput, options: CallOptions) !delete_target.DeleteTargetOutput {
        return delete_target.execute(self, allocator, input, options);
    }

    /// Returns information about a specified notification rule.
    pub fn describeNotificationRule(self: *Self, allocator: std.mem.Allocator, input: describe_notification_rule.DescribeNotificationRuleInput, options: CallOptions) !describe_notification_rule.DescribeNotificationRuleOutput {
    ...
    /// notifications.
    pub fn listEventTypes(self: *Self, allocator: std.mem.Allocator, input: list_event_types.ListEventTypesInput, options: CallOptions) !list_event_types.ListEventTypesOutput {
        return list_event_types.execute(self, allocator, input, options);
    }

    /// Returns a list of the notification rules for an Amazon Web Services account.
    pub fn listNotificationRules(self: *Self, allocator: std.mem.Allocator, input: list_notification_rules.ListNotificationRulesInput, options: CallOptions) !list_notification_rules.ListNotificationRulesOutput {
    ...
    /// UntagResource.
    pub fn updateNotificationRule(self: *Self, allocator: std.mem.Allocator, input: update_notification_rule.UpdateNotificationRuleInput, options: CallOptions) !update_notification_rule.UpdateNotificationRuleOutput {
