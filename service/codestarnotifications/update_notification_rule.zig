...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateNotificationRuleInput, options: CallOptions) !UpdateNotificationRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateNotificationRuleInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateNotificationRuleOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
