...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAgentMemoryInput, options: CallOptions) !DeleteAgentMemoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAgentMemoryInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.memory_id) |v| {
        ...
        try query_buf.appendSlice(allocator, "memoryId=");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAgentMemoryOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
