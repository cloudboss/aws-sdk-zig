...
pub const DeleteAccountInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccountInput, options: Options) !DeleteAccountOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccountInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccountOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccountOutput = .{};
