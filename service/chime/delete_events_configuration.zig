...
pub const DeleteEventsConfigurationInput = struct {
...
pub const DeleteEventsConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEventsConfigurationInput, options: CallOptions) !DeleteEventsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEventsConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEventsConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEventsConfigurationOutput = .{};
