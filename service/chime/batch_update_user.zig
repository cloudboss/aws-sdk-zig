...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchUpdateUserInput, options: CallOptions) !BatchUpdateUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchUpdateUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "\"UpdateUserRequestItems\":");
    try aws.json.writeValue(@TypeOf(input.update_user_request_items), input.update_user_request_items, allocator, &body_buf);
    has_prev = true;
