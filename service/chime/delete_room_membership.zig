...
pub const DeleteRoomMembershipOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRoomMembershipInput, options: CallOptions) !DeleteRoomMembershipOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRoomMembershipInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRoomMembershipOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
