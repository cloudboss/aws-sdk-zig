...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchUnsuspendUserInput, options: CallOptions) !BatchUnsuspendUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchUnsuspendUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "operation=unsuspend");
    query_has_prev = true;
