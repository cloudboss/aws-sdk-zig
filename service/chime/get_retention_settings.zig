...
pub const GetRetentionSettingsInput = struct {
...
pub const GetRetentionSettingsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRetentionSettingsInput, options: Options) !GetRetentionSettingsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetRetentionSettingsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetRetentionSettingsOutput {
    var result: GetRetentionSettingsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetRetentionSettingsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
