...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestorePhoneNumberInput, options: CallOptions) !RestorePhoneNumberOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RestorePhoneNumberInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "operation=restore");
    query_has_prev = true;
