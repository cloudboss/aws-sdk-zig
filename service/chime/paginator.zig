...
pub const ListRoomMembershipsPaginator = struct {
    client: *Client,
    params: list_room_memberships.ListRoomMembershipsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_room_memberships.ListRoomMembershipsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try list_room_memberships.execute(self.client, allocator, self.params, options);
...
pub const ListRoomsPaginator = struct {
    client: *Client,
    params: list_rooms.ListRoomsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_rooms.ListRoomsOutput {
        ...
        const output = try list_rooms.execute(self.client, allocator, self.params, options);
