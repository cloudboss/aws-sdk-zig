...
pub const DisassociatePhoneNumberFromUserInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociatePhoneNumberFromUserInput, options: Options) !DisassociatePhoneNumberFromUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociatePhoneNumberFromUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "operation=disassociate-phone-number");
    query_has_prev = true;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociatePhoneNumberFromUserOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociatePhoneNumberFromUserOutput = .{};
