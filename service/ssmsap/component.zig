...
pub const Component = struct {
    ...
    child_components: ?[]const []const u8,
    ...
    sap_feature: ?[]const u8,

    /// The hostname of the component.
    sap_hostname: ?[]const u8,

    /// The kernel version of the component.
    sap_kernel_version: ?[]const u8,
