...
pub const Client = struct {
    ...
    pub fn cancelContact(self: *Self, allocator: std.mem.Allocator, input: cancel_contact.CancelContactInput, options: CallOptions) !cancel_contact.CancelContactOutput {
    ...
    pub fn createConfig(self: *Self, allocator: std.mem.Allocator, input: create_config.CreateConfigInput, options: CallOptions) !create_config.CreateConfigOutput {
    ...
    pub fn createDataflowEndpointGroup(self: *Self, allocator: std.mem.Allocator, input: create_dataflow_endpoint_group.CreateDataflowEndpointGroupInput, options: CallOptions) !create_dataflow_endpoint_group.CreateDataflowEndpointGroupOutput {
    ...
    /// When a contact uses multiple `DataflowEndpointConfig` objects, each `
    /// Config` must match a `DataflowEndpoint` in the same group.
    pub fn createDataflowEndpointGroupV2(self: *Self, allocator: std.mem.Allocator, input: create_dataflow_endpoint_group_v2.CreateDataflowEndpointGroupV2Input, options: CallOptions) !create_dataflow_endpoint_group_v2.CreateDataflowEndpointGroupV2Output {
    ...
    pub fn createEphemeris(self: *Self, allocator: std.mem.Allocator, input: create_ephemeris.CreateEphemerisInput, options: CallOptions) !create_ephemeris.CreateEphemerisOutput {
    ...
    pub fn createMissionProfile(self: *Self, allocator: std.mem.Allocator, input: create_mission_profile.CreateMissionProfileInput, options: CallOptions) !create_mission_profile.CreateMissionProfileOutput {
        return create_mission_profile.execute(self, allocator, input, options);
    }

    /// Deletes a `Config`.
    pub fn deleteConfig(self: *Self, allocator: std.mem.Allocator, input: delete_config.DeleteConfigInput, options: CallOptions) !delete_config.DeleteConfigOutput {
        return delete_config.execute(self, allocator, input, options);
    }

    /// Deletes a dataflow endpoint group.
    pub fn deleteDataflowEndpointGroup(self: *Self, allocator: std.mem.Allocator, input: delete_dataflow_endpoint_group.DeleteDataflowEndpointGroupInput, options: CallOptions) !delete_dataflow_endpoint_group.DeleteDataflowEndpointGroupOutput {
        return delete_dataflow_endpoint_group.execute(self, allocator, input, options);
    }

    /// Delete an ephemeris.
    pub fn deleteEphemeris(self: *Self, allocator: std.mem.Allocator, input: delete_ephemeris.DeleteEphemerisInput, options: CallOptions) !delete_ephemeris.DeleteEphemerisOutput {
        return delete_ephemeris.execute(self, allocator, input, options);
    }

    /// Deletes a mission profile.
    pub fn deleteMissionProfile(self: *Self, allocator: std.mem.Allocator, input: delete_mission_profile.DeleteMissionProfileInput, options: CallOptions) !delete_mission_profile.DeleteMissionProfileOutput {
    ...
    pub fn getAgentConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_agent_configuration.GetAgentConfigurationInput, options: CallOptions) !get_agent_configuration.GetAgentConfigurationOutput {
    ...
    pub fn getAgentTaskResponseUrl(self: *Self, allocator: std.mem.Allocator, input: get_agent_task_response_url.GetAgentTaskResponseUrlInput, options: CallOptions) !get_agent_task_response_url.GetAgentTaskResponseUrlOutput {
    ...
    pub fn getDataflowEndpointGroup(self: *Self, allocator: std.mem.Allocator, input: get_dataflow_endpoint_group.GetDataflowEndpointGroupInput, options: CallOptions) !get_dataflow_endpoint_group.GetDataflowEndpointGroupOutput {
        return get_dataflow_endpoint_group.execute(self, allocator, input, options);
    }

    /// Returns the number of reserved minutes used by account.
    pub fn getMinuteUsage(self: *Self, allocator: std.mem.Allocator, input: get_minute_usage.GetMinuteUsageInput, options: CallOptions) !get_minute_usage.GetMinuteUsageOutput {
        return get_minute_usage.execute(self, allocator, input, options);
    }

    /// Returns a mission profile.
    pub fn getMissionProfile(self: *Self, allocator: std.mem.Allocator, input: get_mission_profile.GetMissionProfileInput, options: CallOptions) !get_mission_profile.GetMissionProfileOutput {
        return get_mission_profile.execute(self, allocator, input, options);
    }

    /// Returns a satellite.
    pub fn getSatellite(self: *Self, allocator: std.mem.Allocator, input: get_satellite.GetSatelliteInput, options: CallOptions) !get_satellite.GetSatelliteOutput {
    ...
    pub fn listDataflowEndpointGroups(self: *Self, allocator: std.mem.Allocator, input: list_dataflow_endpoint_groups.ListDataflowEndpointGroupsInput, options: CallOptions) !list_dataflow_endpoint_groups.ListDataflowEndpointGroupsOutput {
    ...
    pub fn listGroundStations(self: *Self, allocator: std.mem.Allocator, input: list_ground_stations.ListGroundStationsInput, options: CallOptions) !list_ground_stations.ListGroundStationsOutput {
        return list_ground_stations.execute(self, allocator, input, options);
    }

    /// Returns a list of mission profiles.
    pub fn listMissionProfiles(self: *Self, allocator: std.mem.Allocator, input: list_mission_profiles.ListMissionProfilesInput, options: CallOptions) !list_mission_profiles.ListMissionProfilesOutput {
        return list_mission_profiles.execute(self, allocator, input, options);
    }

    /// Returns a list of satellites.
    pub fn listSatellites(self: *Self, allocator: std.mem.Allocator, input: list_satellites.ListSatellitesInput, options: CallOptions) !list_satellites.ListSatellitesOutput {
    ...
    pub fn registerAgent(self: *Self, allocator: std.mem.Allocator, input: register_agent.RegisterAgentInput, options: CallOptions) !register_agent.RegisterAgentOutput {
        return register_agent.execute(self, allocator, input, options);
    }

    /// Reserves a contact using specified parameters.
    pub fn reserveContact(self: *Self, allocator: std.mem.Allocator, input: reserve_contact.ReserveContactInput, options: CallOptions) !reserve_contact.ReserveContactOutput {
    ...
    pub fn updateConfig(self: *Self, allocator: std.mem.Allocator, input: update_config.UpdateConfigInput, options: CallOptions) !update_config.UpdateConfigOutput {
    ...
    pub fn updateMissionProfile(self: *Self, allocator: std.mem.Allocator, input: update_mission_profile.UpdateMissionProfileInput, options: CallOptions) !update_mission_profile.UpdateMissionProfileOutput {
