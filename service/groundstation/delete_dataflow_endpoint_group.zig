...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataflowEndpointGroupInput, options: CallOptions) !DeleteDataflowEndpointGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDataflowEndpointGroupInput, config: *aws.Config) !aws.http.Request {
