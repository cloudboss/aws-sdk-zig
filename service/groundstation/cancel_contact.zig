...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelContactInput, options: CallOptions) !CancelContactOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelContactInput, config: *aws.Config) !aws.http.Request {
