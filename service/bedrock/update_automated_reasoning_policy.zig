...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAutomatedReasoningPolicyInput, options: CallOptions) !UpdateAutomatedReasoningPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateAutomatedReasoningPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.json.writeValue(@TypeOf(input.policy_definition), input.policy_definition, allocator, &body_buf);
    has_prev = true;
