...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAutomatedReasoningPolicyTestCasesInput, options: Options) !ListAutomatedReasoningPolicyTestCasesOutput {
