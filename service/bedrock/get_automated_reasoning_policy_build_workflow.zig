...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAutomatedReasoningPolicyBuildWorkflowInput, options: Options) !GetAutomatedReasoningPolicyBuildWorkflowOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAutomatedReasoningPolicyBuildWorkflowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetAutomatedReasoningPolicyBuildWorkflowOutput {
    var result: GetAutomatedReasoningPolicyBuildWorkflowOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetAutomatedReasoningPolicyBuildWorkflowOutput, body, alloc);
    }
    _ = status;
    _ = headers;
