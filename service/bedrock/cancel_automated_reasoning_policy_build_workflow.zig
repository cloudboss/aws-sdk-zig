...
pub const CancelAutomatedReasoningPolicyBuildWorkflowInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelAutomatedReasoningPolicyBuildWorkflowInput, options: Options) !CancelAutomatedReasoningPolicyBuildWorkflowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelAutomatedReasoningPolicyBuildWorkflowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelAutomatedReasoningPolicyBuildWorkflowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CancelAutomatedReasoningPolicyBuildWorkflowOutput = .{};
