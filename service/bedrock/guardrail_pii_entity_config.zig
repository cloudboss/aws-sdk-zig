...
pub const GuardrailPiiEntityConfig = struct {
    ...
    /// digits long and is often formatted as *month/year* or *MM/YY*. Guardrails
    ...
    ///
    /// The SIN is formatted as three groups of three digits, such as *123-456-789*.
    /// A SIN can be validated through a simple check-digit process called the [Luhn
    /// algorithm](https://www.wikipedia.org/wiki/Luhn_algorithm).
    ///
    /// * **UK Specific**
    ///
    ...
    /// 777 3456*. The current system formats the 10-digit number with spaces after
