...
pub const ListAutomatedReasoningPolicyBuildWorkflowsOutput = struct {
    ...
    automated_reasoning_policy_build_workflow_summaries: ?[]const AutomatedReasoningPolicyBuildWorkflowSummary = null,
    ...
    pub const json_field_names = .{
        .automated_reasoning_policy_build_workflow_summaries = "automatedReasoningPolicyBuildWorkflowSummaries",
        .next_token = "nextToken",
    };
};
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAutomatedReasoningPolicyBuildWorkflowsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAutomatedReasoningPolicyBuildWorkflowsOutput {
    var result: ListAutomatedReasoningPolicyBuildWorkflowsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAutomatedReasoningPolicyBuildWorkflowsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
