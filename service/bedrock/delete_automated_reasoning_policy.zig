...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAutomatedReasoningPolicyInput, options: Options) !DeleteAutomatedReasoningPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAutomatedReasoningPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAutomatedReasoningPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
