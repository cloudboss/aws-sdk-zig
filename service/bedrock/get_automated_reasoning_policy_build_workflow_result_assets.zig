...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAutomatedReasoningPolicyBuildWorkflowResultAssetsInput, options: Options) !GetAutomatedReasoningPolicyBuildWorkflowResultAssetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAutomatedReasoningPolicyBuildWorkflowResultAssetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(allocator, &query_buf, @tagName(input.asset_type));
    query_has_prev = true;
