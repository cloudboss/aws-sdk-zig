...
pub const Client = struct {
    ...
    pub fn batchDeleteEvaluationJob(self: *Self, allocator: std.mem.Allocator, input: batch_delete_evaluation_job.BatchDeleteEvaluationJobInput, options: batch_delete_evaluation_job.Options) !batch_delete_evaluation_job.BatchDeleteEvaluationJobOutput {
    ...
    /// policy rules.
    pub fn createAutomatedReasoningPolicy(self: *Self, allocator: std.mem.Allocator, input: create_automated_reasoning_policy.CreateAutomatedReasoningPolicyInput, options: create_automated_reasoning_policy.Options) !create_automated_reasoning_policy.CreateAutomatedReasoningPolicyOutput {
    ...
    pub fn createAutomatedReasoningPolicyTestCase(self: *Self, allocator: std.mem.Allocator, input: create_automated_reasoning_policy_test_case.CreateAutomatedReasoningPolicyTestCaseInput, options: create_automated_reasoning_policy_test_case.Options) !create_automated_reasoning_policy_test_case.CreateAutomatedReasoningPolicyTestCaseOutput {
    ...
    pub fn createAutomatedReasoningPolicyVersion(self: *Self, allocator: std.mem.Allocator, input: create_automated_reasoning_policy_version.CreateAutomatedReasoningPolicyVersionInput, options: create_automated_reasoning_policy_version.Options) !create_automated_reasoning_policy_version.CreateAutomatedReasoningPolicyVersionOutput {
    ...
    pub fn createCustomModel(self: *Self, allocator: std.mem.Allocator, input: create_custom_model.CreateCustomModelInput, options: create_custom_model.Options) !create_custom_model.CreateCustomModelOutput {
    ...
    pub fn createCustomModelDeployment(self: *Self, allocator: std.mem.Allocator, input: create_custom_model_deployment.CreateCustomModelDeploymentInput, options: create_custom_model_deployment.Options) !create_custom_model_deployment.CreateCustomModelDeploymentOutput {
        return create_custom_model_deployment.execute(self, allocator, input, options);
    }

    /// Creates an evaluation job.
    pub fn createEvaluationJob(self: *Self, allocator: std.mem.Allocator, input: create_evaluation_job.CreateEvaluationJobInput, options: create_evaluation_job.Options) !create_evaluation_job.CreateEvaluationJobOutput {
        return create_evaluation_job.execute(self, allocator, input, options);
    }

    /// Request a model access agreement for the specified model.
    pub fn createFoundationModelAgreement(self: *Self, allocator: std.mem.Allocator, input: create_foundation_model_agreement.CreateFoundationModelAgreementInput, options: create_foundation_model_agreement.Options) !create_foundation_model_agreement.CreateFoundationModelAgreementOutput {
    ...
    pub fn createGuardrail(self: *Self, allocator: std.mem.Allocator, input: create_guardrail.CreateGuardrailInput, options: create_guardrail.Options) !create_guardrail.CreateGuardrailOutput {
    ...
    pub fn createGuardrailVersion(self: *Self, allocator: std.mem.Allocator, input: create_guardrail_version.CreateGuardrailVersionInput, options: create_guardrail_version.Options) !create_guardrail_version.CreateGuardrailVersionOutput {
    ...
    pub fn createInferenceProfile(self: *Self, allocator: std.mem.Allocator, input: create_inference_profile.CreateInferenceProfileInput, options: create_inference_profile.Options) !create_inference_profile.CreateInferenceProfileOutput {
    ...
    pub fn createMarketplaceModelEndpoint(self: *Self, allocator: std.mem.Allocator, input: create_marketplace_model_endpoint.CreateMarketplaceModelEndpointInput, options: create_marketplace_model_endpoint.Options) !create_marketplace_model_endpoint.CreateMarketplaceModelEndpointOutput {
    ...
    pub fn createModelCopyJob(self: *Self, allocator: std.mem.Allocator, input: create_model_copy_job.CreateModelCopyJobInput, options: create_model_copy_job.Options) !create_model_copy_job.CreateModelCopyJobOutput {
    ...
    pub fn createModelCustomizationJob(self: *Self, allocator: std.mem.Allocator, input: create_model_customization_job.CreateModelCustomizationJobInput, options: create_model_customization_job.Options) !create_model_customization_job.CreateModelCustomizationJobOutput {
    ...
    pub fn createModelImportJob(self: *Self, allocator: std.mem.Allocator, input: create_model_import_job.CreateModelImportJobInput, options: create_model_import_job.Options) !create_model_import_job.CreateModelImportJobOutput {
    ...
    /// about the job.
    pub fn createModelInvocationJob(self: *Self, allocator: std.mem.Allocator, input: create_model_invocation_job.CreateModelInvocationJobInput, options: create_model_invocation_job.Options) !create_model_invocation_job.CreateModelInvocationJobOutput {
    ...
    pub fn createPromptRouter(self: *Self, allocator: std.mem.Allocator, input: create_prompt_router.CreatePromptRouterInput, options: create_prompt_router.Options) !create_prompt_router.CreatePromptRouterOutput {
    ...
    pub fn createProvisionedModelThroughput(self: *Self, allocator: std.mem.Allocator, input: create_provisioned_model_throughput.CreateProvisionedModelThroughputInput, options: create_provisioned_model_throughput.Options) !create_provisioned_model_throughput.CreateProvisionedModelThroughputOutput {
    ...
    pub fn deleteAutomatedReasoningPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_automated_reasoning_policy.DeleteAutomatedReasoningPolicyInput, options: delete_automated_reasoning_policy.Options) !delete_automated_reasoning_policy.DeleteAutomatedReasoningPolicyOutput {
    ...
    /// assets.
    pub fn deleteAutomatedReasoningPolicyBuildWorkflow(self: *Self, allocator: std.mem.Allocator, input: delete_automated_reasoning_policy_build_workflow.DeleteAutomatedReasoningPolicyBuildWorkflowInput, options: delete_automated_reasoning_policy_build_workflow.Options) !delete_automated_reasoning_policy_build_workflow.DeleteAutomatedReasoningPolicyBuildWorkflowOutput {
    ...
    pub fn deleteAutomatedReasoningPolicyTestCase(self: *Self, allocator: std.mem.Allocator, input: delete_automated_reasoning_policy_test_case.DeleteAutomatedReasoningPolicyTestCaseInput, options: delete_automated_reasoning_policy_test_case.Options) !delete_automated_reasoning_policy_test_case.DeleteAutomatedReasoningPolicyTestCaseOutput {
    ...
    /// [Custom
    /// models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn deleteCustomModel(self: *Self, allocator: std.mem.Allocator, input: delete_custom_model.DeleteCustomModelInput, options: delete_custom_model.Options) !delete_custom_model.DeleteCustomModelOutput {
    ...
    /// *
    ///   [ListCustomModelDeployments](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_ListCustomModelDeployments.html)
    pub fn deleteCustomModelDeployment(self: *Self, allocator: std.mem.Allocator, input: delete_custom_model_deployment.DeleteCustomModelDeploymentInput, options: delete_custom_model_deployment.Options) !delete_custom_model_deployment.DeleteCustomModelDeploymentOutput {
    ...
    pub fn deleteEnforcedGuardrailConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_enforced_guardrail_configuration.DeleteEnforcedGuardrailConfigurationInput, options: delete_enforced_guardrail_configuration.Options) !delete_enforced_guardrail_configuration.DeleteEnforcedGuardrailConfigurationOutput {
        return delete_enforced_guardrail_configuration.execute(self, allocator, input, options);
    }

    /// Delete the model access agreement for the specified model.
    pub fn deleteFoundationModelAgreement(self: *Self, allocator: std.mem.Allocator, input: delete_foundation_model_agreement.DeleteFoundationModelAgreementInput, options: delete_foundation_model_agreement.Options) !delete_foundation_model_agreement.DeleteFoundationModelAgreementOutput {
    ...
    ///   field.
    pub fn deleteGuardrail(self: *Self, allocator: std.mem.Allocator, input: delete_guardrail.DeleteGuardrailInput, options: delete_guardrail.Options) !delete_guardrail.DeleteGuardrailOutput {
    ...
    pub fn deleteImportedModel(self: *Self, allocator: std.mem.Allocator, input: delete_imported_model.DeleteImportedModelInput, options: delete_imported_model.Options) !delete_imported_model.DeleteImportedModelOutput {
    ...
    /// Bedrock](https://docs.aws.amazon.com/bedrock/latest/userguide/cross-region-inference.html). in the Amazon Bedrock User Guide.
    pub fn deleteInferenceProfile(self: *Self, allocator: std.mem.Allocator, input: delete_inference_profile.DeleteInferenceProfileInput, options: delete_inference_profile.Options) !delete_inference_profile.DeleteInferenceProfileOutput {
        return delete_inference_profile.execute(self, allocator, input, options);
    }

    /// Deletes an endpoint for a model from Amazon Bedrock Marketplace.
    pub fn deleteMarketplaceModelEndpoint(self: *Self, allocator: std.mem.Allocator, input: delete_marketplace_model_endpoint.DeleteMarketplaceModelEndpointInput, options: delete_marketplace_model_endpoint.Options) !delete_marketplace_model_endpoint.DeleteMarketplaceModelEndpointOutput {
        return delete_marketplace_model_endpoint.execute(self, allocator, input, options);
    }

    /// Delete the invocation logging.
    pub fn deleteModelInvocationLoggingConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_model_invocation_logging_configuration.DeleteModelInvocationLoggingConfigurationInput, options: delete_model_invocation_logging_configuration.Options) !delete_model_invocation_logging_configuration.DeleteModelInvocationLoggingConfigurationOutput {
        return delete_model_invocation_logging_configuration.execute(self, allocator, input, options);
    }

    /// Deletes a specified prompt router. This action cannot be undone.
    pub fn deletePromptRouter(self: *Self, allocator: std.mem.Allocator, input: delete_prompt_router.DeletePromptRouterInput, options: delete_prompt_router.Options) !delete_prompt_router.DeletePromptRouterOutput {
    ...
    /// Throughput](https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn deleteProvisionedModelThroughput(self: *Self, allocator: std.mem.Allocator, input: delete_provisioned_model_throughput.DeleteProvisionedModelThroughputInput, options: delete_provisioned_model_throughput.Options) !delete_provisioned_model_throughput.DeleteProvisionedModelThroughputOutput {
    ...
    pub fn deregisterMarketplaceModelEndpoint(self: *Self, allocator: std.mem.Allocator, input: deregister_marketplace_model_endpoint.DeregisterMarketplaceModelEndpointInput, options: deregister_marketplace_model_endpoint.Options) !deregister_marketplace_model_endpoint.DeregisterMarketplaceModelEndpointOutput {
    ...
    pub fn exportAutomatedReasoningPolicyVersion(self: *Self, allocator: std.mem.Allocator, input: export_automated_reasoning_policy_version.ExportAutomatedReasoningPolicyVersionInput, options: export_automated_reasoning_policy_version.Options) !export_automated_reasoning_policy_version.ExportAutomatedReasoningPolicyVersionOutput {
    ...
    /// timestamps.
    pub fn getAutomatedReasoningPolicy(self: *Self, allocator: std.mem.Allocator, input: get_automated_reasoning_policy.GetAutomatedReasoningPolicyInput, options: get_automated_reasoning_policy.Options) !get_automated_reasoning_policy.GetAutomatedReasoningPolicyOutput {
    ...
    pub fn getAutomatedReasoningPolicyAnnotations(self: *Self, allocator: std.mem.Allocator, input: get_automated_reasoning_policy_annotations.GetAutomatedReasoningPolicyAnnotationsInput, options: get_automated_reasoning_policy_annotations.Options) !get_automated_reasoning_policy_annotations.GetAutomatedReasoningPolicyAnnotationsOutput {
    ...
    pub fn getAutomatedReasoningPolicyBuildWorkflow(self: *Self, allocator: std.mem.Allocator, input: get_automated_reasoning_policy_build_workflow.GetAutomatedReasoningPolicyBuildWorkflowInput, options: get_automated_reasoning_policy_build_workflow.Options) !get_automated_reasoning_policy_build_workflow.GetAutomatedReasoningPolicyBuildWorkflowOutput {
    ...
    pub fn getAutomatedReasoningPolicyNextScenario(self: *Self, allocator: std.mem.Allocator, input: get_automated_reasoning_policy_next_scenario.GetAutomatedReasoningPolicyNextScenarioInput, options: get_automated_reasoning_policy_next_scenario.Options) !get_automated_reasoning_policy_next_scenario.GetAutomatedReasoningPolicyNextScenarioOutput {
        return get_automated_reasoning_policy_next_scenario.execute(self, allocator, input, options);
    }

    /// Retrieves details about a specific Automated Reasoning policy test.
    pub fn getAutomatedReasoningPolicyTestCase(self: *Self, allocator: std.mem.Allocator, input: get_automated_reasoning_policy_test_case.GetAutomatedReasoningPolicyTestCaseInput, options: get_automated_reasoning_policy_test_case.Options) !get_automated_reasoning_policy_test_case.GetAutomatedReasoningPolicyTestCaseOutput {
    ...
    pub fn getAutomatedReasoningPolicyTestResult(self: *Self, allocator: std.mem.Allocator, input: get_automated_reasoning_policy_test_result.GetAutomatedReasoningPolicyTestResultInput, options: get_automated_reasoning_policy_test_result.Options) !get_automated_reasoning_policy_test_result.GetAutomatedReasoningPolicyTestResultOutput {
    ...
    /// models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn getCustomModel(self: *Self, allocator: std.mem.Allocator, input: get_custom_model.GetCustomModelInput, options: get_custom_model.Options) !get_custom_model.GetCustomModelOutput {
    ...
    /// *
    ///   [DeleteCustomModelDeployment](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_DeleteCustomModelDeployment.html)
    pub fn getCustomModelDeployment(self: *Self, allocator: std.mem.Allocator, input: get_custom_model_deployment.GetCustomModelDeploymentInput, options: get_custom_model_deployment.Options) !get_custom_model_deployment.GetCustomModelDeploymentOutput {
        return get_custom_model_deployment.execute(self, allocator, input, options);
    }

    /// Gets information about an evaluation job, such as the status of the job.
    pub fn getEvaluationJob(self: *Self, allocator: std.mem.Allocator, input: get_evaluation_job.GetEvaluationJobInput, options: get_evaluation_job.Options) !get_evaluation_job.GetEvaluationJobOutput {
        return get_evaluation_job.execute(self, allocator, input, options);
    }

    /// Get details about a Amazon Bedrock foundation model.
    pub fn getFoundationModel(self: *Self, allocator: std.mem.Allocator, input: get_foundation_model.GetFoundationModelInput, options: get_foundation_model.Options) !get_foundation_model.GetFoundationModelOutput {
        return get_foundation_model.execute(self, allocator, input, options);
    }

    /// Get information about the Foundation model availability.
    pub fn getFoundationModelAvailability(self: *Self, allocator: std.mem.Allocator, input: get_foundation_model_availability.GetFoundationModelAvailabilityInput, options: get_foundation_model_availability.Options) !get_foundation_model_availability.GetFoundationModelAvailabilityOutput {
    ...
    pub fn getGuardrail(self: *Self, allocator: std.mem.Allocator, input: get_guardrail.GetGuardrailInput, options: get_guardrail.Options) !get_guardrail.GetGuardrailOutput {
        return get_guardrail.execute(self, allocator, input, options);
    }

    /// Gets properties associated with a customized model you imported.
    pub fn getImportedModel(self: *Self, allocator: std.mem.Allocator, input: get_imported_model.GetImportedModelInput, options: get_imported_model.Options) !get_imported_model.GetImportedModelOutput {
    ...
    /// [Increase throughput and resilience with cross-region inference in Amazon
    /// Bedrock](https://docs.aws.amazon.com/bedrock/latest/userguide/cross-region-inference.html). in the Amazon Bedrock User Guide.
    pub fn getInferenceProfile(self: *Self, allocator: std.mem.Allocator, input: get_inference_profile.GetInferenceProfileInput, options: get_inference_profile.Options) !get_inference_profile.GetInferenceProfileOutput {
    ...
    /// Marketplace.
    pub fn getMarketplaceModelEndpoint(self: *Self, allocator: std.mem.Allocator, input: get_marketplace_model_endpoint.GetMarketplaceModelEndpointInput, options: get_marketplace_model_endpoint.Options) !get_marketplace_model_endpoint.GetMarketplaceModelEndpointOutput {
    ...
    /// regions](https://docs.aws.amazon.com/bedrock/latest/userguide/copy-model.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn getModelCopyJob(self: *Self, allocator: std.mem.Allocator, input: get_model_copy_job.GetModelCopyJobInput, options: get_model_copy_job.Options) !get_model_copy_job.GetModelCopyJobOutput {
    ...
    /// models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn getModelCustomizationJob(self: *Self, allocator: std.mem.Allocator, input: get_model_customization_job.GetModelCustomizationJobInput, options: get_model_customization_job.Options) !get_model_customization_job.GetModelCustomizationJobOutput {
    ...
    /// model](https://docs.aws.amazon.com/bedrock/latest/userguide/model-customization-import-model.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn getModelImportJob(self: *Self, allocator: std.mem.Allocator, input: get_model_import_job.GetModelImportJobInput, options: get_model_import_job.Options) !get_model_import_job.GetModelImportJobOutput {
    ...
    pub fn getModelInvocationJob(self: *Self, allocator: std.mem.Allocator, input: get_model_invocation_job.GetModelInvocationJobInput, options: get_model_invocation_job.Options) !get_model_invocation_job.GetModelInvocationJobOutput {
        return get_model_invocation_job.execute(self, allocator, input, options);
    }

    /// Get the current configuration values for model invocation logging.
    pub fn getModelInvocationLoggingConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_model_invocation_logging_configuration.GetModelInvocationLoggingConfigurationInput, options: get_model_invocation_logging_configuration.Options) !get_model_invocation_logging_configuration.GetModelInvocationLoggingConfigurationOutput {
        return get_model_invocation_logging_configuration.execute(self, allocator, input, options);
    }

    /// Retrieves details about a prompt router.
    pub fn getPromptRouter(self: *Self, allocator: std.mem.Allocator, input: get_prompt_router.GetPromptRouterInput, options: get_prompt_router.Options) !get_prompt_router.GetPromptRouterOutput {
    ...
    /// [Provisioned
    /// Throughput](https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn getProvisionedModelThroughput(self: *Self, allocator: std.mem.Allocator, input: get_provisioned_model_throughput.GetProvisionedModelThroughputInput, options: get_provisioned_model_throughput.Options) !get_provisioned_model_throughput.GetProvisionedModelThroughputOutput {
        return get_provisioned_model_throughput.execute(self, allocator, input, options);
    }

    /// Get usecase for model access.
    pub fn getUseCaseForModelAccess(self: *Self, allocator: std.mem.Allocator, input: get_use_case_for_model_access.GetUseCaseForModelAccessInput, options: get_use_case_for_model_access.Options) !get_use_case_for_model_access.GetUseCaseForModelAccessOutput {
    ...
    /// policies.
    pub fn listAutomatedReasoningPolicies(self: *Self, allocator: std.mem.Allocator, input: list_automated_reasoning_policies.ListAutomatedReasoningPoliciesInput, options: list_automated_reasoning_policies.Options) !list_automated_reasoning_policies.ListAutomatedReasoningPoliciesOutput {
    ...
    pub fn listAutomatedReasoningPolicyBuildWorkflows(self: *Self, allocator: std.mem.Allocator, input: list_automated_reasoning_policy_build_workflows.ListAutomatedReasoningPolicyBuildWorkflowsInput, options: list_automated_reasoning_policy_build_workflows.Options) !list_automated_reasoning_policy_build_workflows.ListAutomatedReasoningPolicyBuildWorkflowsOutput {
    ...
    pub fn listAutomatedReasoningPolicyTestCases(self: *Self, allocator: std.mem.Allocator, input: list_automated_reasoning_policy_test_cases.ListAutomatedReasoningPolicyTestCasesInput, options: list_automated_reasoning_policy_test_cases.Options) !list_automated_reasoning_policy_test_cases.ListAutomatedReasoningPolicyTestCasesOutput {
    ...
    pub fn listAutomatedReasoningPolicyTestResults(self: *Self, allocator: std.mem.Allocator, input: list_automated_reasoning_policy_test_results.ListAutomatedReasoningPolicyTestResultsInput, options: list_automated_reasoning_policy_test_results.Options) !list_automated_reasoning_policy_test_results.ListAutomatedReasoningPolicyTestResultsOutput {
    ...
    /// *
    ///   [DeleteCustomModelDeployment](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_DeleteCustomModelDeployment.html)
    pub fn listCustomModelDeployments(self: *Self, allocator: std.mem.Allocator, input: list_custom_model_deployments.ListCustomModelDeploymentsInput, options: list_custom_model_deployments.Options) !list_custom_model_deployments.ListCustomModelDeploymentsOutput {
    ...
    /// For more information, see [Custom
    /// models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn listCustomModels(self: *Self, allocator: std.mem.Allocator, input: list_custom_models.ListCustomModelsInput, options: list_custom_models.Options) !list_custom_models.ListCustomModelsOutput {
        return list_custom_models.execute(self, allocator, input, options);
    }

    /// Lists the account-level enforced guardrail configurations.
    pub fn listEnforcedGuardrailsConfiguration(self: *Self, allocator: std.mem.Allocator, input: list_enforced_guardrails_configuration.ListEnforcedGuardrailsConfigurationInput, options: list_enforced_guardrails_configuration.Options) !list_enforced_guardrails_configuration.ListEnforcedGuardrailsConfigurationOutput {
        return list_enforced_guardrails_configuration.execute(self, allocator, input, options);
    }

    /// Lists all existing evaluation jobs.
    pub fn listEvaluationJobs(self: *Self, allocator: std.mem.Allocator, input: list_evaluation_jobs.ListEvaluationJobsInput, options: list_evaluation_jobs.Options) !list_evaluation_jobs.ListEvaluationJobsOutput {
        return list_evaluation_jobs.execute(self, allocator, input, options);
    }

    /// Get the offers associated with the specified model.
    pub fn listFoundationModelAgreementOffers(self: *Self, allocator: std.mem.Allocator, input: list_foundation_model_agreement_offers.ListFoundationModelAgreementOffersInput, options: list_foundation_model_agreement_offers.Options) !list_foundation_model_agreement_offers.ListFoundationModelAgreementOffersOutput {
    ...
    pub fn listFoundationModels(self: *Self, allocator: std.mem.Allocator, input: list_foundation_models.ListFoundationModelsInput, options: list_foundation_models.Options) !list_foundation_models.ListFoundationModelsOutput {
    ...
    pub fn listGuardrails(self: *Self, allocator: std.mem.Allocator, input: list_guardrails.ListGuardrailsInput, options: list_guardrails.Options) !list_guardrails.ListGuardrailsOutput {
    ...
    /// customized
    /// model](https://docs.aws.amazon.com/bedrock/latest/userguide/model-customization-import-model.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn listImportedModels(self: *Self, allocator: std.mem.Allocator, input: list_imported_models.ListImportedModelsInput, options: list_imported_models.Options) !list_imported_models.ListImportedModelsOutput {
    ...
    /// Amazon
    /// Bedrock](https://docs.aws.amazon.com/bedrock/latest/userguide/cross-region-inference.html). in the Amazon Bedrock User Guide.
    pub fn listInferenceProfiles(self: *Self, allocator: std.mem.Allocator, input: list_inference_profiles.ListInferenceProfilesInput, options: list_inference_profiles.Options) !list_inference_profiles.ListInferenceProfilesOutput {
    ...
    pub fn listMarketplaceModelEndpoints(self: *Self, allocator: std.mem.Allocator, input: list_marketplace_model_endpoints.ListMarketplaceModelEndpointsInput, options: list_marketplace_model_endpoints.Options) !list_marketplace_model_endpoints.ListMarketplaceModelEndpointsOutput {
    ...
    /// [Copy models to be used in other
    /// regions](https://docs.aws.amazon.com/bedrock/latest/userguide/copy-model.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn listModelCopyJobs(self: *Self, allocator: std.mem.Allocator, input: list_model_copy_jobs.ListModelCopyJobsInput, options: list_model_copy_jobs.Options) !list_model_copy_jobs.ListModelCopyJobsOutput {
    ...
    /// For more information, see [Custom
    /// models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn listModelCustomizationJobs(self: *Self, allocator: std.mem.Allocator, input: list_model_customization_jobs.ListModelCustomizationJobsInput, options: list_model_customization_jobs.Options) !list_model_customization_jobs.ListModelCustomizationJobsOutput {
    ...
    /// customized
    /// model](https://docs.aws.amazon.com/bedrock/latest/userguide/model-customization-import-model.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn listModelImportJobs(self: *Self, allocator: std.mem.Allocator, input: list_model_import_jobs.ListModelImportJobsInput, options: list_model_import_jobs.Options) !list_model_import_jobs.ListModelImportJobsOutput {
    ...
    pub fn listModelInvocationJobs(self: *Self, allocator: std.mem.Allocator, input: list_model_invocation_jobs.ListModelInvocationJobsInput, options: list_model_invocation_jobs.Options) !list_model_invocation_jobs.ListModelInvocationJobsOutput {
        return list_model_invocation_jobs.execute(self, allocator, input, options);
    }

    /// Retrieves a list of prompt routers.
    pub fn listPromptRouters(self: *Self, allocator: std.mem.Allocator, input: list_prompt_routers.ListPromptRoutersInput, options: list_prompt_routers.Options) !list_prompt_routers.ListPromptRoutersOutput {
    ...
    /// [Provisioned
    /// Throughput](https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn listProvisionedModelThroughputs(self: *Self, allocator: std.mem.Allocator, input: list_provisioned_model_throughputs.ListProvisionedModelThroughputsInput, options: list_provisioned_model_throughputs.Options) !list_provisioned_model_throughputs.ListProvisionedModelThroughputsOutput {
    ...
    pub fn putEnforcedGuardrailConfiguration(self: *Self, allocator: std.mem.Allocator, input: put_enforced_guardrail_configuration.PutEnforcedGuardrailConfigurationInput, options: put_enforced_guardrail_configuration.Options) !put_enforced_guardrail_configuration.PutEnforcedGuardrailConfigurationOutput {
        return put_enforced_guardrail_configuration.execute(self, allocator, input, options);
    }

    /// Set the configuration values for model invocation logging.
    pub fn putModelInvocationLoggingConfiguration(self: *Self, allocator: std.mem.Allocator, input: put_model_invocation_logging_configuration.PutModelInvocationLoggingConfigurationInput, options: put_model_invocation_logging_configuration.Options) !put_model_invocation_logging_configuration.PutModelInvocationLoggingConfigurationOutput {
        return put_model_invocation_logging_configuration.execute(self, allocator, input, options);
    }

    /// Put usecase for model access.
    pub fn putUseCaseForModelAccess(self: *Self, allocator: std.mem.Allocator, input: put_use_case_for_model_access.PutUseCaseForModelAccessInput, options: put_use_case_for_model_access.Options) !put_use_case_for_model_access.PutUseCaseForModelAccessOutput {
    ...
    pub fn registerMarketplaceModelEndpoint(self: *Self, allocator: std.mem.Allocator, input: register_marketplace_model_endpoint.RegisterMarketplaceModelEndpointInput, options: register_marketplace_model_endpoint.Options) !register_marketplace_model_endpoint.RegisterMarketplaceModelEndpointOutput {
    ...
    pub fn startAutomatedReasoningPolicyBuildWorkflow(self: *Self, allocator: std.mem.Allocator, input: start_automated_reasoning_policy_build_workflow.StartAutomatedReasoningPolicyBuildWorkflowInput, options: start_automated_reasoning_policy_build_workflow.Options) !start_automated_reasoning_policy_build_workflow.StartAutomatedReasoningPolicyBuildWorkflowOutput {
    ...
    /// validation results.
    pub fn startAutomatedReasoningPolicyTestWorkflow(self: *Self, allocator: std.mem.Allocator, input: start_automated_reasoning_policy_test_workflow.StartAutomatedReasoningPolicyTestWorkflowInput, options: start_automated_reasoning_policy_test_workflow.Options) !start_automated_reasoning_policy_test_workflow.StartAutomatedReasoningPolicyTestWorkflowOutput {
        return start_automated_reasoning_policy_test_workflow.execute(self, allocator, input, options);
    }

    /// Stops an evaluation job that is current being created or running.
    pub fn stopEvaluationJob(self: *Self, allocator: std.mem.Allocator, input: stop_evaluation_job.StopEvaluationJobInput, options: stop_evaluation_job.Options) !stop_evaluation_job.StopEvaluationJobOutput {
    ...
    /// models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn stopModelCustomizationJob(self: *Self, allocator: std.mem.Allocator, input: stop_model_customization_job.StopModelCustomizationJobInput, options: stop_model_customization_job.Options) !stop_model_customization_job.StopModelCustomizationJobOutput {
    ...
    pub fn stopModelInvocationJob(self: *Self, allocator: std.mem.Allocator, input: stop_model_invocation_job.StopModelInvocationJobInput, options: stop_model_invocation_job.Options) !stop_model_invocation_job.StopModelInvocationJobOutput {
    ...
    /// previous version.
    pub fn updateAutomatedReasoningPolicy(self: *Self, allocator: std.mem.Allocator, input: update_automated_reasoning_policy.UpdateAutomatedReasoningPolicyInput, options: update_automated_reasoning_policy.Options) !update_automated_reasoning_policy.UpdateAutomatedReasoningPolicyOutput {
    ...
    pub fn updateAutomatedReasoningPolicyAnnotations(self: *Self, allocator: std.mem.Allocator, input: update_automated_reasoning_policy_annotations.UpdateAutomatedReasoningPolicyAnnotationsInput, options: update_automated_reasoning_policy_annotations.Options) !update_automated_reasoning_policy_annotations.UpdateAutomatedReasoningPolicyAnnotationsOutput {
    ...
    pub fn updateAutomatedReasoningPolicyTestCase(self: *Self, allocator: std.mem.Allocator, input: update_automated_reasoning_policy_test_case.UpdateAutomatedReasoningPolicyTestCaseInput, options: update_automated_reasoning_policy_test_case.Options) !update_automated_reasoning_policy_test_case.UpdateAutomatedReasoningPolicyTestCaseOutput {
    ...
    pub fn updateCustomModelDeployment(self: *Self, allocator: std.mem.Allocator, input: update_custom_model_deployment.UpdateCustomModelDeploymentInput, options: update_custom_model_deployment.Options) !update_custom_model_deployment.UpdateCustomModelDeploymentOutput {
    ...
    ///   field.
    pub fn updateGuardrail(self: *Self, allocator: std.mem.Allocator, input: update_guardrail.UpdateGuardrailInput, options: update_guardrail.Options) !update_guardrail.UpdateGuardrailOutput {
    ...
    /// Bedrock Marketplace.
    pub fn updateMarketplaceModelEndpoint(self: *Self, allocator: std.mem.Allocator, input: update_marketplace_model_endpoint.UpdateMarketplaceModelEndpointInput, options: update_marketplace_model_endpoint.Options) !update_marketplace_model_endpoint.UpdateMarketplaceModelEndpointOutput {
    ...
    /// information, see [Provisioned
    /// Throughput](https://docs.aws.amazon.com/bedrock/latest/userguide/prov-throughput.html) in the [Amazon Bedrock User Guide](https://docs.aws.amazon.com/bedrock/latest/userguide/what-is-service.html).
    pub fn updateProvisionedModelThroughput(self: *Self, allocator: std.mem.Allocator, input: update_provisioned_model_throughput.UpdateProvisionedModelThroughputInput, options: update_provisioned_model_throughput.Options) !update_provisioned_model_throughput.UpdateProvisionedModelThroughputOutput {
