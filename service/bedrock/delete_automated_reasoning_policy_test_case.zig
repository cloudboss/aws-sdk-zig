...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAutomatedReasoningPolicyTestCaseInput, options: Options) !DeleteAutomatedReasoningPolicyTestCaseOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAutomatedReasoningPolicyTestCaseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAutomatedReasoningPolicyTestCaseOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
