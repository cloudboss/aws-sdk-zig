...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListModelCustomizationJobsInput, options: Options) !ListModelCustomizationJobsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListModelCustomizationJobsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListModelCustomizationJobsOutput {
    var result: ListModelCustomizationJobsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListModelCustomizationJobsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
