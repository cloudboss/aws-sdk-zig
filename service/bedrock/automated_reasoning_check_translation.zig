...
const AutomatedReasoningCheckInputTextReference = @import("automated_reasoning_check_input_text_reference.zig").AutomatedReasoningCheckInputTextReference;
...
pub const AutomatedReasoningCheckTranslation = struct {
