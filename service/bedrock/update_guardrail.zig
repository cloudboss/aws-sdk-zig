...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateGuardrailInput, options: CallOptions) !UpdateGuardrailOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateGuardrailInput, config: *aws.Config) !aws.http.Request {
