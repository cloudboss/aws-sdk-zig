...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetHealthEventInput, options: CallOptions) !GetHealthEventOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetHealthEventInput, config: *aws.Config) !aws.http.Request {
