...
pub const ListHealthEventsPaginator = struct {
    client: *Client,
    params: list_health_events.ListHealthEventsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_health_events.Options) !list_health_events.ListHealthEventsOutput {
        ...
        const output = try list_health_events.execute(self.client, allocator, self.params, options);
...
pub const ListInternetEventsPaginator = struct {
    client: *Client,
    params: list_internet_events.ListInternetEventsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_internet_events.Options) !list_internet_events.ListInternetEventsOutput {
        ...
        const output = try list_internet_events.execute(self.client, allocator, self.params, options);
