...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableProfileInput, options: CallOptions) !EnableProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: EnableProfileInput, config: *aws.Config) !aws.http.Request {
