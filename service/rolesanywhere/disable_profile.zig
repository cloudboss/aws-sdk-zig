...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableProfileInput, options: CallOptions) !DisableProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableProfileInput, config: *aws.Config) !aws.http.Request {
