...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateImageBuilderStreamingURLInput, options: Options) !CreateImageBuilderStreamingURLOutput {
