...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSessionsInput, options: Options) !DescribeSessionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeSessionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PhotonAdminProxyService.DescribeSessions");
