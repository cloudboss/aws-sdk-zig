...
pub const DisassociateApplicationFromEntitlementInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateApplicationFromEntitlementInput, options: Options) !DisassociateApplicationFromEntitlementOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateApplicationFromEntitlementInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "PhotonAdminProxyService.DisassociateApplicationFromEntitlement");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateApplicationFromEntitlementOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
