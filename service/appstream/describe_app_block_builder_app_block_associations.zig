...
pub const DescribeAppBlockBuilderAppBlockAssociationsInput = struct {
    /// The ARN of the app block.
    app_block_arn: ?[]const u8 = null,

    /// The name of the app block builder.
    app_block_builder_name: ?[]const u8 = null,
...
pub const DescribeAppBlockBuilderAppBlockAssociationsOutput = struct {
    /// This list of app block builders associated with app blocks.
    app_block_builder_app_block_associations: ?[]const AppBlockBuilderAppBlockAssociation = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAppBlockBuilderAppBlockAssociationsInput, options: CallOptions) !DescribeAppBlockBuilderAppBlockAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAppBlockBuilderAppBlockAssociationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "PhotonAdminProxyService.DescribeAppBlockBuilderAppBlockAssociations");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeAppBlockBuilderAppBlockAssociationsOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeAppBlockBuilderAppBlockAssociationsOutput, body, allocator);
}
