...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAppBlockBuilderStreamingURLInput, options: Options) !CreateAppBlockBuilderStreamingURLOutput {
