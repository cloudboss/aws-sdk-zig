...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateAppBlockBuilderAppBlockInput, options: Options) !AssociateAppBlockBuilderAppBlockOutput {
