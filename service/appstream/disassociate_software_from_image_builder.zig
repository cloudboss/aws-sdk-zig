...
pub const DisassociateSoftwareFromImageBuilderInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateSoftwareFromImageBuilderInput, options: Options) !DisassociateSoftwareFromImageBuilderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateSoftwareFromImageBuilderInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "PhotonAdminProxyService.DisassociateSoftwareFromImageBuilder");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateSoftwareFromImageBuilderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
