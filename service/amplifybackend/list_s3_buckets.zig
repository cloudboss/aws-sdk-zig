...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListS3BucketsInput, options: CallOptions) !ListS3BucketsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListS3BucketsInput, config: *aws.Config) !aws.http.Request {
