...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBackendStorageInput, options: CallOptions) !GetBackendStorageOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBackendStorageInput, config: *aws.Config) !aws.http.Request {
