...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateBackendJobInput, options: CallOptions) !UpdateBackendJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateBackendJobInput, config: *aws.Config) !aws.http.Request {
