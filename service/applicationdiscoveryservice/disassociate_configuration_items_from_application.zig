...
pub const DisassociateConfigurationItemsFromApplicationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateConfigurationItemsFromApplicationInput, options: Options) !DisassociateConfigurationItemsFromApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateConfigurationItemsFromApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSPoseidonService_V2015_11_01.DisassociateConfigurationItemsFromApplication");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateConfigurationItemsFromApplicationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
