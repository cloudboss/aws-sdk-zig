...
pub const DeleteApplicationsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteApplicationsInput, options: Options) !DeleteApplicationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteApplicationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSPoseidonService_V2015_11_01.DeleteApplications");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteApplicationsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
