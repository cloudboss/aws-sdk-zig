...
pub const AssociateConfigurationItemsToApplicationInput = struct {
    /// The configuration ID of an application with which items are to be
    /// associated.
    application_configuration_id: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateConfigurationItemsToApplicationInput, options: Options) !AssociateConfigurationItemsToApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateConfigurationItemsToApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSPoseidonService_V2015_11_01.AssociateConfigurationItemsToApplication");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateConfigurationItemsToApplicationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
