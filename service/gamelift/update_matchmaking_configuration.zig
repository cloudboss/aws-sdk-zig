...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateMatchmakingConfigurationInput, options: Options) !UpdateMatchmakingConfigurationOutput {
