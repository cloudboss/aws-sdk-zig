...
pub const ValidateMatchmakingRuleSetInput = struct {
...
pub const ValidateMatchmakingRuleSetOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ValidateMatchmakingRuleSetInput, options: CallOptions) !ValidateMatchmakingRuleSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ValidateMatchmakingRuleSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GameLift.ValidateMatchmakingRuleSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ValidateMatchmakingRuleSetOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ValidateMatchmakingRuleSetOutput, body, allocator);
}
