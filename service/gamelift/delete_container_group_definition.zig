...
pub const DeleteContainerGroupDefinitionInput = struct {
    ...
    pub const json_field_names = .{
        .name = "Name",
        .version_count_to_retain = "VersionCountToRetain",
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContainerGroupDefinitionInput, options: Options) !DeleteContainerGroupDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteContainerGroupDefinitionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GameLift.DeleteContainerGroupDefinition");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteContainerGroupDefinitionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
