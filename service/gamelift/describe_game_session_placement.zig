...
pub const DescribeGameSessionPlacementInput = struct {
...
pub const DescribeGameSessionPlacementOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeGameSessionPlacementInput, options: CallOptions) !DescribeGameSessionPlacementOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeGameSessionPlacementInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GameLift.DescribeGameSessionPlacement");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeGameSessionPlacementOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeGameSessionPlacementOutput, body, allocator);
}
