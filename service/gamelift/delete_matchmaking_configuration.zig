...
pub const DeleteMatchmakingConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMatchmakingConfigurationInput, options: Options) !DeleteMatchmakingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMatchmakingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GameLift.DeleteMatchmakingConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMatchmakingConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
