...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateVpcPeeringConnectionInput, options: Options) !CreateVpcPeeringConnectionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateVpcPeeringConnectionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "GameLift.CreateVpcPeeringConnection");
