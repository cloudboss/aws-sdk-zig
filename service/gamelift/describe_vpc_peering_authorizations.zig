...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVpcPeeringAuthorizationsInput, options: Options) !DescribeVpcPeeringAuthorizationsOutput {
