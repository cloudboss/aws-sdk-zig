...
const DeleteScalingPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteScalingPolicyInput, options: Options) !DeleteScalingPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteScalingPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GameLift.DeleteScalingPolicy");
