...
const accept_match = @import("accept_match.zig");
const claim_game_server = @import("claim_game_server.zig");
const create_alias = @import("create_alias.zig");
const create_build = @import("create_build.zig");
const create_container_fleet = @import("create_container_fleet.zig");
const create_container_group_definition = @import("create_container_group_definition.zig");
const create_fleet = @import("create_fleet.zig");
const create_fleet_locations = @import("create_fleet_locations.zig");
const create_game_server_group = @import("create_game_server_group.zig");
const create_game_session = @import("create_game_session.zig");
const create_game_session_queue = @import("create_game_session_queue.zig");
const create_location = @import("create_location.zig");
const create_matchmaking_configuration = @import("create_matchmaking_configuration.zig");
const create_matchmaking_rule_set = @import("create_matchmaking_rule_set.zig");
const create_player_session = @import("create_player_session.zig");
const create_player_sessions = @import("create_player_sessions.zig");
const create_script = @import("create_script.zig");
const create_vpc_peering_authorization = @import("create_vpc_peering_authorization.zig");
const create_vpc_peering_connection = @import("create_vpc_peering_connection.zig");
const delete_alias = @import("delete_alias.zig");
const delete_build = @import("delete_build.zig");
const delete_container_fleet = @import("delete_container_fleet.zig");
const delete_container_group_definition = @import("delete_container_group_definition.zig");
const delete_fleet = @import("delete_fleet.zig");
const delete_fleet_locations = @import("delete_fleet_locations.zig");
const delete_game_server_group = @import("delete_game_server_group.zig");
const delete_game_session_queue = @import("delete_game_session_queue.zig");
const delete_location = @import("delete_location.zig");
const delete_matchmaking_configuration = @import("delete_matchmaking_configuration.zig");
const delete_matchmaking_rule_set = @import("delete_matchmaking_rule_set.zig");
const delete_scaling_policy = @import("delete_scaling_policy.zig");
const delete_script = @import("delete_script.zig");
const delete_vpc_peering_authorization = @import("delete_vpc_peering_authorization.zig");
const delete_vpc_peering_connection = @import("delete_vpc_peering_connection.zig");
const deregister_compute = @import("deregister_compute.zig");
const deregister_game_server = @import("deregister_game_server.zig");
const describe_alias = @import("describe_alias.zig");
const describe_build = @import("describe_build.zig");
...
const describe_fleet_deployment = @import("describe_fleet_deployment.zig");
...
const describe_fleet_location_capacity = @import("describe_fleet_location_capacity.zig");
const describe_fleet_location_utilization = @import("describe_fleet_location_utilization.zig");
const describe_fleet_port_settings = @import("describe_fleet_port_settings.zig");
const describe_fleet_utilization = @import("describe_fleet_utilization.zig");
const describe_game_server = @import("describe_game_server.zig");
const describe_game_server_group = @import("describe_game_server_group.zig");
...
const describe_game_session_placement = @import("describe_game_session_placement.zig");
...
const describe_matchmaking = @import("describe_matchmaking.zig");
...
const describe_runtime_configuration = @import("describe_runtime_configuration.zig");
const describe_scaling_policies = @import("describe_scaling_policies.zig");
const describe_script = @import("describe_script.zig");
const describe_vpc_peering_authorizations = @import("describe_vpc_peering_authorizations.zig");
const describe_vpc_peering_connections = @import("describe_vpc_peering_connections.zig");
const get_compute_access = @import("get_compute_access.zig");
...
const register_compute = @import("register_compute.zig");
const register_game_server = @import("register_game_server.zig");
const request_upload_credentials = @import("request_upload_credentials.zig");
const resolve_alias = @import("resolve_alias.zig");
const resume_game_server_group = @import("resume_game_server_group.zig");
const search_game_sessions = @import("search_game_sessions.zig");
const start_fleet_actions = @import("start_fleet_actions.zig");
const start_game_session_placement = @import("start_game_session_placement.zig");
const start_match_backfill = @import("start_match_backfill.zig");
const start_matchmaking = @import("start_matchmaking.zig");
const stop_fleet_actions = @import("stop_fleet_actions.zig");
const stop_game_session_placement = @import("stop_game_session_placement.zig");
const stop_matchmaking = @import("stop_matchmaking.zig");
const suspend_game_server_group = @import("suspend_game_server_group.zig");
const tag_resource = @import("tag_resource.zig");
const terminate_game_session = @import("terminate_game_session.zig");
const untag_resource = @import("untag_resource.zig");
const update_alias = @import("update_alias.zig");
const update_build = @import("update_build.zig");
const update_container_fleet = @import("update_container_fleet.zig");
const update_container_group_definition = @import("update_container_group_definition.zig");
const update_fleet_attributes = @import("update_fleet_attributes.zig");
const update_fleet_capacity = @import("update_fleet_capacity.zig");
const update_fleet_port_settings = @import("update_fleet_port_settings.zig");
const update_game_server = @import("update_game_server.zig");
const update_game_server_group = @import("update_game_server_group.zig");
const update_game_session = @import("update_game_session.zig");
const update_game_session_queue = @import("update_game_session_queue.zig");
const update_matchmaking_configuration = @import("update_matchmaking_configuration.zig");
...
pub const Client = struct {
    ...
    /// useful when
    /// redirecting player traffic from one fleet to another, such as when updating
    /// your game
    /// build.
    ///
    ...
    /// Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/UploadingObjects.html) in
    ...
    /// servers. Use this operation to define how to deploy a container architecture
    /// onto each
    ...
    /// deploys one or more replicas of this container group to each fleet instance.
    /// The
    ...
    /// instance.
    ///
    /// Each container group can include the definition for one or more containers.
    /// A
    ...
    /// **Results**
    ///
    /// If successful, this operation creates a new container fleet resource, places
    /// it in
    /// `PENDING` status, and initiates the [fleet creation
    /// workflow](https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-creating-all.html#fleets-creation-workflow). For fleets with container groups, this workflow
    ...
    ///
    /// A managed fleet's runtime environment depends on the Amazon Machine Image
    /// (AMI)
    ...
    /// fleet
    /// are deployed with that version. To update the AMI version, you must create a
    /// new
    /// fleet. As a best practice, we recommend replacing your managed fleets every
    /// 30
    ...
    /// hosting. An Amazon GameLift Servers container group
    /// is similar to a container task or pod. Use container group definitions when
    /// you create a
    ...
    /// container.
    /// Alternatively, you can separate the software into one game server container
    /// and one or
    /// more support containers.
    ///
    /// On a container fleet instance, a game server container group can be deployed
    /// multiple
    /// times (depending on the compute resources of the instance). This means that
    /// all containers
    ...
    /// for Amazon GameLift
    /// Servers](https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-iam-policy-examples.html) for help setting the appropriate permissions.
    ///
    /// **Request options**
    ///
    ...
    /// **Results**
    ///
    /// If successful, this request creates a `ContainerGroupDefinition` resource
    /// and
    ...
    /// `NEW` status while Amazon GameLift Servers initiates the [fleet creation
    /// workflow](https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-creating-all.html#fleets-creation-workflow). To debug your fleet, fetch logs, view performance
    ...
    ///
    /// [Update fleet
    /// locations](https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-editing.html#fleets-update-locations)
    ///
    /// [
    ...
    /// in your
    /// Amazon Web Services account, and establishes a link between the two groups.
    ...
    /// see
    /// [Create IAM
    /// roles for cross-service
    /// interaction](https://docs.aws.amazon.com/gamelift/latest/fleetiqguide/gsg-iam-permissions-roles.html) in the *Amazon GameLift Servers FleetIQ Developer
    /// Guide*.
    ///
    ...
    /// the group. You
    /// must also set initial maximum and minimum limits on the group's instance
    /// count. You can
    ...
    /// you have
    /// full access to change the Auto Scaling group's configuration as needed.
    /// Several
    ...
    /// and
    /// provide a set of game session configuration settings. The target fleet must
    /// be in
    /// `ACTIVE` status.
    ///
    ...
    /// [UpdateGameSession](https://docs.aws.amazon.com/gamelift/latest/apireference/API_UpdateGameSession.html) to change the game session's player session creation
    /// policy.
    ///
    ...
    /// combination of
    /// location, hosting cost, and player latency. You can set up the queue to use
    /// the default
    ...
    /// session
    /// requests with
    /// [StartGameSessionPlacement](https://docs.aws.amazon.com/gamelift/latest/apireference/API_StartGameSessionPlacement.html) or [StartMatchmaking](https://docs.aws.amazon.com/gamelift/latest/apireference/API_StartMatchmaking.html).
    ///
    /// **Learn more**
    ///
    /// [
    ...
    /// you're also
    /// using Amazon GameLift Servers hosting, it defines how to start game sessions
    /// for each match. Your
    ...
    /// type of match
    /// to create, such as the number and size of teams. It also sets the parameters
    /// for
    ...
    /// sessions can
    /// be created in any game session with an open slot that is in `ACTIVE` status
    /// and has a player creation policy of `ACCEPT_ALL`. To add a single player to
    /// a
    /// game session, use
    ...
    /// script. Realtime scripts are JavaScript that
    ...
    /// file(s).
    /// The script files and all dependencies must be zipped into a single file. You
    /// can pull
    ...
    /// bucket and the script record's storage location reflects this location. If
    /// the script
    /// file is provided as an S3 bucket, Amazon GameLift Servers accesses the file
    /// at this storage location as
    /// needed for deployment.
    ///
    /// **Learn more**
    ///
    /// [Amazon GameLift Servers Amazon GameLift Servers
    /// Realtime](https://docs.aws.amazon.com/gamelift/latest/developerguide/realtime-intro.html)
    ///
    /// [Set Up a Role for Amazon GameLift Servers
    ...
    /// Amazon Web Services account. VPC peering enables the game servers on
    ...
    /// for your Amazon GameLift Servers fleet. VPC peering enables the game servers
    /// on your fleet to communicate
    /// directly with other Amazon Web Services resources. You can peer with VPCs in
    /// any Amazon Web Services account that
    ...
    /// see [VPC
    /// Peering with Amazon GameLift Servers
    /// Fleets](https://docs.aws.amazon.com/gamelift/latest/developerguide/vpc-peering.html).
    ///
    ...
    /// establish
    /// the connection. These two operations handle all tasks necessary to peer the
    /// two VPCs,
    ...
    /// to manage the Amazon GameLift Servers fleets. Identify the following values:
    /// (1) The ID of the fleet you
    ...
    /// down
    /// currently running fleet instances, including those in remote locations. The
    /// container
    ...
    /// options for how
    /// these resources are impacted when deleting the game server group. Depending
    /// on the type
    ...
    /// The game
    /// server group status is changed to `DELETE_SCHEDULED`, which prevents new
    /// game
    ...
    /// **This API works with the following fleet types:** Anywhere
    ///
    /// Removes a compute resource from an Anywhere fleet. Deregistered computes can
    /// no longer
    /// host game sessions through Amazon GameLift Servers. Use this operation with
    /// an Anywhere fleet that
    ...
    /// **Request options**
    ///
    /// Provide the fleet ID and compute name. The compute name varies depending on
    /// the type
    /// of fleet.
    ///
    ...
    /// location, that
    /// your Amazon Web Services account can use. Learn more at [Amazon EC2 Instance
    /// Types](http://aws.amazon.com/ec2/instance-types/). The information
    ...
    /// Amazon Web Services Region by fleets that reside in the same Region: Specify
    /// the Region only.
    ...
    /// Region: Provide both
    /// the Amazon Web Services Region and the remote location. Optionally, specify
    /// a single instance
    ...
    /// changes in
    /// status, such as during fleet creation and termination, changes in capacity,
    /// etc. If a
    /// fleet has multiple locations, events are also initiated by changes to status
    ...
    /// settings for
    /// the requested fleet location. For a managed container fleet, this operation
    /// also returns counts
    ...
    /// this operation
    /// to retrieve utilization information for a fleet's remote location or home
    /// Region (you
    ...
    ///
    /// If successful, a
    /// [FleetUtilization](https://docs.aws.amazon.com/gamelift/latest/apireference/API_FleetUtilization.html) object is returned for each requested fleet ID, unless the
    ...
    /// request. If a
    /// request exceeds this limit, the request fails and the error message includes
    /// the
    /// maximum allowed.
    ///
    /// **Learn more**
    ...
    /// game server group. This operation returns only properties related to Amazon
    /// GameLift Servers FleetIQ. To view or
    ...
    /// alternative,
    /// use the operations
    /// [https://docs.aws.amazon.com/gamelift/latest/apireference/API_ListCompute](https://docs.aws.amazon.com/gamelift/latest/apireference/API_ListCompute) and [https://docs.aws.amazon.com/gamelift/latest/apireference/API_DescribeCompute](https://docs.aws.amazon.com/gamelift/latest/apireference/API_DescribeCompute)
    ...
    /// When
    /// requesting multiple items, use the pagination parameters to retrieve results
    /// as a set of
    ...
    /// provide
    /// a specific `PlayerSessionId` or `PlayerId`, Amazon GameLift Servers ignores
    /// the filter criteria.
    /// Use the pagination parameters to retrieve results as a set of sequential
    /// pages.
    ///
    ...
    /// fleet. This operation is not used with Amazon GameLift Servers Anywhere
    /// fleets.
    ///
    /// **Request options**
    ///
    ...
    /// fleet. Game servers that are running on the compute use this token to
    /// communicate
    ...
    ///
    /// * [Test your
    /// integration](https://docs.aws.amazon.com/gamelift/latest/developerguide/integration-testing.html)
    ///
    /// * [Server SDK
    /// reference
    ...
    /// session on
    /// Amazon GameLift Servers managed fleets. When a game session is terminated,
    /// Amazon GameLift Servers automatically stores
    /// the logs in Amazon S3 and retains them for 14 days. Use this URL to download
    /// the logs.
    ///
    /// See the [Amazon Web Services Service
    /// Limits](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_gamelift) page for maximum log file sizes. Log files that exceed this limit
    /// are not saved.
    ///
    /// [All APIs by
    /// task](https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets)
    ...
    /// instance](https://docs.aws.amazon.com/gamelift/latest/apireference/API_GetInstanceAccess.html#API_GetInstanceAccess_Examples) for tips on automatically
    ...
    ///   container
    /// group definition name or ARN value. (If the ARN value has a version number,
    /// it's
    /// ignored.)
    ///
    /// **Results:**
    ...
    /// and Amazon Web Services Region. Use the pagination parameters to retrieve
    /// results in a set of sequential
    /// pages.
    ///
    ...
    /// You can filter the
    /// result set to find only those fleets that are deployed with a specific build
    /// or script.
    ...
    /// servers that are currently active in a specified game server group. You can
    /// opt to sort
    ...
    /// resource tags to organize Amazon Web Services
    ...
    /// created. If the
    /// fleet's auto-scaling actions are temporarily suspended, the new policy will
    /// be in force
    ...
    /// and fleet
    /// ID, and set the policy type to "RuleBased". Specify the parameter values for
    /// a policy
    ...
    /// endpoint or Agent endpoint. Game server processes running on the compute can
    /// use this
    ...
    /// the game
    /// server is running, and provide a unique identifier for the game server. You
    /// can also
    ...
    /// game build
    /// files to Amazon GameLift Servers's Amazon S3. This is done as part of the
    /// build creation process; see
    ...
    /// location, provide a fleet or alias ID and a location name. For location, you
    /// can
    ...
    ///   custom data in a game session.
    /// For example: `{"Key": "difficulty", "Value": "novice"}`.
    /// The filter expression must specify the
    /// [https://docs.aws.amazon.com/gamelift/latest/apireference/API_GameProperty](https://docs.aws.amazon.com/gamelift/latest/apireference/API_GameProperty) -- a `Key` and a string `Value` to search for the game sessions.
    ///
    ...
    /// indicating whether a game session has reached its maximum number of players.
    /// It
    /// is highly recommended that all search requests include this filter attribute
    /// to
    ...
    /// [PriorityConfiguration](https://docs.aws.amazon.com/gamelift/latest/apireference/API_PriorityConfiguration.html) for game session queues), you can
    ...
    /// [DescribeGameSessionPlacement](https://docs.aws.amazon.com/gamelift/latest/apireference/API_DescribeGameSessionPlacement.html) or by monitoring queue notifications. When the
    ...
    /// a client service by calling this operation with a `GameSessions` ID. You
    /// also
    /// have the option of making backfill requests directly from your game server.
    /// In response
    /// to a request, FlexMatch creates player sessions for the new players, updates
    /// the
    ...
    /// session being
    /// backfilled. Optionally, specify the `GameSession` ARN. If successful, a
    /// match
    ...
    /// matchmaking
    /// rules. With games that use Amazon GameLift Servers managed hosting, this
    ...
    /// build a match that includes all players in the request, placing them in the
    /// same team
    ...
    /// operation is
    /// used to stop auto-scaling activity. For multi-location fleets, fleet actions
    /// are managed
    ...
    /// session.
    /// This is for game sessions that are created with a matchmaking configuration
    /// that has
    ...
    /// evaluates the current game hosting viability of all Spot instance types that
    /// are
    ...
    /// protection, utilization metrics, and capacity scaling activities continue to
    /// be
    /// active.
    ///
    ...
    /// most efficient way to free up a server process when it's hosting a game
    /// session that's
    /// in a bad state or not ending properly. You can use this action to terminate
    /// a game
    ...
    /// **Results**
    ///
    /// If successful, game session termination is initiated. During this activity,
    /// the game
    /// session status is changed to `TERMINATING`. When completed, the server
    /// process that was hosting the game session has been stopped and replaced with
    /// a new
    ...
    /// **Learn more**
    ///
    /// [Add Amazon GameLift Servers to your game
    /// server](https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-server-api.html)
    ///
    ...
    /// doesn't
    /// replace the definition. Instead, it creates a new version of the definition
    /// and saves it
    ...
    /// definitions, excluding the definition to remove. If the container group has
    /// only one
    ...
    /// request--either through manual update or automatic scaling--it won't change
    /// the capacity
    ...
    /// Before changing a fleet's desired capacity, check the maximum capacity of
    /// the
    ...
    /// [DescribeFleetCapacity](https://docs.aws.amazon.com/gamelift/latest/apireference/API_DescribeFleetCapacity.html) or [DescribeFleetLocationCapacity](https://docs.aws.amazon.com/gamelift/latest/apireference/API_DescribeFleetLocationCapacity.html).
    ///
    ...
    /// game
    /// server group and specify the new utilization status. You can't change the
    /// status
    ...
    /// queue
    /// processes new game session requests. To update settings, specify the queue
    /// name to be
    ...
    pub fn describeFleetAttributesPaginator(self: *Self, params: describe_fleet_attributes.DescribeFleetAttributesInput) paginator.DescribeFleetAttributesPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeFleetCapacityPaginator(self: *Self, params: describe_fleet_capacity.DescribeFleetCapacityInput) paginator.DescribeFleetCapacityPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeFleetEventsPaginator(self: *Self, params: describe_fleet_events.DescribeFleetEventsInput) paginator.DescribeFleetEventsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeFleetLocationAttributesPaginator(self: *Self, params: describe_fleet_location_attributes.DescribeFleetLocationAttributesInput) paginator.DescribeFleetLocationAttributesPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeFleetUtilizationPaginator(self: *Self, params: describe_fleet_utilization.DescribeFleetUtilizationInput) paginator.DescribeFleetUtilizationPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeGameServerInstancesPaginator(self: *Self, params: describe_game_server_instances.DescribeGameServerInstancesInput) paginator.DescribeGameServerInstancesPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeGameSessionDetailsPaginator(self: *Self, params: describe_game_session_details.DescribeGameSessionDetailsInput) paginator.DescribeGameSessionDetailsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeGameSessionQueuesPaginator(self: *Self, params: describe_game_session_queues.DescribeGameSessionQueuesInput) paginator.DescribeGameSessionQueuesPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeGameSessionsPaginator(self: *Self, params: describe_game_sessions.DescribeGameSessionsInput) paginator.DescribeGameSessionsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeMatchmakingConfigurationsPaginator(self: *Self, params: describe_matchmaking_configurations.DescribeMatchmakingConfigurationsInput) paginator.DescribeMatchmakingConfigurationsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describeMatchmakingRuleSetsPaginator(self: *Self, params: describe_matchmaking_rule_sets.DescribeMatchmakingRuleSetsInput) paginator.DescribeMatchmakingRuleSetsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn describePlayerSessionsPaginator(self: *Self, params: describe_player_sessions.DescribePlayerSessionsInput) paginator.DescribePlayerSessionsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listComputePaginator(self: *Self, params: list_compute.ListComputeInput) paginator.ListComputePaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listContainerFleetsPaginator(self: *Self, params: list_container_fleets.ListContainerFleetsInput) paginator.ListContainerFleetsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listContainerGroupDefinitionVersionsPaginator(self: *Self, params: list_container_group_definition_versions.ListContainerGroupDefinitionVersionsInput) paginator.ListContainerGroupDefinitionVersionsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listContainerGroupDefinitionsPaginator(self: *Self, params: list_container_group_definitions.ListContainerGroupDefinitionsInput) paginator.ListContainerGroupDefinitionsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listFleetDeploymentsPaginator(self: *Self, params: list_fleet_deployments.ListFleetDeploymentsInput) paginator.ListFleetDeploymentsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listGameServerGroupsPaginator(self: *Self, params: list_game_server_groups.ListGameServerGroupsInput) paginator.ListGameServerGroupsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listGameServersPaginator(self: *Self, params: list_game_servers.ListGameServersInput) paginator.ListGameServersPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn listScriptsPaginator(self: *Self, params: list_scripts.ListScriptsInput) paginator.ListScriptsPaginator {
        return .{
            .client = self,
            .params = params,
        };
    ...
    pub fn searchGameSessionsPaginator(self: *Self, params: search_game_sessions.SearchGameSessionsInput) paginator.SearchGameSessionsPaginator {
        return .{
            .client = self,
            .params = params,
        };
