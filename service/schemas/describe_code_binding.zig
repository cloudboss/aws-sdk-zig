...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCodeBindingInput, options: CallOptions) !DescribeCodeBindingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCodeBindingInput, config: *aws.Config) !aws.http.Request {
