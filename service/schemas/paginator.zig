...
pub const ListDiscoverersPaginator = struct {
    client: *Client,
    params: list_discoverers.ListDiscoverersInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_discoverers.ListDiscoverersOutput {
        if (self.done) {
        ...
        const output = try list_discoverers.execute(self.client, allocator, self.params, options);
...
pub const SearchSchemasPaginator = struct {
    client: *Client,
    params: search_schemas.SearchSchemasInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !search_schemas.SearchSchemasOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
        ...
        const output = try search_schemas.execute(self.client, allocator, self.params, options);
