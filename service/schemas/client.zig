...
pub const Client = struct {
    ...
    pub fn createDiscoverer(self: *Self, allocator: std.mem.Allocator, input: create_discoverer.CreateDiscovererInput, options: create_discoverer.Options) !create_discoverer.CreateDiscovererOutput {
    ...
    pub fn deleteDiscoverer(self: *Self, allocator: std.mem.Allocator, input: delete_discoverer.DeleteDiscovererInput, options: delete_discoverer.Options) !delete_discoverer.DeleteDiscovererOutput {
    ...
    pub fn deleteSchemaVersion(self: *Self, allocator: std.mem.Allocator, input: delete_schema_version.DeleteSchemaVersionInput, options: delete_schema_version.Options) !delete_schema_version.DeleteSchemaVersionOutput {
        return delete_schema_version.execute(self, allocator, input, options);
    }

    /// Describe the code binding URI.
    pub fn describeCodeBinding(self: *Self, allocator: std.mem.Allocator, input: describe_code_binding.DescribeCodeBindingInput, options: describe_code_binding.Options) !describe_code_binding.DescribeCodeBindingOutput {
        return describe_code_binding.execute(self, allocator, input, options);
    }

    /// Describes the discoverer.
    pub fn describeDiscoverer(self: *Self, allocator: std.mem.Allocator, input: describe_discoverer.DescribeDiscovererInput, options: describe_discoverer.Options) !describe_discoverer.DescribeDiscovererOutput {
    ...
    pub fn exportSchema(self: *Self, allocator: std.mem.Allocator, input: export_schema.ExportSchemaInput, options: export_schema.Options) !export_schema.ExportSchemaOutput {
        return export_schema.execute(self, allocator, input, options);
    }

    /// Get the code binding source URI.
    pub fn getCodeBindingSource(self: *Self, allocator: std.mem.Allocator, input: get_code_binding_source.GetCodeBindingSourceInput, options: get_code_binding_source.Options) !get_code_binding_source.GetCodeBindingSourceOutput {
        return get_code_binding_source.execute(self, allocator, input, options);
    }

    /// Get the discovered schema that was generated based on sampled events.
    pub fn getDiscoveredSchema(self: *Self, allocator: std.mem.Allocator, input: get_discovered_schema.GetDiscoveredSchemaInput, options: get_discovered_schema.Options) !get_discovered_schema.GetDiscoveredSchemaOutput {
    ...
    pub fn listDiscoverers(self: *Self, allocator: std.mem.Allocator, input: list_discoverers.ListDiscoverersInput, options: list_discoverers.Options) !list_discoverers.ListDiscoverersOutput {
    ...
    pub fn putCodeBinding(self: *Self, allocator: std.mem.Allocator, input: put_code_binding.PutCodeBindingInput, options: put_code_binding.Options) !put_code_binding.PutCodeBindingOutput {
    ...
    /// Search the schemas
    pub fn searchSchemas(self: *Self, allocator: std.mem.Allocator, input: search_schemas.SearchSchemasInput, options: search_schemas.Options) !search_schemas.SearchSchemasOutput {
        return search_schemas.execute(self, allocator, input, options);
    }

    /// Starts the discoverer
    pub fn startDiscoverer(self: *Self, allocator: std.mem.Allocator, input: start_discoverer.StartDiscovererInput, options: start_discoverer.Options) !start_discoverer.StartDiscovererOutput {
        return start_discoverer.execute(self, allocator, input, options);
    }

    /// Stops the discoverer
    pub fn stopDiscoverer(self: *Self, allocator: std.mem.Allocator, input: stop_discoverer.StopDiscovererInput, options: stop_discoverer.Options) !stop_discoverer.StopDiscovererOutput {
    ...
    pub fn updateDiscoverer(self: *Self, allocator: std.mem.Allocator, input: update_discoverer.UpdateDiscovererInput, options: update_discoverer.Options) !update_discoverer.UpdateDiscovererOutput {
