...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDiscovererInput, options: CallOptions) !UpdateDiscovererOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDiscovererInput, config: *aws.Config) !aws.http.Request {
