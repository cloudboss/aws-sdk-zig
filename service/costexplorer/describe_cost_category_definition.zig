...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCostCategoryDefinitionInput, options: Options) !DescribeCostCategoryDefinitionOutput {
