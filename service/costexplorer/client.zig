...
pub const Client = struct {
    ...
    /// monitor
    /// specification.
    pub fn createAnomalyMonitor(self: *Self, allocator: std.mem.Allocator, input: create_anomaly_monitor.CreateAnomalyMonitorInput, options: CallOptions) !create_anomaly_monitor.CreateAnomalyMonitorOutput {
    ...
    /// notifications.
    pub fn createAnomalySubscription(self: *Self, allocator: std.mem.Allocator, input: create_anomaly_subscription.CreateAnomalySubscriptionInput, options: CallOptions) !create_anomaly_subscription.CreateAnomalySubscriptionOutput {
        return create_anomaly_subscription.execute(self, allocator, input, options);
    }

    /// Creates a new cost category with the requested name and rules.
    pub fn createCostCategoryDefinition(self: *Self, allocator: std.mem.Allocator, input: create_cost_category_definition.CreateCostCategoryDefinitionInput, options: CallOptions) !create_cost_category_definition.CreateCostCategoryDefinitionOutput {
        return create_cost_category_definition.execute(self, allocator, input, options);
    }

    /// Deletes a cost anomaly monitor.
    pub fn deleteAnomalyMonitor(self: *Self, allocator: std.mem.Allocator, input: delete_anomaly_monitor.DeleteAnomalyMonitorInput, options: CallOptions) !delete_anomaly_monitor.DeleteAnomalyMonitorOutput {
        return delete_anomaly_monitor.execute(self, allocator, input, options);
    }

    /// Deletes a cost anomaly subscription.
    pub fn deleteAnomalySubscription(self: *Self, allocator: std.mem.Allocator, input: delete_anomaly_subscription.DeleteAnomalySubscriptionInput, options: CallOptions) !delete_anomaly_subscription.DeleteAnomalySubscriptionOutput {
    ...
    pub fn deleteCostCategoryDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_cost_category_definition.DeleteCostCategoryDefinitionInput, options: CallOptions) !delete_cost_category_definition.DeleteCostCategoryDefinitionOutput {
    ...
    pub fn describeCostCategoryDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_cost_category_definition.DescribeCostCategoryDefinitionInput, options: CallOptions) !describe_cost_category_definition.DescribeCostCategoryDefinitionOutput {
    ...
    /// days.
    pub fn getAnomalies(self: *Self, allocator: std.mem.Allocator, input: get_anomalies.GetAnomaliesInput, options: CallOptions) !get_anomalies.GetAnomaliesOutput {
    ...
    pub fn getAnomalyMonitors(self: *Self, allocator: std.mem.Allocator, input: get_anomaly_monitors.GetAnomalyMonitorsInput, options: CallOptions) !get_anomaly_monitors.GetAnomalyMonitorsOutput {
    ...
    /// filter using a
    /// list of cost anomaly monitor Amazon Resource Names (ARNs).
    pub fn getAnomalySubscriptions(self: *Self, allocator: std.mem.Allocator, input: get_anomaly_subscriptions.GetAnomalySubscriptionsInput, options: CallOptions) !get_anomaly_subscriptions.GetAnomalySubscriptionsOutput {
    ...
    /// data at daily
    /// granularity.
    pub fn getApproximateUsageRecords(self: *Self, allocator: std.mem.Allocator, input: get_approximate_usage_records.GetApproximateUsageRecordsInput, options: CallOptions) !get_approximate_usage_records.GetApproximateUsageRecordsOutput {
    ...
    /// `AnalysisId`.
    pub fn getCommitmentPurchaseAnalysis(self: *Self, allocator: std.mem.Allocator, input: get_commitment_purchase_analysis.GetCommitmentPurchaseAnalysisInput, options: CallOptions) !get_commitment_purchase_analysis.GetCommitmentPurchaseAnalysisOutput {
    ...
    pub fn getCostAndUsage(self: *Self, allocator: std.mem.Allocator, input: get_cost_and_usage.GetCostAndUsageInput, options: CallOptions) !get_cost_and_usage.GetCostAndUsageOutput {
    ...
    /// can go back up to
    /// 38 months.
    pub fn getCostAndUsageComparisons(self: *Self, allocator: std.mem.Allocator, input: get_cost_and_usage_comparisons.GetCostAndUsageComparisonsInput, options: CallOptions) !get_cost_and_usage_comparisons.GetCostAndUsageComparisonsOutput {
    ...
    /// Guide*.
    pub fn getCostAndUsageWithResources(self: *Self, allocator: std.mem.Allocator, input: get_cost_and_usage_with_resources.GetCostAndUsageWithResourcesInput, options: CallOptions) !get_cost_and_usage_with_resources.GetCostAndUsageWithResourcesOutput {
    ...
    pub fn getCostCategories(self: *Self, allocator: std.mem.Allocator, input: get_cost_categories.GetCostCategoriesInput, options: CallOptions) !get_cost_categories.GetCostCategoriesOutput {
    ...
    /// months.
    pub fn getCostComparisonDrivers(self: *Self, allocator: std.mem.Allocator, input: get_cost_comparison_drivers.GetCostComparisonDriversInput, options: CallOptions) !get_cost_comparison_drivers.GetCostComparisonDriversOutput {
    ...
    pub fn getCostForecast(self: *Self, allocator: std.mem.Allocator, input: get_cost_forecast.GetCostForecastInput, options: CallOptions) !get_cost_forecast.GetCostForecastOutput {
    ...
    pub fn getDimensionValues(self: *Self, allocator: std.mem.Allocator, input: get_dimension_values.GetDimensionValuesInput, options: CallOptions) !get_dimension_values.GetDimensionValuesOutput {
    ...
    /// operation.
    pub fn getReservationCoverage(self: *Self, allocator: std.mem.Allocator, input: get_reservation_coverage.GetReservationCoverageInput, options: CallOptions) !get_reservation_coverage.GetReservationCoverageOutput {
    ...
    pub fn getReservationPurchaseRecommendation(self: *Self, allocator: std.mem.Allocator, input: get_reservation_purchase_recommendation.GetReservationPurchaseRecommendationInput, options: CallOptions) !get_reservation_purchase_recommendation.GetReservationPurchaseRecommendationOutput {
    ...
    pub fn getReservationUtilization(self: *Self, allocator: std.mem.Allocator, input: get_reservation_utilization.GetReservationUtilizationInput, options: CallOptions) !get_reservation_utilization.GetReservationUtilizationOutput {
    ...
    pub fn getRightsizingRecommendation(self: *Self, allocator: std.mem.Allocator, input: get_rightsizing_recommendation.GetRightsizingRecommendationInput, options: CallOptions) !get_rightsizing_recommendation.GetRightsizingRecommendationOutput {
    ...
    /// To determine valid values for a dimension, use the `GetDimensionValues`
    /// operation.
    pub fn getSavingsPlansCoverage(self: *Self, allocator: std.mem.Allocator, input: get_savings_plans_coverage.GetSavingsPlansCoverageInput, options: CallOptions) !get_savings_plans_coverage.GetSavingsPlansCoverageOutput {
    ...
    /// retrieve
    /// them.
    pub fn getSavingsPlansPurchaseRecommendation(self: *Self, allocator: std.mem.Allocator, input: get_savings_plans_purchase_recommendation.GetSavingsPlansPurchaseRecommendationInput, options: CallOptions) !get_savings_plans_purchase_recommendation.GetSavingsPlansPurchaseRecommendationOutput {
    ...
    pub fn getSavingsPlansUtilization(self: *Self, allocator: std.mem.Allocator, input: get_savings_plans_utilization.GetSavingsPlansUtilizationInput, options: CallOptions) !get_savings_plans_utilization.GetSavingsPlansUtilizationOutput {
    ...
    /// `SavingsPlansArn`.
    pub fn getSavingsPlansUtilizationDetails(self: *Self, allocator: std.mem.Allocator, input: get_savings_plans_utilization_details.GetSavingsPlansUtilizationDetailsInput, options: CallOptions) !get_savings_plans_utilization_details.GetSavingsPlansUtilizationDetailsOutput {
    ...
    pub fn getUsageForecast(self: *Self, allocator: std.mem.Allocator, input: get_usage_forecast.GetUsageForecastInput, options: CallOptions) !get_usage_forecast.GetUsageForecastOutput {
        return get_usage_forecast.execute(self, allocator, input, options);
    }

    /// Lists the commitment purchase analyses for your account.
    pub fn listCommitmentPurchaseAnalyses(self: *Self, allocator: std.mem.Allocator, input: list_commitment_purchase_analyses.ListCommitmentPurchaseAnalysesInput, options: CallOptions) !list_commitment_purchase_analyses.ListCommitmentPurchaseAnalysesOutput {
        return list_commitment_purchase_analyses.execute(self, allocator, input, options);
    }

    /// Retrieves a list of your historical cost allocation tag backfill requests.
    pub fn listCostAllocationTagBackfillHistory(self: *Self, allocator: std.mem.Allocator, input: list_cost_allocation_tag_backfill_history.ListCostAllocationTagBackfillHistoryInput, options: CallOptions) !list_cost_allocation_tag_backfill_history.ListCostAllocationTagBackfillHistoryOutput {
    ...
    pub fn listCostAllocationTags(self: *Self, allocator: std.mem.Allocator, input: list_cost_allocation_tags.ListCostAllocationTagsInput, options: CallOptions) !list_cost_allocation_tags.ListCostAllocationTagsOutput {
    ...
    pub fn listCostCategoryDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_cost_category_definitions.ListCostCategoryDefinitionsInput, options: CallOptions) !list_cost_category_definitions.ListCostCategoryDefinitionsOutput {
    ...
    pub fn listCostCategoryResourceAssociations(self: *Self, allocator: std.mem.Allocator, input: list_cost_category_resource_associations.ListCostCategoryResourceAssociationsInput, options: CallOptions) !list_cost_category_resource_associations.ListCostCategoryResourceAssociationsOutput {
    ...
    /// past 30
    /// days.
    pub fn listSavingsPlansPurchaseRecommendationGeneration(self: *Self, allocator: std.mem.Allocator, input: list_savings_plans_purchase_recommendation_generation.ListSavingsPlansPurchaseRecommendationGenerationInput, options: CallOptions) !list_savings_plans_purchase_recommendation_generation.ListSavingsPlansPurchaseRecommendationGenerationOutput {
    ...
    pub fn provideAnomalyFeedback(self: *Self, allocator: std.mem.Allocator, input: provide_anomaly_feedback.ProvideAnomalyFeedbackInput, options: CallOptions) !provide_anomaly_feedback.ProvideAnomalyFeedbackOutput {
    ...
    pub fn startCommitmentPurchaseAnalysis(self: *Self, allocator: std.mem.Allocator, input: start_commitment_purchase_analysis.StartCommitmentPurchaseAnalysisInput, options: CallOptions) !start_commitment_purchase_analysis.StartCommitmentPurchaseAnalysisOutput {
    ...
    pub fn startCostAllocationTagBackfill(self: *Self, allocator: std.mem.Allocator, input: start_cost_allocation_tag_backfill.StartCostAllocationTagBackfillInput, options: CallOptions) !start_cost_allocation_tag_backfill.StartCostAllocationTagBackfillOutput {
    ...
    pub fn startSavingsPlansPurchaseRecommendationGeneration(self: *Self, allocator: std.mem.Allocator, input: start_savings_plans_purchase_recommendation_generation.StartSavingsPlansPurchaseRecommendationGenerationInput, options: CallOptions) !start_savings_plans_purchase_recommendation_generation.StartSavingsPlansPurchaseRecommendationGenerationOutput {
    ...
    pub fn updateAnomalyMonitor(self: *Self, allocator: std.mem.Allocator, input: update_anomaly_monitor.UpdateAnomalyMonitorInput, options: CallOptions) !update_anomaly_monitor.UpdateAnomalyMonitorOutput {
    ...
    /// `AnomalySubscription`.
    pub fn updateAnomalySubscription(self: *Self, allocator: std.mem.Allocator, input: update_anomaly_subscription.UpdateAnomalySubscriptionInput, options: CallOptions) !update_anomaly_subscription.UpdateAnomalySubscriptionOutput {
    ...
    /// tag).
    pub fn updateCostAllocationTagsStatus(self: *Self, allocator: std.mem.Allocator, input: update_cost_allocation_tags_status.UpdateCostAllocationTagsStatusInput, options: CallOptions) !update_cost_allocation_tags_status.UpdateCostAllocationTagsStatusOutput {
    ...
    pub fn updateCostCategoryDefinition(self: *Self, allocator: std.mem.Allocator, input: update_cost_category_definition.UpdateCostCategoryDefinitionInput, options: CallOptions) !update_cost_category_definition.UpdateCostCategoryDefinitionOutput {
