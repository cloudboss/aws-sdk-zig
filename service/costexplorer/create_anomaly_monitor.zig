...
pub const CreateAnomalyMonitorInput = struct {
    /// The cost anomaly detection monitor object that you want to create.
    anomaly_monitor: AnomalyMonitor,

    /// An optional list of tags to associate with the specified [
    /// `AnomalyMonitor`
    /// ](https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_AnomalyMonitor.html). You can use resource tags to control access to your
...
pub const CreateAnomalyMonitorOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAnomalyMonitorInput, options: CallOptions) !CreateAnomalyMonitorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateAnomalyMonitorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSInsightsIndexService.CreateAnomalyMonitor");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateAnomalyMonitorOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(CreateAnomalyMonitorOutput, body, allocator);
}
