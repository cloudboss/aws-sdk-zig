...
pub const ReservationPurchaseRecommendationDetail = struct {
    ...
    /// reservation
    /// purchases.
    average_normalized_units_used_per_hour: ?[]const u8,
    ...
    average_number_of_capacity_units_used_per_hour: ?[]const u8,
    ...
    /// start saving
    /// you money, in months.
    estimated_break_even_in_months: ?[]const u8,

    /// How much Amazon Web Services estimates that you spend on On-Demand Instances
    /// in a
    /// month.
    estimated_monthly_on_demand_cost: ?[]const u8,
    ...
    estimated_monthly_savings_percentage: ?[]const u8,
    ...
    estimated_reservation_cost_for_lookback_period: ?[]const u8,
    ...
    /// reservation
    /// purchases.
    maximum_normalized_units_used_per_hour: ?[]const u8,
    ...
    ///
    /// reservation purchases.
    maximum_number_of_capacity_units_used_per_hour: ?[]const u8,

    /// The maximum number of instances that you used in an hour during the
    /// historical period.
    /// Amazon Web Services uses this to calculate your recommended reservation
    /// purchases.
    maximum_number_of_instances_used_per_hour: ?[]const u8,
    ...
    /// reservation
    /// purchases.
    minimum_normalized_units_used_per_hour: ?[]const u8,
    ...
    ///
    /// reservation purchases.
    minimum_number_of_capacity_units_used_per_hour: ?[]const u8,

    /// The minimum number of instances that you used in an hour during the
    /// historical period.
    /// Amazon Web Services uses this to calculate your recommended reservation
    /// purchases.
    minimum_number_of_instances_used_per_hour: ?[]const u8,

    /// The number of normalized units that Amazon Web Services recommends that you
    /// purchase.
    recommended_normalized_units_to_purchase: ?[]const u8,

    /// The number of reserved capacity units that Amazon Web Services recommends
    /// that you
    ///
    /// purchase.
    recommended_number_of_capacity_units_to_purchase: ?[]const u8,

    /// The number of instances that Amazon Web Services recommends that you
    /// purchase.
    recommended_number_of_instances_to_purchase: ?[]const u8,

    /// How much purchasing this instance costs you on a monthly basis.
    recurring_standard_monthly_cost: ?[]const u8,
