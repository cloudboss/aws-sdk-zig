...
const RecommendationDetailData = @import("recommendation_detail_data.zig").RecommendationDetailData;

pub const GetSavingsPlanPurchaseRecommendationDetailsInput = struct {
...
pub const GetSavingsPlanPurchaseRecommendationDetailsOutput = struct {
    /// Contains detailed information about a specific Savings Plan recommendation.
    recommendation_detail_data: ?RecommendationDetailData = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSavingsPlanPurchaseRecommendationDetailsInput, options: CallOptions) !GetSavingsPlanPurchaseRecommendationDetailsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSavingsPlanPurchaseRecommendationDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSInsightsIndexService.GetSavingsPlanPurchaseRecommendationDetails");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSavingsPlanPurchaseRecommendationDetailsOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetSavingsPlanPurchaseRecommendationDetailsOutput, body, allocator);
}
