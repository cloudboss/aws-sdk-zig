...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSavingsPlanPurchaseRecommendationDetailsInput, options: Options) !GetSavingsPlanPurchaseRecommendationDetailsOutput {
