...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAnomaliesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSInsightsIndexService.GetAnomalies");
