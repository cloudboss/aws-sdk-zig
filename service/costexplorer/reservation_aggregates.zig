...
pub const ReservationAggregates = struct {
    ...
    net_ri_savings: ?[]const u8,

    /// How much your reservation costs if charged On-Demand rates.
    on_demand_cost_of_ri_hours_used: ?[]const u8,

    /// How many reservation hours that you purchased.
    purchased_hours: ?[]const u8,
    ...
    /// after
    /// November 11, 2017.
    purchased_units: ?[]const u8,

    /// The realized savings because of purchasing and using a reservation.
    realized_savings: ?[]const u8,

    /// The cost of unused hours for your reservation.
    ri_cost_for_unused_hours: ?[]const u8,

    /// The total number of reservation hours that you used.
    total_actual_hours: ?[]const u8,
    ...
    /// after
    /// November 11, 2017.
    total_actual_units: ?[]const u8,

    /// The total cost of your reservation. It's amortized over the reservation
    /// period.
    total_amortized_fee: ?[]const u8,

    /// How much you might save if you use your entire reservation.
    total_potential_ri_savings: ?[]const u8,

    /// The unrealized savings because of purchasing and using a reservation.
    unrealized_savings: ?[]const u8,

    /// The number of reservation hours that you didn't use.
    unused_hours: ?[]const u8,
    ...
    /// after
    /// November 11, 2017.
    utilization_percentage_in_units: ?[]const u8,
