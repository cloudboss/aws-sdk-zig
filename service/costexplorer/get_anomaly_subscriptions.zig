...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAnomalySubscriptionsInput, options: Options) !GetAnomalySubscriptionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAnomalySubscriptionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSInsightsIndexService.GetAnomalySubscriptions");
