...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSavingsPlansPurchaseRecommendationGenerationInput, options: Options) !ListSavingsPlansPurchaseRecommendationGenerationOutput {
