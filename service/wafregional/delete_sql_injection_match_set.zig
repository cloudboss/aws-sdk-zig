...
pub const DeleteSqlInjectionMatchSetInput = struct {
...
pub const DeleteSqlInjectionMatchSetOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSqlInjectionMatchSetInput, options: CallOptions) !DeleteSqlInjectionMatchSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSqlInjectionMatchSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSWAF_Regional_20161128.DeleteSqlInjectionMatchSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSqlInjectionMatchSetOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DeleteSqlInjectionMatchSetOutput, body, allocator);
}
