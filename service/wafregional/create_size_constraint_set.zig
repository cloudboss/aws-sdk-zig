...
const SizeConstraintSet = @import("size_constraint_set.zig").SizeConstraintSet;

pub const CreateSizeConstraintSetInput = struct {
...
pub const CreateSizeConstraintSetOutput = struct {
    ...
    size_constraint_set: ?SizeConstraintSet = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSizeConstraintSetInput, options: CallOptions) !CreateSizeConstraintSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateSizeConstraintSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSWAF_Regional_20161128.CreateSizeConstraintSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateSizeConstraintSetOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreateSizeConstraintSetOutput, body, allocator);
}
