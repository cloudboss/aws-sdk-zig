...
pub const DisassociateWebACLInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateWebACLInput, options: Options) !DisassociateWebACLOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateWebACLInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSWAF_Regional_20161128.DisassociateWebACL");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateWebACLOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
