...
fn serializeRequest(alloc: std.mem.Allocator, input: GetLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWSWAF_Regional_20161128.GetLoggingConfiguration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetLoggingConfigurationOutput {
    ...
    return aws.json.parseJsonObject(GetLoggingConfigurationOutput, body, alloc);
}
