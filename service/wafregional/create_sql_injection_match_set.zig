...
pub const CreateSqlInjectionMatchSetInput = struct {
...
pub const CreateSqlInjectionMatchSetOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSqlInjectionMatchSetInput, options: CallOptions) !CreateSqlInjectionMatchSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateSqlInjectionMatchSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSWAF_Regional_20161128.CreateSqlInjectionMatchSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateSqlInjectionMatchSetOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreateSqlInjectionMatchSetOutput, body, allocator);
}
