...
pub const ManagedResourceSummary = struct {
    ...
    applied_weights: ?[]const aws.map.MapEntry(f32),

    /// The Amazon Resource Name (ARN) for the managed resource.
    arn: ?[]const u8,

    /// An array of the autoshifts that have been completed for a resource.
    autoshifts: ?[]const AutoshiftInResource,
    ...
    /// `DISABLED`.
    practice_run_status: ?ZonalAutoshiftStatus,
    ...
    zonal_shifts: ?[]const ZonalShiftInResource,
