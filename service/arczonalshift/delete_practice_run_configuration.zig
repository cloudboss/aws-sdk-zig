...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePracticeRunConfigurationInput, options: Options) !DeletePracticeRunConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePracticeRunConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePracticeRunConfigurationOutput {
    var result: DeletePracticeRunConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeletePracticeRunConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
