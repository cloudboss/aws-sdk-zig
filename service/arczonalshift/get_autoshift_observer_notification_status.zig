...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAutoshiftObserverNotificationStatusInput, options: CallOptions) !GetAutoshiftObserverNotificationStatusOutput {
