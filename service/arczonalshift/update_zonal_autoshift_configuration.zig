...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateZonalAutoshiftConfigurationInput, options: Options) !UpdateZonalAutoshiftConfigurationOutput {
