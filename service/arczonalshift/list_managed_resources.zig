...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListManagedResourcesInput, options: CallOptions) !ListManagedResourcesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListManagedResourcesInput, config: *aws.Config) !aws.http.Request {
