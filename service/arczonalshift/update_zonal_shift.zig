...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateZonalShiftInput, options: CallOptions) !UpdateZonalShiftOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateZonalShiftInput, config: *aws.Config) !aws.http.Request {
