...
pub const DeleteFolderOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFolderInput, options: CallOptions) !DeleteFolderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFolderInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFolderOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFolderOutput = .{};
