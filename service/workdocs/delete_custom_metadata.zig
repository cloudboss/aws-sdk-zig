...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomMetadataInput, options: Options) !DeleteCustomMetadataOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCustomMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCustomMetadataOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
