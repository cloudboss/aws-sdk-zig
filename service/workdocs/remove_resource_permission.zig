...
pub const RemoveResourcePermissionInput = struct {
...
pub const RemoveResourcePermissionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveResourcePermissionInput, options: CallOptions) !RemoveResourcePermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveResourcePermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveResourcePermissionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: RemoveResourcePermissionOutput = .{};
