...
pub const DescribeCommentsInput = struct {
...
pub const DescribeCommentsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCommentsInput, options: CallOptions) !DescribeCommentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCommentsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/comments");
