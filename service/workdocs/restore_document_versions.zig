...
fn serializeRequest(alloc: std.mem.Allocator, input: RestoreDocumentVersionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/api/v1/documentVersions/restore/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RestoreDocumentVersionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
