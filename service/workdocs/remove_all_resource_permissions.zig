...
pub const RemoveAllResourcePermissionsInput = struct {
...
pub const RemoveAllResourcePermissionsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveAllResourcePermissionsInput, options: CallOptions) !RemoveAllResourcePermissionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveAllResourcePermissionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveAllResourcePermissionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: RemoveAllResourcePermissionsOutput = .{};
