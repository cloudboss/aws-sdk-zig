...
const DeleteCommentOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCommentInput, options: Options) !DeleteCommentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteCommentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteCommentOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
