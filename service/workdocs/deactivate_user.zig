...
pub const DeactivateUserInput = struct {
...
const DeactivateUserOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeactivateUserInput, options: Options) !DeactivateUserOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeactivateUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/activation");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeactivateUserOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeactivateUserOutput = .{};
