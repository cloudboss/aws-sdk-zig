...
pub const DeleteNotificationSubscriptionInput = struct {
...
pub const DeleteNotificationSubscriptionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteNotificationSubscriptionInput, options: CallOptions) !DeleteNotificationSubscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteNotificationSubscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteNotificationSubscriptionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteNotificationSubscriptionOutput = .{};
