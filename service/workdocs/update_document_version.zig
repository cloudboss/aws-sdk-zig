...
const UpdateDocumentVersionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDocumentVersionInput, options: Options) !UpdateDocumentVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateDocumentVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.version_status) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"VersionStatus\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateDocumentVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
