...
pub const AbortDocumentVersionUploadInput = struct {
...
pub const AbortDocumentVersionUploadOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AbortDocumentVersionUploadInput, options: CallOptions) !AbortDocumentVersionUploadOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AbortDocumentVersionUploadInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AbortDocumentVersionUploadOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AbortDocumentVersionUploadOutput = .{};
