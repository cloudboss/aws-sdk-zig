...
pub const ListInstancesOutput = struct {
    /// An array of `InstanceSummary` resources that contain details about the
    /// instances that provide user-based subscriptions and also meet the request
    /// criteria.
    instance_summaries: ?[]const InstanceSummary = null,
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/instance/ListInstances";
