...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTableBucketMaintenanceConfigurationInput, options: CallOptions) !GetTableBucketMaintenanceConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTableBucketMaintenanceConfigurationInput, config: *aws.Config) !aws.http.Request {
