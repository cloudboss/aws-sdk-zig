...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTableBucketPolicyInput, options: CallOptions) !GetTableBucketPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTableBucketPolicyInput, config: *aws.Config) !aws.http.Request {
