...
pub const DeleteTableBucketMetricsConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTableBucketMetricsConfigurationInput, options: CallOptions) !DeleteTableBucketMetricsConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTableBucketMetricsConfigurationInput, config: *aws.Config) !aws.http.Request {
