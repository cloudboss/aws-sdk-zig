...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTableStorageClassInput, options: CallOptions) !GetTableStorageClassOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTableStorageClassInput, config: *aws.Config) !aws.http.Request {
