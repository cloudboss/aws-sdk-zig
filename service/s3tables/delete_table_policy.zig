...
pub const DeleteTablePolicyInput = struct {
    /// The table name.
    name: []const u8,
...
pub const DeleteTablePolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTablePolicyInput, options: CallOptions) !DeleteTablePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTablePolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTablePolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTablePolicyOutput = .{};
