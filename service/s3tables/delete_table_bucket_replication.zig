...
pub const DeleteTableBucketReplicationInput = struct {
...
pub const DeleteTableBucketReplicationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTableBucketReplicationInput, options: CallOptions) !DeleteTableBucketReplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTableBucketReplicationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTableBucketReplicationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteTableBucketReplicationOutput = .{};
