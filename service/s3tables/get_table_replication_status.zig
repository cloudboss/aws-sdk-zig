...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetTableReplicationStatusInput, options: CallOptions) !GetTableReplicationStatusOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetTableReplicationStatusInput, config: *aws.Config) !aws.http.Request {
