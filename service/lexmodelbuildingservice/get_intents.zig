...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetIntentsInput, options: CallOptions) !GetIntentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetIntentsInput, config: *aws.Config) !aws.http.Request {
