...
pub const DeleteUtterancesInput = struct {
    ...
    /// is the user ID that was sent in the
    /// [PostContent](http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostContent.html) or [PostText](http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html) operation request that contained the
    /// utterance.
    user_id: []const u8,
...
const DeleteUtterancesOutput = struct {};
