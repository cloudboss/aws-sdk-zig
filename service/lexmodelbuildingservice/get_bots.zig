...
pub const GetBotsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBotsInput, options: CallOptions) !GetBotsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBotsInput, config: *aws.Config) !aws.http.Request {
