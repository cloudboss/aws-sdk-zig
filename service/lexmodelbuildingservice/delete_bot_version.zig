...
pub const DeleteBotVersionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBotVersionInput, options: CallOptions) !DeleteBotVersionOutput {
