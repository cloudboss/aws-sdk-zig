...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTrustedAdvisorCheckRefreshStatusesInput, options: Options) !DescribeTrustedAdvisorCheckRefreshStatusesOutput {
