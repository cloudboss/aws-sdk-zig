...
const WorkflowRunSortCriteria = @import("workflow_run_sort_criteria.zig").WorkflowRunSortCriteria;
...
pub const ListWorkflowRunsInput = struct {
    ...
    sort_by: ?[]const WorkflowRunSortCriteria = null,
...
pub const ListWorkflowRunsOutput = struct {
    ...
    items: ?[]const WorkflowRunSummary = null,
