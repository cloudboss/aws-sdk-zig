...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSourceRepositoriesInput, options: CallOptions) !ListSourceRepositoriesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSourceRepositoriesInput, config: *aws.Config) !aws.http.Request {
