...
pub const CreateSourceRepositoryInput = struct {
...
pub const CreateSourceRepositoryOutput = struct {
    /// The description of the source repository.
    description: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSourceRepositoryInput, options: Options) !CreateSourceRepositoryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateSourceRepositoryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateSourceRepositoryOutput {
    var result: CreateSourceRepositoryOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateSourceRepositoryOutput, body, alloc);
    }
    _ = status;
    _ = headers;
