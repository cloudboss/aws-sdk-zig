...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSourceRepositoryInput, options: CallOptions) !CreateSourceRepositoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateSourceRepositoryInput, config: *aws.Config) !aws.http.Request {
