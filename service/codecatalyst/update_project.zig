...
const UpdateProjectInput = @import("update_project_request.zig").UpdateProjectRequest;

const UpdateProjectOutput = @import("update_project_response.zig").UpdateProjectResponse;
