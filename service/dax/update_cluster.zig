...
pub const UpdateClusterInput = @import("update_cluster_request.zig").UpdateClusterRequest;

pub const UpdateClusterOutput = @import("update_cluster_response.zig").UpdateClusterResponse;
