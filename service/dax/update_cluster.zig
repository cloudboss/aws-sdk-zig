...
const UpdateClusterInput = @import("update_cluster_request.zig").UpdateClusterRequest;

const UpdateClusterOutput = @import("update_cluster_response.zig").UpdateClusterResponse;
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateClusterInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonDAXV3.UpdateCluster");
