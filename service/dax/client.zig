...
pub const Client = struct {
    ...
    pub fn decreaseReplicationFactor(self: *Self, allocator: std.mem.Allocator, input: decrease_replication_factor.DecreaseReplicationFactorInput, options: CallOptions) !decrease_replication_factor.DecreaseReplicationFactorOutput {
    ...
    /// software.
    pub fn describeDefaultParameters(self: *Self, allocator: std.mem.Allocator, input: describe_default_parameters.DescribeDefaultParametersInput, options: CallOptions) !describe_default_parameters.DescribeDefaultParametersOutput {
    ...
    pub fn increaseReplicationFactor(self: *Self, allocator: std.mem.Allocator, input: increase_replication_factor.IncreaseReplicationFactorInput, options: CallOptions) !increase_replication_factor.IncreaseReplicationFactorOutput {
    ...
    pub fn rebootNode(self: *Self, allocator: std.mem.Allocator, input: reboot_node.RebootNodeInput, options: CallOptions) !reboot_node.RebootNodeOutput {
