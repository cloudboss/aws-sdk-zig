...
pub const StopMeetingTranscriptionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopMeetingTranscriptionInput, options: CallOptions) !StopMeetingTranscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopMeetingTranscriptionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopMeetingTranscriptionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
