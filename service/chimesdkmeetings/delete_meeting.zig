...
pub const DeleteMeetingInput = struct {
...
pub const DeleteMeetingOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMeetingInput, options: CallOptions) !DeleteMeetingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMeetingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMeetingOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMeetingOutput = .{};
