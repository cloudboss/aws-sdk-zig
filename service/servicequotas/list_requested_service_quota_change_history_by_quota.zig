...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRequestedServiceQuotaChangeHistoryByQuotaInput, options: Options) !ListRequestedServiceQuotaChangeHistoryByQuotaOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListRequestedServiceQuotaChangeHistoryByQuotaInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "ServiceQuotasV20190624.ListRequestedServiceQuotaChangeHistoryByQuota");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListRequestedServiceQuotaChangeHistoryByQuotaOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListRequestedServiceQuotaChangeHistoryByQuotaOutput, body, alloc);
}
