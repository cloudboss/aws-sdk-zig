...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateServiceQuotaTemplateInput, options: Options) !DisassociateServiceQuotaTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateServiceQuotaTemplateInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ServiceQuotasV20190624.DisassociateServiceQuotaTemplate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateServiceQuotaTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
