...
pub const ListServiceQuotaIncreaseRequestsInTemplateInput = struct {
...
pub const ListServiceQuotaIncreaseRequestsInTemplateOutput = struct {
    ...
    service_quota_increase_request_in_template_list: ?[]const ServiceQuotaIncreaseRequestInTemplate = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListServiceQuotaIncreaseRequestsInTemplateInput, options: CallOptions) !ListServiceQuotaIncreaseRequestsInTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListServiceQuotaIncreaseRequestsInTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ServiceQuotasV20190624.ListServiceQuotaIncreaseRequestsInTemplate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListServiceQuotaIncreaseRequestsInTemplateOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListServiceQuotaIncreaseRequestsInTemplateOutput, body, allocator);
}
