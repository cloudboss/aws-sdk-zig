...
pub const DeleteServiceQuotaIncreaseRequestFromTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServiceQuotaIncreaseRequestFromTemplateInput, options: Options) !DeleteServiceQuotaIncreaseRequestFromTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteServiceQuotaIncreaseRequestFromTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ServiceQuotasV20190624.DeleteServiceQuotaIncreaseRequestFromTemplate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteServiceQuotaIncreaseRequestFromTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
