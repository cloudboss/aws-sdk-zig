...
pub const AssociateServiceQuotaTemplateInput = struct {
};

pub const AssociateServiceQuotaTemplateOutput = struct {
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateServiceQuotaTemplateInput, options: CallOptions) !AssociateServiceQuotaTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateServiceQuotaTemplateInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ServiceQuotasV20190624.AssociateServiceQuotaTemplate");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateServiceQuotaTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
