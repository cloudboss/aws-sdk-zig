...
const ServiceInfo = @import("service_info.zig").ServiceInfo;
...
pub const ListServicesOutput = struct {
    ...
    services: ?[]const ServiceInfo = null,
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListServicesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "ServiceQuotasV20190624.ListServices");
