...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAssociationForServiceQuotaTemplateInput, options: Options) !GetAssociationForServiceQuotaTemplateOutput {
