...
pub const AddApplicationCloudWatchLoggingOptionInput = struct {
    ...
    /// role ARN.
    /// Note: To write application messages to CloudWatch, the IAM role that is used
    /// must have
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddApplicationCloudWatchLoggingOptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "KinesisAnalytics_20150814.AddApplicationCloudWatchLoggingOption");
