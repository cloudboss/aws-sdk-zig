...
pub const Client = struct {
    ...
    const Self = @This();
    pub const sdk_id = "Kinesis Analytics";
    ...
    /// Kinesis stream, an
    /// Amazon Kinesis Firehose delivery stream, or an AWS Lambda function), you add
    /// the
    ...
    /// application execution and deletes the application, including any application
    /// artifacts (such as in-application streams, reference table, and application
    /// code).
    ///
    /// This operation requires permissions to perform the
    ...
    /// use the
    /// [ListApplications](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_ListApplications.html) operation.
    ///
    /// This operation requires permissions to perform the
    ...
    /// source (Amazon Kinesis stream or Amazon Kinesis Firehose delivery stream) or
    ...
    /// [StopApplication](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_StopApplication.html) operation.
    ///
    /// This operation requires permissions to perform the
    ...
    /// You can use the
    /// [DescribeApplication](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html) operation to find the application state.
