...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddApplicationInputProcessingConfigurationInput, options: Options) !AddApplicationInputProcessingConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AddApplicationInputProcessingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "KinesisAnalytics_20150814.AddApplicationInputProcessingConfiguration");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddApplicationInputProcessingConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
