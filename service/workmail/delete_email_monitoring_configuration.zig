...
pub const DeleteEmailMonitoringConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEmailMonitoringConfigurationInput, options: Options) !DeleteEmailMonitoringConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEmailMonitoringConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkMailService.DeleteEmailMonitoringConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEmailMonitoringConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
