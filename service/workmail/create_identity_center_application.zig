...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateIdentityCenterApplicationInput, options: Options) !CreateIdentityCenterApplicationOutput {
