...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeEmailMonitoringConfigurationInput, options: Options) !DescribeEmailMonitoringConfigurationOutput {
