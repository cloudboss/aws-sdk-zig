...
pub const DescribeEmailMonitoringConfigurationInput = struct {
...
pub const DescribeEmailMonitoringConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeEmailMonitoringConfigurationInput, options: CallOptions) !DescribeEmailMonitoringConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeEmailMonitoringConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkMailService.DescribeEmailMonitoringConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeEmailMonitoringConfigurationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeEmailMonitoringConfigurationOutput, body, allocator);
}
