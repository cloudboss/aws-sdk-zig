...
pub const DisassociateDelegateFromResourceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateDelegateFromResourceInput, options: Options) !DisassociateDelegateFromResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateDelegateFromResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkMailService.DisassociateDelegateFromResource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateDelegateFromResourceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
