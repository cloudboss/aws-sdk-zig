...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutVectorBucketPolicyInput, options: Options) !PutVectorBucketPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutVectorBucketPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutVectorBucketPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
