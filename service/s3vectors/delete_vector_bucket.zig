...
pub const DeleteVectorBucketInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVectorBucketInput, options: Options) !DeleteVectorBucketOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVectorBucketInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVectorBucketOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVectorBucketOutput = .{};
