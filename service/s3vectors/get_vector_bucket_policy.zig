...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVectorBucketPolicyInput, options: CallOptions) !GetVectorBucketPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVectorBucketPolicyInput, config: *aws.Config) !aws.http.Request {
