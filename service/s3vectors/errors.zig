...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        kms_invalid_key_usage_exception: KmsInvalidKeyUsageException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .kms_invalid_key_usage_exception => |e| e.message,
        ...
        pub fn httpStatus(self: Kind) u16 {
            return switch (self) {
                ...
                .kms_invalid_key_usage_exception => 400,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .kms_invalid_key_usage_exception => |e| e.request_id,
...
pub const KmsInvalidKeyUsageException = struct {
    message: []const u8 = "",
    request_id: []const u8 = "",
};
