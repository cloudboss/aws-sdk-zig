...
pub const DeleteVectorBucketPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVectorBucketPolicyInput, options: CallOptions) !DeleteVectorBucketPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVectorBucketPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteVectorBucketPolicy";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVectorBucketPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVectorBucketPolicyOutput = .{};
