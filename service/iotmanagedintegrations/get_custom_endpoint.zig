...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCustomEndpointInput, options: CallOptions) !GetCustomEndpointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCustomEndpointInput, config: *aws.Config) !aws.http.Request {
    _ = input;
