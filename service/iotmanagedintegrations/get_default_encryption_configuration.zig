...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDefaultEncryptionConfigurationInput, options: Options) !GetDefaultEncryptionConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetDefaultEncryptionConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetDefaultEncryptionConfigurationOutput {
    var result: GetDefaultEncryptionConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetDefaultEncryptionConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
