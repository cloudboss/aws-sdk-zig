...
pub const DeregisterAccountAssociationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterAccountAssociationInput, options: CallOptions) !DeregisterAccountAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterAccountAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterAccountAssociationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
