...
pub const UpdateAccountAssociationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAccountAssociationInput, options: CallOptions) !UpdateAccountAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateAccountAssociationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateAccountAssociationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
