...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddRoleToDBClusterInput, options: Options) !AddRoleToDBClusterOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AddRoleToDBClusterInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AddRoleToDBCluster&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddRoleToDBClusterOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
