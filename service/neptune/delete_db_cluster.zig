...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDBClusterInput, options: Options) !DeleteDBClusterOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDBClusterInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteDBCluster&Version=2014-10-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDBClusterOutput {
    _ = status;
    _ = headers;
