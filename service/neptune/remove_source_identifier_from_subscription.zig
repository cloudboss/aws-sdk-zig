...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveSourceIdentifierFromSubscriptionInput, options: Options) !RemoveSourceIdentifierFromSubscriptionOutput {
