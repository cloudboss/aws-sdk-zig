...
pub const CreateEventSubscriptionInput = struct {
    ...
    /// notification. The ARN is
    /// created by Amazon SNS when you create a topic and subscribe to it.
    sns_topic_arn: []const u8,

    /// The list of identifiers of the event sources for which events are returned.
    /// If not
    /// specified, then all sources are included in the response. An identifier must
    /// begin with a
    /// letter and must contain only ASCII letters, digits, and hyphens; it can't
    ...
    /// to be notified
    /// of events generated by a DB instance, you would set this parameter to
    /// db-instance. if this
