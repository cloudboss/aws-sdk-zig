...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGlobalClusterInput, options: CallOptions) !DeleteGlobalClusterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteGlobalClusterInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteGlobalCluster&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteGlobalClusterOutput {
    _ = status;
    _ = headers;
