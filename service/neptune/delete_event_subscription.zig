...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEventSubscriptionInput, options: CallOptions) !DeleteEventSubscriptionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEventSubscriptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteEventSubscription&Version=2014-10-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEventSubscriptionOutput {
    _ = status;
    _ = headers;
