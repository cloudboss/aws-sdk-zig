...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: InvokeBlueprintOptimizationAsyncInput, options: Options) !InvokeBlueprintOptimizationAsyncOutput {
