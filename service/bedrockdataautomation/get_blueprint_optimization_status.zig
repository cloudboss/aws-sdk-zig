...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBlueprintOptimizationStatusInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/getBlueprintOptimizationStatus/");
