...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataAutomationProjectInput, options: Options) !UpdateDataAutomationProjectOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateDataAutomationProjectInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateDataAutomationProjectOutput {
    var result: UpdateDataAutomationProjectOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateDataAutomationProjectOutput, body, alloc);
    }
    _ = status;
    _ = headers;
