...
pub const ListDataAutomationLibrariesPaginator = struct {
    client: *Client,
    params: list_data_automation_libraries.ListDataAutomationLibrariesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_data_automation_libraries.ListDataAutomationLibrariesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDataAutomationLibraryEntitiesPaginator = struct {
    client: *Client,
    params: list_data_automation_library_entities.ListDataAutomationLibraryEntitiesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_data_automation_library_entities.ListDataAutomationLibraryEntitiesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDataAutomationLibraryIngestionJobsPaginator = struct {
    client: *Client,
    params: list_data_automation_library_ingestion_jobs.ListDataAutomationLibraryIngestionJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_data_automation_library_ingestion_jobs.ListDataAutomationLibraryIngestionJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
