...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListServiceOperationsInput, options: CallOptions) !ListServiceOperationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListServiceOperationsInput, config: *aws.Config) !aws.http.Request {
