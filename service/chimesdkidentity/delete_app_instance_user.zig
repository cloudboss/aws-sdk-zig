...
pub const DeleteAppInstanceUserInput = struct {
...
pub const DeleteAppInstanceUserOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppInstanceUserInput, options: CallOptions) !DeleteAppInstanceUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppInstanceUserInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAppInstanceUserOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAppInstanceUserOutput = .{};
