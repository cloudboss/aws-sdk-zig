...
pub const DeregisterAppInstanceUserEndpointInput = struct {
...
pub const DeregisterAppInstanceUserEndpointOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterAppInstanceUserEndpointInput, options: CallOptions) !DeregisterAppInstanceUserEndpointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterAppInstanceUserEndpointInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterAppInstanceUserEndpointOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeregisterAppInstanceUserEndpointOutput = .{};
