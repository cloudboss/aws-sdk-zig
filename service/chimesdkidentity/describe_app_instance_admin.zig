...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAppInstanceAdminInput, options: CallOptions) !DescribeAppInstanceAdminOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAppInstanceAdminInput, config: *aws.Config) !aws.http.Request {
