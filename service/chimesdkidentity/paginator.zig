...
pub const ListAppInstanceAdminsPaginator = struct {
    client: *Client,
    params: list_app_instance_admins.ListAppInstanceAdminsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_app_instance_admins.ListAppInstanceAdminsOutput {
        ...
        const output = try list_app_instance_admins.execute(self.client, allocator, self.params, options);
...
pub const ListAppInstanceBotsPaginator = struct {
    client: *Client,
    params: list_app_instance_bots.ListAppInstanceBotsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_app_instance_bots.ListAppInstanceBotsOutput {
        ...
        const output = try list_app_instance_bots.execute(self.client, allocator, self.params, options);
...
pub const ListAppInstanceUserEndpointsPaginator = struct {
    client: *Client,
    params: list_app_instance_user_endpoints.ListAppInstanceUserEndpointsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_app_instance_user_endpoints.ListAppInstanceUserEndpointsOutput {
        ...
        const output = try list_app_instance_user_endpoints.execute(self.client, allocator, self.params, options);
...
pub const ListAppInstanceUsersPaginator = struct {
    client: *Client,
    params: list_app_instance_users.ListAppInstanceUsersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_app_instance_users.ListAppInstanceUsersOutput {
        ...
        const output = try list_app_instance_users.execute(self.client, allocator, self.params, options);
...
pub const ListAppInstancesPaginator = struct {
    client: *Client,
    params: list_app_instances.ListAppInstancesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_app_instances.ListAppInstancesOutput {
        ...
        const output = try list_app_instances.execute(self.client, allocator, self.params, options);
