...
pub const DeleteAppInstanceAdminOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppInstanceAdminInput, options: CallOptions) !DeleteAppInstanceAdminOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppInstanceAdminInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.app_instance_admin_arn);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAppInstanceAdminOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
