...
pub const DeleteAppInstanceInput = struct {
...
pub const DeleteAppInstanceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppInstanceInput, options: CallOptions) !DeleteAppInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppInstanceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAppInstanceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAppInstanceOutput = .{};
