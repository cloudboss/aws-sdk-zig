...
pub const DeleteAccessGrantOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessGrantInput, options: CallOptions) !DeleteAccessGrantOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccessGrantInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccessGrantOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
