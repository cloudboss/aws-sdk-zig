...
pub const DeleteAccessGrantInput = struct {
...
const DeleteAccessGrantOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessGrantInput, options: Options) !DeleteAccessGrantOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccessGrantInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/v20180820/accessgrantsinstance/grant/");
    try path_buf.appendSlice(alloc, input.access_grant_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccessGrantOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessGrantOutput = .{};
