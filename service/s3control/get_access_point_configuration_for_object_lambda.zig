...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessPointConfigurationForObjectLambdaInput, options: Options) !GetAccessPointConfigurationForObjectLambdaOutput {
