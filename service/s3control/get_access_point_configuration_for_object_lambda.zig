...
pub const GetAccessPointConfigurationForObjectLambdaInput = struct {
...
pub const GetAccessPointConfigurationForObjectLambdaOutput = struct {
    /// Object Lambda Access Point configuration document.
    configuration: ?ObjectLambdaConfiguration = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessPointConfigurationForObjectLambdaInput, options: CallOptions) !GetAccessPointConfigurationForObjectLambdaOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAccessPointConfigurationForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAccessPointConfigurationForObjectLambdaOutput {
    var result: GetAccessPointConfigurationForObjectLambdaOutput = .{};
    _ = status;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "Configuration")) {
                    result.configuration = try serde.deserializeObjectLambdaConfiguration(allocator, &reader);
                } else {
