...
pub const GetBucketInput = struct {
...
pub const GetBucketOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBucketInput, options: CallOptions) !GetBucketOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBucketInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetBucketOutput {
    var result: GetBucketOutput = .{};
    _ = status;
