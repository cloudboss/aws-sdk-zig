...
pub const DeleteBucketLifecycleConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketLifecycleConfigurationInput, options: CallOptions) !DeleteBucketLifecycleConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketLifecycleConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketLifecycleConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
