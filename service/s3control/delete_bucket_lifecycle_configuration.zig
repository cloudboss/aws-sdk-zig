...
pub const DeleteBucketLifecycleConfigurationInput = struct {
...
const DeleteBucketLifecycleConfigurationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketLifecycleConfigurationInput, options: Options) !DeleteBucketLifecycleConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBucketLifecycleConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/lifecycleconfiguration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBucketLifecycleConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteBucketLifecycleConfigurationOutput = .{};
