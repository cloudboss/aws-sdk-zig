...
const DeleteAccessGrantsLocationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessGrantsLocationInput, options: Options) !DeleteAccessGrantsLocationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccessGrantsLocationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccessGrantsLocationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
