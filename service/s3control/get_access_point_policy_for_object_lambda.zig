...
pub const GetAccessPointPolicyForObjectLambdaInput = struct {
...
pub const GetAccessPointPolicyForObjectLambdaOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessPointPolicyForObjectLambdaInput, options: Options) !GetAccessPointPolicyForObjectLambdaOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAccessPointPolicyForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetAccessPointPolicyForObjectLambdaOutput {
    var result: GetAccessPointPolicyForObjectLambdaOutput = .{};
    _ = status;
