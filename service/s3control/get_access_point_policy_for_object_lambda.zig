...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessPointPolicyForObjectLambdaInput, options: CallOptions) !GetAccessPointPolicyForObjectLambdaOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAccessPointPolicyForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAccessPointPolicyForObjectLambdaOutput {
