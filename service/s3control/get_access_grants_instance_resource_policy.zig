...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessGrantsInstanceResourcePolicyInput, options: Options) !GetAccessGrantsInstanceResourcePolicyOutput {
