...
pub const GetAccessGrantsInstanceResourcePolicyInput = struct {
    /// The Amazon Web Services account ID of the S3 Access Grants instance.
    account_id: []const u8,
};

pub const GetAccessGrantsInstanceResourcePolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessGrantsInstanceResourcePolicyInput, options: CallOptions) !GetAccessGrantsInstanceResourcePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAccessGrantsInstanceResourcePolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAccessGrantsInstanceResourcePolicyOutput {
    var result: GetAccessGrantsInstanceResourcePolicyOutput = .{};
    _ = status;
