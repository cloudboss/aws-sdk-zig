...
pub const CreateMultiRegionAccessPointInput = @import("create_multi_region_access_point_request.zig").CreateMultiRegionAccessPointRequest;
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateMultiRegionAccessPointInput, options: CallOptions) !CreateMultiRegionAccessPointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateMultiRegionAccessPointInput, config: *aws.Config) !aws.http.Request {
    ...
    try serde.serializeCreateMultiRegionAccessPointInput(allocator, &body_buf, input.details);
    try body_buf.appendSlice(allocator, "</Details>");
    try body_buf.appendSlice(allocator, "</CreateMultiRegionAccessPointRequest>");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateMultiRegionAccessPointOutput {
