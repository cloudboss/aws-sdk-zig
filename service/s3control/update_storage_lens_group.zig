...
const UpdateStorageLensGroupOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateStorageLensGroupInput, options: Options) !UpdateStorageLensGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateStorageLensGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<UpdateStorageLensGroupRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateStorageLensGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
