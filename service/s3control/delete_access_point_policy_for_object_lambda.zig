...
pub const DeleteAccessPointPolicyForObjectLambdaInput = struct {
...
const DeleteAccessPointPolicyForObjectLambdaOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessPointPolicyForObjectLambdaInput, options: Options) !DeleteAccessPointPolicyForObjectLambdaOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccessPointPolicyForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccessPointPolicyForObjectLambdaOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessPointPolicyForObjectLambdaOutput = .{};
