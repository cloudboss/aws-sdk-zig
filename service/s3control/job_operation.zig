...
pub const JobOperation = struct {
    ...
    /// the
    /// manifest.
    lambda_invoke: ?LambdaInvokeOperation = null,

    /// Directs the specified job to compute checksum values for every object in the
    /// manifest.
    s3_compute_object_checksum: ?S3ComputeObjectChecksumOperation = null,
    ...
    s3_delete_object_tagging: ?S3DeleteObjectTaggingOperation = null,
    ...
    ///
    /// This functionality is not supported by directory buckets.
    s3_initiate_restore_object: ?S3InitiateRestoreObjectOperation = null,
    ...
    ///
    /// This functionality is not supported by directory buckets.
    s3_put_object_acl: ?S3SetObjectAclOperation = null,

    /// Directs the specified job to run a PUT Copy object call on every object in
    /// the
    /// manifest.
    s3_put_object_copy: ?S3CopyObjectOperation = null,

    s3_put_object_legal_hold: ?S3SetObjectLegalHoldOperation = null,

    s3_put_object_retention: ?S3SetObjectRetentionOperation = null,
    ...
    ///
    /// This functionality is not supported by directory buckets.
    s3_put_object_tagging: ?S3SetObjectTaggingOperation = null,

    /// Directs the specified job to invoke `ReplicateObject` on every object in the
    /// job's manifest.
    ///
    /// This functionality is not supported by directory buckets.
    s3_replicate_object: ?S3ReplicateObjectOperation = null,
    ...
    s3_update_object_encryption: ?S3UpdateObjectEncryptionOperation = null,
};
