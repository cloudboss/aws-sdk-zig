...
pub const PutAccessPointPolicyForObjectLambdaInput = struct {
...
pub const PutAccessPointPolicyForObjectLambdaOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccessPointPolicyForObjectLambdaInput, options: CallOptions) !PutAccessPointPolicyForObjectLambdaOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutAccessPointPolicyForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "<PutAccessPointPolicyForObjectLambdaRequest xmlns=\"http://awss3control.amazonaws.com/doc/2018-08-20/\">");
    try body_buf.appendSlice(allocator, "<Policy>");
    try aws.xml.appendXmlEscaped(allocator, &body_buf, input.policy);
    try body_buf.appendSlice(allocator, "</Policy>");
    try body_buf.appendSlice(allocator, "</PutAccessPointPolicyForObjectLambdaRequest>");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutAccessPointPolicyForObjectLambdaOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutAccessPointPolicyForObjectLambdaOutput = .{};
