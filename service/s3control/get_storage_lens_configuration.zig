...
pub const GetStorageLensConfigurationInput = struct {
...
pub const GetStorageLensConfigurationOutput = struct {
    /// The S3 Storage Lens configuration requested.
    storage_lens_configuration: ?StorageLensConfiguration = null,
};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetStorageLensConfigurationInput, options: Options) !GetStorageLensConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetStorageLensConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetStorageLensConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetStorageLensConfigurationOutput = .{};
