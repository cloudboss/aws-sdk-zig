...
pub const DeleteAccessPointForObjectLambdaInput = struct {
...
pub const DeleteAccessPointForObjectLambdaOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessPointForObjectLambdaInput, options: CallOptions) !DeleteAccessPointForObjectLambdaOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccessPointForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccessPointForObjectLambdaOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessPointForObjectLambdaOutput = .{};
