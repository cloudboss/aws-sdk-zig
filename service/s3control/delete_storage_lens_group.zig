...
const DeleteStorageLensGroupOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteStorageLensGroupInput, options: Options) !DeleteStorageLensGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteStorageLensGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/v20180820/storagelensgroup/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteStorageLensGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
