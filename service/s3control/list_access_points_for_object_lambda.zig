...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAccessPointsForObjectLambdaInput, options: CallOptions) !ListAccessPointsForObjectLambdaOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAccessPointsForObjectLambdaOutput {
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.object_lambda_access_point_list = try serde.deserializeObjectLambdaAccessPointList(allocator, &reader, "ObjectLambdaAccessPoint");
                } else {
