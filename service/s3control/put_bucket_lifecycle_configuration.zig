...
fn serializeRequest(alloc: std.mem.Allocator, input: PutBucketLifecycleConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const body: ?[]const u8 = blk: {
        if (input.lifecycle_configuration) |payload| {
            ...
            try body_buf.appendSlice(alloc, "<LifecycleConfiguration xmlns=" ++ &[_]u8{0x22} ++ "http://awss3control.amazonaws.com/doc/2018-08-20/" ++ &[_]u8{0x22} ++ ">");
            try serde.serializeLifecycleConfiguration(alloc, &body_buf, payload);
