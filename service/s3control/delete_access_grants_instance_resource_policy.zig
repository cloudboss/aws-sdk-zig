...
pub const DeleteAccessGrantsInstanceResourcePolicyInput = struct {
    /// The Amazon Web Services account ID of the S3 Access Grants instance.
    account_id: []const u8,
};

pub const DeleteAccessGrantsInstanceResourcePolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessGrantsInstanceResourcePolicyInput, options: CallOptions) !DeleteAccessGrantsInstanceResourcePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccessGrantsInstanceResourcePolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccessGrantsInstanceResourcePolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessGrantsInstanceResourcePolicyOutput = .{};
