...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessGrantInput, options: Options) !GetAccessGrantOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAccessGrantInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetAccessGrantOutput {
