...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRegionalBucketsInput, options: Options) !ListRegionalBucketsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListRegionalBucketsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListRegionalBucketsOutput {
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.regional_bucket_list = try serde.deserializeRegionalBucketList(&reader, alloc, "RegionalBucket");
                } else {
