...
pub const PutAccessPointPolicyInput = struct {
    ...
    /// access
    /// points](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-points.html) or [Managing access to shared datasets in directory buckets with access points](https://docs.aws.amazon.com/AmazonS3/latest/userguide/access-points-directory-buckets.html) in the *Amazon S3 User Guide*.
    policy: []const u8,
};

const PutAccessPointPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccessPointPolicyInput, options: Options) !PutAccessPointPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutAccessPointPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<PutAccessPointPolicyRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutAccessPointPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutAccessPointPolicyOutput = .{};
