...
pub const PutAccessPointPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccessPointPolicyInput, options: CallOptions) !PutAccessPointPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutAccessPointPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutAccessPointPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
