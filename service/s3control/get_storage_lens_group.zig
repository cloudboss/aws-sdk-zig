...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetStorageLensGroupInput, options: Options) !GetStorageLensGroupOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetStorageLensGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetStorageLensGroupOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
