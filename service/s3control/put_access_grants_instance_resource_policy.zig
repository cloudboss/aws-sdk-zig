...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccessGrantsInstanceResourcePolicyInput, options: Options) !PutAccessGrantsInstanceResourcePolicyOutput {
