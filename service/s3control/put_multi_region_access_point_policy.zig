...
const PutMultiRegionAccessPointPolicyInput = @import("put_multi_region_access_point_policy_request.zig").PutMultiRegionAccessPointPolicyRequest;
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutMultiRegionAccessPointPolicyInput, options: Options) !PutMultiRegionAccessPointPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutMultiRegionAccessPointPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<PutMultiRegionAccessPointPolicyRequest>");
    try body_buf.appendSlice(alloc, "<ClientToken>");
    try aws.xml.appendXmlEscaped(alloc, &body_buf, input.client_token);
    try body_buf.appendSlice(alloc, "</ClientToken>");
    try body_buf.appendSlice(alloc, "<Details>");
    try serde.serializePutMultiRegionAccessPointPolicyInput(alloc, &body_buf, input.details);
    try body_buf.appendSlice(alloc, "</Details>");
    try body_buf.appendSlice(alloc, "</PutMultiRegionAccessPointPolicyRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutMultiRegionAccessPointPolicyOutput {
