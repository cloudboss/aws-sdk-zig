...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessGrantsInstanceForPrefixInput, options: Options) !GetAccessGrantsInstanceForPrefixOutput {
