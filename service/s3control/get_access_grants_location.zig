...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessGrantsLocationInput, options: CallOptions) !GetAccessGrantsLocationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAccessGrantsLocationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAccessGrantsLocationOutput {
