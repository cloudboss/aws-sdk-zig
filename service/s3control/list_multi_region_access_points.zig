...
pub const ListMultiRegionAccessPointsInput = struct {
...
pub const ListMultiRegionAccessPointsOutput = struct {
    /// The list of Multi-Region Access Points associated with the user.
    access_points: ?[]const MultiRegionAccessPointReport = null,

    /// If the specified bucket has more Multi-Region Access Points than can be
    /// returned in one call to this
    /// action, this field contains a continuation token. You can use this token tin
    /// subsequent
    /// calls to this action to retrieve additional Multi-Region Access Points.
    next_token: ?[]const u8 = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMultiRegionAccessPointsInput, options: CallOptions) !ListMultiRegionAccessPointsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListMultiRegionAccessPointsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v20180820/mrap/instances";
