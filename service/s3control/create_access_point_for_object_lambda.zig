...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAccessPointForObjectLambdaInput, options: Options) !CreateAccessPointForObjectLambdaOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateAccessPointForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "<CreateAccessPointForObjectLambdaRequest>");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateAccessPointForObjectLambdaOutput {
