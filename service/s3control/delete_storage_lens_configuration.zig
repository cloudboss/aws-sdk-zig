...
pub const DeleteStorageLensConfigurationInput = struct {
...
pub const DeleteStorageLensConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteStorageLensConfigurationInput, options: CallOptions) !DeleteStorageLensConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteStorageLensConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteStorageLensConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteStorageLensConfigurationOutput = .{};
