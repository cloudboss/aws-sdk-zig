...
pub const DeleteAccessPointScopeInput = struct {
...
pub const DeleteAccessPointScopeOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessPointScopeInput, options: CallOptions) !DeleteAccessPointScopeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccessPointScopeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccessPointScopeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessPointScopeOutput = .{};
