...
/// S3
/// account. You can enable the configuration options in any combination. For
/// more information
...
pub const PublicAccessBlockConfiguration = struct {
    ...
    /// in this account.
    /// Setting this element to `TRUE` causes Amazon S3 to reject calls to PUT
    /// Bucket policy
    ...
    /// account. Setting
    /// this element to `TRUE` causes Amazon S3 to ignore all public ACLs on buckets
    /// in this
    ...
    /// buckets in this
    /// account. Setting this element to `TRUE` restricts access to buckets with
    /// public
    /// policies to only Amazon Web Services service principals and authorized users
    /// within this
    /// account.
    ///
