...
pub const DeleteBucketTaggingInput = struct {
...
const DeleteBucketTaggingOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBucketTaggingInput, options: Options) !DeleteBucketTaggingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBucketTaggingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteBucketTaggingOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
