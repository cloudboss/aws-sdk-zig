...
pub const DeleteAccessPointPolicyInput = struct {
...
pub const DeleteAccessPointPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccessPointPolicyInput, options: CallOptions) !DeleteAccessPointPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccessPointPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccessPointPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAccessPointPolicyOutput = .{};
