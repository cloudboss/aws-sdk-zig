...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessPointPolicyStatusForObjectLambdaInput, options: Options) !GetAccessPointPolicyStatusForObjectLambdaOutput {
