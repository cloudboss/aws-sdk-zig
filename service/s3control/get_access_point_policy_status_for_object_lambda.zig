...
pub const GetAccessPointPolicyStatusForObjectLambdaInput = struct {
...
pub const GetAccessPointPolicyStatusForObjectLambdaOutput = struct {
    policy_status: ?PolicyStatus = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccessPointPolicyStatusForObjectLambdaInput, options: CallOptions) !GetAccessPointPolicyStatusForObjectLambdaOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAccessPointPolicyStatusForObjectLambdaInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAccessPointPolicyStatusForObjectLambdaOutput {
    var result: GetAccessPointPolicyStatusForObjectLambdaOutput = .{};
    _ = status;
