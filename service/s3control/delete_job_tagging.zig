...
pub const DeleteJobTaggingInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteJobTaggingInput, options: Options) !DeleteJobTaggingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteJobTaggingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteJobTaggingOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteJobTaggingOutput = .{};
