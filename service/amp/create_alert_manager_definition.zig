...
pub const CreateAlertManagerDefinitionInput = struct {
...
pub const CreateAlertManagerDefinitionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAlertManagerDefinitionInput, options: CallOptions) !CreateAlertManagerDefinitionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateAlertManagerDefinitionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateAlertManagerDefinitionOutput {
    var result: CreateAlertManagerDefinitionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CreateAlertManagerDefinitionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
