...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeQueryLoggingConfigurationInput, options: Options) !DescribeQueryLoggingConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeQueryLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeQueryLoggingConfigurationOutput {
    var result: DescribeQueryLoggingConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeQueryLoggingConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
