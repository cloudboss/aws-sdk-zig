...
const WorkspaceConfigurationDescription = @import("workspace_configuration_description.zig").WorkspaceConfigurationDescription;
...
pub const DescribeWorkspaceConfigurationInput = struct {
    ...
    /// the IDs of your workspaces, use the
...
pub const DescribeWorkspaceConfigurationOutput = struct {
    ...
    workspace_configuration: ?WorkspaceConfigurationDescription = null,
