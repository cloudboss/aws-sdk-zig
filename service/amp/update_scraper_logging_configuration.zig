...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateScraperLoggingConfigurationInput, options: Options) !UpdateScraperLoggingConfigurationOutput {
