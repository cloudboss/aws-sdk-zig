...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeScraperLoggingConfigurationInput, options: Options) !DescribeScraperLoggingConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeScraperLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeScraperLoggingConfigurationOutput {
    var result: DescribeScraperLoggingConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeScraperLoggingConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
