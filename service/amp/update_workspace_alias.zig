...
pub const UpdateWorkspaceAliasInput = struct {
...
pub const UpdateWorkspaceAliasOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateWorkspaceAliasInput, options: CallOptions) !UpdateWorkspaceAliasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateWorkspaceAliasInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateWorkspaceAliasOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateWorkspaceAliasOutput = .{};
