...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePerformanceAnalysisReportInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "PerformanceInsightsv20180227.DeletePerformanceAnalysisReport");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePerformanceAnalysisReportOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
