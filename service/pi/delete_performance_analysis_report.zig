...
pub const DeletePerformanceAnalysisReportInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePerformanceAnalysisReportInput, options: Options) !DeletePerformanceAnalysisReportOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePerformanceAnalysisReportInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "PerformanceInsightsv20180227.DeletePerformanceAnalysisReport");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePerformanceAnalysisReportOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
