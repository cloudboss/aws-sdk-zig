...
pub const DescribeDimensionKeysPaginator = struct {
    client: *Client,
    params: describe_dimension_keys.DescribeDimensionKeysInput,
...
pub const GetResourceMetricsPaginator = struct {
    client: *Client,
    params: get_resource_metrics.GetResourceMetricsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListAvailableResourceDimensionsPaginator = struct {
    client: *Client,
    params: list_available_resource_dimensions.ListAvailableResourceDimensionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListAvailableResourceMetricsPaginator = struct {
    client: *Client,
    params: list_available_resource_metrics.ListAvailableResourceMetricsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListPerformanceAnalysisReportsPaginator = struct {
    client: *Client,
    params: list_performance_analysis_reports.ListPerformanceAnalysisReportsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
