...
pub const MapConfiguration = struct {
    ...
    /// can choose a view, such as `IND` for the Indian view.
    ///
    /// Default is unset.
    ///
    ...
    ///   basemap with a dark gray, neutral background with minimal colors, labels,
    ...
    ///   provides one meter or better satellite and aerial imagery in many parts of
    ...
    ///   provides a detailed vector basemap with a light gray, neutral background
    ...
    ///   detailed basemap for the world symbolized with a custom navigation map
    ...
    ///   attributes (e.g. width / height / HAZMAT) symbolized with highlighted
    ...
    ///   automatically retrieve both raster and vector tiles, and your charges will
    ///   be based on total tiles retrieved.
    ///
    ...
    /// more information, see [GrabMaps countries and area
    ...
    ///   application use. The map includes highways major roads, minor roads,
    ///   railways, water features, cities, parks, landmarks, building footprints,
    ...
    ///   style is a light-themed style with muted colors and fewer features that
    ///   aids in understanding overlaid data.
    /// * `VectorOpenDataVisualizationDark` – The Open Data Visualization Dark map
    ///   style is a dark-themed style with muted colors and fewer features that
    ///   aids in understanding overlaid data.
    style: []const u8,
