...
const ApiKeyFilter = @import("api_key_filter.zig").ApiKeyFilter;
const ListKeysResponseEntry = @import("list_keys_response_entry.zig").ListKeysResponseEntry;
...
pub const ListKeysOutput = struct {
    ...
    /// will expire.
    entries: ?[]const ListKeysResponseEntry = null,
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListKeysInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/metadata/v0/list-keys";
