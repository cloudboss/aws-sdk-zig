...
fn serializeRequest(alloc: std.mem.Allocator, input: GetMapStyleDescriptorInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/style-descriptor");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetMapStyleDescriptorOutput {
