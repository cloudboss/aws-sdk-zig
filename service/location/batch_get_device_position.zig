...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchGetDevicePositionInput, options: CallOptions) !BatchGetDevicePositionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchGetDevicePositionInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/get-positions");
