...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMapSpritesInput, options: Options) !GetMapSpritesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetMapSpritesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/sprites/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetMapSpritesOutput {
