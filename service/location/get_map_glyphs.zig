...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMapGlyphsInput, options: CallOptions) !GetMapGlyphsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetMapGlyphsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetMapGlyphsOutput {
