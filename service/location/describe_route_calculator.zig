...
pub const DescribeRouteCalculatorInput = struct {
...
pub const DescribeRouteCalculatorOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRouteCalculatorInput, options: Options) !DescribeRouteCalculatorOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeRouteCalculatorInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeRouteCalculatorOutput {
    var result: DescribeRouteCalculatorOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeRouteCalculatorOutput, body, alloc);
    }
    _ = status;
    _ = headers;
