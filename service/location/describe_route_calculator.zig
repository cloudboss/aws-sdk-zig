...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRouteCalculatorInput, options: CallOptions) !DescribeRouteCalculatorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeRouteCalculatorInput, config: *aws.Config) !aws.http.Request {
