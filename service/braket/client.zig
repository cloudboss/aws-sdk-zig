...
pub const Client = struct {
    ...
    pub fn cancelQuantumTask(self: *Self, allocator: std.mem.Allocator, input: cancel_quantum_task.CancelQuantumTaskInput, options: cancel_quantum_task.Options) !cancel_quantum_task.CancelQuantumTaskOutput {
    ...
    pub fn createQuantumTask(self: *Self, allocator: std.mem.Allocator, input: create_quantum_task.CreateQuantumTaskInput, options: create_quantum_task.Options) !create_quantum_task.CreateQuantumTaskOutput {
    ...
    pub fn createSpendingLimit(self: *Self, allocator: std.mem.Allocator, input: create_spending_limit.CreateSpendingLimitInput, options: create_spending_limit.Options) !create_spending_limit.CreateSpendingLimitOutput {
    ...
    pub fn deleteSpendingLimit(self: *Self, allocator: std.mem.Allocator, input: delete_spending_limit.DeleteSpendingLimitInput, options: delete_spending_limit.Options) !delete_spending_limit.DeleteSpendingLimitOutput {
    ...
    pub fn getQuantumTask(self: *Self, allocator: std.mem.Allocator, input: get_quantum_task.GetQuantumTaskInput, options: get_quantum_task.Options) !get_quantum_task.GetQuantumTaskOutput {
    ...
    pub fn searchDevices(self: *Self, allocator: std.mem.Allocator, input: search_devices.SearchDevicesInput, options: search_devices.Options) !search_devices.SearchDevicesOutput {
    ...
    pub fn searchQuantumTasks(self: *Self, allocator: std.mem.Allocator, input: search_quantum_tasks.SearchQuantumTasksInput, options: search_quantum_tasks.Options) !search_quantum_tasks.SearchQuantumTasksOutput {
    ...
    pub fn searchSpendingLimits(self: *Self, allocator: std.mem.Allocator, input: search_spending_limits.SearchSpendingLimitsInput, options: search_spending_limits.Options) !search_spending_limits.SearchSpendingLimitsOutput {
    ...
    pub fn updateSpendingLimit(self: *Self, allocator: std.mem.Allocator, input: update_spending_limit.UpdateSpendingLimitInput, options: update_spending_limit.Options) !update_spending_limit.UpdateSpendingLimitOutput {
