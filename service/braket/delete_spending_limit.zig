...
pub const DeleteSpendingLimitInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSpendingLimitInput, options: Options) !DeleteSpendingLimitOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSpendingLimitInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/delete");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSpendingLimitOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSpendingLimitOutput = .{};
