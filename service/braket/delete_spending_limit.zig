...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSpendingLimitInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/delete");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSpendingLimitOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
