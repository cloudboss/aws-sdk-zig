...
const DeleteDeploymentConfigOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDeploymentConfigInput, options: Options) !DeleteDeploymentConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDeploymentConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeDeploy_20141006.DeleteDeploymentConfig");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDeploymentConfigOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
