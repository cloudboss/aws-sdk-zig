...
pub const DeleteDeploymentConfigInput = struct {
...
pub const DeleteDeploymentConfigOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDeploymentConfigInput, options: CallOptions) !DeleteDeploymentConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDeploymentConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeDeploy_20141006.DeleteDeploymentConfig");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDeploymentConfigOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
