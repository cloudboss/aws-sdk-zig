...
pub const UpdateApplicationInput = struct {
    ...
    new_application_name: ?[]const u8 = null,
...
const UpdateApplicationOutput = struct {};
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeDeploy_20141006.UpdateApplication");
