...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteResourcesByExternalIdInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeDeploy_20141006.DeleteResourcesByExternalId");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteResourcesByExternalIdOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
