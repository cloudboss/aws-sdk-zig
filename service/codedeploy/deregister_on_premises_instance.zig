...
pub const DeregisterOnPremisesInstanceInput = struct {
...
pub const DeregisterOnPremisesInstanceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterOnPremisesInstanceInput, options: CallOptions) !DeregisterOnPremisesInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterOnPremisesInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeDeploy_20141006.DeregisterOnPremisesInstance");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterOnPremisesInstanceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
