...
const DeregisterOnPremisesInstanceOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterOnPremisesInstanceInput, options: Options) !DeregisterOnPremisesInstanceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeregisterOnPremisesInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeDeploy_20141006.DeregisterOnPremisesInstance");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeregisterOnPremisesInstanceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
