...
pub const ErrorInformation = struct {
    ...
    /// CodeDeploy](https://docs.aws.amazon.com/codedeploy/latest/userguide/error-codes.html) in the [CodeDeploy User Guide](https://docs.aws.amazon.com/codedeploy/latest/userguide).
    ///
    /// The error code:
    ///
    ...
    ///   code is
    /// most likely raised if the deployment group is deleted after the deployment
    /// is
