...
const RemoveTagsFromOnPremisesInstancesOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveTagsFromOnPremisesInstancesInput, options: Options) !RemoveTagsFromOnPremisesInstancesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveTagsFromOnPremisesInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeDeploy_20141006.RemoveTagsFromOnPremisesInstances");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RemoveTagsFromOnPremisesInstancesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
