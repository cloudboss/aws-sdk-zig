...
pub const RegisterOnPremisesInstanceInput = struct {
...
pub const RegisterOnPremisesInstanceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RegisterOnPremisesInstanceInput, options: CallOptions) !RegisterOnPremisesInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RegisterOnPremisesInstanceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeDeploy_20141006.RegisterOnPremisesInstance");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RegisterOnPremisesInstanceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
