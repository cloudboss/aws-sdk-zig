...
const SkipWaitTimeForInstanceTerminationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SkipWaitTimeForInstanceTerminationInput, options: Options) !SkipWaitTimeForInstanceTerminationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SkipWaitTimeForInstanceTerminationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodeDeploy_20141006.SkipWaitTimeForInstanceTermination");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SkipWaitTimeForInstanceTerminationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
