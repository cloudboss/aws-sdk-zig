...
pub const RegisterApplicationRevisionInput = struct {
...
pub const RegisterApplicationRevisionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RegisterApplicationRevisionInput, options: CallOptions) !RegisterApplicationRevisionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RegisterApplicationRevisionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodeDeploy_20141006.RegisterApplicationRevision");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RegisterApplicationRevisionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
