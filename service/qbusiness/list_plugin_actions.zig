...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPluginActionsInput, options: CallOptions) !ListPluginActionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPluginActionsInput, config: *aws.Config) !aws.http.Request {
