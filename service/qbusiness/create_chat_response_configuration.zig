...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateChatResponseConfigurationInput, options: CallOptions) !CreateChatResponseConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateChatResponseConfigurationInput, config: *aws.Config) !aws.http.Request {
