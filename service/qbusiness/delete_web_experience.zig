...
pub const DeleteWebExperienceInput = struct {
...
pub const DeleteWebExperienceOutput = struct {
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteWebExperienceInput, options: CallOptions) !DeleteWebExperienceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteWebExperienceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteWebExperienceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteWebExperienceOutput = .{};
