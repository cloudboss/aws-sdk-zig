...
pub const DeleteConversationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConversationInput, options: Options) !DeleteConversationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConversationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConversationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteConversationOutput = .{};
