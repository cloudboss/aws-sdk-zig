...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateWebExperienceInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.authentication_configuration) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"authenticationConfiguration\":");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateWebExperienceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
