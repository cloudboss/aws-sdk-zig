...
pub const UpdateDataAccessorInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDataAccessorInput, options: Options) !UpdateDataAccessorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDataAccessorInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDataAccessorOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateDataAccessorOutput = .{};
