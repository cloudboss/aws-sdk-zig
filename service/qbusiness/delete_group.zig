...
const DeleteGroupInput = @import("delete_group_request.zig").DeleteGroupRequest;

const DeleteGroupOutput = @import("delete_group_response.zig").DeleteGroupResponse;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGroupInput, options: Options) !DeleteGroupOutput {
