...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdatePluginInput, options: Options) !UpdatePluginOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdatePluginInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdatePluginOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
