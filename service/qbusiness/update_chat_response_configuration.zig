...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateChatResponseConfigurationInput, options: Options) !UpdateChatResponseConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateChatResponseConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateChatResponseConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
