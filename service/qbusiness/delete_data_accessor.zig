...
pub const DeleteDataAccessorInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataAccessorInput, options: Options) !DeleteDataAccessorOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteDataAccessorInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteDataAccessorOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteDataAccessorOutput = .{};
