...
pub const DeleteChatControlsConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChatControlsConfigurationInput, options: Options) !DeleteChatControlsConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteChatControlsConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteChatControlsConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteChatControlsConfigurationOutput = .{};
