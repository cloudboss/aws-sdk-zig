...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConversationsInput, options: CallOptions) !ListConversationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListConversationsInput, config: *aws.Config) !aws.http.Request {
