...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChatResponseConfigurationInput, options: Options) !DeleteChatResponseConfigurationOutput {
