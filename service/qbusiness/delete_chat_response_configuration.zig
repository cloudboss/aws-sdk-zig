...
pub const DeleteChatResponseConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChatResponseConfigurationInput, options: CallOptions) !DeleteChatResponseConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteChatResponseConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteChatResponseConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteChatResponseConfigurationOutput = .{};
