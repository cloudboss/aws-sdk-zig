...
pub const ListApprovalTeamsPaginator = struct {
    client: *Client,
    params: list_approval_teams.ListApprovalTeamsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_approval_teams.ListApprovalTeamsOutput {
        if (self.done) {
...
pub const ListIdentitySourcesPaginator = struct {
    client: *Client,
    params: list_identity_sources.ListIdentitySourcesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_identity_sources.ListIdentitySourcesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListResourcePoliciesPaginator = struct {
    client: *Client,
    params: list_resource_policies.ListResourcePoliciesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_resource_policies.ListResourcePoliciesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
