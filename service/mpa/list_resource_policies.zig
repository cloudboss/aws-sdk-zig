...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResourcePoliciesInput, options: CallOptions) !ListResourcePoliciesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListResourcePoliciesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/resource-policies/");
