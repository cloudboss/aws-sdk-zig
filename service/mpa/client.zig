...
pub const Client = struct {
    ...
    pub fn cancelSession(self: *Self, allocator: std.mem.Allocator, input: cancel_session.CancelSessionInput, options: cancel_session.Options) !cancel_session.CancelSessionOutput {
    ...
    pub fn createApprovalTeam(self: *Self, allocator: std.mem.Allocator, input: create_approval_team.CreateApprovalTeamInput, options: create_approval_team.Options) !create_approval_team.CreateApprovalTeamOutput {
    ...
    pub fn deleteInactiveApprovalTeamVersion(self: *Self, allocator: std.mem.Allocator, input: delete_inactive_approval_team_version.DeleteInactiveApprovalTeamVersionInput, options: delete_inactive_approval_team_version.Options) !delete_inactive_approval_team_version.DeleteInactiveApprovalTeamVersionOutput {
        return delete_inactive_approval_team_version.execute(self, allocator, input, options);
    }

    /// Returns details for an approval team.
    pub fn getApprovalTeam(self: *Self, allocator: std.mem.Allocator, input: get_approval_team.GetApprovalTeamInput, options: get_approval_team.Options) !get_approval_team.GetApprovalTeamOutput {
    ...
    pub fn listApprovalTeams(self: *Self, allocator: std.mem.Allocator, input: list_approval_teams.ListApprovalTeamsInput, options: list_approval_teams.Options) !list_approval_teams.ListApprovalTeamsOutput {
    ...
    pub fn startActiveApprovalTeamDeletion(self: *Self, allocator: std.mem.Allocator, input: start_active_approval_team_deletion.StartActiveApprovalTeamDeletionInput, options: start_active_approval_team_deletion.Options) !start_active_approval_team_deletion.StartActiveApprovalTeamDeletionOutput {
    ...
    pub fn updateApprovalTeam(self: *Self, allocator: std.mem.Allocator, input: update_approval_team.UpdateApprovalTeamInput, options: update_approval_team.Options) !update_approval_team.UpdateApprovalTeamOutput {
