...
/// see [Lustre root
/// squash](https://docs.aws.amazon.com/fsx/latest/LustreGuide/root-squash.html).
///
...
pub const LustreRootSquashConfiguration = struct {
    /// When root squash is enabled, you can optionally specify an array of NIDs of
    /// clients
    /// for which root squash does not apply. A client NID is a Lustre Network
    /// Identifier used
    /// to uniquely identify a client. You can specify the NID as either a single
    /// address or a
    /// range of addresses:
    ///
