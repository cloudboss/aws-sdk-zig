...
pub const DetachAndDeleteS3AccessPointInput = struct {
...
pub const DetachAndDeleteS3AccessPointOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachAndDeleteS3AccessPointInput, options: CallOptions) !DetachAndDeleteS3AccessPointOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachAndDeleteS3AccessPointInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSSimbaAPIService_v20180301.DetachAndDeleteS3AccessPoint");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachAndDeleteS3AccessPointOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DetachAndDeleteS3AccessPointOutput, body, allocator);
}
