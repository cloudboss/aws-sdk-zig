...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeSharedVpcConfigurationInput, options: Options) !DescribeSharedVpcConfigurationOutput {
