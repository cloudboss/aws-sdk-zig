...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartMisconfiguredStateRecoveryInput, options: Options) !StartMisconfiguredStateRecoveryOutput {
