...
pub const PutEncryptionConfigurationInput = struct {
...
pub const PutEncryptionConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutEncryptionConfigurationInput, options: CallOptions) !PutEncryptionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutEncryptionConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "IoTAutobahnControlPlane.PutEncryptionConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutEncryptionConfigurationOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(PutEncryptionConfigurationOutput, body, allocator);
}
