...
pub const Client = struct {
    ...
    pub fn associateVehicleFleet(self: *Self, allocator: std.mem.Allocator, input: associate_vehicle_fleet.AssociateVehicleFleetInput, options: CallOptions) !associate_vehicle_fleet.AssociateVehicleFleetOutput {
    ...
    pub fn batchCreateVehicle(self: *Self, allocator: std.mem.Allocator, input: batch_create_vehicle.BatchCreateVehicleInput, options: CallOptions) !batch_create_vehicle.BatchCreateVehicleOutput {
    ...
    pub fn batchUpdateVehicle(self: *Self, allocator: std.mem.Allocator, input: batch_update_vehicle.BatchUpdateVehicleInput, options: CallOptions) !batch_update_vehicle.BatchUpdateVehicleOutput {
    ...
    pub fn createDecoderManifest(self: *Self, allocator: std.mem.Allocator, input: create_decoder_manifest.CreateDecoderManifestInput, options: CallOptions) !create_decoder_manifest.CreateDecoderManifestOutput {
    ...
    pub fn createModelManifest(self: *Self, allocator: std.mem.Allocator, input: create_model_manifest.CreateModelManifestInput, options: CallOptions) !create_model_manifest.CreateModelManifestOutput {
    ...
    /// vehicle
    /// models.
    pub fn createSignalCatalog(self: *Self, allocator: std.mem.Allocator, input: create_signal_catalog.CreateSignalCatalogInput, options: CallOptions) !create_signal_catalog.CreateSignalCatalogOutput {
    ...
    /// gated. For more information, see [Amazon Web Services Region and feature
    /// availability](https://docs.aws.amazon.com/iot-fleetwise/latest/developerguide/fleetwise-regions.html) in the *Amazon Web Services IoT FleetWise Developer Guide*.
    pub fn createStateTemplate(self: *Self, allocator: std.mem.Allocator, input: create_state_template.CreateStateTemplateInput, options: CallOptions) !create_state_template.CreateStateTemplateOutput {
    ...
    pub fn createVehicle(self: *Self, allocator: std.mem.Allocator, input: create_vehicle.CreateVehicleInput, options: CallOptions) !create_vehicle.CreateVehicleOutput {
    ...
    /// vehicles
    /// associated with it.
    pub fn deleteDecoderManifest(self: *Self, allocator: std.mem.Allocator, input: delete_decoder_manifest.DeleteDecoderManifestInput, options: CallOptions) !delete_decoder_manifest.DeleteDecoderManifestOutput {
    ...
    pub fn deleteModelManifest(self: *Self, allocator: std.mem.Allocator, input: delete_model_manifest.DeleteModelManifestInput, options: CallOptions) !delete_model_manifest.DeleteModelManifestOutput {
        return delete_model_manifest.execute(self, allocator, input, options);
    }

    /// Deletes a signal catalog.
    pub fn deleteSignalCatalog(self: *Self, allocator: std.mem.Allocator, input: delete_signal_catalog.DeleteSignalCatalogInput, options: CallOptions) !delete_signal_catalog.DeleteSignalCatalogOutput {
        return delete_signal_catalog.execute(self, allocator, input, options);
    }

    /// Deletes a state template.
    pub fn deleteStateTemplate(self: *Self, allocator: std.mem.Allocator, input: delete_state_template.DeleteStateTemplateInput, options: CallOptions) !delete_state_template.DeleteStateTemplateOutput {
        return delete_state_template.execute(self, allocator, input, options);
    }

    /// Deletes a vehicle and removes it from any campaigns.
    pub fn deleteVehicle(self: *Self, allocator: std.mem.Allocator, input: delete_vehicle.DeleteVehicleInput, options: CallOptions) !delete_vehicle.DeleteVehicleOutput {
    ...
    pub fn disassociateVehicleFleet(self: *Self, allocator: std.mem.Allocator, input: disassociate_vehicle_fleet.DisassociateVehicleFleetInput, options: CallOptions) !disassociate_vehicle_fleet.DisassociateVehicleFleetOutput {
    ...
    pub fn getDecoderManifest(self: *Self, allocator: std.mem.Allocator, input: get_decoder_manifest.GetDecoderManifestInput, options: CallOptions) !get_decoder_manifest.GetDecoderManifestOutput {
    ...
    pub fn getEncryptionConfiguration(self: *Self, allocator: std.mem.Allocator, input: get_encryption_configuration.GetEncryptionConfigurationInput, options: CallOptions) !get_encryption_configuration.GetEncryptionConfigurationOutput {
    ...
    pub fn getModelManifest(self: *Self, allocator: std.mem.Allocator, input: get_model_manifest.GetModelManifestInput, options: CallOptions) !get_model_manifest.GetModelManifestOutput {
    ...
    pub fn getRegisterAccountStatus(self: *Self, allocator: std.mem.Allocator, input: get_register_account_status.GetRegisterAccountStatusInput, options: CallOptions) !get_register_account_status.GetRegisterAccountStatusOutput {
        return get_register_account_status.execute(self, allocator, input, options);
    }

    /// Retrieves information about a signal catalog.
    pub fn getSignalCatalog(self: *Self, allocator: std.mem.Allocator, input: get_signal_catalog.GetSignalCatalogInput, options: CallOptions) !get_signal_catalog.GetSignalCatalogOutput {
    ...
    /// gated. For more information, see [Amazon Web Services Region and feature
    /// availability](https://docs.aws.amazon.com/iot-fleetwise/latest/developerguide/fleetwise-regions.html) in the *Amazon Web Services IoT FleetWise Developer Guide*.
    pub fn getStateTemplate(self: *Self, allocator: std.mem.Allocator, input: get_state_template.GetStateTemplateInput, options: CallOptions) !get_state_template.GetStateTemplateOutput {
        return get_state_template.execute(self, allocator, input, options);
    }

    /// Retrieves information about a vehicle.
    pub fn getVehicle(self: *Self, allocator: std.mem.Allocator, input: get_vehicle.GetVehicleInput, options: CallOptions) !get_vehicle.GetVehicleOutput {
    ...
    pub fn getVehicleStatus(self: *Self, allocator: std.mem.Allocator, input: get_vehicle_status.GetVehicleStatusInput, options: CallOptions) !get_vehicle_status.GetVehicleStatusOutput {
    ...
    pub fn importDecoderManifest(self: *Self, allocator: std.mem.Allocator, input: import_decoder_manifest.ImportDecoderManifestInput, options: CallOptions) !import_decoder_manifest.ImportDecoderManifestOutput {
    ...
    /// local
    /// device.
    pub fn importSignalCatalog(self: *Self, allocator: std.mem.Allocator, input: import_signal_catalog.ImportSignalCatalogInput, options: CallOptions) !import_signal_catalog.ImportSignalCatalogOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listDecoderManifestNetworkInterfaces(self: *Self, allocator: std.mem.Allocator, input: list_decoder_manifest_network_interfaces.ListDecoderManifestNetworkInterfacesInput, options: CallOptions) !list_decoder_manifest_network_interfaces.ListDecoderManifestNetworkInterfacesOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listDecoderManifestSignals(self: *Self, allocator: std.mem.Allocator, input: list_decoder_manifest_signals.ListDecoderManifestSignalsInput, options: CallOptions) !list_decoder_manifest_signals.ListDecoderManifestSignalsOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listDecoderManifests(self: *Self, allocator: std.mem.Allocator, input: list_decoder_manifests.ListDecoderManifestsInput, options: CallOptions) !list_decoder_manifests.ListDecoderManifestsOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listFleetsForVehicle(self: *Self, allocator: std.mem.Allocator, input: list_fleets_for_vehicle.ListFleetsForVehicleInput, options: CallOptions) !list_fleets_for_vehicle.ListFleetsForVehicleOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listModelManifestNodes(self: *Self, allocator: std.mem.Allocator, input: list_model_manifest_nodes.ListModelManifestNodesInput, options: CallOptions) !list_model_manifest_nodes.ListModelManifestNodesOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listModelManifests(self: *Self, allocator: std.mem.Allocator, input: list_model_manifests.ListModelManifestsInput, options: CallOptions) !list_model_manifests.ListModelManifestsOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listSignalCatalogNodes(self: *Self, allocator: std.mem.Allocator, input: list_signal_catalog_nodes.ListSignalCatalogNodesInput, options: CallOptions) !list_signal_catalog_nodes.ListSignalCatalogNodesOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listSignalCatalogs(self: *Self, allocator: std.mem.Allocator, input: list_signal_catalogs.ListSignalCatalogsInput, options: CallOptions) !list_signal_catalogs.ListSignalCatalogsOutput {
    ...
    /// gated. For more information, see [Amazon Web Services Region and feature
    /// availability](https://docs.aws.amazon.com/iot-fleetwise/latest/developerguide/fleetwise-regions.html) in the *Amazon Web Services IoT FleetWise Developer Guide*.
    pub fn listStateTemplates(self: *Self, allocator: std.mem.Allocator, input: list_state_templates.ListStateTemplatesInput, options: CallOptions) !list_state_templates.ListStateTemplatesOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listVehicles(self: *Self, allocator: std.mem.Allocator, input: list_vehicles.ListVehiclesInput, options: CallOptions) !list_vehicles.ListVehiclesOutput {
    ...
    /// This API operation uses pagination. Specify the `nextToken` parameter in the
    /// request to return more results.
    pub fn listVehiclesInFleet(self: *Self, allocator: std.mem.Allocator, input: list_vehicles_in_fleet.ListVehiclesInFleetInput, options: CallOptions) !list_vehicles_in_fleet.ListVehiclesInFleetOutput {
    ...
    pub fn putEncryptionConfiguration(self: *Self, allocator: std.mem.Allocator, input: put_encryption_configuration.PutEncryptionConfigurationInput, options: CallOptions) !put_encryption_configuration.PutEncryptionConfigurationOutput {
    ...
    pub fn updateDecoderManifest(self: *Self, allocator: std.mem.Allocator, input: update_decoder_manifest.UpdateDecoderManifestInput, options: CallOptions) !update_decoder_manifest.UpdateDecoderManifestOutput {
    ...
    pub fn updateModelManifest(self: *Self, allocator: std.mem.Allocator, input: update_model_manifest.UpdateModelManifestInput, options: CallOptions) !update_model_manifest.UpdateModelManifestOutput {
        return update_model_manifest.execute(self, allocator, input, options);
    }

    /// Updates a signal catalog.
    pub fn updateSignalCatalog(self: *Self, allocator: std.mem.Allocator, input: update_signal_catalog.UpdateSignalCatalogInput, options: CallOptions) !update_signal_catalog.UpdateSignalCatalogOutput {
    ...
    /// gated. For more information, see [Amazon Web Services Region and feature
    /// availability](https://docs.aws.amazon.com/iot-fleetwise/latest/developerguide/fleetwise-regions.html) in the *Amazon Web Services IoT FleetWise Developer Guide*.
    pub fn updateStateTemplate(self: *Self, allocator: std.mem.Allocator, input: update_state_template.UpdateStateTemplateInput, options: CallOptions) !update_state_template.UpdateStateTemplateOutput {
    ...
    /// gated. For more information, see [Amazon Web Services Region and feature
    /// availability](https://docs.aws.amazon.com/iot-fleetwise/latest/developerguide/fleetwise-regions.html) in the *Amazon Web Services IoT FleetWise Developer Guide*.
    pub fn updateVehicle(self: *Self, allocator: std.mem.Allocator, input: update_vehicle.UpdateVehicleInput, options: CallOptions) !update_vehicle.UpdateVehicleOutput {
