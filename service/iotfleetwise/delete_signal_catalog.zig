...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSignalCatalogInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "IoTAutobahnControlPlane.DeleteSignalCatalog");
