...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "NetworkFirewall_20201112.UpdateLoggingConfiguration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateLoggingConfigurationOutput {
    ...
    return aws.json.parseJsonObject(UpdateLoggingConfigurationOutput, body, alloc);
}
