...
pub const AssociateAvailabilityZonesInput = struct {
...
pub const AssociateAvailabilityZonesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateAvailabilityZonesInput, options: CallOptions) !AssociateAvailabilityZonesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateAvailabilityZonesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.AssociateAvailabilityZones");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateAvailabilityZonesOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(AssociateAvailabilityZonesOutput, body, allocator);
}
