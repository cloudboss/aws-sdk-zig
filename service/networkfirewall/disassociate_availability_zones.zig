...
pub const DisassociateAvailabilityZonesInput = struct {
...
pub const DisassociateAvailabilityZonesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateAvailabilityZonesInput, options: CallOptions) !DisassociateAvailabilityZonesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateAvailabilityZonesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.DisassociateAvailabilityZones");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateAvailabilityZonesOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DisassociateAvailabilityZonesOutput, body, allocator);
}
