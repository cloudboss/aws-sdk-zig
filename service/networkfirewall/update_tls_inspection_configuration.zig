...
pub const UpdateTLSInspectionConfigurationInput = struct {
...
pub const UpdateTLSInspectionConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateTLSInspectionConfigurationInput, options: CallOptions) !UpdateTLSInspectionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateTLSInspectionConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.UpdateTLSInspectionConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateTLSInspectionConfigurationOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(UpdateTLSInspectionConfigurationOutput, body, allocator);
}
