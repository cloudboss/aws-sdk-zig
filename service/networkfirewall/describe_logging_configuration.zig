...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.DescribeLoggingConfiguration");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeLoggingConfigurationOutput {
    ...
    return aws.json.parseJsonObject(DescribeLoggingConfigurationOutput, body, allocator);
}
