...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeLoggingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "NetworkFirewall_20201112.DescribeLoggingConfiguration");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeLoggingConfigurationOutput {
    ...
    return aws.json.parseJsonObject(DescribeLoggingConfigurationOutput, body, alloc);
}
