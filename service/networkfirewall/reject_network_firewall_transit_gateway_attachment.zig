...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectNetworkFirewallTransitGatewayAttachmentInput, options: Options) !RejectNetworkFirewallTransitGatewayAttachmentOutput {
