...
pub const RejectNetworkFirewallTransitGatewayAttachmentInput = struct {
...
pub const RejectNetworkFirewallTransitGatewayAttachmentOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectNetworkFirewallTransitGatewayAttachmentInput, options: CallOptions) !RejectNetworkFirewallTransitGatewayAttachmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RejectNetworkFirewallTransitGatewayAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.RejectNetworkFirewallTransitGatewayAttachment");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RejectNetworkFirewallTransitGatewayAttachmentOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(RejectNetworkFirewallTransitGatewayAttachmentOutput, body, allocator);
}
