...
pub const DeleteVpcEndpointAssociationInput = struct {
...
pub const DeleteVpcEndpointAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVpcEndpointAssociationInput, options: CallOptions) !DeleteVpcEndpointAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVpcEndpointAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.DeleteVpcEndpointAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVpcEndpointAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DeleteVpcEndpointAssociationOutput, body, allocator);
}
