...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAvailabilityZoneChangeProtectionInput, options: Options) !UpdateAvailabilityZoneChangeProtectionOutput {
