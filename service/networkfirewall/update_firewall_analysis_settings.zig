...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFirewallAnalysisSettingsInput, options: Options) !UpdateFirewallAnalysisSettingsOutput {
