...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFirewallEncryptionConfigurationInput, options: Options) !UpdateFirewallEncryptionConfigurationOutput {
