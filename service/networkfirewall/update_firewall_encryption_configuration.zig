...
pub const UpdateFirewallEncryptionConfigurationInput = struct {
...
pub const UpdateFirewallEncryptionConfigurationOutput = struct {
    encryption_configuration: ?EncryptionConfiguration = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFirewallEncryptionConfigurationInput, options: CallOptions) !UpdateFirewallEncryptionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateFirewallEncryptionConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.UpdateFirewallEncryptionConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateFirewallEncryptionConfigurationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateFirewallEncryptionConfigurationOutput, body, allocator);
}
