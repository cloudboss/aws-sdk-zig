...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTLSInspectionConfigurationsInput, options: Options) !ListTLSInspectionConfigurationsOutput {
