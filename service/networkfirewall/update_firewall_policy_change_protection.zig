...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFirewallPolicyChangeProtectionInput, options: Options) !UpdateFirewallPolicyChangeProtectionOutput {
