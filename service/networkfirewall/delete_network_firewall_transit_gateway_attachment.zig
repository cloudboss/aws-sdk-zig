...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteNetworkFirewallTransitGatewayAttachmentInput, options: CallOptions) !DeleteNetworkFirewallTransitGatewayAttachmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteNetworkFirewallTransitGatewayAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "NetworkFirewall_20201112.DeleteNetworkFirewallTransitGatewayAttachment");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteNetworkFirewallTransitGatewayAttachmentOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DeleteNetworkFirewallTransitGatewayAttachmentOutput, body, allocator);
}
