...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachRuleGroupsToProxyConfigurationInput, options: Options) !AttachRuleGroupsToProxyConfigurationOutput {
