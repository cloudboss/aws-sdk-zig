...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachRuleGroupsFromProxyConfigurationInput, options: Options) !DetachRuleGroupsFromProxyConfigurationOutput {
