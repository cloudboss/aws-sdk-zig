...
const ChannelBan = @import("channel_ban.zig").ChannelBan;

pub const DescribeChannelBanInput = struct {
...
pub const DescribeChannelBanOutput = struct {
    /// The details of the ban.
    channel_ban: ?ChannelBan = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelBanInput, options: Options) !DescribeChannelBanOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeChannelBanInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeChannelBanOutput {
    var result: DescribeChannelBanOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeChannelBanOutput, body, alloc);
    }
    _ = status;
    _ = headers;
