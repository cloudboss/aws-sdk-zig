...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelBanInput, options: CallOptions) !DescribeChannelBanOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeChannelBanInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeChannelBanOutput {
    var result: DescribeChannelBanOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeChannelBanOutput, body, allocator);
    }
    _ = status;
    _ = headers;
