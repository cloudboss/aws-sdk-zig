...
pub const DeleteChannelModeratorInput = struct {
...
pub const DeleteChannelModeratorOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelModeratorInput, options: CallOptions) !DeleteChannelModeratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteChannelModeratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.channel_moderator_arn);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteChannelModeratorOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteChannelModeratorOutput = .{};
