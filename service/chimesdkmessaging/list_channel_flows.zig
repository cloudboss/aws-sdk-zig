...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListChannelFlowsInput, options: CallOptions) !ListChannelFlowsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListChannelFlowsInput, config: *aws.Config) !aws.http.Request {
