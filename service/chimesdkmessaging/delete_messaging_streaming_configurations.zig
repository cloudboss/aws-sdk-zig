...
pub const DeleteMessagingStreamingConfigurationsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMessagingStreamingConfigurationsInput, options: CallOptions) !DeleteMessagingStreamingConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMessagingStreamingConfigurationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMessagingStreamingConfigurationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
