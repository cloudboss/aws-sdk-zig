...
pub const GetChannelMembershipPreferencesInput = struct {
...
pub const GetChannelMembershipPreferencesOutput = struct {
    /// The ARN of the channel.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChannelMembershipPreferencesInput, options: CallOptions) !GetChannelMembershipPreferencesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetChannelMembershipPreferencesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetChannelMembershipPreferencesOutput {
    var result: GetChannelMembershipPreferencesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetChannelMembershipPreferencesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
