...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChannelMembershipPreferencesInput, options: Options) !GetChannelMembershipPreferencesOutput {
