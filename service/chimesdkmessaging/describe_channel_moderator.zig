...
const ChannelModerator = @import("channel_moderator.zig").ChannelModerator;

pub const DescribeChannelModeratorInput = struct {
...
pub const DescribeChannelModeratorOutput = struct {
    /// The details of the channel moderator.
    channel_moderator: ?ChannelModerator = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelModeratorInput, options: Options) !DescribeChannelModeratorOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeChannelModeratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.channel_moderator_arn);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeChannelModeratorOutput {
    var result: DescribeChannelModeratorOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeChannelModeratorOutput, body, alloc);
    }
    _ = status;
    _ = headers;
