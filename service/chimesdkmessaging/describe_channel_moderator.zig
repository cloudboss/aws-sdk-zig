...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelModeratorInput, options: CallOptions) !DescribeChannelModeratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeChannelModeratorInput, config: *aws.Config) !aws.http.Request {
