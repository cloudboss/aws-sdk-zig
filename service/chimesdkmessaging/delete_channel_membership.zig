...
pub const DeleteChannelMembershipInput = struct {
...
pub const DeleteChannelMembershipOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelMembershipInput, options: CallOptions) !DeleteChannelMembershipOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteChannelMembershipInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteChannelMembershipOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteChannelMembershipOutput = .{};
