...
const ChannelMembershipSummary = @import("channel_membership_summary.zig").ChannelMembershipSummary;

pub const ListChannelMembershipsInput = struct {
...
pub const ListChannelMembershipsOutput = struct {
    /// The ARN of the channel.
    channel_arn: ?[]const u8 = null,

    /// The information for the requested channel memberships.
    channel_memberships: ?[]const ChannelMembershipSummary = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListChannelMembershipsInput, options: Options) !ListChannelMembershipsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListChannelMembershipsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListChannelMembershipsOutput {
    var result: ListChannelMembershipsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListChannelMembershipsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
