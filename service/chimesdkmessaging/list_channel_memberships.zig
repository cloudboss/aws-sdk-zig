...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListChannelMembershipsInput, options: CallOptions) !ListChannelMembershipsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListChannelMembershipsInput, config: *aws.Config) !aws.http.Request {
