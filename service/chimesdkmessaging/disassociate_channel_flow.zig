...
pub const DisassociateChannelFlowInput = struct {
...
const DisassociateChannelFlowOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateChannelFlowInput, options: Options) !DisassociateChannelFlowOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateChannelFlowInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/channel-flow/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateChannelFlowOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DisassociateChannelFlowOutput = .{};
