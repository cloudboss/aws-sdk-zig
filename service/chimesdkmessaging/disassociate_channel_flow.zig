...
pub const DisassociateChannelFlowOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateChannelFlowInput, options: CallOptions) !DisassociateChannelFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateChannelFlowInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/channel-flow/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateChannelFlowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
