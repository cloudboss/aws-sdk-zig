...
const DeleteChannelBanOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelBanInput, options: Options) !DeleteChannelBanOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteChannelBanInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteChannelBanOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
