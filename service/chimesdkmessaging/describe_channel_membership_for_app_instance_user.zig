...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelMembershipForAppInstanceUserInput, options: CallOptions) !DescribeChannelMembershipForAppInstanceUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeChannelMembershipForAppInstanceUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "scope=app-instance-user-membership");
    query_has_prev = true;
