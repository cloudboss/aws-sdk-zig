...
const ChannelMessage = @import("channel_message.zig").ChannelMessage;

pub const GetChannelMessageInput = struct {
...
pub const GetChannelMessageOutput = struct {
    /// The details of and content in the message.
    channel_message: ?ChannelMessage = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChannelMessageInput, options: CallOptions) !GetChannelMessageOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetChannelMessageInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetChannelMessageOutput {
    var result: GetChannelMessageOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetChannelMessageOutput, body, allocator);
    }
    _ = status;
    _ = headers;
