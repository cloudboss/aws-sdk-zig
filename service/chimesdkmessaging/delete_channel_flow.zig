...
pub const DeleteChannelFlowOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelFlowInput, options: CallOptions) !DeleteChannelFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteChannelFlowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteChannelFlowOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
