...
const DeleteChannelMessageOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteChannelMessageInput, options: Options) !DeleteChannelMessageOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteChannelMessageInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteChannelMessageOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
