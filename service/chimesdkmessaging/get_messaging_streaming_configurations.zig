...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMessagingStreamingConfigurationsInput, options: Options) !GetMessagingStreamingConfigurationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetMessagingStreamingConfigurationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetMessagingStreamingConfigurationsOutput {
    var result: GetMessagingStreamingConfigurationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetMessagingStreamingConfigurationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
