...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeChannelFlowInput, options: CallOptions) !DescribeChannelFlowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeChannelFlowInput, config: *aws.Config) !aws.http.Request {
