...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetLifecycleExecutionInput, options: CallOptions) !GetLifecycleExecutionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetLifecycleExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    try query_buf.appendSlice(allocator, "lifecycleExecutionId=");
    try aws.url.appendUrlEncoded(allocator, &query_buf, input.lifecycle_execution_id);
    query_has_prev = true;
