...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDistributionConfigurationInput, options: Options) !DeleteDistributionConfigurationOutput {
