...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateDistributionConfigurationInput, options: CallOptions) !CreateDistributionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateDistributionConfigurationInput, config: *aws.Config) !aws.http.Request {
