...
pub const DeleteInfrastructureConfigurationInput = struct {
...
pub const DeleteInfrastructureConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInfrastructureConfigurationInput, options: Options) !DeleteInfrastructureConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteInfrastructureConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/DeleteInfrastructureConfiguration";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteInfrastructureConfigurationOutput {
    var result: DeleteInfrastructureConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteInfrastructureConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
