...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInfrastructureConfigurationInput, options: CallOptions) !DeleteInfrastructureConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteInfrastructureConfigurationInput, config: *aws.Config) !aws.http.Request {
