...
pub const GetDistributionConfigurationInput = struct {
...
pub const GetDistributionConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDistributionConfigurationInput, options: CallOptions) !GetDistributionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDistributionConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/GetDistributionConfiguration";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDistributionConfigurationOutput {
    var result: GetDistributionConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetDistributionConfigurationOutput, body, allocator);
    }
    _ = status;
    _ = headers;
