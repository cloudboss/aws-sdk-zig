...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListLifecycleExecutionsInput, options: CallOptions) !ListLifecycleExecutionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListLifecycleExecutionsInput, config: *aws.Config) !aws.http.Request {
