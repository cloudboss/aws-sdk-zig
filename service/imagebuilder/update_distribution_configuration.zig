...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDistributionConfigurationInput, options: CallOptions) !UpdateDistributionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDistributionConfigurationInput, config: *aws.Config) !aws.http.Request {
