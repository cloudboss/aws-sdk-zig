...
pub const ListImagePackagesOutput = struct {
    /// The list of Image Packages returned in the response.
    image_package_list: ?[]const ImagePackage = null,
    ...
    pub const json_field_names = .{
        .image_package_list = "imagePackageList",
        .next_token = "nextToken",
        .request_id = "requestId",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListImagePackagesInput, options: CallOptions) !ListImagePackagesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListImagePackagesInput, config: *aws.Config) !aws.http.Request {
