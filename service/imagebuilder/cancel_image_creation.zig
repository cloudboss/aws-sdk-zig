...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelImageCreationInput, options: CallOptions) !CancelImageCreationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelImageCreationInput, config: *aws.Config) !aws.http.Request {
