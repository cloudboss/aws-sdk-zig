...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetImageRecipeInput, options: CallOptions) !GetImageRecipeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetImageRecipeInput, config: *aws.Config) !aws.http.Request {
