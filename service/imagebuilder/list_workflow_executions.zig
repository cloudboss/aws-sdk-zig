...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListWorkflowExecutionsInput, options: CallOptions) !ListWorkflowExecutionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListWorkflowExecutionsInput, config: *aws.Config) !aws.http.Request {
