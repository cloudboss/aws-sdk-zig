...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateInfrastructureConfigurationInput, options: CallOptions) !UpdateInfrastructureConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateInfrastructureConfigurationInput, config: *aws.Config) !aws.http.Request {
