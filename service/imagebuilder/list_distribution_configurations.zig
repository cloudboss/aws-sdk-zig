...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionConfigurationsInput, options: Options) !ListDistributionConfigurationsOutput {
