...
const DistributionConfigurationSummary = @import("distribution_configuration_summary.zig").DistributionConfigurationSummary;

pub const ListDistributionConfigurationsInput = struct {
...
pub const ListDistributionConfigurationsOutput = struct {
    /// The list of distributions.
    distribution_configuration_summary_list: ?[]const DistributionConfigurationSummary = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDistributionConfigurationsInput, options: CallOptions) !ListDistributionConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDistributionConfigurationsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/ListDistributionConfigurations";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListDistributionConfigurationsOutput {
    var result: ListDistributionConfigurationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListDistributionConfigurationsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
