...
pub const Distribution = struct {
    ...
    fast_launch_configurations: ?[]const FastLaunchConfiguration,

    /// A group of launchTemplateConfiguration settings that apply to image
    /// distribution for
    /// specified accounts.
    launch_template_configurations: ?[]const LaunchTemplateConfiguration,
    ...
    ssm_parameter_configurations: ?[]const SsmParameterConfiguration,
