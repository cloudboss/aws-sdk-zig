...
pub const StartImagePipelineExecutionInput = struct {
...
pub const StartImagePipelineExecutionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartImagePipelineExecutionInput, options: CallOptions) !StartImagePipelineExecutionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartImagePipelineExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/StartImagePipelineExecution";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartImagePipelineExecutionOutput {
    var result: StartImagePipelineExecutionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(StartImagePipelineExecutionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
