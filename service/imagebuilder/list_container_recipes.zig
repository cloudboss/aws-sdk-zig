...
const ContainerRecipeSummary = @import("container_recipe_summary.zig").ContainerRecipeSummary;

pub const ListContainerRecipesInput = struct {
...
pub const ListContainerRecipesOutput = struct {
    /// The list of container recipes returned for the request.
    container_recipe_summary_list: ?[]const ContainerRecipeSummary = null,
    ...
    pub const json_field_names = .{
        .container_recipe_summary_list = "containerRecipeSummaryList",
        .next_token = "nextToken",
        .request_id = "requestId",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListContainerRecipesInput, options: CallOptions) !ListContainerRecipesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListContainerRecipesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/ListContainerRecipes";
