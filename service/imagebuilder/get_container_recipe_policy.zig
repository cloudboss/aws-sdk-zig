...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContainerRecipePolicyInput, options: CallOptions) !GetContainerRecipePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetContainerRecipePolicyInput, config: *aws.Config) !aws.http.Request {
