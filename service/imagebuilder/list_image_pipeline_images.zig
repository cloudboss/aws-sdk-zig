...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListImagePipelineImagesInput, options: CallOptions) !ListImagePipelineImagesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListImagePipelineImagesInput, config: *aws.Config) !aws.http.Request {
