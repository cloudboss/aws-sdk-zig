...
pub const ListImagePipelineImagesInput = struct {
...
pub const ListImagePipelineImagesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListImagePipelineImagesInput, options: Options) !ListImagePipelineImagesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListImagePipelineImagesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/ListImagePipelineImages";
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListImagePipelineImagesOutput {
    var result: ListImagePipelineImagesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListImagePipelineImagesOutput, body, alloc);
    }
    _ = status;
    _ = headers;
