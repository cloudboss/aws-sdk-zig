...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListWaitingWorkflowStepsInput, options: CallOptions) !ListWaitingWorkflowStepsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListWaitingWorkflowStepsInput, config: *aws.Config) !aws.http.Request {
