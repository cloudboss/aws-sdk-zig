...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetInfrastructureConfigurationInput, options: Options) !GetInfrastructureConfigurationOutput {
