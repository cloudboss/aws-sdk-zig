...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListComponentBuildVersionsInput, options: CallOptions) !ListComponentBuildVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListComponentBuildVersionsInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.component_version_arn) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"componentVersionArn\":");
