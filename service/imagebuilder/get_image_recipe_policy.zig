...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetImageRecipePolicyInput, options: CallOptions) !GetImageRecipePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetImageRecipePolicyInput, config: *aws.Config) !aws.http.Request {
