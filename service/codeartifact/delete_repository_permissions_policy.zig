...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRepositoryPermissionsPolicyInput, options: Options) !DeleteRepositoryPermissionsPolicyOutput {
