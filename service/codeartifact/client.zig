...
pub const Client = struct {
    ...
    /// connection.
    pub fn associateExternalConnection(self: *Self, allocator: std.mem.Allocator, input: associate_external_connection.AssociateExternalConnectionInput, options: CallOptions) !associate_external_connection.AssociateExternalConnectionOutput {
    ...
    pub fn copyPackageVersions(self: *Self, allocator: std.mem.Allocator, input: copy_package_versions.CopyPackageVersionsInput, options: CallOptions) !copy_package_versions.CopyPackageVersionsOutput {
    ...
    pub fn createPackageGroup(self: *Self, allocator: std.mem.Allocator, input: create_package_group.CreatePackageGroupInput, options: CallOptions) !create_package_group.CreatePackageGroupOutput {
    ...
    pub fn deleteDomainPermissionsPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_domain_permissions_policy.DeleteDomainPermissionsPolicyInput, options: CallOptions) !delete_domain_permissions_policy.DeleteDomainPermissionsPolicyOutput {
    ...
    pub fn deletePackageGroup(self: *Self, allocator: std.mem.Allocator, input: delete_package_group.DeletePackageGroupInput, options: CallOptions) !delete_package_group.DeletePackageGroupOutput {
    ...
    pub fn deletePackageVersions(self: *Self, allocator: std.mem.Allocator, input: delete_package_versions.DeletePackageVersionsInput, options: CallOptions) !delete_package_versions.DeletePackageVersionsOutput {
    ...
    pub fn deleteRepositoryPermissionsPolicy(self: *Self, allocator: std.mem.Allocator, input: delete_repository_permissions_policy.DeleteRepositoryPermissionsPolicyInput, options: CallOptions) !delete_repository_permissions_policy.DeleteRepositoryPermissionsPolicyOutput {
    ...
    pub fn describePackageGroup(self: *Self, allocator: std.mem.Allocator, input: describe_package_group.DescribePackageGroupInput, options: CallOptions) !describe_package_group.DescribePackageGroupOutput {
    ...
    pub fn describeRepository(self: *Self, allocator: std.mem.Allocator, input: describe_repository.DescribeRepositoryInput, options: CallOptions) !describe_repository.DescribeRepositoryOutput {
        return describe_repository.execute(self, allocator, input, options);
    }

    /// Removes an existing external connection from a repository.
    pub fn disassociateExternalConnection(self: *Self, allocator: std.mem.Allocator, input: disassociate_external_connection.DisassociateExternalConnectionInput, options: CallOptions) !disassociate_external_connection.DisassociateExternalConnectionOutput {
    ...
    pub fn disposePackageVersions(self: *Self, allocator: std.mem.Allocator, input: dispose_package_versions.DisposePackageVersionsInput, options: CallOptions) !dispose_package_versions.DisposePackageVersionsOutput {
    ...
    pub fn getAssociatedPackageGroup(self: *Self, allocator: std.mem.Allocator, input: get_associated_package_group.GetAssociatedPackageGroupInput, options: CallOptions) !get_associated_package_group.GetAssociatedPackageGroupOutput {
    ...
    pub fn getDomainPermissionsPolicy(self: *Self, allocator: std.mem.Allocator, input: get_domain_permissions_policy.GetDomainPermissionsPolicyInput, options: CallOptions) !get_domain_permissions_policy.GetDomainPermissionsPolicyOutput {
    ...
    pub fn getPackageVersionAsset(self: *Self, allocator: std.mem.Allocator, input: get_package_version_asset.GetPackageVersionAssetInput, options: CallOptions) !get_package_version_asset.GetPackageVersionAssetOutput {
    ...
    pub fn getPackageVersionReadme(self: *Self, allocator: std.mem.Allocator, input: get_package_version_readme.GetPackageVersionReadmeInput, options: CallOptions) !get_package_version_readme.GetPackageVersionReadmeOutput {
    ...
    ///
    /// * `swift`
    pub fn getRepositoryEndpoint(self: *Self, allocator: std.mem.Allocator, input: get_repository_endpoint.GetRepositoryEndpointInput, options: CallOptions) !get_repository_endpoint.GetRepositoryEndpointOutput {
        return get_repository_endpoint.execute(self, allocator, input, options);
    }

    /// Returns the resource policy that is set on a repository.
    pub fn getRepositoryPermissionsPolicy(self: *Self, allocator: std.mem.Allocator, input: get_repository_permissions_policy.GetRepositoryPermissionsPolicyInput, options: CallOptions) !get_repository_permissions_policy.GetRepositoryPermissionsPolicyOutput {
    ...
    pub fn listAllowedRepositoriesForGroup(self: *Self, allocator: std.mem.Allocator, input: list_allowed_repositories_for_group.ListAllowedRepositoriesForGroupInput, options: CallOptions) !list_allowed_repositories_for_group.ListAllowedRepositoriesForGroupOutput {
    ...
    /// definition syntax and matching
    /// behavior](https://docs.aws.amazon.com/codeartifact/latest/ug/package-group-definition-syntax-matching-behavior.html) in the *CodeArtifact User Guide*.
    pub fn listAssociatedPackages(self: *Self, allocator: std.mem.Allocator, input: list_associated_packages.ListAssociatedPackagesInput, options: CallOptions) !list_associated_packages.ListAssociatedPackagesOutput {
    ...
    pub fn listPackageGroups(self: *Self, allocator: std.mem.Allocator, input: list_package_groups.ListPackageGroupsInput, options: CallOptions) !list_package_groups.ListPackageGroupsOutput {
    ...
    pub fn listPackageVersionAssets(self: *Self, allocator: std.mem.Allocator, input: list_package_version_assets.ListPackageVersionAssetsInput, options: CallOptions) !list_package_version_assets.ListPackageVersionAssetsOutput {
    ...
    pub fn listPackageVersionDependencies(self: *Self, allocator: std.mem.Allocator, input: list_package_version_dependencies.ListPackageVersionDependenciesInput, options: CallOptions) !list_package_version_dependencies.ListPackageVersionDependenciesOutput {
    ...
    /// parameters.
    pub fn listRepositoriesInDomain(self: *Self, allocator: std.mem.Allocator, input: list_repositories_in_domain.ListRepositoriesInDomainInput, options: CallOptions) !list_repositories_in_domain.ListRepositoriesInDomainOutput {
    ...
    /// definition syntax and matching
    /// behavior](https://docs.aws.amazon.com/codeartifact/latest/ug/package-group-definition-syntax-matching-behavior.html) in the *CodeArtifact User Guide*.
    pub fn listSubPackageGroups(self: *Self, allocator: std.mem.Allocator, input: list_sub_package_groups.ListSubPackageGroupsInput, options: CallOptions) !list_sub_package_groups.ListSubPackageGroupsOutput {
    ...
    pub fn publishPackageVersion(self: *Self, allocator: std.mem.Allocator, input: publish_package_version.PublishPackageVersionInput, options: CallOptions) !publish_package_version.PublishPackageVersionOutput {
    ...
    pub fn putDomainPermissionsPolicy(self: *Self, allocator: std.mem.Allocator, input: put_domain_permissions_policy.PutDomainPermissionsPolicyInput, options: CallOptions) !put_domain_permissions_policy.PutDomainPermissionsPolicyOutput {
    ...
    pub fn putPackageOriginConfiguration(self: *Self, allocator: std.mem.Allocator, input: put_package_origin_configuration.PutPackageOriginConfigurationInput, options: CallOptions) !put_package_origin_configuration.PutPackageOriginConfigurationOutput {
    ...
    /// able to update the resource policy.
    pub fn putRepositoryPermissionsPolicy(self: *Self, allocator: std.mem.Allocator, input: put_repository_permissions_policy.PutRepositoryPermissionsPolicyInput, options: CallOptions) !put_repository_permissions_policy.PutRepositoryPermissionsPolicyOutput {
    ...
    pub fn updatePackageGroup(self: *Self, allocator: std.mem.Allocator, input: update_package_group.UpdatePackageGroupInput, options: CallOptions) !update_package_group.UpdatePackageGroupOutput {
    ...
    pub fn updatePackageGroupOriginConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_package_group_origin_configuration.UpdatePackageGroupOriginConfigurationInput, options: CallOptions) !update_package_group_origin_configuration.UpdatePackageGroupOriginConfigurationOutput {
    ...
    pub fn updatePackageVersionsStatus(self: *Self, allocator: std.mem.Allocator, input: update_package_versions_status.UpdatePackageVersionsStatusInput, options: CallOptions) !update_package_versions_status.UpdatePackageVersionsStatusOutput {
        return update_package_versions_status.execute(self, allocator, input, options);
    }

    /// Update the properties of a repository.
    pub fn updateRepository(self: *Self, allocator: std.mem.Allocator, input: update_repository.UpdateRepositoryInput, options: CallOptions) !update_repository.UpdateRepositoryOutput {
