...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDomainPermissionsPolicyInput, options: CallOptions) !GetDomainPermissionsPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDomainPermissionsPolicyInput, config: *aws.Config) !aws.http.Request {
