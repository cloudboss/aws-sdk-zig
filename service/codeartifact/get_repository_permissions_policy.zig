...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRepositoryPermissionsPolicyInput, options: Options) !GetRepositoryPermissionsPolicyOutput {
