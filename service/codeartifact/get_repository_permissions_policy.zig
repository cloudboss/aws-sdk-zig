...
pub const GetRepositoryPermissionsPolicyInput = struct {
...
pub const GetRepositoryPermissionsPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRepositoryPermissionsPolicyInput, options: CallOptions) !GetRepositoryPermissionsPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetRepositoryPermissionsPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetRepositoryPermissionsPolicyOutput {
    var result: GetRepositoryPermissionsPolicyOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetRepositoryPermissionsPolicyOutput, body, allocator);
    }
    _ = status;
    _ = headers;
