...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateExternalConnectionInput, options: CallOptions) !DisassociateExternalConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateExternalConnectionInput, config: *aws.Config) !aws.http.Request {
