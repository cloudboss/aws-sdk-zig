...
pub const DescribeRepositoryInput = struct {
...
pub const DescribeRepositoryOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRepositoryInput, options: CallOptions) !DescribeRepositoryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeRepositoryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeRepositoryOutput {
    var result: DescribeRepositoryOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DescribeRepositoryOutput, body, allocator);
    }
    _ = status;
    _ = headers;
