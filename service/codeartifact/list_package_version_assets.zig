...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPackageVersionAssetsInput, options: CallOptions) !ListPackageVersionAssetsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPackageVersionAssetsInput, config: *aws.Config) !aws.http.Request {
