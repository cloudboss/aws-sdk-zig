...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAllowedRepositoriesForGroupInput, options: CallOptions) !ListAllowedRepositoriesForGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAllowedRepositoriesForGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListAllowedRepositoriesForGroupOutput {
    var result: ListAllowedRepositoriesForGroupOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListAllowedRepositoriesForGroupOutput, body, allocator);
    }
    _ = status;
    _ = headers;
