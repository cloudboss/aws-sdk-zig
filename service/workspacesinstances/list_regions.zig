...
pub const ListRegionsInput = struct {
    /// Maximum number of regions to return in a single API call. Enables pagination
    /// of region results.
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListRegionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "EUCMIFrontendAPIService.ListRegions");
