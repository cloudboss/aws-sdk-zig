...
pub const Client = struct {
    ...
    pub fn associateVolume(self: *Self, allocator: std.mem.Allocator, input: associate_volume.AssociateVolumeInput, options: associate_volume.Options) !associate_volume.AssociateVolumeOutput {
    ...
    pub fn createWorkspaceInstance(self: *Self, allocator: std.mem.Allocator, input: create_workspace_instance.CreateWorkspaceInstanceInput, options: create_workspace_instance.Options) !create_workspace_instance.CreateWorkspaceInstanceOutput {
    ...
    pub fn deleteWorkspaceInstance(self: *Self, allocator: std.mem.Allocator, input: delete_workspace_instance.DeleteWorkspaceInstanceInput, options: delete_workspace_instance.Options) !delete_workspace_instance.DeleteWorkspaceInstanceOutput {
        return delete_workspace_instance.execute(self, allocator, input, options);
    }

    /// Detaches a volume from a WorkSpace Instance.
    pub fn disassociateVolume(self: *Self, allocator: std.mem.Allocator, input: disassociate_volume.DisassociateVolumeInput, options: disassociate_volume.Options) !disassociate_volume.DisassociateVolumeOutput {
        return disassociate_volume.execute(self, allocator, input, options);
    }

    /// Retrieves detailed information about a specific WorkSpace Instance.
    pub fn getWorkspaceInstance(self: *Self, allocator: std.mem.Allocator, input: get_workspace_instance.GetWorkspaceInstanceInput, options: get_workspace_instance.Options) !get_workspace_instance.GetWorkspaceInstanceOutput {
    ...
    pub fn listInstanceTypes(self: *Self, allocator: std.mem.Allocator, input: list_instance_types.ListInstanceTypesInput, options: list_instance_types.Options) !list_instance_types.ListInstanceTypesOutput {
    ...
    pub fn listWorkspaceInstances(self: *Self, allocator: std.mem.Allocator, input: list_workspace_instances.ListWorkspaceInstancesInput, options: list_workspace_instances.Options) !list_workspace_instances.ListWorkspaceInstancesOutput {
