...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SendDurableExecutionCallbackSuccessInput, options: Options) !SendDurableExecutionCallbackSuccessOutput {
