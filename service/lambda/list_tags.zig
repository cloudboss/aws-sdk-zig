...
pub fn execute(client: *Client, input: ListTagsInput, options: Options) !ListTagsOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListTagsOutput {
