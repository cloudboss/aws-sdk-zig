...
pub const GetFunctionEventInvokeConfigInput = struct {
...
pub const GetFunctionEventInvokeConfigOutput = @import("function_event_invoke_config.zig").FunctionEventInvokeConfig;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFunctionEventInvokeConfigInput, options: CallOptions) !GetFunctionEventInvokeConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFunctionEventInvokeConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetFunctionEventInvokeConfigOutput {
    var result: GetFunctionEventInvokeConfigOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetFunctionEventInvokeConfigOutput, body, allocator);
    }
    _ = status;
    _ = headers;
