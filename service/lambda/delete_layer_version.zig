...
const DeleteLayerVersionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLayerVersionInput, options: Options) !DeleteLayerVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLayerVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLayerVersionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteLayerVersionOutput = .{};
