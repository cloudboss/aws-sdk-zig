...
pub fn execute(client: *Client, input: DeleteFunctionConcurrencyInput, options: Options) !DeleteFunctionConcurrencyOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteFunctionConcurrencyOutput {
    _ = body;
    _ = status;
