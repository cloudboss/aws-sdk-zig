...
const DeleteFunctionConcurrencyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFunctionConcurrencyInput, options: Options) !DeleteFunctionConcurrencyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteFunctionConcurrencyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteFunctionConcurrencyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
