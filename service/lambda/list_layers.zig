...
pub const ListLayersOutput = struct {
    ...
    pub fn deinit(self: *const ListLayersOutput) void {
...
pub fn execute(client: *Client, input: ListLayersInput, options: Options) !ListLayersOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListLayersInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListLayersOutput {
