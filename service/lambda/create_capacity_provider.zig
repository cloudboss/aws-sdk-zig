...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateCapacityProviderOutput {
    _ = body;
    _ = status;
    const result: CreateCapacityProviderOutput = .{ .allocator = alloc };
