...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCapacityProviderInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetCapacityProviderOutput {
    _ = body;
    _ = status;
