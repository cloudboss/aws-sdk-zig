...
pub const DeleteFunctionUrlConfigOutput = struct {
    ...
    pub fn deinit(self: *const DeleteFunctionUrlConfigOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteFunctionUrlConfigInput, options: Options) !DeleteFunctionUrlConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteFunctionUrlConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteFunctionUrlConfigOutput {
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteFunctionUrlConfigOutput = .{ .allocator = alloc };
