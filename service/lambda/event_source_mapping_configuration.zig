...
pub const EventSourceMappingConfiguration = struct {
    ...
    event_source_mapping_arn: ?[]const u8,
    ...
    /// source mapping.
    function_response_types: ?[]const FunctionResponseType,
    ...
    last_processing_result: ?[]const u8,
    ...
    logging_config: ?EventSourceMappingLoggingConfig,
    ...
    metrics_config: ?EventSourceMappingMetricsConfig,
    ...
    source_access_configurations: ?[]const SourceAccessConfiguration,
    ...
    starting_position_timestamp: ?i64,
