...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SendDurableExecutionCallbackHeartbeatInput, options: CallOptions) !SendDurableExecutionCallbackHeartbeatOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SendDurableExecutionCallbackHeartbeatInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/heartbeat");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SendDurableExecutionCallbackHeartbeatOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: SendDurableExecutionCallbackHeartbeatOutput = .{};
