...
pub const GetFunctionCodeSigningConfigOutput = struct {
    ...
    pub fn deinit(self: *const GetFunctionCodeSigningConfigOutput) void {
...
pub fn execute(client: *Client, input: GetFunctionCodeSigningConfigInput, options: Options) !GetFunctionCodeSigningConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetFunctionCodeSigningConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-06-30/functions/");
    try path_buf.appendSlice(alloc, input.function_name);
    try path_buf.appendSlice(alloc, "/code-signing-config");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetFunctionCodeSigningConfigOutput {
