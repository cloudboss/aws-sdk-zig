const SourceAccessType = @import("source_access_type.zig").SourceAccessType;
...
pub const SourceAccessConfiguration = struct {
    ...
    ///   secret key used for SASL/PLAIN authentication of your Apache Kafka
    ///   brokers.
