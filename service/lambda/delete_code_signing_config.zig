...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCodeSigningConfigInput, options: Options) !DeleteCodeSigningConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCodeSigningConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCodeSigningConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteCodeSigningConfigOutput = .{};
