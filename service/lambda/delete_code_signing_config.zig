...
pub const DeleteCodeSigningConfigOutput = struct {
    ...
    pub fn deinit(self: *DeleteCodeSigningConfigOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteCodeSigningConfigInput, options: Options) !DeleteCodeSigningConfigOutput {
