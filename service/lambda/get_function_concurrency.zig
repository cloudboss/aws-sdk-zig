...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFunctionConcurrencyInput, options: CallOptions) !GetFunctionConcurrencyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFunctionConcurrencyInput, config: *aws.Config) !aws.http.Request {
