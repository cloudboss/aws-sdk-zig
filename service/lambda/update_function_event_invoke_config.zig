...
pub const UpdateFunctionEventInvokeConfigOutput = struct {
    ...
    pub fn deinit(self: *const UpdateFunctionEventInvokeConfigOutput) void {
...
pub fn execute(client: *Client, input: UpdateFunctionEventInvokeConfigInput, options: Options) !UpdateFunctionEventInvokeConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateFunctionEventInvokeConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !UpdateFunctionEventInvokeConfigOutput {
