...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveLayerVersionPermissionInput, options: CallOptions) !RemoveLayerVersionPermissionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveLayerVersionPermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveLayerVersionPermissionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
