...
pub const DeleteAliasOutput = struct {
    ...
    pub fn deinit(self: *const DeleteAliasOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteAliasInput, options: Options) !DeleteAliasOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteAliasOutput {
    _ = body;
    _ = status;
    const result: DeleteAliasOutput = .{ .allocator = alloc };
