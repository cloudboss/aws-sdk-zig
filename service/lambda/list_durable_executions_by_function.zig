...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDurableExecutionsByFunctionInput, options: Options) !ListDurableExecutionsByFunctionOutput {
