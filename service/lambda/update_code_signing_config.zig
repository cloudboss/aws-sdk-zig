...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCodeSigningConfigInput, options: Options) !UpdateCodeSigningConfigOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateCodeSigningConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/2020-04-22/code-signing-configs/");
    try path_buf.appendSlice(alloc, input.code_signing_config_arn);
