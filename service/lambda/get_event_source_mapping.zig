...
pub const GetEventSourceMappingOutput = struct {
    ...
    pub fn deinit(self: *const GetEventSourceMappingOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetEventSourceMappingOutput {
