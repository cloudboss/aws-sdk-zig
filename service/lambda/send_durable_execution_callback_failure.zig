...
pub fn execute(client: *Client, input: SendDurableExecutionCallbackFailureInput, options: Options) !SendDurableExecutionCallbackFailureOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !SendDurableExecutionCallbackFailureOutput {
    _ = body;
    _ = status;
