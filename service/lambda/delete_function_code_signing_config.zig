...
pub fn execute(client: *Client, input: DeleteFunctionCodeSigningConfigInput, options: Options) !DeleteFunctionCodeSigningConfigOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteFunctionCodeSigningConfigOutput {
    _ = body;
    _ = status;
