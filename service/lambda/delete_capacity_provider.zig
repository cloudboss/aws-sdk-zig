...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteCapacityProviderOutput {
    _ = body;
    _ = status;
    const result: DeleteCapacityProviderOutput = .{ .allocator = alloc };
