...
pub const UpdateEventSourceMappingOutput = struct {
    ...
    pub fn deinit(self: *UpdateEventSourceMappingOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: UpdateEventSourceMappingInput, options: Options) !UpdateEventSourceMappingOutput {
