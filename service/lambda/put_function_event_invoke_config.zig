...
pub const PutFunctionEventInvokeConfigOutput = @import("function_event_invoke_config.zig").FunctionEventInvokeConfig;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutFunctionEventInvokeConfigInput, options: CallOptions) !PutFunctionEventInvokeConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutFunctionEventInvokeConfigInput, config: *aws.Config) !aws.http.Request {
