...
pub const PutFunctionEventInvokeConfigOutput = struct {
    ...
    pub fn deinit(self: *const PutFunctionEventInvokeConfigOutput) void {
...
pub fn execute(client: *Client, input: PutFunctionEventInvokeConfigInput, options: Options) !PutFunctionEventInvokeConfigOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !PutFunctionEventInvokeConfigOutput {
    var result: PutFunctionEventInvokeConfigOutput = .{ .allocator = alloc };
    _ = status;
