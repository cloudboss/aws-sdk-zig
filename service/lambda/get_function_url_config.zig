...
pub const GetFunctionUrlConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFunctionUrlConfigInput, options: CallOptions) !GetFunctionUrlConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFunctionUrlConfigInput, config: *aws.Config) !aws.http.Request {
