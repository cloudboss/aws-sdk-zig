...
pub const DeleteEventSourceMappingOutput = struct {
    ...
    pub fn deinit(self: *const DeleteEventSourceMappingOutput) void {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DeleteEventSourceMappingOutput {
    var result: DeleteEventSourceMappingOutput = .{ .allocator = alloc };
    _ = status;
