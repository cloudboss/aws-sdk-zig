...
pub const Client = struct {
    ...
    pub fn addLayerVersionPermission(self: *Self, input: add_layer_version_permission.AddLayerVersionPermissionInput, options: add_layer_version_permission.Options) !add_layer_version_permission.AddLayerVersionPermissionOutput {
        return add_layer_version_permission.execute(self, input, options);
    }
    ...
    pub fn checkpointDurableExecution(self: *Self, input: checkpoint_durable_execution.CheckpointDurableExecutionInput, options: checkpoint_durable_execution.Options) !checkpoint_durable_execution.CheckpointDurableExecutionOutput {
        return checkpoint_durable_execution.execute(self, input, options);
    }
    ...
    pub fn createAlias(self: *Self, input: create_alias.CreateAliasInput, options: create_alias.Options) !create_alias.CreateAliasOutput {
        return create_alias.execute(self, input, options);
    }

    /// Creates a capacity provider that manages compute resources for Lambda
    /// functions
    pub fn createCapacityProvider(self: *Self, input: create_capacity_provider.CreateCapacityProviderInput, options: create_capacity_provider.Options) !create_capacity_provider.CreateCapacityProviderOutput {
        return create_capacity_provider.execute(self, input, options);
    }
    ...
    pub fn createCodeSigningConfig(self: *Self, input: create_code_signing_config.CreateCodeSigningConfigInput, options: create_code_signing_config.Options) !create_code_signing_config.CreateCodeSigningConfigOutput {
        return create_code_signing_config.execute(self, input, options);
    }
    ...
    pub fn createEventSourceMapping(self: *Self, input: create_event_source_mapping.CreateEventSourceMappingInput, options: create_event_source_mapping.Options) !create_event_source_mapping.CreateEventSourceMappingOutput {
        return create_event_source_mapping.execute(self, input, options);
    }
    ...
    pub fn createFunction(self: *Self, input: create_function.CreateFunctionInput, options: create_function.Options) !create_function.CreateFunctionOutput {
        return create_function.execute(self, input, options);
    }
    ...
    /// function.
    pub fn createFunctionUrlConfig(self: *Self, input: create_function_url_config.CreateFunctionUrlConfigInput, options: create_function_url_config.Options) !create_function_url_config.CreateFunctionUrlConfigOutput {
        return create_function_url_config.execute(self, input, options);
    }

    /// Deletes a Lambda function
    /// [alias](https://docs.aws.amazon.com/lambda/latest/dg/configuration-aliases.html).
    pub fn deleteAlias(self: *Self, input: delete_alias.DeleteAliasInput, options: delete_alias.Options) !delete_alias.DeleteAliasOutput {
        return delete_alias.execute(self, input, options);
    }

    /// Deletes a capacity provider. You cannot delete a capacity provider that is
    /// currently being used by Lambda functions.
    pub fn deleteCapacityProvider(self: *Self, input: delete_capacity_provider.DeleteCapacityProviderInput, options: delete_capacity_provider.Options) !delete_capacity_provider.DeleteCapacityProviderOutput {
        return delete_capacity_provider.execute(self, input, options);
    }

    /// Deletes the code signing configuration. You can delete the code signing
    /// configuration only if no function is using it.
    pub fn deleteCodeSigningConfig(self: *Self, input: delete_code_signing_config.DeleteCodeSigningConfigInput, options: delete_code_signing_config.Options) !delete_code_signing_config.DeleteCodeSigningConfigOutput {
        return delete_code_signing_config.execute(self, input, options);
    }
    ...
    pub fn deleteEventSourceMapping(self: *Self, input: delete_event_source_mapping.DeleteEventSourceMappingInput, options: delete_event_source_mapping.Options) !delete_event_source_mapping.DeleteEventSourceMappingOutput {
        return delete_event_source_mapping.execute(self, input, options);
    }
    ...
    pub fn deleteFunction(self: *Self, input: delete_function.DeleteFunctionInput, options: delete_function.Options) !delete_function.DeleteFunctionOutput {
        return delete_function.execute(self, input, options);
    }

    /// Removes the code signing configuration from the function.
    pub fn deleteFunctionCodeSigningConfig(self: *Self, input: delete_function_code_signing_config.DeleteFunctionCodeSigningConfigInput, options: delete_function_code_signing_config.Options) !delete_function_code_signing_config.DeleteFunctionCodeSigningConfigOutput {
        return delete_function_code_signing_config.execute(self, input, options);
    }

    /// Removes a concurrent execution limit from a function.
    pub fn deleteFunctionConcurrency(self: *Self, input: delete_function_concurrency.DeleteFunctionConcurrencyInput, options: delete_function_concurrency.Options) !delete_function_concurrency.DeleteFunctionConcurrencyOutput {
        return delete_function_concurrency.execute(self, input, options);
    }
    ...
    pub fn deleteFunctionEventInvokeConfig(self: *Self, input: delete_function_event_invoke_config.DeleteFunctionEventInvokeConfigInput, options: delete_function_event_invoke_config.Options) !delete_function_event_invoke_config.DeleteFunctionEventInvokeConfigOutput {
        return delete_function_event_invoke_config.execute(self, input, options);
    }
    ...
    pub fn deleteFunctionUrlConfig(self: *Self, input: delete_function_url_config.DeleteFunctionUrlConfigInput, options: delete_function_url_config.Options) !delete_function_url_config.DeleteFunctionUrlConfigOutput {
        return delete_function_url_config.execute(self, input, options);
    }
    ...
    pub fn deleteLayerVersion(self: *Self, input: delete_layer_version.DeleteLayerVersionInput, options: delete_layer_version.Options) !delete_layer_version.DeleteLayerVersionOutput {
        return delete_layer_version.execute(self, input, options);
    }

    /// Deletes the provisioned concurrency configuration for a function.
    pub fn deleteProvisionedConcurrencyConfig(self: *Self, input: delete_provisioned_concurrency_config.DeleteProvisionedConcurrencyConfigInput, options: delete_provisioned_concurrency_config.Options) !delete_provisioned_concurrency_config.DeleteProvisionedConcurrencyConfigOutput {
        return delete_provisioned_concurrency_config.execute(self, input, options);
    }

    /// Retrieves details about your account's
    /// [limits](https://docs.aws.amazon.com/lambda/latest/dg/limits.html) and usage
    /// in an Amazon Web Services Region.
    pub fn getAccountSettings(self: *Self, input: get_account_settings.GetAccountSettingsInput, options: get_account_settings.Options) !get_account_settings.GetAccountSettingsOutput {
        return get_account_settings.execute(self, input, options);
    }

    /// Returns details about a Lambda function
    /// [alias](https://docs.aws.amazon.com/lambda/latest/dg/configuration-aliases.html).
    pub fn getAlias(self: *Self, input: get_alias.GetAliasInput, options: get_alias.Options) !get_alias.GetAliasOutput {
        return get_alias.execute(self, input, options);
    }

    /// Retrieves information about a specific capacity provider, including its
    /// configuration, state, and associated resources.
    pub fn getCapacityProvider(self: *Self, input: get_capacity_provider.GetCapacityProviderInput, options: get_capacity_provider.Options) !get_capacity_provider.GetCapacityProviderOutput {
        return get_capacity_provider.execute(self, input, options);
    }

    /// Returns information about the specified code signing configuration.
    pub fn getCodeSigningConfig(self: *Self, input: get_code_signing_config.GetCodeSigningConfigInput, options: get_code_signing_config.Options) !get_code_signing_config.GetCodeSigningConfigOutput {
        return get_code_signing_config.execute(self, input, options);
    }
    ...
    pub fn getDurableExecution(self: *Self, input: get_durable_execution.GetDurableExecutionInput, options: get_durable_execution.Options) !get_durable_execution.GetDurableExecutionOutput {
        return get_durable_execution.execute(self, input, options);
    }
    ...
    /// payloads.
    pub fn getDurableExecutionHistory(self: *Self, input: get_durable_execution_history.GetDurableExecutionHistoryInput, options: get_durable_execution_history.Options) !get_durable_execution_history.GetDurableExecutionHistoryOutput {
        return get_durable_execution_history.execute(self, input, options);
    }
    ...
    pub fn getDurableExecutionState(self: *Self, input: get_durable_execution_state.GetDurableExecutionStateInput, options: get_durable_execution_state.Options) !get_durable_execution_state.GetDurableExecutionStateOutput {
        return get_durable_execution_state.execute(self, input, options);
    }
    ...
    pub fn getEventSourceMapping(self: *Self, input: get_event_source_mapping.GetEventSourceMappingInput, options: get_event_source_mapping.Options) !get_event_source_mapping.GetEventSourceMappingOutput {
        return get_event_source_mapping.execute(self, input, options);
    }
    ...
    /// returned.
    pub fn getFunction(self: *Self, input: get_function.GetFunctionInput, options: get_function.Options) !get_function.GetFunctionOutput {
        return get_function.execute(self, input, options);
    }

    /// Returns the code signing configuration for the specified function.
    pub fn getFunctionCodeSigningConfig(self: *Self, input: get_function_code_signing_config.GetFunctionCodeSigningConfigInput, options: get_function_code_signing_config.Options) !get_function_code_signing_config.GetFunctionCodeSigningConfigOutput {
        return get_function_code_signing_config.execute(self, input, options);
    }

    /// Returns details about the reserved concurrency configuration for a function.
    /// To set a concurrency limit for a function, use PutFunctionConcurrency.
    pub fn getFunctionConcurrency(self: *Self, input: get_function_concurrency.GetFunctionConcurrencyInput, options: get_function_concurrency.Options) !get_function_concurrency.GetFunctionConcurrencyOutput {
        return get_function_concurrency.execute(self, input, options);
    }
    ...
    /// GetFunction.
    pub fn getFunctionConfiguration(self: *Self, input: get_function_configuration.GetFunctionConfigurationInput, options: get_function_configuration.Options) !get_function_configuration.GetFunctionConfigurationOutput {
        return get_function_configuration.execute(self, input, options);
    }
    ...
    /// To configure options for asynchronous invocation, use
    /// PutFunctionEventInvokeConfig.
    pub fn getFunctionEventInvokeConfig(self: *Self, input: get_function_event_invoke_config.GetFunctionEventInvokeConfigInput, options: get_function_event_invoke_config.Options) !get_function_event_invoke_config.GetFunctionEventInvokeConfigOutput {
        return get_function_event_invoke_config.execute(self, input, options);
    }
    ...
    pub fn getFunctionRecursionConfig(self: *Self, input: get_function_recursion_config.GetFunctionRecursionConfigInput, options: get_function_recursion_config.Options) !get_function_recursion_config.GetFunctionRecursionConfigOutput {
        return get_function_recursion_config.execute(self, input, options);
    }

    /// Retrieves the scaling configuration for a Lambda Managed Instances function.
    pub fn getFunctionScalingConfig(self: *Self, input: get_function_scaling_config.GetFunctionScalingConfigInput, options: get_function_scaling_config.Options) !get_function_scaling_config.GetFunctionScalingConfigOutput {
        return get_function_scaling_config.execute(self, input, options);
    }

    /// Returns details about a Lambda function URL.
    pub fn getFunctionUrlConfig(self: *Self, input: get_function_url_config.GetFunctionUrlConfigInput, options: get_function_url_config.Options) !get_function_url_config.GetFunctionUrlConfigOutput {
        return get_function_url_config.execute(self, input, options);
    }
    ...
    pub fn getLayerVersion(self: *Self, input: get_layer_version.GetLayerVersionInput, options: get_layer_version.Options) !get_layer_version.GetLayerVersionOutput {
        return get_layer_version.execute(self, input, options);
    }

    /// Returns information about a version of an [Lambda
    /// layer](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html), with a link to download the layer archive that's valid for 10 minutes.
    pub fn getLayerVersionByArn(self: *Self, input: get_layer_version_by_arn.GetLayerVersionByArnInput, options: get_layer_version_by_arn.Options) !get_layer_version_by_arn.GetLayerVersionByArnOutput {
        return get_layer_version_by_arn.execute(self, input, options);
    }
    ...
    pub fn getLayerVersionPolicy(self: *Self, input: get_layer_version_policy.GetLayerVersionPolicyInput, options: get_layer_version_policy.Options) !get_layer_version_policy.GetLayerVersionPolicyOutput {
        return get_layer_version_policy.execute(self, input, options);
    }
    ...
    /// or version.
    pub fn getProvisionedConcurrencyConfig(self: *Self, input: get_provisioned_concurrency_config.GetProvisionedConcurrencyConfigInput, options: get_provisioned_concurrency_config.Options) !get_provisioned_concurrency_config.GetProvisionedConcurrencyConfigOutput {
        return get_provisioned_concurrency_config.execute(self, input, options);
    }
    ...
    pub fn getRuntimeManagementConfig(self: *Self, input: get_runtime_management_config.GetRuntimeManagementConfigInput, options: get_runtime_management_config.Options) !get_runtime_management_config.GetRuntimeManagementConfigOutput {
        return get_runtime_management_config.execute(self, input, options);
    }
    ...
    pub fn invoke(self: *Self, input: invoke_.InvokeInput, options: invoke_.Options) !invoke_.InvokeOutput {
    ...
    pub fn invokeAsync(self: *Self, input: invoke_async.InvokeAsyncInput, options: invoke_async.Options) !invoke_async.InvokeAsyncOutput {
        return invoke_async.execute(self, input, options);
    }
    ...
    /// This operation requires permission for the
    /// [lambda:InvokeFunction](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awslambda.html) action. For details on how to set up permissions for cross-account invocations, see [Granting function access to other accounts](https://docs.aws.amazon.com/lambda/latest/dg/access-control-resource-based.html#permissions-resource-xaccountinvoke).
    pub fn invokeWithResponseStream(self: *Self, input: invoke_with_response_stream.InvokeWithResponseStreamInput, options: invoke_with_response_stream.Options) !invoke_with_response_stream.InvokeWithResponseStreamOutput {
        return invoke_with_response_stream.execute(self, input, options);
    }

    /// Returns a list of
    /// [aliases](https://docs.aws.amazon.com/lambda/latest/dg/configuration-aliases.html) for a Lambda function.
    pub fn listAliases(self: *Self, input: list_aliases.ListAliasesInput, options: list_aliases.Options) !list_aliases.ListAliasesOutput {
        return list_aliases.execute(self, input, options);
    }

    /// Returns a list of capacity providers in your account.
    pub fn listCapacityProviders(self: *Self, input: list_capacity_providers.ListCapacityProvidersInput, options: list_capacity_providers.Options) !list_capacity_providers.ListCapacityProvidersOutput {
        return list_capacity_providers.execute(self, input, options);
    }
    ...
    pub fn listCodeSigningConfigs(self: *Self, input: list_code_signing_configs.ListCodeSigningConfigsInput, options: list_code_signing_configs.Options) !list_code_signing_configs.ListCodeSigningConfigsOutput {
        return list_code_signing_configs.execute(self, input, options);
    }
    ...
    pub fn listDurableExecutionsByFunction(self: *Self, input: list_durable_executions_by_function.ListDurableExecutionsByFunctionInput, options: list_durable_executions_by_function.Options) !list_durable_executions_by_function.ListDurableExecutionsByFunctionOutput {
        return list_durable_executions_by_function.execute(self, input, options);
    }

    /// Lists event source mappings. Specify an `EventSourceArn` to show only event
    /// source mappings for a single event source.
    pub fn listEventSourceMappings(self: *Self, input: list_event_source_mappings.ListEventSourceMappingsInput, options: list_event_source_mappings.Options) !list_event_source_mappings.ListEventSourceMappingsOutput {
        return list_event_source_mappings.execute(self, input, options);
    }
    ...
    /// To configure options for asynchronous invocation, use
    /// PutFunctionEventInvokeConfig.
    pub fn listFunctionEventInvokeConfigs(self: *Self, input: list_function_event_invoke_configs.ListFunctionEventInvokeConfigsInput, options: list_function_event_invoke_configs.Options) !list_function_event_invoke_configs.ListFunctionEventInvokeConfigsOutput {
        return list_function_event_invoke_configs.execute(self, input, options);
    }

    /// Returns a list of Lambda function URLs for the specified function.
    pub fn listFunctionUrlConfigs(self: *Self, input: list_function_url_configs.ListFunctionUrlConfigsInput, options: list_function_url_configs.Options) !list_function_url_configs.ListFunctionUrlConfigsOutput {
        return list_function_url_configs.execute(self, input, options);
    }

    /// Returns a list of function versions that are configured to use a specific
    /// capacity provider.
    pub fn listFunctionVersionsByCapacityProvider(self: *Self, input: list_function_versions_by_capacity_provider.ListFunctionVersionsByCapacityProviderInput, options: list_function_versions_by_capacity_provider.Options) !list_function_versions_by_capacity_provider.ListFunctionVersionsByCapacityProviderOutput {
        return list_function_versions_by_capacity_provider.execute(self, input, options);
    }
    ...
    pub fn listFunctions(self: *Self, input: list_functions.ListFunctionsInput, options: list_functions.Options) !list_functions.ListFunctionsOutput {
        return list_functions.execute(self, input, options);
    }
    ...
    pub fn listFunctionsByCodeSigningConfig(self: *Self, input: list_functions_by_code_signing_config.ListFunctionsByCodeSigningConfigInput, options: list_functions_by_code_signing_config.Options) !list_functions_by_code_signing_config.ListFunctionsByCodeSigningConfigOutput {
        return list_functions_by_code_signing_config.execute(self, input, options);
    }
    ...
    pub fn listLayerVersions(self: *Self, input: list_layer_versions.ListLayerVersionsInput, options: list_layer_versions.Options) !list_layer_versions.ListLayerVersionsOutput {
        return list_layer_versions.execute(self, input, options);
    }
    ...
    pub fn listLayers(self: *Self, input: list_layers.ListLayersInput, options: list_layers.Options) !list_layers.ListLayersOutput {
        return list_layers.execute(self, input, options);
    }

    /// Retrieves a list of provisioned concurrency configurations for a function.
    pub fn listProvisionedConcurrencyConfigs(self: *Self, input: list_provisioned_concurrency_configs.ListProvisionedConcurrencyConfigsInput, options: list_provisioned_concurrency_configs.Options) !list_provisioned_concurrency_configs.ListProvisionedConcurrencyConfigsOutput {
        return list_provisioned_concurrency_configs.execute(self, input, options);
    }
    ...
    pub fn listTags(self: *Self, input: list_tags.ListTagsInput, options: list_tags.Options) !list_tags.ListTagsOutput {
        return list_tags.execute(self, input, options);
    }
    ...
    pub fn listVersionsByFunction(self: *Self, input: list_versions_by_function.ListVersionsByFunctionInput, options: list_versions_by_function.Options) !list_versions_by_function.ListVersionsByFunctionOutput {
        return list_versions_by_function.execute(self, input, options);
    }
    ...
    pub fn publishLayerVersion(self: *Self, input: publish_layer_version.PublishLayerVersionInput, options: publish_layer_version.Options) !publish_layer_version.PublishLayerVersionOutput {
        return publish_layer_version.execute(self, input, options);
    }
    ...
    /// use CreateAlias.
    pub fn publishVersion(self: *Self, input: publish_version.PublishVersionInput, options: publish_version.Options) !publish_version.PublishVersionOutput {
        return publish_version.execute(self, input, options);
    }
    ...
    pub fn putFunctionCodeSigningConfig(self: *Self, input: put_function_code_signing_config.PutFunctionCodeSigningConfigInput, options: put_function_code_signing_config.Options) !put_function_code_signing_config.PutFunctionCodeSigningConfigOutput {
        return put_function_code_signing_config.execute(self, input, options);
    }
    ...
    pub fn putFunctionConcurrency(self: *Self, input: put_function_concurrency.PutFunctionConcurrencyInput, options: put_function_concurrency.Options) !put_function_concurrency.PutFunctionConcurrencyOutput {
        return put_function_concurrency.execute(self, input, options);
    }
    ...
    pub fn putFunctionEventInvokeConfig(self: *Self, input: put_function_event_invoke_config.PutFunctionEventInvokeConfigInput, options: put_function_event_invoke_config.Options) !put_function_event_invoke_config.PutFunctionEventInvokeConfigOutput {
        return put_function_event_invoke_config.execute(self, input, options);
    }
    ...
    pub fn putFunctionRecursionConfig(self: *Self, input: put_function_recursion_config.PutFunctionRecursionConfigInput, options: put_function_recursion_config.Options) !put_function_recursion_config.PutFunctionRecursionConfigOutput {
        return put_function_recursion_config.execute(self, input, options);
    }
    ...
    pub fn putFunctionScalingConfig(self: *Self, input: put_function_scaling_config.PutFunctionScalingConfigInput, options: put_function_scaling_config.Options) !put_function_scaling_config.PutFunctionScalingConfigOutput {
        return put_function_scaling_config.execute(self, input, options);
    }

    /// Adds a provisioned concurrency configuration to a function's alias or
    /// version.
    pub fn putProvisionedConcurrencyConfig(self: *Self, input: put_provisioned_concurrency_config.PutProvisionedConcurrencyConfigInput, options: put_provisioned_concurrency_config.Options) !put_provisioned_concurrency_config.PutProvisionedConcurrencyConfigOutput {
        return put_provisioned_concurrency_config.execute(self, input, options);
    }

    /// Sets the runtime management configuration for a function's version. For more
    /// information, see [Runtime
    /// updates](https://docs.aws.amazon.com/lambda/latest/dg/runtimes-update.html).
    pub fn putRuntimeManagementConfig(self: *Self, input: put_runtime_management_config.PutRuntimeManagementConfigInput, options: put_runtime_management_config.Options) !put_runtime_management_config.PutRuntimeManagementConfigOutput {
        return put_runtime_management_config.execute(self, input, options);
    }

    /// Removes a statement from the permissions policy for a version of an [Lambda
    /// layer](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html). For more information, see AddLayerVersionPermission.
    pub fn removeLayerVersionPermission(self: *Self, input: remove_layer_version_permission.RemoveLayerVersionPermissionInput, options: remove_layer_version_permission.Options) !remove_layer_version_permission.RemoveLayerVersionPermissionOutput {
        return remove_layer_version_permission.execute(self, input, options);
    }
    ...
    /// successfully.
    pub fn sendDurableExecutionCallbackFailure(self: *Self, input: send_durable_execution_callback_failure.SendDurableExecutionCallbackFailureInput, options: send_durable_execution_callback_failure.Options) !send_durable_execution_callback_failure.SendDurableExecutionCallbackFailureOutput {
        return send_durable_execution_callback_failure.execute(self, input, options);
    }
    ...
    pub fn sendDurableExecutionCallbackHeartbeat(self: *Self, input: send_durable_execution_callback_heartbeat.SendDurableExecutionCallbackHeartbeatInput, options: send_durable_execution_callback_heartbeat.Options) !send_durable_execution_callback_heartbeat.SendDurableExecutionCallbackHeartbeatOutput {
        return send_durable_execution_callback_heartbeat.execute(self, input, options);
    }
    ...
    /// callback operation.
    pub fn sendDurableExecutionCallbackSuccess(self: *Self, input: send_durable_execution_callback_success.SendDurableExecutionCallbackSuccessInput, options: send_durable_execution_callback_success.Options) !send_durable_execution_callback_success.SendDurableExecutionCallbackSuccessOutput {
        return send_durable_execution_callback_success.execute(self, input, options);
    }
    ...
    pub fn stopDurableExecution(self: *Self, input: stop_durable_execution.StopDurableExecutionInput, options: stop_durable_execution.Options) !stop_durable_execution.StopDurableExecutionOutput {
        return stop_durable_execution.execute(self, input, options);
    }
    ...
    /// [alias](https://docs.aws.amazon.com/lambda/latest/dg/configuration-aliases.html).
    pub fn updateAlias(self: *Self, input: update_alias.UpdateAliasInput, options: update_alias.Options) !update_alias.UpdateAliasOutput {
        return update_alias.execute(self, input, options);
    }

    /// Updates the configuration of an existing capacity provider.
    pub fn updateCapacityProvider(self: *Self, input: update_capacity_provider.UpdateCapacityProviderInput, options: update_capacity_provider.Options) !update_capacity_provider.UpdateCapacityProviderOutput {
        return update_capacity_provider.execute(self, input, options);
    }
    ...
    pub fn updateCodeSigningConfig(self: *Self, input: update_code_signing_config.UpdateCodeSigningConfigInput, options: update_code_signing_config.Options) !update_code_signing_config.UpdateCodeSigningConfigOutput {
        return update_code_signing_config.execute(self, input, options);
    }
    ...
    /// * [ Amazon
    ///   DocumentDB](https://docs.aws.amazon.com/lambda/latest/dg/with-documentdb.html#docdb-configuration)
    pub fn updateEventSourceMapping(self: *Self, input: update_event_source_mapping.UpdateEventSourceMappingInput, options: update_event_source_mapping.Options) !update_event_source_mapping.UpdateEventSourceMappingOutput {
        return update_event_source_mapping.execute(self, input, options);
    }
    ...
    pub fn updateFunctionCode(self: *Self, input: update_function_code.UpdateFunctionCodeInput, options: update_function_code.Options) !update_function_code.UpdateFunctionCodeOutput {
        return update_function_code.execute(self, input, options);
    }
    ...
    pub fn updateFunctionConfiguration(self: *Self, input: update_function_configuration.UpdateFunctionConfigurationInput, options: update_function_configuration.Options) !update_function_configuration.UpdateFunctionConfigurationOutput {
        return update_function_configuration.execute(self, input, options);
    }
    ...
    /// To configure options for asynchronous invocation, use
    /// PutFunctionEventInvokeConfig.
    pub fn updateFunctionEventInvokeConfig(self: *Self, input: update_function_event_invoke_config.UpdateFunctionEventInvokeConfigInput, options: update_function_event_invoke_config.Options) !update_function_event_invoke_config.UpdateFunctionEventInvokeConfigOutput {
        return update_function_event_invoke_config.execute(self, input, options);
    }
