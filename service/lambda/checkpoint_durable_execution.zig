...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CheckpointDurableExecutionInput, options: Options) !CheckpointDurableExecutionOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CheckpointDurableExecutionOutput {
    ...
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(CheckpointDurableExecutionOutput, body, allocator);
    }
    _ = status;
    _ = headers;
