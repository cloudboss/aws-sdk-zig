...
pub const DeleteProvisionedConcurrencyConfigOutput = struct {
    ...
    pub fn deinit(self: *DeleteProvisionedConcurrencyConfigOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteProvisionedConcurrencyConfigInput, options: Options) !DeleteProvisionedConcurrencyConfigOutput {
