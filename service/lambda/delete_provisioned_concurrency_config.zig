...
const DeleteProvisionedConcurrencyConfigOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProvisionedConcurrencyConfigInput, options: Options) !DeleteProvisionedConcurrencyConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProvisionedConcurrencyConfigInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteProvisionedConcurrencyConfigOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProvisionedConcurrencyConfigOutput = .{};
