...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFunctionsByCodeSigningConfigInput, options: Options) !ListFunctionsByCodeSigningConfigOutput {
