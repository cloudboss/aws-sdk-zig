...
pub fn execute(client: *Client, input: GetAccountSettingsInput, options: Options) !GetAccountSettingsOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetAccountSettingsOutput {
    _ = body;
    _ = status;
