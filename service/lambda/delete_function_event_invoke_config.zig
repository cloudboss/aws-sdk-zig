...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteFunctionEventInvokeConfigInput, options: CallOptions) !DeleteFunctionEventInvokeConfigOutput {
