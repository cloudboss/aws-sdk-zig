...
pub const GetProvisionedConcurrencyConfigOutput = struct {
    ...
    pub fn deinit(self: *const GetProvisionedConcurrencyConfigOutput) void {
...
pub fn execute(client: *Client, input: GetProvisionedConcurrencyConfigInput, options: Options) !GetProvisionedConcurrencyConfigOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetProvisionedConcurrencyConfigOutput {
