...
fn serializeRequest(alloc: std.mem.Allocator, input: ListFunctionEventInvokeConfigsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/event-invoke-config/list");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListFunctionEventInvokeConfigsOutput {
