...
pub const DeleteMetricStreamInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMetricStreamInput, options: Options) !DeleteMetricStreamOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteMetricStreamInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteMetricStream&Version=2010-08-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteMetricStreamOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteMetricStreamOutput = .{};
