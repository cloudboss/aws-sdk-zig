...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInsightRulesInput, options: CallOptions) !DeleteInsightRulesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteInsightRulesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteInsightRules&Version=2010-08-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteInsightRulesOutput {
    _ = status;
    _ = headers;
