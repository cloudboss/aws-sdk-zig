...
pub const DeleteAlarmsInput = struct {
...
pub const DeleteAlarmsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAlarmsInput, options: CallOptions) !DeleteAlarmsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAlarmsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteAlarms&Version=2010-08-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAlarmsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteAlarmsOutput = .{};
