...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAlarmsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteAlarms&Version=2010-08-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAlarmsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
