...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopMetricStreamsInput, options: Options) !StopMetricStreamsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopMetricStreamsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=StopMetricStreams&Version=2010-08-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopMetricStreamsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
