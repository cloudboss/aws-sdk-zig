...
fn serializeRequest(allocator: std.mem.Allocator, input: StopOTelEnrichmentInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=StopOTelEnrichment&Version=2010-08-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopOTelEnrichmentOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: StopOTelEnrichmentOutput = .{};
