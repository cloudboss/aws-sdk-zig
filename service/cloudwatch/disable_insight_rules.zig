...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableInsightRulesInput, options: CallOptions) !DisableInsightRulesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableInsightRulesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DisableInsightRules&Version=2010-08-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableInsightRulesOutput {
    _ = status;
    _ = headers;
