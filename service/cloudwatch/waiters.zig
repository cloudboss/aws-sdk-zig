...
pub const AlarmMuteRuleExistsWaiter = struct {
    client: *Client,
    params: get_alarm_mute_rule.GetAlarmMuteRuleInput,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        _ = self.client.getAlarmMuteRule(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
