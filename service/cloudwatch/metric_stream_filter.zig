...
/// applies to
/// the sum of namespace names and metric names in the filters. For example,
/// this could
/// include 10 metric namespace filters with 99 metrics each, or 20 namespace
/// filters with
/// 49 metrics specified in each filter.
pub const MetricStreamFilter = struct {
    ...
    /// excluded,
    /// depending on whether this filter is specified as an exclude filter or an
    /// include
    /// filter.
    ///
