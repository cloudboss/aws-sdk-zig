...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableAlarmActionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableAlarmActions&Version=2010-08-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !EnableAlarmActionsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
