...
pub const DeleteAlarmMuteRuleInput = struct {
...
pub const DeleteAlarmMuteRuleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAlarmMuteRuleInput, options: CallOptions) !DeleteAlarmMuteRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAlarmMuteRuleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteAlarmMuteRule&Version=2010-08-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAlarmMuteRuleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteAlarmMuteRuleOutput = .{};
