...
pub const UndeprecateWorkflowTypeInput = struct {
...
pub const UndeprecateWorkflowTypeOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UndeprecateWorkflowTypeInput, options: CallOptions) !UndeprecateWorkflowTypeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UndeprecateWorkflowTypeInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SimpleWorkflowService.UndeprecateWorkflowType");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UndeprecateWorkflowTypeOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
