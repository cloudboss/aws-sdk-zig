...
pub const RequestCancelWorkflowExecutionInput = struct {
...
pub const RequestCancelWorkflowExecutionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RequestCancelWorkflowExecutionInput, options: CallOptions) !RequestCancelWorkflowExecutionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RequestCancelWorkflowExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SimpleWorkflowService.RequestCancelWorkflowExecution");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RequestCancelWorkflowExecutionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
