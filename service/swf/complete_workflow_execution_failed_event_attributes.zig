const CompleteWorkflowExecutionFailedCause = @import("complete_workflow_execution_failed_cause.zig").CompleteWorkflowExecutionFailedCause;

/// Provides the details of the `CompleteWorkflowExecutionFailed` event.
pub const CompleteWorkflowExecutionFailedEventAttributes = struct {
