...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PollForDecisionTaskInput, options: Options) !PollForDecisionTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PollForDecisionTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SimpleWorkflowService.PollForDecisionTask");
