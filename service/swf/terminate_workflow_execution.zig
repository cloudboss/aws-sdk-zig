...
const TerminateWorkflowExecutionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TerminateWorkflowExecutionInput, options: Options) !TerminateWorkflowExecutionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: TerminateWorkflowExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SimpleWorkflowService.TerminateWorkflowExecution");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !TerminateWorkflowExecutionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
