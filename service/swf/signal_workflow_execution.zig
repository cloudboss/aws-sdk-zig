...
pub const SignalWorkflowExecutionInput = struct {
...
pub const SignalWorkflowExecutionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SignalWorkflowExecutionInput, options: CallOptions) !SignalWorkflowExecutionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SignalWorkflowExecutionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SimpleWorkflowService.SignalWorkflowExecution");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SignalWorkflowExecutionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
