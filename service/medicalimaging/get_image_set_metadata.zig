...
fn serializeRequest(alloc: std.mem.Allocator, input: GetImageSetMetadataInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/getImageSetMetadata");
...
fn deserializeStreamingResponse(stream_resp: *aws.http.StreamingResponse, alloc: std.mem.Allocator) !GetImageSetMetadataOutput {
