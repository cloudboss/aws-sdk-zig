...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListImageSetVersionsInput, options: CallOptions) !ListImageSetVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListImageSetVersionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/listImageSetVersions");
