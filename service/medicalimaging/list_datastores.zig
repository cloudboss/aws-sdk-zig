...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDatastoresInput, options: CallOptions) !ListDatastoresOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDatastoresInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.datastore_status) |v| {
        ...
        try query_buf.appendSlice(allocator, "datastoreStatus=");
