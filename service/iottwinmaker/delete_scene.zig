...
pub const DeleteSceneInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSceneInput, options: Options) !DeleteSceneOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSceneInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSceneOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSceneOutput = .{};
