...
pub const DeleteComponentTypeInput = struct {
...
pub const DeleteComponentTypeOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteComponentTypeInput, options: CallOptions) !DeleteComponentTypeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteComponentTypeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteComponentTypeOutput {
    var result: DeleteComponentTypeOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeleteComponentTypeOutput, body, allocator);
    }
    _ = status;
    _ = headers;
