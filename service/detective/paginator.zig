...
pub const ListDatasourcePackagesPaginator = struct {
    client: *Client,
    params: list_datasource_packages.ListDatasourcePackagesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_datasource_packages.Options) !list_datasource_packages.ListDatasourcePackagesOutput {
        if (self.done) {
        ...
        const output = try list_datasource_packages.execute(self.client, allocator, self.params, options);
