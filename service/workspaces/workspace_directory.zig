...
pub const WorkspaceDirectory = struct {
    ...
    dns_ip_addresses: ?[]const []const u8,

    /// The IPv6 addresses of the DNS servers for the directory.
    dns_ipv_6_addresses: ?[]const []const u8,
    ...
    workspace_directory_description: ?[]const u8,

    /// The name fo the WorkSpace directory.
    workspace_directory_name: ?[]const u8,
