...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyCertificateBasedAuthPropertiesInput, options: Options) !ModifyCertificateBasedAuthPropertiesOutput {
