...
const DeletableCertificateBasedAuthProperty = @import("deletable_certificate_based_auth_property.zig").DeletableCertificateBasedAuthProperty;

pub const ModifyCertificateBasedAuthPropertiesInput = struct {
    /// The properties of the certificate-based authentication.
    certificate_based_auth_properties: ?CertificateBasedAuthProperties = null,

    /// The properties of the certificate-based authentication you want to delete.
    properties_to_delete: ?[]const DeletableCertificateBasedAuthProperty = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyCertificateBasedAuthPropertiesInput, options: CallOptions) !ModifyCertificateBasedAuthPropertiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyCertificateBasedAuthPropertiesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.ModifyCertificateBasedAuthProperties");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyCertificateBasedAuthPropertiesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
