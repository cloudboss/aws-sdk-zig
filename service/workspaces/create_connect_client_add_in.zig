...
pub const CreateConnectClientAddInInput = struct {
...
pub const CreateConnectClientAddInOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateConnectClientAddInInput, options: CallOptions) !CreateConnectClientAddInOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateConnectClientAddInInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.CreateConnectClientAddIn");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateConnectClientAddInOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreateConnectClientAddInOutput, body, allocator);
}
