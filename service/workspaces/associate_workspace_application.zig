...
pub const AssociateWorkspaceApplicationInput = struct {
...
pub const AssociateWorkspaceApplicationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateWorkspaceApplicationInput, options: CallOptions) !AssociateWorkspaceApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateWorkspaceApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.AssociateWorkspaceApplication");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateWorkspaceApplicationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(AssociateWorkspaceApplicationOutput, body, allocator);
}
