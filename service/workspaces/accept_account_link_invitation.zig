...
pub const AcceptAccountLinkInvitationInput = struct {
...
pub const AcceptAccountLinkInvitationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptAccountLinkInvitationInput, options: CallOptions) !AcceptAccountLinkInvitationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AcceptAccountLinkInvitationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.AcceptAccountLinkInvitation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AcceptAccountLinkInvitationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(AcceptAccountLinkInvitationOutput, body, allocator);
}
