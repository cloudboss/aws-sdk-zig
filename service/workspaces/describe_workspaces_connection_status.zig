...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeWorkspacesConnectionStatusInput, options: Options) !DescribeWorkspacesConnectionStatusOutput {
