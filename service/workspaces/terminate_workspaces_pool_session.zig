...
pub const TerminateWorkspacesPoolSessionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TerminateWorkspacesPoolSessionInput, options: Options) !TerminateWorkspacesPoolSessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TerminateWorkspacesPoolSessionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.TerminateWorkspacesPoolSession");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TerminateWorkspacesPoolSessionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
