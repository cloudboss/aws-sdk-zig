...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyWorkspaceAccessPropertiesInput, options: Options) !ModifyWorkspaceAccessPropertiesOutput {
