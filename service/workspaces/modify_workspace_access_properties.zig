...
pub const ModifyWorkspaceAccessPropertiesInput = struct {
...
pub const ModifyWorkspaceAccessPropertiesOutput = struct {
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ModifyWorkspaceAccessPropertiesInput, options: CallOptions) !ModifyWorkspaceAccessPropertiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ModifyWorkspaceAccessPropertiesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.ModifyWorkspaceAccessProperties");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ModifyWorkspaceAccessPropertiesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
