...
const ClientDeviceType = @import("client_device_type.zig").ClientDeviceType;

pub const DeleteClientBrandingInput = struct {
    /// The device type for which you want to delete client branding.
    platforms: []const ClientDeviceType,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteClientBrandingInput, options: CallOptions) !DeleteClientBrandingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteClientBrandingInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "WorkspacesService.DeleteClientBranding");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteClientBrandingOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
