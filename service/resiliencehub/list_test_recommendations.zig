...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTestRecommendationsInput, options: CallOptions) !ListTestRecommendationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTestRecommendationsInput, config: *aws.Config) !aws.http.Request {
