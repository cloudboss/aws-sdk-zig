...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListUnsupportedAppVersionResourcesInput, options: Options) !ListUnsupportedAppVersionResourcesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListUnsupportedAppVersionResourcesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListUnsupportedAppVersionResourcesOutput {
    var result: ListUnsupportedAppVersionResourcesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListUnsupportedAppVersionResourcesOutput, body, alloc);
    }
    _ = status;
    _ = headers;
