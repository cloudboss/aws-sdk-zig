...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResolveAppVersionResourcesInput, options: CallOptions) !ResolveAppVersionResourcesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ResolveAppVersionResourcesInput, config: *aws.Config) !aws.http.Request {
