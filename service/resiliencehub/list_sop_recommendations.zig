...
const SopRecommendation = @import("sop_recommendation.zig").SopRecommendation;

pub const ListSopRecommendationsInput = struct {
...
pub const ListSopRecommendationsOutput = struct {
    ...
    /// Hub
    /// applications.
    sop_recommendations: ?[]const SopRecommendation = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSopRecommendationsInput, options: CallOptions) !ListSopRecommendationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSopRecommendationsInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/list-sop-recommendations";
