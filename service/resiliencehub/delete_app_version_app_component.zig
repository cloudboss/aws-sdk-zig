...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAppVersionAppComponentInput, options: CallOptions) !DeleteAppVersionAppComponentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAppVersionAppComponentInput, config: *aws.Config) !aws.http.Request {
