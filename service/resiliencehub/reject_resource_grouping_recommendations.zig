...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectResourceGroupingRecommendationsInput, options: Options) !RejectResourceGroupingRecommendationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RejectResourceGroupingRecommendationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RejectResourceGroupingRecommendationsOutput {
    var result: RejectResourceGroupingRecommendationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(RejectResourceGroupingRecommendationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
