...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        unprocessable_content_exception: UnprocessableContentException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .unprocessable_content_exception => |e| e.message,
        ...
        pub fn httpStatus(self: Kind) u16 {
            return switch (self) {
                ...
                .unprocessable_content_exception => 422,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .unprocessable_content_exception => |e| e.request_id,
...
pub const UnprocessableContentException = struct {
    message: []const u8 = "",
    request_id: []const u8 = "",
};
