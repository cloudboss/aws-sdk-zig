...
pub const CreateContentAssociationInput = struct {
...
pub const CreateContentAssociationOutput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateContentAssociationInput, config: *aws.Config) !aws.http.Request {
