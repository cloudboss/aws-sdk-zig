...
pub const UpdateMessageTemplateMetadataInput = struct {
...
pub const UpdateMessageTemplateMetadataOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateMessageTemplateMetadataInput, options: Options) !UpdateMessageTemplateMetadataOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateMessageTemplateMetadataInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateMessageTemplateMetadataOutput {
    var result: UpdateMessageTemplateMetadataOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateMessageTemplateMetadataOutput, body, alloc);
    }
    _ = status;
    _ = headers;
