...
pub const GuardrailPiiEntityConfig = struct {
    ...
    /// 555 3456*. The current system formats the 10-digit number with spaces after
    /// the third and sixth digits. The final digit is an error-detecting checksum.
