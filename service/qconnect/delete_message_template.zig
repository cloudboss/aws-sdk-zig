...
pub const DeleteMessageTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMessageTemplateInput, options: Options) !DeleteMessageTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMessageTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMessageTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMessageTemplateOutput = .{};
