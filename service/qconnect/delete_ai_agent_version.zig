...
pub const DeleteAIAgentVersionInput = struct {
    /// The identifier of the Amazon Q in Connect AI Agent. Can be either the ID or
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAIAgentVersionInput, options: Options) !DeleteAIAgentVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAIAgentVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAIAgentVersionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAIAgentVersionOutput = .{};
