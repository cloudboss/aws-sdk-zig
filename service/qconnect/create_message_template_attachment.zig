...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateMessageTemplateAttachmentInput, options: Options) !CreateMessageTemplateAttachmentOutput {
