...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveKnowledgeBaseTemplateUriInput, options: CallOptions) !RemoveKnowledgeBaseTemplateUriOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveKnowledgeBaseTemplateUriInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveKnowledgeBaseTemplateUriOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
