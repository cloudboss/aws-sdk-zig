...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMessageTemplateVersionsInput, options: CallOptions) !ListMessageTemplateVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListMessageTemplateVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListMessageTemplateVersionsOutput {
    var result: ListMessageTemplateVersionsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListMessageTemplateVersionsOutput, body, allocator);
    }
    _ = status;
    _ = headers;
