...
pub const DeleteAIAgentInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAIAgentInput, options: Options) !DeleteAIAgentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAIAgentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAIAgentOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAIAgentOutput = .{};
