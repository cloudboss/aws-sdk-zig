...
pub const DeleteContentAssociationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteContentAssociationInput, options: Options) !DeleteContentAssociationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteContentAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.content_association_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteContentAssociationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteContentAssociationOutput = .{};
