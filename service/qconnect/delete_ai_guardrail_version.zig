...
pub const DeleteAIGuardrailVersionInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAIGuardrailVersionInput, options: Options) !DeleteAIGuardrailVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAIGuardrailVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAIGuardrailVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAIGuardrailVersionOutput = .{};
