...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAIPromptsInput, options: CallOptions) !ListAIPromptsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAIPromptsInput, config: *aws.Config) !aws.http.Request {
