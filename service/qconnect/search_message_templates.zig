...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SearchMessageTemplatesInput, options: CallOptions) !SearchMessageTemplatesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SearchMessageTemplatesInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/search/messageTemplates");
