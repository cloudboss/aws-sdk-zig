...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAIPromptVersionsInput, options: CallOptions) !ListAIPromptVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListAIPromptVersionsInput, config: *aws.Config) !aws.http.Request {
