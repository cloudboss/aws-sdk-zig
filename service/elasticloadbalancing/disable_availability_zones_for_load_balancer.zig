...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableAvailabilityZonesForLoadBalancerInput, options: CallOptions) !DisableAvailabilityZonesForLoadBalancerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableAvailabilityZonesForLoadBalancerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DisableAvailabilityZonesForLoadBalancer&Version=2012-06-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableAvailabilityZonesForLoadBalancerOutput {
    _ = status;
    _ = headers;
