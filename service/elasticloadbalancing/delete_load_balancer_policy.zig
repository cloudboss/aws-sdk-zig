...
pub const DeleteLoadBalancerPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLoadBalancerPolicyInput, options: Options) !DeleteLoadBalancerPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLoadBalancerPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteLoadBalancerPolicy&Version=2012-06-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLoadBalancerPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteLoadBalancerPolicyOutput = .{};
