...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLoadBalancerPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteLoadBalancerPolicy&Version=2012-06-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLoadBalancerPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
