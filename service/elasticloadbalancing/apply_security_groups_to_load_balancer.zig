...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ApplySecurityGroupsToLoadBalancerInput, options: Options) !ApplySecurityGroupsToLoadBalancerOutput {
