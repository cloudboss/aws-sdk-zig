...
fn serializeRequest(alloc: std.mem.Allocator, input: AttachLoadBalancerToSubnetsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AttachLoadBalancerToSubnets&Version=2012-06-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AttachLoadBalancerToSubnetsOutput {
    _ = status;
    _ = headers;
