...
fn serializeRequest(alloc: std.mem.Allocator, input: RegisterInstancesWithLoadBalancerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RegisterInstancesWithLoadBalancer&Version=2012-06-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RegisterInstancesWithLoadBalancerOutput {
    _ = status;
    _ = headers;
