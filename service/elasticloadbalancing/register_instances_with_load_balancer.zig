...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RegisterInstancesWithLoadBalancerInput, options: Options) !RegisterInstancesWithLoadBalancerOutput {
