...
pub const CreateAppCookieStickinessPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAppCookieStickinessPolicyInput, options: Options) !CreateAppCookieStickinessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateAppCookieStickinessPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateAppCookieStickinessPolicy&Version=2012-06-01");
    try body_buf.appendSlice(allocator, "&CookieName=");
    try aws.url.appendUrlEncoded(allocator, &body_buf, input.cookie_name);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateAppCookieStickinessPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: CreateAppCookieStickinessPolicyOutput = .{};
