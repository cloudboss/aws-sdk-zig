...
pub const LoadBalancerDescription = struct {
    ...
    backend_server_descriptions: ?[]const BackendServerDescription = null,
    ...
    listener_descriptions: ?[]const ListenerDescription = null,
    ...
    source_security_group: ?SourceSecurityGroup = null,
