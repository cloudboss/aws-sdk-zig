...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteLoadBalancerListenersInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteLoadBalancerListeners&Version=2012-06-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteLoadBalancerListenersOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
