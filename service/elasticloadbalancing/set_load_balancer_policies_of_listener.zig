...
fn serializeRequest(alloc: std.mem.Allocator, input: SetLoadBalancerPoliciesOfListenerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=SetLoadBalancerPoliciesOfListener&Version=2012-06-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetLoadBalancerPoliciesOfListenerOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
