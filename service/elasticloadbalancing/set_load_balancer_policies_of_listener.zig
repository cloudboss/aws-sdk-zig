...
pub const SetLoadBalancerPoliciesOfListenerInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetLoadBalancerPoliciesOfListenerInput, options: Options) !SetLoadBalancerPoliciesOfListenerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SetLoadBalancerPoliciesOfListenerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=SetLoadBalancerPoliciesOfListener&Version=2012-06-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SetLoadBalancerPoliciesOfListenerOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: SetLoadBalancerPoliciesOfListenerOutput = .{};
