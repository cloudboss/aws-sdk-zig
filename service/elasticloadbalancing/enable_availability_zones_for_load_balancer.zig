...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableAvailabilityZonesForLoadBalancerInput, options: CallOptions) !EnableAvailabilityZonesForLoadBalancerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: EnableAvailabilityZonesForLoadBalancerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=EnableAvailabilityZonesForLoadBalancer&Version=2012-06-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !EnableAvailabilityZonesForLoadBalancerOutput {
    _ = status;
    _ = headers;
