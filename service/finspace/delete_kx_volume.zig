...
pub const DeleteKxVolumeInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKxVolumeInput, options: CallOptions) !DeleteKxVolumeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKxVolumeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteKxVolumeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteKxVolumeOutput = .{};
