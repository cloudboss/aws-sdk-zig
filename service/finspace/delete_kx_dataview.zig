...
pub const DeleteKxDataviewInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKxDataviewInput, options: Options) !DeleteKxDataviewOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKxDataviewInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteKxDataviewOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteKxDataviewOutput = .{};
