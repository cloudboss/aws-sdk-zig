...
pub const DeleteKxClusterNodeInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKxClusterNodeInput, options: Options) !DeleteKxClusterNodeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKxClusterNodeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteKxClusterNodeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteKxClusterNodeOutput = .{};
