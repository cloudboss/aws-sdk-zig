...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateKxDataviewInput, options: CallOptions) !UpdateKxDataviewOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateKxDataviewInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.dataview_name);
