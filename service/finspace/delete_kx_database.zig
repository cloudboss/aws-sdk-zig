...
pub const DeleteKxDatabaseInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKxDatabaseInput, options: Options) !DeleteKxDatabaseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKxDatabaseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteKxDatabaseOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteKxDatabaseOutput = .{};
