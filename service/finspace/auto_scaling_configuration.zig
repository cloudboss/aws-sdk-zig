...
pub const AutoScalingConfiguration = struct {
    ...
    auto_scaling_metric: ?AutoScalingMetric = null,

    /// The highest number of nodes to scale. This value cannot be greater than 5.
    max_node_count: ?i32 = null,
