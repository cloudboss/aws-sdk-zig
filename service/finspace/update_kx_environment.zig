...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateKxEnvironmentInput, options: CallOptions) !UpdateKxEnvironmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateKxEnvironmentInput, config: *aws.Config) !aws.http.Request {
