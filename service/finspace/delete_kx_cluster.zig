...
pub const DeleteKxClusterInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteKxClusterInput, options: Options) !DeleteKxClusterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteKxClusterInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteKxClusterOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteKxClusterOutput = .{};
