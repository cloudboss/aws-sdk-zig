...
pub const DeleteMethodResponseInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMethodResponseInput, options: CallOptions) !DeleteMethodResponseOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMethodResponseOutput {
    ...
    _ = status;
    _ = headers;
    const result: DeleteMethodResponseOutput = .{};
