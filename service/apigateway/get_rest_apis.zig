...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRestApisInput, options: CallOptions) !GetRestApisOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetRestApisInput, config: *aws.Config) !aws.http.Request {
