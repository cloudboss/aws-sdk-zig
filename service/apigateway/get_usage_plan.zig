...
pub const GetUsagePlanOutput = @import("usage_plan.zig").UsagePlan;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetUsagePlanInput, options: CallOptions) !GetUsagePlanOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetUsagePlanInput, config: *aws.Config) !aws.http.Request {
