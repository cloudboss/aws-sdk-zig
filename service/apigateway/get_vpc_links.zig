...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVpcLinksInput, options: CallOptions) !GetVpcLinksOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVpcLinksInput, config: *aws.Config) !aws.http.Request {
