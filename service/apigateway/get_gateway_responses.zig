...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetGatewayResponsesInput, options: CallOptions) !GetGatewayResponsesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetGatewayResponsesInput, config: *aws.Config) !aws.http.Request {
