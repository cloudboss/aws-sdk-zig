...
pub const UpdateVpcLinkOutput = @import("vpc_link.zig").VpcLink;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateVpcLinkInput, options: CallOptions) !UpdateVpcLinkOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateVpcLinkInput, config: *aws.Config) !aws.http.Request {
