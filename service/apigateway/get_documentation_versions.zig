...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDocumentationVersionsInput, options: CallOptions) !GetDocumentationVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDocumentationVersionsInput, config: *aws.Config) !aws.http.Request {
