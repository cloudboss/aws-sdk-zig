...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBasePathMappingInput, options: Options) !DeleteBasePathMappingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteBasePathMappingInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteBasePathMappingOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
