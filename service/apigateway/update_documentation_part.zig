...
pub const UpdateDocumentationPartInput = struct {
...
pub const UpdateDocumentationPartOutput = @import("documentation_part.zig").DocumentationPart;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDocumentationPartInput, options: CallOptions) !UpdateDocumentationPartOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDocumentationPartInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDocumentationPartOutput {
    var result: UpdateDocumentationPartOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(UpdateDocumentationPartOutput, body, allocator);
    }
    _ = status;
    _ = headers;
