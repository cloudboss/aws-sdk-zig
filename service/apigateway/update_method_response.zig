...
const UpdateMethodResponseOutput = @import("method_response.zig").MethodResponse;

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateMethodResponseInput, options: Options) !UpdateMethodResponseOutput {
