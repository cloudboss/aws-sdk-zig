...
pub const GetRequestValidatorOutput = @import("request_validator.zig").RequestValidator;

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRequestValidatorInput, options: CallOptions) !GetRequestValidatorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetRequestValidatorInput, config: *aws.Config) !aws.http.Request {
