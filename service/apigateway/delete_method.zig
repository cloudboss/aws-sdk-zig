...
pub const DeleteMethodInput = struct {
...
pub const DeleteMethodOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteMethodInput, options: CallOptions) !DeleteMethodOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteMethodInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteMethodOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteMethodOutput = .{};
