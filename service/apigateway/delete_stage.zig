...
pub const DeleteStageInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteStageInput, options: Options) !DeleteStageOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteStageInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteStageOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteStageOutput = .{};
