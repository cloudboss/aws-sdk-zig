...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGatewayResponseInput, options: CallOptions) !DeleteGatewayResponseOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteGatewayResponseInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteGatewayResponseOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
