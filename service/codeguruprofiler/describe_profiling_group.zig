...
pub const DescribeProfilingGroupInput = struct {
...
pub const DescribeProfilingGroupOutput = struct {
    /// The returned [
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeProfilingGroupInput, options: CallOptions) !DescribeProfilingGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeProfilingGroupInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeProfilingGroupOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DescribeProfilingGroupOutput = .{};
