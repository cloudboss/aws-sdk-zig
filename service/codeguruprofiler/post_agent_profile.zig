...
fn serializeRequest(alloc: std.mem.Allocator, input: PostAgentProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/agentProfile");
    ...
    if (input.profile_token) |v| {
        ...
        try query_buf.appendSlice(alloc, "profileToken=");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PostAgentProfileOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
