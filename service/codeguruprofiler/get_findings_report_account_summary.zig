...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFindingsReportAccountSummaryInput, options: CallOptions) !GetFindingsReportAccountSummaryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFindingsReportAccountSummaryInput, config: *aws.Config) !aws.http.Request {
