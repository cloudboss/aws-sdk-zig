...
pub const TagServerCertificateOutput = struct {
    ...
    pub fn deinit(self: *TagServerCertificateOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: TagServerCertificateInput, options: Options) !TagServerCertificateOutput {
