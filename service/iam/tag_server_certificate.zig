...
pub const TagServerCertificateInput = struct {
...
const TagServerCertificateOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagServerCertificateInput, options: Options) !TagServerCertificateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: TagServerCertificateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=TagServerCertificate&Version=2010-05-08");
    try body_buf.appendSlice(alloc, "&ServerCertificateName=");
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.server_certificate_name);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !TagServerCertificateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: TagServerCertificateOutput = .{};
