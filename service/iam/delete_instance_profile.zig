...
pub const DeleteInstanceProfileInput = struct {
...
const DeleteInstanceProfileOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInstanceProfileInput, options: Options) !DeleteInstanceProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteInstanceProfile&Version=2010-05-08");
    try body_buf.appendSlice(alloc, "&InstanceProfileName=");
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.instance_profile_name);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: DeleteInstanceProfileOutput = .{};
