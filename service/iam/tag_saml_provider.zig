...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagSAMLProviderInput, options: CallOptions) !TagSAMLProviderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagSAMLProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=TagSAMLProvider&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagSAMLProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
