...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagInstanceProfileInput, options: CallOptions) !TagInstanceProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=TagInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
