...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRolePermissionsBoundaryInput, options: CallOptions) !DeleteRolePermissionsBoundaryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRolePermissionsBoundaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteRolePermissionsBoundary&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRolePermissionsBoundaryOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteRolePermissionsBoundaryOutput = .{};
