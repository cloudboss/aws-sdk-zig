...
pub const DeleteRolePermissionsBoundaryOutput = struct {
    ...
    pub fn deinit(self: *const DeleteRolePermissionsBoundaryOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteRolePermissionsBoundaryInput, options: Options) !DeleteRolePermissionsBoundaryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteRolePermissionsBoundaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteRolePermissionsBoundary&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteRolePermissionsBoundaryOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteRolePermissionsBoundaryOutput = .{ .allocator = alloc };
