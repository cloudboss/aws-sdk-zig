...
pub const ListGroupsForUserOutput = struct {
    ...
    pub fn deinit(self: *ListGroupsForUserOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: ListGroupsForUserInput, options: Options) !ListGroupsForUserOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListGroupsForUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ListGroupsForUser&Version=2010-05-08");
    if (input.marker) |v| {
