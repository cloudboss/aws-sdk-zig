...
pub const RejectDelegationRequestInput = struct {
...
const RejectDelegationRequestOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectDelegationRequestInput, options: Options) !RejectDelegationRequestOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RejectDelegationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RejectDelegationRequest&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RejectDelegationRequestOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
