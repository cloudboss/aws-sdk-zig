...
pub const AssociateDelegationRequestInput = struct {
...
pub const AssociateDelegationRequestOutput = struct {
    ...
    pub fn deinit(self: *const AssociateDelegationRequestOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AssociateDelegationRequestInput, options: Options) !AssociateDelegationRequestOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AssociateDelegationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AssociateDelegationRequest&Version=2010-05-08");
    try body_buf.appendSlice(alloc, "&DelegationRequestId=");
    try appendUrlEncoded(alloc, &body_buf, input.delegation_request_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AssociateDelegationRequestOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: AssociateDelegationRequestOutput = .{ .allocator = alloc };
