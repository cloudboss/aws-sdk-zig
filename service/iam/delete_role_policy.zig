...
pub const DeleteRolePolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRolePolicyInput, options: CallOptions) !DeleteRolePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRolePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteRolePolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRolePolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
