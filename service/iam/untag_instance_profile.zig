...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagInstanceProfileInput, options: CallOptions) !UntagInstanceProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UntagInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
