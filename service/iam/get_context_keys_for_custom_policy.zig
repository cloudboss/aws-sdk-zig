...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContextKeysForCustomPolicyInput, options: CallOptions) !GetContextKeysForCustomPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetContextKeysForCustomPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=GetContextKeysForCustomPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetContextKeysForCustomPolicyOutput {
    _ = status;
    _ = headers;
