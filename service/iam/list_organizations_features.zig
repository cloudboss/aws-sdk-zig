...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListOrganizationsFeaturesInput, options: CallOptions) !ListOrganizationsFeaturesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListOrganizationsFeaturesInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=ListOrganizationsFeatures&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListOrganizationsFeaturesOutput {
    _ = status;
    _ = headers;
