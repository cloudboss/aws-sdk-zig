...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SimulatePrincipalPolicyInput, options: CallOptions) !SimulatePrincipalPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SimulatePrincipalPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=SimulatePrincipalPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SimulatePrincipalPolicyOutput {
    _ = status;
    _ = headers;
