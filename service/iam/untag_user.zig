...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagUserInput, options: CallOptions) !UntagUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UntagUser&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagUserOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
