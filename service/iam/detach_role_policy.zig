...
const DetachRolePolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachRolePolicyInput, options: Options) !DetachRolePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachRolePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DetachRolePolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachRolePolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
