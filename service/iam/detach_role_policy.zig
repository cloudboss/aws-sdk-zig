...
fn serializeRequest(alloc: std.mem.Allocator, input: DetachRolePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DetachRolePolicy&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DetachRolePolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
