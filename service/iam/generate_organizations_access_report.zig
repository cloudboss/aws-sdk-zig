...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GenerateOrganizationsAccessReportInput, options: Options) !GenerateOrganizationsAccessReportOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GenerateOrganizationsAccessReportInput, config: *aws.Config) !aws.http.Request {
    ...
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.entity_path);
