...
const TagUserOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagUserInput, options: Options) !TagUserOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagUserInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=TagUser&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagUserOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
