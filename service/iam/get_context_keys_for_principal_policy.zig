...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContextKeysForPrincipalPolicyInput, options: Options) !GetContextKeysForPrincipalPolicyOutput {
