...
pub fn execute(client: *Client, input: GenerateServiceLastAccessedDetailsInput, options: Options) !GenerateServiceLastAccessedDetailsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GenerateServiceLastAccessedDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GenerateServiceLastAccessedDetails&Version=2010-05-08");
    try body_buf.appendSlice(alloc, "&Arn=");
    try appendUrlEncoded(alloc, &body_buf, input.arn);
