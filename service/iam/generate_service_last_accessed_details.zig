...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GenerateServiceLastAccessedDetailsInput, options: Options) !GenerateServiceLastAccessedDetailsOutput {
