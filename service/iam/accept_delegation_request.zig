...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptDelegationRequestInput, options: CallOptions) !AcceptDelegationRequestOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AcceptDelegationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AcceptDelegationRequest&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AcceptDelegationRequestOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: AcceptDelegationRequestOutput = .{};
