...
pub const AcceptDelegationRequestOutput = struct {
    ...
    pub fn deinit(self: *AcceptDelegationRequestOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: AcceptDelegationRequestInput, options: Options) !AcceptDelegationRequestOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AcceptDelegationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AcceptDelegationRequest&Version=2010-05-08");
