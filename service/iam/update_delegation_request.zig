...
pub const UpdateDelegationRequestOutput = struct {
    ...
    pub fn deinit(self: *const UpdateDelegationRequestOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: UpdateDelegationRequestInput, options: Options) !UpdateDelegationRequestOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateDelegationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdateDelegationRequest&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateDelegationRequestOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: UpdateDelegationRequestOutput = .{ .allocator = alloc };
