...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDelegationRequestInput, options: CallOptions) !UpdateDelegationRequestOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDelegationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UpdateDelegationRequest&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDelegationRequestOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
