...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachUserPolicyInput, options: CallOptions) !DetachUserPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachUserPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DetachUserPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachUserPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
