...
pub const AddClientIDToOpenIDConnectProviderOutput = struct {
    ...
    pub fn deinit(self: *const AddClientIDToOpenIDConnectProviderOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AddClientIDToOpenIDConnectProviderInput, options: Options) !AddClientIDToOpenIDConnectProviderOutput {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddClientIDToOpenIDConnectProviderOutput {
    ...
    _ = headers;
    _ = body;
    const result: AddClientIDToOpenIDConnectProviderOutput = .{ .allocator = alloc };
