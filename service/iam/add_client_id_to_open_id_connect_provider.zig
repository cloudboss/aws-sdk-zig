...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddClientIDToOpenIDConnectProviderInput, options: CallOptions) !AddClientIDToOpenIDConnectProviderOutput {
