...
const AddClientIDToOpenIDConnectProviderOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddClientIDToOpenIDConnectProviderInput, options: Options) !AddClientIDToOpenIDConnectProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AddClientIDToOpenIDConnectProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AddClientIDToOpenIDConnectProvider&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddClientIDToOpenIDConnectProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: AddClientIDToOpenIDConnectProviderOutput = .{};
