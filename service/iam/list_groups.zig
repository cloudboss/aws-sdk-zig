...
pub const ListGroupsOutput = struct {
    ...
    pub fn deinit(self: *const ListGroupsOutput) void {
        if (self.marker) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListGroupsOutput {
    _ = status;
    var result: ListGroupsOutput = .{ .allocator = alloc };
