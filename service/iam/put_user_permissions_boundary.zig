...
pub const PutUserPermissionsBoundaryInput = struct {
...
pub const PutUserPermissionsBoundaryOutput = struct {

    allocator: std.mem.Allocator,

    pub fn deinit(self: *const PutUserPermissionsBoundaryOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: PutUserPermissionsBoundaryInput, options: Options) !PutUserPermissionsBoundaryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutUserPermissionsBoundaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=PutUserPermissionsBoundary&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutUserPermissionsBoundaryOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: PutUserPermissionsBoundaryOutput = .{ .allocator = alloc };
