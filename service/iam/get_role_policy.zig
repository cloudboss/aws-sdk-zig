...
pub const GetRolePolicyOutput = struct {
    ...
    pub fn deinit(self: *GetRolePolicyOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: GetRolePolicyInput, options: Options) !GetRolePolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetRolePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetRolePolicy&Version=2010-05-08");
