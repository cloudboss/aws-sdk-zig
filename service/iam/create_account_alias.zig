...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateAccountAliasInput, options: CallOptions) !CreateAccountAliasOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateAccountAliasInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=CreateAccountAlias&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateAccountAliasOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
