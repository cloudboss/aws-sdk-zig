...
pub const PutRolePolicyOutput = struct {
    ...
    pub fn deinit(self: *PutRolePolicyOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: PutRolePolicyInput, options: Options) !PutRolePolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutRolePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=PutRolePolicy&Version=2010-05-08");
