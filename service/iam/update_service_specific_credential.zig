...
pub const UpdateServiceSpecificCredentialOutput = struct {
    ...
    pub fn deinit(self: *const UpdateServiceSpecificCredentialOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: UpdateServiceSpecificCredentialInput, options: Options) !UpdateServiceSpecificCredentialOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateServiceSpecificCredentialInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdateServiceSpecificCredential&Version=2010-05-08");
    ...
    try appendUrlEncoded(alloc, &body_buf, @tagName(input.status));
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateServiceSpecificCredentialOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: UpdateServiceSpecificCredentialOutput = .{ .allocator = alloc };
