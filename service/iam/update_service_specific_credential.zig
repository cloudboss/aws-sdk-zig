...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateServiceSpecificCredentialInput, options: Options) !UpdateServiceSpecificCredentialOutput {
