...
pub const PutRolePermissionsBoundaryOutput = struct {
    ...
    pub fn deinit(self: *const PutRolePermissionsBoundaryOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: PutRolePermissionsBoundaryInput, options: Options) !PutRolePermissionsBoundaryOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutRolePermissionsBoundaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=PutRolePermissionsBoundary&Version=2010-05-08");
    try body_buf.appendSlice(alloc, "&PermissionsBoundary=");
    try appendUrlEncoded(alloc, &body_buf, input.permissions_boundary);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutRolePermissionsBoundaryOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: PutRolePermissionsBoundaryOutput = .{ .allocator = alloc };
