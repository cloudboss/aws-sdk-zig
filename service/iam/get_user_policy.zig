...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetUserPolicyInput, options: CallOptions) !GetUserPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetUserPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=GetUserPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetUserPolicyOutput {
    _ = status;
    _ = headers;
