...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableOrganizationsRootSessionsInput, options: Options) !DisableOrganizationsRootSessionsOutput {
