...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableOrganizationsRootSessionsInput, options: CallOptions) !DisableOrganizationsRootSessionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableOrganizationsRootSessionsInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=DisableOrganizationsRootSessions&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableOrganizationsRootSessionsOutput {
    _ = status;
    _ = headers;
