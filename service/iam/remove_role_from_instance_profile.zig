...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveRoleFromInstanceProfileInput, options: CallOptions) !RemoveRoleFromInstanceProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveRoleFromInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RemoveRoleFromInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveRoleFromInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
