...
pub const RemoveRoleFromInstanceProfileInput = struct {
...
pub const RemoveRoleFromInstanceProfileOutput = struct {
    ...
    pub fn deinit(self: *const RemoveRoleFromInstanceProfileOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: RemoveRoleFromInstanceProfileInput, options: Options) !RemoveRoleFromInstanceProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveRoleFromInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RemoveRoleFromInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RemoveRoleFromInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: RemoveRoleFromInstanceProfileOutput = .{ .allocator = alloc };
