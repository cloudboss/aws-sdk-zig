...
pub fn execute(client: *Client, input: GetLoginProfileInput, options: Options) !GetLoginProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetLoginProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetLoginProfile&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetLoginProfileOutput {
    _ = status;
    _ = body;
