...
pub const RemoveClientIDFromOpenIDConnectProviderOutput = struct {
    ...
    pub fn deinit(self: *const RemoveClientIDFromOpenIDConnectProviderOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: RemoveClientIDFromOpenIDConnectProviderInput, options: Options) !RemoveClientIDFromOpenIDConnectProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveClientIDFromOpenIDConnectProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RemoveClientIDFromOpenIDConnectProvider&Version=2010-05-08");
    try body_buf.appendSlice(alloc, "&ClientID=");
    try appendUrlEncoded(alloc, &body_buf, input.client_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RemoveClientIDFromOpenIDConnectProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: RemoveClientIDFromOpenIDConnectProviderOutput = .{ .allocator = alloc };
