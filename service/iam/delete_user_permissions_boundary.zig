...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserPermissionsBoundaryInput, options: CallOptions) !DeleteUserPermissionsBoundaryOutput {
