...
const DeleteUserPermissionsBoundaryOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserPermissionsBoundaryInput, options: Options) !DeleteUserPermissionsBoundaryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserPermissionsBoundaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteUserPermissionsBoundary&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserPermissionsBoundaryOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
