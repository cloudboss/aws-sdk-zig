...
pub const PutGroupPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutGroupPolicyInput, options: CallOptions) !PutGroupPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutGroupPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=PutGroupPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutGroupPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: PutGroupPolicyOutput = .{};
