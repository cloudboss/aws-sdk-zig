...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetServiceLastAccessedDetailsInput, options: CallOptions) !GetServiceLastAccessedDetailsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetServiceLastAccessedDetailsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=GetServiceLastAccessedDetails&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetServiceLastAccessedDetailsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "Error")) {
                    ...
                    result.services_last_accessed = try serde.deserializeServicesLastAccessed(allocator, &reader, "member");
                } else {
