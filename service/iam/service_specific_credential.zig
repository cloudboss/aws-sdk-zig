...
pub const ServiceSpecificCredential = struct {
    ...
    /// is
    /// created.
    service_credential_secret: ?[]const u8 = null,
    ...
    /// generated by
    /// combining the IAM user's name combined with the ID number of the Amazon Web
