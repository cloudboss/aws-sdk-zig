...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachGroupPolicyInput, options: CallOptions) !DetachGroupPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachGroupPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DetachGroupPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachGroupPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
