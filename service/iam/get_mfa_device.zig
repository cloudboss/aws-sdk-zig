...
pub fn execute(client: *Client, input: GetMFADeviceInput, options: Options) !GetMFADeviceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetMFADeviceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetMFADevice&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetMFADeviceOutput {
    _ = status;
