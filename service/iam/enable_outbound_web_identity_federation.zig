...
fn serializeRequest(allocator: std.mem.Allocator, input: EnableOutboundWebIdentityFederationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=EnableOutboundWebIdentityFederation&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !EnableOutboundWebIdentityFederationOutput {
    _ = status;
    _ = headers;
