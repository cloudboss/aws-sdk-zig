...
const UntagPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagPolicyInput, options: Options) !UntagPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UntagPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
