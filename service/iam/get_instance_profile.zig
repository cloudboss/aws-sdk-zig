...
pub fn execute(client: *Client, input: GetInstanceProfileInput, options: Options) !GetInstanceProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetInstanceProfileOutput {
    _ = status;
    _ = body;
