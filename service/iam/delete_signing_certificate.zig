...
pub const DeleteSigningCertificateOutput = struct {
    ...
    pub fn deinit(self: *const DeleteSigningCertificateOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteSigningCertificateInput, options: Options) !DeleteSigningCertificateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSigningCertificateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteSigningCertificate&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSigningCertificateOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteSigningCertificateOutput = .{ .allocator = alloc };
