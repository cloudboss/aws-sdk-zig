...
pub fn execute(client: *Client, input: ListVirtualMFADevicesInput, options: Options) !ListVirtualMFADevicesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListVirtualMFADevicesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ListVirtualMFADevices&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListVirtualMFADevicesOutput {
    _ = status;
