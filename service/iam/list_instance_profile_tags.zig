...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListInstanceProfileTagsInput, options: CallOptions) !ListInstanceProfileTagsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListInstanceProfileTagsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ListInstanceProfileTags&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListInstanceProfileTagsOutput {
    _ = status;
    _ = headers;
