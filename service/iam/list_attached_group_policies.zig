...
fn serializeRequest(alloc: std.mem.Allocator, input: ListAttachedGroupPoliciesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ListAttachedGroupPolicies&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListAttachedGroupPoliciesOutput {
    _ = status;
