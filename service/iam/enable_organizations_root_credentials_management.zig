...
pub const EnableOrganizationsRootCredentialsManagementOutput = struct {
    ...
    pub fn deinit(self: *EnableOrganizationsRootCredentialsManagementOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: EnableOrganizationsRootCredentialsManagementInput, options: Options) !EnableOrganizationsRootCredentialsManagementOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableOrganizationsRootCredentialsManagementInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableOrganizationsRootCredentialsManagement&Version=2010-05-08");
