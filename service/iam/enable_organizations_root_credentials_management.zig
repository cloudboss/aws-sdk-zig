...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableOrganizationsRootCredentialsManagementInput, options: Options) !EnableOrganizationsRootCredentialsManagementOutput {
