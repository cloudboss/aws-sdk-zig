...
const TagPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagPolicyInput, options: Options) !TagPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=TagPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
