...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddUserToGroupInput, options: CallOptions) !AddUserToGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddUserToGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AddUserToGroup&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddUserToGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
