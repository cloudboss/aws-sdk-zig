...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListOpenIDConnectProviderTagsInput, options: CallOptions) !ListOpenIDConnectProviderTagsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListOpenIDConnectProviderTagsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ListOpenIDConnectProviderTags&Version=2010-05-08");
    if (input.marker) |v| {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListOpenIDConnectProviderTagsOutput {
    _ = status;
    _ = headers;
