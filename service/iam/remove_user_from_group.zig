...
pub const RemoveUserFromGroupInput = struct {
...
const RemoveUserFromGroupOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveUserFromGroupInput, options: Options) !RemoveUserFromGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveUserFromGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RemoveUserFromGroup&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveUserFromGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: RemoveUserFromGroupOutput = .{};
