...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddRoleToInstanceProfileInput, options: CallOptions) !AddRoleToInstanceProfileOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddRoleToInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AddRoleToInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddRoleToInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
