...
pub const AddRoleToInstanceProfileOutput = struct {
    ...
    pub fn deinit(self: *const AddRoleToInstanceProfileOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: AddRoleToInstanceProfileInput, options: Options) !AddRoleToInstanceProfileOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AddRoleToInstanceProfileInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AddRoleToInstanceProfile&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AddRoleToInstanceProfileOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: AddRoleToInstanceProfileOutput = .{ .allocator = alloc };
