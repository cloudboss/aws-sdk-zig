...
pub const DeleteOpenIDConnectProviderOutput = struct {
    ...
    pub fn deinit(self: *const DeleteOpenIDConnectProviderOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteOpenIDConnectProviderInput, options: Options) !DeleteOpenIDConnectProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteOpenIDConnectProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteOpenIDConnectProvider&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteOpenIDConnectProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteOpenIDConnectProviderOutput = .{ .allocator = alloc };
