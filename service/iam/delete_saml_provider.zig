...
pub const DeleteSAMLProviderOutput = struct {
    ...
    pub fn deinit(self: *const DeleteSAMLProviderOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteSAMLProviderInput, options: Options) !DeleteSAMLProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSAMLProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteSAMLProvider&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSAMLProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteSAMLProviderOutput = .{ .allocator = alloc };
