...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSAMLProviderInput, options: CallOptions) !DeleteSAMLProviderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSAMLProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteSAMLProvider&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSAMLProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
