...
pub fn execute(client: *Client, input: EnableOrganizationsRootSessionsInput, options: Options) !EnableOrganizationsRootSessionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EnableOrganizationsRootSessionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnableOrganizationsRootSessions&Version=2010-05-08");
