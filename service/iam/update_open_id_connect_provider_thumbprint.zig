...
const UpdateOpenIDConnectProviderThumbprintOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateOpenIDConnectProviderThumbprintInput, options: Options) !UpdateOpenIDConnectProviderThumbprintOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateOpenIDConnectProviderThumbprintInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdateOpenIDConnectProviderThumbprint&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateOpenIDConnectProviderThumbprintOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
