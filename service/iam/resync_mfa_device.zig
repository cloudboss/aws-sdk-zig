...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResyncMFADeviceInput, options: CallOptions) !ResyncMFADeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ResyncMFADeviceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ResyncMFADevice&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ResyncMFADeviceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
