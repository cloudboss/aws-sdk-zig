...
pub const SimulateCustomPolicyOutput = struct {
    ...
    pub fn deinit(self: *const SimulateCustomPolicyOutput) void {
        if (self.marker) |v| {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !SimulateCustomPolicyOutput {
    _ = status;
    var result: SimulateCustomPolicyOutput = .{ .allocator = alloc };
