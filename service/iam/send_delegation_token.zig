...
fn serializeRequest(allocator: std.mem.Allocator, input: SendDelegationTokenInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=SendDelegationToken&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SendDelegationTokenOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
