...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateServiceSpecificCredentialInput, options: Options) !CreateServiceSpecificCredentialOutput {
