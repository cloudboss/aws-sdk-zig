...
/// Reference*.
pub const DeleteServerCertificateInput = struct {
...
pub const DeleteServerCertificateOutput = struct {
    ...
    pub fn deinit(self: *const DeleteServerCertificateOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteServerCertificateInput, options: Options) !DeleteServerCertificateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteServerCertificateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteServerCertificate&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteServerCertificateOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteServerCertificateOutput = .{ .allocator = alloc };
