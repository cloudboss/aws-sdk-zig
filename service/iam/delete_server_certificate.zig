...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServerCertificateInput, options: CallOptions) !DeleteServerCertificateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteServerCertificateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteServerCertificate&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteServerCertificateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
