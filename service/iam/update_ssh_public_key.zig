...
pub const UpdateSSHPublicKeyOutput = struct {
    ...
    pub fn deinit(self: *const UpdateSSHPublicKeyOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: UpdateSSHPublicKeyInput, options: Options) !UpdateSSHPublicKeyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateSSHPublicKeyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UpdateSSHPublicKey&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateSSHPublicKeyOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: UpdateSSHPublicKeyOutput = .{ .allocator = alloc };
