...
pub const UpdateSSHPublicKeyInput = struct {
...
const UpdateSSHPublicKeyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSSHPublicKeyInput, options: Options) !UpdateSSHPublicKeyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSSHPublicKeyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UpdateSSHPublicKey&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateSSHPublicKeyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: UpdateSSHPublicKeyOutput = .{};
