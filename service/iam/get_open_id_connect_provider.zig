...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOpenIDConnectProviderInput, options: Options) !GetOpenIDConnectProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetOpenIDConnectProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetOpenIDConnectProvider&Version=2010-05-08");
