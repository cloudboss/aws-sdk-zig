...
pub fn execute(client: *Client, input: CreateUserInput, options: Options) !CreateUserOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !CreateUserOutput {
    _ = status;
    _ = body;
