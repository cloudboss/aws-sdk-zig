...
pub const AttachUserPolicyInput = struct {
...
const AttachUserPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachUserPolicyInput, options: Options) !AttachUserPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachUserPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AttachUserPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachUserPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: AttachUserPolicyOutput = .{};
