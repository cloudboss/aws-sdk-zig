...
const DeleteAccountPasswordPolicyInput = struct {};

const DeleteAccountPasswordPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAccountPasswordPolicyInput, options: Options) !DeleteAccountPasswordPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAccountPasswordPolicyInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteAccountPasswordPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAccountPasswordPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteAccountPasswordPolicyOutput = .{};
