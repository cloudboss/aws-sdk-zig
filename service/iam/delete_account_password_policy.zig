...
pub const DeleteAccountPasswordPolicyOutput = struct {

    allocator: std.mem.Allocator,

    pub fn deinit(self: *const DeleteAccountPasswordPolicyOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteAccountPasswordPolicyInput, options: Options) !DeleteAccountPasswordPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteAccountPasswordPolicyInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteAccountPasswordPolicy&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteAccountPasswordPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteAccountPasswordPolicyOutput = .{ .allocator = alloc };
