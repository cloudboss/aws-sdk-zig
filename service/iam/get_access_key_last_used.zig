...
pub fn execute(client: *Client, input: GetAccessKeyLastUsedInput, options: Options) !GetAccessKeyLastUsedOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAccessKeyLastUsedInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetAccessKeyLastUsed&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !GetAccessKeyLastUsedOutput {
    _ = status;
