...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachRolePolicyInput, options: CallOptions) !AttachRolePolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachRolePolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AttachRolePolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachRolePolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
