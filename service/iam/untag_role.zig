...
pub const UntagRoleInput = struct {
...
const UntagRoleOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagRoleInput, options: Options) !UntagRoleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagRoleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UntagRole&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagRoleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
