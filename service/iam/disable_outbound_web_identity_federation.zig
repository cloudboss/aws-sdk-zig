...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableOutboundWebIdentityFederationInput, options: CallOptions) !DisableOutboundWebIdentityFederationOutput {
