...
const DisableOutboundWebIdentityFederationInput = struct {};

const DisableOutboundWebIdentityFederationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableOutboundWebIdentityFederationInput, options: Options) !DisableOutboundWebIdentityFederationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableOutboundWebIdentityFederationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(allocator, "Action=DisableOutboundWebIdentityFederation&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisableOutboundWebIdentityFederationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
