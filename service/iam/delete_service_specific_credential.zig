...
pub const DeleteServiceSpecificCredentialOutput = struct {
    ...
    pub fn deinit(self: *const DeleteServiceSpecificCredentialOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteServiceSpecificCredentialInput, options: Options) !DeleteServiceSpecificCredentialOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteServiceSpecificCredentialInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteServiceSpecificCredential&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteServiceSpecificCredentialOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteServiceSpecificCredentialOutput = .{ .allocator = alloc };
