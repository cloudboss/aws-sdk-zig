...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServiceSpecificCredentialInput, options: Options) !DeleteServiceSpecificCredentialOutput {
