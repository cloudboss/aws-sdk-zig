...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteServiceSpecificCredentialInput, options: CallOptions) !DeleteServiceSpecificCredentialOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteServiceSpecificCredentialInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteServiceSpecificCredential&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteServiceSpecificCredentialOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
