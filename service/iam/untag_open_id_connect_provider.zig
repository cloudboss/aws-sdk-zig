...
pub const UntagOpenIDConnectProviderOutput = struct {
    ...
    pub fn deinit(self: *const UntagOpenIDConnectProviderOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: UntagOpenIDConnectProviderInput, options: Options) !UntagOpenIDConnectProviderOutput {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UntagOpenIDConnectProviderOutput {
    ...
    _ = headers;
    _ = body;
    const result: UntagOpenIDConnectProviderOutput = .{ .allocator = alloc };
