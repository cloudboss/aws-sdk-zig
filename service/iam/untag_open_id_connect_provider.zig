...
pub const UntagOpenIDConnectProviderInput = struct {
...
const UntagOpenIDConnectProviderOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagOpenIDConnectProviderInput, options: Options) !UntagOpenIDConnectProviderOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UntagOpenIDConnectProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=UntagOpenIDConnectProvider&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UntagOpenIDConnectProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: UntagOpenIDConnectProviderOutput = .{};
