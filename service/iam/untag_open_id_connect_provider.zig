...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagOpenIDConnectProviderInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UntagOpenIDConnectProvider&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagOpenIDConnectProviderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
