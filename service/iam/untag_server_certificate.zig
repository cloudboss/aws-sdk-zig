...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagServerCertificateInput, options: CallOptions) !UntagServerCertificateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagServerCertificateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UntagServerCertificate&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagServerCertificateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
