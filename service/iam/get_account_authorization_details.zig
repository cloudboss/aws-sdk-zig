...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAccountAuthorizationDetailsInput, options: Options) !GetAccountAuthorizationDetailsOutput {
