...
pub fn execute(client: *Client, input: ListPoliciesGrantingServiceAccessInput, options: Options) !ListPoliciesGrantingServiceAccessOutput {
...
fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !ListPoliciesGrantingServiceAccessOutput {
    _ = status;
