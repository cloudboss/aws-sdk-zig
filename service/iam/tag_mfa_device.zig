...
pub const TagMFADeviceInput = struct {
...
const TagMFADeviceOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagMFADeviceInput, options: Options) !TagMFADeviceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagMFADeviceInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=TagMFADevice&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagMFADeviceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: TagMFADeviceOutput = .{};
