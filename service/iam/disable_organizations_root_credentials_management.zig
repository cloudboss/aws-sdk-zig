...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableOrganizationsRootCredentialsManagementInput, options: Options) !DisableOrganizationsRootCredentialsManagementOutput {
