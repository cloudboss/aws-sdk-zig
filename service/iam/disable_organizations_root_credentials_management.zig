...
pub const DisableOrganizationsRootCredentialsManagementOutput = struct {
    ...
    pub fn deinit(self: *const DisableOrganizationsRootCredentialsManagementOutput) void {
...
pub fn execute(client: *Client, input: DisableOrganizationsRootCredentialsManagementInput, options: Options) !DisableOrganizationsRootCredentialsManagementOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisableOrganizationsRootCredentialsManagementInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=DisableOrganizationsRootCredentialsManagement&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisableOrganizationsRootCredentialsManagementOutput {
    _ = status;
    _ = headers;
    var result: DisableOrganizationsRootCredentialsManagementOutput = .{ .allocator = alloc };
