...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserPolicyInput, options: CallOptions) !DeleteUserPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteUserPolicy&Version=2010-05-08");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
