...
pub const DeleteUserPolicyOutput = struct {
    ...
    pub fn deinit(self: *const DeleteUserPolicyOutput) void {
        _ = self;
    }
};
...
pub fn execute(client: *Client, input: DeleteUserPolicyInput, options: Options) !DeleteUserPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteUserPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteUserPolicy&Version=2010-05-08");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteUserPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    const result: DeleteUserPolicyOutput = .{ .allocator = alloc };
