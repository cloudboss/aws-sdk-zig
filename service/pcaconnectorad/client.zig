...
pub const Client = struct {
    ...
    /// Active Directory
    pub fn createDirectoryRegistration(self: *Self, allocator: std.mem.Allocator, input: create_directory_registration.CreateDirectoryRegistrationInput, options: create_directory_registration.Options) !create_directory_registration.CreateDirectoryRegistrationOutput {
    ...
    /// sign-in
    /// account.
    pub fn createServicePrincipalName(self: *Self, allocator: std.mem.Allocator, input: create_service_principal_name.CreateServicePrincipalNameInput, options: create_service_principal_name.Options) !create_service_principal_name.CreateServicePrincipalNameOutput {
    ...
    /// (SIDs).
    pub fn createTemplateGroupAccessControlEntry(self: *Self, allocator: std.mem.Allocator, input: create_template_group_access_control_entry.CreateTemplateGroupAccessControlEntryInput, options: create_template_group_access_control_entry.Options) !create_template_group_access_control_entry.CreateTemplateGroupAccessControlEntryOutput {
    ...
    pub fn deleteDirectoryRegistration(self: *Self, allocator: std.mem.Allocator, input: delete_directory_registration.DeleteDirectoryRegistrationInput, options: delete_directory_registration.Options) !delete_directory_registration.DeleteDirectoryRegistrationOutput {
    ...
    /// with your
    /// Active Directory.
    pub fn deleteServicePrincipalName(self: *Self, allocator: std.mem.Allocator, input: delete_service_principal_name.DeleteServicePrincipalNameInput, options: delete_service_principal_name.Options) !delete_service_principal_name.DeleteServicePrincipalNameOutput {
    ...
    pub fn deleteTemplateGroupAccessControlEntry(self: *Self, allocator: std.mem.Allocator, input: delete_template_group_access_control_entry.DeleteTemplateGroupAccessControlEntryInput, options: delete_template_group_access_control_entry.Options) !delete_template_group_access_control_entry.DeleteTemplateGroupAccessControlEntryOutput {
    ...
    pub fn getDirectoryRegistration(self: *Self, allocator: std.mem.Allocator, input: get_directory_registration.GetDirectoryRegistrationInput, options: get_directory_registration.Options) !get_directory_registration.GetDirectoryRegistrationOutput {
    ...
    /// with
    /// Active Directory.
    pub fn getServicePrincipalName(self: *Self, allocator: std.mem.Allocator, input: get_service_principal_name.GetServicePrincipalNameInput, options: get_service_principal_name.Options) !get_service_principal_name.GetServicePrincipalNameOutput {
    ...
    pub fn getTemplateGroupAccessControlEntry(self: *Self, allocator: std.mem.Allocator, input: get_template_group_access_control_entry.GetTemplateGroupAccessControlEntryInput, options: get_template_group_access_control_entry.Options) !get_template_group_access_control_entry.GetTemplateGroupAccessControlEntryOutput {
    ...
    /// action.
    pub fn listDirectoryRegistrations(self: *Self, allocator: std.mem.Allocator, input: list_directory_registrations.ListDirectoryRegistrationsInput, options: list_directory_registrations.Options) !list_directory_registrations.ListDirectoryRegistrationsOutput {
    ...
    /// with
    /// Active Directory.
    pub fn listServicePrincipalNames(self: *Self, allocator: std.mem.Allocator, input: list_service_principal_names.ListServicePrincipalNamesInput, options: list_service_principal_names.Options) !list_service_principal_names.ListServicePrincipalNamesOutput {
    ...
    pub fn listTemplateGroupAccessControlEntries(self: *Self, allocator: std.mem.Allocator, input: list_template_group_access_control_entries.ListTemplateGroupAccessControlEntriesInput, options: list_template_group_access_control_entries.Options) !list_template_group_access_control_entries.ListTemplateGroupAccessControlEntriesOutput {
    ...
    pub fn updateTemplateGroupAccessControlEntry(self: *Self, allocator: std.mem.Allocator, input: update_template_group_access_control_entry.UpdateTemplateGroupAccessControlEntryInput, options: update_template_group_access_control_entry.Options) !update_template_group_access_control_entry.UpdateTemplateGroupAccessControlEntryOutput {
