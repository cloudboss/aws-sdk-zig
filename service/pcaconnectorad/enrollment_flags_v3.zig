...
pub const EnrollmentFlagsV3 = struct {
    /// Allow renewal using the same key.
    enable_key_reuse_on_nt_token_keyset_storage_full: ?bool = null,

    /// Include symmetric algorithms allowed by the subject.
    include_symmetric_algorithms: ?bool = null,
    ...
    no_security_extension: ?bool = null,

    /// Delete expired or revoked certificates instead of archiving them.
    remove_invalid_certificate_from_personal_store: ?bool = null,
