...
pub const UpdateTemplateGroupAccessControlEntryOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateTemplateGroupAccessControlEntryInput, options: CallOptions) !UpdateTemplateGroupAccessControlEntryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateTemplateGroupAccessControlEntryInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateTemplateGroupAccessControlEntryOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
