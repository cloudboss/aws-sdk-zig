...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeClusterV2Input, options: CallOptions) !DescribeClusterV2Output {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeClusterV2Input, config: *aws.Config) !aws.http.Request {
