...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTopicPartitionsInput, options: CallOptions) !DescribeTopicPartitionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTopicPartitionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/partitions");
