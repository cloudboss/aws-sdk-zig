...
pub const DescribeTopicPartitionsPaginator = struct {
    client: *Client,
    params: describe_topic_partitions.DescribeTopicPartitionsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_topic_partitions.DescribeTopicPartitionsOutput {
        if (self.done) {
...
pub const ListClientVpcConnectionsPaginator = struct {
    client: *Client,
    params: list_client_vpc_connections.ListClientVpcConnectionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_client_vpc_connections.ListClientVpcConnectionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListClusterOperationsPaginator = struct {
    client: *Client,
    params: list_cluster_operations.ListClusterOperationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_cluster_operations.ListClusterOperationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListClusterOperationsV2Paginator = struct {
    client: *Client,
    params: list_cluster_operations_v2.ListClusterOperationsV2Input,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_cluster_operations_v2.ListClusterOperationsV2Output {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListClustersV2Paginator = struct {
    client: *Client,
    params: list_clusters_v2.ListClustersV2Input,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_clusters_v2.ListClustersV2Output {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListConfigurationRevisionsPaginator = struct {
    client: *Client,
    params: list_configuration_revisions.ListConfigurationRevisionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_configuration_revisions.ListConfigurationRevisionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListKafkaVersionsPaginator = struct {
    client: *Client,
    params: list_kafka_versions.ListKafkaVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_kafka_versions.ListKafkaVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListReplicatorsPaginator = struct {
    client: *Client,
    params: list_replicators.ListReplicatorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_replicators.ListReplicatorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListScramSecretsPaginator = struct {
    client: *Client,
    params: list_scram_secrets.ListScramSecretsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_scram_secrets.ListScramSecretsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListVpcConnectionsPaginator = struct {
    client: *Client,
    params: list_vpc_connections.ListVpcConnectionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_vpc_connections.ListVpcConnectionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
