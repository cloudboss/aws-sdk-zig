...
pub const RejectAgreementCancellationRequestInput = struct {
...
pub const RejectAgreementCancellationRequestOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectAgreementCancellationRequestInput, options: CallOptions) !RejectAgreementCancellationRequestOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RejectAgreementCancellationRequestInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSMPCommerceService_v20200301.RejectAgreementCancellationRequest");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RejectAgreementCancellationRequestOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(RejectAgreementCancellationRequestOutput, body, allocator);
}
