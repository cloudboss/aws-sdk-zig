...
pub const ListAgreementCancellationRequestsPaginator = struct {
    client: *Client,
    params: list_agreement_cancellation_requests.ListAgreementCancellationRequestsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agreement_cancellation_requests.ListAgreementCancellationRequestsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAgreementInvoiceLineItemsPaginator = struct {
    client: *Client,
    params: list_agreement_invoice_line_items.ListAgreementInvoiceLineItemsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agreement_invoice_line_items.ListAgreementInvoiceLineItemsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAgreementPaymentRequestsPaginator = struct {
    client: *Client,
    params: list_agreement_payment_requests.ListAgreementPaymentRequestsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_agreement_payment_requests.ListAgreementPaymentRequestsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListBillingAdjustmentRequestsPaginator = struct {
    client: *Client,
    params: list_billing_adjustment_requests.ListBillingAdjustmentRequestsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,

    const Self = @This();

    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_billing_adjustment_requests.ListBillingAdjustmentRequestsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
