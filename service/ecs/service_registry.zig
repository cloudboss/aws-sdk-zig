...
/// ECS
/// starts a new deployment. New tasks are registered and deregistered to the
/// updated
/// service registry configuration.
pub const ServiceRegistry = struct {
    /// The container name value to be used for your service discovery service. It's
    /// already
    /// specified in the task definition. If the task definition that your service
    /// task
    ...
    /// specified
    /// in the task definition. If the task definition your service task specifies
    /// uses the
    ...
    /// supported
    /// service registry is Cloud Map. For more information, see
