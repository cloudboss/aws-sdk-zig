...
pub const DescribeTaskDefinitionInput = struct {
    ...
    /// specific revision in the family, or full Amazon Resource Name (ARN) of the
    /// task
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTaskDefinitionInput, options: Options) !DescribeTaskDefinitionOutput {
