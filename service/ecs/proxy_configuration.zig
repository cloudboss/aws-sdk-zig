...
const ProxyConfigurationType = @import("proxy_configuration_type.zig").ProxyConfigurationType;
...
/// the `ecs-init` package to use a proxy configuration. If your container
...
pub const ProxyConfiguration = struct {
    ...
    ///   defined by the `user` parameter in a container definition. This is used to
    ///   ensure the proxy ignores its own traffic. If `IgnoredUID` is specified,
    ///   this field can be empty.
