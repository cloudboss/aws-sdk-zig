...
/// For more information, see [Restart individual containers in Amazon ECS tasks
/// with container restart
/// policies](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/container-restart-policy.html) in the *Amazon Elastic Container Service Developer Guide*.
pub const ContainerRestartPolicy = struct {
    ...
    /// 1800 seconds. By default, a container must run for 300 seconds before it can
    /// be restarted.
