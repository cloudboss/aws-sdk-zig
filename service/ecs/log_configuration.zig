...
///   the
/// Docker daemon. Additional log drivers may be available in future releases of
/// the
...
pub const LogConfiguration = struct {
    ...
    /// Amazon ECS logs to
    /// CloudWatch](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using_awslogs.html) in the *Amazon Elastic Container
    ...
    /// with that driver. We
    /// encourage you to submit pull requests for changes that you would like to
    /// have
    ...
    /// For more information, see [Preventing log loss with non-blocking mode in the
    /// `awslogs`
    /// container log
    ...
    /// mode](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-settings.html#default-log-driver-mode) in the *Amazon Elastic
    ...
    /// are buffered in memory, before being sent to the log router container. It
    /// can help to
    /// resolve potential log loss issue because high throughput might result in
    /// memory running
