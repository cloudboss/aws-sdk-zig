...
pub const ListAccountSettingsPaginator = struct {
    client: *Client,
    params: list_account_settings.ListAccountSettingsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_account_settings.Options) !list_account_settings.ListAccountSettingsOutput {
        if (self.done) {
...
pub const ListAttributesPaginator = struct {
    client: *Client,
    params: list_attributes.ListAttributesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_attributes.Options) !list_attributes.ListAttributesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListContainerInstancesPaginator = struct {
    client: *Client,
    params: list_container_instances.ListContainerInstancesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_container_instances.Options) !list_container_instances.ListContainerInstancesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListServicesByNamespacePaginator = struct {
    client: *Client,
    params: list_services_by_namespace.ListServicesByNamespaceInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_services_by_namespace.Options) !list_services_by_namespace.ListServicesByNamespaceOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTaskDefinitionFamiliesPaginator = struct {
    client: *Client,
    params: list_task_definition_families.ListTaskDefinitionFamiliesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_task_definition_families.Options) !list_task_definition_families.ListTaskDefinitionFamiliesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTaskDefinitionsPaginator = struct {
    client: *Client,
    params: list_task_definitions.ListTaskDefinitionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_task_definitions.Options) !list_task_definitions.ListTaskDefinitionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
