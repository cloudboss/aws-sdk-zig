...
/// can modify
/// the infrastructure role, instance launch template, and tag propagation
/// settings. Changes
...
pub const UpdateManagedInstancesProviderConfiguration = struct {
    ...
    /// role must
    /// have the necessary permissions to manage instances and access required
    /// Amazon Web Services
    /// services.
    ///
    ...
    /// affect new
    /// instances launched after the update, while existing instances continue to
    /// use their
