...
/// uses this
/// configuration to automatically launch, manage, and terminate Amazon EC2
/// instances on
/// your behalf. Managed instances provide access to the full range of Amazon
/// EC2 instance
...
pub const ManagedInstancesProvider = struct {
    ...
    /// assumes to
    /// manage instances. This role must include permissions for Amazon EC2 instance
    /// lifecycle
    /// management, networking, and any additional Amazon Web Services services
    /// required for your
    /// workloads.
    ///
    ...
    /// configuration,
    /// and instance requirements that determine which Amazon EC2 instance types can
    /// be
    /// used.
    ///
