...
pub const TagResourceInput = struct {
    ...
    /// ECS short service ARN to a long
    /// ARN](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-arn-migration.html) in the *Amazon Elastic
...
fn serializeRequest(alloc: std.mem.Allocator, input: TagResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonEC2ContainerServiceV20141113.TagResource");
