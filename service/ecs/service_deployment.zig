...
/// deployments](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-deployment.html) in the *
/// Amazon
...
pub const ServiceDeployment = struct {
    ...
    lifecycle_stage: ?ServiceDeploymentLifecycleStage,
    ...
    source_service_revisions: ?[]const ServiceRevisionSummary,
    ...
    target_service_revision: ?ServiceRevisionSummary,
