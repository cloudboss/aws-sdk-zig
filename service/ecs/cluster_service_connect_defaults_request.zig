...
pub const ClusterServiceConnectDefaultsRequest = struct {
    ...
    /// The name is case-sensitive. The name can't include greater than (>), less
    /// than (<), double quotation marks ("), or slash (/).
    ///
    ...
    /// namespace will remain in Cloud Map and must be deleted separately.
    ///
    /// For more information about Cloud Map, see [Working with
    /// Services](https://docs.aws.amazon.com/cloud-map/latest/dg/working-with-services.html) in the *Cloud Map Developer Guide*.
    namespace: []const u8,
