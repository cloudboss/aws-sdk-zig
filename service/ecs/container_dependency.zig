const ContainerCondition = @import("container_condition.zig").ContainerCondition;

/// The dependencies defined for container startup and shutdown. A container can
/// contain
/// multiple dependencies. When a dependency is defined for container startup,
/// for container
/// shutdown it is reversed.
///
/// Your Amazon ECS container instances require at least version 1.26.0 of the
/// container
/// agent to use container dependencies. However, we recommend using the latest
/// container
/// agent version. For information about checking your agent version and
/// updating to the
/// latest version, see [Updating the Amazon ECS
/// Container
/// Agent](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-update.html) in the *Amazon Elastic Container Service Developer
