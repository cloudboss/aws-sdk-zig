...
/// service deployment will fail if the service can't reach a steady state. If
/// it is turned
/// on, a service deployment will transition to a failed state and stop
/// launching new tasks.
/// You can also configure Amazon ECS to roll back your service to the last
/// completed
