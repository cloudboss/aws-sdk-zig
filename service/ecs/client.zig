...
const delete_daemon = @import("delete_daemon.zig");
const delete_daemon_task_definition = @import("delete_daemon_task_definition.zig");
...
const describe_daemon_deployments = @import("describe_daemon_deployments.zig");
const describe_daemon_revisions = @import("describe_daemon_revisions.zig");
...
const list_daemon_deployments = @import("list_daemon_deployments.zig");
const list_daemon_task_definitions = @import("list_daemon_task_definitions.zig");
const list_daemons = @import("list_daemons.zig");
...
const register_daemon_task_definition = @import("register_daemon_task_definition.zig");
...
const update_daemon = @import("update_daemon.zig");
...
pub const Client = struct {
    ...
    /// auto scaling. You can create capacity providers for Amazon ECS Managed
    /// Instances and EC2 instances. Fargate has the predefined `FARGATE` and
    ...
    /// Capacity Providers.
    pub fn createDaemon(self: *Self, allocator: std.mem.Allocator, input: create_daemon.CreateDaemonInput, options: CallOptions) !create_daemon.CreateDaemonOutput {
        return create_daemon.execute(self, allocator, input, options);
    }
    ...
    /// This operation provisions and configures Application Load Balancers, target
    /// groups, security groups, and auto-scaling policies automatically.
    ///
    ...
    /// cluster. To update an existing service, use
    ...
    /// supported for REPLICA service and not DAEMON service. For more information,
    /// see [Amazon EBS
    /// volumes](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ebs-volumes.html#ebs-volume-types) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    ...
    ///   concepts](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_services.html) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    ///   task placement constraints for running tasks. It also stops tasks that
    ///   don't meet the placement constraints. When using this strategy, you don't
    ///   need to specify a desired number of tasks, a task placement strategy, or
    ///   use Service Auto Scaling policies. For more information, see [Amazon ECS
    ///   services](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs_services.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    ...
    /// can choose between the following deployment strategies (which you can set in
    /// the “`strategy`” field in “`deploymentConfiguration`”): :
    ///
    ...
    ///   controlled by the service deployment configuration. For more information,
    ///   see [Deploy Amazon ECS services by replacing
    ///   tasks](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-type-ecs.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    ...
    ///   balancer, Application Load Balancer, Network Load Balancer, or Service
    ///   Connect (which are required for blue/green deployments).
    ...
    ///
    /// Rolling updates are the default deployment strategy for services and provide
    /// a balance between deployment safety and resource efficiency for many common
    ...
    ///   more information, see [Amazon ECS blue/green
    ///   deployments](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-type-blue-green.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    ...
    /// using the
    /// [CreateTaskSet](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_CreateTaskSet.html). For more information, see [Amazon ECS deployment types](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-types.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    /// When the service scheduler launches new tasks, it determines task placement.
    /// For information about task placement and task placement strategies, see
    /// [Amazon ECS task
    /// placement](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-placement.html) in the *Amazon Elastic Container Service Developer Guide*
    ...
    /// [Amazon ECS service
    /// quotas](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-quotas.html) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    /// the future. We don't recommend that you rely on `INACTIVE` clusters
    /// persisting.
    ///
    ...
    /// provisions new instances without the deleted daemon. Amazon ECS
    /// automatically launches replacement tasks for your Amazon ECS services.
    ///
    /// ECS Managed Daemons is only supported for Amazon ECS Managed Instances
    /// Capacity Providers.
    pub fn deleteDaemon(self: *Self, allocator: std.mem.Allocator, input: delete_daemon.DeleteDaemonInput, options: CallOptions) !delete_daemon.DeleteDaemonOutput {
        return delete_daemon.execute(self, allocator, input, options);
    }

    /// Deletes the specified daemon task definition. After a daemon task definition
    /// is deleted, no new daemons can be created using this definition. Existing
    /// daemons that reference the deleted daemon task definition continue to run.
    ///
    /// A daemon task definition must be in an `ACTIVE` state to be deleted.
    pub fn deleteDaemonTaskDefinition(self: *Self, allocator: std.mem.Allocator, input: delete_daemon_task_definition.DeleteDaemonTaskDefinitionInput, options: CallOptions) !delete_daemon_task_definition.DeleteDaemonTaskDefinitionOutput {
        return delete_daemon_task_definition.execute(self, allocator, input, options);
    }
    ...
    /// from the `INACTIVE` to `DELETE_IN_PROGRESS`. Existing tasks and services
    /// that reference a `DELETE_IN_PROGRESS` task definition revision continue to
    /// run without disruption. Existing services that reference a
    /// `DELETE_IN_PROGRESS` task definition revision can still scale up or down by
    ...
    /// reference a `DELETE_IN_PROGRESS` task definition revision.
    ///
    ...
    /// If a task definition revisions are in the `DELETE_IN_PROGRESS` state, the
    /// task definition name is displayed in the console and returned in the API.
    /// The task definition name is retained by Amazon ECS and the revision is
    ...
    /// it doesn't terminate the EC2 instance. If you are finished using the
    ...
    /// following deregistration where these restrictions have not yet taken effect.
    ///
    ...
    pub fn describeDaemon(self: *Self, allocator: std.mem.Allocator, input: describe_daemon.DescribeDaemonInput, options: CallOptions) !describe_daemon.DescribeDaemonOutput {
        return describe_daemon.execute(self, allocator, input, options);
    }
    ...
    /// providers. Each deployment includes circuit breaker and alarm-based rollback
    /// capabilities.
    pub fn describeDaemonDeployments(self: *Self, allocator: std.mem.Allocator, input: describe_daemon_deployments.DescribeDaemonDeploymentsInput, options: CallOptions) !describe_daemon_deployments.DescribeDaemonDeploymentsOutput {
        return describe_daemon_deployments.execute(self, allocator, input, options);
    }
    ...
    /// immutable.
    pub fn describeDaemonRevisions(self: *Self, allocator: std.mem.Allocator, input: describe_daemon_revisions.DescribeDaemonRevisionsInput, options: CallOptions) !describe_daemon_revisions.DescribeDaemonRevisionsOutput {
        return describe_daemon_revisions.execute(self, allocator, input, options);
    }

    /// Describes a daemon task definition. You can specify a `family` and
    /// `revision` to find information about a specific daemon task definition, or
    /// you can simply specify the family to find the latest `ACTIVE` revision in
    /// that family.
    pub fn describeDaemonTaskDefinition(self: *Self, allocator: std.mem.Allocator, input: describe_daemon_task_definition.DescribeDaemonTaskDefinitionInput, options: CallOptions) !describe_daemon_task_definition.DescribeDaemonTaskDefinitionOutput {
        return describe_daemon_task_definition.execute(self, allocator, input, options);
    }
    ...
    /// the Amazon ECS resources (for example, task definition) and the environment
    /// resources (for example, load balancers, subnets, and security groups). For
    ...
    /// find information about a specific task definition, or you can simply specify
    ...
    /// Amazon ECS Exec for
    /// debugging](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-exec.html) in the *Amazon ECS Developer Guide*.
    ...
    /// returns a list of attribute objects, one for each attribute on each
    /// resource. You can filter the list of results to a single attribute name to
    /// only return results that have that name. You can also filter the results by
    /// attribute name and value. You can do this, for example, to see which
    ...
    /// Returns a list of daemon deployments for a specified daemon. You can filter
    /// the results by status or creation time.
    pub fn listDaemonDeployments(self: *Self, allocator: std.mem.Allocator, input: list_daemon_deployments.ListDaemonDeploymentsInput, options: CallOptions) !list_daemon_deployments.ListDaemonDeploymentsOutput {
        return list_daemon_deployments.execute(self, allocator, input, options);
    }
    ...
    /// daemon task definitions that match your criteria.
    pub fn listDaemonTaskDefinitions(self: *Self, allocator: std.mem.Allocator, input: list_daemon_task_definitions.ListDaemonTaskDefinitionsInput, options: CallOptions) !list_daemon_task_definitions.ListDaemonTaskDefinitionsOutput {
        return list_daemon_task_definitions.execute(self, allocator, input, options);
    }

    /// Returns a list of daemons. You can filter the results by cluster or capacity
    /// provider.
    pub fn listDaemons(self: *Self, allocator: std.mem.Allocator, input: list_daemons.ListDaemonsInput, options: CallOptions) !list_daemons.ListDaemonsOutput {
        return list_daemons.execute(self, allocator, input, options);
    }
    ...
    /// Settings](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-settings.html) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    /// [DeleteAttributes](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_DeleteAttributes.html). For more information, see [Attributes](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-placement-constraints.html#attributes) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    /// existing capacity providers that are associated with a cluster that are
    /// omitted from a
    /// [PutClusterCapacityProviders](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_PutClusterCapacityProviders.html) API call will be disassociated with the cluster. You can only disassociate an existing capacity provider from a cluster if it's not being used by any existing tasks.
    ///
    ...
    /// only within the specified cluster.
    ...
    /// containers with the `volumes` parameter. For more information, see [Daemon
    /// task
    /// definitions](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/daemon-task-definitions.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    /// A daemon task definition is a template that describes the containers that
    /// form a daemon. Daemons deploy cross-cutting software agents such as security
    ...
    /// daemon task definition is created. You can't modify a revision after you
    /// register it.
    pub fn registerDaemonTaskDefinition(self: *Self, allocator: std.mem.Allocator, input: register_daemon_task_definition.RegisterDaemonTaskDefinitionInput, options: CallOptions) !register_daemon_task_definition.RegisterDaemonTaskDefinitionOutput {
        return register_daemon_task_definition.execute(self, allocator, input, options);
    }
    ...
    /// services that are specified in the policy that's associated with the role.
    ...
    /// Tasks](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/scheduling_tasks.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    ...
    /// processed due to conflicts. The provided `clientToken` is already in use
    /// with a different `RunTask` request. The `resourceIds` are the existing task
    /// ARNs which are already associated with the `clientToken`.
    ///
    /// To fix this issue:
    ///
    ...
    /// because you use managed scaling and there is a capacity error because the
    ...
    /// deployments](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/stop-service-deployment.html) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    /// issued to the containers running in the task. This results in a stop signal
    /// value and a default 30-second timeout, after which the `SIGKILL` value is
    /// sent and the containers are forcibly stopped. This signal can be defined in
    /// your container image with the `STOPSIGNAL` instruction and will default to
    /// `SIGTERM`. If the container handles the `SIGTERM` value gracefully and exits
    ...
    /// agent](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/agent-update-ecs-ami.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    ...
    /// agent](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-agent-update.html#manually_update_agent) in the *Amazon Elastic Container Service Developer Guide*.
    ...
    /// deployment configuration of your service using
    /// [UpdateService](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_UpdateService.html).
    ///
    ...
    ///   if they're in the `RUNNING` state and are reported as healthy by the load
    ///   balancer.
    ...
    /// to `ACTIVE` status and once it has reached that status the Amazon ECS
    ...
    /// triggered that progressively rolls out the changes to the container
    /// instances associated with the daemon's capacity providers. For more
    /// information, see [Daemon
    /// deployments](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/daemon-deployments.html) in the *Amazon Elastic Container Service Developer Guide*.
    ///
    /// Amazon ECS drains existing container instances and provisions new instances
    /// with the updated daemon. Amazon ECS automatically launches replacement tasks
    /// for your services.
    ///
    ...
    /// ECS Managed Daemons is only supported for Amazon ECS Managed Instances
    /// Capacity Providers.
    pub fn updateDaemon(self: *Self, allocator: std.mem.Allocator, input: update_daemon.UpdateDaemonInput, options: CallOptions) !update_daemon.UpdateDaemonOutput {
        return update_daemon.execute(self, allocator, input, options);
    }
    ...
    /// parameters without recreating the service.
    ///
    ...
    /// task placement constraints and strategies, and task definition. When you
    ...
    /// task placement constraints and strategies, enable ECS managed tags option,
    ...
    /// be updated, create a new CodeDeploy deployment. For more information, see
    ...
    ///   batch size. For example, if `desiredCount` is four tasks, a maximum of
    ///   200% starts four new tasks before stopping the four older tasks (provided
    ...
    /// set the `expiresInMinutes` property. The `expiresInMinutes` property is
    /// always reset when you invoke this operation for a task that already has
    /// `protectionEnabled` set to `true`. You can keep extending the protection
    /// expiration period of a task by invoking this operation repeatedly.
    ///
    /// To learn more about Amazon ECS task protection, see [Task scale-in
    /// protection](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-scale-in-protection.html) in the * Amazon Elastic Container Service Developer Guide* .
    ///
    ...
    pub fn waitUntilDaemonActive(self: *Self, params: describe_daemon.DescribeDaemonInput) aws.waiter.WaiterError!void {
        var w = waiters.DaemonActiveWaiter{ .client = self, .params = params };
        return w.wait();
    }

    pub fn waitUntilDaemonTaskDefinitionActive(self: *Self, params: describe_daemon_task_definition.DescribeDaemonTaskDefinitionInput) aws.waiter.WaiterError!void {
        var w = waiters.DaemonTaskDefinitionActiveWaiter{ .client = self, .params = params };
        return w.wait();
    }

    pub fn waitUntilDaemonTaskDefinitionDeleted(self: *Self, params: describe_daemon_task_definition.DescribeDaemonTaskDefinitionInput) aws.waiter.WaiterError!void {
        var w = waiters.DaemonTaskDefinitionDeletedWaiter{ .client = self, .params = params };
        return w.wait();
    }
};
