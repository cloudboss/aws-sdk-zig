...
/// starts a new
/// deployment with the updated Elastic Load Balancing configuration. This
/// causes tasks to
...
/// service-linked
/// roles](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/using-service-linked-roles.html) in the *Amazon Elastic Container Service
/// Developer Guide*.
pub const LoadBalancer = struct {
    ...
    /// service](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/register-multiple-targetgroups.html) in
