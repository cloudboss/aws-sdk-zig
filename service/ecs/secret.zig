...
pub const Secret = struct {
    ...
    /// permissions,
    /// see [Required IAM permissions for Amazon ECS
    /// secrets](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data-secrets.html#secrets-iam) (for Secrets Manager) or
    /// [Required IAM permissions for Amazon ECS
    /// secrets](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/specifying-sensitive-data-parameters.html) (for Systems Manager
    ...
    /// you're
    /// launching, then you can use either the full ARN or name of the parameter. If
    /// the
