...
/// configuration for a
/// container defined in the task definition. For more detailed information
/// about these
...
/// latest behavior, see [Docker Compose: order of cap_drop and
/// cap_add](https://forums.docker.com/t/docker-compose-order-of-cap-drop-and-cap-add/97136/1) in the Docker Community
/// Forum.
///
...
/// parameter are both empty, the capabilities the container capabilities are
/// all of
