...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListRoutingControlsInput, options: Options) !ListRoutingControlsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListRoutingControlsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "ToggleCustomerAPI.ListRoutingControls");
