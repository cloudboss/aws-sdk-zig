...
fn serializeRequest(alloc: std.mem.Allocator, input: RegisterStreamConsumerInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Kinesis_20131202.RegisterStreamConsumer");
