...
pub const DecreaseStreamRetentionPeriodInput = struct {
...
pub const DecreaseStreamRetentionPeriodOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DecreaseStreamRetentionPeriodInput, options: CallOptions) !DecreaseStreamRetentionPeriodOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DecreaseStreamRetentionPeriodInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Kinesis_20131202.DecreaseStreamRetentionPeriod");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DecreaseStreamRetentionPeriodOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
