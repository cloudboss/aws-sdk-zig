...
const StopStreamEncryptionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopStreamEncryptionInput, options: Options) !StopStreamEncryptionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StopStreamEncryptionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Kinesis_20131202.StopStreamEncryption");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopStreamEncryptionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
