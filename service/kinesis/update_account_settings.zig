...
const MinimumThroughputBillingCommitmentInput = @import("minimum_throughput_billing_commitment_input.zig").MinimumThroughputBillingCommitmentInput;
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateAccountSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Kinesis_20131202.UpdateAccountSettings");
