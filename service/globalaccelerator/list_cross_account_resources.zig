...
const CrossAccountResource = @import("cross_account_resource.zig").CrossAccountResource;

pub const ListCrossAccountResourcesInput = struct {
    ...
    resource_owner_aws_account_id: []const u8,

    pub const json_field_names = .{
        .accelerator_arn = "AcceleratorArn",
        .max_results = "MaxResults",
        .next_token = "NextToken",
        .resource_owner_aws_account_id = "ResourceOwnerAwsAccountId",
    };
};

pub const ListCrossAccountResourcesOutput = struct {
    /// The cross-account resources used with an accelerator.
    cross_account_resources: ?[]const CrossAccountResource = null,
    ...
    pub const json_field_names = .{
        .cross_account_resources = "CrossAccountResources",
        .next_token = "NextToken",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCrossAccountResourcesInput, options: CallOptions) !ListCrossAccountResourcesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListCrossAccountResourcesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.ListCrossAccountResources");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListCrossAccountResourcesOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListCrossAccountResourcesOutput, body, allocator);
}
