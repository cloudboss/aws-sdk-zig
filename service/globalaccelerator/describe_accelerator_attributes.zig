...
pub const DescribeAcceleratorAttributesInput = struct {
...
pub const DescribeAcceleratorAttributesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAcceleratorAttributesInput, options: CallOptions) !DescribeAcceleratorAttributesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeAcceleratorAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DescribeAcceleratorAttributes");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeAcceleratorAttributesOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeAcceleratorAttributesOutput, body, allocator);
}
