...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCustomRoutingEndpointGroupsInput, options: Options) !ListCustomRoutingEndpointGroupsOutput {
