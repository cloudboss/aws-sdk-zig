...
pub const UpdateCustomRoutingAcceleratorInput = struct {
...
pub const UpdateCustomRoutingAcceleratorOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCustomRoutingAcceleratorInput, options: CallOptions) !UpdateCustomRoutingAcceleratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateCustomRoutingAcceleratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.UpdateCustomRoutingAccelerator");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateCustomRoutingAcceleratorOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(UpdateCustomRoutingAcceleratorOutput, body, allocator);
}
