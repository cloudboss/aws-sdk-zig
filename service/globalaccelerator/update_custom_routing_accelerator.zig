...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateCustomRoutingAcceleratorInput, options: Options) !UpdateCustomRoutingAcceleratorOutput {
