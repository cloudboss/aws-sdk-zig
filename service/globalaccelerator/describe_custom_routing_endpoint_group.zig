...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomRoutingEndpointGroupInput, options: Options) !DescribeCustomRoutingEndpointGroupOutput {
