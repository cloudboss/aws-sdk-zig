...
pub const DescribeCustomRoutingEndpointGroupInput = struct {
...
pub const DescribeCustomRoutingEndpointGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomRoutingEndpointGroupInput, options: CallOptions) !DescribeCustomRoutingEndpointGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCustomRoutingEndpointGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DescribeCustomRoutingEndpointGroup");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCustomRoutingEndpointGroupOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeCustomRoutingEndpointGroupOutput, body, allocator);
}
