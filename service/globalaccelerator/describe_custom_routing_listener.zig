...
pub const DescribeCustomRoutingListenerInput = struct {
...
pub const DescribeCustomRoutingListenerOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomRoutingListenerInput, options: CallOptions) !DescribeCustomRoutingListenerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCustomRoutingListenerInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DescribeCustomRoutingListener");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCustomRoutingListenerOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeCustomRoutingListenerOutput, body, allocator);
}
