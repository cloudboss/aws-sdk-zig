...
pub const DeleteCrossAccountAttachmentInput = struct {
...
pub const DeleteCrossAccountAttachmentOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCrossAccountAttachmentInput, options: CallOptions) !DeleteCrossAccountAttachmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCrossAccountAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DeleteCrossAccountAttachment");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCrossAccountAttachmentOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
