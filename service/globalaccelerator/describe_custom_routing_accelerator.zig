...
pub const DescribeCustomRoutingAcceleratorInput = struct {
...
pub const DescribeCustomRoutingAcceleratorOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomRoutingAcceleratorInput, options: CallOptions) !DescribeCustomRoutingAcceleratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCustomRoutingAcceleratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DescribeCustomRoutingAccelerator");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCustomRoutingAcceleratorOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeCustomRoutingAcceleratorOutput, body, allocator);
}
