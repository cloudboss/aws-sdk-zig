...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCustomRoutingAcceleratorInput, options: Options) !DescribeCustomRoutingAcceleratorOutput {
