...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCustomRoutingPortMappingsByDestinationInput, options: Options) !ListCustomRoutingPortMappingsByDestinationOutput {
