...
pub const DeleteEndpointGroupInput = struct {
...
pub const DeleteEndpointGroupOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEndpointGroupInput, options: CallOptions) !DeleteEndpointGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEndpointGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DeleteEndpointGroup");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEndpointGroupOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
