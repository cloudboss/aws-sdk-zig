...
pub const RemoveCustomRoutingEndpointsInput = struct {
...
pub const RemoveCustomRoutingEndpointsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveCustomRoutingEndpointsInput, options: CallOptions) !RemoveCustomRoutingEndpointsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveCustomRoutingEndpointsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.RemoveCustomRoutingEndpoints");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RemoveCustomRoutingEndpointsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
