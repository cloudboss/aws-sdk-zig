...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCrossAccountAttachmentInput, options: Options) !DescribeCrossAccountAttachmentOutput {
