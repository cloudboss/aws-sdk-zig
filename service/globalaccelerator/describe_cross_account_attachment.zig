...
pub const DescribeCrossAccountAttachmentInput = struct {
...
pub const DescribeCrossAccountAttachmentOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeCrossAccountAttachmentInput, options: CallOptions) !DescribeCrossAccountAttachmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeCrossAccountAttachmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DescribeCrossAccountAttachment");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeCrossAccountAttachmentOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeCrossAccountAttachmentOutput, body, allocator);
}
