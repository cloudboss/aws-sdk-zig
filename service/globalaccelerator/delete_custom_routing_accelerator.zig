...
pub const DeleteCustomRoutingAcceleratorInput = struct {
...
pub const DeleteCustomRoutingAcceleratorOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomRoutingAcceleratorInput, options: CallOptions) !DeleteCustomRoutingAcceleratorOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCustomRoutingAcceleratorInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DeleteCustomRoutingAccelerator");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCustomRoutingAcceleratorOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
