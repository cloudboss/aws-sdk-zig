...
pub const DeleteCustomRoutingListenerInput = struct {
...
pub const DeleteCustomRoutingListenerOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteCustomRoutingListenerInput, options: CallOptions) !DeleteCustomRoutingListenerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteCustomRoutingListenerInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "GlobalAccelerator_V20180706.DeleteCustomRoutingListener");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteCustomRoutingListenerOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
