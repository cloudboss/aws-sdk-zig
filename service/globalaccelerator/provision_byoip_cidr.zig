...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ProvisionByoipCidrInput, options: Options) !ProvisionByoipCidrOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ProvisionByoipCidrInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "GlobalAccelerator_V20180706.ProvisionByoipCidr");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ProvisionByoipCidrOutput {
    ...
    return aws.json.parseJsonObject(ProvisionByoipCidrOutput, body, alloc);
}
