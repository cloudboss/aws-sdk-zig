...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCrossAccountResourceAccountsInput, options: Options) !ListCrossAccountResourceAccountsOutput {
