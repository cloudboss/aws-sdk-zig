...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeprovisionByoipCidrInput, options: Options) !DeprovisionByoipCidrOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeprovisionByoipCidrInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "GlobalAccelerator_V20180706.DeprovisionByoipCidr");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeprovisionByoipCidrOutput {
    ...
    return aws.json.parseJsonObject(DeprovisionByoipCidrOutput, body, alloc);
}
