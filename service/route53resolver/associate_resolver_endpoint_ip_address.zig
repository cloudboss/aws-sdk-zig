...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateResolverEndpointIpAddressInput, options: Options) !AssociateResolverEndpointIpAddressOutput {
