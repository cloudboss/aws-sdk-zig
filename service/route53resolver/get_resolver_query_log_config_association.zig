...
pub const GetResolverQueryLogConfigAssociationInput = struct {
    /// The ID of the Resolver query logging configuration association that you want
    /// to get information about.
    resolver_query_log_config_association_id: []const u8,
...
pub const GetResolverQueryLogConfigAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetResolverQueryLogConfigAssociationInput, options: CallOptions) !GetResolverQueryLogConfigAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetResolverQueryLogConfigAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.GetResolverQueryLogConfigAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetResolverQueryLogConfigAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetResolverQueryLogConfigAssociationOutput, body, allocator);
}
