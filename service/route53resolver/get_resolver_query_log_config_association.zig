...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetResolverQueryLogConfigAssociationInput, options: Options) !GetResolverQueryLogConfigAssociationOutput {
