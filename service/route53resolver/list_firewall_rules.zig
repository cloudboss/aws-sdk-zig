...
pub const ListFirewallRulesInput = @import("list_firewall_rules_request.zig").ListFirewallRulesRequest;

pub const ListFirewallRulesOutput = @import("list_firewall_rules_response.zig").ListFirewallRulesResponse;
