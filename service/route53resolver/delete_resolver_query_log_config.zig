...
pub const DeleteResolverQueryLogConfigInput = struct {
...
pub const DeleteResolverQueryLogConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteResolverQueryLogConfigInput, options: CallOptions) !DeleteResolverQueryLogConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteResolverQueryLogConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.DeleteResolverQueryLogConfig");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteResolverQueryLogConfigOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DeleteResolverQueryLogConfigOutput, body, allocator);
}
