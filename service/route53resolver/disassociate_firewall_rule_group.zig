...
pub const DisassociateFirewallRuleGroupInput = struct {
...
pub const DisassociateFirewallRuleGroupOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateFirewallRuleGroupInput, options: CallOptions) !DisassociateFirewallRuleGroupOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateFirewallRuleGroupInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.DisassociateFirewallRuleGroup");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateFirewallRuleGroupOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DisassociateFirewallRuleGroupOutput, body, allocator);
}
