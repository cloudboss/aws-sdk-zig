...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetResolverQueryLogConfigPolicyInput, options: Options) !GetResolverQueryLogConfigPolicyOutput {
