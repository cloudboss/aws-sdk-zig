...
pub const GetResolverQueryLogConfigPolicyInput = struct {
...
pub const GetResolverQueryLogConfigPolicyOutput = struct {
    ...
    resolver_query_log_config_policy: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetResolverQueryLogConfigPolicyInput, options: CallOptions) !GetResolverQueryLogConfigPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetResolverQueryLogConfigPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.GetResolverQueryLogConfigPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetResolverQueryLogConfigPolicyOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetResolverQueryLogConfigPolicyOutput, body, allocator);
}
