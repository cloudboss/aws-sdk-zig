...
pub const ListFirewallRuleGroupAssociationsInput = struct {
...
pub const ListFirewallRuleGroupAssociationsOutput = struct {
    /// A list of your firewall rule group associations.
    ///
    /// This might be a partial list of the associations that you have defined. For
    /// information, see `MaxResults`.
    firewall_rule_group_associations: ?[]const FirewallRuleGroupAssociation = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFirewallRuleGroupAssociationsInput, options: CallOptions) !ListFirewallRuleGroupAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFirewallRuleGroupAssociationsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.ListFirewallRuleGroupAssociations");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListFirewallRuleGroupAssociationsOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListFirewallRuleGroupAssociationsOutput, body, allocator);
}
