...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFirewallRuleGroupAssociationsInput, options: Options) !ListFirewallRuleGroupAssociationsOutput {
