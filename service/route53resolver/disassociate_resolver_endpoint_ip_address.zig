...
pub const DisassociateResolverEndpointIpAddressInput = struct {
...
pub const DisassociateResolverEndpointIpAddressOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateResolverEndpointIpAddressInput, options: CallOptions) !DisassociateResolverEndpointIpAddressOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateResolverEndpointIpAddressInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.DisassociateResolverEndpointIpAddress");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateResolverEndpointIpAddressOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DisassociateResolverEndpointIpAddressOutput, body, allocator);
}
