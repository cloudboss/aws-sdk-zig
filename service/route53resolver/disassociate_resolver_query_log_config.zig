...
pub const DisassociateResolverQueryLogConfigInput = struct {
...
pub const DisassociateResolverQueryLogConfigOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateResolverQueryLogConfigInput, options: CallOptions) !DisassociateResolverQueryLogConfigOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateResolverQueryLogConfigInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.DisassociateResolverQueryLogConfig");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateResolverQueryLogConfigOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DisassociateResolverQueryLogConfigOutput, body, allocator);
}
