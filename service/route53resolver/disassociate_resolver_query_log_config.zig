...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateResolverQueryLogConfigInput, options: Options) !DisassociateResolverQueryLogConfigOutput {
