...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateFirewallRuleGroupAssociationInput, options: Options) !UpdateFirewallRuleGroupAssociationOutput {
