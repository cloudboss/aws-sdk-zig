...
pub const Client = struct {
    ...
    pub fn associateResolverEndpointIpAddress(self: *Self, allocator: std.mem.Allocator, input: associate_resolver_endpoint_ip_address.AssociateResolverEndpointIpAddressInput, options: CallOptions) !associate_resolver_endpoint_ip_address.AssociateResolverEndpointIpAddressOutput {
    ...
    pub fn associateResolverQueryLogConfig(self: *Self, allocator: std.mem.Allocator, input: associate_resolver_query_log_config.AssociateResolverQueryLogConfigInput, options: CallOptions) !associate_resolver_query_log_config.AssociateResolverQueryLogConfigOutput {
    ...
    pub fn associateResolverRule(self: *Self, allocator: std.mem.Allocator, input: associate_resolver_rule.AssociateResolverRuleInput, options: CallOptions) !associate_resolver_rule.AssociateResolverRuleOutput {
    ...
    pub fn createFirewallRuleGroup(self: *Self, allocator: std.mem.Allocator, input: create_firewall_rule_group.CreateFirewallRuleGroupInput, options: CallOptions) !create_firewall_rule_group.CreateFirewallRuleGroupOutput {
    ...
    ///   for a VPC
    /// to your network.
    pub fn createResolverEndpoint(self: *Self, allocator: std.mem.Allocator, input: create_resolver_endpoint.CreateResolverEndpointInput, options: CallOptions) !create_resolver_endpoint.CreateResolverEndpointOutput {
    ...
    pub fn createResolverQueryLogConfig(self: *Self, allocator: std.mem.Allocator, input: create_resolver_query_log_config.CreateResolverQueryLogConfigInput, options: CallOptions) !create_resolver_query_log_config.CreateResolverQueryLogConfigOutput {
    ...
    pub fn createResolverRule(self: *Self, allocator: std.mem.Allocator, input: create_resolver_rule.CreateResolverRuleInput, options: CallOptions) !create_resolver_rule.CreateResolverRuleOutput {
    ...
    pub fn deleteFirewallRuleGroup(self: *Self, allocator: std.mem.Allocator, input: delete_firewall_rule_group.DeleteFirewallRuleGroupInput, options: CallOptions) !delete_firewall_rule_group.DeleteFirewallRuleGroupOutput {
    ...
    pub fn deleteResolverEndpoint(self: *Self, allocator: std.mem.Allocator, input: delete_resolver_endpoint.DeleteResolverEndpointInput, options: CallOptions) !delete_resolver_endpoint.DeleteResolverEndpointOutput {
    ...
    pub fn deleteResolverQueryLogConfig(self: *Self, allocator: std.mem.Allocator, input: delete_resolver_query_log_config.DeleteResolverQueryLogConfigInput, options: CallOptions) !delete_resolver_query_log_config.DeleteResolverQueryLogConfigOutput {
    ...
    pub fn deleteResolverRule(self: *Self, allocator: std.mem.Allocator, input: delete_resolver_rule.DeleteResolverRuleInput, options: CallOptions) !delete_resolver_rule.DeleteResolverRuleOutput {
    ...
    /// the VPC.
    pub fn disassociateFirewallRuleGroup(self: *Self, allocator: std.mem.Allocator, input: disassociate_firewall_rule_group.DisassociateFirewallRuleGroupInput, options: CallOptions) !disassociate_firewall_rule_group.DisassociateFirewallRuleGroupOutput {
    ...
    pub fn disassociateResolverEndpointIpAddress(self: *Self, allocator: std.mem.Allocator, input: disassociate_resolver_endpoint_ip_address.DisassociateResolverEndpointIpAddressInput, options: CallOptions) !disassociate_resolver_endpoint_ip_address.DisassociateResolverEndpointIpAddressOutput {
    ...
    pub fn disassociateResolverQueryLogConfig(self: *Self, allocator: std.mem.Allocator, input: disassociate_resolver_query_log_config.DisassociateResolverQueryLogConfigInput, options: CallOptions) !disassociate_resolver_query_log_config.DisassociateResolverQueryLogConfigOutput {
    ...
    pub fn disassociateResolverRule(self: *Self, allocator: std.mem.Allocator, input: disassociate_resolver_rule.DisassociateResolverRuleInput, options: CallOptions) !disassociate_resolver_rule.DisassociateResolverRuleOutput {
    ...
    pub fn getFirewallConfig(self: *Self, allocator: std.mem.Allocator, input: get_firewall_config.GetFirewallConfigInput, options: CallOptions) !get_firewall_config.GetFirewallConfigOutput {
    ...
    pub fn getFirewallRuleGroup(self: *Self, allocator: std.mem.Allocator, input: get_firewall_rule_group.GetFirewallRuleGroupInput, options: CallOptions) !get_firewall_rule_group.GetFirewallRuleGroupOutput {
    ...
    pub fn getFirewallRuleGroupAssociation(self: *Self, allocator: std.mem.Allocator, input: get_firewall_rule_group_association.GetFirewallRuleGroupAssociationInput, options: CallOptions) !get_firewall_rule_group_association.GetFirewallRuleGroupAssociationOutput {
    ...
    pub fn getFirewallRuleGroupPolicy(self: *Self, allocator: std.mem.Allocator, input: get_firewall_rule_group_policy.GetFirewallRuleGroupPolicyInput, options: CallOptions) !get_firewall_rule_group_policy.GetFirewallRuleGroupPolicyOutput {
    ...
    pub fn getOutpostResolver(self: *Self, allocator: std.mem.Allocator, input: get_outpost_resolver.GetOutpostResolverInput, options: CallOptions) !get_outpost_resolver.GetOutpostResolverOutput {
    ...
    pub fn getResolverConfig(self: *Self, allocator: std.mem.Allocator, input: get_resolver_config.GetResolverConfigInput, options: CallOptions) !get_resolver_config.GetResolverConfigOutput {
        return get_resolver_config.execute(self, allocator, input, options);
    }

    /// Gets DNSSEC validation information for a specified resource.
    pub fn getResolverDnssecConfig(self: *Self, allocator: std.mem.Allocator, input: get_resolver_dnssec_config.GetResolverDnssecConfigInput, options: CallOptions) !get_resolver_dnssec_config.GetResolverDnssecConfigOutput {
    ...
    pub fn getResolverEndpoint(self: *Self, allocator: std.mem.Allocator, input: get_resolver_endpoint.GetResolverEndpointInput, options: CallOptions) !get_resolver_endpoint.GetResolverEndpointOutput {
    ...
    pub fn getResolverQueryLogConfig(self: *Self, allocator: std.mem.Allocator, input: get_resolver_query_log_config.GetResolverQueryLogConfigInput, options: CallOptions) !get_resolver_query_log_config.GetResolverQueryLogConfigOutput {
    ...
    /// in that VPC.
    pub fn getResolverQueryLogConfigAssociation(self: *Self, allocator: std.mem.Allocator, input: get_resolver_query_log_config_association.GetResolverQueryLogConfigAssociationInput, options: CallOptions) !get_resolver_query_log_config_association.GetResolverQueryLogConfigAssociationOutput {
    ...
    pub fn getResolverQueryLogConfigPolicy(self: *Self, allocator: std.mem.Allocator, input: get_resolver_query_log_config_policy.GetResolverQueryLogConfigPolicyInput, options: CallOptions) !get_resolver_query_log_config_policy.GetResolverQueryLogConfigPolicyOutput {
    ...
    pub fn getResolverRule(self: *Self, allocator: std.mem.Allocator, input: get_resolver_rule.GetResolverRuleInput, options: CallOptions) !get_resolver_rule.GetResolverRuleOutput {
    ...
    pub fn getResolverRuleAssociation(self: *Self, allocator: std.mem.Allocator, input: get_resolver_rule_association.GetResolverRuleAssociationInput, options: CallOptions) !get_resolver_rule_association.GetResolverRuleAssociationOutput {
    ...
    pub fn getResolverRulePolicy(self: *Self, allocator: std.mem.Allocator, input: get_resolver_rule_policy.GetResolverRulePolicyInput, options: CallOptions) !get_resolver_rule_policy.GetResolverRulePolicyOutput {
    ...
    pub fn listFirewallConfigs(self: *Self, allocator: std.mem.Allocator, input: list_firewall_configs.ListFirewallConfigsInput, options: CallOptions) !list_firewall_configs.ListFirewallConfigsOutput {
    ...
    /// information, see `MaxResults`.
    pub fn listFirewallRuleGroupAssociations(self: *Self, allocator: std.mem.Allocator, input: list_firewall_rule_group_associations.ListFirewallRuleGroupAssociationsInput, options: CallOptions) !list_firewall_rule_group_associations.ListFirewallRuleGroupAssociationsOutput {
    ...
    /// information, see `MaxResults`.
    pub fn listFirewallRuleGroups(self: *Self, allocator: std.mem.Allocator, input: list_firewall_rule_groups.ListFirewallRuleGroupsInput, options: CallOptions) !list_firewall_rule_groups.ListFirewallRuleGroupsOutput {
    ...
    pub fn listOutpostResolvers(self: *Self, allocator: std.mem.Allocator, input: list_outpost_resolvers.ListOutpostResolversInput, options: CallOptions) !list_outpost_resolvers.ListOutpostResolversOutput {
    ...
    /// for your VPCs.
    pub fn listResolverConfigs(self: *Self, allocator: std.mem.Allocator, input: list_resolver_configs.ListResolverConfigsInput, options: CallOptions) !list_resolver_configs.ListResolverConfigsOutput {
    ...
    pub fn listResolverDnssecConfigs(self: *Self, allocator: std.mem.Allocator, input: list_resolver_dnssec_configs.ListResolverDnssecConfigsInput, options: CallOptions) !list_resolver_dnssec_configs.ListResolverDnssecConfigsOutput {
        return list_resolver_dnssec_configs.execute(self, allocator, input, options);
    }

    /// Gets the IP addresses for a specified Resolver endpoint.
    pub fn listResolverEndpointIpAddresses(self: *Self, allocator: std.mem.Allocator, input: list_resolver_endpoint_ip_addresses.ListResolverEndpointIpAddressesInput, options: CallOptions) !list_resolver_endpoint_ip_addresses.ListResolverEndpointIpAddressesOutput {
    ...
    pub fn listResolverEndpoints(self: *Self, allocator: std.mem.Allocator, input: list_resolver_endpoints.ListResolverEndpointsInput, options: CallOptions) !list_resolver_endpoints.ListResolverEndpointsOutput {
    ...
    /// configurations.
    pub fn listResolverQueryLogConfigAssociations(self: *Self, allocator: std.mem.Allocator, input: list_resolver_query_log_config_associations.ListResolverQueryLogConfigAssociationsInput, options: CallOptions) !list_resolver_query_log_config_associations.ListResolverQueryLogConfigAssociationsOutput {
    ...
    pub fn listResolverQueryLogConfigs(self: *Self, allocator: std.mem.Allocator, input: list_resolver_query_log_configs.ListResolverQueryLogConfigsInput, options: CallOptions) !list_resolver_query_log_configs.ListResolverQueryLogConfigsOutput {
    ...
    pub fn listResolverRuleAssociations(self: *Self, allocator: std.mem.Allocator, input: list_resolver_rule_associations.ListResolverRuleAssociationsInput, options: CallOptions) !list_resolver_rule_associations.ListResolverRuleAssociationsOutput {
    ...
    /// Services account.
    pub fn listResolverRules(self: *Self, allocator: std.mem.Allocator, input: list_resolver_rules.ListResolverRulesInput, options: CallOptions) !list_resolver_rules.ListResolverRulesOutput {
    ...
    /// Manager
    /// (RAM).
    pub fn putFirewallRuleGroupPolicy(self: *Self, allocator: std.mem.Allocator, input: put_firewall_rule_group_policy.PutFirewallRuleGroupPolicyInput, options: CallOptions) !put_firewall_rule_group_policy.PutFirewallRuleGroupPolicyOutput {
    ...
    /// configuration.
    pub fn putResolverQueryLogConfigPolicy(self: *Self, allocator: std.mem.Allocator, input: put_resolver_query_log_config_policy.PutResolverQueryLogConfigPolicyInput, options: CallOptions) !put_resolver_query_log_config_policy.PutResolverQueryLogConfigPolicyOutput {
    ...
    /// and the operations that you want the account to be able to perform on the
    /// rule.
    pub fn putResolverRulePolicy(self: *Self, allocator: std.mem.Allocator, input: put_resolver_rule_policy.PutResolverRulePolicyInput, options: CallOptions) !put_resolver_rule_policy.PutResolverRulePolicyOutput {
    ...
    pub fn updateFirewallConfig(self: *Self, allocator: std.mem.Allocator, input: update_firewall_config.UpdateFirewallConfigInput, options: CallOptions) !update_firewall_config.UpdateFirewallConfigOutput {
    ...
    pub fn updateFirewallRuleGroupAssociation(self: *Self, allocator: std.mem.Allocator, input: update_firewall_rule_group_association.UpdateFirewallRuleGroupAssociationInput, options: CallOptions) !update_firewall_rule_group_association.UpdateFirewallRuleGroupAssociationOutput {
    ...
    /// single VPC from
    /// Amazon Virtual Private Cloud.
    pub fn updateResolverConfig(self: *Self, allocator: std.mem.Allocator, input: update_resolver_config.UpdateResolverConfigInput, options: CallOptions) !update_resolver_config.UpdateResolverConfigOutput {
    ...
    pub fn updateResolverDnssecConfig(self: *Self, allocator: std.mem.Allocator, input: update_resolver_dnssec_config.UpdateResolverDnssecConfigInput, options: CallOptions) !update_resolver_dnssec_config.UpdateResolverDnssecConfigOutput {
    ...
    pub fn updateResolverEndpoint(self: *Self, allocator: std.mem.Allocator, input: update_resolver_endpoint.UpdateResolverEndpointInput, options: CallOptions) !update_resolver_endpoint.UpdateResolverEndpointOutput {
    ...
    pub fn updateResolverRule(self: *Self, allocator: std.mem.Allocator, input: update_resolver_rule.UpdateResolverRuleInput, options: CallOptions) !update_resolver_rule.UpdateResolverRuleOutput {
