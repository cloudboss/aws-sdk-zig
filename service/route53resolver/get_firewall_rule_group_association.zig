...
pub const GetFirewallRuleGroupAssociationInput = struct {
...
pub const GetFirewallRuleGroupAssociationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFirewallRuleGroupAssociationInput, options: CallOptions) !GetFirewallRuleGroupAssociationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetFirewallRuleGroupAssociationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Resolver.GetFirewallRuleGroupAssociation");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetFirewallRuleGroupAssociationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetFirewallRuleGroupAssociationOutput, body, allocator);
}
