...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFirewallRuleGroupAssociationInput, options: Options) !GetFirewallRuleGroupAssociationOutput {
