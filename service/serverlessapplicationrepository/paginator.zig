...
pub const ListApplicationDependenciesPaginator = struct {
    client: *Client,
    params: list_application_dependencies.ListApplicationDependenciesInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_application_dependencies.Options) !list_application_dependencies.ListApplicationDependenciesOutput {
        ...
        const output = try list_application_dependencies.execute(self.client, allocator, self.params, options);
