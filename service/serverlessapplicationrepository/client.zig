...
pub const Client = struct {
    ...
    pub fn createCloudFormationChangeSet(self: *Self, allocator: std.mem.Allocator, input: create_cloud_formation_change_set.CreateCloudFormationChangeSetInput, options: create_cloud_formation_change_set.Options) !create_cloud_formation_change_set.CreateCloudFormationChangeSetOutput {
        return create_cloud_formation_change_set.execute(self, allocator, input, options);
    }

    /// Creates an AWS CloudFormation template.
    pub fn createCloudFormationTemplate(self: *Self, allocator: std.mem.Allocator, input: create_cloud_formation_template.CreateCloudFormationTemplateInput, options: create_cloud_formation_template.Options) !create_cloud_formation_template.CreateCloudFormationTemplateOutput {
    ...
    pub fn getApplicationPolicy(self: *Self, allocator: std.mem.Allocator, input: get_application_policy.GetApplicationPolicyInput, options: get_application_policy.Options) !get_application_policy.GetApplicationPolicyOutput {
        return get_application_policy.execute(self, allocator, input, options);
    }

    /// Gets the specified AWS CloudFormation template.
    pub fn getCloudFormationTemplate(self: *Self, allocator: std.mem.Allocator, input: get_cloud_formation_template.GetCloudFormationTemplateInput, options: get_cloud_formation_template.Options) !get_cloud_formation_template.GetCloudFormationTemplateOutput {
        return get_cloud_formation_template.execute(self, allocator, input, options);
    }

    /// Retrieves the list of applications nested in the containing application.
    pub fn listApplicationDependencies(self: *Self, allocator: std.mem.Allocator, input: list_application_dependencies.ListApplicationDependenciesInput, options: list_application_dependencies.Options) !list_application_dependencies.ListApplicationDependenciesOutput {
    ...
    /// .
    pub fn putApplicationPolicy(self: *Self, allocator: std.mem.Allocator, input: put_application_policy.PutApplicationPolicyInput, options: put_application_policy.Options) !put_application_policy.PutApplicationPolicyOutput {
    ...
    pub fn unshareApplication(self: *Self, allocator: std.mem.Allocator, input: unshare_application.UnshareApplicationInput, options: unshare_application.Options) !unshare_application.UnshareApplicationOutput {
