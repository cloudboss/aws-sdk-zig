...
const GetApplicationInput = @import("get_application_request.zig").GetApplicationRequest;

const GetApplicationOutput = @import("get_application_response.zig").GetApplicationResponse;
