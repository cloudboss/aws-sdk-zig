...
pub const GetAccessKeyInfoOutput = struct {
    ...
    pub fn deinit(self: *const GetAccessKeyInfoOutput) void {
        if (self.account) |v| {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetAccessKeyInfoInput, config: *aws.Config) !aws.http.Request {
    ...
    try appendUrlEncoded(alloc, &body_buf, input.access_key_id);
...
fn deserializeResponse(body: []const u8, alloc: std.mem.Allocator) !GetAccessKeyInfoOutput {
