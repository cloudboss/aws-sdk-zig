...
const assume_root = @import("assume_root.zig");
const decode_authorization_message = @import("decode_authorization_message.zig");
const get_access_key_info = @import("get_access_key_info.zig");
const get_caller_identity = @import("get_caller_identity.zig");
const get_delegated_access_token = @import("get_delegated_access_token.zig");
const get_federation_token = @import("get_federation_token.zig");
const get_session_token = @import("get_session_token.zig");
const get_web_identity_token = @import("get_web_identity_token.zig");
...
pub const Client = struct {
    ...
    /// device
    /// produces.
    pub fn assumeRole(self: *Self, allocator: std.mem.Allocator, input: assume_role.AssumeRoleInput, options: CallOptions) !assume_role.AssumeRoleOutput {
    ...
    /// *IAM User Guide*.
    pub fn assumeRoleWithSaml(self: *Self, allocator: std.mem.Allocator, input: assume_role_with_saml.AssumeRoleWithSAMLInput, options: CallOptions) !assume_role_with_saml.AssumeRoleWithSAMLOutput {
        return assume_role_with_saml.execute(self, allocator, input, options);
    }

    /// Returns a set of temporary security credentials for users who have been
    /// authenticated in
    /// a mobile or web application with a web identity provider. Example providers
    /// include the
    ...
    /// pools](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-identity.html) in *Amazon Cognito Developer Guide*.
    ///
    ...
    /// duration for a role
    /// ](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_update-role-settings.html#id_roles_update-session-duration) in the
    /// *IAM User Guide*. The maximum session duration limit applies when
    /// you use the `AssumeRole*` API operations or the `assume-role*` CLI
    /// commands. However the limit does not apply when you use those operations to
    /// create a
    ...
    /// session tags using
    /// AssumeRoleWithWebIdentity](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html#id_session-tags_adding-assume-role-idp) in the
    /// *IAM User Guide*.
    ///
    /// You can pass up to 50 session tags. The plaintext session tag keys can’t
    /// exceed 128
    ...
    /// personally
    /// identifiable information (PII) in this field. For example, you could instead
    /// use a GUID
    ...
    ///   Apps](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_oidc_manual.html) and [Federation Through a Web-based Identity Provider](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_request.html#api_assumerolewithwebidentity).
    ///
    /// * [Amazon Web Services SDK for iOS Developer
    ///   Guide](http://aws.amazon.com/sdkforios/) and [Amazon Web Services SDK for
    ...
    pub fn assumeRoleWithWebIdentity(self: *Self, allocator: std.mem.Allocator, input: assume_role_with_web_identity.AssumeRoleWithWebIdentityInput, options: CallOptions) !assume_role_with_web_identity.AssumeRoleWithWebIdentityOutput {
    ...
    pub fn assumeRoot(self: *Self, allocator: std.mem.Allocator, input: assume_root.AssumeRootInput, options: CallOptions) !assume_root.AssumeRootOutput {
    ...
    /// contain
    /// privileged information that the user who requested the operation should not
    /// see. To decode
    /// an authorization status message, a user must be granted permissions through
    /// an IAM
    ...
    /// Allowed or
    /// Denied](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_evaluation-logic.html#policy-eval-denyallow) in the
    /// *IAM User Guide*.
    ///
    ...
    pub fn decodeAuthorizationMessage(self: *Self, allocator: std.mem.Allocator, input: decode_authorization_message.DecodeAuthorizationMessageInput, options: CallOptions) !decode_authorization_message.DecodeAuthorizationMessageOutput {
    ...
    /// Users](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html) in the *IAM User Guide*.
    ///
    ...
    /// as the root user and review your root user access keys. Then, you can pull a
    /// [credentials
    /// report](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_getting-report.html) to learn which IAM user owns the keys. To learn who
    /// requested the temporary credentials for an `ASIA` access key, view the STS
    /// events in your [CloudTrail
    /// logs](https://docs.aws.amazon.com/IAM/latest/UserGuide/cloudtrail-integration.html) in the *IAM User Guide*.
    ///
    ...
    /// exist.
    pub fn getAccessKeyInfo(self: *Self, allocator: std.mem.Allocator, input: get_access_key_info.GetAccessKeyInfoInput, options: CallOptions) !get_access_key_info.GetAccessKeyInfoOutput {
    ...
    /// *IAM User Guide*.
    pub fn getCallerIdentity(self: *Self, allocator: std.mem.Allocator, input: get_caller_identity.GetCallerIdentityInput, options: CallOptions) !get_caller_identity.GetCallerIdentityOutput {
    ...
    /// resources.
    pub fn getDelegatedAccessToken(self: *Self, allocator: std.mem.Allocator, input: get_delegated_access_token.GetDelegatedAccessTokenInput, options: CallOptions) !get_delegated_access_token.GetDelegatedAccessTokenOutput {
    ...
    /// *IAM User Guide*.
    pub fn getSessionToken(self: *Self, allocator: std.mem.Allocator, input: get_session_token.GetSessionTokenInput, options: CallOptions) !get_session_token.GetSessionTokenOutput {
