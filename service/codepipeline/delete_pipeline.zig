...
pub const DeletePipelineInput = struct {
...
const DeletePipelineOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePipelineInput, options: Options) !DeletePipelineOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePipelineInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodePipeline_20150709.DeletePipeline");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePipelineOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
