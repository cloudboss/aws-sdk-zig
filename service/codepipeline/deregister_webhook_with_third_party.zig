...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterWebhookWithThirdPartyInput, options: Options) !DeregisterWebhookWithThirdPartyOutput {
