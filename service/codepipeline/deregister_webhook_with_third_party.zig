...
pub const DeregisterWebhookWithThirdPartyInput = struct {
    /// The name of the webhook you want to deregister.
    webhook_name: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterWebhookWithThirdPartyInput, options: CallOptions) !DeregisterWebhookWithThirdPartyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterWebhookWithThirdPartyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodePipeline_20150709.DeregisterWebhookWithThirdParty");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterWebhookWithThirdPartyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
