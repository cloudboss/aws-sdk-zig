...
pub const UpdateActionTypeInput = struct {
...
pub const UpdateActionTypeOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateActionTypeInput, options: CallOptions) !UpdateActionTypeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateActionTypeInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CodePipeline_20150709.UpdateActionType");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateActionTypeOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
