...
const PutThirdPartyJobFailureResultOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutThirdPartyJobFailureResultInput, options: Options) !PutThirdPartyJobFailureResultOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutThirdPartyJobFailureResultInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CodePipeline_20150709.PutThirdPartyJobFailureResult");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutThirdPartyJobFailureResultOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
