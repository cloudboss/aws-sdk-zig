...
pub const DisassociateTagOptionFromResourceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateTagOptionFromResourceInput, options: Options) !DisassociateTagOptionFromResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateTagOptionFromResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWS242ServiceCatalogService.DisassociateTagOptionFromResource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateTagOptionFromResourceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
