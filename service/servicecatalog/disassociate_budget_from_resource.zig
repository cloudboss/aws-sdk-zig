...
pub const DisassociateBudgetFromResourceInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateBudgetFromResourceInput, options: Options) !DisassociateBudgetFromResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateBudgetFromResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWS242ServiceCatalogService.DisassociateBudgetFromResource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateBudgetFromResourceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
