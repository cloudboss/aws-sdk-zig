...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: NotifyTerminateProvisionedProductEngineWorkflowResultInput, options: Options) !NotifyTerminateProvisionedProductEngineWorkflowResultOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: NotifyTerminateProvisionedProductEngineWorkflowResultInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWS242ServiceCatalogService.NotifyTerminateProvisionedProductEngineWorkflowResult");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !NotifyTerminateProvisionedProductEngineWorkflowResultOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
