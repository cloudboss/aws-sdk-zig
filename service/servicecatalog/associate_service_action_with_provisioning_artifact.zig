...
pub const AssociateServiceActionWithProvisioningArtifactInput = struct {
    /// The language code.
    ///
    /// * `jp` - Japanese
    ///
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateServiceActionWithProvisioningArtifactInput, options: Options) !AssociateServiceActionWithProvisioningArtifactOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateServiceActionWithProvisioningArtifactInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWS242ServiceCatalogService.AssociateServiceActionWithProvisioningArtifact");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateServiceActionWithProvisioningArtifactOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
