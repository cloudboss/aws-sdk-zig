...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: NotifyUpdateProvisionedProductEngineWorkflowResultInput, options: Options) !NotifyUpdateProvisionedProductEngineWorkflowResultOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: NotifyUpdateProvisionedProductEngineWorkflowResultInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AWS242ServiceCatalogService.NotifyUpdateProvisionedProductEngineWorkflowResult");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !NotifyUpdateProvisionedProductEngineWorkflowResultOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
