...
pub const DisassociateServiceActionFromProvisioningArtifactInput = struct {
    /// The language code.
    ///
    /// * `jp` - Japanese
    ///
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateServiceActionFromProvisioningArtifactInput, options: Options) !DisassociateServiceActionFromProvisioningArtifactOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateServiceActionFromProvisioningArtifactInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWS242ServiceCatalogService.DisassociateServiceActionFromProvisioningArtifact");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateServiceActionFromProvisioningArtifactOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
