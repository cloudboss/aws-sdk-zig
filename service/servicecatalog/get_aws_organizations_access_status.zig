...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAWSOrganizationsAccessStatusInput, options: Options) !GetAWSOrganizationsAccessStatusOutput {
