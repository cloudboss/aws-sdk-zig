...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAssociateServiceActionWithProvisioningArtifactInput, options: Options) !BatchAssociateServiceActionWithProvisioningArtifactOutput {
