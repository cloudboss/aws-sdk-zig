...
pub const BatchAssociateServiceActionWithProvisioningArtifactInput = struct {
    /// The language code.
    ///
    /// * `jp` - Japanese
    ///
...
pub const BatchAssociateServiceActionWithProvisioningArtifactOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAssociateServiceActionWithProvisioningArtifactInput, options: CallOptions) !BatchAssociateServiceActionWithProvisioningArtifactOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchAssociateServiceActionWithProvisioningArtifactInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWS242ServiceCatalogService.BatchAssociateServiceActionWithProvisioningArtifact");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !BatchAssociateServiceActionWithProvisioningArtifactOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(BatchAssociateServiceActionWithProvisioningArtifactOutput, body, allocator);
}
