...
pub const ListTagsForResourceInput = struct {
    ...
    /// results for
    /// this request, where the request lists the tags for the resource with the
    /// specified
    /// ARN.
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTagsForResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonAthena.ListTagsForResource");
