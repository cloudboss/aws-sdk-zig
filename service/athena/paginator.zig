...
pub const ListApplicationDPUSizesPaginator = struct {
    client: *Client,
    params: list_application_dpu_sizes.ListApplicationDPUSizesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_application_dpu_sizes.Options) !list_application_dpu_sizes.ListApplicationDPUSizesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListCalculationExecutionsPaginator = struct {
    client: *Client,
    params: list_calculation_executions.ListCalculationExecutionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_calculation_executions.Options) !list_calculation_executions.ListCalculationExecutionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListCapacityReservationsPaginator = struct {
    client: *Client,
    params: list_capacity_reservations.ListCapacityReservationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_capacity_reservations.Options) !list_capacity_reservations.ListCapacityReservationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDataCatalogsPaginator = struct {
    client: *Client,
    params: list_data_catalogs.ListDataCatalogsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_data_catalogs.Options) !list_data_catalogs.ListDataCatalogsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListDatabasesPaginator = struct {
    client: *Client,
    params: list_databases.ListDatabasesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
...
pub const ListEngineVersionsPaginator = struct {
    client: *Client,
    params: list_engine_versions.ListEngineVersionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_engine_versions.Options) !list_engine_versions.ListEngineVersionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListExecutorsPaginator = struct {
    client: *Client,
    params: list_executors.ListExecutorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_executors.Options) !list_executors.ListExecutorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListNamedQueriesPaginator = struct {
    client: *Client,
    params: list_named_queries.ListNamedQueriesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_named_queries.Options) !list_named_queries.ListNamedQueriesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListPreparedStatementsPaginator = struct {
    client: *Client,
    params: list_prepared_statements.ListPreparedStatementsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_prepared_statements.Options) !list_prepared_statements.ListPreparedStatementsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListQueryExecutionsPaginator = struct {
    client: *Client,
    params: list_query_executions.ListQueryExecutionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_query_executions.Options) !list_query_executions.ListQueryExecutionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSessionsPaginator = struct {
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_sessions.Options) !list_sessions.ListSessionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTableMetadataPaginator = struct {
    client: *Client,
    params: list_table_metadata.ListTableMetadataInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_table_metadata.Options) !list_table_metadata.ListTableMetadataOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListWorkGroupsPaginator = struct {
    client: *Client,
    params: list_work_groups.ListWorkGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: list_work_groups.Options) !list_work_groups.ListWorkGroupsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
