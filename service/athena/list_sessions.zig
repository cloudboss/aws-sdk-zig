...
const ListSessionsInput = @import("list_sessions_request.zig").ListSessionsRequest;

const ListSessionsOutput = @import("list_sessions_response.zig").ListSessionsResponse;
