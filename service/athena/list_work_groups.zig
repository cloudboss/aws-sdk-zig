...
const WorkGroupSummary = @import("work_group_summary.zig").WorkGroupSummary;
...
pub const ListWorkGroupsOutput = struct {
    ...
    work_groups: ?[]const WorkGroupSummary = null,
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListWorkGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AmazonAthena.ListWorkGroups");
