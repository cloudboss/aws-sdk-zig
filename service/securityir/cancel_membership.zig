...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelMembershipInput, options: CallOptions) !CancelMembershipOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelMembershipInput, config: *aws.Config) !aws.http.Request {
