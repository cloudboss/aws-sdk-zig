...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEvidenceFolderInput, options: CallOptions) !GetEvidenceFolderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetEvidenceFolderInput, config: *aws.Config) !aws.http.Request {
