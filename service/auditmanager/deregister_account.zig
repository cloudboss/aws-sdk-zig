...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterAccountInput, options: CallOptions) !DeregisterAccountOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterAccountInput, config: *aws.Config) !aws.http.Request {
    _ = input;
