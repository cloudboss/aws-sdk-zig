...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchAssociateAssessmentReportEvidenceInput, options: CallOptions) !BatchAssociateAssessmentReportEvidenceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchAssociateAssessmentReportEvidenceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/batchAssociateToAssessmentReport");
