...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAssessmentReportUrlInput, options: CallOptions) !GetAssessmentReportUrlOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAssessmentReportUrlInput, config: *aws.Config) !aws.http.Request {
