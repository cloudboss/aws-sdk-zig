...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PromoteResourceShareCreatedFromPolicyInput, options: Options) !PromoteResourceShareCreatedFromPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PromoteResourceShareCreatedFromPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PromoteResourceShareCreatedFromPolicyOutput {
    var result: PromoteResourceShareCreatedFromPolicyOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(PromoteResourceShareCreatedFromPolicyOutput, body, alloc);
    }
    _ = status;
    _ = headers;
