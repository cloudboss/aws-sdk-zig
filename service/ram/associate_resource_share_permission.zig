...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateResourceSharePermissionInput, options: Options) !AssociateResourceSharePermissionOutput {
