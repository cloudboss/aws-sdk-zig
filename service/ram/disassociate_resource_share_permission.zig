...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateResourceSharePermissionInput, options: Options) !DisassociateResourceSharePermissionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisassociateResourceSharePermissionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DisassociateResourceSharePermissionOutput {
    var result: DisassociateResourceSharePermissionOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DisassociateResourceSharePermissionOutput, body, alloc);
    }
    _ = status;
    _ = headers;
