...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableSharingWithAwsOrganizationInput, options: Options) !EnableSharingWithAwsOrganizationOutput {
