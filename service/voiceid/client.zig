...
pub const Client = struct {
    ...
    pub fn associateFraudster(self: *Self, allocator: std.mem.Allocator, input: associate_fraudster.AssociateFraudsterInput, options: CallOptions) !associate_fraudster.AssociateFraudsterOutput {
    ...
    pub fn createWatchlist(self: *Self, allocator: std.mem.Allocator, input: create_watchlist.CreateWatchlistInput, options: CallOptions) !create_watchlist.CreateWatchlistOutput {
    ...
    pub fn deleteFraudster(self: *Self, allocator: std.mem.Allocator, input: delete_fraudster.DeleteFraudsterInput, options: CallOptions) !delete_fraudster.DeleteFraudsterOutput {
        return delete_fraudster.execute(self, allocator, input, options);
    }

    /// Deletes the specified speaker from Voice ID.
    pub fn deleteSpeaker(self: *Self, allocator: std.mem.Allocator, input: delete_speaker.DeleteSpeakerInput, options: CallOptions) !delete_speaker.DeleteSpeakerOutput {
    ...
    pub fn deleteWatchlist(self: *Self, allocator: std.mem.Allocator, input: delete_watchlist.DeleteWatchlistInput, options: CallOptions) !delete_watchlist.DeleteWatchlistOutput {
    ...
    pub fn describeFraudster(self: *Self, allocator: std.mem.Allocator, input: describe_fraudster.DescribeFraudsterInput, options: CallOptions) !describe_fraudster.DescribeFraudsterOutput {
        return describe_fraudster.execute(self, allocator, input, options);
    }

    /// Describes the specified fraudster registration job.
    pub fn describeFraudsterRegistrationJob(self: *Self, allocator: std.mem.Allocator, input: describe_fraudster_registration_job.DescribeFraudsterRegistrationJobInput, options: CallOptions) !describe_fraudster_registration_job.DescribeFraudsterRegistrationJobOutput {
        return describe_fraudster_registration_job.execute(self, allocator, input, options);
    }

    /// Describes the specified speaker.
    pub fn describeSpeaker(self: *Self, allocator: std.mem.Allocator, input: describe_speaker.DescribeSpeakerInput, options: CallOptions) !describe_speaker.DescribeSpeakerOutput {
        return describe_speaker.execute(self, allocator, input, options);
    }

    /// Describes the specified speaker enrollment job.
    pub fn describeSpeakerEnrollmentJob(self: *Self, allocator: std.mem.Allocator, input: describe_speaker_enrollment_job.DescribeSpeakerEnrollmentJobInput, options: CallOptions) !describe_speaker_enrollment_job.DescribeSpeakerEnrollmentJobOutput {
        return describe_speaker_enrollment_job.execute(self, allocator, input, options);
    }

    /// Describes the specified watchlist.
    pub fn describeWatchlist(self: *Self, allocator: std.mem.Allocator, input: describe_watchlist.DescribeWatchlistInput, options: CallOptions) !describe_watchlist.DescribeWatchlistOutput {
    ...
    pub fn disassociateFraudster(self: *Self, allocator: std.mem.Allocator, input: disassociate_fraudster.DisassociateFraudsterInput, options: CallOptions) !disassociate_fraudster.DisassociateFraudsterOutput {
    ...
    pub fn evaluateSession(self: *Self, allocator: std.mem.Allocator, input: evaluate_session.EvaluateSessionInput, options: CallOptions) !evaluate_session.EvaluateSessionOutput {
    ...
    pub fn listFraudsterRegistrationJobs(self: *Self, allocator: std.mem.Allocator, input: list_fraudster_registration_jobs.ListFraudsterRegistrationJobsInput, options: CallOptions) !list_fraudster_registration_jobs.ListFraudsterRegistrationJobsOutput {
        return list_fraudster_registration_jobs.execute(self, allocator, input, options);
    }

    /// Lists all fraudsters in a specified watchlist or domain.
    pub fn listFraudsters(self: *Self, allocator: std.mem.Allocator, input: list_fraudsters.ListFraudstersInput, options: CallOptions) !list_fraudsters.ListFraudstersOutput {
    ...
    pub fn listSpeakerEnrollmentJobs(self: *Self, allocator: std.mem.Allocator, input: list_speaker_enrollment_jobs.ListSpeakerEnrollmentJobsInput, options: CallOptions) !list_speaker_enrollment_jobs.ListSpeakerEnrollmentJobsOutput {
        return list_speaker_enrollment_jobs.execute(self, allocator, input, options);
    }

    /// Lists all speakers in a specified domain.
    pub fn listSpeakers(self: *Self, allocator: std.mem.Allocator, input: list_speakers.ListSpeakersInput, options: CallOptions) !list_speakers.ListSpeakersOutput {
    ...
    pub fn listWatchlists(self: *Self, allocator: std.mem.Allocator, input: list_watchlists.ListWatchlistsInput, options: CallOptions) !list_watchlists.ListWatchlistsOutput {
    ...
    /// in
    /// Voice ID.
    pub fn optOutSpeaker(self: *Self, allocator: std.mem.Allocator, input: opt_out_speaker.OptOutSpeakerInput, options: CallOptions) !opt_out_speaker.OptOutSpeakerOutput {
        return opt_out_speaker.execute(self, allocator, input, options);
    }

    /// Starts a new batch fraudster registration job using provided details.
    pub fn startFraudsterRegistrationJob(self: *Self, allocator: std.mem.Allocator, input: start_fraudster_registration_job.StartFraudsterRegistrationJobInput, options: CallOptions) !start_fraudster_registration_job.StartFraudsterRegistrationJobOutput {
        return start_fraudster_registration_job.execute(self, allocator, input, options);
    }

    /// Starts a new batch speaker enrollment job using specified details.
    pub fn startSpeakerEnrollmentJob(self: *Self, allocator: std.mem.Allocator, input: start_speaker_enrollment_job.StartSpeakerEnrollmentJobInput, options: CallOptions) !start_speaker_enrollment_job.StartSpeakerEnrollmentJobOutput {
    ...
    /// cannot be updated.
    pub fn updateWatchlist(self: *Self, allocator: std.mem.Allocator, input: update_watchlist.UpdateWatchlistInput, options: CallOptions) !update_watchlist.UpdateWatchlistOutput {
