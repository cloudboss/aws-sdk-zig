...
pub const Client = struct {
    ...
    /// account.
    pub fn acceptSharedDirectory(self: *Self, allocator: std.mem.Allocator, input: accept_shared_directory.AcceptSharedDirectoryInput, options: accept_shared_directory.Options) !accept_shared_directory.AcceptSharedDirectoryOutput {
    ...
    pub fn addIpRoutes(self: *Self, allocator: std.mem.Allocator, input: add_ip_routes.AddIpRoutesInput, options: add_ip_routes.Options) !add_ip_routes.AddIpRoutesOutput {
    ...
    /// `UpdatingSchema`.
    pub fn cancelSchemaExtension(self: *Self, allocator: std.mem.Allocator, input: cancel_schema_extension.CancelSchemaExtensionInput, options: cancel_schema_extension.Options) !cancel_schema_extension.CancelSchemaExtensionOutput {
    ...
    /// Reference](http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html).
    pub fn connectDirectory(self: *Self, allocator: std.mem.Allocator, input: connect_directory.ConnectDirectoryInput, options: connect_directory.Options) !connect_directory.ConnectDirectoryOutput {
    ...
    pub fn createComputer(self: *Self, allocator: std.mem.Allocator, input: create_computer.CreateComputerInput, options: create_computer.Options) !create_computer.CreateComputerOutput {
    ...
    pub fn createConditionalForwarder(self: *Self, allocator: std.mem.Allocator, input: create_conditional_forwarder.CreateConditionalForwarderInput, options: create_conditional_forwarder.Options) !create_conditional_forwarder.CreateConditionalForwarderOutput {
    ...
    pub fn createHybridAd(self: *Self, allocator: std.mem.Allocator, input: create_hybrid_ad.CreateHybridADInput, options: create_hybrid_ad.Options) !create_hybrid_ad.CreateHybridADOutput {
    ...
    /// Services account.
    pub fn createLogSubscription(self: *Self, allocator: std.mem.Allocator, input: create_log_subscription.CreateLogSubscriptionInput, options: create_log_subscription.Options) !create_log_subscription.CreateLogSubscriptionOutput {
    ...
    /// Service API Permissions: Actions, Resources, and Conditions
    /// Reference](http://docs.aws.amazon.com/directoryservice/latest/admin-guide/UsingWithDS_IAM_ResourcePermissions.html).
    pub fn createMicrosoftAd(self: *Self, allocator: std.mem.Allocator, input: create_microsoft_ad.CreateMicrosoftADInput, options: create_microsoft_ad.Options) !create_microsoft_ad.CreateMicrosoftADOutput {
    ...
    /// external trust.
    pub fn createTrust(self: *Self, allocator: std.mem.Allocator, input: create_trust.CreateTrustInput, options: create_trust.Options) !create_trust.CreateTrustOutput {
    ...
    pub fn deleteAdAssessment(self: *Self, allocator: std.mem.Allocator, input: delete_ad_assessment.DeleteADAssessmentInput, options: delete_ad_assessment.Options) !delete_ad_assessment.DeleteADAssessmentOutput {
    ...
    /// Services
    /// directory.
    pub fn deleteConditionalForwarder(self: *Self, allocator: std.mem.Allocator, input: delete_conditional_forwarder.DeleteConditionalForwarderInput, options: delete_conditional_forwarder.Options) !delete_conditional_forwarder.DeleteConditionalForwarderOutput {
    ...
    pub fn deleteLogSubscription(self: *Self, allocator: std.mem.Allocator, input: delete_log_subscription.DeleteLogSubscriptionInput, options: delete_log_subscription.Options) !delete_log_subscription.DeleteLogSubscriptionOutput {
    ...
    /// domain.
    pub fn deleteTrust(self: *Self, allocator: std.mem.Allocator, input: delete_trust.DeleteTrustInput, options: delete_trust.Options) !delete_trust.DeleteTrustOutput {
    ...
    pub fn deregisterCertificate(self: *Self, allocator: std.mem.Allocator, input: deregister_certificate.DeregisterCertificateInput, options: deregister_certificate.Options) !deregister_certificate.DeregisterCertificateOutput {
    ...
    /// topic.
    pub fn deregisterEventTopic(self: *Self, allocator: std.mem.Allocator, input: deregister_event_topic.DeregisterEventTopicInput, options: deregister_event_topic.Options) !deregister_event_topic.DeregisterEventTopicOutput {
    ...
    pub fn describeAdAssessment(self: *Self, allocator: std.mem.Allocator, input: describe_ad_assessment.DescribeADAssessmentInput, options: describe_ad_assessment.Options) !describe_ad_assessment.DescribeADAssessmentOutput {
    ...
    pub fn describeCaEnrollmentPolicy(self: *Self, allocator: std.mem.Allocator, input: describe_ca_enrollment_policy.DescribeCAEnrollmentPolicyInput, options: describe_ca_enrollment_policy.Options) !describe_ca_enrollment_policy.DescribeCAEnrollmentPolicyOutput {
    ...
    pub fn describeClientAuthenticationSettings(self: *Self, allocator: std.mem.Allocator, input: describe_client_authentication_settings.DescribeClientAuthenticationSettingsInput, options: describe_client_authentication_settings.Options) !describe_client_authentication_settings.DescribeClientAuthenticationSettingsOutput {
    ...
    pub fn describeConditionalForwarders(self: *Self, allocator: std.mem.Allocator, input: describe_conditional_forwarders.DescribeConditionalForwardersInput, options: describe_conditional_forwarders.Options) !describe_conditional_forwarders.DescribeConditionalForwardersOutput {
    ...
    /// parameter.
    pub fn describeDirectories(self: *Self, allocator: std.mem.Allocator, input: describe_directories.DescribeDirectoriesInput, options: describe_directories.Options) !describe_directories.DescribeDirectoriesOutput {
    ...
    /// specified directory.
    pub fn describeDirectoryDataAccess(self: *Self, allocator: std.mem.Allocator, input: describe_directory_data_access.DescribeDirectoryDataAccessInput, options: describe_directory_data_access.Options) !describe_directory_data_access.DescribeDirectoryDataAccessOutput {
        return describe_directory_data_access.execute(self, allocator, input, options);
    }

    /// Provides information about any domain controllers in your directory.
    pub fn describeDomainControllers(self: *Self, allocator: std.mem.Allocator, input: describe_domain_controllers.DescribeDomainControllersInput, options: describe_domain_controllers.Options) !describe_domain_controllers.DescribeDomainControllersOutput {
    ...
    pub fn describeEventTopics(self: *Self, allocator: std.mem.Allocator, input: describe_event_topics.DescribeEventTopicsInput, options: describe_event_topics.Options) !describe_event_topics.DescribeEventTopicsOutput {
    ...
    pub fn describeHybridAdUpdate(self: *Self, allocator: std.mem.Allocator, input: describe_hybrid_ad_update.DescribeHybridADUpdateInput, options: describe_hybrid_ad_update.Options) !describe_hybrid_ad_update.DescribeHybridADUpdateOutput {
        return describe_hybrid_ad_update.execute(self, allocator, input, options);
    }

    /// Describes the status of LDAP security for the specified directory.
    pub fn describeLdapsSettings(self: *Self, allocator: std.mem.Allocator, input: describe_ldaps_settings.DescribeLDAPSSettingsInput, options: describe_ldaps_settings.Options) !describe_ldaps_settings.DescribeLDAPSSettingsOutput {
    ...
    /// directory.
    pub fn describeSettings(self: *Self, allocator: std.mem.Allocator, input: describe_settings.DescribeSettingsInput, options: describe_settings.Options) !describe_settings.DescribeSettingsOutput {
        return describe_settings.execute(self, allocator, input, options);
    }

    /// Returns the shared directories in your account.
    pub fn describeSharedDirectories(self: *Self, allocator: std.mem.Allocator, input: describe_shared_directories.DescribeSharedDirectoriesInput, options: describe_shared_directories.Options) !describe_shared_directories.DescribeSharedDirectoriesOutput {
    ...
    pub fn describeTrusts(self: *Self, allocator: std.mem.Allocator, input: describe_trusts.DescribeTrustsInput, options: describe_trusts.Options) !describe_trusts.DescribeTrustsOutput {
        return describe_trusts.execute(self, allocator, input, options);
    }

    /// Describes the updates of a directory for a particular update type.
    pub fn describeUpdateDirectory(self: *Self, allocator: std.mem.Allocator, input: describe_update_directory.DescribeUpdateDirectoryInput, options: describe_update_directory.Options) !describe_update_directory.DescribeUpdateDirectoryOutput {
    ...
    /// expire.
    pub fn disableCaEnrollmentPolicy(self: *Self, allocator: std.mem.Allocator, input: disable_ca_enrollment_policy.DisableCAEnrollmentPolicyInput, options: disable_ca_enrollment_policy.Options) !disable_ca_enrollment_policy.DisableCAEnrollmentPolicyOutput {
    ...
    /// directory.
    pub fn disableClientAuthentication(self: *Self, allocator: std.mem.Allocator, input: disable_client_authentication.DisableClientAuthenticationInput, options: disable_client_authentication.Options) !disable_client_authentication.DisableClientAuthenticationOutput {
    ...
    pub fn disableDirectoryDataAccess(self: *Self, allocator: std.mem.Allocator, input: disable_directory_data_access.DisableDirectoryDataAccessInput, options: disable_directory_data_access.Options) !disable_directory_data_access.DisableDirectoryDataAccessOutput {
        return disable_directory_data_access.execute(self, allocator, input, options);
    }

    /// Deactivates LDAP secure calls for the specified directory.
    pub fn disableLdaps(self: *Self, allocator: std.mem.Allocator, input: disable_ldaps.DisableLDAPSInput, options: disable_ldaps.Options) !disable_ldaps.DisableLDAPSOutput {
    ...
    pub fn disableRadius(self: *Self, allocator: std.mem.Allocator, input: disable_radius.DisableRadiusInput, options: disable_radius.Options) !disable_radius.DisableRadiusOutput {
        return disable_radius.execute(self, allocator, input, options);
    }

    /// Disables single-sign on for a directory.
    pub fn disableSso(self: *Self, allocator: std.mem.Allocator, input: disable_sso.DisableSsoInput, options: disable_sso.Options) !disable_sso.DisableSsoOutput {
    ...
    pub fn enableCaEnrollmentPolicy(self: *Self, allocator: std.mem.Allocator, input: enable_ca_enrollment_policy.EnableCAEnrollmentPolicyInput, options: enable_ca_enrollment_policy.Options) !enable_ca_enrollment_policy.EnableCAEnrollmentPolicyOutput {
    ...
    /// directory.
    pub fn enableClientAuthentication(self: *Self, allocator: std.mem.Allocator, input: enable_client_authentication.EnableClientAuthenticationInput, options: enable_client_authentication.Options) !enable_client_authentication.EnableClientAuthenticationOutput {
    ...
    /// more information, see [Directory Service Data API
    /// Reference](https://docs.aws.amazon.com/directoryservicedata/latest/DirectoryServiceDataAPIReference/Welcome.html).
    pub fn enableDirectoryDataAccess(self: *Self, allocator: std.mem.Allocator, input: enable_directory_data_access.EnableDirectoryDataAccessInput, options: enable_directory_data_access.Options) !enable_directory_data_access.EnableDirectoryDataAccessOutput {
    ...
    /// calls.
    pub fn enableLdaps(self: *Self, allocator: std.mem.Allocator, input: enable_ldaps.EnableLDAPSInput, options: enable_ldaps.Options) !enable_ldaps.EnableLDAPSOutput {
    ...
    /// Dial In User
    /// Service (RADIUS) server for an AD Connector or Microsoft AD directory.
    pub fn enableRadius(self: *Self, allocator: std.mem.Allocator, input: enable_radius.EnableRadiusInput, options: enable_radius.Options) !enable_radius.EnableRadiusOutput {
    ...
    pub fn enableSso(self: *Self, allocator: std.mem.Allocator, input: enable_sso.EnableSsoInput, options: enable_sso.Options) !enable_sso.EnableSsoOutput {
        return enable_sso.execute(self, allocator, input, options);
    }

    /// Obtains directory limit information for the current Region.
    pub fn getDirectoryLimits(self: *Self, allocator: std.mem.Allocator, input: get_directory_limits.GetDirectoryLimitsInput, options: get_directory_limits.Options) !get_directory_limits.GetDirectoryLimitsOutput {
        return get_directory_limits.execute(self, allocator, input, options);
    }

    /// Obtains the manual snapshot limits for a directory.
    pub fn getSnapshotLimits(self: *Self, allocator: std.mem.Allocator, input: get_snapshot_limits.GetSnapshotLimitsInput, options: get_snapshot_limits.Options) !get_snapshot_limits.GetSnapshotLimitsOutput {
    ...
    pub fn listAdAssessments(self: *Self, allocator: std.mem.Allocator, input: list_ad_assessments.ListADAssessmentsInput, options: list_ad_assessments.Options) !list_ad_assessments.ListADAssessmentsOutput {
    ...
    pub fn listIpRoutes(self: *Self, allocator: std.mem.Allocator, input: list_ip_routes.ListIpRoutesInput, options: list_ip_routes.Options) !list_ip_routes.ListIpRoutesOutput {
        return list_ip_routes.execute(self, allocator, input, options);
    }

    /// Lists the active log subscriptions for the Amazon Web Services account.
    pub fn listLogSubscriptions(self: *Self, allocator: std.mem.Allocator, input: list_log_subscriptions.ListLogSubscriptionsInput, options: list_log_subscriptions.Options) !list_log_subscriptions.ListLogSubscriptionsOutput {
        return list_log_subscriptions.execute(self, allocator, input, options);
    }

    /// Lists all schema extensions applied to a Microsoft AD Directory.
    pub fn listSchemaExtensions(self: *Self, allocator: std.mem.Allocator, input: list_schema_extensions.ListSchemaExtensionsInput, options: list_schema_extensions.Options) !list_schema_extensions.ListSchemaExtensionsOutput {
    ...
    pub fn registerEventTopic(self: *Self, allocator: std.mem.Allocator, input: register_event_topic.RegisterEventTopicInput, options: register_event_topic.Options) !register_event_topic.RegisterEventTopicOutput {
    ...
    /// account.
    pub fn rejectSharedDirectory(self: *Self, allocator: std.mem.Allocator, input: reject_shared_directory.RejectSharedDirectoryInput, options: reject_shared_directory.Options) !reject_shared_directory.RejectSharedDirectoryOutput {
        return reject_shared_directory.execute(self, allocator, input, options);
    }

    /// Removes IP address blocks from a directory.
    pub fn removeIpRoutes(self: *Self, allocator: std.mem.Allocator, input: remove_ip_routes.RemoveIpRoutesInput, options: remove_ip_routes.Options) !remove_ip_routes.RemoveIpRoutesOutput {
    ...
    pub fn restoreFromSnapshot(self: *Self, allocator: std.mem.Allocator, input: restore_from_snapshot.RestoreFromSnapshotInput, options: restore_from_snapshot.Options) !restore_from_snapshot.RestoreFromSnapshotOutput {
    ...
    pub fn shareDirectory(self: *Self, allocator: std.mem.Allocator, input: share_directory.ShareDirectoryInput, options: share_directory.Options) !share_directory.ShareDirectoryOutput {
    ...
    pub fn startAdAssessment(self: *Self, allocator: std.mem.Allocator, input: start_ad_assessment.StartADAssessmentInput, options: start_ad_assessment.Options) !start_ad_assessment.StartADAssessmentOutput {
        return start_ad_assessment.execute(self, allocator, input, options);
    }

    /// Applies a schema extension to a Microsoft AD directory.
    pub fn startSchemaExtension(self: *Self, allocator: std.mem.Allocator, input: start_schema_extension.StartSchemaExtensionInput, options: start_schema_extension.Options) !start_schema_extension.StartSchemaExtensionOutput {
    ...
    /// accounts.
    pub fn unshareDirectory(self: *Self, allocator: std.mem.Allocator, input: unshare_directory.UnshareDirectoryInput, options: unshare_directory.Options) !unshare_directory.UnshareDirectoryOutput {
    ...
    /// Services
    /// directory.
    pub fn updateConditionalForwarder(self: *Self, allocator: std.mem.Allocator, input: update_conditional_forwarder.UpdateConditionalForwarderInput, options: update_conditional_forwarder.Options) !update_conditional_forwarder.UpdateConditionalForwarderOutput {
        return update_conditional_forwarder.execute(self, allocator, input, options);
    }

    /// Updates directory configuration for the specified update type.
    pub fn updateDirectorySetup(self: *Self, allocator: std.mem.Allocator, input: update_directory_setup.UpdateDirectorySetupInput, options: update_directory_setup.Options) !update_directory_setup.UpdateDirectorySetupOutput {
    ...
    pub fn updateHybridAd(self: *Self, allocator: std.mem.Allocator, input: update_hybrid_ad.UpdateHybridADInput, options: update_hybrid_ad.Options) !update_hybrid_ad.UpdateHybridADOutput {
    ...
    pub fn updateNumberOfDomainControllers(self: *Self, allocator: std.mem.Allocator, input: update_number_of_domain_controllers.UpdateNumberOfDomainControllersInput, options: update_number_of_domain_controllers.Options) !update_number_of_domain_controllers.UpdateNumberOfDomainControllersOutput {
    ...
    pub fn updateRadius(self: *Self, allocator: std.mem.Allocator, input: update_radius.UpdateRadiusInput, options: update_radius.Options) !update_radius.UpdateRadiusOutput {
    ...
    pub fn updateTrust(self: *Self, allocator: std.mem.Allocator, input: update_trust.UpdateTrustInput, options: update_trust.Options) !update_trust.UpdateTrustOutput {
    ...
    /// directory and an
    /// external domain.
    pub fn verifyTrust(self: *Self, allocator: std.mem.Allocator, input: verify_trust.VerifyTrustInput, options: verify_trust.Options) !verify_trust.VerifyTrustOutput {
