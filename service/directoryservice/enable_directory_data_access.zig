...
pub const EnableDirectoryDataAccessInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnableDirectoryDataAccessInput, options: Options) !EnableDirectoryDataAccessOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: EnableDirectoryDataAccessInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "DirectoryService_20150416.EnableDirectoryDataAccess");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !EnableDirectoryDataAccessOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
