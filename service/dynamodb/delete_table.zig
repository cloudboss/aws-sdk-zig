...
pub const DeleteTableOutput = struct {
    ...
    pub fn deinit(self: *DeleteTableOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: DeleteTableInput, options: Options) !DeleteTableOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DynamoDB_20120810.DeleteTable");
