...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableKinesisStreamingDestinationInput, options: Options) !DisableKinesisStreamingDestinationOutput {
