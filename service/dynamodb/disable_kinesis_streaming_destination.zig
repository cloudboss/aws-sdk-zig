...
pub const DisableKinesisStreamingDestinationOutput = struct {
    ...
    pub fn deinit(self: *const DisableKinesisStreamingDestinationOutput) void {
...
pub fn execute(client: *Client, input: DisableKinesisStreamingDestinationInput, options: Options) !DisableKinesisStreamingDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DisableKinesisStreamingDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DynamoDB_20120810.DisableKinesisStreamingDestination");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, alloc: std.mem.Allocator) !DisableKinesisStreamingDestinationOutput {
    _ = status;
