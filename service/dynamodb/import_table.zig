...
pub const ImportTableOutput = struct {
    ...
    pub fn deinit(self: *ImportTableOutput) void {
        self._arena.deinit();
    }
...
pub fn execute(client: *Client, input: ImportTableInput, options: Options) !ImportTableOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ImportTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DynamoDB_20120810.ImportTable");
