...
/// the table does not have any local secondary indexes, this information is not
/// returned in
/// the response.
pub const ItemCollectionMetrics = struct {
    ...
    /// projected into all
    /// of the local secondary indexes on that table. Use this estimate to measure
    /// whether a
