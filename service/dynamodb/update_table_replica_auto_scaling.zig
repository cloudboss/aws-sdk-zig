...
pub fn execute(client: *Client, input: UpdateTableReplicaAutoScalingInput, options: Options) !UpdateTableReplicaAutoScalingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateTableReplicaAutoScalingInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DynamoDB_20120810.UpdateTableReplicaAutoScaling");

    return request;
}

fn deserializeResponse(body: []const u8, alloc: std.mem.Allocator) !UpdateTableReplicaAutoScalingOutput {
    _ = body;
