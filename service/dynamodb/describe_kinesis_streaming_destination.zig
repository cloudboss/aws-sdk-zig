...
pub const DescribeKinesisStreamingDestinationOutput = struct {
    ...
    pub fn deinit(self: *const DescribeKinesisStreamingDestinationOutput) void {
...
pub fn execute(client: *Client, input: DescribeKinesisStreamingDestinationInput, options: Options) !DescribeKinesisStreamingDestinationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeKinesisStreamingDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "DynamoDB_20120810.DescribeKinesisStreamingDestination");

    return request;
}

fn deserializeResponse(body: []const u8, alloc: std.mem.Allocator) !DescribeKinesisStreamingDestinationOutput {
