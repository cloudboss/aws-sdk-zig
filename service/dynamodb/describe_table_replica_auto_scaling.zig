...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTableReplicaAutoScalingInput, options: Options) !DescribeTableReplicaAutoScalingOutput {
