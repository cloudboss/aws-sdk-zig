...
pub const LoggingConfigurationInput = struct {
    ...
    dag_processing_logs: ?ModuleLoggingConfigurationInput,

    /// Publishes Airflow scheduler logs to CloudWatch Logs.
    scheduler_logs: ?ModuleLoggingConfigurationInput,

    /// Publishes Airflow task logs to CloudWatch Logs.
    task_logs: ?ModuleLoggingConfigurationInput,

    /// Publishes Airflow web server logs to CloudWatch Logs.
    webserver_logs: ?ModuleLoggingConfigurationInput,

    /// Publishes Airflow worker logs to CloudWatch Logs.
    worker_logs: ?ModuleLoggingConfigurationInput,
