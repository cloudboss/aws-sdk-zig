...
fn serializeRequest(allocator: std.mem.Allocator, input: StopEventDataStoreIngestionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CloudTrail_20131101.StopEventDataStoreIngestion");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopEventDataStoreIngestionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
