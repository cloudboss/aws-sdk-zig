...
const ListImportsInput = @import("list_imports_request.zig").ListImportsRequest;

const ListImportsOutput = @import("list_imports_response.zig").ListImportsResponse;
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListImportsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CloudTrail_20131101.ListImports");
