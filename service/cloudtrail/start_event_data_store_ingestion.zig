...
fn serializeRequest(alloc: std.mem.Allocator, input: StartEventDataStoreIngestionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CloudTrail_20131101.StartEventDataStoreIngestion");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StartEventDataStoreIngestionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
