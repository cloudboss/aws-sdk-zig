...
pub const ListEventDataStoresPaginator = struct {
    client: *Client,
    params: list_event_data_stores.ListEventDataStoresInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_event_data_stores.ListEventDataStoresOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListImportFailuresPaginator = struct {
    client: *Client,
    params: list_import_failures.ListImportFailuresInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_import_failures.ListImportFailuresOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListInsightsDataPaginator = struct {
    client: *Client,
    params: list_insights_data.ListInsightsDataInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_insights_data.ListInsightsDataOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListInsightsMetricDataPaginator = struct {
    client: *Client,
    params: list_insights_metric_data.ListInsightsMetricDataInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_insights_metric_data.ListInsightsMetricDataOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListTrailsPaginator = struct {
    client: *Client,
    params: list_trails.ListTrailsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_trails.ListTrailsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const LookupEventsPaginator = struct {
    client: *Client,
    params: lookup_events.LookupEventsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !lookup_events.LookupEventsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
