...
const ListDashboardsInput = @import("list_dashboards_request.zig").ListDashboardsRequest;

const ListDashboardsOutput = @import("list_dashboards_response.zig").ListDashboardsResponse;
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDashboardsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CloudTrail_20131101.ListDashboards");
