...
pub const IngestionStatus = struct {
    ...
    latest_ingestion_attempt_event_id: ?[]const u8,

    /// The time stamp of the most recent attempt to ingest events on the channel.
    latest_ingestion_attempt_time: ?i64,

    /// The error code for the most recent failure to ingest events.
    latest_ingestion_error_code: ?[]const u8,

    /// The event ID of the most recent successful ingestion of events.
    latest_ingestion_success_event_id: ?[]const u8,

    /// The time stamp of the most recent successful ingestion of events for the
    /// channel.
    latest_ingestion_success_time: ?i64,
