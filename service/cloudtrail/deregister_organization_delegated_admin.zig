...
pub const DeregisterOrganizationDelegatedAdminInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterOrganizationDelegatedAdminInput, options: Options) !DeregisterOrganizationDelegatedAdminOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterOrganizationDelegatedAdminInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "CloudTrail_20131101.DeregisterOrganizationDelegatedAdmin");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterOrganizationDelegatedAdminOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
