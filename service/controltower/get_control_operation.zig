...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetControlOperationInput, options: CallOptions) !GetControlOperationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetControlOperationInput, config: *aws.Config) !aws.http.Request {
