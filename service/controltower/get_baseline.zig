...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetBaselineInput, options: CallOptions) !GetBaselineOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetBaselineInput, config: *aws.Config) !aws.http.Request {
