...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisableBaselineInput, options: CallOptions) !DisableBaselineOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisableBaselineInput, config: *aws.Config) !aws.http.Request {
