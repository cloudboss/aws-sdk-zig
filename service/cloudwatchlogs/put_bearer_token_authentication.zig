...
pub const PutBearerTokenAuthenticationInput = struct {
...
pub const PutBearerTokenAuthenticationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutBearerTokenAuthenticationInput, options: CallOptions) !PutBearerTokenAuthenticationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutBearerTokenAuthenticationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.PutBearerTokenAuthentication");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutBearerTokenAuthenticationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
