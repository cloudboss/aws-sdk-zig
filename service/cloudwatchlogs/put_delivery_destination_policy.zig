...
pub const PutDeliveryDestinationPolicyInput = struct {
...
pub const PutDeliveryDestinationPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutDeliveryDestinationPolicyInput, options: CallOptions) !PutDeliveryDestinationPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutDeliveryDestinationPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.PutDeliveryDestinationPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutDeliveryDestinationPolicyOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(PutDeliveryDestinationPolicyOutput, body, allocator);
}
