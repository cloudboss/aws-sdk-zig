...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateSourceFromS3TableIntegrationInput, options: Options) !DisassociateSourceFromS3TableIntegrationOutput {
