...
pub const DeleteLogStreamInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLogStreamInput, options: CallOptions) !DeleteLogStreamOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLogStreamInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteLogStream");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLogStreamOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
