...
pub const DeleteDeliveryDestinationPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDeliveryDestinationPolicyInput, options: CallOptions) !DeleteDeliveryDestinationPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDeliveryDestinationPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteDeliveryDestinationPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDeliveryDestinationPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
