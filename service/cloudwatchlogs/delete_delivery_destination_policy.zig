...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDeliveryDestinationPolicyInput, options: Options) !DeleteDeliveryDestinationPolicyOutput {
