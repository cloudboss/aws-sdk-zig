...
pub const DeleteDataProtectionPolicyInput = struct {
...
pub const DeleteDataProtectionPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDataProtectionPolicyInput, options: CallOptions) !DeleteDataProtectionPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDataProtectionPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteDataProtectionPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDataProtectionPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
