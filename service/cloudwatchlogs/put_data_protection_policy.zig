...
fn serializeRequest(alloc: std.mem.Allocator, input: PutDataProtectionPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Logs_20140328.PutDataProtectionPolicy");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutDataProtectionPolicyOutput {
    ...
    return aws.json.parseJsonObject(PutDataProtectionPolicyOutput, body, alloc);
}
