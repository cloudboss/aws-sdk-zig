...
pub const DeleteDeliveryDestinationInput = struct {
    /// The name of the delivery destination that you want to delete. You can find a
    /// list of
    /// delivery destination names by using the
    /// [DescribeDeliveryDestinations](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/API_DescribeDeliveryDestinations.html) operation.
    name: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDeliveryDestinationInput, options: CallOptions) !DeleteDeliveryDestinationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDeliveryDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteDeliveryDestination");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDeliveryDestinationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
