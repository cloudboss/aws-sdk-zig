...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeConfigurationTemplatesInput, options: Options) !DescribeConfigurationTemplatesOutput {
