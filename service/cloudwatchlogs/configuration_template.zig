...
pub const ConfigurationTemplate = struct {
    ...
    allowed_action_for_allow_vended_logs_delivery_for_resource: ?[]const u8 = null,
    ...
    /// `W3C`, or `Raw` format.
    allowed_field_delimiters: ?[]const []const u8 = null,
