...
pub const DeleteIndexPolicyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIndexPolicyInput, options: Options) !DeleteIndexPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIndexPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteIndexPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIndexPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
