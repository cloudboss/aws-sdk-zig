...
pub const DeleteLookupTableInput = struct {
...
pub const DeleteLookupTableOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLookupTableInput, options: CallOptions) !DeleteLookupTableOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLookupTableInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteLookupTable");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLookupTableOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
