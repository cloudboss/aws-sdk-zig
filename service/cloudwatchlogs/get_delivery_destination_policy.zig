...
pub const GetDeliveryDestinationPolicyInput = struct {
    /// The name of the delivery destination that you want to retrieve the policy
    /// of.
    delivery_destination_name: []const u8,
...
pub const GetDeliveryDestinationPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDeliveryDestinationPolicyInput, options: CallOptions) !GetDeliveryDestinationPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDeliveryDestinationPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.GetDeliveryDestinationPolicy");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDeliveryDestinationPolicyOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetDeliveryDestinationPolicyOutput, body, allocator);
}
