...
pub const DeleteDestinationInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDestinationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteDestination");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDestinationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
