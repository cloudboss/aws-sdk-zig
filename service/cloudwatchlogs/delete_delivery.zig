...
pub const DeleteDeliveryInput = struct {
...
pub const DeleteDeliveryOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteDeliveryInput, options: CallOptions) !DeleteDeliveryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteDeliveryInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Logs_20140328.DeleteDelivery");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteDeliveryOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
