...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateInstanceAccessControlAttributeConfigurationInput, options: Options) !CreateInstanceAccessControlAttributeConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateInstanceAccessControlAttributeConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SWBExternalService.CreateInstanceAccessControlAttributeConfiguration");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateInstanceAccessControlAttributeConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
