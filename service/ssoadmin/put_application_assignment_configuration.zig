...
pub const PutApplicationAssignmentConfigurationInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutApplicationAssignmentConfigurationInput, options: Options) !PutApplicationAssignmentConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutApplicationAssignmentConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SWBExternalService.PutApplicationAssignmentConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutApplicationAssignmentConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
