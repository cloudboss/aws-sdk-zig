...
const PutApplicationAccessScopeOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutApplicationAccessScopeInput, options: Options) !PutApplicationAccessScopeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutApplicationAccessScopeInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SWBExternalService.PutApplicationAccessScope");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutApplicationAccessScopeOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
