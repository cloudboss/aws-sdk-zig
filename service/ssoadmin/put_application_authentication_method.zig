...
const PutApplicationAuthenticationMethodOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutApplicationAuthenticationMethodInput, options: Options) !PutApplicationAuthenticationMethodOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutApplicationAuthenticationMethodInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SWBExternalService.PutApplicationAuthenticationMethod");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutApplicationAuthenticationMethodOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
