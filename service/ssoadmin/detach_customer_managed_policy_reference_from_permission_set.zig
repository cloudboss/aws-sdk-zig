...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachCustomerManagedPolicyReferenceFromPermissionSetInput, options: Options) !DetachCustomerManagedPolicyReferenceFromPermissionSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DetachCustomerManagedPolicyReferenceFromPermissionSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SWBExternalService.DetachCustomerManagedPolicyReferenceFromPermissionSet");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DetachCustomerManagedPolicyReferenceFromPermissionSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
