...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListCustomerManagedPolicyReferencesInPermissionSetInput, options: Options) !ListCustomerManagedPolicyReferencesInPermissionSetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListCustomerManagedPolicyReferencesInPermissionSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "SWBExternalService.ListCustomerManagedPolicyReferencesInPermissionSet");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListCustomerManagedPolicyReferencesInPermissionSetOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(ListCustomerManagedPolicyReferencesInPermissionSetOutput, body, alloc);
}
