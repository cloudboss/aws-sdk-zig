...
pub const AttachCustomerManagedPolicyReferenceToPermissionSetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachCustomerManagedPolicyReferenceToPermissionSetInput, options: Options) !AttachCustomerManagedPolicyReferenceToPermissionSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachCustomerManagedPolicyReferenceToPermissionSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SWBExternalService.AttachCustomerManagedPolicyReferenceToPermissionSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachCustomerManagedPolicyReferenceToPermissionSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
