...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAccountAssignmentsForPrincipalInput, options: Options) !ListAccountAssignmentsForPrincipalOutput {
