...
pub const DetachManagedPolicyFromPermissionSetInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachManagedPolicyFromPermissionSetInput, options: Options) !DetachManagedPolicyFromPermissionSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachManagedPolicyFromPermissionSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "SWBExternalService.DetachManagedPolicyFromPermissionSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachManagedPolicyFromPermissionSetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
