...
pub const ListEnvironmentHostsPaginator = struct {
    client: *Client,
    params: list_environment_hosts.ListEnvironmentHostsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_environment_hosts.ListEnvironmentHostsOutput {
        if (self.done) {
...
pub const ListEnvironmentVlansPaginator = struct {
    client: *Client,
    params: list_environment_vlans.ListEnvironmentVlansInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_environment_vlans.ListEnvironmentVlansOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
