...
pub const Client = struct {
    ...
    pub fn createCustomPlugin(self: *Self, allocator: std.mem.Allocator, input: create_custom_plugin.CreateCustomPluginInput, options: CallOptions) !create_custom_plugin.CreateCustomPluginOutput {
        return create_custom_plugin.execute(self, allocator, input, options);
    }

    /// Creates a worker configuration using the specified properties.
    pub fn createWorkerConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_worker_configuration.CreateWorkerConfigurationInput, options: CallOptions) !create_worker_configuration.CreateWorkerConfigurationOutput {
    ...
    pub fn deleteCustomPlugin(self: *Self, allocator: std.mem.Allocator, input: delete_custom_plugin.DeleteCustomPluginInput, options: CallOptions) !delete_custom_plugin.DeleteCustomPluginOutput {
        return delete_custom_plugin.execute(self, allocator, input, options);
    }

    /// Deletes the specified worker configuration.
    pub fn deleteWorkerConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_worker_configuration.DeleteWorkerConfigurationInput, options: CallOptions) !delete_worker_configuration.DeleteWorkerConfigurationOutput {
    ...
    pub fn describeConnectorOperation(self: *Self, allocator: std.mem.Allocator, input: describe_connector_operation.DescribeConnectorOperationInput, options: CallOptions) !describe_connector_operation.DescribeConnectorOperationOutput {
        return describe_connector_operation.execute(self, allocator, input, options);
    }

    /// A summary description of the custom plugin.
    pub fn describeCustomPlugin(self: *Self, allocator: std.mem.Allocator, input: describe_custom_plugin.DescribeCustomPluginInput, options: CallOptions) !describe_custom_plugin.DescribeCustomPluginOutput {
        return describe_custom_plugin.execute(self, allocator, input, options);
    }

    /// Returns information about a worker configuration.
    pub fn describeWorkerConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_worker_configuration.DescribeWorkerConfigurationInput, options: CallOptions) !describe_worker_configuration.DescribeWorkerConfigurationOutput {
        return describe_worker_configuration.execute(self, allocator, input, options);
    }

    /// Lists information about a connector's operation(s).
    pub fn listConnectorOperations(self: *Self, allocator: std.mem.Allocator, input: list_connector_operations.ListConnectorOperationsInput, options: CallOptions) !list_connector_operations.ListConnectorOperationsOutput {
    ...
    pub fn listCustomPlugins(self: *Self, allocator: std.mem.Allocator, input: list_custom_plugins.ListCustomPluginsInput, options: CallOptions) !list_custom_plugins.ListCustomPluginsOutput {
