...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListWorkerConfigurationsInput, options: CallOptions) !ListWorkerConfigurationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListWorkerConfigurationsInput, config: *aws.Config) !aws.http.Request {
