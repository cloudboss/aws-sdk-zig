...
const DescribeLifecycleHookTypesInput = struct {};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeLifecycleHookTypesInput, options: Options) !DescribeLifecycleHookTypesOutput {
