...
const DescribeAdjustmentTypesInput = struct {};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAdjustmentTypesInput, options: Options) !DescribeAdjustmentTypesOutput {
