...
fn serializeRequest(alloc: std.mem.Allocator, input: AttachLoadBalancersInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AttachLoadBalancers&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AttachLoadBalancersOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
