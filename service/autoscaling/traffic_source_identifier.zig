...
pub const TrafficSourceIdentifier = struct {
    ...
    /// (ARN) for a target group in this account and Region. For Classic Load
    /// Balancers, this will be the name
    ...
    /// Load Balancer, or Network Load Balancer, or the name of a
    /// Classic Load Balancer, use the Elastic Load Balancing
    /// [DescribeTargetGroups](https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_DescribeTargetGroups.html) and [DescribeLoadBalancers](https://docs.aws.amazon.com/elasticloadbalancing/latest/APIReference/API_DescribeLoadBalancers.html) API operations.
    ///
    /// To get the ARN of a target group for VPC Lattice, use the VPC Lattice
    /// [GetTargetGroup](https://docs.aws.amazon.com/vpc-lattice/latest/APIReference/API_GetTargetGroup.html) API operation.
    identifier: []const u8,
