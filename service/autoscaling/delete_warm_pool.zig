...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteWarmPoolInput, options: Options) !DeleteWarmPoolOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteWarmPoolInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteWarmPool&Version=2011-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteWarmPoolOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteWarmPoolOutput = .{};
