...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: EnterStandbyInput, options: Options) !EnterStandbyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: EnterStandbyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=EnterStandby&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !EnterStandbyOutput {
    _ = status;
    _ = headers;
