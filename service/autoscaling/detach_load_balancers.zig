...
fn serializeRequest(alloc: std.mem.Allocator, input: DetachLoadBalancersInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DetachLoadBalancers&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DetachLoadBalancersOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
