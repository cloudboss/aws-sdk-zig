...
fn serializeRequest(alloc: std.mem.Allocator, input: ExitStandbyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ExitStandby&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ExitStandbyOutput {
    _ = status;
    _ = headers;
