...
pub const RollbackDetails = struct {
    ...
    /// started.
    instances_to_update_on_rollback: ?i32,

    /// Indicates the value of `PercentageComplete` at the time the rollback
    /// started.
    percentage_complete_on_rollback: ?i32,
    ...
    /// (the live pool).
    progress_details_on_rollback: ?InstanceRefreshProgressDetails,
