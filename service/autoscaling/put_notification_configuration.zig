...
pub const PutNotificationConfigurationInput = struct {
    ...
    /// [DescribeAutoScalingNotificationTypes](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_DescribeAutoScalingNotificationTypes.html) API.
    notification_types: []const []const u8,

    /// The Amazon Resource Name (ARN) of the Amazon SNS topic.
    topic_arn: []const u8,
};

pub const PutNotificationConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutNotificationConfigurationInput, options: CallOptions) !PutNotificationConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutNotificationConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=PutNotificationConfiguration&Version=2011-01-01");
    ...
    for (input.notification_types, 0..) |item, idx| {
        const n = idx + 1;
        var prefix_buf: [256]u8 = undefined;
        const field_prefix = std.fmt.bufPrint(&prefix_buf, "&NotificationTypes.member.{d}=", .{n}) catch continue;
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutNotificationConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: PutNotificationConfigurationOutput = .{};
