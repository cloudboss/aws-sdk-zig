...
pub const AttachInstancesInput = struct {
...
pub const AttachInstancesOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachInstancesInput, options: CallOptions) !AttachInstancesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AttachInstances&Version=2011-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachInstancesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: AttachInstancesOutput = .{};
