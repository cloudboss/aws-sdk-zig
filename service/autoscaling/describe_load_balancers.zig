...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeLoadBalancersInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DescribeLoadBalancers&Version=2011-01-01");
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "LoadBalancers")) {
                    result.load_balancers = try serde.deserializeLoadBalancerStates(&reader, alloc, "member");
