...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AttachTrafficSourcesInput, options: Options) !AttachTrafficSourcesOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: AttachTrafficSourcesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AttachTrafficSources&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AttachTrafficSourcesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
