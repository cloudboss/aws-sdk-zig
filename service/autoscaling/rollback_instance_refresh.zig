...
fn serializeRequest(alloc: std.mem.Allocator, input: RollbackInstanceRefreshInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=RollbackInstanceRefresh&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RollbackInstanceRefreshOutput {
    _ = status;
    _ = headers;
