...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeNotificationConfigurationsInput, options: Options) !DescribeNotificationConfigurationsOutput {
