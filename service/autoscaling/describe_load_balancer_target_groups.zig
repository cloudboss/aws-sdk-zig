...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeLoadBalancerTargetGroupsInput, options: Options) !DescribeLoadBalancerTargetGroupsOutput {
