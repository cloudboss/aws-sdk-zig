...
pub const DeleteLaunchConfigurationInput = struct {
    /// The name of the launch configuration.
    launch_configuration_name: []const u8,
};

pub const DeleteLaunchConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteLaunchConfigurationInput, options: CallOptions) !DeleteLaunchConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteLaunchConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteLaunchConfiguration&Version=2011-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteLaunchConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteLaunchConfigurationOutput = .{};
