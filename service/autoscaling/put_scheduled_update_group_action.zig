...
pub const PutScheduledUpdateGroupActionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutScheduledUpdateGroupActionInput, options: CallOptions) !PutScheduledUpdateGroupActionOutput {
