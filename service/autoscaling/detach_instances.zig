...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachInstancesInput, options: CallOptions) !DetachInstancesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DetachInstances&Version=2011-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachInstancesOutput {
    _ = status;
    _ = headers;
