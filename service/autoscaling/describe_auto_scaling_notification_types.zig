...
const DescribeAutoScalingNotificationTypesInput = struct {};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeAutoScalingNotificationTypesInput, options: Options) !DescribeAutoScalingNotificationTypesOutput {
