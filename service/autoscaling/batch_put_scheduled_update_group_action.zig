...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchPutScheduledUpdateGroupActionInput, options: Options) !BatchPutScheduledUpdateGroupActionOutput {
