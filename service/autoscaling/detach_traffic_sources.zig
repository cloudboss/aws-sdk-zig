...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DetachTrafficSourcesInput, options: CallOptions) !DetachTrafficSourcesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DetachTrafficSourcesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DetachTrafficSources&Version=2011-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DetachTrafficSourcesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
