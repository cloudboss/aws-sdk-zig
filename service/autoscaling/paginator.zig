...
pub const DescribeAutoScalingGroupsPaginator = struct {
    client: *Client,
    params: describe_auto_scaling_groups.DescribeAutoScalingGroupsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_auto_scaling_groups.DescribeAutoScalingGroupsOutput {
        ...
        const output = try describe_auto_scaling_groups.execute(self.client, allocator, self.params, options);
...
pub const DescribeAutoScalingInstancesPaginator = struct {
    client: *Client,
    params: describe_auto_scaling_instances.DescribeAutoScalingInstancesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_auto_scaling_instances.DescribeAutoScalingInstancesOutput {
        ...
        const output = try describe_auto_scaling_instances.execute(self.client, allocator, self.params, options);
...
pub const DescribeInstanceRefreshesPaginator = struct {
    client: *Client,
    params: describe_instance_refreshes.DescribeInstanceRefreshesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_instance_refreshes.DescribeInstanceRefreshesOutput {
        ...
        const output = try describe_instance_refreshes.execute(self.client, allocator, self.params, options);
...
pub const DescribeLaunchConfigurationsPaginator = struct {
    client: *Client,
    params: describe_launch_configurations.DescribeLaunchConfigurationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_launch_configurations.DescribeLaunchConfigurationsOutput {
        ...
        const output = try describe_launch_configurations.execute(self.client, allocator, self.params, options);
...
pub const DescribeLoadBalancerTargetGroupsPaginator = struct {
    client: *Client,
    params: describe_load_balancer_target_groups.DescribeLoadBalancerTargetGroupsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_load_balancer_target_groups.DescribeLoadBalancerTargetGroupsOutput {
        ...
        const output = try describe_load_balancer_target_groups.execute(self.client, allocator, self.params, options);
...
pub const DescribeNotificationConfigurationsPaginator = struct {
    client: *Client,
    params: describe_notification_configurations.DescribeNotificationConfigurationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_notification_configurations.DescribeNotificationConfigurationsOutput {
        ...
        const output = try describe_notification_configurations.execute(self.client, allocator, self.params, options);
...
pub const DescribePoliciesPaginator = struct {
    client: *Client,
    params: describe_policies.DescribePoliciesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_policies.DescribePoliciesOutput {
        ...
        const output = try describe_policies.execute(self.client, allocator, self.params, options);
...
pub const DescribeScalingActivitiesPaginator = struct {
    client: *Client,
    params: describe_scaling_activities.DescribeScalingActivitiesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_scaling_activities.DescribeScalingActivitiesOutput {
        ...
        const output = try describe_scaling_activities.execute(self.client, allocator, self.params, options);
...
pub const DescribeTrafficSourcesPaginator = struct {
    client: *Client,
    params: describe_traffic_sources.DescribeTrafficSourcesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_traffic_sources.DescribeTrafficSourcesOutput {
        ...
        const output = try describe_traffic_sources.execute(self.client, allocator, self.params, options);
...
pub const DescribeWarmPoolPaginator = struct {
    client: *Client,
    params: describe_warm_pool.DescribeWarmPoolInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_warm_pool.DescribeWarmPoolOutput {
        ...
        const output = try describe_warm_pool.execute(self.client, allocator, self.params, options);
