...
fn serializeRequest(alloc: std.mem.Allocator, input: DetachLoadBalancerTargetGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DetachLoadBalancerTargetGroups&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DetachLoadBalancerTargetGroupsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
