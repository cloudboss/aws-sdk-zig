...
fn serializeRequest(alloc: std.mem.Allocator, input: AttachLoadBalancerTargetGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=AttachLoadBalancerTargetGroups&Version=2011-01-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !AttachLoadBalancerTargetGroupsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
