...
pub const AttachLoadBalancerTargetGroupsInput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AttachLoadBalancerTargetGroupsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AttachLoadBalancerTargetGroups&Version=2011-01-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AttachLoadBalancerTargetGroupsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: AttachLoadBalancerTargetGroupsOutput = .{};
