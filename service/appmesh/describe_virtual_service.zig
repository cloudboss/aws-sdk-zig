...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVirtualServiceInput, options: CallOptions) !DescribeVirtualServiceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeVirtualServiceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeVirtualServiceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
