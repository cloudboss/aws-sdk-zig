...
pub const DescribeVirtualServiceInput = struct {
...
pub const DescribeVirtualServiceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVirtualServiceInput, options: Options) !DescribeVirtualServiceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeVirtualServiceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.virtual_service_name);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeVirtualServiceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DescribeVirtualServiceOutput = .{};
