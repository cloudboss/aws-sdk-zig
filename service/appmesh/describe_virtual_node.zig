...
pub const DescribeVirtualNodeInput = struct {
...
pub const DescribeVirtualNodeOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVirtualNodeInput, options: Options) !DescribeVirtualNodeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeVirtualNodeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeVirtualNodeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DescribeVirtualNodeOutput = .{};
