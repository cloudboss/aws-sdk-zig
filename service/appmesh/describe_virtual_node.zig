...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVirtualNodeInput, options: CallOptions) !DescribeVirtualNodeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeVirtualNodeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeVirtualNodeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
