...
pub const DeleteVirtualGatewayInput = struct {
...
pub const DeleteVirtualGatewayOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVirtualGatewayInput, options: CallOptions) !DeleteVirtualGatewayOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVirtualGatewayInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVirtualGatewayOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVirtualGatewayOutput = .{};
