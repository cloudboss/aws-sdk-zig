...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeRouteInput, options: CallOptions) !DescribeRouteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeRouteInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.route_name);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeRouteOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
