...
pub const DescribeVirtualGatewayInput = struct {
...
pub const DescribeVirtualGatewayOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeVirtualGatewayInput, options: CallOptions) !DescribeVirtualGatewayOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeVirtualGatewayInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeVirtualGatewayOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DescribeVirtualGatewayOutput = .{};
