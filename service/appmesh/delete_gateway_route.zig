...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGatewayRouteInput, options: Options) !DeleteGatewayRouteOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteGatewayRouteInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteGatewayRouteOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
