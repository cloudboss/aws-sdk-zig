...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateVirtualGatewayInput, options: Options) !UpdateVirtualGatewayOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateVirtualGatewayInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateVirtualGatewayOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
