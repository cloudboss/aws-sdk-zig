...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateGatewayRouteInput, options: CallOptions) !UpdateGatewayRouteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateGatewayRouteInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateGatewayRouteOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
