...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeGatewayRouteInput, options: CallOptions) !DescribeGatewayRouteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeGatewayRouteInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeGatewayRouteOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
