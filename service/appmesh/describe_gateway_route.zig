...
pub const DescribeGatewayRouteInput = struct {
...
pub const DescribeGatewayRouteOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeGatewayRouteInput, options: Options) !DescribeGatewayRouteOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeGatewayRouteInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DescribeGatewayRouteOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DescribeGatewayRouteOutput = .{};
