...
pub const DescribeMeshInput = struct {
...
pub const DescribeMeshOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeMeshInput, options: CallOptions) !DescribeMeshOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeMeshInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeMeshOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DescribeMeshOutput = .{};
