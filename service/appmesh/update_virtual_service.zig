...
pub const UpdateVirtualServiceInput = struct {
...
pub const UpdateVirtualServiceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateVirtualServiceInput, options: Options) !UpdateVirtualServiceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateVirtualServiceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateVirtualServiceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateVirtualServiceOutput = .{};
