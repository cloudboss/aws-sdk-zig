...
pub const DeleteVirtualNodeInput = struct {
...
pub const DeleteVirtualNodeOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVirtualNodeInput, options: Options) !DeleteVirtualNodeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVirtualNodeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteVirtualNodeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVirtualNodeOutput = .{};
