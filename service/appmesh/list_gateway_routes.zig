...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListGatewayRoutesInput, options: CallOptions) !ListGatewayRoutesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListGatewayRoutesInput, config: *aws.Config) !aws.http.Request {
