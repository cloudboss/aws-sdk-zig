...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVirtualServiceInput, options: Options) !DeleteVirtualServiceOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteVirtualServiceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteVirtualServiceOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
