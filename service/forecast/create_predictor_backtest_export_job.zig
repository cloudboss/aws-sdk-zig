...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreatePredictorBacktestExportJobInput, options: Options) !CreatePredictorBacktestExportJobOutput {
