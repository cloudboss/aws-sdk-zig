...
pub const CreatePredictorBacktestExportJobInput = struct {
...
pub const CreatePredictorBacktestExportJobOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreatePredictorBacktestExportJobInput, options: CallOptions) !CreatePredictorBacktestExportJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreatePredictorBacktestExportJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonForecast.CreatePredictorBacktestExportJob");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreatePredictorBacktestExportJobOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreatePredictorBacktestExportJobOutput, body, allocator);
}
