...
pub const DescribeWhatIfForecastExportInput = struct {
...
pub const DescribeWhatIfForecastExportOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeWhatIfForecastExportInput, options: CallOptions) !DescribeWhatIfForecastExportOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeWhatIfForecastExportInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AmazonForecast.DescribeWhatIfForecastExport");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeWhatIfForecastExportOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeWhatIfForecastExportOutput, body, allocator);
}
