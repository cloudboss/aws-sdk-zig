...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AutocompleteInput, options: CallOptions) !AutocompleteOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AutocompleteInput, config: *aws.Config) !aws.http.Request {
