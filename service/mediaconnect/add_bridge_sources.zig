...
pub const AddBridgeSourcesInput = struct {
...
pub const AddBridgeSourcesOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddBridgeSourcesInput, options: CallOptions) !AddBridgeSourcesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddBridgeSourcesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddBridgeSourcesOutput {
    var result: AddBridgeSourcesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(AddBridgeSourcesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
