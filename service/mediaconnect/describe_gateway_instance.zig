...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeGatewayInstanceInput, options: CallOptions) !DescribeGatewayInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeGatewayInstanceInput, config: *aws.Config) !aws.http.Request {
