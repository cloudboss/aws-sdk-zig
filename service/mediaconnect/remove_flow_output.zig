...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveFlowOutputInput, options: Options) !RemoveFlowOutputOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveFlowOutputInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RemoveFlowOutputOutput {
    var result: RemoveFlowOutputOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(RemoveFlowOutputOutput, body, alloc);
    }
    _ = status;
    _ = headers;
