...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteBridgeInput, options: CallOptions) !DeleteBridgeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteBridgeInput, config: *aws.Config) !aws.http.Request {
