...
pub const ListTagsForGlobalResourceInput = struct {
...
pub const ListTagsForGlobalResourceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTagsForGlobalResourceInput, options: CallOptions) !ListTagsForGlobalResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTagsForGlobalResourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/tags/global/");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListTagsForGlobalResourceOutput {
    var result: ListTagsForGlobalResourceOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListTagsForGlobalResourceOutput, body, allocator);
    }
    _ = status;
    _ = headers;
