...
pub const UntagGlobalResourceInput = struct {
...
pub const UntagGlobalResourceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UntagGlobalResourceInput, options: CallOptions) !UntagGlobalResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UntagGlobalResourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UntagGlobalResourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UntagGlobalResourceOutput = .{};
