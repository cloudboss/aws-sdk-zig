...
pub const Client = struct {
    ...
    pub fn addBridgeOutputs(self: *Self, allocator: std.mem.Allocator, input: add_bridge_outputs.AddBridgeOutputsInput, options: add_bridge_outputs.Options) !add_bridge_outputs.AddBridgeOutputsOutput {
        return add_bridge_outputs.execute(self, allocator, input, options);
    }

    /// Adds sources to an existing bridge.
    pub fn addBridgeSources(self: *Self, allocator: std.mem.Allocator, input: add_bridge_sources.AddBridgeSourcesInput, options: add_bridge_sources.Options) !add_bridge_sources.AddBridgeSourcesOutput {
    ...
    pub fn addFlowMediaStreams(self: *Self, allocator: std.mem.Allocator, input: add_flow_media_streams.AddFlowMediaStreamsInput, options: add_flow_media_streams.Options) !add_flow_media_streams.AddFlowMediaStreamsOutput {
        return add_flow_media_streams.execute(self, allocator, input, options);
    }

    /// Adds outputs to an existing flow. You can create up to 50 outputs per flow.
    pub fn addFlowOutputs(self: *Self, allocator: std.mem.Allocator, input: add_flow_outputs.AddFlowOutputsInput, options: add_flow_outputs.Options) !add_flow_outputs.AddFlowOutputsOutput {
        return add_flow_outputs.execute(self, allocator, input, options);
    }

    /// Adds sources to a flow.
    pub fn addFlowSources(self: *Self, allocator: std.mem.Allocator, input: add_flow_sources.AddFlowSourcesInput, options: add_flow_sources.Options) !add_flow_sources.AddFlowSourcesOutput {
        return add_flow_sources.execute(self, allocator, input, options);
    }

    /// Adds VPC interfaces to a flow.
    pub fn addFlowVpcInterfaces(self: *Self, allocator: std.mem.Allocator, input: add_flow_vpc_interfaces.AddFlowVpcInterfacesInput, options: add_flow_vpc_interfaces.Options) !add_flow_vpc_interfaces.AddFlowVpcInterfacesOutput {
    ...
    /// MediaConnect.
    pub fn batchGetRouterInput(self: *Self, allocator: std.mem.Allocator, input: batch_get_router_input.BatchGetRouterInputInput, options: batch_get_router_input.Options) !batch_get_router_input.BatchGetRouterInputOutput {
    ...
    pub fn batchGetRouterNetworkInterface(self: *Self, allocator: std.mem.Allocator, input: batch_get_router_network_interface.BatchGetRouterNetworkInterfaceInput, options: batch_get_router_network_interface.Options) !batch_get_router_network_interface.BatchGetRouterNetworkInterfaceOutput {
    ...
    /// MediaConnect.
    pub fn batchGetRouterOutput(self: *Self, allocator: std.mem.Allocator, input: batch_get_router_output.BatchGetRouterOutputInput, options: batch_get_router_output.Options) !batch_get_router_output.BatchGetRouterOutputOutput {
        return batch_get_router_output.execute(self, allocator, input, options);
    }

    /// Creates a new bridge. The request must include one source.
    pub fn createBridge(self: *Self, allocator: std.mem.Allocator, input: create_bridge.CreateBridgeInput, options: create_bridge.Options) !create_bridge.CreateBridgeOutput {
    ...
    pub fn createRouterInput(self: *Self, allocator: std.mem.Allocator, input: create_router_input.CreateRouterInputInput, options: create_router_input.Options) !create_router_input.CreateRouterInputOutput {
    ...
    pub fn createRouterNetworkInterface(self: *Self, allocator: std.mem.Allocator, input: create_router_network_interface.CreateRouterNetworkInterfaceInput, options: create_router_network_interface.Options) !create_router_network_interface.CreateRouterNetworkInterfaceOutput {
    ...
    pub fn createRouterOutput(self: *Self, allocator: std.mem.Allocator, input: create_router_output.CreateRouterOutputInput, options: create_router_output.Options) !create_router_output.CreateRouterOutputOutput {
        return create_router_output.execute(self, allocator, input, options);
    }

    /// Deletes a bridge. Before you can delete a bridge, you must stop the bridge.
    pub fn deleteBridge(self: *Self, allocator: std.mem.Allocator, input: delete_bridge.DeleteBridgeInput, options: delete_bridge.Options) !delete_bridge.DeleteBridgeOutput {
    ...
    pub fn deleteRouterInput(self: *Self, allocator: std.mem.Allocator, input: delete_router_input.DeleteRouterInputInput, options: delete_router_input.Options) !delete_router_input.DeleteRouterInputOutput {
    ...
    pub fn deleteRouterNetworkInterface(self: *Self, allocator: std.mem.Allocator, input: delete_router_network_interface.DeleteRouterNetworkInterfaceInput, options: delete_router_network_interface.Options) !delete_router_network_interface.DeleteRouterNetworkInterfaceOutput {
    ...
    pub fn deleteRouterOutput(self: *Self, allocator: std.mem.Allocator, input: delete_router_output.DeleteRouterOutputInput, options: delete_router_output.Options) !delete_router_output.DeleteRouterOutputOutput {
    ...
    pub fn deregisterGatewayInstance(self: *Self, allocator: std.mem.Allocator, input: deregister_gateway_instance.DeregisterGatewayInstanceInput, options: deregister_gateway_instance.Options) !deregister_gateway_instance.DeregisterGatewayInstanceOutput {
        return deregister_gateway_instance.execute(self, allocator, input, options);
    }

    /// Displays the details of a bridge.
    pub fn describeBridge(self: *Self, allocator: std.mem.Allocator, input: describe_bridge.DescribeBridgeInput, options: describe_bridge.Options) !describe_bridge.DescribeBridgeOutput {
    ...
    pub fn describeFlowSourceMetadata(self: *Self, allocator: std.mem.Allocator, input: describe_flow_source_metadata.DescribeFlowSourceMetadataInput, options: describe_flow_source_metadata.Options) !describe_flow_source_metadata.DescribeFlowSourceMetadataOutput {
        return describe_flow_source_metadata.execute(self, allocator, input, options);
    }

    /// Describes the thumbnail for the flow source.
    pub fn describeFlowSourceThumbnail(self: *Self, allocator: std.mem.Allocator, input: describe_flow_source_thumbnail.DescribeFlowSourceThumbnailInput, options: describe_flow_source_thumbnail.Options) !describe_flow_source_thumbnail.DescribeFlowSourceThumbnailOutput {
    ...
    pub fn describeGatewayInstance(self: *Self, allocator: std.mem.Allocator, input: describe_gateway_instance.DescribeGatewayInstanceInput, options: describe_gateway_instance.Options) !describe_gateway_instance.DescribeGatewayInstanceOutput {
    ...
    /// MediaConnect.
    pub fn getRouterInput(self: *Self, allocator: std.mem.Allocator, input: get_router_input.GetRouterInputInput, options: get_router_input.Options) !get_router_input.GetRouterInputOutput {
    ...
    pub fn getRouterInputSourceMetadata(self: *Self, allocator: std.mem.Allocator, input: get_router_input_source_metadata.GetRouterInputSourceMetadataInput, options: get_router_input_source_metadata.Options) !get_router_input_source_metadata.GetRouterInputSourceMetadataOutput {
    ...
    pub fn getRouterInputThumbnail(self: *Self, allocator: std.mem.Allocator, input: get_router_input_thumbnail.GetRouterInputThumbnailInput, options: get_router_input_thumbnail.Options) !get_router_input_thumbnail.GetRouterInputThumbnailOutput {
    ...
    /// Elemental MediaConnect.
    pub fn getRouterNetworkInterface(self: *Self, allocator: std.mem.Allocator, input: get_router_network_interface.GetRouterNetworkInterfaceInput, options: get_router_network_interface.Options) !get_router_network_interface.GetRouterNetworkInterfaceOutput {
    ...
    /// MediaConnect.
    pub fn getRouterOutput(self: *Self, allocator: std.mem.Allocator, input: get_router_output.GetRouterOutputInput, options: get_router_output.Options) !get_router_output.GetRouterOutputOutput {
        return get_router_output.execute(self, allocator, input, options);
    }

    /// Grants entitlements to an existing flow.
    pub fn grantFlowEntitlements(self: *Self, allocator: std.mem.Allocator, input: grant_flow_entitlements.GrantFlowEntitlementsInput, options: grant_flow_entitlements.Options) !grant_flow_entitlements.GrantFlowEntitlementsOutput {
    ...
    /// paginated result.
    pub fn listBridges(self: *Self, allocator: std.mem.Allocator, input: list_bridges.ListBridgesInput, options: list_bridges.Options) !list_bridges.ListBridgesOutput {
        return list_bridges.execute(self, allocator, input, options);
    }

    /// Displays a list of all entitlements that have been granted to this account.
    /// This request returns 20 results per page.
    pub fn listEntitlements(self: *Self, allocator: std.mem.Allocator, input: list_entitlements.ListEntitlementsInput, options: list_entitlements.Options) !list_entitlements.ListEntitlementsOutput {
    ...
    pub fn listGatewayInstances(self: *Self, allocator: std.mem.Allocator, input: list_gateway_instances.ListGatewayInstancesInput, options: list_gateway_instances.Options) !list_gateway_instances.ListGatewayInstancesOutput {
    ...
    pub fn listRouterInputs(self: *Self, allocator: std.mem.Allocator, input: list_router_inputs.ListRouterInputsInput, options: list_router_inputs.Options) !list_router_inputs.ListRouterInputsOutput {
    ...
    pub fn listRouterNetworkInterfaces(self: *Self, allocator: std.mem.Allocator, input: list_router_network_interfaces.ListRouterNetworkInterfacesInput, options: list_router_network_interfaces.Options) !list_router_network_interfaces.ListRouterNetworkInterfacesOutput {
    ...
    pub fn listRouterOutputs(self: *Self, allocator: std.mem.Allocator, input: list_router_outputs.ListRouterOutputsInput, options: list_router_outputs.Options) !list_router_outputs.ListRouterOutputsOutput {
    ...
    pub fn listTagsForGlobalResource(self: *Self, allocator: std.mem.Allocator, input: list_tags_for_global_resource.ListTagsForGlobalResourceInput, options: list_tags_for_global_resource.Options) !list_tags_for_global_resource.ListTagsForGlobalResourceOutput {
    ...
    pub fn removeBridgeOutput(self: *Self, allocator: std.mem.Allocator, input: remove_bridge_output.RemoveBridgeOutputInput, options: remove_bridge_output.Options) !remove_bridge_output.RemoveBridgeOutputOutput {
        return remove_bridge_output.execute(self, allocator, input, options);
    }

    /// Removes a source from a bridge.
    pub fn removeBridgeSource(self: *Self, allocator: std.mem.Allocator, input: remove_bridge_source.RemoveBridgeSourceInput, options: remove_bridge_source.Options) !remove_bridge_source.RemoveBridgeSourceOutput {
    ...
    pub fn removeFlowMediaStream(self: *Self, allocator: std.mem.Allocator, input: remove_flow_media_stream.RemoveFlowMediaStreamInput, options: remove_flow_media_stream.Options) !remove_flow_media_stream.RemoveFlowMediaStreamOutput {
    ...
    /// associated output.
    pub fn removeFlowOutput(self: *Self, allocator: std.mem.Allocator, input: remove_flow_output.RemoveFlowOutputInput, options: remove_flow_output.Options) !remove_flow_output.RemoveFlowOutputOutput {
    ...
    pub fn removeFlowSource(self: *Self, allocator: std.mem.Allocator, input: remove_flow_source.RemoveFlowSourceInput, options: remove_flow_source.Options) !remove_flow_source.RemoveFlowSourceOutput {
    ...
    /// interface.
    pub fn removeFlowVpcInterface(self: *Self, allocator: std.mem.Allocator, input: remove_flow_vpc_interface.RemoveFlowVpcInterfaceInput, options: remove_flow_vpc_interface.Options) !remove_flow_vpc_interface.RemoveFlowVpcInterfaceOutput {
    ...
    pub fn restartRouterInput(self: *Self, allocator: std.mem.Allocator, input: restart_router_input.RestartRouterInputInput, options: restart_router_input.Options) !restart_router_input.RestartRouterInputOutput {
    ...
    pub fn restartRouterOutput(self: *Self, allocator: std.mem.Allocator, input: restart_router_output.RestartRouterOutputInput, options: restart_router_output.Options) !restart_router_output.RestartRouterOutputOutput {
    ...
    /// removed.
    pub fn revokeFlowEntitlement(self: *Self, allocator: std.mem.Allocator, input: revoke_flow_entitlement.RevokeFlowEntitlementInput, options: revoke_flow_entitlement.Options) !revoke_flow_entitlement.RevokeFlowEntitlementOutput {
    ...
    pub fn startRouterInput(self: *Self, allocator: std.mem.Allocator, input: start_router_input.StartRouterInputInput, options: start_router_input.Options) !start_router_input.StartRouterInputOutput {
        return start_router_input.execute(self, allocator, input, options);
    }

    /// Starts a router output in AWS Elemental MediaConnect.
    pub fn startRouterOutput(self: *Self, allocator: std.mem.Allocator, input: start_router_output.StartRouterOutputInput, options: start_router_output.Options) !start_router_output.StartRouterOutputOutput {
    ...
    pub fn stopRouterInput(self: *Self, allocator: std.mem.Allocator, input: stop_router_input.StopRouterInputInput, options: stop_router_input.Options) !stop_router_input.StopRouterInputOutput {
        return stop_router_input.execute(self, allocator, input, options);
    }

    /// Stops a router output in AWS Elemental MediaConnect.
    pub fn stopRouterOutput(self: *Self, allocator: std.mem.Allocator, input: stop_router_output.StopRouterOutputInput, options: stop_router_output.Options) !stop_router_output.StopRouterOutputOutput {
    ...
    pub fn tagGlobalResource(self: *Self, allocator: std.mem.Allocator, input: tag_global_resource.TagGlobalResourceInput, options: tag_global_resource.Options) !tag_global_resource.TagGlobalResourceOutput {
    ...
    /// MediaConnect.
    pub fn takeRouterInput(self: *Self, allocator: std.mem.Allocator, input: take_router_input.TakeRouterInputInput, options: take_router_input.Options) !take_router_input.TakeRouterInputOutput {
    ...
    /// supports the following global resources: router inputs, router outputs and
    /// router network interfaces.
    pub fn untagGlobalResource(self: *Self, allocator: std.mem.Allocator, input: untag_global_resource.UntagGlobalResourceInput, options: untag_global_resource.Options) !untag_global_resource.UntagGlobalResourceOutput {
    ...
    /// Updates the bridge.
    pub fn updateBridge(self: *Self, allocator: std.mem.Allocator, input: update_bridge.UpdateBridgeInput, options: update_bridge.Options) !update_bridge.UpdateBridgeOutput {
        return update_bridge.execute(self, allocator, input, options);
    }

    /// Updates an existing bridge output.
    pub fn updateBridgeOutput(self: *Self, allocator: std.mem.Allocator, input: update_bridge_output.UpdateBridgeOutputInput, options: update_bridge_output.Options) !update_bridge_output.UpdateBridgeOutputOutput {
        return update_bridge_output.execute(self, allocator, input, options);
    }

    /// Updates an existing bridge source.
    pub fn updateBridgeSource(self: *Self, allocator: std.mem.Allocator, input: update_bridge_source.UpdateBridgeSourceInput, options: update_bridge_source.Options) !update_bridge_source.UpdateBridgeSourceOutput {
        return update_bridge_source.execute(self, allocator, input, options);
    }

    /// Updates the bridge state.
    pub fn updateBridgeState(self: *Self, allocator: std.mem.Allocator, input: update_bridge_state.UpdateBridgeStateInput, options: update_bridge_state.Options) !update_bridge_state.UpdateBridgeStateOutput {
    ...
    pub fn updateFlowEntitlement(self: *Self, allocator: std.mem.Allocator, input: update_flow_entitlement.UpdateFlowEntitlementInput, options: update_flow_entitlement.Options) !update_flow_entitlement.UpdateFlowEntitlementOutput {
        return update_flow_entitlement.execute(self, allocator, input, options);
    }

    /// Updates an existing media stream.
    pub fn updateFlowMediaStream(self: *Self, allocator: std.mem.Allocator, input: update_flow_media_stream.UpdateFlowMediaStreamInput, options: update_flow_media_stream.Options) !update_flow_media_stream.UpdateFlowMediaStreamOutput {
        return update_flow_media_stream.execute(self, allocator, input, options);
    }

    /// Updates an existing flow output.
    pub fn updateFlowOutput(self: *Self, allocator: std.mem.Allocator, input: update_flow_output.UpdateFlowOutputInput, options: update_flow_output.Options) !update_flow_output.UpdateFlowOutputOutput {
    ...
    /// * After that, you can then use the `UpdateFlow` operation to downgrade the
    ///   flow size to `MEDIUM`.
    pub fn updateFlowSource(self: *Self, allocator: std.mem.Allocator, input: update_flow_source.UpdateFlowSourceInput, options: update_flow_source.Options) !update_flow_source.UpdateFlowSourceOutput {
        return update_flow_source.execute(self, allocator, input, options);
    }

    /// Updates an existing gateway instance.
    pub fn updateGatewayInstance(self: *Self, allocator: std.mem.Allocator, input: update_gateway_instance.UpdateGatewayInstanceInput, options: update_gateway_instance.Options) !update_gateway_instance.UpdateGatewayInstanceOutput {
    ...
    /// MediaConnect.
    pub fn updateRouterInput(self: *Self, allocator: std.mem.Allocator, input: update_router_input.UpdateRouterInputInput, options: update_router_input.Options) !update_router_input.UpdateRouterInputOutput {
    ...
    /// Elemental MediaConnect.
    pub fn updateRouterNetworkInterface(self: *Self, allocator: std.mem.Allocator, input: update_router_network_interface.UpdateRouterNetworkInterfaceInput, options: update_router_network_interface.Options) !update_router_network_interface.UpdateRouterNetworkInterfaceOutput {
    ...
    /// MediaConnect.
    pub fn updateRouterOutput(self: *Self, allocator: std.mem.Allocator, input: update_router_output.UpdateRouterOutputInput, options: update_router_output.Options) !update_router_output.UpdateRouterOutputOutput {
