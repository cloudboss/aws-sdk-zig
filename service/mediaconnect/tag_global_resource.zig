...
pub const TagGlobalResourceInput = struct {
...
pub const TagGlobalResourceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: TagGlobalResourceInput, options: CallOptions) !TagGlobalResourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: TagGlobalResourceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !TagGlobalResourceOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: TagGlobalResourceOutput = .{};
