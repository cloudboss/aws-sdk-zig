...
pub const DeregisterGatewayInstanceInput = struct {
...
pub const DeregisterGatewayInstanceOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeregisterGatewayInstanceInput, options: CallOptions) !DeregisterGatewayInstanceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeregisterGatewayInstanceInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeregisterGatewayInstanceOutput {
    var result: DeregisterGatewayInstanceOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(DeregisterGatewayInstanceOutput, body, allocator);
    }
    _ = status;
    _ = headers;
