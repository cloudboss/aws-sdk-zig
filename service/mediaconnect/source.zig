...
pub const Source = struct {
    ...
    connected_router_output_arn: ?[]const u8 = null,
    ...
    gateway_bridge_source: ?GatewayBridgeSource = null,

    /// The IP address that the flow will be listening on for incoming content.
    ingest_ip: ?[]const u8 = null,
    ...
    media_stream_source_configurations: ?[]const MediaStreamSourceConfiguration = null,
