...
const ListedGatewayInstance = @import("listed_gateway_instance.zig").ListedGatewayInstance;

pub const ListGatewayInstancesInput = struct {
...
pub const ListGatewayInstancesOutput = struct {
    /// A list of instance summaries.
    instances: ?[]const ListedGatewayInstance = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListGatewayInstancesInput, options: CallOptions) !ListGatewayInstancesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListGatewayInstancesInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/v1/gateway-instances";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListGatewayInstancesOutput {
    var result: ListGatewayInstancesOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListGatewayInstancesOutput, body, allocator);
    }
    _ = status;
    _ = headers;
