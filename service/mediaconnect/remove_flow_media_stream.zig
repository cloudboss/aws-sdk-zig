...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveFlowMediaStreamInput, options: CallOptions) !RemoveFlowMediaStreamOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveFlowMediaStreamInput, config: *aws.Config) !aws.http.Request {
