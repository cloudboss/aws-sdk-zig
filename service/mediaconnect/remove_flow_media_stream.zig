...
pub const RemoveFlowMediaStreamInput = struct {
...
pub const RemoveFlowMediaStreamOutput = struct {
    /// The ARN of the flow that was updated.
    flow_arn: ?[]const u8 = null,

    /// The name of the media stream that was removed.
    media_stream_name: ?[]const u8 = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveFlowMediaStreamInput, options: Options) !RemoveFlowMediaStreamOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: RemoveFlowMediaStreamInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !RemoveFlowMediaStreamOutput {
    var result: RemoveFlowMediaStreamOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(RemoveFlowMediaStreamOutput, body, alloc);
    }
    _ = status;
    _ = headers;
