...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateBridgeOutputInput, options: CallOptions) !UpdateBridgeOutputOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateBridgeOutputInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.output_name);
    ...
    if (input.network_output) |v| {
        ...
        try body_buf.appendSlice(allocator, "\"NetworkOutput\":");
