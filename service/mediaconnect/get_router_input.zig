...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRouterInputInput, options: CallOptions) !GetRouterInputOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetRouterInputInput, config: *aws.Config) !aws.http.Request {
