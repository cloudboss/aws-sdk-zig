...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RemoveBridgeSourceInput, options: CallOptions) !RemoveBridgeSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RemoveBridgeSourceInput, config: *aws.Config) !aws.http.Request {
