...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestartRouterInputInput, options: CallOptions) !RestartRouterInputOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RestartRouterInputInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/v1/routerInput/restart/");
