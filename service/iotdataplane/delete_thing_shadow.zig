...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteThingShadowInput, options: CallOptions) !DeleteThingShadowOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteThingShadowInput, config: *aws.Config) !aws.http.Request {
