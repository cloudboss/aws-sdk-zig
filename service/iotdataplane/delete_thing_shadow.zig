...
pub const DeleteThingShadowInput = struct {
...
pub const DeleteThingShadowOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteThingShadowInput, options: Options) !DeleteThingShadowOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteThingShadowInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteThingShadowOutput {
