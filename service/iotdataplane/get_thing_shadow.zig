...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetThingShadowInput, options: Options) !GetThingShadowOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetThingShadowInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/shadow");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetThingShadowOutput {
