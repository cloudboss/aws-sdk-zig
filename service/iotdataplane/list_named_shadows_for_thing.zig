...
pub const ListNamedShadowsForThingInput = struct {
...
pub const ListNamedShadowsForThingOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListNamedShadowsForThingInput, options: Options) !ListNamedShadowsForThingOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListNamedShadowsForThingInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/api/things/shadow/ListNamedShadowsForThing/");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListNamedShadowsForThingOutput {
    var result: ListNamedShadowsForThingOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListNamedShadowsForThingOutput, body, alloc);
    }
    _ = status;
    _ = headers;
