...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListNamedShadowsForThingInput, options: CallOptions) !ListNamedShadowsForThingOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListNamedShadowsForThingInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/api/things/shadow/ListNamedShadowsForThing/");
