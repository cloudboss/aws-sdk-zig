...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartAssessmentRunInput, options: Options) !StartAssessmentRunOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: StartAssessmentRunInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "InspectorService.StartAssessmentRun");
