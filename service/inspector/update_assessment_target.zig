...
const UpdateAssessmentTargetOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateAssessmentTargetInput, options: Options) !UpdateAssessmentTargetOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateAssessmentTargetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "InspectorService.UpdateAssessmentTarget");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateAssessmentTargetOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
