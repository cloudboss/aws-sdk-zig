...
pub const CreateExclusionsPreviewInput = struct {
...
pub const CreateExclusionsPreviewOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateExclusionsPreviewInput, options: CallOptions) !CreateExclusionsPreviewOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateExclusionsPreviewInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "InspectorService.CreateExclusionsPreview");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateExclusionsPreviewOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(CreateExclusionsPreviewOutput, body, allocator);
}
