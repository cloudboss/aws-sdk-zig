...
pub const StartSentimentDetectionJobInput = struct {
...
pub const StartSentimentDetectionJobOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartSentimentDetectionJobInput, options: CallOptions) !StartSentimentDetectionJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartSentimentDetectionJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.StartSentimentDetectionJob");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartSentimentDetectionJobOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(StartSentimentDetectionJobOutput, body, allocator);
}
