...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopTargetedSentimentDetectionJobInput, options: Options) !StopTargetedSentimentDetectionJobOutput {
