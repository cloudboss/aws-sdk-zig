...
const BatchDetectSentimentItemResult = @import("batch_detect_sentiment_item_result.zig").BatchDetectSentimentItemResult;

pub const BatchDetectSentimentInput = struct {
...
pub const BatchDetectSentimentOutput = struct {
    ...
    result_list: ?[]const BatchDetectSentimentItemResult = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: BatchDetectSentimentInput, options: CallOptions) !BatchDetectSentimentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: BatchDetectSentimentInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.BatchDetectSentiment");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !BatchDetectSentimentOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(BatchDetectSentimentOutput, body, allocator);
}
