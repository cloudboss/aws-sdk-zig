...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeKeyPhrasesDetectionJobInput, options: Options) !DescribeKeyPhrasesDetectionJobOutput {
