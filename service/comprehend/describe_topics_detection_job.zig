...
pub const DescribeTopicsDetectionJobInput = struct {
...
pub const DescribeTopicsDetectionJobOutput = struct {
    /// The list of properties for the requested job.
    topics_detection_job_properties: ?TopicsDetectionJobProperties = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeTopicsDetectionJobInput, options: CallOptions) !DescribeTopicsDetectionJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeTopicsDetectionJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.DescribeTopicsDetectionJob");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DescribeTopicsDetectionJobOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(DescribeTopicsDetectionJobOutput, body, allocator);
}
