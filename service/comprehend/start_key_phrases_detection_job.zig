...
pub const StartKeyPhrasesDetectionJobInput = struct {
...
pub const StartKeyPhrasesDetectionJobOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartKeyPhrasesDetectionJobInput, options: CallOptions) !StartKeyPhrasesDetectionJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartKeyPhrasesDetectionJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.StartKeyPhrasesDetectionJob");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartKeyPhrasesDetectionJobOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(StartKeyPhrasesDetectionJobOutput, body, allocator);
}
