...
fn serializeRequest(alloc: std.mem.Allocator, input: StopTrainingEntityRecognizerInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Comprehend_20171127.StopTrainingEntityRecognizer");

    return request;
}

fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !StopTrainingEntityRecognizerOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
