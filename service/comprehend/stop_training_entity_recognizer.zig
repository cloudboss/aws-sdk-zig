...
pub const StopTrainingEntityRecognizerInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopTrainingEntityRecognizerInput, options: Options) !StopTrainingEntityRecognizerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopTrainingEntityRecognizerInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.StopTrainingEntityRecognizer");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopTrainingEntityRecognizerOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
