...
pub const StopPiiEntitiesDetectionJobInput = struct {
...
pub const StopPiiEntitiesDetectionJobOutput = struct {
    /// The identifier of the PII entities detection job to stop.
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopPiiEntitiesDetectionJobInput, options: CallOptions) !StopPiiEntitiesDetectionJobOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopPiiEntitiesDetectionJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.StopPiiEntitiesDetectionJob");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopPiiEntitiesDetectionJobOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(StopPiiEntitiesDetectionJobOutput, body, allocator);
}
