...
pub const StopTrainingDocumentClassifierInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopTrainingDocumentClassifierInput, options: Options) !StopTrainingDocumentClassifierOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopTrainingDocumentClassifierInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Comprehend_20171127.StopTrainingDocumentClassifier");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopTrainingDocumentClassifierOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
