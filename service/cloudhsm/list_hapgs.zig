...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListHapgsInput, options: Options) !ListHapgsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListHapgsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "CloudHsmFrontendService.ListHapgs");
