...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfigurationInput, options: CallOptions) !DeleteConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfigurationInput, config: *aws.Config) !aws.http.Request {
