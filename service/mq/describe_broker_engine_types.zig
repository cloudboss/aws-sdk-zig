...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeBrokerEngineTypesInput, options: CallOptions) !DescribeBrokerEngineTypesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DescribeBrokerEngineTypesInput, config: *aws.Config) !aws.http.Request {
