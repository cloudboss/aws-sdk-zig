...
pub const Client = struct {
    ...
    pub fn getReport(self: *Self, allocator: std.mem.Allocator, input: get_report.GetReportInput, options: get_report.Options) !get_report.GetReportOutput {
        return get_report.execute(self, allocator, input, options);
    }

    /// Get the metadata for a single report.
    pub fn getReportMetadata(self: *Self, allocator: std.mem.Allocator, input: get_report_metadata.GetReportMetadataInput, options: get_report_metadata.Options) !get_report_metadata.GetReportMetadataOutput {
        return get_report_metadata.execute(self, allocator, input, options);
    }

    /// Get the Term content associated with a single report.
    pub fn getTermForReport(self: *Self, allocator: std.mem.Allocator, input: get_term_for_report.GetTermForReportInput, options: get_term_for_report.Options) !get_term_for_report.GetTermForReportOutput {
        return get_term_for_report.execute(self, allocator, input, options);
    }

    /// List active customer-agreements applicable to calling identity.
    pub fn listCustomerAgreements(self: *Self, allocator: std.mem.Allocator, input: list_customer_agreements.ListCustomerAgreementsInput, options: list_customer_agreements.Options) !list_customer_agreements.ListCustomerAgreementsOutput {
        return list_customer_agreements.execute(self, allocator, input, options);
    }

    /// List available report versions for a given report.
    pub fn listReportVersions(self: *Self, allocator: std.mem.Allocator, input: list_report_versions.ListReportVersionsInput, options: list_report_versions.Options) !list_report_versions.ListReportVersionsOutput {
    ...
    pub fn putAccountSettings(self: *Self, allocator: std.mem.Allocator, input: put_account_settings.PutAccountSettingsInput, options: put_account_settings.Options) !put_account_settings.PutAccountSettingsOutput {
