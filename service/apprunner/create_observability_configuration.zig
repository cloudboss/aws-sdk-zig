...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateObservabilityConfigurationInput, options: Options) !CreateObservabilityConfigurationOutput {
