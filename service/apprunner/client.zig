...
pub const Client = struct {
    ...
    pub fn associateCustomDomain(self: *Self, allocator: std.mem.Allocator, input: associate_custom_domain.AssociateCustomDomainInput, options: CallOptions) !associate_custom_domain.AssociateCustomDomainOutput {
    ...
    pub fn createAutoScalingConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_auto_scaling_configuration.CreateAutoScalingConfigurationInput, options: CallOptions) !create_auto_scaling_configuration.CreateAutoScalingConfigurationOutput {
    ...
    pub fn createObservabilityConfiguration(self: *Self, allocator: std.mem.Allocator, input: create_observability_configuration.CreateObservabilityConfigurationInput, options: CallOptions) !create_observability_configuration.CreateObservabilityConfigurationOutput {
    ...
    /// (Amazon VPC).
    pub fn createVpcConnector(self: *Self, allocator: std.mem.Allocator, input: create_vpc_connector.CreateVpcConnectorInput, options: CallOptions) !create_vpc_connector.CreateVpcConnectorOutput {
    ...
    /// Amazon VPC endpoint.
    pub fn createVpcIngressConnection(self: *Self, allocator: std.mem.Allocator, input: create_vpc_ingress_connection.CreateVpcIngressConnectionInput, options: CallOptions) !create_vpc_ingress_connection.CreateVpcIngressConnectionOutput {
    ...
    pub fn deleteAutoScalingConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_auto_scaling_configuration.DeleteAutoScalingConfigurationInput, options: CallOptions) !delete_auto_scaling_configuration.DeleteAutoScalingConfigurationOutput {
    ...
    pub fn deleteObservabilityConfiguration(self: *Self, allocator: std.mem.Allocator, input: delete_observability_configuration.DeleteObservabilityConfigurationInput, options: CallOptions) !delete_observability_configuration.DeleteObservabilityConfigurationOutput {
    ...
    pub fn deleteVpcConnector(self: *Self, allocator: std.mem.Allocator, input: delete_vpc_connector.DeleteVpcConnectorInput, options: CallOptions) !delete_vpc_connector.DeleteVpcConnectorOutput {
    ...
    ///
    /// * `FAILED_DELETION`
    pub fn deleteVpcIngressConnection(self: *Self, allocator: std.mem.Allocator, input: delete_vpc_ingress_connection.DeleteVpcIngressConnectionInput, options: CallOptions) !delete_vpc_ingress_connection.DeleteVpcIngressConnectionOutput {
    ...
    /// resource.
    pub fn describeAutoScalingConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_auto_scaling_configuration.DescribeAutoScalingConfigurationInput, options: CallOptions) !describe_auto_scaling_configuration.DescribeAutoScalingConfigurationOutput {
    ...
    /// Runner service.
    pub fn describeCustomDomains(self: *Self, allocator: std.mem.Allocator, input: describe_custom_domains.DescribeCustomDomainsInput, options: CallOptions) !describe_custom_domains.DescribeCustomDomainsOutput {
    ...
    /// resource.
    pub fn describeObservabilityConfiguration(self: *Self, allocator: std.mem.Allocator, input: describe_observability_configuration.DescribeObservabilityConfigurationInput, options: CallOptions) !describe_observability_configuration.DescribeObservabilityConfigurationOutput {
        return describe_observability_configuration.execute(self, allocator, input, options);
    }

    /// Return a full description of an App Runner service.
    pub fn describeService(self: *Self, allocator: std.mem.Allocator, input: describe_service.DescribeServiceInput, options: CallOptions) !describe_service.DescribeServiceOutput {
        return describe_service.execute(self, allocator, input, options);
    }

    /// Return a description of an App Runner VPC connector resource.
    pub fn describeVpcConnector(self: *Self, allocator: std.mem.Allocator, input: describe_vpc_connector.DescribeVpcConnectorInput, options: CallOptions) !describe_vpc_connector.DescribeVpcConnectorOutput {
        return describe_vpc_connector.execute(self, allocator, input, options);
    }

    /// Return a full description of an App Runner VPC Ingress Connection resource.
    pub fn describeVpcIngressConnection(self: *Self, allocator: std.mem.Allocator, input: describe_vpc_ingress_connection.DescribeVpcIngressConnectionInput, options: CallOptions) !describe_vpc_ingress_connection.DescribeVpcIngressConnectionOutput {
    ...
    pub fn disassociateCustomDomain(self: *Self, allocator: std.mem.Allocator, input: disassociate_custom_domain.DisassociateCustomDomainInput, options: CallOptions) !disassociate_custom_domain.DisassociateCustomDomainOutput {
    ...
    pub fn listAutoScalingConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_auto_scaling_configurations.ListAutoScalingConfigurationsInput, options: CallOptions) !list_auto_scaling_configurations.ListAutoScalingConfigurationsOutput {
    ...
    pub fn listObservabilityConfigurations(self: *Self, allocator: std.mem.Allocator, input: list_observability_configurations.ListObservabilityConfigurationsInput, options: CallOptions) !list_observability_configurations.ListObservabilityConfigurationsOutput {
    ...
    /// configuration.
    pub fn listServicesForAutoScalingConfiguration(self: *Self, allocator: std.mem.Allocator, input: list_services_for_auto_scaling_configuration.ListServicesForAutoScalingConfigurationInput, options: CallOptions) !list_services_for_auto_scaling_configuration.ListServicesForAutoScalingConfigurationOutput {
    ...
    /// account.
    pub fn listVpcConnectors(self: *Self, allocator: std.mem.Allocator, input: list_vpc_connectors.ListVpcConnectorsInput, options: CallOptions) !list_vpc_connectors.ListVpcConnectorsOutput {
    ...
    /// Services account.
    pub fn listVpcIngressConnections(self: *Self, allocator: std.mem.Allocator, input: list_vpc_ingress_connections.ListVpcIngressConnectionsInput, options: CallOptions) !list_vpc_ingress_connections.ListVpcIngressConnectionsOutput {
    ...
    /// returned `OperationId` and the ListOperations
    /// call to track the operation's progress.
    pub fn pauseService(self: *Self, allocator: std.mem.Allocator, input: pause_service.PauseServiceInput, options: CallOptions) !pause_service.PauseServiceOutput {
    ...
    /// returned `OperationId` and the ListOperations
    /// call to track the operation's progress.
    pub fn resumeService(self: *Self, allocator: std.mem.Allocator, input: resume_service.ResumeServiceInput, options: CallOptions) !resume_service.ResumeServiceOutput {
    ...
    /// automatically.
    pub fn updateDefaultAutoScalingConfiguration(self: *Self, allocator: std.mem.Allocator, input: update_default_auto_scaling_configuration.UpdateDefaultAutoScalingConfigurationInput, options: CallOptions) !update_default_auto_scaling_configuration.UpdateDefaultAutoScalingConfigurationOutput {
    ...
    ///
    /// * FAILED_UPDATE
    pub fn updateVpcIngressConnection(self: *Self, allocator: std.mem.Allocator, input: update_vpc_ingress_connection.UpdateVpcIngressConnectionInput, options: CallOptions) !update_vpc_ingress_connection.UpdateVpcIngressConnectionOutput {
