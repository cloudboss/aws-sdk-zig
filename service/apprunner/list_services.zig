...
const ListServicesInput = @import("list_services_request.zig").ListServicesRequest;

const ListServicesOutput = @import("list_services_response.zig").ListServicesResponse;
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListServicesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "AppRunner.ListServices");
