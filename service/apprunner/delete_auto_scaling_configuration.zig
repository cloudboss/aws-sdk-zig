...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAutoScalingConfigurationInput, options: Options) !DeleteAutoScalingConfigurationOutput {
