...
pub const DeleteAutoScalingConfigurationInput = struct {
    ...
    pub const json_field_names = .{
        ...
        .delete_all_revisions = "DeleteAllRevisions",
    };
};

pub const DeleteAutoScalingConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAutoScalingConfigurationInput, options: CallOptions) !DeleteAutoScalingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAutoScalingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AppRunner.DeleteAutoScalingConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAutoScalingConfigurationOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DeleteAutoScalingConfigurationOutput, body, allocator);
}
