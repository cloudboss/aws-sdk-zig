...
pub const DescribeCustomDomainsPaginator = struct {
    client: *Client,
    params: describe_custom_domains.DescribeCustomDomainsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_custom_domains.DescribeCustomDomainsOutput {
        if (self.done) {
...
pub const ListAutoScalingConfigurationsPaginator = struct {
    client: *Client,
    params: list_auto_scaling_configurations.ListAutoScalingConfigurationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_auto_scaling_configurations.ListAutoScalingConfigurationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListObservabilityConfigurationsPaginator = struct {
    client: *Client,
    params: list_observability_configurations.ListObservabilityConfigurationsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_observability_configurations.ListObservabilityConfigurationsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListServicesForAutoScalingConfigurationPaginator = struct {
    client: *Client,
    params: list_services_for_auto_scaling_configuration.ListServicesForAutoScalingConfigurationInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_services_for_auto_scaling_configuration.ListServicesForAutoScalingConfigurationOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListVpcConnectorsPaginator = struct {
    client: *Client,
    params: list_vpc_connectors.ListVpcConnectorsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_vpc_connectors.ListVpcConnectorsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListVpcIngressConnectionsPaginator = struct {
    client: *Client,
    params: list_vpc_ingress_connections.ListVpcIngressConnectionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_vpc_ingress_connections.ListVpcIngressConnectionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
