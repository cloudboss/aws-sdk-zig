...
pub const DeleteVpcIngressConnectionInput = struct {
...
pub const DeleteVpcIngressConnectionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVpcIngressConnectionInput, options: CallOptions) !DeleteVpcIngressConnectionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVpcIngressConnectionInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AppRunner.DeleteVpcIngressConnection");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVpcIngressConnectionOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DeleteVpcIngressConnectionOutput, body, allocator);
}
