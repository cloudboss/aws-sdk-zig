...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDefaultAutoScalingConfigurationInput, options: Options) !UpdateDefaultAutoScalingConfigurationOutput {
