...
pub const UpdateDefaultAutoScalingConfigurationInput = struct {
...
pub const UpdateDefaultAutoScalingConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateDefaultAutoScalingConfigurationInput, options: CallOptions) !UpdateDefaultAutoScalingConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateDefaultAutoScalingConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AppRunner.UpdateDefaultAutoScalingConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateDefaultAutoScalingConfigurationOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(UpdateDefaultAutoScalingConfigurationOutput, body, allocator);
}
