...
pub const AdminListGroupsForUserPaginator = struct {
    client: *Client,
    params: admin_list_groups_for_user.AdminListGroupsForUserInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !admin_list_groups_for_user.AdminListGroupsForUserOutput {
        ...
        const output = try admin_list_groups_for_user.execute(self.client, allocator, self.params, options);
...
pub const AdminListUserAuthEventsPaginator = struct {
    client: *Client,
    params: admin_list_user_auth_events.AdminListUserAuthEventsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !admin_list_user_auth_events.AdminListUserAuthEventsOutput {
        ...
        const output = try admin_list_user_auth_events.execute(self.client, allocator, self.params, options);
...
pub const ListResourceServersPaginator = struct {
    client: *Client,
    params: list_resource_servers.ListResourceServersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_resource_servers.ListResourceServersOutput {
        ...
        const output = try list_resource_servers.execute(self.client, allocator, self.params, options);
...
pub const ListUserPoolClientsPaginator = struct {
    client: *Client,
    params: list_user_pool_clients.ListUserPoolClientsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_user_pool_clients.ListUserPoolClientsOutput {
        ...
        const output = try list_user_pool_clients.execute(self.client, allocator, self.params, options);
...
pub const ListUserPoolsPaginator = struct {
    client: *Client,
    params: list_user_pools.ListUserPoolsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_user_pools.ListUserPoolsOutput {
        ...
        const output = try list_user_pools.execute(self.client, allocator, self.params, options);
...
pub const ListUsersInGroupPaginator = struct {
    client: *Client,
    params: list_users_in_group.ListUsersInGroupInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_users_in_group.ListUsersInGroupOutput {
        ...
        const output = try list_users_in_group.execute(self.client, allocator, self.params, options);
