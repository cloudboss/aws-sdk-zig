const EmailSendingAccountType = @import("email_sending_account_type.zig").EmailSendingAccountType;
...
/// resources in the Amazon Web Services Region where
...
/// user
/// pools](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-email.html).
pub const EmailConfigurationType = struct {
    /// The set of configuration rules that can be applied to emails sent using
    /// Amazon Simple Email Service. A
    /// configuration set is applied to an email by including a reference to the
    /// configuration
    /// set in the headers of the email. Once applied, all of the rules in that
    /// configuration
    /// set are applied to the email. Configuration sets can be used to apply the
    /// following
    ...
    /// information about these events to other Amazon Web Services services such as
    /// and
    /// Amazon CloudWatch
    ///
    /// **IP pool management**
    ...
    /// [Limits](https://docs.aws.amazon.com/cognito/latest/developerguide/limits.html) in the *Amazon Cognito Developer
    /// Guide*.
    ///
    ...
    /// permissions to
    /// call Amazon SES on your behalf. When you update your user pool with this
    /// option,
    ...
    /// address. For more information about the service-linked role that Amazon
    /// Cognito
    ...
    /// You can set a verified email address, but not an address in a verified
    /// domain, in the
    /// Amazon Cognito console. Amazon Cognito uses the email address that you
    /// provide in one of the following
    ...
    /// `SourceArn` and
    /// the user pool Region are the same. For more information, see [Amazon SES
    /// email configuration
