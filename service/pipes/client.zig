...
pub const Client = struct {
    ...
    pub fn createPipe(self: *Self, allocator: std.mem.Allocator, input: create_pipe.CreatePipeInput, options: create_pipe.Options) !create_pipe.CreatePipeOutput {
    ...
    pub fn deletePipe(self: *Self, allocator: std.mem.Allocator, input: delete_pipe.DeletePipeInput, options: delete_pipe.Options) !delete_pipe.DeletePipeOutput {
    ...
    /// Pipes](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes.html) in the Amazon EventBridge User Guide.
    pub fn describePipe(self: *Self, allocator: std.mem.Allocator, input: describe_pipe.DescribePipeInput, options: describe_pipe.Options) !describe_pipe.DescribePipeOutput {
    ...
    /// pipes, see [Amazon EventBridge
    /// Pipes](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes.html) in the Amazon EventBridge User Guide.
    pub fn listPipes(self: *Self, allocator: std.mem.Allocator, input: list_pipes.ListPipesInput, options: list_pipes.Options) !list_pipes.ListPipesOutput {
    ...
    pub fn startPipe(self: *Self, allocator: std.mem.Allocator, input: start_pipe.StartPipeInput, options: start_pipe.Options) !start_pipe.StartPipeOutput {
        return start_pipe.execute(self, allocator, input, options);
    }

    /// Stop an existing pipe.
    pub fn stopPipe(self: *Self, allocator: std.mem.Allocator, input: stop_pipe.StopPipeInput, options: stop_pipe.Options) !stop_pipe.StopPipeOutput {
    ...
    /// Amazon EventBridge
    /// Pipes](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes.html) in the Amazon EventBridge User Guide.
    pub fn updatePipe(self: *Self, allocator: std.mem.Allocator, input: update_pipe.UpdatePipeInput, options: update_pipe.Options) !update_pipe.UpdatePipeOutput {
