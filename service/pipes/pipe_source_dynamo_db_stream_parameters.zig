...
const DynamoDBStreamStartPosition = @import("dynamo_db_stream_start_position.zig").DynamoDBStreamStartPosition;

/// The parameters for using a DynamoDB stream as a source.
pub const PipeSourceDynamoDBStreamParameters = struct {
    ...
    starting_position: DynamoDBStreamStartPosition,
