...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopPipeInput, options: CallOptions) !StopPipeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopPipeInput, config: *aws.Config) !aws.http.Request {
