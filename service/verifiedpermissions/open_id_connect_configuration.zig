const OpenIdConnectGroupConfiguration = @import("open_id_connect_group_configuration.zig").OpenIdConnectGroupConfiguration;
const OpenIdConnectTokenSelection = @import("open_id_connect_token_selection.zig").OpenIdConnectTokenSelection;
...
/// [Configuration](https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_Configuration.html) structure, which is a parameter to [CreateIdentitySource](https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_CreateIdentitySource.html).
pub const OpenIdConnectConfiguration = struct {
    ...
    group_configuration: ?OpenIdConnectGroupConfiguration = null,
    ...
    token_selection: OpenIdConnectTokenSelection,
