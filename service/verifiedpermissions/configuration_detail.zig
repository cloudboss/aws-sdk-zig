const CognitoUserPoolConfigurationDetail = @import("cognito_user_pool_configuration_detail.zig").CognitoUserPoolConfigurationDetail;
const OpenIdConnectConfigurationDetail = @import("open_id_connect_configuration_detail.zig").OpenIdConnectConfigurationDetail;

/// Contains configuration information about an identity source.
///
/// This data type is a response parameter to the
/// [GetIdentitySource](https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_GetIdentitySource.html) operation.
pub const ConfigurationDetail = union(enum) {
    ...
    cognito_user_pool_configuration: ?CognitoUserPoolConfigurationDetail,
    ...
    open_id_connect_configuration: ?OpenIdConnectConfigurationDetail,
