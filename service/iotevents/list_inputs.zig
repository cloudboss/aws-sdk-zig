...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListInputsInput, options: CallOptions) !ListInputsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListInputsInput, config: *aws.Config) !aws.http.Request {
