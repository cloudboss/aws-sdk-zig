...
pub const Client = struct {
    ...
    pub fn createAlarmModel(self: *Self, allocator: std.mem.Allocator, input: create_alarm_model.CreateAlarmModelInput, options: CallOptions) !create_alarm_model.CreateAlarmModelOutput {
        return create_alarm_model.execute(self, allocator, input, options);
    }

    /// Creates a detector model.
    pub fn createDetectorModel(self: *Self, allocator: std.mem.Allocator, input: create_detector_model.CreateDetectorModelInput, options: CallOptions) !create_detector_model.CreateDetectorModelOutput {
    ...
    pub fn deleteAlarmModel(self: *Self, allocator: std.mem.Allocator, input: delete_alarm_model.DeleteAlarmModelInput, options: CallOptions) !delete_alarm_model.DeleteAlarmModelOutput {
    ...
    /// also
    /// deleted.
    pub fn deleteDetectorModel(self: *Self, allocator: std.mem.Allocator, input: delete_detector_model.DeleteDetectorModelInput, options: CallOptions) !delete_detector_model.DeleteDetectorModelOutput {
    ...
    pub fn describeAlarmModel(self: *Self, allocator: std.mem.Allocator, input: describe_alarm_model.DescribeAlarmModelInput, options: CallOptions) !describe_alarm_model.DescribeAlarmModelOutput {
    ...
    pub fn describeDetectorModel(self: *Self, allocator: std.mem.Allocator, input: describe_detector_model.DescribeDetectorModelInput, options: CallOptions) !describe_detector_model.DescribeDetectorModelOutput {
    ...
    pub fn describeDetectorModelAnalysis(self: *Self, allocator: std.mem.Allocator, input: describe_detector_model_analysis.DescribeDetectorModelAnalysisInput, options: CallOptions) !describe_detector_model_analysis.DescribeDetectorModelAnalysisOutput {
    ...
    /// After AWS IoT Events starts analyzing your detector model, you have up to 24
    /// hours to retrieve the analysis results.
    pub fn getDetectorModelAnalysisResults(self: *Self, allocator: std.mem.Allocator, input: get_detector_model_analysis_results.GetDetectorModelAnalysisResultsInput, options: CallOptions) !get_detector_model_analysis_results.GetDetectorModelAnalysisResultsOutput {
    ...
    pub fn listAlarmModelVersions(self: *Self, allocator: std.mem.Allocator, input: list_alarm_model_versions.ListAlarmModelVersionsInput, options: CallOptions) !list_alarm_model_versions.ListAlarmModelVersionsOutput {
    ...
    pub fn listAlarmModels(self: *Self, allocator: std.mem.Allocator, input: list_alarm_models.ListAlarmModelsInput, options: CallOptions) !list_alarm_models.ListAlarmModelsOutput {
    ...
    pub fn listDetectorModelVersions(self: *Self, allocator: std.mem.Allocator, input: list_detector_model_versions.ListDetectorModelVersionsInput, options: CallOptions) !list_detector_model_versions.ListDetectorModelVersionsOutput {
    ...
    pub fn listDetectorModels(self: *Self, allocator: std.mem.Allocator, input: list_detector_models.ListDetectorModelsInput, options: CallOptions) !list_detector_models.ListDetectorModelsOutput {
        return list_detector_models.execute(self, allocator, input, options);
    }

    /// Lists one or more input routings.
    pub fn listInputRoutings(self: *Self, allocator: std.mem.Allocator, input: list_input_routings.ListInputRoutingsInput, options: CallOptions) !list_input_routings.ListInputRoutingsOutput {
    ...
    pub fn startDetectorModelAnalysis(self: *Self, allocator: std.mem.Allocator, input: start_detector_model_analysis.StartDetectorModelAnalysisInput, options: CallOptions) !start_detector_model_analysis.StartDetectorModelAnalysisOutput {
    ...
    pub fn updateAlarmModel(self: *Self, allocator: std.mem.Allocator, input: update_alarm_model.UpdateAlarmModelInput, options: CallOptions) !update_alarm_model.UpdateAlarmModelOutput {
    ...
    pub fn updateDetectorModel(self: *Self, allocator: std.mem.Allocator, input: update_detector_model.UpdateDetectorModelInput, options: CallOptions) !update_detector_model.UpdateDetectorModelOutput {
