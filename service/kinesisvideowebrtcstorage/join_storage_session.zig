...
pub const JoinStorageSessionInput = struct {
...
pub const JoinStorageSessionOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: JoinStorageSessionInput, options: CallOptions) !JoinStorageSessionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: JoinStorageSessionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !JoinStorageSessionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: JoinStorageSessionOutput = .{};
