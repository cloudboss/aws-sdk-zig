...
pub const JoinStorageSessionAsViewerOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: JoinStorageSessionAsViewerInput, options: CallOptions) !JoinStorageSessionAsViewerOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !JoinStorageSessionAsViewerOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
