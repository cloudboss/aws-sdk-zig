...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetOrganizationCustomRulePolicyInput, options: Options) !GetOrganizationCustomRulePolicyOutput {
