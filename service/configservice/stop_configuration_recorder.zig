...
pub const StopConfigurationRecorderInput = struct {
...
pub const StopConfigurationRecorderOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopConfigurationRecorderInput, options: CallOptions) !StopConfigurationRecorderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopConfigurationRecorderInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StarlingDoveService.StopConfigurationRecorder");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopConfigurationRecorderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
