...
pub const DeleteRetentionConfigurationInput = struct {
    /// The name of the retention configuration to delete.
    retention_configuration_name: []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRetentionConfigurationInput, options: CallOptions) !DeleteRetentionConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRetentionConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StarlingDoveService.DeleteRetentionConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRetentionConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
