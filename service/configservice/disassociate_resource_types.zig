...
pub const DisassociateResourceTypesInput = struct {
    /// The Amazon Resource Name (ARN) of the specified configuration recorder.
    configuration_recorder_arn: []const u8,
    ...
    pub const json_field_names = .{
        .configuration_recorder_arn = "ConfigurationRecorderArn",
        .resource_types = "ResourceTypes",
    };
};

pub const DisassociateResourceTypesOutput = struct {
    configuration_recorder: ?ConfigurationRecorder = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateResourceTypesInput, options: CallOptions) !DisassociateResourceTypesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateResourceTypesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StarlingDoveService.DisassociateResourceTypes");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateResourceTypesOutput {
    _ = status;
    _ = headers;
    return aws.json.parseJsonObject(DisassociateResourceTypesOutput, body, allocator);
}
