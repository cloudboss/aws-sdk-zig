...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListConformancePackComplianceScoresInput, options: Options) !ListConformancePackComplianceScoresOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListConformancePackComplianceScoresInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "StarlingDoveService.ListConformancePackComplianceScores");
