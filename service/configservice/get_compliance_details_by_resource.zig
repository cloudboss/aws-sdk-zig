...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetComplianceDetailsByResourceInput, options: Options) !GetComplianceDetailsByResourceOutput {
