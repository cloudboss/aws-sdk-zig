...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePendingAggregationRequestInput, options: Options) !DeletePendingAggregationRequestOutput {
