...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOrganizationConfigRuleStatusesInput, options: Options) !DescribeOrganizationConfigRuleStatusesOutput {
