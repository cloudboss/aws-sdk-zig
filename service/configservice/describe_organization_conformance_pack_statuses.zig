...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOrganizationConformancePackStatusesInput, options: Options) !DescribeOrganizationConformancePackStatusesOutput {
