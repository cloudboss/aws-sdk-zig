...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeConfigurationAggregatorSourcesStatusInput, options: Options) !DescribeConfigurationAggregatorSourcesStatusOutput {
