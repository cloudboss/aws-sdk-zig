...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAggregationAuthorizationInput, options: Options) !DeleteAggregationAuthorizationOutput {
