...
const ConfigRuleComplianceSummaryFilters = @import("config_rule_compliance_summary_filters.zig").ConfigRuleComplianceSummaryFilters;
const ConfigRuleComplianceSummaryGroupKey = @import("config_rule_compliance_summary_group_key.zig").ConfigRuleComplianceSummaryGroupKey;
const AggregateComplianceCount = @import("aggregate_compliance_count.zig").AggregateComplianceCount;

pub const GetAggregateConfigRuleComplianceSummaryInput = struct {
    ...
    group_by_key: ?ConfigRuleComplianceSummaryGroupKey = null,
...
pub const GetAggregateConfigRuleComplianceSummaryOutput = struct {
    /// Returns a list of AggregateComplianceCounts object.
    aggregate_compliance_counts: ?[]const AggregateComplianceCount = null,
    ...
    pub const json_field_names = .{
        .aggregate_compliance_counts = "AggregateComplianceCounts",
        .group_by_key = "GroupByKey",
        .next_token = "NextToken",
    };
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAggregateConfigRuleComplianceSummaryInput, options: CallOptions) !GetAggregateConfigRuleComplianceSummaryOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAggregateConfigRuleComplianceSummaryInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StarlingDoveService.GetAggregateConfigRuleComplianceSummary");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAggregateConfigRuleComplianceSummaryOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetAggregateConfigRuleComplianceSummaryOutput, body, allocator);
}
