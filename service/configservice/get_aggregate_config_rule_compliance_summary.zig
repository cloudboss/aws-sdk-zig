...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAggregateConfigRuleComplianceSummaryInput, options: Options) !GetAggregateConfigRuleComplianceSummaryOutput {
