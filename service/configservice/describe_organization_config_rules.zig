...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeOrganizationConfigRulesInput, options: Options) !DescribeOrganizationConfigRulesOutput {
