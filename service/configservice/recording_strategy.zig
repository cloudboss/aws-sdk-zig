const RecordingStrategyType = @import("recording_strategy_type.zig").RecordingStrategyType;

/// Specifies the recording strategy of the configuration recorder.
pub const RecordingStrategy = struct {
    ...
    /// You also must set the `allSupported` field of
    /// [RecordingGroup](https://docs.aws.amazon.com/config/latest/APIReference/API_RecordingGroup.html) to `true`.
    /// When Config adds support for a new resource type, Config automatically
    ...
    /// Config after February 2022. This list where you cannot record the global IAM
