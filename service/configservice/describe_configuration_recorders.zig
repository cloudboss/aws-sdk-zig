...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeConfigurationRecordersInput, options: Options) !DescribeConfigurationRecordersOutput {
