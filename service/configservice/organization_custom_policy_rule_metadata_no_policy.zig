...
/// other custom rule metadata such as resource type, resource ID of Amazon Web
/// Services
/// resource, and organization trigger types that trigger Config to evaluate
/// Amazon Web Services resources against a rule.
pub const OrganizationCustomPolicyRuleMetadataNoPolicy = struct {
