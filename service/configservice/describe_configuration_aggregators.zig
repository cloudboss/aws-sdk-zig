...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeConfigurationAggregatorsInput, options: Options) !DescribeConfigurationAggregatorsOutput {
