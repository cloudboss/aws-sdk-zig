...
pub const StartConfigurationRecorderInput = struct {
...
pub const StartConfigurationRecorderOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StartConfigurationRecorderInput, options: CallOptions) !StartConfigurationRecorderOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StartConfigurationRecorderInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "StarlingDoveService.StartConfigurationRecorder");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StartConfigurationRecorderOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
