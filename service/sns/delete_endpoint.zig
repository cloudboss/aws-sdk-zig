...
pub const DeleteEndpointOutput = struct {
    ...
    pub fn deinit(self: *DeleteEndpointOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeleteEndpointInput, options: Options) !DeleteEndpointOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteEndpointInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteEndpoint&Version=2010-03-31");
