...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSMSSandboxPhoneNumberInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteSMSSandboxPhoneNumber&Version=2010-03-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSMSSandboxPhoneNumberOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
