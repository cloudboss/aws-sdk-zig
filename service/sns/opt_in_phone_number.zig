...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: OptInPhoneNumberInput, options: Options) !OptInPhoneNumberOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: OptInPhoneNumberInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=OptInPhoneNumber&Version=2010-03-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !OptInPhoneNumberOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
