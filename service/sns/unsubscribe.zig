...
const UnsubscribeOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UnsubscribeInput, options: Options) !UnsubscribeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UnsubscribeInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=Unsubscribe&Version=2010-03-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UnsubscribeOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
