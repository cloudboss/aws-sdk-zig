...
pub const PutDataProtectionPolicyInput = struct {
    ...
    data_protection_policy: []const u8,
...
pub const PutDataProtectionPolicyOutput = struct {
    ...
    pub fn deinit(self: *PutDataProtectionPolicyOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: PutDataProtectionPolicyInput, options: Options) !PutDataProtectionPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutDataProtectionPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=PutDataProtectionPolicy&Version=2010-03-31");
    try body_buf.appendSlice(alloc, "&DataProtectionPolicy=");
    try aws.url.appendUrlEncoded(alloc, &body_buf, input.data_protection_policy);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutDataProtectionPolicyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
    const result: PutDataProtectionPolicyOutput = .{};
