...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListSubscriptionsByTopicInput, options: CallOptions) !ListSubscriptionsByTopicOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListSubscriptionsByTopicInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ListSubscriptionsByTopic&Version=2010-03-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListSubscriptionsByTopicOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.subscriptions = try serde.deserializeSubscriptionsList(allocator, &reader, "member");
                } else {
