...
pub const CreatePlatformEndpointOutput = struct {
    ...
    pub fn deinit(self: *CreatePlatformEndpointOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: CreatePlatformEndpointInput, options: Options) !CreatePlatformEndpointOutput {
