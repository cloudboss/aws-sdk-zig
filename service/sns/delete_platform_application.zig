...
fn serializeRequest(alloc: std.mem.Allocator, input: DeletePlatformApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeletePlatformApplication&Version=2010-03-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeletePlatformApplicationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
