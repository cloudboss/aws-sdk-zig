...
pub const DeletePlatformApplicationOutput = struct {
    ...
    pub fn deinit(self: *DeletePlatformApplicationOutput) void {
        self._arena.deinit();
    }
};
...
pub fn execute(client: *Client, input: DeletePlatformApplicationInput, options: Options) !DeletePlatformApplicationOutput {
