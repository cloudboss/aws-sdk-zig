...
const DeletePlatformApplicationOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePlatformApplicationInput, options: Options) !DeletePlatformApplicationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePlatformApplicationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeletePlatformApplication&Version=2010-03-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePlatformApplicationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeletePlatformApplicationOutput = .{};
