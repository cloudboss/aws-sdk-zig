...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPhoneNumbersOptedOutInput, options: CallOptions) !ListPhoneNumbersOptedOutOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPhoneNumbersOptedOutInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ListPhoneNumbersOptedOut&Version=2010-03-31");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListPhoneNumbersOptedOutOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "nextToken")) {
                    ...
                    result.phone_numbers = try serde.deserializePhoneNumberList(allocator, &reader, "member");
                } else {
