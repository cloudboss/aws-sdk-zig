...
fn serializeRequest(alloc: std.mem.Allocator, input: GetPlatformApplicationAttributesInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=GetPlatformApplicationAttributes&Version=2010-03-31");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetPlatformApplicationAttributesOutput {
    _ = status;
    _ = headers;
