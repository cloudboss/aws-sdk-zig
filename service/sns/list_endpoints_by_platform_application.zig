...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListEndpointsByPlatformApplicationInput, options: Options) !ListEndpointsByPlatformApplicationOutput {
