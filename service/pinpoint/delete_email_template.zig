...
pub const DeleteEmailTemplateInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEmailTemplateInput, options: Options) !DeleteEmailTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteEmailTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/email");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteEmailTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteEmailTemplateOutput = .{};
