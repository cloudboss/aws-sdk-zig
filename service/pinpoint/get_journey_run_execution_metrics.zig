...
const JourneyRunExecutionMetricsResponse = @import("journey_run_execution_metrics_response.zig").JourneyRunExecutionMetricsResponse;

pub const GetJourneyRunExecutionMetricsInput = struct {
...
pub const GetJourneyRunExecutionMetricsOutput = struct {
    journey_run_execution_metrics_response: ?JourneyRunExecutionMetricsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyRunExecutionMetricsInput, options: CallOptions) !GetJourneyRunExecutionMetricsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetJourneyRunExecutionMetricsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetJourneyRunExecutionMetricsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetJourneyRunExecutionMetricsOutput = .{};
