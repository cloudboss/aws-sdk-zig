...
pub const GetExportJobsInput = struct {
...
pub const GetExportJobsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetExportJobsInput, options: CallOptions) !GetExportJobsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetExportJobsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetExportJobsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetExportJobsOutput = .{};
