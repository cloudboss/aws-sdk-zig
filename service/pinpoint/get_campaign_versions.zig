...
pub const GetCampaignVersionsInput = struct {
...
pub const GetCampaignVersionsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCampaignVersionsInput, options: CallOptions) !GetCampaignVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCampaignVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetCampaignVersionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetCampaignVersionsOutput = .{};
