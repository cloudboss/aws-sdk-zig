...
pub const GetApnsChannelInput = struct {
...
pub const GetApnsChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApnsChannelInput, options: CallOptions) !GetApnsChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetApnsChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetApnsChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetApnsChannelOutput = .{};
