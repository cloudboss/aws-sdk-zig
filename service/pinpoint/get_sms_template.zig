...
const SMSTemplateResponse = @import("sms_template_response.zig").SMSTemplateResponse;

pub const GetSmsTemplateInput = struct {
...
pub const GetSmsTemplateOutput = struct {
    sms_template_response: ?SMSTemplateResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSmsTemplateInput, options: CallOptions) !GetSmsTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSmsTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSmsTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetSmsTemplateOutput = .{};
