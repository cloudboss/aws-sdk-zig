...
pub const GetUserEndpointsInput = struct {
...
pub const GetUserEndpointsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetUserEndpointsInput, options: CallOptions) !GetUserEndpointsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetUserEndpointsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetUserEndpointsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetUserEndpointsOutput = .{};
