...
const ApplicationsResponse = @import("applications_response.zig").ApplicationsResponse;

pub const GetAppsInput = struct {
...
pub const GetAppsOutput = struct {
    applications_response: ?ApplicationsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetAppsInput, options: CallOptions) !GetAppsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetAppsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetAppsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetAppsOutput = .{};
