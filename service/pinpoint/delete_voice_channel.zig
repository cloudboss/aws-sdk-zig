...
pub const DeleteVoiceChannelInput = struct {
...
pub const DeleteVoiceChannelOutput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceChannelOutput = .{};
