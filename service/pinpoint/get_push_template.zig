...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetPushTemplateInput, options: Options) !GetPushTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetPushTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetPushTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
