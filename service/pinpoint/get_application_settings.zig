...
pub const GetApplicationSettingsInput = struct {
...
pub const GetApplicationSettingsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApplicationSettingsInput, options: CallOptions) !GetApplicationSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetApplicationSettingsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetApplicationSettingsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetApplicationSettingsOutput = .{};
