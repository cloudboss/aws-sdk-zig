...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyExecutionMetricsInput, options: Options) !GetJourneyExecutionMetricsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetJourneyExecutionMetricsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetJourneyExecutionMetricsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
