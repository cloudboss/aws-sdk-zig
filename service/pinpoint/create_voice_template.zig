...
pub const CreateVoiceTemplateInput = struct {
...
pub const CreateVoiceTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateVoiceTemplateInput, options: CallOptions) !CreateVoiceTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateVoiceTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateVoiceTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateVoiceTemplateOutput = .{};
