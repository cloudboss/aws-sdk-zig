...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSegmentExportJobsInput, options: CallOptions) !GetSegmentExportJobsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSegmentExportJobsInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/jobs/export");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSegmentExportJobsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
