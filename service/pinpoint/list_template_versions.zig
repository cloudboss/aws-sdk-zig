...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListTemplateVersionsInput, options: CallOptions) !ListTemplateVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListTemplateVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListTemplateVersionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
