...
const SegmentsResponse = @import("segments_response.zig").SegmentsResponse;

pub const GetSegmentVersionsInput = struct {
...
pub const GetSegmentVersionsOutput = struct {
    segments_response: ?SegmentsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSegmentVersionsInput, options: Options) !GetSegmentVersionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetSegmentVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetSegmentVersionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetSegmentVersionsOutput = .{};
