...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSegmentVersionsInput, options: CallOptions) !GetSegmentVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSegmentVersionsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSegmentVersionsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
