...
pub const GetSegmentVersionInput = struct {
...
pub const GetSegmentVersionOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSegmentVersionInput, options: CallOptions) !GetSegmentVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSegmentVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSegmentVersionOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetSegmentVersionOutput = .{};
