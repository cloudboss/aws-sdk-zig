...
const JourneyStateRequest = @import("journey_state_request.zig").JourneyStateRequest;
const JourneyResponse = @import("journey_response.zig").JourneyResponse;

pub const UpdateJourneyStateInput = struct {
...
pub const UpdateJourneyStateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateJourneyStateInput, options: CallOptions) !UpdateJourneyStateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateJourneyStateInput, config: *aws.Config) !aws.http.Request {
    ...
    const body = try aws.json.jsonStringify(input.journey_state_request, allocator);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateJourneyStateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateJourneyStateOutput = .{};
