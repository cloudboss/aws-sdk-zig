...
const ActivitiesResponse = @import("activities_response.zig").ActivitiesResponse;

pub const GetCampaignActivitiesInput = struct {
...
pub const GetCampaignActivitiesOutput = struct {
    activities_response: ?ActivitiesResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCampaignActivitiesInput, options: CallOptions) !GetCampaignActivitiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCampaignActivitiesInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetCampaignActivitiesOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetCampaignActivitiesOutput = .{};
