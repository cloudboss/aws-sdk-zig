...
pub const DeleteVoiceTemplateInput = struct {
...
pub const DeleteVoiceTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVoiceTemplateInput, options: CallOptions) !DeleteVoiceTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVoiceTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVoiceTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVoiceTemplateOutput = .{};
