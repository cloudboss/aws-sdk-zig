...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInAppTemplateInput, options: CallOptions) !DeleteInAppTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteInAppTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteInAppTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
