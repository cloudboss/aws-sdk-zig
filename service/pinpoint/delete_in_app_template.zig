...
pub const DeleteInAppTemplateInput = struct {
...
pub const DeleteInAppTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteInAppTemplateInput, options: Options) !DeleteInAppTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteInAppTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteInAppTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteInAppTemplateOutput = .{};
