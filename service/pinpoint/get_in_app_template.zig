...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetInAppTemplateInput, options: CallOptions) !GetInAppTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetInAppTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetInAppTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
