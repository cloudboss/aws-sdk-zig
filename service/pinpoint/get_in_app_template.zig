...
const InAppTemplateResponse = @import("in_app_template_response.zig").InAppTemplateResponse;

pub const GetInAppTemplateInput = struct {
...
pub const GetInAppTemplateOutput = struct {
    in_app_template_response: ?InAppTemplateResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetInAppTemplateInput, options: Options) !GetInAppTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetInAppTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/inapp");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetInAppTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetInAppTemplateOutput = .{};
