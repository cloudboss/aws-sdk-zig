...
pub const GetJourneyInput = struct {
...
pub const GetJourneyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyInput, options: CallOptions) !GetJourneyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetJourneyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetJourneyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetJourneyOutput = .{};
