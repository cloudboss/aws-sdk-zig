...
pub const DeleteSmsTemplateInput = struct {
...
pub const DeleteSmsTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSmsTemplateInput, options: CallOptions) !DeleteSmsTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSmsTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSmsTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSmsTemplateOutput = .{};
