...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetEventStreamInput, options: Options) !GetEventStreamOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetEventStreamInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetEventStreamOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetEventStreamOutput = .{};
