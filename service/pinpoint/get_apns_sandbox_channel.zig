...
pub const GetApnsSandboxChannelInput = struct {
...
pub const GetApnsSandboxChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApnsSandboxChannelInput, options: CallOptions) !GetApnsSandboxChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetApnsSandboxChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetApnsSandboxChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetApnsSandboxChannelOutput = .{};
