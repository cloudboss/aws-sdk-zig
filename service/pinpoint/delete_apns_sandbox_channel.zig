...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteApnsSandboxChannelInput, options: Options) !DeleteApnsSandboxChannelOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteApnsSandboxChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteApnsSandboxChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
