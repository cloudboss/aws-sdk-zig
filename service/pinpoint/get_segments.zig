...
fn serializeRequest(alloc: std.mem.Allocator, input: GetSegmentsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetSegmentsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
