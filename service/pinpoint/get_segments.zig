...
pub const GetSegmentsInput = struct {
...
pub const GetSegmentsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSegmentsInput, options: CallOptions) !GetSegmentsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSegmentsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSegmentsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetSegmentsOutput = .{};
