...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSmsTemplateInput, options: CallOptions) !UpdateSmsTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSmsTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateSmsTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
