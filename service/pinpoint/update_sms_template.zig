...
pub const UpdateSmsTemplateInput = struct {
...
pub const UpdateSmsTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSmsTemplateInput, options: Options) !UpdateSmsTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateSmsTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/sms");
    ...
    if (input.create_new_version) |v| {
        ...
        try query_buf.appendSlice(alloc, "create-new-version=");
    ...
    const body = try aws.json.jsonStringify(input.sms_template_request, alloc);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateSmsTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: UpdateSmsTemplateOutput = .{};
