...
pub const CreateJourneyInput = struct {
...
pub const CreateJourneyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateJourneyInput, options: CallOptions) !CreateJourneyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateJourneyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateJourneyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateJourneyOutput = .{};
