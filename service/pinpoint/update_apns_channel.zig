...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateApnsChannelInput, config: *aws.Config) !aws.http.Request {
    ...
    const body = try aws.json.jsonStringify(input.apns_channel_request, alloc);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateApnsChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
