...
pub const DeletePushTemplateInput = struct {
...
pub const DeletePushTemplateOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePushTemplateInput, options: CallOptions) !DeletePushTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePushTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePushTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeletePushTemplateOutput = .{};
