...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRecommenderConfigurationInput, options: Options) !DeleteRecommenderConfigurationOutput {
