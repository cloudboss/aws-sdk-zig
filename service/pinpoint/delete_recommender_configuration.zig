...
pub const DeleteRecommenderConfigurationInput = struct {
...
pub const DeleteRecommenderConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteRecommenderConfigurationInput, options: CallOptions) !DeleteRecommenderConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRecommenderConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteRecommenderConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteRecommenderConfigurationOutput = .{};
