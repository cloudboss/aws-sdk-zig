...
pub const GetApnsVoipSandboxChannelInput = struct {
...
pub const GetApnsVoipSandboxChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetApnsVoipSandboxChannelInput, options: CallOptions) !GetApnsVoipSandboxChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetApnsVoipSandboxChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetApnsVoipSandboxChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetApnsVoipSandboxChannelOutput = .{};
