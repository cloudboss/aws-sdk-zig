...
pub const GetImportJobsInput = struct {
...
pub const GetImportJobsOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetImportJobsInput, options: CallOptions) !GetImportJobsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetImportJobsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetImportJobsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetImportJobsOutput = .{};
