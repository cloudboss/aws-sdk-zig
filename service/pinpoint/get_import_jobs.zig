...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetImportJobsInput, options: Options) !GetImportJobsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetImportJobsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetImportJobsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
