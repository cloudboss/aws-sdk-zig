...
pub const DeleteGcmChannelInput = struct {
...
pub const DeleteGcmChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGcmChannelInput, options: CallOptions) !DeleteGcmChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteGcmChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteGcmChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteGcmChannelOutput = .{};
