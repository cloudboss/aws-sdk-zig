...
const EmailTemplateResponse = @import("email_template_response.zig").EmailTemplateResponse;
...
pub const GetEmailTemplateOutput = struct {
    email_template_response: ?EmailTemplateResponse = null,
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetEmailTemplateOutput {
    ...
    _ = status;
    _ = headers;
    const result: GetEmailTemplateOutput = .{};
