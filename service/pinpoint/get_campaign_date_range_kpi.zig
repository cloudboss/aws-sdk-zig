...
const CampaignDateRangeKpiResponse = @import("campaign_date_range_kpi_response.zig").CampaignDateRangeKpiResponse;

pub const GetCampaignDateRangeKpiInput = struct {
...
pub const GetCampaignDateRangeKpiOutput = struct {
    campaign_date_range_kpi_response: ?CampaignDateRangeKpiResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCampaignDateRangeKpiInput, options: CallOptions) !GetCampaignDateRangeKpiOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCampaignDateRangeKpiInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetCampaignDateRangeKpiOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetCampaignDateRangeKpiOutput = .{};
