...
pub const GetVoiceChannelInput = struct {
...
pub const GetVoiceChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceChannelInput, options: CallOptions) !GetVoiceChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVoiceChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetVoiceChannelOutput = .{};
