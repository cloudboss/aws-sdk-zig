...
const EndpointsResponse = @import("endpoints_response.zig").EndpointsResponse;

pub const DeleteUserEndpointsInput = struct {
...
pub const DeleteUserEndpointsOutput = struct {
    endpoints_response: ?EndpointsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteUserEndpointsInput, options: CallOptions) !DeleteUserEndpointsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteUserEndpointsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteUserEndpointsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteUserEndpointsOutput = .{};
