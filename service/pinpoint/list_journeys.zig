...
const JourneysResponse = @import("journeys_response.zig").JourneysResponse;

pub const ListJourneysInput = struct {
...
pub const ListJourneysOutput = struct {
    journeys_response: ?JourneysResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListJourneysInput, options: CallOptions) !ListJourneysOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListJourneysInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListJourneysOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: ListJourneysOutput = .{};
