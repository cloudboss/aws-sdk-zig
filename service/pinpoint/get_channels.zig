...
const ChannelsResponse = @import("channels_response.zig").ChannelsResponse;

pub const GetChannelsInput = struct {
...
pub const GetChannelsOutput = struct {
    channels_response: ?ChannelsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetChannelsInput, options: CallOptions) !GetChannelsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetChannelsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetChannelsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetChannelsOutput = .{};
