...
pub const DeleteSegmentInput = struct {
...
pub const DeleteSegmentOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSegmentInput, options: CallOptions) !DeleteSegmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteSegmentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteSegmentOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteSegmentOutput = .{};
