...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteSegmentInput, options: Options) !DeleteSegmentOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteSegmentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteSegmentOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
