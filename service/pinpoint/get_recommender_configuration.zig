...
pub const GetRecommenderConfigurationInput = struct {
...
pub const GetRecommenderConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetRecommenderConfigurationInput, options: CallOptions) !GetRecommenderConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetRecommenderConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetRecommenderConfigurationOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetRecommenderConfigurationOutput = .{};
