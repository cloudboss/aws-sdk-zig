...
pub const CreateSegmentInput = struct {
...
pub const CreateSegmentOutput = struct {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateSegmentInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateSegmentOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CreateSegmentOutput = .{};
