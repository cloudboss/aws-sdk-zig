...
pub const DeleteApnsVoipSandboxChannelInput = struct {
...
pub const DeleteApnsVoipSandboxChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteApnsVoipSandboxChannelInput, options: CallOptions) !DeleteApnsVoipSandboxChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteApnsVoipSandboxChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteApnsVoipSandboxChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteApnsVoipSandboxChannelOutput = .{};
