...
pub const GetGcmChannelInput = struct {
...
pub const GetGcmChannelOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetGcmChannelInput, options: CallOptions) !GetGcmChannelOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetGcmChannelInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetGcmChannelOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetGcmChannelOutput = .{};
