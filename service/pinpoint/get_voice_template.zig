...
const VoiceTemplateResponse = @import("voice_template_response.zig").VoiceTemplateResponse;

pub const GetVoiceTemplateInput = struct {
...
pub const GetVoiceTemplateOutput = struct {
    voice_template_response: ?VoiceTemplateResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVoiceTemplateInput, options: CallOptions) !GetVoiceTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVoiceTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVoiceTemplateOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetVoiceTemplateOutput = .{};
