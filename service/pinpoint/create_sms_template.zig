...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateSmsTemplateInput, options: Options) !CreateSmsTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateSmsTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateSmsTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
