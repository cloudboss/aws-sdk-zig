...
const JourneyDateRangeKpiResponse = @import("journey_date_range_kpi_response.zig").JourneyDateRangeKpiResponse;

pub const GetJourneyDateRangeKpiInput = struct {
...
pub const GetJourneyDateRangeKpiOutput = struct {
    journey_date_range_kpi_response: ?JourneyDateRangeKpiResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyDateRangeKpiInput, options: CallOptions) !GetJourneyDateRangeKpiOutput {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetJourneyDateRangeKpiOutput {
    ...
    _ = status;
    _ = headers;
    const result: GetJourneyDateRangeKpiOutput = .{};
