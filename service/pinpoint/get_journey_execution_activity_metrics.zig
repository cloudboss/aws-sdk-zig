...
const JourneyExecutionActivityMetricsResponse = @import("journey_execution_activity_metrics_response.zig").JourneyExecutionActivityMetricsResponse;

pub const GetJourneyExecutionActivityMetricsInput = struct {
...
pub const GetJourneyExecutionActivityMetricsOutput = struct {
    journey_execution_activity_metrics_response: ?JourneyExecutionActivityMetricsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyExecutionActivityMetricsInput, options: CallOptions) !GetJourneyExecutionActivityMetricsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetJourneyExecutionActivityMetricsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetJourneyExecutionActivityMetricsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetJourneyExecutionActivityMetricsOutput = .{};
