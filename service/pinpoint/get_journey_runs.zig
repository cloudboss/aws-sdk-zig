...
const JourneyRunsResponse = @import("journey_runs_response.zig").JourneyRunsResponse;

pub const GetJourneyRunsInput = struct {
...
pub const GetJourneyRunsOutput = struct {
    journey_runs_response: ?JourneyRunsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyRunsInput, options: CallOptions) !GetJourneyRunsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetJourneyRunsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetJourneyRunsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetJourneyRunsOutput = .{};
