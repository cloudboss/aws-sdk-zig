...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetJourneyRunsInput, options: Options) !GetJourneyRunsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetJourneyRunsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetJourneyRunsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
