...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateInAppTemplateInput, options: Options) !UpdateInAppTemplateOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateInAppTemplateInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateInAppTemplateOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
