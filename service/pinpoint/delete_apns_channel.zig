...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteApnsChannelInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/channels/apns");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteApnsChannelOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
