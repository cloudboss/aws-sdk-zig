...
const CampaignsResponse = @import("campaigns_response.zig").CampaignsResponse;

pub const GetCampaignsInput = struct {
...
pub const GetCampaignsOutput = struct {
    campaigns_response: ?CampaignsResponse = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCampaignsInput, options: CallOptions) !GetCampaignsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetCampaignsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetCampaignsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetCampaignsOutput = .{};
