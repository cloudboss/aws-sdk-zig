...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCampaignsInput, options: Options) !GetCampaignsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCampaignsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetCampaignsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
