...
pub const DeleteJourneyInput = struct {
...
pub const DeleteJourneyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteJourneyInput, options: CallOptions) !DeleteJourneyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteJourneyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteJourneyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteJourneyOutput = .{};
