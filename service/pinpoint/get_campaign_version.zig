...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetCampaignVersionInput, options: Options) !GetCampaignVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetCampaignVersionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetCampaignVersionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
