...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateSamplingRuleInput, options: CallOptions) !UpdateSamplingRuleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateSamplingRuleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "\"SamplingRuleUpdate\":");
    try aws.json.writeValue(@TypeOf(input.sampling_rule_update), input.sampling_rule_update, allocator, &body_buf);
    has_prev = true;
