...
/// Placement
/// Strategies](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-placement-strategies.html) in the Amazon Elastic Container Service Service Developer
/// Guide.
pub const PlacementStrategy = struct {
    ...
    /// places tasks on
    /// available candidates. The spread placement strategy spreads placement across
    /// available
