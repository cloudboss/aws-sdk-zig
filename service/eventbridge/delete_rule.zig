...
const DeleteRuleInput = @import("delete_rule_request.zig").DeleteRuleRequest;

const DeleteRuleOutput = struct {};
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteRuleInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSEvents.DeleteRule");
