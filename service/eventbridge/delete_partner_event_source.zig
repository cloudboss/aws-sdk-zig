...
pub const DeletePartnerEventSourceInput = struct {
...
pub const DeletePartnerEventSourceOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeletePartnerEventSourceInput, options: CallOptions) !DeletePartnerEventSourceOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeletePartnerEventSourceInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSEvents.DeletePartnerEventSource");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeletePartnerEventSourceOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
