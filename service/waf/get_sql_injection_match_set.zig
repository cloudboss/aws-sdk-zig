...
const SqlInjectionMatchSet = @import("sql_injection_match_set.zig").SqlInjectionMatchSet;

pub const GetSqlInjectionMatchSetInput = struct {
...
pub const GetSqlInjectionMatchSetOutput = struct {
    ...
    sql_injection_match_set: ?SqlInjectionMatchSet = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetSqlInjectionMatchSetInput, options: CallOptions) !GetSqlInjectionMatchSetOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetSqlInjectionMatchSetInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSWAF_20150824.GetSqlInjectionMatchSet");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetSqlInjectionMatchSetOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetSqlInjectionMatchSetOutput, body, allocator);
}
