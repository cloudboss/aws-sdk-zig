...
const SetDataRetrievalPolicyOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetDataRetrievalPolicyInput, options: Options) !SetDataRetrievalPolicyOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: SetDataRetrievalPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/policies/data-retrieval");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetDataRetrievalPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
