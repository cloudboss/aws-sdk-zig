...
fn serializeRequest(alloc: std.mem.Allocator, input: CompleteVaultLockInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, input.lock_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CompleteVaultLockOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
