...
pub const CompleteVaultLockInput = struct {
...
pub const CompleteVaultLockOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CompleteVaultLockInput, options: CallOptions) !CompleteVaultLockOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CompleteVaultLockInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, input.lock_id);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CompleteVaultLockOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: CompleteVaultLockOutput = .{};
