...
pub const CreateVaultInput = struct {
...
pub const CreateVaultOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateVaultInput, options: Options) !CreateVaultOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateVaultInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateVaultOutput {
