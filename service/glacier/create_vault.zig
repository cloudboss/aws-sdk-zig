...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateVaultInput, options: CallOptions) !CreateVaultOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateVaultInput, config: *aws.Config) !aws.http.Request {
