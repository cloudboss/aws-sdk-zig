...
pub const DeleteVaultNotificationsInput = struct {
...
pub const DeleteVaultNotificationsOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVaultNotificationsInput, options: CallOptions) !DeleteVaultNotificationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVaultNotificationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVaultNotificationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVaultNotificationsOutput = .{};
