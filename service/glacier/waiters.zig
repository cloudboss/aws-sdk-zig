...
pub const VaultExistsWaiter = struct {
    client: *Client,
    params: describe_vault.DescribeVaultInput,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        _ = self.client.describeVault(arena.allocator(), self.params, .{ .diagnostic = &diagnostic }) catch |err| {
...
pub const VaultNotExistsWaiter = struct {
    client: *Client,
    params: describe_vault.DescribeVaultInput,
    config: aws.waiter.WaiterConfig = .{
        .min_delay_s = 3,
