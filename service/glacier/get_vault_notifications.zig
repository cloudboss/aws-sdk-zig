...
const VaultNotificationConfig = @import("vault_notification_config.zig").VaultNotificationConfig;

pub const GetVaultNotificationsInput = struct {
...
pub const GetVaultNotificationsOutput = struct {
    /// Returns the notification configuration set on the vault.
    vault_notification_config: ?VaultNotificationConfig = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVaultNotificationsInput, options: CallOptions) !GetVaultNotificationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVaultNotificationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVaultNotificationsOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetVaultNotificationsOutput = .{};
