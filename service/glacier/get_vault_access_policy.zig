...
pub const GetVaultAccessPolicyInput = struct {
...
pub const GetVaultAccessPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetVaultAccessPolicyInput, options: CallOptions) !GetVaultAccessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetVaultAccessPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: GetVaultAccessPolicyOutput = .{};
