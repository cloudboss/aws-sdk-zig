...
pub const AddTagsToVaultInput = struct {
...
pub const AddTagsToVaultOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AddTagsToVaultInput, options: CallOptions) !AddTagsToVaultOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AddTagsToVaultInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AddTagsToVaultOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AddTagsToVaultOutput = .{};
