...
pub const GetDataRetrievalPolicyInput = struct {
...
pub const GetDataRetrievalPolicyOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataRetrievalPolicyInput, options: CallOptions) !GetDataRetrievalPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDataRetrievalPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDataRetrievalPolicyOutput {
    var result: GetDataRetrievalPolicyOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetDataRetrievalPolicyOutput, body, allocator);
    }
    _ = status;
    _ = headers;
