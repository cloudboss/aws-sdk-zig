...
pub const DeleteVaultAccessPolicyInput = struct {
...
pub const DeleteVaultAccessPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVaultAccessPolicyInput, options: CallOptions) !DeleteVaultAccessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVaultAccessPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVaultAccessPolicyOutput = .{};
