...
pub const DeleteArchiveInput = struct {
...
const DeleteArchiveOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteArchiveInput, options: Options) !DeleteArchiveOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteArchiveInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/archives/");
    try path_buf.appendSlice(alloc, input.archive_id);
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteArchiveOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteArchiveOutput = .{};
