...
pub const GlacierJobDescription = struct {
    ...
    archive_sha256_tree_hash: ?[]const u8 = null,
    ...
    /// is
    /// null.
    archive_size_in_bytes: ?i64 = null,
    ...
    inventory_retrieval_parameters: ?InventoryRetrievalJobDescription = null,
    ...
    /// is
    /// null.
    inventory_size_in_bytes: ?i64 = null,
    ...
    ///
    /// * Select jobs
    sha256_tree_hash: ?[]const u8 = null,
