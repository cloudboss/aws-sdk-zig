...
pub const AbortVaultLockInput = struct {
...
pub const AbortVaultLockOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AbortVaultLockInput, options: CallOptions) !AbortVaultLockOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AbortVaultLockInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AbortVaultLockOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: AbortVaultLockOutput = .{};
