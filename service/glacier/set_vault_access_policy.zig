...
const VaultAccessPolicy = @import("vault_access_policy.zig").VaultAccessPolicy;

pub const SetVaultAccessPolicyInput = struct {
...
pub const SetVaultAccessPolicyOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: SetVaultAccessPolicyInput, options: CallOptions) !SetVaultAccessPolicyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: SetVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/access-policy");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !SetVaultAccessPolicyOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: SetVaultAccessPolicyOutput = .{};
