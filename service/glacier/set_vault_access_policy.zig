...
fn serializeRequest(alloc: std.mem.Allocator, input: SetVaultAccessPolicyInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !SetVaultAccessPolicyOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
