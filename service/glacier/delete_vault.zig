...
pub const DeleteVaultInput = struct {
...
pub const DeleteVaultOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteVaultInput, options: CallOptions) !DeleteVaultOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteVaultInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteVaultOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteVaultOutput = .{};
