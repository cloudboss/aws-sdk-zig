...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFHIRImportJobsInput, options: Options) !ListFHIRImportJobsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListFHIRImportJobsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "HealthLake.ListFHIRImportJobs");
