...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeFHIRExportJobInput, options: Options) !DescribeFHIRExportJobOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DescribeFHIRExportJobInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "HealthLake.DescribeFHIRExportJob");
