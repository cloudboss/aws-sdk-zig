...
pub const ClassificationResultStatus = struct {
    ...
    ///   the finding applies to. For example, the object is an archive file that
    ...
    ///   but Macie isn't allowed to use the key. Macie can't decrypt and analyze
    ///   the object.
    ...
    ///   nested depth of the data exceeds the quota for the number of nested levels
    ...
    ///   file that is malformed or exceeds the size quota for this type of file. If
    ///   the file is malformed, an error occurred when Macie attempted to extract
    ///   data from the file.
    ...
    ///   file whose compression ratio exceeds the compression quota for this type
    ///   of file.
