...
const ListInvitationsInput = @import("list_invitations_request.zig").ListInvitationsRequest;

const ListInvitationsOutput = @import("list_invitations_response.zig").ListInvitationsResponse;
