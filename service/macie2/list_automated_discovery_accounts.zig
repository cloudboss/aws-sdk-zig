...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAutomatedDiscoveryAccountsInput, options: Options) !ListAutomatedDiscoveryAccountsOutput {
