...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateResourceProfileDetectionsInput, options: Options) !UpdateResourceProfileDetectionsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateResourceProfileDetectionsInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.suppress_data_identifiers) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"suppressDataIdentifiers\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateResourceProfileDetectionsOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
