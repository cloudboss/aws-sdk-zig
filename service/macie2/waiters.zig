...
pub const FindingRevealedWaiter = struct {
    client: *Client,
    params: get_sensitive_data_occurrences.GetSensitiveDataOccurrencesInput,
    ...
    fn poll(self: *Self) aws.waiter.AcceptorState {
        ...
        const output = self.client.getSensitiveDataOccurrences(arena.allocator(), self.params, .{}) catch {
            return .retry;
        };
