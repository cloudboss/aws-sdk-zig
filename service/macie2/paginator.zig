...
pub const DescribeBucketsPaginator = struct {
    client: *Client,
    params: describe_buckets.DescribeBucketsInput,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !describe_buckets.DescribeBucketsOutput {
        if (self.done) {
...
pub const GetUsageStatisticsPaginator = struct {
    client: *Client,
    params: get_usage_statistics.GetUsageStatisticsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !get_usage_statistics.GetUsageStatisticsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAllowListsPaginator = struct {
    client: *Client,
    params: list_allow_lists.ListAllowListsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_allow_lists.ListAllowListsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListAutomatedDiscoveryAccountsPaginator = struct {
    client: *Client,
    params: list_automated_discovery_accounts.ListAutomatedDiscoveryAccountsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_automated_discovery_accounts.ListAutomatedDiscoveryAccountsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListClassificationJobsPaginator = struct {
    client: *Client,
    params: list_classification_jobs.ListClassificationJobsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_classification_jobs.ListClassificationJobsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListClassificationScopesPaginator = struct {
    client: *Client,
    params: list_classification_scopes.ListClassificationScopesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_classification_scopes.ListClassificationScopesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListCustomDataIdentifiersPaginator = struct {
    client: *Client,
    params: list_custom_data_identifiers.ListCustomDataIdentifiersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_custom_data_identifiers.ListCustomDataIdentifiersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListFindingsFiltersPaginator = struct {
    client: *Client,
    params: list_findings_filters.ListFindingsFiltersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_findings_filters.ListFindingsFiltersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListManagedDataIdentifiersPaginator = struct {
    client: *Client,
    params: list_managed_data_identifiers.ListManagedDataIdentifiersInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_managed_data_identifiers.ListManagedDataIdentifiersOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListResourceProfileArtifactsPaginator = struct {
    client: *Client,
    params: list_resource_profile_artifacts.ListResourceProfileArtifactsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_resource_profile_artifacts.ListResourceProfileArtifactsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListResourceProfileDetectionsPaginator = struct {
    client: *Client,
    params: list_resource_profile_detections.ListResourceProfileDetectionsInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_resource_profile_detections.ListResourceProfileDetectionsOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
...
pub const ListSensitivityInspectionTemplatesPaginator = struct {
    client: *Client,
    params: list_sensitivity_inspection_templates.ListSensitivityInspectionTemplatesInput,
    next_token: ?[]const u8 = null,
    done: bool = false,
    allocator: std.mem.Allocator,
    ...
    pub fn next(self: *Self, allocator: std.mem.Allocator, options: CallOptions) !list_sensitivity_inspection_templates.ListSensitivityInspectionTemplatesOutput {
        if (self.done) {
            return error.EndOfPagination;
        }
