...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateAutomatedDiscoveryConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    if (input.auto_enable_organization_members) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"autoEnableOrganizationMembers\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateAutomatedDiscoveryConfigurationOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
