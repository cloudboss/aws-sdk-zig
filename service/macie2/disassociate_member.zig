...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateMemberInput, options: CallOptions) !DisassociateMemberOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateMemberInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(allocator, "/members/disassociate/");
