...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutClassificationExportConfigurationInput, options: Options) !PutClassificationExportConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutClassificationExportConfigurationInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutClassificationExportConfigurationOutput {
    var result: PutClassificationExportConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(PutClassificationExportConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
