...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListFindingsFiltersInput, options: CallOptions) !ListFindingsFiltersOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListFindingsFiltersInput, config: *aws.Config) !aws.http.Request {
