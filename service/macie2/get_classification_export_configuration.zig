...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetClassificationExportConfigurationInput, options: Options) !GetClassificationExportConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetClassificationExportConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetClassificationExportConfigurationOutput {
    var result: GetClassificationExportConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetClassificationExportConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
