...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateMacieSessionInput, options: Options) !UpdateMacieSessionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateMacieSessionInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateMacieSessionOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
