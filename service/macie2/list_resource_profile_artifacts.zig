...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListResourceProfileArtifactsInput, options: CallOptions) !ListResourceProfileArtifactsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListResourceProfileArtifactsInput, config: *aws.Config) !aws.http.Request {
