...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetFindingsPublicationConfigurationInput, options: Options) !GetFindingsPublicationConfigurationOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: GetFindingsPublicationConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !GetFindingsPublicationConfigurationOutput {
    var result: GetFindingsPublicationConfigurationOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(GetFindingsPublicationConfigurationOutput, body, alloc);
    }
    _ = status;
    _ = headers;
