...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateClassificationScopeInput, options: Options) !UpdateClassificationScopeOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: UpdateClassificationScopeInput, config: *aws.Config) !aws.http.Request {
    ...
    try path_buf.appendSlice(alloc, "/classification-scopes/");
    ...
    if (input.s_3) |v| {
        ...
        try body_buf.appendSlice(alloc, "\"s3\":");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !UpdateClassificationScopeOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
