...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateFindingsFilterInput, options: CallOptions) !CreateFindingsFilterOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateFindingsFilterInput, config: *aws.Config) !aws.http.Request {
