...
pub const ServiceError = struct {
    ...
    pub const Kind = union(enum) {
        ...
        dependent_service_failure_exception: DependentServiceFailureException,
        ...
        pub fn message(self: Kind) []const u8 {
            return switch (self) {
                ...
                .dependent_service_failure_exception => |e| e.message,
        ...
        pub fn httpStatus(self: Kind) u16 {
            return switch (self) {
                ...
                .dependent_service_failure_exception => 503,
        ...
        pub fn requestId(self: Kind) []const u8 {
            return switch (self) {
                ...
                .dependent_service_failure_exception => |e| e.request_id,
...
pub const DependentServiceFailureException = struct {
    message: []const u8 = "",
    request_id: []const u8 = "",
};
