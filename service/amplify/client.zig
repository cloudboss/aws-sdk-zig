...
pub const Client = struct {
    ...
    pub fn createBackendEnvironment(self: *Self, allocator: std.mem.Allocator, input: create_backend_environment.CreateBackendEnvironmentInput, options: create_backend_environment.Options) !create_backend_environment.CreateBackendEnvironmentOutput {
    ...
    pub fn createDomainAssociation(self: *Self, allocator: std.mem.Allocator, input: create_domain_association.CreateDomainAssociationInput, options: create_domain_association.Options) !create_domain_association.CreateDomainAssociationOutput {
    ...
    /// provision the app's
    /// backend infrastructure using Typescript code.
    pub fn deleteBackendEnvironment(self: *Self, allocator: std.mem.Allocator, input: delete_backend_environment.DeleteBackendEnvironmentInput, options: delete_backend_environment.Options) !delete_backend_environment.DeleteBackendEnvironmentOutput {
    ...
    pub fn deleteDomainAssociation(self: *Self, allocator: std.mem.Allocator, input: delete_domain_association.DeleteDomainAssociationInput, options: delete_domain_association.Options) !delete_domain_association.DeleteDomainAssociationOutput {
    ...
    /// URL.
    pub fn generateAccessLogs(self: *Self, allocator: std.mem.Allocator, input: generate_access_logs.GenerateAccessLogsInput, options: generate_access_logs.Options) !generate_access_logs.GenerateAccessLogsOutput {
    ...
    pub fn getArtifactUrl(self: *Self, allocator: std.mem.Allocator, input: get_artifact_url.GetArtifactUrlInput, options: get_artifact_url.Options) !get_artifact_url.GetArtifactUrlOutput {
    ...
    /// provision the app's
    /// backend infrastructure using Typescript code.
    pub fn getBackendEnvironment(self: *Self, allocator: std.mem.Allocator, input: get_backend_environment.GetBackendEnvironmentInput, options: get_backend_environment.Options) !get_backend_environment.GetBackendEnvironmentOutput {
    ...
    pub fn getDomainAssociation(self: *Self, allocator: std.mem.Allocator, input: get_domain_association.GetDomainAssociationInput, options: get_domain_association.Options) !get_domain_association.GetDomainAssociationOutput {
    ...
    pub fn getWebhook(self: *Self, allocator: std.mem.Allocator, input: get_webhook.GetWebhookInput, options: get_webhook.Options) !get_webhook.GetWebhookOutput {
    ...
    /// provision the app's
    /// backend infrastructure using Typescript code.
    pub fn listBackendEnvironments(self: *Self, allocator: std.mem.Allocator, input: list_backend_environments.ListBackendEnvironmentsInput, options: list_backend_environments.Options) !list_backend_environments.ListBackendEnvironmentsOutput {
    ...
    pub fn listDomainAssociations(self: *Self, allocator: std.mem.Allocator, input: list_domain_associations.ListDomainAssociationsInput, options: list_domain_associations.Options) !list_domain_associations.ListDomainAssociationsOutput {
    ...
    pub fn updateBranch(self: *Self, allocator: std.mem.Allocator, input: update_branch.UpdateBranchInput, options: update_branch.Options) !update_branch.UpdateBranchOutput {
