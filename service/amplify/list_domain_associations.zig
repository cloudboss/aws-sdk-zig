...
pub const ListDomainAssociationsInput = struct {
...
pub const ListDomainAssociationsOutput = struct {
    /// A list of domain associations.
    domain_associations: ?[]const DomainAssociation = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDomainAssociationsInput, options: Options) !ListDomainAssociationsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ListDomainAssociationsInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ListDomainAssociationsOutput {
    var result: ListDomainAssociationsOutput = .{};
    if (body.len > 0) {
        result = try aws.json.parseJsonObject(ListDomainAssociationsOutput, body, alloc);
    }
    _ = status;
    _ = headers;
