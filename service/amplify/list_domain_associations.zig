...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDomainAssociationsInput, options: CallOptions) !ListDomainAssociationsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListDomainAssociationsInput, config: *aws.Config) !aws.http.Request {
