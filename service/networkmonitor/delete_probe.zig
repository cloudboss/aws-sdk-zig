...
pub const DeleteProbeInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteProbeInput, options: Options) !DeleteProbeOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteProbeInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteProbeOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteProbeOutput = .{};
