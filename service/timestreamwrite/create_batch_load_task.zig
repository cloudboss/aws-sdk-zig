...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateBatchLoadTaskInput, options: Options) !CreateBatchLoadTaskOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateBatchLoadTaskInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(alloc, "X-Amz-Target", "Timestream_20181101.CreateBatchLoadTask");
