...
/// to
/// data validation issues that must be resolved before reinserting time-series
/// data into the
/// system.
pub const RejectedRecord = struct {
    ...
    /// Timestream](https://docs.aws.amazon.com/timestream/latest/developerguide/best-practices.html#configuration) and [the
    /// explanation of how storage works in
    /// Timestream](https://docs.aws.amazon.com/timestream/latest/developerguide/storage.html).
    ///
