...
pub const ResendOperationAuthorizationInput = struct {
    /// Operation ID.
...
pub const ResendOperationAuthorizationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ResendOperationAuthorizationInput, options: CallOptions) !ResendOperationAuthorizationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ResendOperationAuthorizationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Domains_v20140515.ResendOperationAuthorization");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ResendOperationAuthorizationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
