...
pub const AcceptDomainTransferFromAnotherAwsAccountInput = struct {
...
pub const AcceptDomainTransferFromAnotherAwsAccountOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptDomainTransferFromAnotherAwsAccountInput, options: CallOptions) !AcceptDomainTransferFromAnotherAwsAccountOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AcceptDomainTransferFromAnotherAwsAccountInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Domains_v20140515.AcceptDomainTransferFromAnotherAwsAccount");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AcceptDomainTransferFromAnotherAwsAccountOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(AcceptDomainTransferFromAnotherAwsAccountOutput, body, allocator);
}
