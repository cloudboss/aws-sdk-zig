...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AcceptDomainTransferFromAnotherAwsAccountInput, options: Options) !AcceptDomainTransferFromAnotherAwsAccountOutput {
