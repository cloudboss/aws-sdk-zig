...
pub const DeleteTagsForDomainInput = struct {
    /// The domain for which you want to delete one or more tags.
    domain_name: []const u8,

    /// A list of tag keys to delete.
    tags_to_delete: []const []const u8,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteTagsForDomainInput, options: Options) !DeleteTagsForDomainOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteTagsForDomainInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "Route53Domains_v20140515.DeleteTagsForDomain");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteTagsForDomainOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
