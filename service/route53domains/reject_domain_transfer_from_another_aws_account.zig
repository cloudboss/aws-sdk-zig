...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RejectDomainTransferFromAnotherAwsAccountInput, options: Options) !RejectDomainTransferFromAnotherAwsAccountOutput {
