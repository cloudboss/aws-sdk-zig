...
pub const PutAlternateContactOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAlternateContactInput, options: CallOptions) !PutAlternateContactOutput {
