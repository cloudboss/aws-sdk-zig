...
pub const Client = struct {
    ...
    pub fn acceptPrimaryEmailUpdate(self: *Self, allocator: std.mem.Allocator, input: accept_primary_email_update.AcceptPrimaryEmailUpdateInput, options: CallOptions) !accept_primary_email_update.AcceptPrimaryEmailUpdateOutput {
    ...
    pub fn deleteAlternateContact(self: *Self, allocator: std.mem.Allocator, input: delete_alternate_contact.DeleteAlternateContactInput, options: CallOptions) !delete_alternate_contact.DeleteAlternateContactOutput {
    ...
    pub fn disableRegion(self: *Self, allocator: std.mem.Allocator, input: disable_region.DisableRegionInput, options: CallOptions) !disable_region.DisableRegionOutput {
        return disable_region.execute(self, allocator, input, options);
    }

    /// Enables (opts-in) a particular Region for an account.
    pub fn enableRegion(self: *Self, allocator: std.mem.Allocator, input: enable_region.EnableRegionInput, options: CallOptions) !enable_region.EnableRegionOutput {
    ...
    /// Web Services Account
    /// Management](https://docs.aws.amazon.com/accounts/latest/reference/using-orgs-trusted-access.html).
    pub fn getAlternateContact(self: *Self, allocator: std.mem.Allocator, input: get_alternate_contact.GetAlternateContactInput, options: CallOptions) !get_alternate_contact.GetAlternateContactOutput {
    ...
    pub fn getContactInformation(self: *Self, allocator: std.mem.Allocator, input: get_contact_information.GetContactInformationInput, options: CallOptions) !get_contact_information.GetContactInformationOutput {
    ...
    pub fn getGovCloudAccountInformation(self: *Self, allocator: std.mem.Allocator, input: get_gov_cloud_account_information.GetGovCloudAccountInformationInput, options: CallOptions) !get_gov_cloud_account_information.GetGovCloudAccountInformationOutput {
        return get_gov_cloud_account_information.execute(self, allocator, input, options);
    }

    /// Retrieves the primary email address for the specified account.
    pub fn getPrimaryEmail(self: *Self, allocator: std.mem.Allocator, input: get_primary_email.GetPrimaryEmailInput, options: CallOptions) !get_primary_email.GetPrimaryEmailOutput {
    ...
    pub fn putAccountName(self: *Self, allocator: std.mem.Allocator, input: put_account_name.PutAccountNameInput, options: CallOptions) !put_account_name.PutAccountNameOutput {
    ...
    /// Web Services Account
    /// Management](https://docs.aws.amazon.com/accounts/latest/reference/using-orgs-trusted-access.html).
    pub fn putAlternateContact(self: *Self, allocator: std.mem.Allocator, input: put_alternate_contact.PutAlternateContactInput, options: CallOptions) !put_alternate_contact.PutAlternateContactOutput {
    ...
    /// [Update the primary contact for your Amazon Web Services
    /// account](https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-contact-primary.html).
    pub fn putContactInformation(self: *Self, allocator: std.mem.Allocator, input: put_contact_information.PutContactInformationInput, options: CallOptions) !put_contact_information.PutContactInformationOutput {
