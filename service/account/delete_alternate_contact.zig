...
pub const DeleteAlternateContactInput = struct {
...
pub const DeleteAlternateContactOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteAlternateContactInput, options: CallOptions) !DeleteAlternateContactOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteAlternateContactInput, config: *aws.Config) !aws.http.Request {
    ...
    const path = "/deleteAlternateContact";
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteAlternateContactOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
    const result: DeleteAlternateContactOutput = .{};
