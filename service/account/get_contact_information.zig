...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetContactInformationInput, options: CallOptions) !GetContactInformationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetContactInformationInput, config: *aws.Config) !aws.http.Request {
