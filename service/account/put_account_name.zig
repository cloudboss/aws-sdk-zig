...
pub const PutAccountNameInput = struct {
...
const PutAccountNameOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccountNameInput, options: Options) !PutAccountNameOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: PutAccountNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !PutAccountNameOutput {
    _ = alloc;
    _ = body;
    _ = status;
    _ = headers;
    const result: PutAccountNameOutput = .{};
