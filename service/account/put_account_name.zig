...
pub const PutAccountNameOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutAccountNameInput, options: CallOptions) !PutAccountNameOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutAccountNameInput, config: *aws.Config) !aws.http.Request {
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutAccountNameOutput {
    _ = allocator;
    _ = body;
    _ = status;
    _ = headers;
