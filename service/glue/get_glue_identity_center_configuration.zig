...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetGlueIdentityCenterConfigurationInput, options: Options) !GetGlueIdentityCenterConfigurationOutput {
