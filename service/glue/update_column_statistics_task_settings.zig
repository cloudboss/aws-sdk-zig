...
pub const UpdateColumnStatisticsTaskSettingsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateColumnStatisticsTaskSettingsInput, options: Options) !UpdateColumnStatisticsTaskSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateColumnStatisticsTaskSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.UpdateColumnStatisticsTaskSettings");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateColumnStatisticsTaskSettingsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
