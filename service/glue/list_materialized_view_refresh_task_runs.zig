...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListMaterializedViewRefreshTaskRunsInput, options: Options) !ListMaterializedViewRefreshTaskRunsOutput {
