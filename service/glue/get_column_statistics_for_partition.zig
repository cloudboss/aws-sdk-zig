...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetColumnStatisticsForPartitionInput, options: Options) !GetColumnStatisticsForPartitionOutput {
