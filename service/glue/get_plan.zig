...
pub const GetPlanInput = struct {
    ...
    ///   for the default script generated by an Glue job. For example, to set
    ///   `inferSchema` to true, pass the following key value pair:
    ///
    /// `--additional-plan-options-map '{"inferSchema":"true"}'`
    additional_plan_options_map: ?[]const aws.map.StringMapEntry = null,
    ...
    pub const json_field_names = .{
        .additional_plan_options_map = "AdditionalPlanOptionsMap",
        .language = "Language",
        .location = "Location",
        .mapping = "Mapping",
        .sinks = "Sinks",
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetPlanInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.GetPlan");
