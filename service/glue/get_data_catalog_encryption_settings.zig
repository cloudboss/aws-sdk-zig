...
pub const GetDataCatalogEncryptionSettingsInput = struct {
...
pub const GetDataCatalogEncryptionSettingsOutput = struct {
    /// The requested security configuration.
    data_catalog_encryption_settings: ?DataCatalogEncryptionSettings = null,
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataCatalogEncryptionSettingsInput, options: CallOptions) !GetDataCatalogEncryptionSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDataCatalogEncryptionSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.GetDataCatalogEncryptionSettings");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDataCatalogEncryptionSettingsOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetDataCatalogEncryptionSettingsOutput, body, allocator);
}
