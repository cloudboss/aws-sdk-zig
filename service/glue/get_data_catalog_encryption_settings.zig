...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataCatalogEncryptionSettingsInput, options: Options) !GetDataCatalogEncryptionSettingsOutput {
