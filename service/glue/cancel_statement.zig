...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelStatementInput, options: Options) !CancelStatementOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelStatementInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.CancelStatement");
