...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateColumnStatisticsForPartitionInput, options: Options) !UpdateColumnStatisticsForPartitionOutput {
