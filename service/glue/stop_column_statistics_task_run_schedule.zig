...
pub const StopColumnStatisticsTaskRunScheduleInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: StopColumnStatisticsTaskRunScheduleInput, options: Options) !StopColumnStatisticsTaskRunScheduleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: StopColumnStatisticsTaskRunScheduleInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.StopColumnStatisticsTaskRunSchedule");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !StopColumnStatisticsTaskRunScheduleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
