...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetMaterializedViewRefreshTaskRunInput, options: Options) !GetMaterializedViewRefreshTaskRunOutput {
