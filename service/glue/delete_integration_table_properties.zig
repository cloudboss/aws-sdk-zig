...
pub const DeleteIntegrationTablePropertiesInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIntegrationTablePropertiesInput, options: Options) !DeleteIntegrationTablePropertiesOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIntegrationTablePropertiesInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.DeleteIntegrationTableProperties");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIntegrationTablePropertiesOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
