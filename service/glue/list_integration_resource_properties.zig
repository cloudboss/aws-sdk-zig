...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListIntegrationResourcePropertiesInput, options: Options) !ListIntegrationResourcePropertiesOutput {
