...
pub const DeleteIntegrationResourcePropertyInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteIntegrationResourcePropertyInput, options: Options) !DeleteIntegrationResourcePropertyOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteIntegrationResourcePropertyInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.DeleteIntegrationResourceProperty");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteIntegrationResourcePropertyOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
