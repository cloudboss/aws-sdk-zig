...
pub const CancelDataQualityRulesetEvaluationRunInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CancelDataQualityRulesetEvaluationRunInput, options: Options) !CancelDataQualityRulesetEvaluationRunOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CancelDataQualityRulesetEvaluationRunInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.CancelDataQualityRulesetEvaluationRun");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CancelDataQualityRulesetEvaluationRunOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
