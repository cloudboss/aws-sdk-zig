...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataQualityRulesetEvaluationRunInput, options: Options) !GetDataQualityRulesetEvaluationRunOutput {
