...
pub const GetDataQualityRulesetEvaluationRunInput = struct {
...
pub const GetDataQualityRulesetEvaluationRunOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: GetDataQualityRulesetEvaluationRunInput, options: CallOptions) !GetDataQualityRulesetEvaluationRunOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: GetDataQualityRulesetEvaluationRunInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.GetDataQualityRulesetEvaluationRun");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !GetDataQualityRulesetEvaluationRunOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(GetDataQualityRulesetEvaluationRunOutput, body, allocator);
}
