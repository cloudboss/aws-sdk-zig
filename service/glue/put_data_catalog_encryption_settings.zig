...
const DataCatalogEncryptionSettings = @import("data_catalog_encryption_settings.zig").DataCatalogEncryptionSettings;

pub const PutDataCatalogEncryptionSettingsInput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: PutDataCatalogEncryptionSettingsInput, options: Options) !PutDataCatalogEncryptionSettingsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: PutDataCatalogEncryptionSettingsInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.PutDataCatalogEncryptionSettings");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !PutDataCatalogEncryptionSettingsOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
