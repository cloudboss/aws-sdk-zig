...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateColumnStatisticsForTableInput, options: Options) !UpdateColumnStatisticsForTableOutput {
