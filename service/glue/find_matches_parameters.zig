...
pub const FindMatchesParameters = struct {
    /// The value that is selected when tuning your transform for a balance between
    /// accuracy and
    /// cost. A value of 0.5 means that the system balances accuracy and cost
    /// concerns. A value of 1.0
    /// means a bias purely for accuracy, which typically results in a higher cost,
    /// sometimes
    ...
    /// A value of 0.5 means no preference; a value of 1.0 means a bias purely for
    /// precision, and a
    /// value of 0.0 means a bias for recall. Because this is a tradeoff, choosing
    /// values close to 1.0
    /// means very low recall, and choosing values close to 0.0 results in very low
    /// precision.
    ///
