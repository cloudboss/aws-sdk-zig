...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListDataQualityRuleRecommendationRunsInput, options: Options) !ListDataQualityRuleRecommendationRunsOutput {
