...
pub const CreateGlueIdentityCenterConfigurationInput = struct {
...
pub const CreateGlueIdentityCenterConfigurationOutput = struct {
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateGlueIdentityCenterConfigurationInput, options: CallOptions) !CreateGlueIdentityCenterConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: CreateGlueIdentityCenterConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.CreateGlueIdentityCenterConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !CreateGlueIdentityCenterConfigurationOutput {
    _ = status;
    _ = headers;
    if (body.len == 0) return .{};
    return aws.json.parseJsonObject(CreateGlueIdentityCenterConfigurationOutput, body, allocator);
}
