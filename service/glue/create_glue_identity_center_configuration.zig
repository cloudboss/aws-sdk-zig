...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateGlueIdentityCenterConfigurationInput, options: Options) !CreateGlueIdentityCenterConfigurationOutput {
