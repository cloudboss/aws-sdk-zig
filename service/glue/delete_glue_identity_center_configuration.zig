...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteGlueIdentityCenterConfigurationInput, options: Options) !DeleteGlueIdentityCenterConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteGlueIdentityCenterConfigurationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try request.headers.put(allocator, "X-Amz-Target", "AWSGlue.DeleteGlueIdentityCenterConfiguration");

    return request;
}

fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteGlueIdentityCenterConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
