...
pub const RebuildEnvironmentInput = struct {
...
pub const RebuildEnvironmentOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RebuildEnvironmentInput, options: CallOptions) !RebuildEnvironmentOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RebuildEnvironmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RebuildEnvironment&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RebuildEnvironmentOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: RebuildEnvironmentOutput = .{};
