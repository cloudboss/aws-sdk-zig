...
const CreateEnvironmentInput = @import("create_environment_message.zig").CreateEnvironmentMessage;

const CreateEnvironmentOutput = @import("environment_description.zig").EnvironmentDescription;
...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateEnvironmentInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=CreateEnvironment&Version=2010-12-01");
