...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListPlatformVersionsInput, options: CallOptions) !ListPlatformVersionsOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: ListPlatformVersionsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=ListPlatformVersions&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !ListPlatformVersionsOutput {
    _ = status;
    _ = headers;
        ...
        switch (event) {
            .element_start => |e| {
                if (std.mem.eql(u8, e.local, "NextToken")) {
                    ...
                    result.platform_summary_list = try serde.deserializePlatformSummaryList(allocator, &reader, "member");
                } else {
