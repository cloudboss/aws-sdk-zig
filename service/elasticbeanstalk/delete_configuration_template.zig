...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteConfigurationTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteConfigurationTemplate&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteConfigurationTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
