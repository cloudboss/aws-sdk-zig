...
pub const DeleteConfigurationTemplateInput = struct {
...
pub const DeleteConfigurationTemplateOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteConfigurationTemplateInput, options: CallOptions) !DeleteConfigurationTemplateOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteConfigurationTemplateInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteConfigurationTemplate&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteConfigurationTemplateOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteConfigurationTemplateOutput = .{};
