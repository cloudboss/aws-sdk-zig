...
pub const DeleteEnvironmentConfigurationInput = struct {
...
pub const DeleteEnvironmentConfigurationOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteEnvironmentConfigurationInput, options: CallOptions) !DeleteEnvironmentConfigurationOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DeleteEnvironmentConfigurationInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DeleteEnvironmentConfiguration&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DeleteEnvironmentConfigurationOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DeleteEnvironmentConfigurationOutput = .{};
