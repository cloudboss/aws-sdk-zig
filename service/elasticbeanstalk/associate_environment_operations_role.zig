...
pub const AssociateEnvironmentOperationsRoleInput = struct {
...
pub const AssociateEnvironmentOperationsRoleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: AssociateEnvironmentOperationsRoleInput, options: CallOptions) !AssociateEnvironmentOperationsRoleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: AssociateEnvironmentOperationsRoleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=AssociateEnvironmentOperationsRole&Version=2010-12-01");
    try body_buf.appendSlice(allocator, "&EnvironmentName=");
    try aws.url.appendUrlEncoded(allocator, &body_buf, input.environment_name);
    try body_buf.appendSlice(allocator, "&OperationsRole=");
    try aws.url.appendUrlEncoded(allocator, &body_buf, input.operations_role);
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !AssociateEnvironmentOperationsRoleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: AssociateEnvironmentOperationsRoleOutput = .{};
