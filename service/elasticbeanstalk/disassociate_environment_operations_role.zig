...
pub const DisassociateEnvironmentOperationsRoleInput = struct {
    /// The name of the environment from which to disassociate the operations role.
    environment_name: []const u8,
};

pub const DisassociateEnvironmentOperationsRoleOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DisassociateEnvironmentOperationsRoleInput, options: CallOptions) !DisassociateEnvironmentOperationsRoleOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: DisassociateEnvironmentOperationsRoleInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=DisassociateEnvironmentOperationsRole&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !DisassociateEnvironmentOperationsRoleOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: DisassociateEnvironmentOperationsRoleOutput = .{};
