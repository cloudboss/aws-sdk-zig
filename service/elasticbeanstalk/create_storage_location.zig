...
const CreateStorageLocationInput = struct {};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: CreateStorageLocationInput, options: Options) !CreateStorageLocationOutput {
