...
fn serializeRequest(alloc: std.mem.Allocator, input: CreateStorageLocationInput, config: *aws.Config) !aws.http.Request {
    _ = input;
    ...
    try body_buf.appendSlice(alloc, "Action=CreateStorageLocation&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !CreateStorageLocationOutput {
    _ = status;
    _ = headers;
