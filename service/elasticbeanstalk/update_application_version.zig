...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApplicationVersionInput, options: CallOptions) !UpdateApplicationVersionOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: UpdateApplicationVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=UpdateApplicationVersion&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !UpdateApplicationVersionOutput {
    _ = status;
    _ = headers;
