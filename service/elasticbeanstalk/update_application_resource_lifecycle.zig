...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: UpdateApplicationResourceLifecycleInput, options: Options) !UpdateApplicationResourceLifecycleOutput {
