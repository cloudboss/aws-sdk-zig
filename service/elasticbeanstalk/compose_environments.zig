...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ComposeEnvironmentsInput, options: Options) !ComposeEnvironmentsOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: ComposeEnvironmentsInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=ComposeEnvironments&Version=2010-12-01");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !ComposeEnvironmentsOutput {
    _ = status;
    _ = headers;
