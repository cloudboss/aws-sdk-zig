...
const DeleteApplicationVersionOutput = struct {};

pub const Options = struct {
    diagnostic: ?*ServiceError = null,
};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DeleteApplicationVersionInput, options: Options) !DeleteApplicationVersionOutput {
...
fn serializeRequest(alloc: std.mem.Allocator, input: DeleteApplicationVersionInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(alloc, "Action=DeleteApplicationVersion&Version=2010-12-01");
    ...
    if (input.delete_source_bundle) |v| {
        try body_buf.appendSlice(alloc, "&DeleteSourceBundle=");
...
fn deserializeResponse(body: []const u8, status: u16, headers: anytype, alloc: std.mem.Allocator) !DeleteApplicationVersionOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = alloc;
