...
const ListAvailableSolutionStacksInput = struct {};
...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: ListAvailableSolutionStacksInput, options: Options) !ListAvailableSolutionStacksOutput {
