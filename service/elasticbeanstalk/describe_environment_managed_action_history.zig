...
pub fn execute(client: *Client, allocator: std.mem.Allocator, input: DescribeEnvironmentManagedActionHistoryInput, options: Options) !DescribeEnvironmentManagedActionHistoryOutput {
