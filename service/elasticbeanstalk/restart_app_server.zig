...
pub const RestartAppServerInput = struct {
...
pub const RestartAppServerOutput = struct {};

pub fn execute(client: *Client, allocator: std.mem.Allocator, input: RestartAppServerInput, options: CallOptions) !RestartAppServerOutput {
...
fn serializeRequest(allocator: std.mem.Allocator, input: RestartAppServerInput, config: *aws.Config) !aws.http.Request {
    ...
    try body_buf.appendSlice(allocator, "Action=RestartAppServer&Version=2010-12-01");
...
fn deserializeResponse(allocator: std.mem.Allocator, body: []const u8, status: u16, headers: anytype) !RestartAppServerOutput {
    _ = status;
    _ = headers;
    _ = body;
    _ = allocator;
    const result: RestartAppServerOutput = .{};
