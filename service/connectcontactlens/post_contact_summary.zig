const PostContactSummaryFailureCode = @import("post_contact_summary_failure_code.zig").PostContactSummaryFailureCode;
const PostContactSummaryStatus = @import("post_contact_summary_status.zig").PostContactSummaryStatus;
